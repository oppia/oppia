...
require('pages/exploration-editor-page/editor-tab/services/responses.service.ts');
...
describe('TrainingDataService', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector, $rootScope) {
        ...
        rs.init({
            ...
            confirmedUnclassifiedAnswers: (state.interaction.confirmedUnclassifiedAnswers)
        });
        ecs.setActiveStateName('State');
    }));
    it('should be able to train answer groups and the default response', function () {
