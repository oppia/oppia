...
require('components/question-directives/question-player/services/' +
...
describe('Question player state service', function () {
    ...
    it('should add a hint to the question state data', function () {
        ...
        expect(stateData[questionId].linkedSkillIds).toEqual(['skill_id1', 'skill_id2']);
    });
    it('should record a wrong answer was submitted to the question state data', function () {
    ...
    it('should record a right answer was submitted to the question state data', function () {
    ...
    it('should record that a solution was viewed', function () {
        ...
        expect(stateData[questionId].viewedSolution.timestamp).toBeGreaterThan(0);
        expect(stateData[questionId].linkedSkillIds).toBeTruthy();
        expect(stateData[questionId].linkedSkillIds).toEqual(['skill_id1', 'skill_id2']);
    });
    it('should shouldn\'t record a correct answer if a solution was viewed', function () {
        qpservice.solutionViewed(question);
        var stateData = qpservice.getQuestionPlayerStateData();
        expect(stateData[questionId]).toBeTruthy();
        expect(stateData[questionId].viewedSolution).toBeDefined();
