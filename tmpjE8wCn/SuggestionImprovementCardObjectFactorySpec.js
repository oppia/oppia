...
describe('SuggestionImprovementCardObjectFactory', function () {
    ...
    beforeEach(angular.mock.inject(function (_$q_, _$rootScope_, _$uibModal_, _ImprovementModalService_, _SuggestionImprovementCardObjectFactory_, _SuggestionModalForExplorationEditorService_, _SuggestionThreadObjectFactory_, _ThreadDataService_, _SUGGESTION_IMPROVEMENT_CARD_TYPE_) {
        $q = _$q_;
    ...
    describe('SuggestionImprovementCard', function () {
        beforeEach(function () {
            ...
            this.mockThread = SuggestionThreadObjectFactory.createFromBackendDicts(mockSuggestionThreadBackendDict, mockSuggestionBackendDict);
            this.card =
