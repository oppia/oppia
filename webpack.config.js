...
module.exports = {
  entries: {
    about: './core/templates/dev/head/pages/about/About.ts',
    admin: './core/templates/dev/head/pages/admin/Admin.ts',
    app: './core/templates/dev/head/App.ts',
    collection_editor: './core/templates/dev/head/pages/collection_editor/CollectionEditor.ts',
    collection_player: './core/templates/dev/head/pages/collection_player/CollectionPlayer.ts',
    contact: './core/templates/dev/head/pages/contact/Contact.ts',
    creator_dashboard: './core/templates/dev/head/pages/creator_dashboard/CreatorDashboard.ts',
    donate: './core/templates/dev/head/pages/donate/Donate.ts',
    email_dashboard: './core/templates/dev/head/pages/email_dashboard/EmailDashboard.ts',
    error: './core/templates/dev/head/pages/error/Error.ts',
    exploration_editor: './core/templates/dev/head/pages/exploration_editor/ExplorationEditor.ts',
    exploration_player: './core/templates/dev/head/pages/exploration_player/ExplorationPlayer.ts',
    get_started: './core/templates/dev/head/pages/get_started/GetStarted.ts',
    landing: './core/templates/dev/head/pages/landing/TopicLandingPage.ts',
    learner_dashboard: './core/templates/dev/head/pages/learner_dashboard/LearnerDashboard.ts',
    library: './core/templates/dev/head/pages/library/Library.ts',
    maintenance: './core/templates/dev/head/pages/maintenance/Maintenance.ts',
    moderator: './core/templates/dev/head/pages/moderator/Moderator.ts',
    notifications_dashboard: './core/templates/dev/head/pages/notifications_dashboard/NotificationsDashboard.ts',
    practice_session: './core/templates/dev/head/pages/practice_session/PracticeSession.ts',
    preferences: './core/templates/dev/head/pages/preferences/Preferences.ts',
    profile: './core/templates/dev/head/pages/profile/Profile.ts',
    signup: './core/templates/dev/head/pages/signup/Signup.ts',
    skill_editor: './core/templates/dev/head/pages/skill_editor/SkillEditor.ts',
    splash: './core/templates/dev/head/pages/splash/Splash.ts',
    stewards: './core/templates/dev/head/pages/landing/stewards/Stewards.ts',
    story_editor: './core/templates/dev/head/pages/story_editor/StoryEditor.ts',
    teach: './core/templates/dev/head/pages/teach/Teach.ts',
    thanks: './core/templates/dev/head/pages/thanks/Thanks.ts',
    topic_editor: './core/templates/dev/head/pages/topic_editor/TopicEditor.ts',
    topics_and_skills_dashboard: './core/templates/dev/head/pages/topics_and_skills_dashboard/TopicsAndSkillsDashboard.ts',
    topic_viewer: './core/templates/dev/head/pages/topic_viewer/TopicViewer.ts',
  },
  plugins: [
