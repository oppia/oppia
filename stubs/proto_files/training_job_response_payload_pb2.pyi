...
class TrainingJobResponsePayload(google.protobuf.message.Message):
    ...
    class JobResult(google.protobuf.message.Message):
        ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["classifier_frozen_model",b"classifier_frozen_model"]) -> typing.Optional[typing_extensions.Literal["text_classifier"]]: ...
