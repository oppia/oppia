...
from typing import (
    Any, Iterator, List, Literal, Optional, Sequence, TypeVar, Tuple, Union, overload
)
...
class Query:
    ...
    def fetch(self,
              ...
              limit: Optional[int] = ...) -> Sequence[Key]:
        ...

    @overload
    def get(self,
            keys_only: Literal[False] = ...,
            **q_options: Any) -> Optional[TYPE_MODEL]:
        ...

    @overload
    def get(self, keys_only: Literal[True], **q_options: Any) -> Optional[Key]:
        ...
