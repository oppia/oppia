...
ACCEPTANCE_TESTS_SUITE_NAMES = [
    ...
    'logged-out-user/access-exploration-player',
    ...
    'logged-out-user/play-a-complete-community-lesson',
    'logged-out-user/play-lesson-in-different-languages-and-listen-'
    'to-voiceovers',
    'logged-out-user/play-lesson-in-embedded-player',
    ...
    'logged-out-user/give-feedback-from-lesson-player',
    'logged-out-user/play-exploration-while-getting-feedback-and-using-help-cards',
    'logged-out-user/play-lesson-in-different-languages-and-listen-to-voiceovers',
    'logged-out-user/share-the-lesson-from-lesson-player',
