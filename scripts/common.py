...
GOOGLE_APP_ENGINE_SDK_HOME = '/google-cloud-sdk/platform/google_appengine' if feconf.OPPIA_IS_DOCKERIZED else os.path.join(
...
NODE_PATH = '/usr' if feconf.OPPIA_IS_DOCKERIZED else os.path.join(OPPIA_TOOLS_DIR, 'node-%s' % NODE_VERSION)
