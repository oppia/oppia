...
# Path for the redis autogenerated dump file that contains information used by
# the Redis server.
...
def start_redis_server():
    ...
    # Check if a dump.rdb file currently exists. This file contains residual
    # data from a previous run of the redis server. If it exists, remove the
