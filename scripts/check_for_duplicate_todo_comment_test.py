...
class CheckForDuplicateTodoCommentTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        with open(
            'dummy_dir/unresolved_todo_list_one.txt', 'w', encoding='utf-8'
        ) as file:
            content = (
                f"""
        ...
        with open(
            'dummy_dir/unresolved_todo_list_two.txt', 'w', encoding='utf-8'
        ) as file:
            content = (
                f"""
            ...
            file.write(textwrap.dedent(content))
        with open(
            'dummy_dir/unresolved_todo_list_three.txt', 'w', encoding='utf-8'
        ) as file:
            content = (
                f"""
            ...
            file.write(textwrap.dedent(content))
        with open(
            'dummy_dir/unresolved_todo_list_four.txt', 'w', encoding='utf-8'
        ) as file:
            content = (
                f"""
                The following TODOs are unresolved for this issue #4177:
