...
class InstallRedisAndElasticSearchTests(test_utils.GenericTestBase):
    ...
    def test_install_redis_cli_function_calls(self) -> None:
        ...
        def mock_call(
            unused_cmd_tokens: List[str], **kwargs: str # pylint: disable=unused-argument
        ) -> Ret:
...
class SetupTests(test_utils.GenericTestBase):
    ...
    def test_download_and_install_package(self) -> None:
        ...
        def mock_url_retrieve(
            unused_url: str, filename: str # pylint: disable=unused-argument
        ) -> None:
        ...
        def mock_extractall(
            unused_self: str, path: str # pylint: disable=unused-argument
        ) -> None:
...
class GoogleCloudSdkInstallationTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        def mock_makedirs(
            unused_path: str, exist_ok: bool = False # pylint: disable=unused-argument
        ) -> None:
    ...
    def test_directory_copying(self) -> None:
        ...
        def mock_subprocess_run(
            *args: str, **kwargs: str # pylint: disable=unused-argument
        ) -> MockProcess:
            return MockProcess()
