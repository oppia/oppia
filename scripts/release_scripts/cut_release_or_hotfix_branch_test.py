...
class CutReleaseOrHotfixBranchTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.check_function_calls = {
            ...
            ('verify_target_version_compatible_with_latest_released_version_is_called'): False,
            ('verify_hotfix_number_is_one_ahead_of_previous_hotfix_number_is_called'): False,
        ...
        self.expected_check_function_calls = {
            ...
            ('verify_target_version_compatible_with_latest_released_version_is_called'): True,
            ('verify_hotfix_number_is_one_ahead_of_previous_hotfix_number_is_called'): True,
        ...
        self.url_open_swap = self.swap(common, 'url_open', mock_url_open)
    ...
    def test_exception_is_raised_if_target_branch_exists(self) -> None:
        ...
        with (
            ...
            self.assertRaisesRegex(
                Exception,
                'ERROR: The target branch name already exists locally. Run "git branch -D new-branch" to delete it.',
            ),
        ):
    ...
    def test_unexpected_major_version_change(self) -> None:
        ...
        with (
            self.url_open_swap,
            load_swap,
            self.assertRaisesRegex(AssertionError, 'Unexpected major version change.'),
        ):
            (cut_release_or_hotfix_branch.verify_target_version_compatible_with_latest_release('1.2.3'))
    ...
    def test_invalid_target_version_raises_error(self) -> None:
        ...
        with (
            self.url_open_swap,
            load_swap,
            self.assertRaisesRegex(Exception, 'ERROR: Could not parse target version.'),
        ):
    ...
    def test_invalid_difference_between_patch_versions(self) -> None:
        ...
        with (
            ...
            self.assertRaisesRegex(
                AssertionError,
                'The current patch version is not equal to previous patch version plus one.',
            ),
        ):
            (cut_release_or_hotfix_branch.verify_target_version_compatible_with_latest_release('1.2.3'))
    ...
    def test_invalid_difference_between_minor_versions(self) -> None:
        ...
        with (
            ...
            self.assertRaisesRegex(
                AssertionError,
                'The current minor version is not equal to previous minor version plus one.',
            ),
        ):
    ...
    def test_invalid_patch_version_with_valid_difference_between_minor_versions(
        ...
        with (
            self.url_open_swap,
            load_swap,
            self.assertRaisesRegex(AssertionError, 'The current patch version is different than 0.'),
        ):
    ...
    def test_exception_is_raised_for_missing_release_branch(self) -> None:
        ...
        with (
            check_output_swap,
            self.assertRaisesRegex(AssertionError, 'Release branch is missing.'),
        ):
            (cut_release_or_hotfix_branch.verify_hotfix_number_is_one_ahead_of_previous_hotfix_number('upstream', '1.2.3', 4))
    ...
    def test_missing_release_version(self) -> None:
        ...
        with (
            args_swap,
            self.assertRaisesRegex(Exception, 'ERROR: A "release_version" arg must be specified.'),
        ):
