...
class StartTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.swap_extend_index_yaml = self.swap(extend_index_yaml, 'main', lambda: None)
        self.swap_webpack_compiler = self.swap_with_checks(
            servers,
            'managed_webpack_compiler',
            lambda **unused_kwargs: MockCompilerContextManager(),
            expected_kwargs=[
                {'use_prod_env': False, 'use_source_maps': False, 'watch_mode': True}
            ],
        )
        ...
        self.swap_create_managed_web_browser = self.swap_to_always_raise(
            servers, 'create_managed_web_browser', Exception(MANAGED_WEB_BROWSER_ERROR)
        )
    ...
    def test_start_servers_successfully(self) -> None:
        ...
        swap_build = self.swap_with_checks(
            build, 'main', lambda **unused_kwargs: None, expected_kwargs=[{'args': []}]
        )
    ...
    def test_source_maps_are_compiled_by_webpack(self) -> None:
        ...
        self.swap_webpack_compiler = self.swap_with_checks(
            ...
            lambda **unused_kwargs: MockCompilerContextManager(),
            expected_kwargs=[
                {'use_prod_env': False, 'use_source_maps': True, 'watch_mode': True}
            ],
        )
