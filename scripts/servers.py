    ...
    with proc_context as proc:
        ...
        try:
            ...
            if common.is_port_in_use(feconf.REDISPORT):
                # Ensure redis is shut down properly on macOS and across other
                # platforms. We use redis-cli to ensure that it has enough
                # time to finish saving to disk or perform other necessary
                # cleanup.
                try:
                    ...
                    # Redis might have already started shutting down, in which
