...
# manually.
# Please keep the list in alphabetical order and divided into two parts:
# 1. The files that are in Angular.
# 2. The files that are in AngularJS.
