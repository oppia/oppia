...
def main() -> None:
    ...
    if (
        coverage_result.group('stmts') != '100'
        or coverage_result.group('branch') != '100'
        or coverage_result.group('funcs') != '100'
        or coverage_result.group('lines') != '100'
    ):
