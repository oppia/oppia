...
RERUN_POLICIES = {
    ...
    'additionaleditorfeatures': RERUN_POLICY_NEVER,
    ...
    'coreeditorandplayerfeatures': RERUN_POLICY_NEVER,
    'creatordashboard': RERUN_POLICY_NEVER,
    'embedding': RERUN_POLICY_NEVER,
