                            ...
                            if (
                                ...
                                if flaky_error_message in failure_log:
                                    ...
                                    try:
                                        ...
                                        # This is marked as no cover because
                                        # the exception happens due to some
                                        # processes running on the local
                                        # system, which might interfere with
                                        # the cleanup stuff. This is added as a
                                        # failsafe to make sure that even when
                                        # it throws an exception, the test is
                                        # retried.
