...
NOT_FULLY_COVERED_FILES = [
    ...
    'core/jobs/base_jobs.py',
    'core/jobs/base_jobs_test.py',
    'core/jobs/batch_jobs/validation_jobs.py',
    'core/jobs/batch_jobs/validation_jobs_test.py',
    ...
    'core/jobs/decorators/validation_decorators.py',
    'core/jobs/decorators/validation_decorators_test.py',
    'core/jobs/io/job_io.py',
    'core/jobs/io/job_io_test.py',
    'core/jobs/io/ndb_io.py',
    'core/jobs/io/ndb_io_test.py',
    'core/jobs/job_options.py',
    'core/jobs/job_options_test.py',
    'core/jobs/job_test_utils.py',
    'core/jobs/job_test_utils_test.py',
    'core/jobs/job_utils.py',
    'core/jobs/job_utils_test.py',
    'core/jobs/registry.py',
    'core/jobs/registry_test.py',
    'core/jobs/transforms/validation/auth_validation.py',
    'core/jobs/transforms/validation/auth_validation_test.py',
    'core/jobs/transforms/validation/base_validation.py',
    'core/jobs/transforms/validation/base_validation_registry.py',
    'core/jobs/transforms/validation/base_validation_registry_test.py',
    'core/jobs/transforms/validation/base_validation_test.py',
    'core/jobs/transforms/validation/blog_validation.py',
    'core/jobs/transforms/validation/blog_validation_test.py',
    'core/jobs/transforms/validation/collection_validation.py',
    'core/jobs/transforms/validation/collection_validation_test.py',
    'core/jobs/transforms/validation/config_validation.py',
    'core/jobs/transforms/validation/config_validation_test.py',
    'core/jobs/transforms/validation/exp_validation.py',
    'core/jobs/transforms/validation/exp_validation_test.py',
    'core/jobs/transforms/validation/feedback_validation.py',
    'core/jobs/transforms/validation/feedback_validation_test.py',
    'core/jobs/transforms/validation/improvements_validation.py',
    'core/jobs/transforms/validation/improvements_validation_test.py',
    ...
    'core/jobs/transforms/validation/story_validation_test.py',
    'core/jobs/transforms/validation/subtopic_validation.py',
    'core/jobs/transforms/validation/subtopic_validation_test.py',
    'core/jobs/transforms/validation/topic_validation.py',
    'core/jobs/transforms/validation/topic_validation_test.py',
    'core/jobs/transforms/validation/user_validation.py',
    'core/jobs/transforms/validation/user_validation_test.py',
    ...
    'core/jobs/types/job_run_result.py',
    'core/jobs/types/job_run_result_test.py',
