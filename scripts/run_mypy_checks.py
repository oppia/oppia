...
NOT_FULLY_COVERED_FILES = [
    ...
    'jobs/blog_validation_errors.py',
    'jobs/blog_validation_errors_test.py',
    'jobs/blog_validation_jobs.py',
    'jobs/blog_validation_jobs_test.py',
    ...
    'jobs/transforms/blog_validation.py',
    'jobs/transforms/blog_validation_test.py',
    ...
    'jobs/transforms/skill_validation.py',
    'jobs/transforms/skill_validation_test.py',
    'jobs/transforms/story_validation.py',
    'jobs/transforms/story_validation_test.py',
    'jobs/transforms/subtopic_validation.py',
    'jobs/transforms/subtopic_validation_test.py',
