...
NOT_FULLY_COVERED_FILES = [
    ...
    'core/jobs/batch_jobs/collection_info_jobs_test.py',
    'core/jobs/batch_jobs/email_deletion_jobs.py',
    'core/jobs/batch_jobs/email_deletion_jobs_test.py',
    ...
    'core/jobs/batch_jobs/mailchimp_population_jobs_test.py',
    'core/jobs/batch_jobs/math_interactions_audit_jobs.py',
    'core/jobs/batch_jobs/math_interactions_audit_jobs_test.py',
    ...
    'core/jobs/batch_jobs/story_migration_jobs_test.py',
    'core/jobs/batch_jobs/suggestion_stats_computation_jobs.py',
    'core/jobs/batch_jobs/suggestion_stats_computation_jobs_test.py',
    'core/jobs/batch_jobs/user_stats_computation_jobs.py',
    'core/jobs/batch_jobs/user_stats_computation_jobs_test.py',
    'extensions/',
