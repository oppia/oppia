...
NOT_FULLY_COVERED_FILES = [
    ...
    'core/domain/learner_group_fetchers.py',
    'core/domain/learner_group_fetchers_test.py',
    'core/domain/learner_group_services.py',
    'core/domain/learner_group_services_test.py',
