...
class BuildTests(test_utils.GenericTestBase):
    ...
    def test_generate_app_yaml_without_deploy_mode(self):
        ...
        with python_utils.open_file(mock_dev_yaml_filepath, 'w') as tmp:
            ...
            tmp.write(u'# NON DEPLOYMENT STATIC START\n')
            tmp.write(u'Test removal of non deploy section.\n')
            tmp.write(u'# NON DEPLOYMENT STATIC END\n')
            tmp.write(u'# DEPLOYMENT STATIC START\n')
            tmp.write(u'Test line 1\n')
            tmp.write(u'# DEPLOYMENT STATIC END\n')
            tmp.write(u'version: default')
            tmp.write(u'Test line 2\n')
        ...
        self.assertEqual(
            ...
            'Test removal of non deploy section.\n'
