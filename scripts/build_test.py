...
class BuildTests(test_utils.GenericTestBase):
    ...
    def test_generate_app_yaml(self):
        ...
        temp_file.name = 'app_dev.yaml'
        with open('app_dev.yaml', 'w') as tmp:
            tmp.write('Some content in app_dev.yaml')
        ...
        temp_file.close()
        checkout_cmd = 'git checkout -- app_dev.yaml'.split()
        subprocess.call(checkout_cmd)
        self.assertEqual(
            content,
            '# THIS FILE IS AUTOGENERATED, DO NOT MODIFY\n'
            'Some content in app_dev.yaml')
