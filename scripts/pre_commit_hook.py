...
KEYS_UPDATED_IN_CONSTANTS = [
    ...
    'FIREBASE_CONFIG_DATABASE_URL', 'FIREBASE_CONFIG_MESSAGING_SENDER_ID',
    'FIREBASE_CONFIG_PROJECT_ID', 'FIREBASE_CONFIG_STORAGE_BUCKET',
    'FIREBASE_CONFIG_GOOGLE_CLIENT_ID', 'FIREBASE_EMULATOR_ENABLED']
