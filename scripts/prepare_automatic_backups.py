...
def generate_backup_url(cloud_storage_bucket_name, module_class_names):
    ...
    Args:
      arg1: str. Name of cloud storage bucket name.
      arg2: list. List of contaning modules class names.
...
def update_cron_dict(cron_dict):
    ...
    Args:
      arg1: dictionary. Content of yaml file in dictionary type. 
    """
    sys_args = sys.argv
...
def save_cron_dict(cron_dict):
    ...
    Args:
      arg1: dictionary. It is the content of updated yaml file.
    """
