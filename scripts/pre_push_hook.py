    ...
    def __enter__(self) -> None:
        if not self.is_same_branch:
            try:
                ...
                print(
                    '\nCould not change branch to %s. This is most probably because you are in a dirty state. Change manually to the branch that is being linted or stash your changes.'
                    % self.new_branch
                )
                sys.exit(1)
