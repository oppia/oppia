...
class ChangedBranch(object):
    """Class contaning methods for changing branch in which modified file is present by passing
    new branch name. It does not change branch when you are in dirty state.
    """
