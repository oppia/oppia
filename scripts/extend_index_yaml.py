...
XmlIndexesDict = Dict[str, Dict[str, List[Dict[str, Union[str, Dict[str, str],
                                                          List[Dict[str, str]]]]]]]
YamlIndexesDict = Dict[str, List[Dict[str, Union[str, Dict[str, str],
                                                 List[Dict[str, str]]]]]]

INDEX_YAML_PATH = os.path.join(os.getcwd(), 'index.yaml')
WEB_INF_INDEX_XML_PATH = os.path.join(
    os.getcwd(), os.pardir, 'cloud_datastore_emulator_cache', 'WEB-INF',
...
def reformat_xml_dict_into_yaml_dict(
    ...
    for xml_index in xml_dict['datastore-indexes']['datastore-index']:
        ...
        yaml_index_entries.append({
            'kind': xml_index['@kind'],
            'properties': yaml_index_properties
        })

    return {
        'indexes': yaml_index_entries
    }
