...
def _normalize_directory_name(directory_name):
    ...
    the same python installation but their names are not the same. To make sure
    these two directory names are considered equal, we use this method to
    enforce that all directory names are lowercase.
