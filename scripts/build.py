...
def generate_app_yaml(is_prod_mode=False):
    ...
    """
    APP_YAML_LOCAL_FILEPATH = APP_DEV_YAML_FILEPATH
    if is_prod_mode:
        APP_YAML_LOCAL_FILEPATH = APP_PROD_YAML_FILEPATH
    prod_file_prefix = 'build/'
    content = '# THIS FILE IS AUTOGENERATED, DO NOT MODIFY\n'
    with python_utils.open_file(APP_YAML_LOCAL_FILEPATH, 'r') as yaml_file:
