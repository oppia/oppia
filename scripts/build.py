...
def inject_angular_css_hashes() -> None:
    ...
    styles.{hash}.css and vendor-styles.{hash}.css files generated by Angular
    CLI, then updates all HTML files in backend_prod_files/webpack_bundles/
    to reference the correct hashed filenames. It also updates
    assets/hashes.json to include Angular CSS hashes for frontend cache
    invalidation.
    ...
    # Find the hashed styles files generated by Angular CLI.
    ...
    if len(vendor_styles_files) == 1:
        ...
        print(
            'Found Angular vendor styles file: %s'
    ...
    if hash_match:
        ...
        print(
            'Warning: Could not extract hash from %s' % hashed_styles_filename
        )
