...
def generate_app_yaml(deploy_mode: bool = False) -> None:
    ...
    content = content.replace(
        'static_dir: dist/oppia-angular/assets/ckeditor\n',
        'static_dir: dist/oppia-angular-prod/assets/ckeditor\n',
    )
    content = content.replace(
        'static_dir: dist/oppia-angular/assets/ckeditor-bootstrapck\n',
        'static_dir: dist/oppia-angular-prod/assets/ckeditor-bootstrapck\n',
    )
