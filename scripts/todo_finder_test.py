...
class TodoFinderTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        open('dummy_directory/dist/file4.txt', 'w', encoding='utf-8').close()
    ...
    def test_should_exclude_bad_files(self) -> None:
        search_files = todo_finder.get_search_files('dummy_directory')
        self.assertIn('dummy_directory/file1.txt', search_files)
        self.assertIn('dummy_directory/file2.txt', search_files)
        self.assertNotIn('dummy_directory/dist/file3.txt', search_files)
        self.assertNotIn('dummy_directory/dist/file4.txt', search_files)

    def test_get_all_todos(self) -> None:
        todos = todo_finder.get_todos('dummy_directory')
        expected_todos = [
            {
            ...
            {
                'file_path': 'dummy_directory/file2.txt',
    ...
    def test_get_all_correctly_formatted_todos(self) -> None:
        todos = todo_finder.get_todos('dummy_directory')
        correctly_formatted_todos = todo_finder.get_correctly_formated_todos(
            todos
        )
        ...
        self.assertItemsEqual(
            correctly_formatted_todos, expected_correctly_formated_todos
        )
