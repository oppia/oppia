...
echo Checking if Pillow is installed in $GAE_THIRD_PARTY_LIB_DIR
if [ ! -d "$GAE_THIRD_PARTY_LIB_DIR/Pillow-6.0.0" ]; then
  echo Installing Pillow

  pip_install Pillow==6.0.0 --target="$GAE_THIRD_PARTY_LIB_DIR/Pillow-6.0.0"
