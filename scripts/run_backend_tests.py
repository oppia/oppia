...
_EXCLUSIVE_GROUP.add_argument(
    '--test_targets', help='optional dotted module name of the test(s) to run', type=str
)
_EXCLUSIVE_GROUP.add_argument(
    '--test_path',
        ...
        if not task.finished:
            ...
            try:
                if not tests_failed_regex_match:
                    raise Exception(
                        'The error message did not match ' 'tests_failed_regex_match'
                    )
...
def main(args: Optional[List[str]] = None) -> None:
    ...
    if parsed_args.generate_coverage_report:
        ...
        if coverage != 100:
            ...
            print('For more information, please see our ' 'backend tests wiki page:')
            print(
