...
from core import (  # isort:skip  pylint: disable=wrong-import-position, wrong-import-order
    feconf,
    utils,
)

from . import (  # isort:skip  pylint: disable=wrong-import-position, wrong-import-order
    common,
...
class TestingTaskSpec:
    ...
    def __init__(
        self, test_target: str, generate_coverage_report: bool
    ) -> None:
    ...
    with contextlib.ExitStack() as stack:
        ...
        for test_target in all_test_targets:
            ...
            task = concurrent_task_utils.create_task(
                ...
                errors_to_retry_on=[ERROR_RETRY_CODE],
            )
