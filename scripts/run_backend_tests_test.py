...
class RunBackendTestsTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.swap_logs = mock.patch.object(
            concurrent_task_utils, 'log', mock_log
        )
    ...
    def test_duplicate_test_files_in_shards_throws_error(self) -> None:
        ...
        swap_shard_modules = mock.patch.object(
    ...
    def test_module_not_in_shards_throws_error(self) -> None:
        ...
        swap_test_modules = mock.patch.object(
            run_backend_tests,
    ...
    def test_tests_in_load_tests_dir_are_not_included_when_flag_is_passed(
        ...
        self.assertNotIn(
            os.path.join(_LOAD_TESTS_DIR, 'new_test.py'), test_modules
        )
    ...
    def test_tests_failed_due_to_internal_error(self) -> None:
        ...
        with self.print_patch, self.assertRaisesRegex(
    ...
    def test_successfull_test_run_message_is_printed_correctly(self) -> None:
        ...
        self.assertIn(
            'SUCCESS   %s: 9 tests (2.5 secs)' % task2_target, self.print_arr
        )
    ...
    def test_successful_test_run_with_generate_time_report_flag(self) -> None:
        ...
        swap_time_report_path = mock.patch.object(
    ...
    def test_invalid_directory_in_sys_path_throws_error(self) -> None:
        ...
        swap_path_exists = mock.patch.object(
    ...
    def test_successful_test_run_with_run_on_changed_files_in_branch_flag(
        ...
        get_changed_python_test_files_patch = mock.patch.object(
            git_changes_utils,
    ...
    def test_backend_tests_with_run_on_changed_files_in_branch_no_remote(
        ...
        with get_remote_name_patch, self.swap_redis_server:
            with self.swap_cloud_datastore_emulator, self.assertRaisesRegex(
    ...
    def test_failure_to_combine_coverage_report_throws_error(self) -> None:
        ...
        swap_subprocess_run = mock.patch.object(
    ...
    def test_failure_to_run_test_tasks_throws_error(self) -> None:
        ...
        swap_run_shell_cmd = mock.patch.object(
            run_backend_tests, 'run_shell_cmd', mock_run_shell_cmd
        )
        swap_hostname = mock.patch.object(
            socket, 'gethostname', lambda: 'IamEzio'
        )
        swap_getpid = mock.patch.object(os, 'getpid', lambda: 12345)
    ...
    def test_convert_args_to_pytest_with_test_shard(self) -> None:
        ...
        swap_check_shards = mock.patch.object(
            run_backend_tests,
            'check_shards_match_tests',
            mock_check_shards_match_tests,
        )
        swap_get_shard_tests = mock.patch.object(
            run_backend_tests,
    ...
    def test_convert_args_to_pytest_with_run_on_changed_files(self) -> None:
        ...
        swap_changed_files = mock.patch.object(
            git_changes_utils,
            'get_changed_python_test_files',
    ...
    def test_main_with_use_pytest_uses_correct_emulator_context(self) -> None:
        ...
        swap_redis = mock.patch.object(
            servers, 'managed_redis_server', mock_redis_server
        )
        swap_datastore = mock.patch.object(
            servers,
