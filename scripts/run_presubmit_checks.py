...
_PARSER = argparse.ArgumentParser(
    description='Run this script from the oppia root folder prior to opening a '
    'PR: '
    ...
    '- Javascript and Python Linting '
    '- Backend Python tests '
    'Only when frontend files are changed will it run Frontend Karma unit '
    'tests. '
    'If any of these tests result in errors, this script will terminate. '
    'Note: The test scripts are arranged in increasing order of time taken. '
    'This enables a broken build to be detected as quickly as possible.')
