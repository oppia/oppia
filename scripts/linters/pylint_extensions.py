...
class SingleLineCommentChecker(checkers.BaseChecker):  # type: ignore[misc]
    ...
    msgs = {
        ...
        'C0040': (
            ...
            'Inline comments should start with an allowed inline pragma.',
        ),
    }
    options = (
        (
...
class SingleLinePragmaChecker(checkers.BaseChecker):  # type: ignore[misc]
    ...
    msgs = {
        'C0028': (
            ...
            'single-line-pragma',
            'Use pylint pragmas to disable a rule for a single line only',
        )
    }
...
class TypeIgnoreCommentChecker(checkers.BaseChecker):  # type: ignore[misc]
    ...
    msgs = {
        ...
        'C0050': (
            ...
            'A limited number of type ignores are allowed in the codebase.',
        ),
        'C0051': (
