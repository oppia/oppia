    ...
    * Check that all explicitly raised exceptions in a function are documented
    ...
    def visit_raise(self, node):
        ...
        if not func_node.doc:
            ...
            _property = docstrings_checker.get_setters_property(func_node)
            if _property:
                func_node = _property
...
class SnakeCaseForDictionaryKeysChecker(checkers.BaseChecker):
    """Checks if dictionary keys follow snake_case naming style."""
    ...
    msgs = {
        'C0027': (
            ...
            'snake-case-violated-for-dictionary-keys',
    ...
    def visit_subscript(self, node):
        ...
        # Only consider the actual unicode strings for checking snake_case.
        if key_string[0] == 'u':
            ...
            if snake_case_followed is False:
                self.add_message('snake-case-violated-for-dictionary-keys',
                                 node=node)
