...
_PARSER.add_argument(
    ...
    help='specific file extensions to be linted. Space separated list. If either of js or ts used then both js and ts files will be linted.',
    action='store',
)
...
def _get_filepaths_from_non_other_shard(
    ...
    if len(filepaths) != len(set(filepaths)):
        ...
        raise AssertionError(  # pragma: no cover
            'There is a file duplicated across shards. We should have been able to find it but failed.'
        )
    return filepaths
