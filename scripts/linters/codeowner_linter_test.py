...
class CodeownerLinterTests(test_utils.LinterTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.listdir_swap_file_with_blanket_codeowner_only = self.swap(
    ...
    def test_missing_important_codeowner_path_from_list(self) -> None:
        ...
        self.assert_same_list_elements(
            [
                'Rule /.github/stale.yml is not present in the CODEOWNER_IMPORTANT_PATHS list in scripts/linters/codeowner_linter.py. Please add this rule in the mentioned list or remove this rule from the \'Critical files\' section.'
            ],
    ...
    def test_check_codeowner_file_without_full_file_path(self) -> None:
        ...
        self.assert_same_list_elements(
            [
                'Pattern on line 18 is invalid. Use full path relative to the root directory'
            ],
            lint_task_report.trimmed_messages,
        )
        self.assertEqual('CODEOWNERS', lint_task_report.name)
