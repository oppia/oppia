...
VALID_STYLE_INDENTATION_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'valid_style_indentation.html')
...
VALID_QUOTES_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'valid_quotes.html')
INVALID_ALIGNMENT_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'invalid_alignment_of_tags.html')
VALID_ALIGNMENT_HTML_FILEPATH: Final = os.path.join(LINTER_TESTS_DIR, 'valid_alignment_of_tags.html')
...
class CustomHTMLParserTests(test_utils.LinterTestBase):
    ...
    def test_custom_linter_with_invalid_style_indentation(self) -> None:
        ...
        self.assert_same_list_elements(
            ['invalid_style_indentation.html --> Expected indentation of 6, found indentation of 4 for content of style tag on line 7'],
    ...
    def test_custom_linter_with_valid_style_indentation(self) -> None:
        lint_task_report = html_linter.HTMLLintChecksManager([VALID_STYLE_INDENTATION_HTML_FILEPATH], FILE_CACHE).check_html_tags_and_attributes()
    ...
    def test_custom_linter_with_invalid_indentation(self) -> None:
        ...
        self.assert_same_list_elements(
            ['Expected indentation of 10, found indentation of 12 for classroom-page tag on line 14'],
            lint_task_report.trimmed_messages,
        )
        self.assertEqual('HTML tag and attribute', lint_task_report.name)
        self.assertTrue(lint_task_report.failed)
    ...
    def test_custom_linter_with_invalid_quotes(self) -> None:
        ...
        self.assert_same_list_elements(
            ['The value color:white; of attribute style for the tag content on line 12 should be enclosed within double quotes.'],
            lint_task_report.trimmed_messages,
        )
        self.assertEqual('HTML tag and attribute', lint_task_report.name)
        self.assertTrue(lint_task_report.failed)
    ...
    def test_custom_linter_with_invalid_alignment(self) -> None:
        ...
        self.assert_same_list_elements(
            ['Attribute for tag content on line 13 should align with the leftmost attribute on line 12'],
            lint_task_report.trimmed_messages,
        )
        self.assertEqual('HTML tag and attribute', lint_task_report.name)
        self.assertTrue(lint_task_report.failed)
    ...
    def test_custom_linter_with_valid_alignment(self) -> None:
        lint_task_report = html_linter.HTMLLintChecksManager([VALID_ALIGNMENT_HTML_FILEPATH], FILE_CACHE).check_html_tags_and_attributes()
        self.assertEqual(
            ['SUCCESS  HTML tag and attribute check passed'],
            lint_task_report.get_report(),
        )
    ...
    def test_custom_linter_with_mismatched_indentation(self) -> None:
        ...
        self.assert_same_list_elements(
            ['Indentation for end tag content on line 18 does not match the indentation of the start tag content on line 12'],
            lint_task_report.trimmed_messages,
        )
        self.assertEqual('HTML tag and attribute', lint_task_report.name)
        self.assertTrue(lint_task_report.failed)
    ...
    def test_third_party_linter_without_lint_errors(self) -> None:
        lint_task_report = html_linter.ThirdPartyHTMLLintChecksManager([VALID_QUOTES_HTML_FILEPATH]).lint_html_files()
    ...
    def test_trimmed_output_false_branch(self) -> None:
        fake_linter_output = '/path/to/file/invalid_quotes.html: line 10, col 20, line contains trailing whitespace\nsome unrelated line\nnot empty last line'
    ...
    def test_check_space_between_attributes_and_values_false(self) -> None:
        ...
        parser = html_linter.CustomHTMLParser(filepath='dummy.html', file_lines=file_lines, failed=False)
