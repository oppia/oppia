    ...
    def _check_ts_ignore(self):
        ...
        for file_path in self.all_filepaths:
            ...
            for line_number, line in enumerate(file_content.split('\n')):
                if (previous_line_has_ts_ignore and
                        not file_path.endswith('comment-checker.js')):
                ...
                if (
                        ...
                        not previous_line_has_comment_with_ts_error and
                        not file_path.endswith('comment-checker.js')):
                    failed = True
                    error_message = (
            ...
            for line_number, line in enumerate(file_content.split('\n')):
                if re.findall(ts_expect_error_pattern, line):
                    if not (
                            ...
                            file_path.endswith('Spec.ts') or
                            file_path.endswith('comment-checker.js')):
                        failed = True
                        error_message = (
                    ...
                    if (not previous_line_has_comment_with_ts_error and
                            not file_path.endswith('comment-checker.js')):
                        failed = True
                        error_message = (
