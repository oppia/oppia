...
FILES_CONTAIN_UNKNOWN_TYPE: Final = [
    ...
    'core/templates/base-components/warnings-and-alerts.component.spec.ts',
    'core/templates/components/ck-editor-helpers/ck-editor-4-widgets.initializer.ts',
    'core/templates/components/code-mirror/codemirror.component.spec.ts',
    ...
    'core/templates/components/on-screen-keyboard/on-screen-keyboard.component.spec.ts',
    'core/templates/components/question-directives/modal-templates/remove-question-skill-link-modal.comonent.spec.ts',
    ...
    'core/templates/components/state-editor/state-skill-editor/state-skill-editor.component.spec.ts',
    'core/templates/directives/mathjax.directive.spec.ts',
    'core/templates/domain/exploration/LostChangeObjectFactory.ts',
    ...
    'core/templates/pages/blog-dashboard-page/blog-card/blog-card.component.spec.ts',
    'core/templates/pages/blog-dashboard-page/blog-dashboard-page.component.spec.ts',
    'core/templates/pages/blog-dashboard-page/navbar/navbar-breadcrumb/blog-dashboard-navbar-breadcrumb.component.spec.ts',
    'core/templates/pages/blog-dashboard-page/navbar/navbar-pre-logo-action/blog-post-editor-pre-logo-action.component.spec.ts',
    'core/templates/pages/blog-dashboard-page/services/blog-dashboard-page.service.spec.ts',
    ...
    'core/templates/pages/topic-editor-page/modal-templates/preview-thumbnail.component.spec.ts',
    ...
    'extensions/interactions/CodeRepl/directives/oppia-short-response-code-repl.component.spec.ts',
    ...
    'extensions/interactions/SetInput/directives/oppia-response-set-input.component.spec.ts',
    'extensions/interactions/SetInput/directives/oppia-short-response-set-input.component.ts',
    'extensions/objects/templates/allowed-variables-editor.component.spec.ts',
    'extensions/objects/templates/coord-two-dim-editor.component.spec.ts',
    'extensions/objects/templates/fraction-editor.component.ts',
    ...
    'extensions/objects/templates/sanitized-url-editor.component.ts',
    'extensions/objects/templates/set-of-algebraic-identifier-editor.component.ts',
    'extensions/objects/templates/set-of-unicode-string-editor.component.ts',
