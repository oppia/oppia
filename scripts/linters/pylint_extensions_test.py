...
class DocstringParameterCheckerTests(unittest.TestCase):
    ...
    def test_excessive_newline_below_class_docstring(self) -> None:
        node_excessive_newline_below_class_docstring = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
    ...
    def test_inline_comment_after_class_docstring(self) -> None:
        node_inline_comment_after_class_docstring = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
    ...
    def test_multiline_class_argument_with_correct_style(self) -> None:
        node_multiline_class_argument_with_correct_style = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
    ...
    def test_newline_before_docstring_with_correct_style(self) -> None:
        node_newline_before_docstring_with_correct_style = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
    ...
    def test_malformed_returns_section(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='malformed-returns-section', node=node_malformed_returns_section
        )
    ...
    def test_malformed_yields_section(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='malformed-yields-section', node=node_malformed_yields_section
        )
    ...
    def test_malformed_raises_section(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='malformed-raises-section', node=node_malformed_raises_section
        )
    ...
    def test_two_lines_empty_docstring_raise_correct_message(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='single-line-docstring-span-two-lines', node=node_with_docstring
        )
    ...
    def test_no_period_at_end_of_a_multiline_docstring(self) -> None:
        ...
        with self.checker_test_object.assertAddsMessages(
            no_period_at_end_message, malformed_args_message, ignore_position=True
        ):
            self.checker_test_object.checker.visit_functiondef(node_no_period_at_end)
    ...
    def test_no_newline_above_args(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='single-space-above-args', node=node_single_newline_above_args
        )
    ...
    def test_no_newline_above_raises(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='single-space-above-raises', node=node_single_newline_above_raises
        )
    ...
    def test_no_newline_above_return(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='single-space-above-returns', node=node_with_no_space_above_return
        )
    ...
    def test_varying_combination_of_newline_above_args(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='single-space-above-raises', node=node_newline_above_args_raises
        )
        ...
        message = testutils.MessageTest(
            msg_id='single-space-above-returns', node=node_newline_above_args_returns
        )
        ...
        message = testutils.MessageTest(
            msg_id='single-space-above-raises', node=node_newline_above_returns_raises
        )
    ...
    def test_malformed_parameter_docstring(self) -> None:
        ...
        with self.checker_test_object.assertAddsMessages(
            malformed_raises_message, malformed_raises_message, ignore_position=True
        ):
    ...
    def test_finds_docstring_parameter(self) -> None:
        ...
        with self.checker_test_object.assertAddsMessages(
            testutils.MessageTest(
                msg_id='redundant-returns-doc', node=missing_yield_type_func_node
            ),
            ignore_position=True,
        ):
            self.checker_test_object.checker.visit_functiondef(
        ...
        with self.checker_test_object.assertAddsMessages(
            ...
            testutils.MessageTest(
                msg_id='missing-yield-type-doc', node=missing_yield_type_func_node
            ),
            ignore_position=True,
        ):
        ...
        with self.checker_test_object.assertAddsMessages(
            testutils.MessageTest(
                msg_id='redundant-yields-doc', node=missing_return_type_func_node
            ),
            ignore_position=True,
        ):
            self.checker_test_object.checker.visit_functiondef(
        ...
        with self.checker_test_object.assertAddsMessages(
            ...
            testutils.MessageTest(
                msg_id='missing-return-type-doc', node=missing_return_type_func_node
            ),
            ignore_position=True,
        ):
    ...
    def test_visit_raise_warns_unknown_style(self) -> None:
        ...
        with self.checker_test_object.assertAddsMessages(
            testutils.MessageTest(
                msg_id='missing-raises-doc', args=('RuntimeError',), node=func_node
            ),
            ignore_position=True,
        ):
...
class TypeIgnoreCommentCheckerTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.checker_test_object.setup_method()
        self.checker_test_object.checker.config.allowed_type_ignore_error_codes = (
    ...
    def test_type_ignore_used_without_comment_raises_error(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='mypy-ignore-used', line=2, node=node_function_with_type_ignore_only
        )
        with self.checker_test_object.assertAddsMessages(message):
    ...
    def test_raises_error_if_prohibited_error_code_is_used_in_combined_form(
        ...
        node_with_prohibited_error_code_in_combined_form = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
    ...
    def test_raises_error_if_type_ignore_is_in_second_place(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='mypy-ignore-used', line=2, node=node_with_type_ignore
        )
        with self.checker_test_object.assertAddsMessages(message):
    ...
    def test_raises_error_if_gap_in_ignore_and_comment_is_more_than_fifteen(
        ...
        node_with_ignore_and_more_than_fifteen_gap = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
    ...
    def test_generic_type_ignore_raises_pylint_error(self) -> None:
        ...
        message2 = testutils.MessageTest(
            msg_id='redundant-type-comment', line=2, node=node_with_generic_type_ignore
        )
...
class ExceptionalTypesCommentCheckerTests(unittest.TestCase):
    ...
    def test_raises_error_if_exceptional_types_are_used_without_comment(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='any-type-used', line=2, node=node_with_any_type
        )
        with self.checker_test_object.assertAddsMessages(message):
        ...
        message = testutils.MessageTest(
            msg_id='object-class-used', line=2, node=node_with_object_type
        )
        with self.checker_test_object.assertAddsMessages(message):
        ...
        message = testutils.MessageTest(
            msg_id='cast-func-used', line=2, node=node_with_cast_method
        )
        with self.checker_test_object.assertAddsMessages(message):
    ...
    def test_raises_error_if_exceptional_types_are_combined_in_module(self) -> None:
        ...
        message1 = testutils.MessageTest(
            msg_id='any-type-used', line=2, node=node_with_combined_types
        )
        message2 = testutils.MessageTest(
            msg_id='object-class-used', line=6, node=node_with_combined_types
        )
        message3 = testutils.MessageTest(
            msg_id='cast-func-used', line=18, node=node_with_combined_types
        )
    ...
    def test_raises_error_if_any_type_used_in_function_signature(self) -> None:
        ...
        message = testutils.MessageTest(
            msg_id='any-type-used', line=2, node=node_with_any_type_arg
        )
        with self.checker_test_object.assertAddsMessages(message):
        ...
        message = testutils.MessageTest(
            msg_id='any-type-used', line=2, node=node_with_any_type_return
        )
        with self.checker_test_object.assertAddsMessages(message):
        ...
        message = testutils.MessageTest(
            msg_id='any-type-used', line=2, node=node_with_any_type_return_and_args
        )
        with self.checker_test_object.assertAddsMessages(message):
            self.checker_test_object.checker.visit_module(
        ...
        message = testutils.MessageTest(
            msg_id='any-type-used', line=2, node=node_with_multiple_any_type_functions
        )
        message2 = testutils.MessageTest(
            msg_id='any-type-used', line=8, node=node_with_multiple_any_type_functions
        )
    ...
    def test_any_and_cast_will_not_raise_error_in_import(self) -> None:
        ...
        node_with_any_and_cast_in_multi_line_import = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
    ...
    def test_raises_error_if_gap_between_type_and_comment_is_more_than_fifteen(
        ...
        node_with_object_and_more_than_expected_gap = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
        ...
        node_with_object_and_less_than_fifteen_gap = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
...
class SingleLineCommentCheckerTests(unittest.TestCase):
    ...
    def test_inline_comment_with_allowed_pragma_raises_no_error(self) -> None:
        ...
        self.checker_test_object.checker.process_tokens(
            pylint_utils.tokenize_module(node_inline_comment_with_allowed_pragma)
        )
    ...
    def test_inline_comment_with_invalid_pragma_raises_error(self) -> None:
        ...
        self.checker_test_object.checker.process_tokens(
            pylint_utils.tokenize_module(node_inline_comment_with_invalid_pragma)
        )
...
class SingleLinePragmaCheckerTests(unittest.TestCase):
    ...
    def test_enable_single_line_pragma_for_multiline(self) -> None:
        node_enable_single_line_pragma_for_multiline = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
        ...
        self.checker_test_object.checker.process_tokens(
            pylint_utils.tokenize_module(node_enable_single_line_pragma_for_multiline)
        )
    ...
    def test_enable_single_line_pragma_with_invalid_name(self) -> None:
        node_enable_single_line_pragma_with_invalid_name = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
    ...
    def test_no_and_extra_space_before_pylint(self) -> None:
        node_no_and_extra_space_before_pylint = astroid.scoped_nodes.Module(
            name='test', doc='Custom test'
        )
        temp_file = tempfile.NamedTemporaryFile()
        filename = temp_file.name
...
class SingleSpaceAfterKeyWordCheckerTests(unittest.TestCase):
    ...
    def test_no_space_after_keyword(self) -> None:
        ...
        with self.checker_test_object.assertAddsMessages(
            if_message, elif_message, while_message, yield_message, if_exp_message
        ):
            temp_file.close()
...
class DisallowedFunctionsCheckerTests(unittest.TestCase):
    ...
    def test_disallowed_removals_regex(self) -> None:
        (
            self.checker_test_object.checker.config.disallowed_functions_and_replacements_regex
