...
class HangingIndentCheckerTests(unittest.TestCase):
    ...
    def test_no_break_after_hanging_indentation(self) -> None:
        ...
        with open(filename, 'w', encoding='utf-8') as tmp:
            tmp.write("""self.post_json('/some/\\url',
    ...
    def test_hanging_indentation_with_a_comment_after_bracket(self) -> None:
        ...
        filename = temp_file.name
        with open(filename, 'w', encoding='utf-8') as tmp:
            tmp.write("""self.post_json(  # Random comment
                '(',
                self.payload, expect_errors=True, expected_status_int=401)""")
        node_with_no_error_message.file = filename
        node_with_no_error_message.path = filename
    ...
    def test_hanging_indentation_with_a_comment_after_two_or_more_bracket(
        ...
        filename = temp_file.name
        with open(filename, 'w', encoding='utf-8') as tmp:
            tmp.write("""self.post_json(func(  # Random comment
                '(',
                self.payload, expect_errors=True, expected_status_int=401))""")
        node_with_no_error_message.file = filename
        node_with_no_error_message.path = filename
...
class DocstringParameterCheckerTests(unittest.TestCase):
    ...
    def test_malformed_args_section(self) -> None:
        node_malformed_args_section = astroid.extract_node("""def func(arg): #@
                \"\"\"Does nothing.
    ...
    def test_malformed_returns_section(self) -> None:
        node_malformed_returns_section = astroid.extract_node("""def func(): #@
                \"\"\"Return True.
    ...
    def test_malformed_yields_section(self) -> None:
        node_malformed_yields_section = astroid.extract_node("""def func(): #@
                \"\"\"Yield true.
    ...
    def test_malformed_raises_section(self) -> None:
        node_malformed_raises_section = astroid.extract_node("""def func(): #@
                \"\"\"Raise an exception.
    ...
    def test_well_formated_args_argument(self) -> None:
        node_with_no_error_message = astroid.extract_node("""def func(*args): #@
                \"\"\"Does nothing.
    ...
    def test_well_formated_args_section(self) -> None:
        node_with_no_error_message = astroid.extract_node("""def func(arg): #@
                \"\"\"Does nothing.
    ...
    def test_well_formated_returns_section(self) -> None:
        node_with_no_error_message = astroid.extract_node("""def func(): #@
                \"\"\"Does nothing.
    ...
    def test_space_after_docstring(self) -> None:
        node_space_after_docstring = astroid.extract_node("""def func():
                    \"\"\" Hello world.\"\"\"
                    Something
        """)
    ...
    def test_two_lines_empty_docstring_raise_correct_message(self) -> None:
        node_with_docstring = astroid.extract_node("""def func():
                    \"\"\"
                    \"\"\"
                    pass
        """)
    ...
    def test_no_period_at_end(self) -> None:
        node_no_period_at_end = astroid.extract_node("""def func(): #@
                    \"\"\"This is a docstring\"\"\"
                    Something
        """)
    ...
    def test_empty_line_before_end_of_docstring(self) -> None:
        node_empty_line_before_end = astroid.extract_node("""def func(): #@
                    \"\"\"This is a docstring.
    ...
    def test_no_period_at_end_of_a_multiline_docstring(self) -> None:
        node_no_period_at_end = astroid.extract_node("""def func(arg): #@
                    \"\"\"This is a docstring.
    ...
    def test_no_newline_at_end_of_multi_line_docstring(self) -> None:
        node_no_newline_at_end = astroid.extract_node("""def func(arg): #@
                    \"\"\"This is a docstring.
    ...
    def test_no_newline_above_return(self) -> None:
        node_with_no_space_above_return = astroid.extract_node("""def func(): #@
                \"\"\"Returns something.
                Returns:
    ...
    def test_excessive_newline_above_args(self) -> None:
        node_with_two_newline = astroid.extract_node("""def func(arg): #@
                    \"\"\"Returns something.
    ...
    def test_return_in_comment(self) -> None:
        node_with_return_in_comment = astroid.extract_node("""def func(arg): #@
                    \"\"\"Returns something.
    ...
    def test_function_with_no_args(self) -> None:
        node_with_no_args = astroid.extract_node("""def func():
                \"\"\"Do something.\"\"\"
    ...
    def test_malformed_parameter_docstring(self) -> None:
        invalid_parameter_name = astroid.extract_node("""def func(arg): #@
                    \"\"\"This is a docstring.
...
class SingleLineCommentCheckerTests(unittest.TestCase):
    ...
    def test_inline_comment_with_multiple_allowed_pragmas_raises_no_error(
        ...
        with open(filename, 'w', encoding='utf-8') as tmp:
            tmp.write("""a = 1 + 2  # isort:skip # pylint: ignore[some-rule]
                """)
