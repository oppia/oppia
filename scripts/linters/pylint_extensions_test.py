...
class DisallowedFunctionsCheckerTests(unittest.TestCase):
    ...
    def test_disallowed_removals_str(self) -> None:
        (
            self.checker_test_object.checker.config.disallowed_functions_and_replacements_str  # pylint: disable=line-too-long
        ) = [
            'example_func',
            'a.example_attr',
        ]
    ...
    def test_disallowed_removals_regex(self) -> None:
        (
            self.checker_test_object.checker.config.disallowed_functions_and_replacements_regex  # pylint: disable=line-too-long
...
class PreventStringConcatenationCheckerTests(unittest.TestCase):
    ...
    def test_does_not_encourage_string_interpolation_for_one_side_string_concatenation(  # pylint: disable=line-too-long
        self,
    ) -> None:
        node = astroid.extract_node(
            """
