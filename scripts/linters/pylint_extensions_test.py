...
class DocstringParameterCheckerTests(unittest.TestCase):
    ...
    def test_excessive_newline_above_args(self) -> None:
        ...
        with self.checker_test_object.assertAddsMessages(
            ...
            single_space_above_yields_message, ignore_position=True
        ):
            self.checker_test_object.checker.visit_functiondef(
    ...
    def test_invalid_description_indentation_docstring(self) -> None:
        ...
        with self.checker_test_object.assertAddsMessages(
            ...
            malformed_raises_message, ignore_position=True
        ):
            self.checker_test_object.checker.visit_functiondef(
...
class NoBlankLineAfterFunctionDefCheckerTests(unittest.TestCase):
    ...
    def test_function_with_blank_line_after_function_definition_with_docs(
        self
    ) -> None:
        node = astroid.extract_node(
    ...
    def test_function_with_no_blank_line_after_function_definition_and_no_docs(
        self
    ) -> None:
        ...
        with utils.open_file(filename, 'w') as tmp:
            tmp.write(
                u"""def add3(first: int, second: int) -> int:
                        return first+second
                """
            )
        node.file = filename
    ...
    def test_function_with_no_blank_line_after_function_definition_and_docs(
        ...
        with utils.open_file(filename, 'w') as tmp:
            tmp.write(
                u"""
                    def add4(first: int, second: int) -> int:
                        \"\"\" This a docstring.\"\"\"
                        return first+second
                """
            )
