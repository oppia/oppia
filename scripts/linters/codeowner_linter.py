...
class CodeownerLintChecksManager(linter_utils.BaseLinter):
    ...
    def _check_for_important_patterns_at_bottom_of_codeowners(
        ...
        critical_rule_section_minus_list_set = important_patterns_set.difference(
            codeowner_important_paths_set
        )
        list_minus_critical_rule_section_set = codeowner_important_paths_set.difference(
            important_patterns_set
        )
