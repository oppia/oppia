...
class Distribution:
    ...
    def __init__(
        self, library_name: str, version_string: str, metadata_dict: Dict[str, str]
    ) -> None:
...
class InstallBackendPythonLibsTests(test_utils.GenericTestBase):
    ...
    INVALID_GIT_REQUIREMENTS_TEST_TXT_FILE_PATH = os.path.join(
        THIRD_PARTY_DATA_DIRECTORY_FILE_PATH, 'invalid_git_requirements_test.txt'
    )
        ...
        self.assertEqual(
            ...
            [[
             ...
             [
                 ...
                 '--target', common.THIRD_PARTY_PYTHON_LIBS_DIR, '--no-dependencies',
                 '-r', common.COMPILED_REQUIREMENTS_FILE_PATH, '--upgrade'
             ]]
        )
    ...
    def test_library_change_or_addition_runs_correct_commands(self) -> None:
        ...
        def mock_get_mismatches() -> install_python_prod_dependencies.MismatchType:
            return {
                ...
                'git-dep2': (self.get_git_version_string('git-dep2', 'a'), None),
            }
    ...
    def test_library_version_change_is_handled_correctly(self) -> None:
        directory_names = [
            ...
            'webencodings', 'flask', 'flask-1.1.1.dist-info', 'flask-10.0.1.dist-info',
            'six', 'six-1.16.0.dist-info', 'six-10.13.0.egg-info',
        ...
        self.assertItemsEqual(
            paths_to_delete, [
                'flask-10.0.1.dist-info', 'webencodings-1.0.1.dist-info',
                'six-10.13.0.egg-info', 'google_cloud_datastore-1.13.0.dist-info'
            ]
        )
    ...
    def test_pip_install_with_import_error_and_darwin_os(self) -> None:
        ...
        try:
            ...
            with os_name_swap, self.print_swap, self.swap_check_call:
                with self.assertRaisesRegex(
                    ImportError, 'Error importing pip: import of pip halted; '
                    'None in sys.modules'
                ):
