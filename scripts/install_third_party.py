...
NG_DRAGGABLE_REV = '0.1.8'
NG_DRAGGABLE_ZIP_URL = (
    'https://github.com/fatlinesofcode/ngDraggable/archive/%s.zip' %
    NG_DRAGGABLE_REV)
NG_DRAGGABLE_ZIP_ROOT_NAME = 'ngDraggable-%s' % NG_DRAGGABLE_REV
NG_DRAGGABLE_TARGET_ROOT_NAME = 'ng-draggable-%s' % NG_DRAGGABLE_REV
...
download_and_unzip_files(
    NG_DRAGGABLE_ZIP_URL, THIRD_PARTY_STATIC_DIR,
    NG_DRAGGABLE_ZIP_ROOT_NAME, NG_DRAGGABLE_TARGET_ROOT_NAME)
download_and_unzip_files(
