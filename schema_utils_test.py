...
class SchemaValidationUnitTests(test_utils.GenericTestBase):
    ...
    def test_is_valid_algebraic_expression_validator(self):
        ...
        self.assertTrue(is_valid_asciimath_expression('a+b/2.3'))
        self.assertTrue(is_valid_asciimath_expression('a+ sqrt(beta/gamma)'))
        self.assertTrue(is_valid_asciimath_expression('cos(theta/2^epsilon)'))
        self.assertTrue(is_valid_asciimath_expression('a+{-b/22}'))
        self.assertTrue(is_valid_asciimath_expression('abs(a^2 + b^2)'))
        self.assertTrue(is_valid_asciimath_expression(
            'sin(theta)^2 + cos(theta)^2'))
        self.assertTrue(is_valid_asciimath_expression('(2*pi*r^2)/2'))
        ...
        self.assertTrue(is_valid_asciimath_expression('{a+(b-[c])-(beta^4)}'))
        ...
        self.assertFalse(is_valid_asciimath_expression('ab/2'))
    ...
    def test_is_valid_numeric_expression_validator(self):
        ...
        self.assertTrue(is_valid_asciimath_expression('sqrt(-1)', False))
        self.assertTrue(is_valid_asciimath_expression(
            'sqrt(-abs(-1))^2/abs(5)', False))
