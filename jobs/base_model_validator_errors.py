...
class ModelDomainObjectValidateError(ModelValidationErrorBase):
...
class IdsInModelFieldValidationError(ModelValidationErrorBase):
    """Error class for domain object validation errors."""
...
class ModelFieldCheckValidateError(ModelValidationErrorBase):
