...
def story_commit_log_entry_model_relationships(model: Any) -> Iterator[Tuple[Any, List[Type[story_models.StoryModel]]]]:
...
def story_summary_model_relationships(model: Any) -> Iterator[Tuple[Any, List[Type[story_models.StoryModel]]]]:
    """Yields how the properties of the model relates to the ID of others."""
