...
oppia.factory('ExpressionTypeParserService', [
    ...
    'PARAMETER_TYPES',
    function ($log, ExpressionParserService, ExpressionSyntaxTreeService, PARAMETER_TYPES) {
        var getExpressionOutputType = function (expression, envs) {
            return ExpressionSyntaxTreeService.applyFunctionToParseTree(ExpressionParserService.parse(expression), envs, getType);
        };
        /**
        ...
        var getType = function (parsed, envs) {
            ...
            if (parsed instanceof Array) {
                ...
                return ExpressionSyntaxTreeService.lookupEnvs(parsed[0], envs).getType(args);
            }
