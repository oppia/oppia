...
describe('Assets Backend API Service', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        FileDownloadRequestObjectFactory = $injector.get('FileDownloadRequestObjectFactory');
    ...
    it('should correctly formulate the download URL', function () {
        ...
        expect(AssetsBackendApiService.getAudioDownloadUrl('expid12345', 'a.mp3')).toEqual('/assetsdevhandler/expid12345/assets/audio/a.mp3');
    });
    it('should successfully fetch and cache audio', function () {
        var successHandler = jasmine.createSpy('success');
        var failHandler = jasmine.createSpy('fail');
        var requestUrl = UrlInterpolationService.interpolateUrl('/assetsdevhandler/<exploration_id>/assets/audio/<filename>', {
            exploration_id: '0',
            filename: 'myfile.mp3'
        });
    ...
    it('should successfully fetch and cache image', function () {
        var successHandler = jasmine.createSpy('success');
        var failHandler = jasmine.createSpy('fail');
        var requestUrl = UrlInterpolationService.interpolateUrl('/assetsdevhandler/<exploration_id>/assets/image/<filename>', {
            exploration_id: '0',
            filename: 'myfile.png'
        });
        $httpBackend.expect('GET', requestUrl).respond(201, 'image data');
        expect(AssetsBackendApiService.isCached('myfile.png')).toBe(false);
        AssetsBackendApiService.loadImage('0', 'myfile.png').then(successHandler, failHandler);
        expect((AssetsBackendApiService.getAssetsFilesCurrentlyBeingRequested())
            .image.length).toBe(1);
        $httpBackend.flush();
        expect((AssetsBackendApiService.getAssetsFilesCurrentlyBeingRequested())
    ...
    it('should call the provided failure handler on HTTP failure for an audio', function () {
        var successHandler = jasmine.createSpy('success');
        var failHandler = jasmine.createSpy('fail');
        var requestUrl = UrlInterpolationService.interpolateUrl('/assetsdevhandler/<exploration_id>/assets/audio/<filename>', {
            exploration_id: '0',
    ...
    it('should call the provided failure handler on HTTP failure for an image', function () {
        var successHandler = jasmine.createSpy('success');
        var failHandler = jasmine.createSpy('fail');
        var requestUrl = UrlInterpolationService.interpolateUrl('/assetsdevhandler/<exploration_id>/assets/image/<filename>', {
            exploration_id: '0',
    ...
    it('should successfully abort the download of all the audio files', function () {
        var successHandler = jasmine.createSpy('success');
        var failHandler = jasmine.createSpy('fail');
        var requestUrl = UrlInterpolationService.interpolateUrl('/assetsdevhandler/<exploration_id>/assets/audio/<filename>', {
            exploration_id: '0',
    ...
    it('should successfully abort the download of the all the image files', function () {
        var successHandler = jasmine.createSpy('success');
        var failHandler = jasmine.createSpy('fail');
        var requestUrl = UrlInterpolationService.interpolateUrl('assetsdevhandler/<exploration_id>/assets/image/<filename>', {
            exploration_id: '0',
