...
describe('EditabilityService', function () {
    ...
    it('should allow to translate an exploration after the tutorial ends', function () {
        EditabilityService.onEndTutorial();
        EditabilityService.markTranslatable();
        expect(EditabilityService.isTranslatable()).toBe(true);
    });
    it('should allow to edit an exploration outside the tutorial mode', function () {
        EditabilityService.markEditable();
        expect(EditabilityService.isEditableOutsideTutorialMode()).toBe(true);
    });
    it('should not allow to edit an exploration during tutorial mode', function () {
