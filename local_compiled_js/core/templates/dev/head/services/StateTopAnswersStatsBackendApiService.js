 ...
 */
oppia.constant('STATE_ANSWER_STATS_URL', '/createhandler/state_answer_stats/<exploration_id>');
    ...
    function ($http, UrlInterpolationService, STATE_ANSWER_STATS_URL) {
        return {
            fetchStats: function (explorationId) {
                return $http.get(UrlInterpolationService.interpolateUrl(STATE_ANSWER_STATS_URL, { exploration_id: explorationId })).then(function (response) {
