...
describe('Preferences Controller', function () {
    describe('PreferencesCtrl', function () {
        ...
        it('should show that editor role notifications checkbox is true by default', function () {
            $httpBackend.flush();
        ...
        it('should map SUPPORTED_AUDIO_LANGUAGES correctly to ' +
            'AUDIO_LANGUAGE_CHOICES to support select2 plugin', function () {
            ...
            for (var index = 0; index < numberOfAudioLanguageChoices; index++) {
                expect(Object.keys(scope.AUDIO_LANGUAGE_CHOICES[index])).toEqual(['id', 'text']);
            }
        });
    });
});
