...
oppia.controller('Signup', [
    ...
    function ($http, $rootScope, $scope, $uibModal, AlertsService, FocusManagerService, SiteAnalyticsService, UrlInterpolationService, UrlService, SITE_NAME) {
        ...
        $scope.showLicenseExplanationModal = function () {
            $uibModal.open({
                templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/pages/signup/licence_explanation_modal_directive.html'),
                backdrop: true,
                resolve: {},
                controller: [
        ...
        $scope.showRegistrationSessionExpiredModal = function () {
            $uibModal.open({
                templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/pages/signup/registration_session_expired_modal_directive.html'),
                backdrop: 'static',
                keyboard: false,
                resolve: {},
                controller: [
