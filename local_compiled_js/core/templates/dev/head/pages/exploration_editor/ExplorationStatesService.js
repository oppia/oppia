...
oppia.factory('ExplorationStatesService', [
    ...
    function ($filter, $injector, $location, $log, $q, $rootScope, $uibModal, AlertsService, AngularNameService, AnswerClassificationService, ChangeListService, ContextService, ExplorationInitStateNameService, SolutionValidityService, StateEditorService, StatesObjectFactory, UrlInterpolationService, ValidatorsService) {
        ...
        var BACKEND_CONVERSIONS = {
            ...
            content_ids_to_audio_translations: function (contentIdsToAudioTranslations) {
            ...
            if (!angular.equals(oldValue, newValue)) {
                ...
                if (CONTENT_ID_EXTRACTORS.hasOwnProperty(backendName)) {
                    ...
                    contentIdsToDelete.forEach(function (contentId) {
                        newStateData.contentIdsToAudioTranslations.deleteContentId(contentId);
        ...
        return {
            ...
            getContentIdsToAudioTranslationsMemento: function (stateName) {
                return getStatePropertyMemento(stateName, 'content_ids_to_audio_translations');
            },
            saveContentIdsToAudioTranslations: function (stateName, newContentIdsToAudioTranslations) {
                saveStateProperty(stateName, 'content_ids_to_audio_translations', newContentIdsToAudioTranslations);
            },
