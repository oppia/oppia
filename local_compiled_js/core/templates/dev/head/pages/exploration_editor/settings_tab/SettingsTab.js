...
oppia.controller('SettingsTab', [
    ...
    function ($http, $rootScope, $scope, $uibModal, $window, AlertsService, ChangeListService, EditableExplorationBackendApiService, ExplorationAutomaticTextToSpeechService, ExplorationCategoryService, ExplorationCorrectnessFeedbackService, ExplorationDataService, ExplorationFeaturesService, ExplorationInitStateNameService, ExplorationLanguageCodeService, ExplorationObjectiveService, ExplorationParamChangesService, ExplorationParamSpecsService, ExplorationRightsService, ExplorationStatesService, ExplorationTagsService, ExplorationTitleService, ExplorationWarningsService, UrlInterpolationService, UserEmailPreferencesService, ALL_CATEGORIES, EXPLORATION_TITLE_INPUT_FOCUS_LABEL) {
        $scope.EXPLORATION_TITLE_INPUT_FOCUS_LABEL = (EXPLORATION_TITLE_INPUT_FOCUS_LABEL);
        ...
        $scope.saveExplorationInitStateName = function () {
            ...
            if (!ExplorationStatesService.getState(newInitStateName)) {
                AlertsService.addWarning('Invalid initial state name: ' + newInitStateName);
        ...
        $scope.isAutomaticTextToSpeechEnabled = (ExplorationAutomaticTextToSpeechService.isAutomaticTextToSpeechEnabled);
        $scope.toggleAutomaticTextToSpeech = (ExplorationAutomaticTextToSpeechService.toggleAutomaticTextToSpeech);
        $scope.isCorrectnessFeedbackEnabled = (ExplorationCorrectnessFeedbackService.isEnabled);
        $scope.toggleCorrectnessFeedback = (ExplorationCorrectnessFeedbackService.toggleCorrectnessFeedback);
        ...
        $scope.editRole = function (newMemberUsername, newMemberRole) {
            $scope.closeRolesForm();
            ExplorationRightsService.saveRoleChanges(newMemberUsername, newMemberRole);
        };
        $scope.toggleViewabilityIfPrivate = function () {
            ExplorationRightsService.setViewability(!ExplorationRightsService.viewableIfPrivate());
        };
        ...
        $scope.previewSummaryTile = function () {
            ...
            $uibModal.open({
                templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/pages/exploration_editor/settings_tab/' +
        ...
        $scope.deleteExploration = function () {
            ...
            $uibModal.open({
                ...
                EditableExplorationBackendApiService.deleteExploration($scope.explorationId).then(function () {
