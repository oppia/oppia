...
describe('Solution Verification Service', function () {
    ...
    describe('Success case', function () {
        it('should verify a correct solution', function () {
            ...
            expect(svs.verifySolution('First State', state.interaction, ess.getState('First State').interaction.solution.correctAnswer)).toBe(true);
    ...
    describe('Failure case', function () {
        it('should verify an incorrect solution', function () {
            ...
            expect(svs.verifySolution('First State', state.interaction, ess.getState('First State').interaction.solution.correctAnswer)).toBe(false);
        });
    });
});
// Change
