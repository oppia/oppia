    ...
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            controller: [
                ...
                'RouterService',
                function ($scope, $filter, $rootScope, EditabilityService, StateEditorService, FocusManagerService, ExplorationStatesService, RouterService) {
                    ...
                    $scope.saveStateName = function (newStateName) {
                        ...
                        if (_stateNameMemento === normalizedNewName) {
                            ...
                            ExplorationStatesService.renameState(StateEditorService.getActiveStateName(), normalizedNewName);
                            $scope.stateNameEditorIsShown = false;
