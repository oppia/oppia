...
oppia.controller('ExplorationGraph', [
    ...
    function ($scope, $uibModal, AlertsService, EditabilityService, ExplorationStatesService, GraphDataService, RouterService, StateEditorService, UrlInterpolationService) {
        ...
        $scope.openStateGraphModal = function () {
            ...
            $uibModal.open({
                ...
                controller: [
                    ...
                    function ($scope, $uibModalInstance, StateEditorService, GraphDataService, isEditable) {
