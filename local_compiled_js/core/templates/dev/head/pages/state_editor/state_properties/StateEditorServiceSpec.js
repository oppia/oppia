...
describe('Editor state service', function () {
    ...
    describe('editor state service', function () {
        ...
        it('should correctly return answer choices for interaction', function () {
            ...
            expect(ecs.getAnswerChoices('MultipleChoiceInput', customizationArgsForMultipleChoiceInput)).toEqual([{
                    val: 0,
                    label: 'Choice 1',
                }, {
                    val: 1,
            ...
            expect(ecs.getAnswerChoices('ImageClickInput', customizationArgsForImageClickInput)).toEqual([{
                    val: 'Label 1',
                    label: 'Label 1',
                }, {
                    val: 'Label 2',
            ...
            expect(ecs.getAnswerChoices('ItemSelectionInput', customizationArgsForItemSelectionAndDragAndDropInput)).toEqual([{
                    val: 'Choice 1',
                    label: 'Choice 1',
                }, {
                    val: 'Choice 2',
            ...
            expect(ecs.getAnswerChoices('DragAndDropSortInput', customizationArgsForItemSelectionAndDragAndDropInput)).toEqual([{
                    val: 'Choice 1',
                    label: 'Choice 1',
                }, {
                    val: 'Choice 2',
