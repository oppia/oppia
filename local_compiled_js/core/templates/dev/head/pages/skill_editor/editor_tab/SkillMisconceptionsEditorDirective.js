...
oppia.directive('skillMisconceptionsEditor', [
    ...
    function (SkillEditorStateService, SkillUpdateService, UrlInterpolationService) {
        return {
            restrict: 'E',
            scope: {},
            ...
            controller: [
                ...
                function ($scope, $filter, $uibModal, $rootScope, MisconceptionObjectFactory, EVENT_SKILL_REINITIALIZED) {
                    ...
                    $scope.openAddMisconceptionModal = function () {
                        $uibModal.open({
                            ...
                            controller: [
                                ...
                                function ($scope, $uibModalInstance) {
                                    ...
                                    $scope.saveMisconception = function () {
                                        ...
                                        $uibModalInstance.close({
                                            misconception: MisconceptionObjectFactory.create(newMisconceptionId, $scope.misconceptionName, $scope.misconceptionNotes, $scope.misconceptionFeedback)
                                        });
                                    };
                                    $scope.cancel = function () {
                                        $uibModalInstance.dismiss('cancel');
                            ...
                            SkillUpdateService.addMisconception($scope.skill, result.misconception);
                            $scope.misconceptions = $scope.skill.getMisconceptions();
                        });
                    };
                }
