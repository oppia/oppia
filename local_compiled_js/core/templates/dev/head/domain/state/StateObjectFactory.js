...
oppia.factory('StateObjectFactory', [
    ...
    'WrittenTranslationsObjectFactory', function (ContentIdsToAudioTranslationsObjectFactory, InteractionObjectFactory, ParamChangesObjectFactory, SubtitledHtmlObjectFactory, WrittenTranslationsObjectFactory) {
        var State = function (name, classifierModelId, content, interaction, paramChanges, contentIdsToAudioTranslations, writtenTranslations) {
            this.name = name;
        ...
        State.prototype.toBackendDict = function () {
            return {
                ...
                content_ids_to_audio_translations: (this.contentIdsToAudioTranslations.toBackendDict()),
        ...
        State['createDefaultState'] = function (newStateName) {
            ...
            var newState = this.createFromBackendDict(newStateName, {
                ...
                content_ids_to_audio_translations: (newStateTemplate.content_ids_to_audio_translations),
        ...
        State['createFromBackendDict'] = function (stateName, stateDict) {
            /* eslint-enable dot-notation */
            return new State(stateName, stateDict.classifier_model_id, SubtitledHtmlObjectFactory.createFromBackendDict(stateDict.content), InteractionObjectFactory.createFromBackendDict(stateDict.interaction), ParamChangesObjectFactory.createFromBackendList(stateDict.param_changes), ContentIdsToAudioTranslationsObjectFactory.createFromBackendDict(stateDict.content_ids_to_audio_translations), WrittenTranslationsObjectFactory.createFromBackendDict(stateDict.written_translations));
        };
        return State;
    }
]);
