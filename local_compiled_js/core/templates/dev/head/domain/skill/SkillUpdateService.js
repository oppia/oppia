...
oppia.constant('CMD_UPDATE_SKILL_PROPERTY', 'update_skill_property');
oppia.constant('CMD_UPDATE_SKILL_CONTENTS_PROPERTY', 'update_skill_contents_property');
oppia.constant('CMD_UPDATE_SKILL_MISCONCEPTIONS_PROPERTY', 'update_skill_misconceptions_property');
oppia.constant('CMD_ADD_SKILL_MISCONCEPTION', 'add_skill_misconception');
oppia.constant('CMD_DELETE_SKILL_MISCONCEPTION', 'delete_skill_misconception');
oppia.factory('SkillUpdateService', [
    ...
    function (ChangeObjectFactory, SkillObjectFactory, UndoRedoService, CMD_ADD_SKILL_MISCONCEPTION, CMD_DELETE_SKILL_MISCONCEPTION, CMD_UPDATE_SKILL_CONTENTS_PROPERTY, CMD_UPDATE_SKILL_MISCONCEPTIONS_PROPERTY, CMD_UPDATE_SKILL_PROPERTY, SKILL_CONTENTS_PROPERTY_EXPLANATION, SKILL_CONTENTS_PROPERTY_WORKED_EXAMPLES, SKILL_MISCONCEPTIONS_PROPERTY_FEEDBACK, SKILL_MISCONCEPTIONS_PROPERTY_NAME, SKILL_MISCONCEPTIONS_PROPERTY_NOTES, SKILL_PROPERTY_DESCRIPTION, SKILL_PROPERTY_LANGUAGE_CODE) {
        ...
        var _applyPropertyChange = function (skill, propertyName, newValue, oldValue, apply, reverse) {
        ...
        var _applyMisconceptionPropertyChange = function (skill, misconceptionId, propertyName, newValue, oldValue, apply, reverse) {
        ...
        var _applySkillContentsPropertyChange = function (skill, propertyName, newValue, oldValue, apply, reverse) {
        ...
        return {
            setSkillDescription: function (skill, newDescription) {
                ...
                _applyPropertyChange(skill, SKILL_PROPERTY_DESCRIPTION, newDescription, oldDescription, function (changeDict, skill) {
            ...
            setConceptCardExplanation: function (skill, newExplanation) {
                ...
                _applySkillContentsPropertyChange(skill, SKILL_CONTENTS_PROPERTY_EXPLANATION, newExplanation.toBackendDict(), oldExplanation.toBackendDict(), function (changeDict, skill) {
            ...
            addWorkedExample: function (skill, newWorkedExample) {
                var oldWorkedExamples = angular.copy(skill.getConceptCard().getWorkedExamples());
                var newWorkedExamples = angular.copy(oldWorkedExamples);
                newWorkedExamples.push(newWorkedExample);
                _applySkillContentsPropertyChange(skill, SKILL_CONTENTS_PROPERTY_WORKED_EXAMPLES, newWorkedExamples.map(function (workedExample) {
            ...
            updateWorkedExample: function (skill, workedExampleIndex, newWorkedExampleHtml) {
                var oldWorkedExamples = angular.copy(skill.getConceptCard().getWorkedExamples());
                var newWorkedExamples = angular.copy(oldWorkedExamples);
            ...
            addMisconception: function (skill, newMisconception) {
                ...
                _applyChange(skill, CMD_ADD_SKILL_MISCONCEPTION, params, function (changeDict, skill) {
            ...
            deleteMisconception: function (skill, misconceptionId) {
                ...
                _applyChange(skill, CMD_DELETE_SKILL_MISCONCEPTION, params, function (changeDict, skill) {
                    skill.deleteMisconception(misconceptionId);
                }, function (changeDict, skill) {
                    skill.appendMisconception(oldMisconception);
                });
            },
            updateMisconceptionName: function (skill, misconceptionId, oldName, newName) {
                var misconception = skill.findMisconceptionById(misconceptionId);
                if (misconception) {
                    _applyMisconceptionPropertyChange(skill, misconceptionId, SKILL_MISCONCEPTIONS_PROPERTY_NAME, newName, oldName, function (changeDict, skill) {
            ...
            updateMisconceptionNotes: function (skill, misconceptionId, oldNotes, newNotes) {
                var misconception = skill.findMisconceptionById(misconceptionId);
                if (misconception) {
                    _applyMisconceptionPropertyChange(skill, misconceptionId, SKILL_MISCONCEPTIONS_PROPERTY_NOTES, newNotes, oldNotes, function (changeDict, skill) {
            ...
            updateMisconceptionFeedback: function (skill, misconceptionId, oldFeedback, newFeedback) {
                var misconception = skill.findMisconceptionById(misconceptionId);
                if (misconception) {
                    _applyMisconceptionPropertyChange(skill, misconceptionId, SKILL_MISCONCEPTIONS_PROPERTY_FEEDBACK, newFeedback, oldFeedback, function (changeDict, skill) {
