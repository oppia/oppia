...
oppia.factory('ExplorationObjectFactory', [
    ...
    'INTERACTION_SPECS', function ($log, ParamChangesObjectFactory, ParamSpecsObjectFactory, StatesObjectFactory, UrlInterpolationService, INTERACTION_DISPLAY_MODE_INLINE, INTERACTION_SPECS) {
        ...
        Exploration.prototype.getAudioTranslations = function (stateName) {
            ...
            return contentIdsToAudioTranslations.getBindableAudioTranslations(contentId);
        };
        Exploration.prototype.getAudioTranslation = function (stateName, languageCode) {
            var state = this.getState(stateName);
            var contentIdsToAudioTranslations = state.contentIdsToAudioTranslations;
            var contentId = state.content.getContentId();
            return contentIdsToAudioTranslations.getAudioTranslation(contentId, languageCode);
        };
