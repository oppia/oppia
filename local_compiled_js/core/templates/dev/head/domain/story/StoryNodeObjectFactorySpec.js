...
describe('Story node object factory', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        _sampleStoryNode = StoryNodeObjectFactory.createFromBackendDict(sampleStoryNodeBackendDict);
    }));
    it('should correctly create a node from node id alone', function () {
        var storyNode = StoryNodeObjectFactory.createFromIdAndTitle('node_1', 'Title 1');
    ...
    it('should correctly throw error when duplicate values are added to arrays', function () {
        expect(function () {
    ...
    it('should correctly throw error when invalid values are deleted from arrays', function () {
        expect(function () {
