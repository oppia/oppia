...
describe('Feedback thread object factory', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        FeedbackThreadSummaryObjectFactory = $injector.get('FeedbackThreadSummaryObjectFactory');
    }));
    it('should update the summary of the thread on addition of a ' +
        ' message', function () {
        var feedbackThreadSummary = FeedbackThreadSummaryObjectFactory.create('open', 'Test user 1', new Date(), 'last message', 2, false, false, 'Test user 2', 'Test user 2', 'Test exploration name', '0', 'thread_id');
    ...
    it('should fetch the feedback thread domain object from the backend ' +
        ...
        var feedbackThreadSummary = (FeedbackThreadSummaryObjectFactory.createFromBackendDict(threadSummary));
        expect(feedbackThreadSummary.explorationTitle).toEqual('Sample exploration 1');
