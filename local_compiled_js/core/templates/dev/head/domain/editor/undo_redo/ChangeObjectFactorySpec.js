...
describe('Factory for Change domain objects', function () {
    ...
    it('should invoke the apply callback when applied', function () {
        ...
        var changeDomainObject = ChangeObjectFactory.create(backendChangeObject, applyFunc, reverseFunc);
    ...
    it('should not receive changes to the provided change backend object', function () {
        var backendChangeObject = {
            property_name: 'value'
        };
        var changeDomainObject = ChangeObjectFactory.create(backendChangeObject, function () { }, function () { });
