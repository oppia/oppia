...
describe('Topic rights object factory', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        sampleTopicRights = TopicRightsObjectFactory.createFromBackendDict(initialTopicRightsBackendObject);
    }));
    it('should be able to publish and unpublish topic when user can edit it', function () {
    ...
    it('should throw error and not be able to publish or unpublish topic when ' +
        'user cannot edit topic', function () {
        expect(sampleTopicRights.isPublished()).toBe(false);
        ...
        var exampleTopicRights = TopicRightsObjectFactory.createFromBackendDict(exampleTopicRightsBackendObject);
        expect(function () {
    ...
    it('should create an empty topic rights object', function () {
        var emptyTopicRightsBackendObject = (TopicRightsObjectFactory.createInterstitialRights());
