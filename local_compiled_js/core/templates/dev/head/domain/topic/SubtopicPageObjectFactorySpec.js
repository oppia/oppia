...
describe('Subtopic page object factory', function () {
    ...
    it('should be able to create a subtopic page object with given topic and ' +
        ...
        var subtopicPage = SubtopicPageObjectFactory.createDefault('topic_id', 2);
    ...
    it('should be able to create an interstitial subtopic page object', function () {
        var subtopicPage = SubtopicPageObjectFactory.createInterstitialSubtopicPage();
