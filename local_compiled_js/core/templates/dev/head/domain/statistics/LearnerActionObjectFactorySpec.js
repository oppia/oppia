...
describe('Learner Action Object Factory', function () {
    ...
    it('should create a new learner action', function () {
        var learnerActionObject = this.LearnerActionObjectFactory.createNew('AnswerSubmit', {});
    ...
    it('should throw if the schema version is not a positive int', function () {
        var LearnerActionObjectFactoryLocalReference = this.LearnerActionObjectFactory;
        expect(function () {
            return LearnerActionObjectFactoryLocalReference.createNew('AnswerSubmit', {}, -1);
        }).toThrow(new Error('given invalid schema version'));
    });
    it('should use a specific schema version if provided', function () {
        var learnerActionObject = this.LearnerActionObjectFactory.createNew('AnswerSubmit', {}, 99);
        expect(learnerActionObject.schemaVersion).toEqual(99);
    });
    it('should create a new learner action from a backend dict', function () {
        var learnerActionObject = this.LearnerActionObjectFactory.createFromBackendDict({
    ...
    it('should convert a learner action to a backend dict', function () {
        var learnerActionObject = this.LearnerActionObjectFactory.createNew('AnswerSubmit', {}, 1);
