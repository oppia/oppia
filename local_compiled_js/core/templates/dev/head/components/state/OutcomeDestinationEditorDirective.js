...
oppia.directive('outcomeDestinationEditor', [
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/state/outcome_destination_editor_directive.html'),
            controller: [
                ...
                function ($scope, EditorFirstTimeEventsService, FocusManagerService, StateEditorService, StateGraphLayoutService, UserService, EXPLORATION_AND_SKILL_ID_PATTERN, PLACEHOLDER_OUTCOME_DEST) {
                    ...
                    $scope.canAddPrerequisiteSkill = (constants.ENABLE_NEW_STRUCTURE_EDITORS &&
                    ...
                    UserService.getUserInfoAsync().then(function (userInfo) {
                        ...
                        // development.
                        $scope.canEditRefresherExplorationId = (userInfo.isAdmin() || userInfo.isModerator());
                    });
