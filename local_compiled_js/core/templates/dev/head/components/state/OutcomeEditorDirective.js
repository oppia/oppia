...
oppia.directive('outcomeEditor', [
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/state/outcome_editor_directive.html'),
            controller: [
                ...
                function ($scope, StateEditorService, StateInteractionIdService, INTERACTION_SPECS) {
                    ...
                    $scope.saveThisFeedback = function (fromClickSaveFeedbackButton) {
                        ...
                        $scope.feedbackEditorIsOpen = false;
                        var contentHasChanged = ($scope.savedOutcome.feedback.getHtml() !==
                    ...
                    $scope.saveThisDestination = function () {
                        ...
                        $scope.savedOutcome.refresherExplorationId = ($scope.outcome.refresherExplorationId);
                    ...
                    $scope.onChangeCorrectnessLabel = function () {
                        $scope.savedOutcome.labelledAsCorrect = ($scope.outcome.labelledAsCorrect);
                    ...
                    $scope.cancelThisDestinationEdit = function () {
                        ...
                        $scope.outcome.refresherExplorationId = ($scope.savedOutcome.refresherExplorationId);
                        $scope.outcome.missingPrerequisiteSkillId =
                            $scope.savedOutcome.missingPrerequisiteSkillId;
                        $scope.destinationEditorIsOpen = false;
                    };
