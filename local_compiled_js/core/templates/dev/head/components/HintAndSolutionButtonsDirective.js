...
oppia.directive('hintAndSolutionButtons', [
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            restrict: 'E',
            scope: {},
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/hint_and_solution_buttons_directive.html'),
            controller: [
                ...
                function ($scope, $rootScope, HintsAndSolutionManagerService, PlayerTranscriptService, ExplorationPlayerStateService, HintAndSolutionModalService, DeviceInfoService, ContextService, PlayerPositionService, EVENT_ACTIVE_CARD_CHANGED, EVENT_NEW_CARD_OPENED, INTERACTION_SPECS, StatsReportingService) {
                    ...
                    $scope.isSolutionConsumed = (HintsAndSolutionManagerService.isSolutionConsumed);
                    ...
                    $scope.$on(EVENT_ACTIVE_CARD_CHANGED, function (evt) {
                        ...
                        $scope.currentlyOnLatestCard = PlayerTranscriptService.isLastCard(displayedCardIndex);
