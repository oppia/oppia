...
oppia.directive('versionDiffVisualization', [
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/' +
            ...
            controller: ['$scope', '$uibModal', function ($scope, $uibModal) {
                    ...
                    $scope.DIFF_GRAPH_LINK_PROPERTY_MAPPING = {
                        added: ('stroke: #1F7D1F; stroke-opacity: 0.8; ' +
                            'marker-end: url(#arrowhead-green)'),
                        deleted: ('stroke: #B22222; stroke-opacity: 0.8; ' +
                    ...
                    $scope.onClickStateInDiffGraph = function (stateId) {
                        ...
                        $scope.showStateDiffModal(nodesData[stateId].newestStateName, oldStateName, nodesData[stateId].stateProperty);
                    };
                    ...
                    //     deleted.
                    $scope.showStateDiffModal = function (newStateName, oldStateName, stateProperty) {
                        $uibModal.open({
                            ...
                            resolve: {
                                ...
                                newState: function () {
                                    if (stateProperty !== STATE_PROPERTY_DELETED &&
                                        $scope.getDiffData().v2States.hasOwnProperty(newStateName)) {
                                ...
                                oldState: function () {
                                    ...
                                    if (stateProperty !== STATE_PROPERTY_ADDED &&
                                        $scope.getDiffData().v1States.hasOwnProperty(stateNameToRetrieve)) {
                            ...
                            controller: [
                                ...
                                function ($scope, $http, $uibModalInstance, $timeout, newStateName, oldStateName, newState, oldState, headers, ContextService, UrlInterpolationService) {
                                    var STATE_YAML_URL = UrlInterpolationService.interpolateUrl('/createhandler/state_yaml/<exploration_id>', {
