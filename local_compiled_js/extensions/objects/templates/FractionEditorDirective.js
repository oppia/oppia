...
oppia.directive('fractionEditor', [
    ...
    function (FractionObjectFactory, UrlInterpolationService, OBJECT_EDITOR_URL_PREFIX) {
        return {
            restrict: 'E',
            scope: {},
            bindToController: {
            ...
            templateUrl: UrlInterpolationService.getExtensionResourceUrl('/objects/templates/fraction_editor_directive.html'),
            controllerAs: '$ctrl',
