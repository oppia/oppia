...
oppia.directive('imageWithRegionsEditor', [
    ...
    function ($document, $sce, AlertsService, AssetsBackendApiService, ContextService, UrlInterpolationService, OBJECT_EDITOR_URL_PREFIX) {
        return {
            restrict: 'E',
            scope: {},
            bindToController: {
            ...
            templateUrl: UrlInterpolationService.getExtensionResourceUrl('/objects/templates/image_with_regions_editor_directive.html'),
            controllerAs: '$ctrl',
            controller: [
                ...
                function ($scope, $element, $uibModal) {
                    ...
                    ctrl.getPreviewUrl = function (imageUrl) {
                        return AssetsBackendApiService.getImageUrlForPreview(ContextService.getExplorationId(), encodeURIComponent(imageUrl));
                    };
