...
describe('MultipleChoiceInputValidationService', function () {
    ...
    it('should validate answer group rules refer to valid choices only once', function () {
    ...
    it('should expect a non-confusing and non-null default outcome only when ' +
        ...
        var warnings = validatorService.getAllWarnings(currentState, customizationArguments, goodAnswerGroups, badOutcome);
        ...
        warnings = validatorService.getAllWarnings(currentState, customizationArguments, goodAnswerGroups, null);
        expect(warnings).toEqual([{
