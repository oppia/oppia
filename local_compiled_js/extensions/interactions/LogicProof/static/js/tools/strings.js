...
var DEFAULT_LAYOUT_MISTAKE_STRINGS = [{
        ...
        occurs: ('template(n)=\'for_all_introduce\' \u2227 ' +
        ...
        occurs: ('template(n)=\'implies_introduce\' \u2227 ' +
        ...
        occurs: ('template(n)=\'not_introduce\' \u2227 ' +
            '(indentation(n)=indentation(n-1) \u2227 indentation(n)=0)'),
        message: [
            'To prove {{result(n)}} you need to start by writing ' +
        ...
        occurs: ('n=1 \u2227 (template(n)=\'for_all_introduce\' \u2228 ' +
...
var DEFAULT_VARIABLE_MISTAKE_STRINGS = [{
        ...
        occurs: ('~is_initializer(n) \u2227 template(n)!= \'for_all_introduce\' \u2227 ' +
...
var DEFAULT_LOGIC_MISTAKE_STRINGS = [{
        ...
        occurs: ('template(n)=\'or_eliminate\' \u2227 ' +
...
var DEFAULT_TARGET_MISTAKE_STRINGS = [{
        ...
        occurs: ('n=num_lines() \u2227 indentation(n)>0 \u2227 ' +
...
var DEFAULT_CONTROL_FUNCTION_STRINGS = [{
        ...
        LHS: 'is_in_scope(k, n)',
        RHS: ('(~is_scope_creator(k) \u2227 indentation(n)>=indentation(k) \u2227 ' +
        ...
        RHS: ('template(n)=\'given\' \u2228 template(n)=\'for_all_eliminate\' \u2228 ' +
        ...
        description: ('Whether variable x is initialized by line n (this does not mean it ' +
        ...
        description: ('Whether there is a line before n that proves R (again, it may still be ' +
        ...
        RHS: ('R\u2208assumptions()\u2228\u2203k<n.(is_in_scope(k,n)\u2227' +
            'R\u2208results(k))'),
        ...
        RHS: ('m<n \u2227 indentation(n)>0 \u2227 (S\u2208results(n) \u2228 ' +
        ...
        RHS: ('m<n \u2227 indentation(n)>0 \u2227 (yields_false(n)) \u2227 ' +
            'template(m)=\'assumption\' \u2227 R\u2208results(m) \u2227 ' +
            'indentation(n)=indentation(m)+1 \u2227 ~\u2203i<n. (i>m \u2227 ' +
            'indentation(i)<=indentation(m))'),
        description: ('Whether line n is a proof of contradiction under the assumption of R, ' +
            'made on line m')
    }, {
        LHS: 'is_available_implication(A,B,n)',
        RHS: ('\u2203j<n.\u2203i<j.(yields_implication(A,B,i,j) \u2227 ' +
            '(~\u2203k<n.(k>i \u2227 indentation(k)<indentation(i))) \u2227 ' +
            'indentation(i)<=indentation(n))'),
        description: ('Whether there is a proof of B under the assumption of A available at ' +
            'line n')
    }, {
        LHS: 'is_available_implies_false(A,n)',
        RHS: ('\u2203j<n.\u2203i<j.(yields_implies_false(A,i,j) \u2227 ' +
            '(~\u2203k<n.(k>i \u2227 indentation(k)<indentation(i))) \u2227 ' +
            'indentation(i)<=indentation(n))'),
        description: ('Whether there is a proof of contradiction under the assumption of A ' +
            'available at line n')
    }];
