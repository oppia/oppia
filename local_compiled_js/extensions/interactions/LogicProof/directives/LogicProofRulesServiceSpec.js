...
describe('Logic Proof rules service', function () {
    ...
    it('should have a correct \'not correct by category\' rule', function () {
        ...
        expect(lprs.NotCorrectByCategory(INCORRECT_EXAMPLE_PARSING, RULE_INPUT)).toBe(false);
        expect(lprs.NotCorrectByCategory(INCORRECT_EXAMPLE_TYPING, RULE_INPUT)).toBe(true);
    });
});
