...
describe('DragAndDropSortInputValidationService', function () {
    ...
    var equalsListWithEmptyValuesRule, equalsListWithDuplicatesRule, equalsListWithAllowedValuesRule, equalsListWithValuesRule, hasXBeforeYRule;
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        answerGroups = [agof.createNew([equalsListWithAllowedValuesRule], goodDefaultOutcome, false)];
    }));
    it('should be able to perform basic validation', function () {
        var warnings = validatorService.getAllWarnings(currentState, customizationArgs, answerGroups, goodDefaultOutcome);
