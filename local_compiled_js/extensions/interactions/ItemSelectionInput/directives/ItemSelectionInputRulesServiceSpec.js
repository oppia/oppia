...
describe('Item Selection rules service', function () {
    ...
    it('should have a correct \'does not contain at least one of\' rule', function () {
        var RULE_INPUT = {
            x: ['a', 'b', 'c']
        };
        ...
        expect(isirs.DoesNotContainAtLeastOneOf(['a', 'b', 'c'], RULE_INPUT)).toBe(false);
        expect(isirs.DoesNotContainAtLeastOneOf(['a', 'b', 'c', 'd'], RULE_INPUT)).toBe(false);
    });
    it('should have a correct \'is a proper subset of\' rule', function () {
        var RULE_INPUT = {
            x: ['a', 'b', 'c']
        };
        ...
        expect(isirs.IsProperSubsetOf(['a', 'b', 'c', 'd'], RULE_INPUT)).toBe(false);
