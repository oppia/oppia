...
class CustomizationArgsUtil(object):
    """Utility class for obtaining and validating customization args
    for interactions.
    """
    ...
    def validate_customization_args_and_values(
        ...
        customization_args = CustomizationArgsUtil.get_full_customization_args(
