...
var ruleTemplates = require('../../../../extensions/interactions/rule_templates.json');
...
var ExplorationEditorMainTab = function () {
     ...
     */
    var addResponseDetails = protractor_1.element(protractor_1.by.css('.protractor-test-add-response-details'));
    var addResponseHeader = protractor_1.element(protractor_1.by.css('.protractor-test-add-response-modal-header'));
    var multipleChoiceAnswerOptions = function (optionNum) {
        return protractor_1.element(protractor_1.by.cssContainingText('.protractor-test-html-select-option', optionNum));
    };
    var neutralElement = protractor_1.element.all(protractor_1.by.css('.protractor-test-neutral-element'))
        .first();
    var defaultResponseTab = protractor_1.element(protractor_1.by.css('.protractor-test-default-response-tab'));
    var editorWelcomeModal = protractor_1.element(protractor_1.by.css('.protractor-test-welcome-modal'));
    var editOutcomeDestBubble = protractor_1.element(protractor_1.by.css('.protractor-test-dest-bubble'));
    var editOutcomeDestStateInput = editOutcomeDestBubble.element(protractor_1.by.css('.protractor-test-add-state-input'));
    var editOutcomeDestAddExplorationId = protractor_1.element(protractor_1.by.css('.protractor-test-add-refresher-exploration-id'));
    var editOutcomeDestDropdownOptions = function (targetOption) {
        return protractor_1.element.all(protractor_1.by.cssContainingText('option', targetOption)).first();
    };
    var editParamChanges = protractor_1.element(protractor_1.by.css('.protractor-test-state-edit-param-changes'));
    var feedbackBubble = protractor_1.element(protractor_1.by.css('.protractor-test-feedback-bubble'));
    var feedbackEditor = protractor_1.element(protractor_1.by.css('.protractor-test-open-feedback-editor'));
    var interaction = protractor_1.element(protractor_1.by.css('.protractor-test-interaction'));
    var interactionEditor = protractor_1.element(protractor_1.by.css('.protractor-test-interaction-editor'));
    var explorationGraph = protractor_1.element(protractor_1.by.css('.protractor-test-exploration-graph'));
    var stateNodes = explorationGraph.all(protractor_1.by.css('.protractor-test-node'));
    var stateNodeLabel = function (nodeElement) {
        return nodeElement.element(protractor_1.by.css('.protractor-test-node-label'));
    };
    var interactionTab = function (tabId) {
        return protractor_1.element(protractor_1.by.css('.protractor-test-interaction-tab-' + tabId));
    };
    var interactionTile = function (interactionId) {
        return protractor_1.element(protractor_1.by.css('.protractor-test-interaction-tile-' + interactionId));
    };
    var openOutcomeDestEditor = protractor_1.element(protractor_1.by.css('.protractor-test-open-outcome-dest-editor'));
    var openOutcomeFeedBackEditor = protractor_1.element(protractor_1.by.css('.protractor-test-open-outcome-feedback-editor'));
    var postTutorialPopover = protractor_1.element(protractor_1.by.css('.popover-content'));
    var responseBody = function (responseNum) {
        return protractor_1.element(protractor_1.by.css('.protractor-test-response-body-' + responseNum));
    };
    var responseTab = protractor_1.element.all(protractor_1.by.css('.protractor-test-response-tab'));
    var ruleBlock = protractor_1.element.all(protractor_1.by.css('.protractor-test-rule-block'));
    var stateEditContent = protractor_1.element(protractor_1.by.css('.protractor-test-edit-content'));
    var stateContentDisplay = protractor_1.element(protractor_1.by.css('.protractor-test-state-content-display'));
    var stateNameContainer = protractor_1.element(protractor_1.by.css('.protractor-test-state-name-container'));
    var stateNameInput = protractor_1.element(protractor_1.by.css('.protractor-test-state-name-input'));
    /*
     * Buttons
     */
    var addAnswerButton = protractor_1.element(protractor_1.by.css('.protractor-test-add-answer'));
    var addHintButton = protractor_1.element(protractor_1.by.css('.protractor-test-oppia-add-hint-button'));
    var addNewResponseButton = protractor_1.element(protractor_1.by.css('.protractor-test-add-new-response'));
    var addParamButton = protractor_1.element(protractor_1.by.css('.protractor-test-add-param-button'));
    var addResponseButton = protractor_1.element(protractor_1.by.css('.protractor-test-open-add-response-modal'));
    var addSolutionButton = protractor_1.element(protractor_1.by.css('.protractor-test-oppia-add-solution-button'));
    var addInteractionButton = protractor_1.element(protractor_1.by.css('.protractor-test-open-add-interaction-modal'));
    var cancelOutcomeDestButton = protractor_1.element(protractor_1.by.css('.protractor-test-cancel-outcome-dest'));
    var closeAddResponseButton = protractor_1.element(protractor_1.by.css('.protractor-test-close-add-response-modal'));
    var confirmDeleteInteractionButton = protractor_1.element(protractor_1.by.css('.protractor-test-confirm-delete-interaction'));
    var confirmDeleteResponseButton = protractor_1.element(protractor_1.by.css('.protractor-test-confirm-delete-response'));
    var confirmDeleteStateButton = protractor_1.element(protractor_1.by.css('.protractor-test-confirm-delete-state'));
    var deleteAnswerButton = protractor_1.element(protractor_1.by.css('.protractor-test-delete-answer'));
    var deleteInteractionButton = protractor_1.element(protractor_1.by.css('.protractor-test-delete-interaction'));
    var deleteResponseButton = protractor_1.element(protractor_1.by.css('.protractor-test-delete-response'));
    var dismissWelcomeModalButton = protractor_1.element(protractor_1.by.css('.protractor-test-dismiss-welcome-modal'));
    var saveAnswerButton = protractor_1.element(protractor_1.by.css('.protractor-test-save-answer'));
    var saveHintButton = protractor_1.element(protractor_1.by.css('.protractor-test-save-hint'));
    var saveHintEditButton = protractor_1.element(protractor_1.by.css('.protractor-test-save-hint-edit'));
    var saveInteractionButton = protractor_1.element(protractor_1.by.css('.protractor-test-save-interaction'));
    var saveOutcomeDestButton = protractor_1.element(protractor_1.by.css('.protractor-test-save-outcome-dest'));
    var saveOutcomeFeedbackButton = protractor_1.element(protractor_1.by.css('.protractor-test-save-outcome-feedback'));
    var saveParamChangesButton = protractor_1.element(protractor_1.by.css('.protractor-test-save-param-changes-button'));
    var saveStateContentButton = protractor_1.element(protractor_1.by.css('.protractor-test-save-state-content'));
    var stateNameSubmitButton = stateNameContainer.element(protractor_1.by.css('.protractor-test-state-name-submit'));
    /*
     * Actions
     */
    // TUTORIAL
    this.exitTutorial = function () {
        ...
        waitFor.invisibilityOf(editorWelcomeModal, 'Editor Welcome modal takes too long to disappear');
    ...
    this.startTutorial = function () {
        waitFor.visibilityOf(editorWelcomeModal, 'Editor Welcome modal takes too long to appear');
        protractor_1.element(protractor_1.by.css('.protractor-test-start-tutorial')).click();
        waitFor.visibilityOf(protractor_1.element(protractor_1.by.css('.ng-joyride-title')), 'Tutorial modal takes too long to appear');
    };
    // RESPONSE EDITOR
    /**
     ...
     */
    this.addResponse = function (interactionId, feedbackInstructions, destStateName, createNewState, ruleName) {
        ...
        if (destStateName || destStateName !== '(try again)') {
            ...
            _setOutcomeDest(destStateName, createNewState, null);
        }
        // Close new response modal.
        expect(addNewResponseButton.isDisplayed()).toBe(true);
        addNewResponseButton.click();
        waitFor.invisibilityOf(addNewResponseButton, 'Add New Response Modal is not closed');
    };
    ...
    this.getResponseEditor = function (responseNum) {
        ...
        if (responseNum === 'default') {
            ...
            headerElem = responseTab.get(responseNum);
        }
        responseBody(responseNum).isPresent().then(function (isVisible) {
            if (!isVisible) {
                expect(headerElem.isDisplayed()).toBe(true);
                waitFor.elementToBeClickable(headerElem, 'Response Editor header is not clickable');
                headerElem.click();
            }
        });
        return {
            ...
            expectRuleToBe: function (interactionId, ruleName, feedbackTextArray) {
                ...
                ruleDescription = _replaceRuleInputPlaceholders(ruleDescription, feedbackTextArray);
                ruleDescription += '...';
                // Adding "..." to end of string.
                var answerTab = protractor_1.element(protractor_1.by.css('.protractor-test-answer-tab'));
            ...
            expectFeedbackInstructionToBe: function (feedbackInstructionsText) {
                ...
                var feedbackRTE = responseBody(responseNum).
                    element(protractor_1.by.className('oppia-rte-editor'));
                expect(feedbackRTE.getText()).toEqual(feedbackInstructionsText);
            },
            ...
            setDestination: function (destinationName, createNewState, refresherExplorationId) {
                // Begin editing destination.
                expect(openOutcomeDestEditor.isDisplayed()).toBe(true);
                openOutcomeDestEditor.click();
                // Set destination contents.
                _setOutcomeDest(destinationName, createNewState, refresherExplorationId);
                // Save destination.
            ...
            expectAvailableDestinationsToBe: function (stateNames) {
                // Begin editing destination.
                openOutcomeDestEditor.click();
                var expectedOptionTexts = [_CURRENT_STATE_OPTION].concat(stateNames.slice(1));
                // Create new option always at the end of the list.
                expectedOptionTexts.push(_NEW_STATE_OPTION);
                editOutcomeDestBubble.all(protractor_1.by.tagName('option')).map(function (optionElem) {
            ...
            addRule: function (interactionId, ruleName) {
                ...
                // Set the rule description.
                var ruleDetails = protractor_1.element(protractor_1.by.css('.protractor-test-rule-details'));
    ...
    var _setOutcomeDest = function (destName, createNewDest, refresherExplorationId) {
        ...
        waitFor.visibilityOf(editOutcomeDestDropdownOptions(targetOption), 'editOutcomeDestDropdownOptions taking too long to appear');
    ...
    this.setContent = function (richTextInstructions) {
        ...
        waitFor.invisibilityOf(postTutorialPopover, 'Post-tutorial popover does not disappear.');
        waitFor.elementToBeClickable(stateEditContent, 'stateEditContent taking too long to appear to set content');
        stateEditContent.click();
        var stateEditorTag = protractor_1.element(protractor_1.by.tagName('state-content-editor'));
        var stateContentEditor = stateEditorTag.element(protractor_1.by.css('.protractor-test-state-content-editor'));
        waitFor.visibilityOf(stateContentEditor, 'stateContentEditor taking too long to appear to set content');
        ...
        waitFor.invisibilityOf(saveStateContentButton, 'State content editor takes too long to disappear');
    };
    ...
    this.addHint = function (hint) {
        addHintButton.click();
        var addHintModal = protractor_1.element(protractor_1.by.cssContainingText('.protractor-test-hint-modal', 'Add Hint'));
        waitFor.visibilityOf(addHintModal, 'Add hint modal takes too long to appear');
        protractor_1.element(protractor_1.by.css('.protractor-test-hint-text')).all(protractor_1.by.tagName('p'))
            .last().click();
        protractor_1.browser.switchTo().activeElement().sendKeys(hint);
        waitFor.elementToBeClickable(saveHintButton, 'Save Hint button takes too long to be clickable');
        saveHintButton.click();
        waitFor.invisibilityOf(addHintModal, 'Add Hint modal takes too long to close');
    };
    // Hints are zero-indexed.
    this.getHintEditor = function (hintNum) {
        var confirmDeteletHintButton = protractor_1.element(protractor_1.by.css('.protractor-test-confirm-delete-hint'));
        var headerElem = protractor_1.element.all(protractor_1.by.css('.protractor-test-hint-tab')).get(hintNum);
        var deleteHintIcon = headerElem.element(protractor_1.by.css('.protractor-test-delete-response'));
        var hintBodyElem = protractor_1.element(protractor_1.by.css('.protractor-test-hint-body-' + hintNum));
        ...
        return {
            setHint: function (hint) {
                var editHintIcon = protractor_1.element(protractor_1.by.css('.protractor-test-open-hint-editor'));
                editHintIcon.click();
                protractor_1.browser.switchTo().activeElement().clear();
                protractor_1.browser.switchTo().activeElement().sendKeys(hint);
                waitFor.elementToBeClickable(saveHintEditButton, 'Save Hint button takes too long to be clickable');
                saveHintEditButton.click();
                waitFor.visibilityOf(editHintIcon, 'Add Hint modal takes too long to close');
            },
            deleteHint: function () {
    ...
    this.addSolution = function (interactionId, solution) {
        ...
        var addOrUpdateSolutionModal = protractor_1.element(protractor_1.by.css('.protractor-test-add-or-update-solution-modal'));
        waitFor.visibilityOf(addOrUpdateSolutionModal, 'Add/Update Solution modal takes to long to appear');
        interactions.getInteraction(interactionId).submitAnswer(protractor_1.element(protractor_1.by.css('.protractor-test-interaction-html')), solution.correctAnswer);
        protractor_1.element(protractor_1.by.css('.protractor-test-explanation-textarea'))
            .all(protractor_1.by.tagName('p')).first().click();
        protractor_1.browser.switchTo().activeElement().sendKeys(solution.explanation);
        var submitSolutionButton = protractor_1.element(protractor_1.by.css('.protractor-test-submit-solution-button'));
        waitFor.elementToBeClickable(submitSolutionButton, 'Submit Solution button takes too long to be clickable');
        submitSolutionButton.click();
        waitFor.invisibilityOf(addOrUpdateSolutionModal, 'Add/Update Solution modal takes too long to close');
    };
    // INTERACTIONS
    this.deleteInteraction = function () {
        waitFor.elementToBeClickable(deleteInteractionButton, 'Delete Interaction button is not clickable');
        deleteInteractionButton.click();
        // Click through the "are you sure?" warning.
        waitFor.elementToBeClickable(confirmDeleteInteractionButton, 'Confirm Delete Interaction button takes too long to be clickable');
        confirmDeleteInteractionButton.click();
        waitFor.invisibilityOf(confirmDeleteInteractionButton, 'Delete Interaction modal takes too long to close');
    };
    ...
    this.setInteraction = function (interactionId) {
        ...
        waitFor.invisibilityOf(addResponseHeader, 'Add Response modal takes too long to close');
    };
    ...
    var createNewInteraction = function (interactionId) {
        waitFor.invisibilityOf(deleteInteractionButton, 'Please delete interaction before creating a new one');
        waitFor.elementToBeClickable(addInteractionButton, 'Add Interaction button takes too long to be clickable');
    ...
    var customizeInteraction = function (interactionId) {
        if (arguments.length > 1) {
            ...
            interactions.getInteraction(interactionId).customizeInteraction.apply(null, customizationArgs);
        }
        ...
        waitFor.invisibilityOf(saveInteractionButton, 'Customize Interaction modal taking too long to close');
    };
    // This function should not usually be invoked directly; please consider
    // using setInteraction instead.
    ...
    var _setOutcomeFeedback = function (richTextInstructions) {
        var feedbackEditor = forms.RichTextEditor(feedbackBubble);
    ...
    this.addMultipleChoiceParameterChange = function (paramName, paramValues) {
        waitFor.elementToBeClickable(editParamChanges, 'Edit Param Changes is not clickable');
        editParamChanges.click();
        waitFor.elementToBeClickable(addParamButton, 'Add Param button is not clickable');
        ...
        var editorRowOption = editorRowElem.element(protractor_1.by.cssContainingText('option', 'to one of'));
        waitFor.elementToBeClickable(editorRowOption, 'Param Options are not clickable');
        ...
        waitFor.elementToBeClickable(saveParamChangesButton, 'Save Param Changes button is not clickable');
        saveParamChangesButton.click();
        waitFor.invisibilityOf(saveParamChangesButton, 'Param Changes editor takes too long to disappear');
    };
    ...
    this.addParameterChange = function (paramName, paramValue) {
        waitFor.elementToBeClickable(editParamChanges, 'Param Changes editor is not clickable');
        editParamChanges.click();
        waitFor.elementToBeClickable(addParamButton, 'Add Param button is not clickable');
        addParamButton.click();
        var editorRowElem = protractor_1.element.all(protractor_1.by.css('.protractor-test-param-changes-list')).last();
    ...
    var _setRuleParameters = function (ruleElement, interactionId, ruleName) {
        ...
        var answerDescriptionFragment = protractor_1.element.all(protractor_1.by.css('.protractor-test-answer-description-fragment'));
        for (var i = 0; i < parameterValues.length; i++) {
            ...
            if (interactionId === 'MultipleChoiceInput') {
                ...
                parameterElement.element(protractor_1.by.tagName('button')).click();
        ...
        if (placeholders) {
            ...
            placeholders.forEach(function (placeholderElement, index) {
                if (providedText[0] === '...') {
                    ...
                    ruleDescription = ruleDescription.replace(placeholderElement, providedText[index].toString());
                }
            });
        }
    ...
    var _selectRule = function (ruleElem, interactionId, ruleName) {
        ...
        var answerDescription = protractor_1.element(protractor_1.by.css('.protractor-test-answer-description'));
        expect(answerDescription.isDisplayed()).toBe(true);
        answerDescription.click();
        var ruleDropdownElement = protractor_1.element.all(protractor_1.by.cssContainingText('.select2-results__option', ruleDescriptionInDropdown)).first();
        waitFor.visibilityOf(ruleDropdownElement, 'Rule dropdown element takes too long to appear');
        ruleDropdownElement.click();
    };
    // STATE GRAPH
    this.deleteState = function (stateName) {
        general.scrollToTop();
        var nodeElement = explorationGraph.all(protractor_1.by.cssContainingText('.protractor-test-node', stateName)).first();
        waitFor.visibilityOf(nodeElement, 'State ' + stateName + ' takes too long to appear or does not exist');
        nodeElement.element(protractor_1.by.css('.protractor-test-delete-node')).click();
        expect(confirmDeleteStateButton.isDisplayed());
        confirmDeleteStateButton.click();
        waitFor.invisibilityOf(confirmDeleteStateButton, 'Deleting state takes too long');
    };
    ...
    this.moveToState = function (targetName) {
        ...
        stateNodes.map(function (stateElement) {
            ...
            if (!matched) {
                throw Error('State ' + targetName + ' not found by editorMainTab.moveToState.');
            }
        });
        var errorMessage = ('Current state name is:' +
            stateNameContainer.getAttribute('textContent') +
            'instead of expected ' + targetName);
        waitFor.textToBePresentInElement(stateNameContainer, targetName, errorMessage);
    };
    this.setStateName = function (name) {
        waitFor.invisibilityOf(postTutorialPopover, 'Post-tutorial popover takes too long to disappear');
        waitFor.elementToBeClickable(stateNameContainer, 'State Name Container takes too long to appear');
        stateNameContainer.click();
        stateNameInput.clear();
        stateNameInput.sendKeys(name);
        waitFor.elementToBeClickable(stateNameSubmitButton, 'State Name Submit button takes too long to be clickable');
        stateNameSubmitButton.click();
        // Wait for state name container to completely disappear
        // and re-appear again.
        waitFor.textToBePresentInElement(stateNameContainer, name, 'Current state name is:' + stateNameContainer.getAttribute('textContent') + 'instead of expected ' + name);
    };
    this.expectCurrentStateToBe = function (name) {
        waitFor.textToBePresentInElement(stateNameContainer, name, 'Expecting current state ' + stateNameContainer.getAttribute('textContent') + ' to be ' + name);
