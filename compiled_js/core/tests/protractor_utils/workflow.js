...
var publishExploration = function () {
    element(by.css('.protractor-test-publish-exploration')).isDisplayed().then(function () {
        element(by.css('.protractor-test-publish-exploration')).click();
    });
    var prePublicationButtonElem = element(by.css('.protractor-test-confirm-pre-publication'));
    ...
    var sharePublishModal = element(by.css('.protractor-test-share-publish-modal'));
    var closePublishModalButton = element(by.css('.protractor-test-share-publish-close'));
...
var _getExplorationRoles = function (roleName) {
    ...
    return element.all(by.repeater(itemName + ' in ExplorationRightsService.' + listName + ' track by $index')).map(function (elem) {
        return elem.getText();
    });
};
