...
var login = function (email, isSuperAdmin) {
    ...
    var driver = protractor_1.browser.driver;
...
var _completeSignup = function (username) {
    protractor_1.browser.get('/signup?return_url=http%3A%2F%2Flocalhost%3A9001%2F');
    waitFor.pageToFullyLoad();
    var usernameInput = protractor_1.element(protractor_1.by.css('.protractor-test-username-input'));
    var agreeToTermsCheckbox = protractor_1.element(protractor_1.by.css('.protractor-test-agree-to-terms-checkbox'));
    var registerUser = protractor_1.element(protractor_1.by.css('.protractor-test-register-user'));
