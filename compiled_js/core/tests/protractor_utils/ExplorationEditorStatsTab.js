...
var ExplorationEditorStatsTab = function () {
    /**
       ...
       */
    var numPassersby = protractor_1.element(protractor_1.by.css('.protractor-test-num-passersby'));
    var issueElementStr = '.protractor-test-issue';
    var issueTitle = protractor_1.element(protractor_1.by.css('.protractor-test-issue-title'));
    var resolveBtn = protractor_1.element(protractor_1.by.css('.protractor-test-issue-resolve'));
    /**
       * Workflows
       */
    ...
    var _getIssueElement = function (issueIndex) {
        return protractor_1.element(protractor_1.by.css(issueElementStr + issueIndex.toString()));
    };
