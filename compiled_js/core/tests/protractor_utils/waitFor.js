...
var alertToBePresent = function () {
    return browser.wait(until.alertIsPresent(), DEFAULT_WAIT_TIME_MSECS, 'Alert box took too long to appear.');
};
/**
...
var elementToBeClickable = function (element, errorMessage) {
    return browser.wait(until.elementToBeClickable(element), DEFAULT_WAIT_TIME_MSECS, errorMessage);
};
/**
...
var invisibilityOf = function (element, errorMessage) {
    return browser.wait(until.invisibilityOf(element), DEFAULT_WAIT_TIME_MSECS, errorMessage);
};
/**
...
var pageToFullyLoad = function () {
    ...
    return browser.wait(until.invisibilityOf(loadingMessage), 15000, 'Page takes more than 15 secs to load');
};
/**
...
var textToBePresentInElement = function (element, text, errorMessage) {
    return browser.wait(until.textToBePresentInElement(element, text), DEFAULT_WAIT_TIME_MSECS, errorMessage);
};
/**
...
var visibilityOf = function (element, errorMessage) {
    return browser.wait(until.visibilityOf(element), DEFAULT_WAIT_TIME_MSECS, errorMessage);
};
