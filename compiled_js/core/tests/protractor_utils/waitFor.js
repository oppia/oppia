...
// mobile device.
var DEFAULT_WAIT_TIME_MSECS = protractor_1.browser.isMobile ? 20000 : 10000;
var alertToBePresent = function () {
    return protractor_1.browser.wait(until.alertIsPresent(), DEFAULT_WAIT_TIME_MSECS, 'Alert box took too long to appear.');
};
/**
...
var elementToBeClickable = function (element, errorMessage) {
    return protractor_1.browser.wait(until.elementToBeClickable(element), DEFAULT_WAIT_TIME_MSECS, errorMessage);
};
/**
...
var invisibilityOf = function (element, errorMessage) {
    return protractor_1.browser.wait(until.invisibilityOf(element), DEFAULT_WAIT_TIME_MSECS, errorMessage);
};
/**
...
var pageToFullyLoad = function () {
    ...
    return protractor_1.browser.wait(until.invisibilityOf(loadingMessage), 15000, 'Page takes more than 15 secs to load');
};
/**
...
var textToBePresentInElement = function (element, text, errorMessage) {
    return protractor_1.browser.wait(until.textToBePresentInElement(element, text), DEFAULT_WAIT_TIME_MSECS, errorMessage);
};
/**
...
var visibilityOf = function (element, errorMessage) {
    return protractor_1.browser.wait(until.visibilityOf(element), DEFAULT_WAIT_TIME_MSECS, errorMessage);
};
