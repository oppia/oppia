...
describe('Skill Editor functionality', function () {
    ...
    beforeAll(function () {
        ...
        users.createAndLoginAdminUser('creator@skillEditor.com', 'creatorSkillEditor');
    ...
    it('should edit description and concept card explanation', function () {
        ...
        skillEditorPage.saveOrPublishSkill('Changed skill description and added review material.');
        topicsAndSkillsDashboardPage.get();
        topicsAndSkillsDashboardPage.expectSkillDescriptionToBe('Skill 1 edited', 0);
        skillEditorPage.get(skillId);
        skillEditorPage.expectSkillDescriptionToBe('Skill 1 edited');
        skillEditorPage.expectConceptCardExplanationToMatch('Test concept card explanation');
    });
    ...
    it('should create and delete misconceptions', function () {
        skillEditorPage.addMisconception('Misconception 1', 'Notes 1', 'Feedback 1');
        skillEditorPage.addMisconception('Misconception 2', 'Notes 2', 'Feedback 2');
