...
describe('Core exploration functionality', function () {
    ...
    it('should open appropriate modal on re-clicking an interaction to ' +
        ...
        explorationEditorMainTab.setInteraction('NumericInput');
        protractor_1.element(protractor_1.by.css('.protractor-test-interaction')).click();
        var okayBtn = protractor_1.element(protractor_1.by.css('.protractor-test-close-no-customization-modal'));
        ...
        explorationEditorMainTab.setInteraction('Continue');
        protractor_1.element(protractor_1.by.css('.protractor-test-interaction')).click();
        var saveInteractionBtn = protractor_1.element(protractor_1.by.css('.protractor-test-save-interaction'));
