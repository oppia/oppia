...
describe('Topic editor functionality', function () {
    ...
    beforeAll(function () {
        ...
        users.createAndLoginAdminUser('creator@topicEditor.com', 'creatorTopicEditor');
    ...
    it('should edit subtopic page contents correctly', function () {
        ...
        topicEditorPage.changeSubtopicPageContents(forms.toRichText('Subtopic Contents'));
    ...
    it('should create a question for a skill in the topic', function () {
        ...
        browser.getCurrentUrl().then(function (url) {
            ...
            explorationEditorMainTab.addResponse('TextInput', forms.toRichText('Correct Answer'), null, false, 'FuzzyEquals', 'correct');
