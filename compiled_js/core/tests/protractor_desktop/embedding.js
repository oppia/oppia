...
describe('Embedding', function () {
    ...
    it('should display and play embedded explorations', function () {
        ...
        general.getExplorationIdFromEditor().then(function (expId) {
            ...
            for (var i = 0; i < TEST_PAGES.length; i++) {
                ...
                driver.findElement(by.css('.protractor-test-exploration-id-input-field')).sendKeys(explorationId);
                driver.findElement(by.css('.protractor-test-exploration-id-submit-button')).click();
                // Test of standard loading (new and old versions).
                browser.switchTo().frame(driver.findElement(by.css('.protractor-test-standard > iframe')));
                playCountingExploration(3);
                browser.switchTo().defaultContent();
                if (TEST_PAGES[i].isVersion1) {
                    // Test of deferred loading (old version).
                    driver.findElement(by.css('.protractor-test-old-version > oppia > div > button')).click();
                }
                browser.switchTo().frame(driver.findElement(by.css('.protractor-test-old-version > iframe')));
    ...
    it('should use the exploration language as site language.', function () {
        ...
        var checkPlaceholder = function (expectedPlaceholder) {
            ...
            driver.findElement(by.css('.protractor-test-exploration-id-input-field')).sendKeys(explorationId);
            driver.findElement(by.css('.protractor-test-exploration-id-submit-button')).click();
            browser.switchTo().frame(driver.findElement(by.css('.protractor-test-embedded-exploration > iframe')));
            waitFor.pageToFullyLoad();
