...
describe('Learner dashboard functionality', function () {
    ...
    it('displays learners subscriptions', function () {
        ...
        users.createUser(creator2Id + '@learnerDashboard.com', creator2Id);
        users.login(creator1Id + '@learnerDashboard.com');
        workflow.createAndPublishExploration('Activations', 'Chemistry', 'Learn about different types of chemistry activations.', 'English');
        users.logout();
    ...
    it('displays learner feedback threads', function () {
        ...
        users.createUser('feedbackAdm@learnerDashboard.com', 'feedbackAdmlearnerDashboard');
        users.login('feedbackAdm@learnerDashboard.com');
        workflow.createAndPublishExploration('BUS101', 'Business', 'Learn about different business regulations around the world.', 'English');
        users.logout();
