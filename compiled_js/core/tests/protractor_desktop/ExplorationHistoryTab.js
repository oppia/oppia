...
describe('Exploration history', function () {
    ...
    it('should display the history', function () {
        ...
        explorationEditorMainTab.setContent(forms.toRichText('enter 6 to continue'));
        explorationEditorMainTab.setInteraction('NumericInput');
        explorationEditorMainTab.addResponse('NumericInput', null, 'second', true, 'Equals', 6);
        ...
        var STATE_2_STRING = 'classifier_model_id: null\n' +
            'content:\n' +
            '  content_id: content\n' +
        ...
        historyGraph.expectTextWithHighlightingToMatch(VERSION_1_STATE_1_CONTENTS, VERSION_2_STATE_1_CONTENTS);
