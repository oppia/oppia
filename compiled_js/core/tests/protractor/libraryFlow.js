...
describe('Library pages tour', function () {
    ...
    var visitRecentlyPublishedPage = function () {
        protractor_1.browser.get('library/recently_published');
    ...
    it('visits the search page', function () {
        ...
        expect(protractor_1.browser.getCurrentUrl()).toContain('search/find?q=python');
    });
    ...
    it('visits the top rated page', function () {
        ...
        rateExploration();
        libraryPage.get();
        protractor_1.element(protractor_1.by.css('.protractor-test-library-top-rated')).click();
        waitFor.pageToFullyLoad();
        expect(protractor_1.browser.getCurrentUrl()).toContain('library/top_rated');
    });
    it('visits the recent explorations page', function () {
        visitRecentlyPublishedPage();
        expect(protractor_1.browser.getCurrentUrl()).toContain('library/recently_published');
    });
    afterEach(function () {
...
describe('Rating', function () {
    ...
    it('should display ratings on exploration when minimum ratings have been ' +
        ...
        if (protractor_1.browser.isMobile) {
            ...
            workflow.createAndPublishExploration(EXPLORATION_RATINGTEST, CATEGORY_BUSINESS, 'this is an objective', LANGUAGE_ENGLISH);
        }
        users.logout();
