...
describe('Learner dashboard functionality', function () {
    ...
    it('displays incomplete and completed collections', function () {
        ...
        var firstExploration = browser.isMobile ? element.all(by.css('.protractor-mobile-test-collection-exploration')).first() :
        ...
        if (browser.isMobile) {
            ...
            var playExploration = element(by.css('.protractor-test-play-exploration-button'));
