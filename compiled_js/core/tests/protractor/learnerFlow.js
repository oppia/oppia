...
describe('Learner dashboard functionality', function () {
    ...
    var oppiaLogo = protractor_1.element(protractor_1.by.css('.protractor-test-oppia-main-logo'));
    ...
    var clickContinueButton = function () {
        waitFor.elementToBeClickable(continueButton, 'Could not click continue button');
    ...
    var createDummyExplorationOnDesktop = function () {
        ...
        explorationEditorMainTab.setContent(forms.toRichText('Hi there, I’m Oppia! I’m an online personal tutor for everybody!'));
        ...
        explorationEditorMainTab.setContent(forms.toRichText('So what can I tell you?'));
        ...
        explorationEditorMainTab.addResponse('MultipleChoiceInput', null, 'End Card', true, 'Equals', 'Those were all the questions I had!');
    ...
    beforeAll(function () {
        ...
        if (!protractor_1.browser.isMobile) {
    ...
    it('visits the exploration player and plays the correct exploration', function () {
        users.createUser('expCreator@learnerDashboard.com', 'expCreator');
        ...
        if (protractor_1.browser.isMobile) {
            ...
            workflow.createAndPublishExploration('Exploration Player Test', 'Astronomy', 'To test the exploration player', 'English');
        }
        users.logout();
        var PLAYER_USERNAME = 'expPlayerDesktopAndMobile';
        users.createAndLoginUser('expPlayerDesktopAndMobile@learnerFlow.com', PLAYER_USERNAME);
        libraryPage.get();
        libraryPage.findExploration('Exploration Player Test');
        libraryPage.playExploration('Exploration Player Test');
    });
    it('visits the collection player and plays the correct collection', function () {
        users.createUser('expOfCollectionCreator@learnerDashboard.com', 'expOfCollectionCreator');
        ...
        if (protractor_1.browser.isMobile) {
            ...
            workflow.createAndPublishExploration('Demo Exploration', 'Algebra', 'To test collection player', 'English');
            ...
            collectionEditorPage.searchForAndAddExistingExploration('Demo Exploration');
            ...
            collectionEditorPage.setObjective('This is a collection to test player.');
        ...
        users.createAndLoginUser('collectionPlayerDesktopAndMobile@learnerFlow.com', PLAYER_USERNAME);
        libraryPage.get();
    ...
    it('displays incomplete and completed explorations', function () {
        users.createUser('originalCreator@learnerDashboard.com', 'originalCreator');
        ...
        if (protractor_1.browser.isMobile) {
            ...
            workflow.createAndPublishExploration('Test Exploration', 'Astronomy', 'To expand the horizon of the minds!', 'English');
        }
        users.logout();
        users.createAndLoginUser('learner@learnerDashboard.com', 'learnerlearnerDashboard');
        ...
        if (protractor_1.browser.isMobile) {
            ...
            explorationPlayerPage.expectExplorationNameToBe('Dummy Exploration');
            explorationPlayerPage.submitAnswer('Continue', null);
            explorationPlayerPage.submitAnswer('MultipleChoiceInput', 'Those were all the questions I had!');
        }
        ...
        if (!protractor_1.browser.isMobile) {
            ...
            users.createAndLoginAdminUser('inspector@learnerDashboard.com', 'inspector');
            libraryPage.get();
            libraryPage.findExploration('Dummy Exploration');
            libraryPage.playExploration('Dummy Exploration');
            ...
            learnerDashboardPage.expectTitleOfExplorationSummaryTileToMatch('Test Exploration');
            learnerDashboardPage.expectTitleOfExplorationSummaryTileToBeHidden('Dummy Exploration');
        }
    });
    it('displays incomplete and completed collections', function () {
        users.createUser('explorationCreator@learnerDashboard.com', 'explorationCreator');
        ...
        if (protractor_1.browser.isMobile) {
            ...
            workflow.createAndPublishExploration('Collection Exploration', 'Architect', 'To be a part of a collection!', 'English');
            // Update the role of the user to admin since only admin users
            // can create a collection.
            adminPage.get();
            ...
            workflow.createCollectionAsAdmin();
            collectionEditorPage.searchForAndAddExistingExploration('Dummy Exploration');
            collectionEditorPage.saveDraft();
            collectionEditorPage.closeSaveModal();
            collectionEditorPage.publishCollection();
        ...
        users.logout();
        users.createAndLoginUser('learner4@learnerDashboard.com', 'learner4learnerDashboard');
        ...
        var firstExploration = protractor_1.browser.isMobile ? protractor_1.element.all(protractor_1.by.css('.protractor-mobile-test-collection-exploration')).first() :
            protractor_1.element.all(protractor_1.by.css('.protractor-test-collection-exploration')).first();
        // Click first exploration in collection.
        waitFor.elementToBeClickable(firstExploration, 'Could not click first exploration in collection');
        ...
        if (protractor_1.browser.isMobile) {
            ...
            var playExploration = protractor_1.element(protractor_1.by.css('.protractor-test-play-exploration-button'));
            waitFor.elementToBeClickable(playExploration, 'Could not click play exploration button');
        ...
        if (!protractor_1.browser.isMobile) {
            ...
            var collectionsTab = protractor_1.element(protractor_1.by.css('.protractor-test-collections-tab'));
            collectionsTab.click();
            creatorDashboardPage.navigateToCollectionEditor();
            collectionEditorPage.searchForAndAddExistingExploration('Collection Exploration');
            collectionEditorPage.saveDraft();
