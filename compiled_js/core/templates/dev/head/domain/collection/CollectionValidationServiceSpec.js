...
describe('Collection validation service', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        _sampleCollection = CollectionObjectFactory.create(sampleCollectionBackendObject);
    ...
    var _findPrivateValidationIssues = function () {
        return CollectionValidationService.findValidationIssuesForPrivateCollection(_sampleCollection);
    };
    var _findPublicValidationIssues = function () {
        return CollectionValidationService.findValidationIssuesForPublicCollection(_sampleCollection);
    };
    ...
    it('should detect nonexistent/inaccessible explorations', function () {
        expect(_addCollectionNode('exp_id1', DOES_NOT_EXIST, PRIVATE_STATUS)).toBe(true);
    ...
    it('should allow private and public explorations in a private collection', function () {
    ...
    it('should not allow private explorations in a public collection', function () {
    ...
    it('should return false if the tags are not valid', function () {
        ...
        expect(CollectionValidationService.isTagValid(['test', 'test'])).toBe(false);
        expect(CollectionValidationService.isTagValid(['test '])).toBe(false);
    });
});
