...
describe('Collection update service', function () {
    ...
    it('should add/remove a new collection node to/from a collection', function () {
        expect(_sampleCollection.getExplorationIds()).toEqual(['exp_id0']);
        CollectionUpdateService.addCollectionNode(_sampleCollection, 'exp_id1', _sampleExplorationSummaryBackendObject);
    ...
    it('should create a proper backend change dict for adding collection nodes', function () {
        CollectionUpdateService.addCollectionNode(_sampleCollection, 'exp_id1', _sampleExplorationSummaryBackendObject);
    ...
    it('should create a proper backend change dict for deleting collection nodes', function () {
    ...
    it('should create a proper backend change dict for changing titles', function () {
        CollectionUpdateService
    ...
    it('should set/unset changes to a collection\'s category', function () {
        ...
        CollectionUpdateService.setCollectionCategory(_sampleCollection, 'new category');
        expect(_sampleCollection.getCategory()).toEqual('new category');
        UndoRedoService.undoChange(_sampleCollection);
        expect(_sampleCollection.getCategory()).toEqual('a category');
    });
    it('should create a proper backend change dict for changing categories', function () {
        CollectionUpdateService.setCollectionCategory(_sampleCollection, 'new category');
        expect(UndoRedoService.getCommittableChangeList()).toEqual([{
                cmd: 'edit_collection_property',
    ...
    it('should set/unset changes to a collection\'s objective', function () {
        ...
        CollectionUpdateService.setCollectionObjective(_sampleCollection, 'new objective');
        expect(_sampleCollection.getObjective()).toEqual('new objective');
        UndoRedoService.undoChange(_sampleCollection);
        expect(_sampleCollection.getObjective()).toEqual('an objective');
    });
    it('should create a proper backend change dict for changing objectives', function () {
        CollectionUpdateService.setCollectionObjective(_sampleCollection, 'new objective');
        expect(UndoRedoService.getCommittableChangeList()).toEqual([{
                cmd: 'edit_collection_property',
    ...
    it('should create a proper backend change dict for changing tags', function () {
        CollectionUpdateService.setCollectionTags(_sampleCollection, ['test']);
        expect(UndoRedoService.getCommittableChangeList()).toEqual([{
                cmd: 'edit_collection_property',
                property_name: 'tags',
