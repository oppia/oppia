...
describe('Subtopic object factory', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        _sampleSubtopic = SubtopicObjectFactory.create(sampleSubtopicBackendObject, sampleSkillIdToDesriptionMap);
    }));
    ...
    it('should validate the subtopic', function () {
        ...
        expect(_sampleSubtopic.validate()).toEqual(['Subtopic title should not be empty']);
    });
    it('should be able to create a subtopic object with given title and id', function () {
    ...
    it('should correctly remove a skill id', function () {
        ...
        expect(_sampleSubtopic.getSkillSummaries()[0].getDescription()).toEqual('Description 2');
    });
});
