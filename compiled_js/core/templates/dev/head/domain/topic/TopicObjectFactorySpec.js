...
describe('Topic object factory', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        _sampleTopic = TopicObjectFactory.create(sampleTopicBackendObject, skillIdToDescriptionDict);
    }));
    ...
    it('should correctly remove the various array elements', function () {
        ...
        expect(_sampleTopic.getUncategorizedSkillSummaries()[0].getId()).toEqual('skill_2');
        expect(_sampleTopic.getUncategorizedSkillSummaries()[0].getDescription()).toEqual('Description 2');
    });
