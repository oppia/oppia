...
describe('Skill update service', function () {
    var SkillUpdateService, SubtitledHtmlObjectFactory, SkillObjectFactory, MisconceptionObjectFactory, UndoRedoService;
    var skillDict;
    ...
    it('should set/unset the concept card explanation', function () {
        var skill = SkillObjectFactory.createFromBackendDict(skillDict);
        SkillUpdateService.setConceptCardExplanation(skill, SubtitledHtmlObjectFactory.createDefault('new explanation', 'explanation'));
        expect(UndoRedoService.getCommittableChangeList()).toEqual([{
        ...
        expect(skill.getConceptCard().getExplanation()).toEqual(SubtitledHtmlObjectFactory.createDefault('new explanation', 'explanation'));
        UndoRedoService.undoChange(skill);
        expect(skill.getConceptCard().getExplanation()).toEqual(SubtitledHtmlObjectFactory.createDefault('test explanation', 'explanation'));
    });
    it('should add a misconception', function () {
        ...
        var aNewMisconception = MisconceptionObjectFactory.createFromBackendDict(aNewMisconceptionDict);
    ...
    it('should update the name of a misconception', function () {
        var skill = SkillObjectFactory.createFromBackendDict(skillDict);
        SkillUpdateService.updateMisconceptionName(skill, '2', skill.findMisconceptionById('2').getName(), 'new name');
        expect(UndoRedoService.getCommittableChangeList()).toEqual([{
    ...
    it('should update the notes of a misconception', function () {
        var skill = SkillObjectFactory.createFromBackendDict(skillDict);
        SkillUpdateService.updateMisconceptionNotes(skill, '2', skill.findMisconceptionById('2').getNotes(), 'new notes');
        expect(UndoRedoService.getCommittableChangeList()).toEqual([{
                cmd: 'update_skill_misconceptions_property',
                property_name: 'notes',
    ...
    it('should update the feedback of a misconception', function () {
        var skill = SkillObjectFactory.createFromBackendDict(skillDict);
        SkillUpdateService.updateMisconceptionFeedback(skill, '2', skill.findMisconceptionById('2').getFeedback(), 'new feedback');
        expect(UndoRedoService.getCommittableChangeList()).toEqual([{
                cmd: 'update_skill_misconceptions_property',
    ...
    it('should add a worked example', function () {
        var skill = SkillObjectFactory.createFromBackendDict(skillDict);
        SkillUpdateService.addWorkedExample(skill, SubtitledHtmlObjectFactory.createDefault('a new worked example', 'worked_example_3'));
        expect(UndoRedoService.getCommittableChangeList()).toEqual([{
                cmd: 'update_skill_contents_property',
        ...
        expect(skill.getConceptCard().getWorkedExamples()).toEqual([
            SubtitledHtmlObjectFactory.createDefault('test worked example 1', 'worked_example_1'),
            SubtitledHtmlObjectFactory.createDefault('test worked example 2', 'worked_example_2'),
            SubtitledHtmlObjectFactory.createDefault('a new worked example', 'worked_example_3')
        ]);
        UndoRedoService.undoChange(skill);
        expect(skill.getConceptCard().getWorkedExamples()).toEqual([
            SubtitledHtmlObjectFactory.createDefault('test worked example 1', 'worked_example_1'),
    ...
    it('should update a worked example', function () {
        ...
        expect(skill.getConceptCard().getWorkedExamples()).toEqual([
            SubtitledHtmlObjectFactory.createDefault('new content', 'worked_example_1'),
            SubtitledHtmlObjectFactory.createDefault('test worked example 2', 'worked_example_2')
        ]);
        UndoRedoService.undoChange(skill);
        expect(skill.getConceptCard().getWorkedExamples()).toEqual([
