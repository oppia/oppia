...
describe('Skill object factory', function () {
    ...
    describe('SkillObjectFactory', function () {
        ...
        it('should create a new skill from a backend dictionary', function () {
            ...
            expect(skill.getMisconceptions()).toEqual([MisconceptionObjectFactory.createFromBackendDict(misconceptionDict1),
                MisconceptionObjectFactory.createFromBackendDict(misconceptionDict2)]);
            expect(skill.getConceptCard()).toEqual(ConceptCardObjectFactory.createFromBackendDict(skillContentsDict));
        ...
        it('should delete a misconception given its id', function () {
            ...
            expect(skill.getMisconceptions()).toEqual([MisconceptionObjectFactory.createFromBackendDict(misconceptionDict2)]);
        });
        ...
        it('should be able to create an interstitial skill', function () {
            ...
            expect(skill.getConceptCard()).toEqual(ConceptCardObjectFactory.createInterstitialConceptCard());
            expect(skill.getLanguageCode()).toEqual('en');
