...
oppia.factory('SkillObjectFactory', [
    ...
    function (ConceptCardObjectFactory, MisconceptionObjectFactory, ValidatorsService) {
        var Skill = function (id, description, misconceptions, conceptCard, languageCode, version, nextMisconceptionId, supersedingSkillId, allQuestionsMerged) {
            this._id = id;
        ...
        Skill.hasValidDescription = function (description) {
            ...
            return ValidatorsService.isValidEntityName(description, showWarnings, allowDescriptionToBeBlank);
        };
        ...
        Skill.createFromBackendDict = function (skillBackendDict) {
            return new Skill(skillBackendDict.id, skillBackendDict.description, generateMisconceptionsFromBackendDict(skillBackendDict.misconceptions), ConceptCardObjectFactory.createFromBackendDict(skillBackendDict.skill_contents), skillBackendDict.language_code, skillBackendDict.version, skillBackendDict.next_misconception_id, skillBackendDict.superseding_skill_id, skillBackendDict.all_questions_merged);
        };
        ...
        Skill.createInterstitialSkill = function () {
            return new Skill(null, 'Skill description loading', [], ConceptCardObjectFactory.createInterstitialConceptCard(), 'en', 1, 0, null, false);
        };
        var generateMisconceptionsFromBackendDict = function (misconceptionsBackendDicts) {
            return misconceptionsBackendDicts.map(function (misconceptionsBackendDict) {
        ...
        Skill.prototype.appendMisconception = function (newMisconception) {
            ...
            this._nextMisconceptionId = this.getIncrementedMisconceptionId(newMisconception.getId());
        };
