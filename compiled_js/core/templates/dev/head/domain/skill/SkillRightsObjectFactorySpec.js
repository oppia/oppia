...
describe('Skill rights object factory', function () {
    ...
    it('should be able to set public', function () {
        ...
        var skillRights = SkillRightsObjectFactory.createFromBackendDict(initialSkillRightsBackendObject);
    ...
    it('should create an interstitial skill rights object', function () {
        var interstitialSkillRights = SkillRightsObjectFactory.createInterstitialSkillRights();
    ...
    it('should make a copy from another skill rights object', function () {
        ...
        var sampleSkillRights = SkillRightsObjectFactory.createFromBackendDict(sampleSkillRightsObject);
        var interstitialSkillRights = SkillRightsObjectFactory.createInterstitialSkillRights();
