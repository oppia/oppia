...
describe('Learner dashboard activity ids object factory', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        LearnerDashboardActivityIdsObjectFactory = $injector.get('LearnerDashboardActivityIdsObjectFactory');
    }));
    ...
    it('should check if activity id is present among learner dashboard ' +
        ...
        var learnerDashboardActivityIds = (LearnerDashboardActivityIdsObjectFactory.createFromBackendDict(learnerDashboardActivityIdsDict));
    ...
    it('should add exploration to learner playlist', function () {
        ...
        expect(learnerDashboardActivityIds.explorationPlaylistIds).toEqual(['8', '9', '12']);
        learnerDashboardActivityIds.addToExplorationLearnerPlaylist('13');
        expect(learnerDashboardActivityIds.explorationPlaylistIds).toEqual(['8', '9', '12', '13']);
    });
    it('should add collection to learner playlist', function () {
        var learnerDashboardActivityIds = (LearnerDashboardActivityIdsObjectFactory.createFromBackendDict(learnerDashboardActivityIdsDict));
        learnerDashboardActivityIds.addToCollectionLearnerPlaylist('12');
        expect(learnerDashboardActivityIds.collectionPlaylistIds).toEqual(['10', '11', '12']);
        learnerDashboardActivityIds.addToCollectionLearnerPlaylist('13');
        expect(learnerDashboardActivityIds.collectionPlaylistIds).toEqual(['10', '11', '12', '13']);
    });
    it('should remove exploration from learner playlist', function () {
        ...
        expect(learnerDashboardActivityIds.explorationPlaylistIds).toEqual(['8', '12', '13']);
        learnerDashboardActivityIds.removeFromExplorationLearnerPlaylist('8');
        expect(learnerDashboardActivityIds.explorationPlaylistIds).toEqual(['12', '13']);
    });
    it('should remove collection from learner playlist', function () {
        ...
        expect(learnerDashboardActivityIds.collectionPlaylistIds).toEqual(['10', '12', '13']);
        learnerDashboardActivityIds.removeFromCollectionLearnerPlaylist('10');
        expect(learnerDashboardActivityIds.collectionPlaylistIds).toEqual(['12', '13']);
    });
    it('should fetch the learner dashboard activity ids domain object from the ' +
        ...
        var learnerDashboardActivityIds = (LearnerDashboardActivityIdsObjectFactory.createFromBackendDict(learnerDashboardActivityIdsDict));
        expect(learnerDashboardActivityIds.incompleteExplorationIds).toEqual(['0', '1']);
        expect(learnerDashboardActivityIds.incompleteCollectionIds).toEqual(['2', '3']);
        expect(learnerDashboardActivityIds.completedExplorationIds).toEqual(['4', '5']);
        expect(learnerDashboardActivityIds.completedCollectionIds).toEqual(['6', '7']);
        expect(learnerDashboardActivityIds.explorationPlaylistIds).toEqual(['8', '9']);
        expect(learnerDashboardActivityIds.collectionPlaylistIds).toEqual(['10', '11']);
    });
});
