...
oppia.factory('StateCardObjectFactory', [
    ...
    function (AudioTranslationLanguageService, ExplorationHtmlFormatterService, INTERACTION_DISPLAY_MODE_INLINE, INTERACTION_SPECS) {
        var StateCard = function (stateName, contentHtml, interactionHtml, interaction, inputResponsePairs, contentIdsToAudioTranslations, contentId) {
        ...
        StateCard.prototype.isContentAudioTranslationAvailable = function () {
            return Object.keys(this.getAudioTranslations()).length > 0 ||
         ...
         */
        StateCard.createNewCard = function (stateName, contentHtml, interactionHtml, interaction, contentIdsToAudioTranslations, contentId) {
            return new StateCard(stateName, contentHtml, interactionHtml, interaction, [], contentIdsToAudioTranslations, contentId);
        };
        return StateCard;
    }
]);
