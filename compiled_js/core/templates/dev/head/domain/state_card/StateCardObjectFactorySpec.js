...
describe('State card object factory', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        _sampleCard = StateCardObjectFactory.createNewCard('State 1', '<p>Content</p>', '<interaction></interaction>', InteractionObjectFactory.createFromBackendDict(interactionDict), ContentIdsToAudioTranslationsObjectFactory.createFromBackendDict({
            content: {
                en: {
    ...
    it('should be able to get the various fields', function () {
        ...
        expect(_sampleCard.getInteractionHtml()).toEqual('<interaction></interaction>');
        ...
        expect(_sampleCard.getContentIdsToAudioTranslations().
    ...
    it('should be able to set the various fields', function () {
        ...
        expect(_sampleCard.getInteractionHtml()).toEqual('<interaction_2></interaction_2>');
        _sampleCard.addInputResponsePair({
            oppiaResponse: 'response'
        });
