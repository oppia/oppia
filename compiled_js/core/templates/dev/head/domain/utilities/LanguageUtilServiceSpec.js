...
describe('Language util service', function () {
    ...
    beforeEach(function () {
        module('oppia', function ($provide) {
            ...
            $provide.constant('ALL_LANGUAGE_CODES', mockAllLanguageCodes);
            $provide.constant('AUTOGENERATED_AUDIO_LANGUAGES', mockAutogeneratedAudioLanguages);
            $provide.constant('SUPPORTED_AUDIO_LANGUAGES', mockSupportedAudioLanguages);
    ...
    it('should get the correct description given an audio language code', function () {
    ...
    it('should correctly get related language code given audio language code', function () {
    ...
    it('should correctly check if language supports autogenerated audio', function () {
        // Chrome loads voices asynchronously.
        // https://stackoverflow.com/questions/21513706/
        window.speechSynthesis.onvoiceschanged = function () {
    ...
    it('should get correct autogenerated audio language with given code', function () {
        expect(Object.values(lus.getAutogeneratedAudioLanguage('en'))).toEqual(Object.values(mockAutogeneratedAudioLanguages[0]));
    });
