...
oppia.factory('PlaythroughImprovementCardObjectFactory', [
    ...
    function ($uibModal, ImprovementActionButtonObjectFactory, PlaythroughIssuesService, UrlInterpolationService, PLAYTHROUGH_IMPROVEMENT_CARD_TYPE) {
        /**
         * @constructor
        ...
        var PlaythroughImprovementCard = function (issue) {
            ...
            var discardThis = function () {
                return $uibModal.open({
                    templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/confirmation_modal_directive.html'),
                    backdrop: true,
                    controller: [
            ...
            this._actionButtons = [
                ImprovementActionButtonObjectFactory.createNew('Discard', discardThis, 'btn-danger'),
            ];
