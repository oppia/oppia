...
oppia.factory('FeedbackThreadSummaryObjectFactory', [function () {
        ...
        FeedbackThreadSummary.create = function (status, originalAuthorId, lastUpdated, lastMessageText, totalMessageCount, lastMessageRead, secondLastMessageRead, authorLastMessage, authorSecondLastMessage, explorationTitle, explorationId, threadId) {
        ...
        FeedbackThreadSummary.createFromBackendDict = function (feedbackThreadSummaryBackendDict) {
