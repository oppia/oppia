...
oppia.factory('StateObjectFactory', [
    ...
    'ParamChangesObjectFactory', 'SubtitledHtmlObjectFactory', function (ContentIdsToAudioTranslationsObjectFactory, InteractionObjectFactory, ParamChangesObjectFactory, SubtitledHtmlObjectFactory) {
        var State = function (name, classifierModelId, content, interaction, paramChanges, contentIdsToAudioTranslations) {
            this.name = name;
