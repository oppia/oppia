...
].concat(window.GLOBALS ? (window.GLOBALS.ADDITIONAL_ANGULAR_MODULES || []) : []));
...
oppia.config([
    ...
    function ($compileProvider, $httpProvider, $interpolateProvider, $locationProvider, $cookiesProvider) {
