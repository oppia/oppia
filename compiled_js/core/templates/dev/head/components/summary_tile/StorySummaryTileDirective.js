...
oppia.directive('storySummaryTile', [
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/summary_tile/story_summary_tile_directive.html'),
            controller: ['$scope',
                function ($scope) {
                    $scope.getStoryLink = function () {
                        return UrlInterpolationService.getStoryUrl('/story', $scope.getStoryId());
                    };
