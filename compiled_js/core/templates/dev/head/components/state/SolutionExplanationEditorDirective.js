...
oppia.directive('solutionExplanationEditor', [
    ...
    function (StateSolutionService, UrlInterpolationService) {
        return {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/state/solution_explanation_editor_directive.html'),
            controller: [
                    ...
                    $scope.saveThisExplanation = function () {
                        ...
                        if (contentHasChanged) {
                            var solutionContentId = StateSolutionService.displayed.explanation
                                .getContentId();
                            $scope.showMarkAllAudioAsNeedingUpdateModalIfRequired(solutionContentId);
                        }
