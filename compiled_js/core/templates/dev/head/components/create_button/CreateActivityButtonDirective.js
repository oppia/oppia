...
oppia.directive('createActivityButton', [
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            restrict: 'E',
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/create_button/create_activity_button_directive.html'),
            controller: [
                ...
                function ($scope, $timeout, $window, $uibModal, ExplorationCreationService, CollectionCreationService, SiteAnalyticsService, UrlService, UserService, ALLOW_YAML_FILE_UPLOAD) {
                    ...
                    $scope.showUploadExplorationModal = (ExplorationCreationService.showUploadExplorationModal);
                    ...
                    $scope.initCreationProcess = function () {
                        ...
                        if (!$scope.canCreateCollections) {
                            ...
                            $uibModal.open({
                                templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/pages/creator_dashboard/' +
