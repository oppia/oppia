            ...
            controller: [
                ...
                function ($scope, $timeout, StateEditorService, ValidatorsService, INTERACTION_SPECS, ResponsesService, StateInteractionIdService) {
                    ...
                    var computeRuleDescriptionFragments = function () {
                        ...
                        var ruleDescription = (INTERACTION_SPECS[$scope.currentInteractionId].rule_descriptions[$scope.rule.type]);
                            ...
                            if (answerChoices) {
                                ...
                                if (answerChoices.length > 0) {
                                    if (finalInputArray[2] === 'SetOfHtmlString') {
                                        $scope.ruleDescriptionChoices = answerChoices.map(function (choice) {
                                            return {
                                                id: choice.label,
                                                val: choice.label
                                            };
