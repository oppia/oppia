...
describe('Testing filters', function () {
    ...
    it('should truncate multi-line text to the first non-empty line', inject(function ($filter) {
    ...
    it('should summarize large number to at most 4 s.f. and append metric prefix', inject(function ($filter) {
    ...
    it('should get correct list of RTE components from HTML input', inject(function ($filter) {
    ...
    it('should correctly display RTE components in Answer Group Header', inject(function ($filter) {
        var ruleMath = {
            type: 'Equals',
            inputs: {
                x: 2
    ...
    it('should correctly parameterize rule description filter', inject(function ($filter) {
