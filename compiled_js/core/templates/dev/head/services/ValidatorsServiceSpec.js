...
describe('Validators service', function () {
    ...
    describe('validators service', function () {
        ...
        it('should correctly validate exploration titles', function () {
            ...
            expect(vs.isValidExplorationTitle('A title with invalid characters #')).toBe(false);
            expect(vs.isValidExplorationTitle('A title that is toooooooooooooooooooooooooo too long.')).toBe(false);
        });
