...
describe('Speech Synthesis Chunker Service', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        SpeechSynthesisChunkerService = $injector.get('SpeechSynthesisChunkerService');
    }));
    it('Should properly convert subtraction in LaTeX to speakable text', function () {
        var latex1 = '5-3';
        var latex2 = 'i-j';
        var speakableLatex1 = SpeechSynthesisChunkerService.formatLatexToSpeakableText(latex1);
        var speakableLatex2 = SpeechSynthesisChunkerService.formatLatexToSpeakableText(latex2);
        expect(speakableLatex1).toEqual('5 minus 3');
        expect(speakableLatex2).toEqual('i minus j');
    });
    it('Should properly convert fractions in LaTeX to speakable text', function () {
        var latex1 = '\\\\frac{2}{3}';
        ...
        var speakableLatex1 = SpeechSynthesisChunkerService.formatLatexToSpeakableText(latex1);
        var speakableLatex2 = SpeechSynthesisChunkerService.formatLatexToSpeakableText(latex2);
        var speakableLatex3 = SpeechSynthesisChunkerService.formatLatexToSpeakableText(latex3);
        var speakableLatex4 = SpeechSynthesisChunkerService.formatLatexToSpeakableText(latex4);
    ...
    it('Should properly convert square roots in LaTeX to speakable text', function () {
        var latex1 = '\\\\sqrt{3}';
        var latex2 = '\\\\sqrt{xy}';
        var speakableLatex1 = SpeechSynthesisChunkerService.formatLatexToSpeakableText(latex1);
        var speakableLatex2 = SpeechSynthesisChunkerService.formatLatexToSpeakableText(latex2);
    ...
    it('Should properly convert exponents in LaTeX to speakable text', function () {
        var latex1 = 'x^2';
        var latex2 = '42^4';
        var latex3 = 'x^62';
        var latex4 = '3n^4x';
