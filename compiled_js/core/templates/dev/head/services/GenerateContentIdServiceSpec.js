...
describe('GenerateContentIdService', function () {
    ...
    it('should generate content id for new feedbacks', function () {
        expect(gcis.getNextId(scitat.displayed.getAllContentId(), 'feedback'))
            .toEqual('feedback_2');
    });
    it('should generate content id for new hint', function () {
        expect(gcis.getNextId(scitat.displayed.getAllContentId(), 'hint'))
            .toEqual('hint_2');
    });
    it('should generate content id for new worked example', function () {
        ...
        expect(gcis.getNextId(scitat.displayed.getAllContentId(), 'worked_example'))
