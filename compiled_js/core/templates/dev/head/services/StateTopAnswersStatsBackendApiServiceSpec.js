...
describe('StateTopAnswersStatsBackendApiService', function () {
    ...
    describe('.fetchStats', function () {
        it('returns the data provided by the backend.', function () {
            ...
            this.$httpBackend.expectGET('/createhandler/state_answer_stats/7').respond(backendDict);
            this.StateTopAnswersStatsBackendApiService.fetchStats('7').then(successHandler, failureHandler);
