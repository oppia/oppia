...
describe('Expression interpolation service', function () {
    ...
    describe('expression interpolation service', function () {
        ...
        it('should correctly interpolate and escape HTML strings', function () {
            ...
            expect(ExpressionInterpolationService.processHtml('abc{{a}}', [{}])).toEqual('abc<oppia-expression-error-tag></oppia-expression-error-tag>');
        ...
        it('should correctly get params from strings', function () {
            ...
            expect(ExpressionInterpolationService.getParamsFromString('abc{{a}}')).toEqual(['a']);
            expect(ExpressionInterpolationService.getParamsFromString('abc{{a+b}}')).toEqual(['a', 'b']);
        });
    });
});
