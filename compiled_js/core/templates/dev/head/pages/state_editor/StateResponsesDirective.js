...
oppia.directive('stateResponses', [
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/pages/state_editor/state_responses_directive.html'),
            controller: [
                    ...
                    $scope.openAddAnswerGroupModal = function () {
                        ...
                        $uibModal.open({
                            ...
                            controller: [
                                ...
                                function ($scope, $uibModalInstance, ResponsesService, EditorFirstTimeEventsService, StateEditorService, RuleObjectFactory, OutcomeObjectFactory, COMPONENT_NAME_FEEDBACK, GenerateContentIdService) {
