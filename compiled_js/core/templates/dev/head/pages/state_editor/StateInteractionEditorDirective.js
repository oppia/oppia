                        ...
                        if (EditabilityService.isEditable()) {
                            ...
                            $uibModal.open({
                                ...
                                controller: [
                                    ...
                                    function ($scope, $uibModalInstance, $injector, StateSolutionService, StateInteractionIdService, StateCustomizationArgsService, InteractionDetailsCacheService, INTERACTION_SPECS, UrlInterpolationService, EditorFirstTimeEventsService) {
