...
oppia.directive('formOverlay', [
    ...
    function (NestedDirectivesRecursionTimeoutPreventionService, UrlInterpolationService) {
        return {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/pages/tests/form_entry_point_modal_directive.html'),
            restrict: 'E',
...
oppia.controller('FormBuilderTests', [
    '$scope', function ($scope) {
        ...
        $scope.compositeForms = [{
                name: ('Dict with a bool, a unicode string and a list of ints. ' +
