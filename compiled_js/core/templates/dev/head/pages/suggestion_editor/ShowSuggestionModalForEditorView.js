...
oppia.controller('ShowSuggestionModalForEditorView', [
    ...
    'unsavedChangesExist',
    function ($log, $scope, $uibModalInstance, EditabilityService, SuggestionModalService, currentContent, description, newContent, suggestionIsHandled, suggestionIsValid, suggestionStatus, unsavedChangesExist) {
