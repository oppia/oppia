...
describe('Collection editor state service', function () {
    ...
    beforeEach(angular.mock.module('oppia', function ($provide) {
        fakeEditableCollectionBackendApiService = (new FakeEditableCollectionBackendApiService());
        $provide.value('EditableCollectionBackendApiService', [fakeEditableCollectionBackendApiService][0]);
        fakeCollectionRightsBackendApiService = (new FakeCollectionRightsBackendApiService());
