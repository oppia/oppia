...
describe('Current Interaction Service', function () {
    ...
    it('should properly register onSubmitFn and submitAnswerFn', function () {
        ...
        CurrentInteractionService.registerCurrentInteraction(dummySubmitAnswerFn, null);
    ...
    it('should properly register validityCheckFn', function () {
        ...
        CurrentInteractionService.registerCurrentInteraction(null, dummyValidityCheckFn);
        expect(CurrentInteractionService.isSubmitButtonDisabled()).toBe(!dummyValidityCheckFn());
    });
