...
describe('Audio translation language service', function () {
    ...
    it('should properly initialize the current audio language when ' +
        ...
        atls.init(allAudioLanguageCodesInExploration, preferredLanguageCode, explorationLanguageCode);
        ...
        preferredLanguageCode = 'en';
        explorationLanguageCode = 'hi';
        atls.init(['hi-en'], preferredLanguageCode, explorationLanguageCode);
        expect(atls.getCurrentAudioLanguageCode()).toEqual('hi-en');
    });
    ...
    it('should not have any audio language option when no audio is available ' +
        ...
        atls.init(allAudioLanguageCodesInExploration, preferredLanguageCode, explorationLanguageCode, automaticTextToSpeechEnabled);
