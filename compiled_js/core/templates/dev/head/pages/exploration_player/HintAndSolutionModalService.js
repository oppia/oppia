                ...
                return $uibModal.open({
                    ...
                    controller: [
                        ...
                        function ($scope, $rootScope, $uibModalInstance) {
                            ...
                            var contentIdsToAudioTranslations = displayedCard.getContentIdsToAudioTranslations();
                            var hintContentId = $scope.hint.getContentId();
                            AudioTranslationManagerService.setSecondaryAudioTranslations(contentIdsToAudioTranslations.getBindableAudioTranslations(hintContentId), $scope.hint.getHtml(), COMPONENT_NAME_HINT);
                ...
                return $uibModal.open({
                    ...
                    controller: [
                        ...
                        function ($scope, $rootScope, $uibModalInstance) {
                            ...
                            var displayedCard = PlayerTranscriptService.getCard(PlayerPositionService.getDisplayedCardIndex());
                            var contentIdsToAudioTranslations = displayedCard.getContentIdsToAudioTranslations();
                            AudioTranslationManagerService.setSecondaryAudioTranslations(contentIdsToAudioTranslations.getBindableAudioTranslations(solutionContentId), solution.explanation.getHtml(), COMPONENT_NAME_SOLUTION);
                            $rootScope.$broadcast(EVENT_AUTOPLAY_AUDIO);
