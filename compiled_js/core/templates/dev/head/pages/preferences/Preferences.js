...
oppia.controller('Preferences', [
    ...
    function ($http, $q, $rootScope, $scope, $timeout, $translate, $uibModal, AlertsService, UrlInterpolationService, UserService, UtilsService, DASHBOARD_TYPE_CREATOR, DASHBOARD_TYPE_LEARNER, SUPPORTED_AUDIO_LANGUAGES, SUPPORTED_SITE_LANGUAGES) {
