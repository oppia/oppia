...
oppia.factory('ExplorationTitleService', [
    ...
    'ValidatorsService',
    function ($filter, ExplorationPropertyService, ExplorationRightsService, ValidatorsService) {
        var child = Object.create(ExplorationPropertyService);
        child.propertyName = 'title';
        child._normalize = $filter('normalizeWhitespace');
        child._isValid = function (value) {
            return ValidatorsService.isValidEntityName(value, true, ExplorationRightsService.isPrivate());
        };
        return child;
    }
]);
