    ...
    function (SiteAnalyticsService) {
        ...
        return {
            ...
            registerFirstOpenContentBoxEvent: function () {
                if (shouldRegisterEvents &&
                    !alreadyRegisteredEvents.hasOwnProperty('FirstOpenContentBoxEvent')) {
            ...
            registerFirstClickAddInteractionEvent: function () {
                if (shouldRegisterEvents &&
                    !alreadyRegisteredEvents.hasOwnProperty('FirstClickAddInteractionEvent')) {
            ...
            registerFirstSelectInteractionTypeEvent: function () {
                if (shouldRegisterEvents &&
                    !alreadyRegisteredEvents.hasOwnProperty('FirstSelectInteractionTypeEvent')) {
            ...
            registerFirstSaveInteractionEvent: function () {
                if (shouldRegisterEvents &&
                    !alreadyRegisteredEvents.hasOwnProperty('FirstSaveInteractionEvent')) {
            ...
            registerFirstCreateSecondStateEvent: function () {
                if (shouldRegisterEvents &&
                    !alreadyRegisteredEvents.hasOwnProperty('FirstCreateSecondStateEvent')) {
