...
describe('Translation status service', function () {
    ...
    describe('Translation status service', function () {
        ...
        it('should return a correct list of state names for which ' +
            ...
            scitats.init(STATES[0], ess.getContentIdsToAudioTranslationsMemento(STATES[0]));
        ...
        it('should return a correct count of audio translations required ' +
            ...
            var explorationAudioRequiredCount = (tss.getExplorationAudioRequiredCount());
            ...
            tss.getAllStateStatusColors();
            explorationAudioRequiredCount = (tss.getExplorationAudioRequiredCount());
        ...
        it('should return a correct count of audio translations not available ' +
            ...
            tss.getAllStateStatusColors();
            explorationAudioNotAvailableCount = (tss.getExplorationAudioNotAvailableCount());
        ...
        it('should correctly return an object contaning status colors of all ' +
            ...
            expect(stateWiseStatusColor[STATES[0]]).toBe(FEW_AUDIO_AVAILABLE_COLOR);
            expect(stateWiseStatusColor[STATES[1]]).toBe(NO_AUDIO_AVAILABLE_COLOR);
            expect(stateWiseStatusColor[STATES[2]]).toBe(ALL_AUDIO_AVAILABLE_COLOR);
            scitats.init(STATES[1], ess.getContentIdsToAudioTranslationsMemento(STATES[1]));
            var value = scitats.displayed;
            ...
            expect(stateWiseStatusColor[STATES[1]]).toBe(FEW_AUDIO_AVAILABLE_COLOR);
        });
        it('should return correct status color for active state', function () {
            ...
            activeStateComponentStatus = tss
                .getActiveStateComponentStatusColor('feedback');
            expect(activeStateComponentStatus).toBe(NO_AUDIO_AVAILABLE_COLOR);
            scitats.init(STATES[2], ess.getContentIdsToAudioTranslationsMemento(STATES[2]));
            activeStateComponentStatus = tss
                .getActiveStateComponentStatusColor('content');
            expect(activeStateComponentStatus).toBe(ALL_AUDIO_AVAILABLE_COLOR);
        });
        ...
        it('should return correct status color of a contentId of active state', function () {
            scitats.init(STATES[0], ess.getContentIdsToAudioTranslationsMemento(STATES[0]));
