    ...
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            controller: [
                ...
                function ($scope, $rootScope, ExplorationStatesService, GraphDataService, StateEditorService, StateContentIdsToAudioTranslationsService, StateWrittenTranslationsService, TranslationStatusService) {
                    ...
                    $scope.onClickStateInMap = function (newStateName) {
                        ...
                        if (stateName && stateData) {
                            StateContentIdsToAudioTranslationsService.init(StateEditorService.getActiveStateName(), stateData.contentIdsToAudioTranslations);
                            StateWrittenTranslationsService.init(StateEditorService.getActiveStateName(), stateData.writtenTranslations);
