...
oppia.factory('TranslationStatusService', [
    ...
    'TranslationTabActiveModeService', 'INTERACTION_SPECS', function (ExplorationStatesService, StateContentIdsToAudioTranslationsService, StateWrittenTranslationsService, TranslationLanguageService, TranslationTabActiveModeService, INTERACTION_SPECS) {
        ...
        var contentIdsToAudioTranslations = StateContentIdsToAudioTranslationsService.displayed;
        var _getVoiceOverStatus = function (contentIdsToAudioTranslations, contentId) {
            ...
            var availableLanguages = (contentIdsToAudioTranslations.getAudioLanguageCodes(contentId));
            if (availableLanguages.indexOf(langCode) !== -1) {
                availabilityStatus.available = true;
                var audioTranslation = (contentIdsToAudioTranslations.getAudioTranslation(contentId, langCode));
        ...
        var _getContentAvailabilityStatus = function (stateName, contentId) {
            ...
            if (TranslationTabActiveModeService.isTranslationModeActive()) {
                ...
                var contentIdsToAudioTranslations = (ExplorationStatesService.getContentIdsToAudioTranslationsMemento(stateName));
