...
oppia.factory('TranslationStatusService', [
    ...
    'TranslationLanguageService', 'INTERACTION_SPECS', function (ExplorationStatesService, StateContentIdsToAudioTranslationsService, TranslationLanguageService, INTERACTION_SPECS) {
            ...
            if (ExplorationStatesService.isInitialized()) {
                ExplorationStatesService.getStateNames().forEach(function (stateName) {
                    ...
                    allContentId.forEach(function (contentId) {
                        var availableTranslationLanguageCodes = (contentIdsToAudioTranslations.getAudioLanguageCodes(contentId));
        ...
        var _getContentIdListRelatedToComponent = function (componentName) {
            ...
            if (contentIdsToAudioTranslations) {
                ...
                if (componentName === 'solution' || componentName === 'content') {
                    ...
                    contentIdsToAudioTranslations.getAllContentId().forEach(function (contentId) {
