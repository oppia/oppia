...
oppia.factory('LearnerActionRenderService', [
    ...
    function ($sce, ACTION_TYPE_ANSWER_SUBMIT, ACTION_TYPE_EXPLORATION_QUIT, ACTION_TYPE_EXPLORATION_START, ISSUE_TYPE_MULTIPLE_INCORRECT_SUBMISSIONS) {
        var renderExplorationStartActionHTML = function (stateName, actionIndex) {
            var htmlString = '<span class="oppia-issues-learner-action">' + actionIndex +
         ...
         * @returns {string}
         */
        var renderAnswerSubmitActionHTML = function (answer, destStateName, timeSpentInStateSecs, currentStateName, actionIndex) {
            var htmlString;
        ...
        var renderLearnerActionHTML = function (learnerAction, actionIndex) {
            ...
            if (actionType === ACTION_TYPE_EXPLORATION_START) {
                ...
                if (interactionId === 'Continue') {
                    ...
                    return renderAnswerSubmitActionHTML(custArgs.submitted_answer.value, custArgs.dest_state_name.value, custArgs.time_spent_state_in_msecs.value, custArgs.state_name.value, actionIndex);
                }
            }
        };
        /**
