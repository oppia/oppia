    ...
    describe('getData local save', function () {
        ...
        beforeEach(function () {
            angular.mock.module(function ($provide) {
                $provide.value('LocalStorageService', [mockLocalStorageService][0]);
            });
            angular.mock.module(function ($provide) {
                $provide.value('EditableExplorationBackendApiService', [mockBackendApiService][0]);
            });
            angular.mock.module(function ($provide) {
                $provide.value('UrlService', [mockUrlService][0]);
            });
        });
        beforeEach(function () {
            mockUrlService = {
