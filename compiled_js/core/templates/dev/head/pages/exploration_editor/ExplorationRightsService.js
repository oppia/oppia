...
oppia.factory('ExplorationRightsService', [
    ...
    function ($http, AlertsService, ExplorationDataService, ACTIVITY_STATUS_PRIVATE, ACTIVITY_STATUS_PUBLIC) {
        return {
            init: function (ownerNames, editorNames, translatorNames, viewerNames, status, clonedFrom, isCommunityOwned, viewableIfPrivate) {
            ...
            makeCommunityOwned: function () {
                ...
                return $http.put(requestUrl, {
                    ...
                    that.init(data.rights.owner_names, data.rights.editor_names, data.rights.translator_names, data.rights.viewer_names, data.rights.status, data.rights.cloned_from, data.rights.community_owned, data.rights.viewable_if_private);
                });
            },
