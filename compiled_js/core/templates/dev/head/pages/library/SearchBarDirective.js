    ...
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            controller: [
                ...
                function ($scope, $rootScope, $timeout, $window, $location, $translate, SearchService, NavigationService, DebouncerService, HtmlEscaperService, UrlService, ConstructTranslationIdsService) {
                    $scope.isSearchInProgress = SearchService.isSearchInProgress;
                    $scope.SEARCH_DROPDOWN_CATEGORIES = (GLOBALS.SEARCH_DROPDOWN_CATEGORIES.map(function (categoryName) {
                        return {
                            id: categoryName,
