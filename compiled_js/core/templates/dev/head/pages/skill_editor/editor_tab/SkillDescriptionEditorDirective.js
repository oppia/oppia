...
oppia.directive('skillDescriptionEditor', [
    ...
    function (SkillEditorStateService, SkillObjectFactory, SkillUpdateService, UrlInterpolationService) {
        return {
            restrict: 'E',
            scope: {},
            ...
            controller: [
                ...
                function ($scope, EVENT_SKILL_REINITIALIZED) {
                    ...
                    $scope.saveSkillDescription = function (newSkillDescription) {
                        ...
                        if (SkillObjectFactory.hasValidDescription(newSkillDescription)) {
                            $scope.skillDescriptionEditorIsShown = false;
                            SkillUpdateService.setSkillDescription($scope.skill, newSkillDescription);
                        }
                    };
                }
            ]
