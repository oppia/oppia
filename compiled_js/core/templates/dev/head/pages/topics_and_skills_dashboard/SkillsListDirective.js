 ...
 */
oppia.constant('MERGE_SKILL_URL', '/merge_skill');
oppia.directive('skillsList', [
    '$http', 'AlertsService', 'UrlInterpolationService',
    'MERGE_SKILL_URL',
    function ($http, AlertsService, UrlInterpolationService, MERGE_SKILL_URL) {
        return {
            restrict: 'E',
            scope: {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/pages/topics_and_skills_dashboard/skills_list_directive.html'),
            controller: [
                '$scope', '$uibModal', '$rootScope', 'EditableTopicBackendApiService',
                'EditableSkillBackendApiService',
                'EVENT_TOPICS_AND_SKILLS_DASHBOARD_REINITIALIZED',
                function ($scope, $uibModal, $rootScope, EditableTopicBackendApiService, EditableSkillBackendApiService, EVENT_TOPICS_AND_SKILLS_DASHBOARD_REINITIALIZED) {
                    ...
                    $scope.mergeSkill = function (skill) {
                        ...
                        modalInstance.result.then(function (result) {
                            ...
                            EditableSkillBackendApiService.updateSkill(skill.id, skill.version, 'Added superseding skill id ' +
                                supersedingSkillId + ' to skill.', changeList).then(function () {
