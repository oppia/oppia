...
var expectInteractionDetailsToMatch = function (elem) {
    expect(elem.element(protractor_1.by.tagName('oppia-interactive-numeric-input')).isPresent()).toBe(true);
};
var submitAnswer = function (elem, answer) {
    elem.element(protractor_1.by.tagName('oppia-interactive-numeric-input')).
        element(protractor_1.by.tagName('input')).sendKeys(answer + '\n');
};
