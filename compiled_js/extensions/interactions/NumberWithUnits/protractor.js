...
var expectInteractionDetailsToMatch = function (elem) {
    expect(elem.element(protractor_1.by.tagName('oppia-interactive-number-with-units')).isPresent()).toBe(true);
};
var submitAnswer = function (elem, answer) {
    elem.element(protractor_1.by.tagName('oppia-interactive-number-with-units')).
