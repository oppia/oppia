...
var errorWrapper = function (dubiousFunction, input, parameter) {
    ...
    return function () {
        try {
            ...
            throw logicProofShared.renderError(err, logicProofData.BASE_GENERAL_MESSAGES, logicProofData.BASE_STUDENT_LANGUAGE);
        }
    };
};
...
describe('Assign types to expressions', function () {
    ...
    it('should forbid quantification over pre-existing variables', function () {
        expect(errorWrapper(assignTypes, 'a\u2227\u2203a.f(2)', ['variable', 'prefix_function', 'constant'])).toThrowError('The name \'a\' is already in use and so cannot be quantified over in ' +
            '\u2203a.f(2).');
    });
