...
oppia.directive('oppiaInteractiveGraphInput', [
    ...
    function (HtmlEscaperService, UrlInterpolationService, UrlService, graphInputRulesService, EVENT_NEW_CARD_AVAILABLE) {
        return {
            restrict: 'E',
            scope: {
            ...
            controller: [
                ...
                function ($scope, $element, $attrs, WindowDimensionsService, CurrentInteractionService) {
                    ...
                    $scope.submitGraph = function () {
                        ...
                        CurrentInteractionService.onSubmit(angular.copy($scope.graph), graphInputRulesService);
                    };
                    ...
                    CurrentInteractionService.registerCurrentInteraction($scope.submitGraph, validityCheckFn);
                    init();
                }
            ]
        };
