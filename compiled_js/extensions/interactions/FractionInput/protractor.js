...
var customizeInteraction = function (elem, requireSimplestForm) {
    objects.BooleanEditor(elem.element(protractor_1.by.tagName('schema-based-bool-editor')))
        .setValue(requireSimplestForm);
};
var expectInteractionDetailsToMatch = function (elem) {
    expect(elem.element(protractor_1.by.tagName('oppia-interactive-fraction-input')).isPresent()).toBe(true);
};
var submitAnswer = function (elem, answer) {
    elem.element(protractor_1.by.tagName('oppia-interactive-fraction-input'))
