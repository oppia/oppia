...
describe('CodeRepl prediction service', function () {
    ...
    describe('CodeRepl prediction service test', function () {
        ...
        it('should predict correct answer group for the answers', function () {
            var classifierData = window.__fixtures__['core/tests/data/code_classifier_data'];
            ...
            var testData = window.__fixtures__['core/tests/data/code_classifier_test_knn'];
            ...
            var testData = window.__fixtures__['core/tests/data/code_classifier_test_svm'];
            var predictedAnswerGroup = null;
            for (var i = 0; i < testData.length; i++) {
                for (var j = 0; j < testData[i].answers.length; j++) {
                    predictedAnswerGroup = service.predict(classifierData, testData[i].answers[j]);
        ...
        it('should not have accuracy less than 85', function () {
            var classifierData = window.__fixtures__['core/tests/data/code_classifier_data'];
            var trainingData = window.__fixtures__['core/tests/data/code_classifier_accuracy_test'];
