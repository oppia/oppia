...
describe('EndExplorationValidationService', function () {
    ...
    it('should not have warnings for no answer groups or no default outcome', function () {
        var warnings = validatorService.getAllWarnings(currentState, customizationArguments, [], null);
        expect(warnings).toEqual([]);
    });
    it('should have warnings for any answer groups or default outcome', function () {
    ...
    it('should throw for missing recommendations argument', function () {
        ...
        }).toThrow('Expected customization arguments to have property: ' +
            'recommendedExplorationIds');
    });
    it('should not have warnings for 0 or 8 recommendations', function () {
        ...
        warnings = validatorService.getAllWarnings(currentState, customizationArguments, [], null);
        expect(warnings).toEqual([]);
    });
    it('should catch non-string value for recommended exploration ID', function () {
    ...
    it('should have warnings for non-list format of recommended exploration IDs', function () {
