...
var mathExpressionInputTag = function (parentElement) {
    return parentElement.element(by.tagName('oppia-interactive-math-expression-input'));
};
...
var submitAnswer = function (elem, answer) {
    ...
    var submitAnswerButon = element(by.css('.protractor-test-submit-answer-button'));
