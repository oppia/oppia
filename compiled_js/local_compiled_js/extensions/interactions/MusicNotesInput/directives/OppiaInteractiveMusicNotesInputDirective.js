...
oppia.directive('oppiaInteractiveMusicNotesInput', [
    ...
    function (CurrentInteractionService, HtmlEscaperService, MusicNotesInputRulesService, MusicPhrasePlayerService, UrlInterpolationService, WindowDimensionsService, EVENT_NEW_CARD_AVAILABLE, NOTE_NAMES_TO_MIDI_VALUES) {
        return {
            restrict: 'E',
            scope: {
