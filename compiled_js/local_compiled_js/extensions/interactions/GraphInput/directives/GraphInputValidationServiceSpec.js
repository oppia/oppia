...
describe('GraphInputValidationService', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        var answerGroup = agof.createNew([rof.createFromBackendDict({
                inputs: {
                    g: {
                        vertices: new Array(10)
                    }
    ...
    it('should be able to perform basic validation', function () {
        var warnings = validatorService.getAllWarnings(currentState, customizationArguments, answerGroups, goodDefaultOutcome);
        expect(warnings).toEqual([]);
    });
    it('should expect graph and edit customization arguments', function () {
        expect(function () {
            validatorService.getAllWarnings(currentState, {}, answerGroups, goodDefaultOutcome);
