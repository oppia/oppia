...
var customizeInteraction = function (interactionEditor, graphDict) {
    var graphInputContainer = interactionEditor.element(by.css('.protractor-test-graph-input-viz-container'));
    if (graphDict) {
...
var submitAnswer = function (conversationInput, graphDict) {
    ...
    // new nodes.
    var graphInputContainer = conversationInput.element(by.css('.protractor-test-graph-input-viz-container'));
    if (graphDict) {
        forms.GraphEditor(graphInputContainer).setValue(graphDict);
    }
