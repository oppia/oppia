...
var ExplorationEditorSettingsTab = function () {
    ...
    var explorationLanguageInput = element(by.css('.protractor-test-exploration-language-select'));
    var explorationObjectiveInput = element(by.css('.protractor-test-exploration-objective-input'));
    var explorationObjectiveWarning = element(by.css('.protractor-test-exploration-objective-warning'));
