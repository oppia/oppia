...
oppia.directive('translationTab', [
    ...
    function (ContextService, ExplorationDataService, ExplorationStatesService, StateEditorService, StateRecordedVoiceoversService, StateTutorialFirstTimeService, UrlInterpolationService) {
        return {
            restrict: 'E',
            scope: {},
            link: function () {
            ...
            controller: ['$scope', '$rootScope', '$templateCache', '$uibModal',
                ...
                function ($scope, $rootScope, $templateCache, $uibModal, EditabilityService, StateTutorialFirstTimeService, StateWrittenTranslationsService, TranslationTabActiveModeService, UrlInterpolationService) {
                    ...
                    var initTranslationTab = function () {
                        ...
                        StateRecordedVoiceoversService.init(stateName, ExplorationStatesService.getRecordedVoiceoversMemento(stateName));
