    ...
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            controller: [
                ...
                function ($scope, $rootScope, ExplorationStatesService, GraphDataService, StateEditorService, StateRecordedVoiceoversService, StateWrittenTranslationsService, TranslationStatusService) {
                    ...
                    $scope.onClickStateInMap = function (newStateName) {
                        ...
                        if (stateName && stateData) {
                            StateRecordedVoiceoversService.init(StateEditorService.getActiveStateName(), stateData.recordedVoiceovers);
