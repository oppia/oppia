...
describe('Sidebar state name controller', function () {
    describe('SidebarStateName', function () {
        ...
        beforeEach(angular.mock.inject(function ($compile, $filter, $injector, $rootScope, $templateCache) {
            filter = $filter;
            rootScope = $rootScope;
            ...
            var elem = angular.element('<state-name-editor></state-name-editor>');
        ...
        it('should not save state names longer than 50 characters', function () {
            expect(scope.saveStateName('babababababababababababababababababababababababababab')).toBe(false);
        });
        ...
        it('should not change state name if state name edits fail', function () {
            ...
            scope.saveStateName('This state name is too long to be saved. Try to be brief next time.');
            expect(ecs.getActiveStateName()).toEqual('Third State');
            expect(mockExplorationData.autosaveChangeList).not.toHaveBeenCalled();
