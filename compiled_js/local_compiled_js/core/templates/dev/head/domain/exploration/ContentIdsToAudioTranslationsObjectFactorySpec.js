...
describe('ContentIdsToAudioTranslations object factory', function () {
    ...
    describe('ContentIdsToAudioTranslationsObjectFactory', function () {
        ...
        it('should get correct audio translation', function () {
            expect(citat.getAudioTranslation('hint_1', 'en')).toEqual(atof.createFromBackendDict({
                filename: 'filename9.mp3',
                file_size_bytes: 104000,
                needs_update: false
            }));
        ...
        it('should correctly check content id has unflagged audio translations', function () {
        ...
        it('should check whether the text is fully translated', angular.mock.inject(function () {
            ...
            }).toThrowError('Trying to remove non-existing translation for ' +
                'language code hi-en');
        }));
        ...
        it('should toggle needs update attribute in a given content id', function () {
            ...
            expect(citat.getAudioTranslation('content', 'hi')).toEqual(atof.createFromBackendDict({
                filename: 'filename2.mp3',
                file_size_bytes: 11000,
                needs_update: true
            }));
