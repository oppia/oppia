...
oppia.factory('EditableExplorationBackendApiService', [
    ...
    function ($http, $q, ReadOnlyExplorationBackendApiService, UrlInterpolationService, EDITABLE_EXPLORATION_DATA_DRAFT_URL_TEMPLATE, EDITABLE_EXPLORATION_DATA_URL_TEMPLATE, EXPLORATION_DATA_URL_TEMPLATE, VOICEOVER_EXPLORATION_DATA_URL_TEMPLATE) {
        ...
        var _getExplorationUrl = function (explorationId, applyDraft) {
            ...
            if (!GLOBALS.can_edit && GLOBALS.can_voiceover) {
                return UrlInterpolationService.interpolateUrl(VOICEOVER_EXPLORATION_DATA_URL_TEMPLATE, {
                    exploration_id: explorationId
                });
            }
