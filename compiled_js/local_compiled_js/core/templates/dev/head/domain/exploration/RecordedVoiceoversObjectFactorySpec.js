...
describe('RecordedVoiceovers object factory', function () {
    ...
    it('should return a correct voiceover for a given content id and language', function () {
        expect(rv.getVoiceover('hint_1', 'en')).toEqual(vof.createFromBackendDict({
            filename: 'filename9.mp3',
            file_size_bytes: 104000,
            needs_update: false
        }));
    ...
    it('should toggle needs update attribute in a given content id', function () {
        ...
        expect(rv.getVoiceover('content', 'hi')).toEqual(vof.createFromBackendDict({
            filename: 'filename2.mp3',
            file_size_bytes: 11000,
            needs_update: true
        }));
