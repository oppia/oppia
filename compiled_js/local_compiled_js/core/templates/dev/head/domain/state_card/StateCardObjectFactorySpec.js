...
describe('State card object factory', function () {
    ...
    beforeEach(angular.mock.inject(function ($injector) {
        ...
        RecordedVoiceoversObjectFactory = ($injector.get('RecordedVoiceoversObjectFactory'));
        ...
        _sampleCard = StateCardObjectFactory.createNewCard('State 1', '<p>Content</p>', '<interaction></interaction>', InteractionObjectFactory.createFromBackendDict(interactionDict), RecordedVoiceoversObjectFactory.createFromBackendDict({
            voiceovers_mapping: {
                content: {
                    en: {
    ...
    it('should be able to get the various fields', function () {
        ...
        expect(_sampleCard.getRecordedVoiceovers().getBindableVoiceovers('content')).toEqual({
