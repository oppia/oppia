 ...
 */
oppia.constant('COLLECTION_VIEWER_URL', '/collection/<collection_id>');
oppia.constant('COLLECTION_EDITOR_URL', '/collection_editor/create/<collection_id>');
oppia.directive('collectionSummaryTile', [
    'UrlInterpolationService', function (UrlInterpolationService) {
        return {
            ...
            templateUrl: UrlInterpolationService.getDirectiveTemplateUrl('/components/summary_tile/' +
                'collection_summary_tile_directive.html'),
            controller: [
                '$scope', 'DateTimeFormatService', 'UserService',
                'COLLECTION_VIEWER_URL', 'COLLECTION_EDITOR_URL', function ($scope, DateTimeFormatService, UserService, COLLECTION_VIEWER_URL, COLLECTION_EDITOR_URL) {
                    ...
                    $scope.getCollectionLink = function () {
                        var targetUrl = ($scope.isLinkedToEditorPage ?
