...
describe('PlaythroughService', function () {
    ...
    describe('.initSession()', function () {
        it('stores the correct values', function () {
            ...
            this.PlaythroughService.initSession(this.expId, this.expVersion, this.playthroughRecordingProbability);
    ...
    describe('recording exploration playthroughs', function () {
        ...
        describe('.recordPlaythrough()', function () {
            ...
            it('identifies early quits', function () {
                ...
                // flaky between tests.
                expect(playthrough.issueCustomizationArgs).toEqual(jasmine.objectContaining({ state_name: { value: 'stateName1' } }));
            });
            ...
            it('identifies p-shaped cyclic state transitions', function () {
                ...
                this.PlaythroughService.recordAnswerSubmitAction('stateName1', 'stateName2', 'TextInput', 'Hello', 'Try again', 30);
                this.PlaythroughService.recordAnswerSubmitAction('stateName2', 'stateName3', 'TextInput', 'Hello', 'Try again', 30);
                this.PlaythroughService.recordAnswerSubmitAction('stateName3', 'stateName2', 'TextInput', 'Hello', 'Try again', 30);
                this.PlaythroughService.recordAnswerSubmitAction('stateName2', 'stateName3', 'TextInput', 'Hello', 'Try again', 30);
                this.PlaythroughService.recordAnswerSubmitAction('stateName3', 'stateName2', 'TextInput', 'Hello', 'Try again', 30);
                this.PlaythroughService.recordAnswerSubmitAction('stateName2', 'stateName3', 'TextInput', 'Hello', 'Try again', 30);
                this.PlaythroughService.recordAnswerSubmitAction('stateName3', 'stateName2', 'TextInput', 'Hello', 'Try again', 30);
