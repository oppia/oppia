...
class UtilsTests(test_utils.GenericTestBase):
    ...
    def test_convert_png_or_webp_data_url_to_binary_with_incorrect_prefix(
        self
    ) -> None:
        with self.assertRaisesRegex(
            Exception, 'The given string does not represent a png data URL'
        ):
            utils.convert_png_or_webp_data_url_to_binary(
    ...
    def test_convert_png_or_webp_data_url_to_binary_raises_if_prefix_is_missing(
        ...
        with self.assertRaisesRegex(
            ...
            utils.convert_png_or_webp_data_url_to_binary(image_data_url, 'png')
