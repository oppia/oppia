...
class UtilsTests(test_utils.GenericTestBase):
    ...
    def test_require_valid_url_fragment(self) -> None:
        ...
        name_with_spaces_expected_error = 'name-type field contains invalid characters. Only lowercase words separated by hyphens are allowed. Received name with spaces.'
        ...
        name_in_caps = 'NAME'
        name_in_caps_expected_error = 'name-type field contains invalid characters. Only lowercase words separated by hyphens are allowed. Received NAME.'
    ...
    def test_get_exploration_components_from_dir_with_invalid_path_raises_error(
        ...
        with self.assertRaisesRegex(
            Exception,
            'Found invalid non-asset file .+There should only be a single non-asset file, and it should have a .yaml suffix.',
        ):
    ...
    def test_require_valid_name_with_incorrect_input(self) -> None:
        with self.assertRaisesRegex(
            ...
            'The length of the exploration title should be between 1 and 50 characters; received ',
        ):
    ...
    def test_escape_html_function(self) -> None:
        html_data = '<oppia-noninteractive-math math_content-with-value=\'{&amp;quot;raw_latex&amp;quot;:&amp;quot;+,-,-,+&amp;quot;, &amp;quot;svg_filename&amp;quot;: &amp;quot;mathImg.svg&amp;quot;}\'></oppia-noninteractive-math>'
        expected_html_data = '&lt;oppia-noninteractive-math math_content-with-value=&#39;{&amp;amp;quot;raw_latex&amp;amp;quot;:&amp;amp;quot;+,-,-,+&amp;amp;quot;, &amp;amp;quot;svg_filename&amp;amp;quot;: &amp;amp;quot;mathImg.svg&amp;amp;quot;}&#39;&gt;&lt;/oppia-noninteractive-math&gt;'
