...
class UtilsTests(test_utils.GenericTestBase):
    ...
    def test_convert_milisecs_time_to_datetime_object(self) -> None:
        msecs = 1000000.101
        dt = utils.convert_milisecs_time_to_datetime_object(msecs)
        self.assertEqual(
            msecs, (time.mktime(dt.timetuple())) * 1000.0 + (
