...
class UtilsTests(test_utils.GenericTestBase):
    ...
    def test_get_url_scheme(self) -> None:
        test_cases = [('https://www.google.com', 'https'),
                      ('mailto:example@example.com', 'mailto'), ('oppia.org', ''),
                      ('http://www.test.com', 'http'), ('file:///usr/bin/', 'file')]
    ...
    def test_unicode_and_str_chars_in_file(self) -> None:
        ...
        with utils.open_file('core/tests/data/unicode_and_str_handler.py', 'r') as f:
            file_content = f.read()
    ...
    def test_yaml_dict_conversion(self) -> None:
        ...
        test_dicts: List[Dict[str, Union[str, int,
                                         List[Union[str, int,
                                                    Dict[str, float]]]]]] = [{}, {
                                                        'a': 'b'
                                                    }, {
        ...
        with self.assertRaisesRegex(
            utils.InvalidInputException, 'while parsing a flow node\n'
    ...
    def test_string_to_datetime_conversion_returns_correct_datetime(self) -> None:
        time_string = '12/01/2016, 01:02:03:000000'
        initial_time = datetime.datetime(2016, 12, 1, 1, 2, 3)
        self.assertEqual(
            utils.convert_string_to_naive_datetime_object(time_string), initial_time
        )
    ...
    def test_create_string_from_largest_unit_in_timedelta_returns_days(self) -> None:
    ...
    def test_create_string_from_largest_unit_in_timedelta_returns_a_day(self) -> None:
    ...
    def test_create_string_from_largest_unit_in_timedelta_returns_hours(self) -> None:
    ...
    def test_create_string_from_largest_unit_in_timedelta_returns_an_hour(self) -> None:
    ...
    def test_create_string_from_largest_unit_in_timedelta_returns_minutes(self) -> None:
    ...
    def test_convert_png_to_data_url_with_non_png_image_raises_error(self) -> None:
    ...
    def test_get_exploration_components_from_dir_with_multiple_yaml_files(self) -> None:
        with self.assertRaisesRegex(
    ...
    def test_get_exploration_components_from_dir_with_no_yaml_file(self) -> None:
        with self.assertRaisesRegex(
    ...
    def test_get_supported_audio_language_description_with_invalid_code(self) -> None:
    ...
    def test_is_user_id_valid(self) -> None:
        ...
        self.assertTrue(
            utils.is_user_id_valid('pid_%s' % ('a' * 32), allow_pseudonymous_id=True)
        )
    ...
    def test_grouper(self) -> None:
        self.assertEqual([list(g) for g in utils.grouper(range(7), 3)],
    ...
    def test_convert_data_url_to_binary(self) -> None:
        image_data_url = '%s%s' % (
            utils.PNG_DATA_URL_PREFIX, urllib.parse.quote(base64.b64encode(b'test123'))
        )
    ...
    def test_convert_data_url_to_binary_raises_if_prefix_is_missing(self) -> None:
    ...
    def test_unescape_encoded_uri_component(self) -> None:
        self.assertEqual(
            utils.unescape_encoded_uri_component('/El%20Ni%C3%B1o/'), '/El Niño/'
        )
    ...
    def test_get_exploration_components_from_dir_with_yaml_content(self) -> None:  # pylint: disable=line-too-long
        ...
        self.assertEqual(
            final_result, (
                yaml_content,
                set([(img2_path, img2_file_content), (img1_path, img1_file_content)])
            )
        )
