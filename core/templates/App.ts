...
angular.module('oppia').config([
  ...
  function(
    ...
    var servicesToProvide = [
      ...
      'ExpressionEvaluatorService', 'ExpressionParserService',
      ...
      'NumberAttemptsService', 'PageTitleService', 'ParamMetadataObjectFactory',
      ...
      'ReadOnlyCollectionBackendApiService', 'ReviewTestBackendApiService',
      'SchemaDefaultValueService', 'SchemaUndefinedLastElementService',
      'SidebarStatusService', 'SiteAnalyticsService',
      ...
      'StateTopAnswersStatsService', 'StatsReportingService',
      'StopwatchObjectFactory', 'StoryContentsObjectFactory',
      'StoryObjectFactory', 'StorySummaryObjectFactory',
      'StoryViewerBackendApiService', 'SubtopicViewerBackendApiService',
