...
angular.module('oppia').config([
  ...
  function(
    ...
    var servicesToProvide = [
      'AlertsService', 'AnswerClassificationResultObjectFactory', 'AudioFileObjectFactory', 'AudioTranslationLanguageService', 'AudioTranslationManagerService', 'AutogeneratedAudioPlayerService', 'BackgroundMaskService', 'BrowserCheckerService',
      'CodeReplRulesService', 'CollectionCreationBackendService', 'ComputeGraphService', 'ConceptCardObjectFactory',
      ...
      'DocumentAttributeCustomizationService', 'EmailDashboardDataService', 'ExplorationFeaturesBackendApiService', 'ExplorationFeaturesService', 
      'ExplorationHtmlFormatterService', 'ExplorationObjectFactory',
      'ExpressionParserService', 'ExpressionSyntaxTreeService', 'ExtensionTagAssemblerService',
      'ExtractImageFilenamesFromStateService', 'FeedbackMessageSummaryObjectFactory', 'FeedbackThreadSummaryObjectFactory', 'FileDownloadRequestObjectFactory', 'GuestCollectionProgressObjectFactory', 'GuestCollectionProgressService',
      'HtmlEscaperService', 'IdGenerationService', 'ImageFileObjectFactory', 'InteractionObjectFactory',
      'LanguageUtilService', 'LearnerAnswerDetailsBackendApiService', 'LearnerDashboardBackendApiService', 'LearnerParamsService', 'LoaderService', 'LocalStorageService',
      'LoggerService', 'MetaTagCustomizationService',
      'NormalizeWhitespacePipe', 'NumberAttemptsService', 'PageTitleService',
      'PencilCodeEditorRulesService', 'PlayerCorrectnessFeedbackEnabledService', 'PlayerPositionService', 'PlayerTranscriptService', 'PlaythroughService', 'PredictionAlgorithmRegistryService', 'PretestQuestionBackendApiService', 'QuestionBackendApiService', 'QuestionSummaryForOneSkillObjectFactory', 'QuestionSummaryObjectFactory', 'RatingComputationService', 'ReadOnlyCollectionBackendApiService', 'ReadOnlySubtopicPageObjectFactory',
      ...
      'SolutionObjectFactory', 'SpeechSynthesisChunkerService', 'StateCardObjectFactory', 'StateClassifierMappingService',
      'StateImprovementSuggestionService', 'StateObjectFactory',
      'StatesObjectFactory', 'StopwatchObjectFactory', 'StoryContentsObjectFactory', 'StoryObjectFactory', 'StorySummaryObjectFactory', 'StoryViewerBackendApiService', 'SubtopicPageContentsObjectFactory', 'SubtopicPageObjectFactory', 'SubtopicViewerBackendApiService', 'SuggestionsService',
