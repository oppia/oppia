...
angular.module('oppia').config([
  ...
  function(
    ...
    var servicesToProvide = [
      ...
      'DocumentAttributeCustomizationService', 'EmailDashboardDataService',
      'ExplorationHtmlFormatterService', 'ExplorationObjectFactory',
      'ExpressionParserService', 'ExtensionTagAssemblerService',
      'ExtractImageFilenamesFromStateService', 'FeedbackMessageSummaryObjectFactory', 'FeedbackThreadSummaryObjectFactory',
      'HtmlEscaperService', 'IdGenerationService', 'InteractionObjectFactory',
      'LanguageUtilService', 'LearnerDashboardBackendApiService', 'LoaderService', 'LocalStorageService',
      'LoggerService', 'MetaTagCustomizationService',
      'NormalizeWhitespacePipe', 'PageTitleService',
      'PencilCodeEditorRulesService', 'QuestionBackendApiService', 'QuestionSummaryForOneSkillObjectFactory', 'QuestionSummaryObjectFactory', 'RatingComputationService', 'ReadOnlySubtopicPageObjectFactory',
      'RubricObjectFactory', 'SchemaDefaultValueService', 'SchemaUndefinedLastElementService',
      ...
      'StatesObjectFactory', 'StoryContentsObjectFactory', 'StoryObjectFactory', 'StorySummaryObjectFactory', 'SubtopicPageContentsObjectFactory', 'SubtopicPageObjectFactory', 'SubtopicViewerBackendApiService', 'SuggestionsService',
