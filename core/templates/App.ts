...
angular.module('oppia').config([
  ...
  function(
    ...
    var servicesToProvide = [
      ...
      'AssetsBackendApiService', 'AudioPreloaderService',
      ...
      'ImagePreloaderService', 'ImprovementsService',
      ...
      'ReviewTestBackendApiService', 'SchemaDefaultValueService',
      'SchemaUndefinedLastElementService', 'SidebarStatusService',
      'SiteAnalyticsService', 'SkillRightsBackendApiService',
