...
angular.module('oppia').config([
  ...
  function(
    ...
    var servicesToProvide = [
      ...
      'ExplorationImprovementsTaskRegistryService', 'ExplorationObjectFactory',
      'ExplorationRecommendationsService', 'ExplorationRightsService',
      ...
      'ImageFileObjectFactory', 'InteractionObjectFactory',
      'InteractionRulesRegistryService', 'KeyboardShortcutService',
      ...
      'PlaythroughIssuesBackendApiService', 'PlaythroughIssuesService',
