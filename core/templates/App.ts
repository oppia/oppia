...
angular.module('oppia').config([
  ...
  function(
    ...
    var servicesToProvide = [
      ...
      'HtmlEscaperService', 'IdGenerationService', 'ImageFileObjectFactory',
      'ImprovementsService', 'InteractionObjectFactory',
      ...
      'LostChangeObjectFactory', 'MetaTagCustomizationService',
      ...
      'StateTopAnswersStatsBackendApiService', 'StopwatchObjectFactory',
