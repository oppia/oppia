...
oppia.factory('MessengerService', [
  '$log', '$window', function($log, $window) {
    ...
    var SUPPORTED_HASHDICT_VERSIONS = ['0.0.0', '0.0.1', '0.0.2', '0.0.3'];
    ...
    var getPayload = {
      ...
      explorationCompleted: function(data) {
        return {explorationVersion: data.explorationVersion};
      },
      // DEPRECATED
    ...
    var messenger = {
      ...
      // events sent to a container page.
        ...
        // Protractor tests may prepend a / to this hash, which we remove:
          var hash = (rawHash.charAt(0) === '/') ? rawHash.substring(1) :
           rawHash;
