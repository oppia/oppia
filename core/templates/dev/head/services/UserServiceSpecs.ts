...
describe('User Service', function() {
  ...
  it('should be return userInfo data', function() {
    ...
    UserService.getUserInfoAsync().then(function(userInfo) {
      ...
      expect(userInfo.is_topic_manager).toBe(sampleUserInfo.is_topic_manager);
      expect(userInfo.user_is_logged_in).toBe(
        sampleUserInfo.user_is_logged_in);
      expect(userInfo.can_create_collections).toBe(
        sampleUserInfo.can_create_collections);
      expect(userInfo.username).toBe(sampleUserInfo.username);
      expect(userInfo.preferred_site_language_code).toBe(
