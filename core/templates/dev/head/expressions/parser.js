// TODO(kashida): Change name scope programatically.
// Service for parsing expressions.
oppia.factory('expressionParserService', ['$log', function($log) {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c147 = function(condition, trueExpression, falseExpression) {
