...
require('pages/collection-editor-page/editor-tab/collection-editor-tab.directive.ts');
require('pages/collection-editor-page/history-tab/collection-history-tab.directive.ts');
require(
  'pages/collection-editor-page/settings-tab/collection-settings-tab.directive.ts');
require(
  'pages/collection-editor-page/statistics-tab/collection-statistics-tab.directive.ts');
