...
angular.module('oppia').directive('learnerDashboardPage', ['UrlInterpolationService', function(
      ...
      function(
        ...
        dashboardDataPromise.then(
          function(responseData) {
            ...
            ctrl.numberOfUnreadThreads = responseData.number_of_unread_threads;
            ctrl.explorationPlaylist = responseData.exploration_playlist;
            ctrl.collectionPlaylist = responseData.collection_playlist;
            ctrl.activeSection = LEARNER_DASHBOARD_SECTION_I18N_IDS.INCOMPLETE;
        ...
        ctrl.setExplorationsSortingOptions = function(sortType) {
          if (sortType === ctrl.currentExpSortType) {
            ctrl.isCurrentExpSortDescending = !ctrl.isCurrentExpSortDescending;
          } else {
