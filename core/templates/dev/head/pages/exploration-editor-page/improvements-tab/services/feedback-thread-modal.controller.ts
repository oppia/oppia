...
oppia.controller('FeedbackThreadModalController', [
  ...
  function(
    ...
    $scope.tmpMessage = {status: $scope.activeThread.status, text: ''};

    $scope.test = angular.toJson($scope.STATUS_CHOICES, true);

    $scope.getTitle = function() {
      return activeThread.subject;
    };
