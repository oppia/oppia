...
angular.module('oppia').directive('historyTab', ['UrlInterpolationService', function(
      ...
      function(
        ...
        */
        ...
        $scope.$on('refreshVersionHistory', function(evt, data) {
          ...
          angular.forEach(ctrl.versionCheckboxArray, function(versionCheckbox) {
        ...
        ctrl.refreshVersionHistory = function() {
          ...
          ExplorationDataService.getData().then(function(data) {
            ...
            $http.get(ctrl.explorationAllSnapshotsUrl).then(function(response) {
