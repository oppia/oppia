...
angular.module('oppia').directive('previewTab', ['UrlInterpolationService', function(
  ...
  return {
    ...
    controller: [
      ...
      function(
        ...
        // This allows the active state to be kept up-to-date whilst navigating
        // in preview mode, ensuring that the state does not change when
