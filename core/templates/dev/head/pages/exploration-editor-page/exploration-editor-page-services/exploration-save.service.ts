      ...
      return {
        ...
        showPublishExplorationModal: function(
          ...
          if (isAdditionalMetadataNeeded()) {
              ...
              controller: [
                ...
                function($scope, $uibModalInstance, ExplorationObjectiveService,
                  ...
                  $scope.save = function() {
                    ...
                    // It's currently used because there is a race condition:
                    // the saveDisplayedValue() calls above result in autosave
                    // calls. These race with the discardDraft() call that
            ...
            // No further metadata is needed. Open the publish modal
            // immediately.
            openPublishExplorationModal(
              onStartLoadingCallback, onEndLoadingCallback)
              .then(function() {
