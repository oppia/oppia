  ...
  'ExplorationWarningsService', [
    ...
    function(
      ...
      var _getUnreachableNodeNames = function(initNodeIds, nodes, edges) {
        ...
        while (queue.length > 0) {
          ...
          edges.forEach(function(edge) {
            if (
              edge.source === currNodeId && !seen.hasOwnProperty(
                edge.target)) {
      ...
      var _updateWarningsList = function() {
        ...
        angular.forEach(statesWithAnswersThatMustBeResolved, function(
            stateName) {
          _extendStateWarnings(
      ...
      return {
        ...
        hasCriticalWarnings: function() {
          return hasCriticalStateWarning || _warningsList.some(
            function(warning) {
