...
angular.module('oppia').directive('explorationEditorPage', ['UrlInterpolationService', function(
      ...
      function(
        ...
        ********************************************/
        ...
        ctrl.EDITOR_TUTORIAL_OPTIONS = [{
          ...
          heading: 'Responses',
          text: (
            'After the learner uses the interaction you created, it\'s your ' +
            'turn again to choose how your exploration will respond to their ' +
            'input. You can send a learner to a new card or have them repeat ' +
            'the same card, depending on how they answer.')
        }, {
          type: 'function',
          fn: function(isGoingForward) {
            var idToScrollTo = (
        ...
        ctrl.onFinishTutorial = function() {
          SiteAnalyticsService.registerFinishTutorialEvent(ctrl.explorationId);
          leaveTutorial();
        };
