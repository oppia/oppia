...
angular.module('oppia').directive('preferencesPage', ['UrlInterpolationService', function(
          ...
          if (subjectInterests instanceof Array) {
            for (var i = 0; i < subjectInterests.length; i++) {
              if (UtilsService.isString(subjectInterests[i])) {
                ...
                console.error(
                  'Error: received bad value for a subject interest. Expected' +
                  ' a string, got ', subjectInterests[i]);
                throw Error(
            ...
            console.error(
              'Error: received bad value for subject interests. Expected list' +
              ' of strings, got ', subjectInterests);
