            ...
            $scope.getCurrentInteractionName = function() {
              return (
                StateInteractionIdService.savedMemento ?
                  INTERACTION_SPECS[
                    StateInteractionIdService.savedMemento].name : '');
            };
                ...
                $uibModal.open({
                  ...
                  controller: [
                    ...
                    function(
                      ...
                      $scope.onChangeInteractionId = function(
                          newInteractionId) {
                        EditorFirstTimeEventsService
                        ...
                        if (
                          ...
                          $scope.customizationArgSpecs.forEach(function(
                              caSpec) {
                            StateCustomizationArgsService.displayed[
                              caSpec.name] =
                                {
                      ...
                      $scope.getSaveInteractionButtonTooltip = function() {
                        ...
                        var warningsList =
                          $scope.getCustomizationArgsWarningsList();
                        var warningMessages = warningsList.map(function(
                            warning) {
