  ...
  UrlInterpolationService){
    return {
      ...
      templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
        '/pages/creator_dashboard/creator_dashboard_page_directive.html'),
      controllerAs: '$ctrl',
      controller: [
        ...
        function(
          ...
          dashboardDataPromise.then(
            function(response) {
              ...
              ctrl.currentSubscribersSortType = SUBSCRIPTION_SORT_BY_KEYS.USERNAME;
          ...
          ctrl.getAverageRating = RatingComputationService.computeAverageRating;
          ctrl.createNewExploration = (
            ExplorationCreationService.createNewExploration);
          ctrl.getLocaleAbbreviatedDatetimeString = (
            DateTimeFormatService.getLocaleAbbreviatedDatetimeString);
          ctrl.enableQuestionSuggestions = constants.ENABLE_NEW_STRUCTURE_PLAYERS;
          ctrl.getHumanReadableStatus = (
            ThreadStatusDisplayService.getHumanReadableStatus);

          ctrl.emptyDashboardImgUrl = UrlInterpolationService.getStaticImageUrl(
