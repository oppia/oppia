        ...
        function(
          ...
          ctrl.showCreateQuestionModal = function() {
            ...
            $uibModal.open({
              ...
              resolve: {},
              controller: [
                'ctrl', '$uibModalInstance', function(
                    ctrl, $uibModalInstance) {
                  ctrl.question = question;
                  ctrl.topicId = null;
                  ctrl.topicSummaries = topicSummaries;
                  ctrl.misconceptions = [];
                  ctrl.errorMessage = null;

                  ctrl.isValidQuestion = function() {
                    var errorMessage = ctrl.question.validate([]);
                    if (!ctrl.topicId) {
                      ctrl.errorMessage = 'Please choose a topic before submitting';
                    } else if (errorMessage === false) {
                      ctrl.errorMessage = null;
                    } else {
                      ctrl.errorMessage = errorMessage;
                    }
                    return (ctrl.question.validate([]) === false);
                  };
