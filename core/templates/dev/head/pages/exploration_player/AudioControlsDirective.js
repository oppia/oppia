    ...
    return {
      ...
      controller: [
        ...
        function(
          ...
          var playPauseAutogeneratedAudio = function() {
          ...
          var playPauseAudioTranslation = function(languageCode) {
            if (AudioTranslationManagerService
              .isAutogeneratedLanguageCodeSelected()) {
              // This condition will be fulfilled as a callback if the learner
              // selects the autogenerated language after initially seeing the
              // modal asking for bandwidth confirmation.
              playPauseAutogeneratedAudio();
            } else {
              $scope.audioSettingsButtonIsShown = true;
