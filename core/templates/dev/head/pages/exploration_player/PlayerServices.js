...
oppia.factory('ExplorationPlayerService', [
  ...
  'ExplorationHtmlFormatterService', 'ExpressionInterpolationService',
  'GuestCollectionProgressService', 'ImagePreloaderService',
  'LanguageUtilService', 'LearnerParamsService', 'NumberAttemptsService',
  'PlayerCorrectnessFeedbackEnabledService', 'PlayerTranscriptService',
  'PlaythroughService', 'ReadOnlyExplorationBackendApiService',
  'StateClassifierMappingService', 'StatsReportingService',
  'UrlInterpolationService', 'WindowDimensionsService',
  'ExplorationObjectFactory', 'ENABLE_PLAYTHROUGH_RECORDING', 'PAGE_CONTEXT',
