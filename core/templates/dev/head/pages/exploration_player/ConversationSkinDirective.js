  ...
  function(urlService, UrlInterpolationService) {
    return {
      ...
      controller: [
        ...
        'messengerService', 'ExplorationPlayerService', 'urlService', 'focusService',
        ...
        function(
          ...
          $scope.initializePage = function() {
            ...
            ExplorationPlayerService.init(function(exploration, initHtml, newParams) {
          ...
          $scope.showPendingCard = function(
            ...
            $timeout(function() {
              var newInteractionHtml = ExplorationPlayerService.getInteractionHtml(
                newStateName, _nextFocusLabel);
              // Note that newInteractionHtml may be null.
              if (newInteractionHtml) {
                newInteractionHtml += ExplorationPlayerService.getRandomSuffix();
              }
