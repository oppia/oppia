    ...
    return {
      ...
      controller: [
        ...
        function(
          ...
          $scope.oldConceptCardIsBeingShown = false;
          ...
          var _navigateToActiveCard = function() {
            ...
            if ($scope.activeCard.conceptCard) {
              $scope.missingPrerequisiteSkillId = null;
              $scope.conceptCardIsBeingShown = true;
              $scope.oldConceptCardIsBeingShown = true;
            }
          ...
          $scope.returnToExploration = function() {
            $scope.conceptCardIsBeingShown = false;
            $scope.activeCard.conceptCard = null;
            PlayerTranscriptService.addExistingCard($scope.activeCard);
