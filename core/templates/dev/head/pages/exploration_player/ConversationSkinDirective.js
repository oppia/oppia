      ...
      controller: [
        ...
        function(
          ...
          $scope.isSupplementalNavShown = function() {
            if (ExplorationEngineService.isStateShowingConceptCard()) {
              return false;
            }
            var interaction = ExplorationEngineService.getCurrentInteraction();
            return (
          ...
          var _addNewCard = function(
            ...
            if (ExplorationEngineService.isStateTerminal()) {
          ...
          var _initializeDirectiveComponents = function(
            ...
            _addNewCard(
              ...
              newParams,
              initHtml,
              ExplorationEngineService.getCurrentInteractionHtml(_nextFocusLabel));
            ...
            if (_editorPreviewMode) {
              ...
              if (version) {
                  ReadOnlyExplorationBackendApiService.loadExploration(
                    explorationId, version).then(function(returnDict) {
            ...
            $scope.answerIsCorrect = ExplorationEngineService.submitAnswer(
              answer, interactionRulesService, function(
                ...
                var millisecsLeftToWait = (
                  !ExplorationEngineService.isInteractionInline() ? 1.0 :
                  ...
                  if (onSameCard) {
                    ...
                    if (refreshInteraction) {
                      ...
                      PlayerTranscriptService.updateLatestInteractionHtml(
                        ExplorationEngineService.getCurrentInteractionHtml(
                    ...
                    var _isNextInteractionInline = (
                      ExplorationEngineService.isNextInteractionInline());
                    $scope.upcomingInlineInteractionHtml = (
                      _isNextInteractionInline ?
                        ExplorationEngineService.getNextInteractionHtml(
                          _nextFocusLabel
                        ) + _getRandomSuffix() : '');
                    $scope.upcomingInteractionInstructions = (
                      ExplorationEngineService.getNextInteractionInstructions()
                    );
