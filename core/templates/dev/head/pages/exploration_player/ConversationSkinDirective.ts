...
require('components/question-directives/question-player/question-player-state.service.ts');
...
require('pages/exploration_player/SupplementalCardDirective.ts');
require('pages/exploration_player/TutorCardDirective.ts');
...
require('pages/exploration_player/ExplorationRecommendationsService.ts');
require('pages/exploration_player/FatigueDetectionService.ts');
...
require('pages/exploration_player/LearnerViewRatingService.ts');
