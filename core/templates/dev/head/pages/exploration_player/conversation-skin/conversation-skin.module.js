...
angular.module('conversationSkinModule').animation('.conversation-skin-animate-tutor-card-on-narrow', function() {
...
angular.module('conversationSkinModule').animation('.conversation-skin-animate-tutor-card-content', function() {
...
angular.module('conversationSkinModule').animation('.conversation-skin-animate-cards', function() {
