...
oppia.constant('PLAYTHROUGH_ENABLED_EXPLORATION_WHITELIST', [
  // NOTE: These are the exploration ids of the Fractions lessons.
...
oppia.factory('PlaythroughService', [
  ...
  'ACTION_TYPE_EXPLORATION_START', 'CURRENT_ACTION_SCHEMA_VERSION',
  ...
  'PAGE_CONTEXT', 'PLAYTHROUGH_ENABLED_EXPLORATION_WHITELIST',
  'STORE_PLAYTHROUGH_URL',
  function(
      $http, LearnerActionObjectFactory, PlaythroughObjectFactory,
      StopwatchObjectFactory, UrlInterpolationService,
