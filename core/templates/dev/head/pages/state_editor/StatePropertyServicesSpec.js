...
describe('Change list service', function() {
  ...
  describe('change list service', function() {
    ...
    var validAutosaveResponse = {is_version_of_draft_valid: true};

    beforeEach(function() {
      mockWarningsData = {addWarning: function() {}};
    ...
    it('should correctly get and save changes', function() {
      ...
      expect(mockExplorationData.autosaveChangeList)
        .toHaveBeenCalled();
      $httpBackend.expectPUT(autosaveDraftUrl)
        .respond(validAutosaveResponse);
    });
...
describe('Exploration title service', function() {
  ...
  describe('exploration title service', function() {
    ...
    it('correctly initializes the service', function() {
      expect(ets.displayed)
        .toBeUndefined();
      expect(ets.savedMemento)
        .toBeUndefined();
      ets.init('A title');
      expect(ets.displayed)
        .toEqual('A title');
