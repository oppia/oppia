...
require('pages/exploration-player-page/layout-directives/audio-bar.directive.ts');
require('pages/exploration-player-page/learner-experience/input-response-pair.directive.ts');
