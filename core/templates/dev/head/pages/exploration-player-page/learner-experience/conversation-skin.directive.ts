  ...
  function(UrlInterpolationService, UrlService, UserService) {
    return {
      ...
      controller: [
        ...
        'PlayerPositionService', 'PlayerTranscriptService', 'PlaythroughService',
        'PretestQuestionBackendApiService', 'QuestionPlayerEngineService',
        'QuestionPlayerStateService', 'ReadOnlyExplorationBackendApiService',
