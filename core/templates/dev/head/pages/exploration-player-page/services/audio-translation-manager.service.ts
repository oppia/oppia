...
export class AudioTranslationManagerService {
  ...
  _contentAudioTranslations: any = null;
  _contentHtmlForAutogeneratedAudio: any = null;

  // Audio translations for everything other than the main content, such as
  // those for feedback, hints, and solutions.
  _secondaryAudioTranslations: any = null;
  _secondaryHtmlForAutogeneratedAudio: any = null;

  _currentPrimaryComponentName: any = null;
  _currentSecondaryComponentName: any = null;

  setContentAudioTranslations(
      audioTranslations: any, html: any, componentName: any): void {
  ...
  getCurrentAudioTranslations(): any {
  ...
  getCurrentHtmlForAutogeneratedAudio(): any {
