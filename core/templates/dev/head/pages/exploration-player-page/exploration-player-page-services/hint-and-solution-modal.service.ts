...
require('pages/exploration-player-page/exploration-player-page-services/audio-translation-manager.service.ts');
    ...
    return {
      ...
      displaySolutionInterstitialModal: function() {
        return $uibModal.open({
          templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
            '/pages/exploration-player-page/' +
            'exploration-player-page-templates/solution-interstitial-modal.template.html'),
          backdrop: 'static',
          controller: [
