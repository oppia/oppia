...
require('pages/exploration-player-page/exploration-player-page-services/extract-image-filenames-from-state/extract-image-filenames-from-state.service.ts');
