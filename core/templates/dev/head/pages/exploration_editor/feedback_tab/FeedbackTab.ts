  ...
  UrlInterpolationService){
    return {
      ...
      templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
        '/pages/exploration_editor/feedback_tab/feedback_tab.html'),
      controllerAs: '$ctrl',
      controller: [
        ...
        function(
          ...
          ctrl.showCreateThreadModal = function() {
            $uibModal.open({
              ...
              backdrop: true,
              resolve: {},
              controller: ['ctrl', '$uibModalInstance', function(
                  ctrl, $uibModalInstance) {
                ctrl.newThreadSubject = '';
                ctrl.newThreadText = '';

                ctrl.create = function(newThreadSubject, newThreadText) {
                  if (!newThreadSubject) {
          ...
          ctrl.setActiveThread = function(threadId) {
            ...
            var allThreads = [].concat(
              ctrl.threadData.feedbackThreads, ctrl.threadData.suggestionThreads);
