  ...
  UrlInterpolationService){
    return {
      ...
      templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
        '/pages/exploration_editor/history_tab/history_tab.html'),
      controllerAs: '$ctrl',
      controller: [
          ...
          */
          ...
          ctrl.refreshVersionHistory = function() {
            ...
            ExplorationDataService.getData().then(function(data) {
              ...
              $http.get(ctrl.explorationAllSnapshotsUrl).then(function(
                  response) {
          ...
          ctrl.showRevertExplorationModal = function(version) {
            $uibModal.open({
              ...
              controller: [
                'ctrl', '$uibModalInstance', 'version',
                'ExplorationDataService',
                function(
                    ctrl, $uibModalInstance, version, ExplorationDataService) {
                  ctrl.version = version;

                  ctrl.getExplorationUrl = function(version) {
                    return (
