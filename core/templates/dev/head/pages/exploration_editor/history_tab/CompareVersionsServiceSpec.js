...
describe('Compare versions service', function() {
  ...
  describe('compare versions service', function() {
    ...
    beforeEach(function() {
      mockExplorationData = {explorationId: '0'};
    ...
    var _getStatesData = function(statesDetails) {
      ...
      return {exploration: {states: statesData}};
    };
