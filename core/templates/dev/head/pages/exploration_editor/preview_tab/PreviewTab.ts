  ...
  UrlInterpolationService){
    return {
      ...
      templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
        '/pages/exploration_editor/preview_tab/preview_tab.html'),
      controllerAs: '$ctrl',
      controller: [
        ...
        function(
          ...
          ctrl.showSetParamsModal = function(manualParamChanges, callback) {
            var modalInstance = $uibModal.open({
              ...
              controller: [
                'ctrl', '$uibModalInstance', 'RouterService',
                function(ctrl, $uibModalInstance, RouterService) {
                  ctrl.manualParamChanges = manualParamChanges;
                  ctrl.previewParamModalOk = $uibModalInstance.close;
                  ctrl.previewParamModalCancel = function() {
