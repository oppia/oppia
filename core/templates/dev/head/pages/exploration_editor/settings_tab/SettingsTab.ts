  ...
  UrlInterpolationService){
    return {
      ...
      templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
        '/pages/exploration_editor/settings_tab/settings_tab.html'),
      controllerAs: '$ctrl',
      controller: [
        ...
        function(
            ...
            if (ExplorationStatesService.isInitialized()) {
              var categoryIsInSelect2 = ctrl.CATEGORY_LIST_FOR_SELECT2.some(
                function(categoryItem) {
                  return categoryItem.id === ExplorationCategoryService
                    .savedMemento;
                }
              );
          ...
          ctrl.previewSummaryTile = function() {
            ...
            $uibModal.open({
              ...
              backdrop: true,
              controller: [
                'ctrl', '$uibModalInstance', function(ctrl, $uibModalInstance) {
                  ctrl.getExplorationTitle = function() {
                    return ExplorationTitleService.displayed;
                  };
                  ctrl.getExplorationObjective = function() {
                    return ExplorationObjectiveService.displayed;
                  };
                  ctrl.getExplorationCategory = function() {
                    return ExplorationCategoryService.displayed;
                  };
                  ctrl.getThumbnailIconUrl = function() {
                  ...
                  ctrl.getThumbnailBgColor = function() {
                    var category = ExplorationCategoryService.displayed;
                    var color = null;
          ...
          ctrl.showTransferExplorationOwnershipModal = function() {
            ...
            $uibModal.open({
              ...
              controller: [
                'ctrl', '$uibModalInstance', function(ctrl, $uibModalInstance) {
                  ctrl.transfer = $uibModalInstance.close;
          ...
          ctrl.deleteExploration = function() {
            ...
            $uibModal.open({
              ...
              controller: [
                'ctrl', '$uibModalInstance', function(ctrl, $uibModalInstance) {
                  ctrl.reallyDelete = $uibModalInstance.close;
          ...
          ctrl.unpublishExplorationAsModerator = function() {
            ...
            $http.get(moderatorEmailDraftUrl).then(function(response) {
              ...
              $uibModal.open({
                ...
                controller: [
                  'ctrl', '$uibModalInstance', 'draftEmailBody',
                  function(ctrl, $uibModalInstance, draftEmailBody) {
