...
oppia.directive('explorationEditor', ['UrlInterpolationService', function(
  UrlInterpolationService){
    return {
      ...
      templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
        '/pages/exploration_editor/exploration-editor-page.directive.html'),
      controllerAs: '$ctrl',
      controller: [
          ...
          ********************************************/
          ...
          ctrl.showWelcomeExplorationModal = function() {
            var modalInstance = $uibModal.open({
              ...
              backdrop: true,
              controller: [
                'ctrl', '$uibModalInstance', 'SiteAnalyticsService',
                'ContextService',
                function(ctrl, $uibModalInstance, SiteAnalyticsService,
                    ContextService) {
                  var explorationId = ContextService.getExplorationId();

                  SiteAnalyticsService.registerTutorialModalOpenEvent(explorationId);

                  ctrl.beginTutorial = function() {
