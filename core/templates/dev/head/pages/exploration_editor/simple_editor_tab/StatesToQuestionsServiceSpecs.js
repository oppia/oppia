...
/**
 * @fileoverview Unit tests for the StatesToQuestionsService.js
 */

 describe('States To Question Service', function() {
   var statesToQuestionsService;

   beforeEach(module('oppia'));
   beforeEach(inject(function($injector) {
     statesToQuestionsService = $injector
       .get('StatesToQuestionsService');
   }));
