        ...
        function(
          ...
          ctrl.openStateGraphModal = function() {
            ...
            $uibModal.open({
              ...
              controller: [
                'ctrl', '$uibModalInstance', 'StateEditorService',
                'GraphDataService', 'isEditable',
                function(ctrl, $uibModalInstance, StateEditorService,
                    GraphDataService, isEditable) {
                  ctrl.currentStateName = StateEditorService
                    .getActiveStateName();
                  ctrl.graphData = GraphDataService.getGraphData();
                  ctrl.isEditable = isEditable;

                  ctrl.deleteState = function(stateName) {
                  ...
                  ctrl.selectState = function(stateName) {
                    $uibModalInstance.close({
                      action: 'navigate',
                      stateName: stateName
                    });
