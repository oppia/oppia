  ...
  UrlInterpolationService){
    return {
      ...
      templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
        '/pages/exploration_editor/editor_tab/exploration_editor_tab.html'),
      controllerAs: '$ctrl',
      controller: [
        ...
        function(
          ...
          ctrl.saveContentIdsToAudioTranslations = function(displayedValue) {
          ...
          ctrl.showMarkAllAudioAsNeedingUpdateModalIfRequired = function(
            ...
            var contentIdsToAudioTranslations = state
            ...
            if (contentIdsToAudioTranslations.hasUnflaggedAudioTranslations(
              ...
              $uibModal.open({
                templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
                  '/components/forms/' +
                  'mark_all_audio_and_translations_as_needing_' +
