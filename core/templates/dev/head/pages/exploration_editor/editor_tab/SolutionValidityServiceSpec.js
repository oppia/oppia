...
/**
 * @fileoverview Unit tests for State Validity Service.
 */

describe('State Validity Service', function() {
  describe('StateValidityService', function() {
    ...
    it('should store the correct validity of a solution',
      function() {
        ...
        svs.verifySolution(0, state,
          ...
          function() {
            ...
            expect(ess.isSolutionValid('First State')).toEqual(true);
          },
          function() {
        ...
        svs.verifySolution(0, state,
          ...
          function() {
            ess.updateSolutionValidity('First State', false);
            expect(ess.isSolutionValid('First State'), false);
          });
      }
    );
  });
