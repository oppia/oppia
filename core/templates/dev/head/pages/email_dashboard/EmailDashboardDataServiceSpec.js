...
describe('Email Dashboard Services', function() {
  ...
  describe('Email Dashboard Services', function() {
    ...
    it('should fetch correct data from backend', function() {
      ...
      $httpBackend.expectGET(/.*?emaildashboarddatahandler?.*/g)
        .respond({
      ...
      $httpBackend.flush();
      expect(service.getQueries().length)
        .toEqual(2);
      expect(service.getQueries())
        .toEqual(recentQueries);
      expect(service.getCurrentPageIndex())
        .toEqual(0);
      expect(service.getLatestCursor())
        .toBe(null);
    });
    ...
    it('should post correct data to backend', function() {
      ...
      $httpBackend.expectPOST('/emaildashboarddatahandler')
        .respond({query: queryData});
    ...
    it('should replace correct query in queries list', function() {
      ...
      $httpBackend.expectGET(/.*?querystatuscheck?.*/g)
        .respond({
          query: {
            id: 'q123',
            status: 'completed'
    ...
    it('should check simulation', function() {
      ...
      service.getNextQueries()
        .then(function(queries) {
          expect(queries.length)
            ...
            .toEqual(totalQueries.slice(10, 20));
        });
      expect(service.getCurrentPageIndex())
        .toEqual(1);
      ...
      service.getNextQueries()
        .then(function(queries) {
          expect(queries.length)
            ...
            .toEqual(totalQueries.slice(20, 25));
        });
      expect(service.getCurrentPageIndex())
        .toEqual(2);

      // Go back to page 1 and check again.
      expect(service.getPreviousQueries())
        .toEqual(totalQueries.slice(10, 20));
      expect(service.getCurrentPageIndex())
        .toEqual(1);
      ...
      service.getNextQueries()
        .then(function(queries) {
          expect(queries.length)
            ...
            .toEqual(totalQueries.slice(20, 26));
        });
      expect(service.getCurrentPageIndex())
        .toEqual(2);
      ...
      expect(service.getPreviousQueries())
        .toEqual(totalQueries.slice(0, 10));
      expect(service.getCurrentPageIndex())
        .toEqual(0);
    });
  });
