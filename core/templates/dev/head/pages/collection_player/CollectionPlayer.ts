...
oppia.directive('collectionPlayer', ['UrlInterpolationService', function(
      ...
      controller: [
        ...
        function(
          ...
          ctrl.generatePathParameters = function() {
            ...
            // The sParameterExtension represents the co-ordinates following the
            // 'S' (smooth curve to) command in SVG.
          ...
          ReadOnlyCollectionBackendApiService.loadCollection(
            ...
            function(collectionBackendObject) {
              ...
              // Load the user's current progress in the collection. If the user
              // is a guest, then either the defaults from the server will be
              // used or the user's local progress, if any has been made and the
              // collection is whitelisted.
