...
oppia.factory('StatsReportingService', [
  ...
  return {
    initSession: function(newExplorationId, newExplorationVersion, newSessionId, collectionId) {
    ...
    // Note that this also resets the stopwatch.
    recordStateTransition: function(oldStateName, newStateName, answer, oldParams) {
      $http.post(getFullStatsUrl('STATE_HIT'), {
    ...
    recordAnswerSubmitted: function(stateName, params, answer, answerGroupIndex, ruleSpecIndex) {
