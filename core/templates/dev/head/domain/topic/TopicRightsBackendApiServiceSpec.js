...
describe('Topic rights backend API service', function() {
  ...
  it('should successfully publish and unpublish a topic', function() {
    ...
    $httpBackend.expect(
      'PUT', '/rightshandler/change_topic_status/0')
      .respond(200);
    TopicRightsBackendApiService.publishTopic('0')
      .then(
    ...
    $httpBackend.expect(
      'PUT', '/rightshandler/change_topic_status/0')
      .respond(200);
    TopicRightsBackendApiService.unpublishTopic('0')
      .then(
        successHandler, failHandler);
    $httpBackend.flush();
    $rootScope.$digest();
  ...
  it('should report an uncached topic rights after caching it', function() {
    ...
    $httpBackend.expect(
      'GET', '/rightshandler/get_topic_rights/0')
      .respond(200, {
        topic_id: 0,
