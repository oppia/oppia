...
var CollectionPlaythroughObjectFactory = function() {
  // TODO(bhenning): Add setters for some of these properties. Setters allow the
  // collection editor to setup specifically configured playthrough sessions of
  // the collection player through this object (for example, the editor would be
  // able to fake which explorations were completed to see how that particular
  // configuration would look for a learner).

  // Stores information about a current playthrough of a collection for a user.
  ...
  // Static class methods. Note that "this" is not available in static contexts.
  // This function takes a JSON object which represents a backend collection
  // playthrough python dict.
  CollectionPlaythrough.create = function(collectionPlaythroughBackendObject) {
