...
describe('Language util service', function() {
  ...
  it('should get the correct language count', function() {
    expect(lus.getAudioLanguagesCount())
      .toEqual(3);
  });

  it('should get the correct description given an audio language code',
    function() {
      expect(lus.getAudioLanguageDescription('en'))
        .toEqual('English');
      expect(lus.getAudioLanguageDescription('hi-en'))
        .toEqual('Hinglish');
      expect(lus.getAudioLanguageDescription('es'))
        .toEqual('Spanish');
    }
  );
  ...
  it('should correctly compute the complement languages', function() {
    ...
    expect(lus.getComplementAudioLanguageCodes(['hi-en', 'en']))
      .toEqual(['es']);
    expect(lus.getComplementAudioLanguageCodes(['abcdefg']))
      .toEqual(['en', 'hi-en', 'es']);
  });
  ...
  it('should correctly check if language supports autogenerated audio',
    function() {
      ...
      // https://stackoverflow.com/questions/21513706/
      window.speechSynthesis.onvoiceschanged = function() {
        expect(lus.supportsAutogeneratedAudio('hi'))
          .toEqual(false);
        expect(lus.supportsAutogeneratedAudio('en'))
          .toEqual(true);
      };
    });

  it('should correctly check if audio language is autogenerated', function() {
    expect(lus.isAutogeneratedAudioLanguage('en'))
      .toEqual(false);
    expect(lus.isAutogeneratedAudioLanguage('en-auto'))
      .toEqual(true);
  });

  it('should get correct autogenerated audio language with given code',
    function() {
      expect(Object.values(lus.getAutogeneratedAudioLanguage('en')))
        .toEqual(
