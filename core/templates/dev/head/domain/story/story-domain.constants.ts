...
angular.module('oppia').constant('CMD_UPDATE_STORY_PROPERTY', 'update_story_property');
angular.module('oppia').constant('CMD_UPDATE_STORY_NODE_PROPERTY', 'update_story_node_property');
angular.module('oppia').constant(
...
angular.module('oppia').constant('STORY_PROPERTY_LANGUAGE_CODE', 'language_code');
...
angular.module('oppia').constant('STORY_NODE_PROPERTY_EXPLORATION_ID', 'exploration_id');
angular.module('oppia').constant(
  'STORY_NODE_PROPERTY_DESTINATION_NODE_IDS', 'destination_node_ids');
angular.module('oppia').constant('STORY_NODE_PROPERTY_ACQUIRED_SKILL_IDS', 'acquired_skill_ids');
angular.module('oppia').constant(
