...
oppia.factory('LearnerDashboardActivityIdsObjectFactory', [
  function() {
    ...
    LearnerDashboardActivityIds.prototype
      .removeFromExplorationLearnerPlaylist = (
        function(explorationId) {
    ...
    LearnerDashboardActivityIds.prototype
      .removeFromCollectionLearnerPlaylist = (
        function(collectionId) {
