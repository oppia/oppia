...
describe('Learner dashboard activity ids object factory', function() {
  ...
  it('should check if activity id is present among learner dashboard ' +
    ...
    expect(learnerDashboardActivityIds.includesActivity('0'))
      .toEqual(true);
    expect(learnerDashboardActivityIds.includesActivity('1'))
      .toEqual(true);
    expect(learnerDashboardActivityIds.includesActivity('8'))
      .toEqual(true);

    expect(learnerDashboardActivityIds.includesActivity('12'))
      .toEqual(false);
    expect(learnerDashboardActivityIds.includesActivity('13'))
      .toEqual(false);
    expect(learnerDashboardActivityIds.includesActivity('14'))
      .toEqual(false);
  });
  ...
  it('should add exploration to learner playlist', function() {
    ...
    expect(learnerDashboardActivityIds.explorationPlaylistIds)
      .toEqual(
        ['8', '9', '12']);
  ...
  it('should add collection to learner playlist', function() {
    ...
    expect(learnerDashboardActivityIds.collectionPlaylistIds)
      .toEqual(
        ['10', '11', '12']);
  ...
  it('should fetch the learner dashboard activity ids domain object from the ' +
    ...
    expect(learnerDashboardActivityIds.incompleteExplorationIds)
      .toEqual(
        ['0', '1']);
    expect(learnerDashboardActivityIds.incompleteCollectionIds)
      .toEqual(
        ['2', '3']);
    expect(learnerDashboardActivityIds.completedExplorationIds)
      .toEqual(
        ['4', '5']);
    expect(learnerDashboardActivityIds.completedCollectionIds)
      .toEqual(
        ['6', '7']);
    expect(learnerDashboardActivityIds.explorationPlaylistIds)
      .toEqual(
