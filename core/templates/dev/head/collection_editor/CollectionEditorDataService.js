...
/**
 * @fileoverview Standalone services for the collection editor page.
 *
...
oppia.factory('collectionEditorDataService', [
  ...
  var _fetchCollection = function(collectionId, successCallback, errorCallback) {   
    var collectionDataUrl = urlInterpolationService.interpolateUrl(
      COLLECTION_EDITOR_DATA_URL, {'collection_id': collectionId});
  ...
  return {
    ...
    fetchCollection: function(collectionId, successCallback, errorCallback) {
      _fetchCollection(collection_id, successCallback, errorCallback)
    },
