...
require('components/question-directives/question-editor/question-editor.constants.ts');
  ...
  'UrlInterpolationService', function(UrlInterpolationService) {
    return {
      ...
      templateUrl: UrlInterpolationService.getDirectiveTemplateUrl(
        '/components/question-directives/question-editor/question-editor.directive.html'),
      controller: [
