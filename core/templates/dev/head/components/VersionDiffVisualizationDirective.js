...
oppia.directive('versionDiffVisualization', [function() {
  return {
    restrict: 'E',
    scope: {
      ...
      //     later version
      // - v1States: the states dict for the earlier version of the exploration
      // - v2States: the states dict for the later version of the exploration
      getDiffData: '&diffData',
      // The header for the pane of the state comparison modal corresponding to
      // the earlier version of the exploration.
    ...
    controller: ['$scope', '$modal', function($scope, $modal) {
      ...
      // false depending on whether the state property is used in the diff
      // graph. (Will be used to generate legend)
      var _stateTypeUsed = {};
