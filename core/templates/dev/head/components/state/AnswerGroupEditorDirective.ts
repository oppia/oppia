            ...
            var modalInstance = $uibModal.open({
              ...
              controller: [
                ...
                function(ctrl, $uibModalInstance, StateEditorService) {
                  ...
                  ctrl.misconceptionFeedbackIsUsed = false;

                  ctrl.selectMisconception = function(misconception) {
                  ...
                  ctrl.done = function() {
                    $uibModalInstance.close({
                      misconception: ctrl.selectedMisconception,
                      feedbackIsUsed: ctrl.misconceptionFeedbackIsUsed
                    });
                  };
