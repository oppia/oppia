...
describe('Learner dashboard activity ids model', () => {
  ...
  it(
    'should check if activity id is present among learner dashboard ' +
      'activity ids',
    () => {
  ...
  it('should remove topic from learn', () => {
    ...
    expect(learnerDashboardActivityIds.topicIdsToLearn).toEqual(['19']);
  ...
  it(
    'should fetch the learner dashboard activity ids domain object from ' +
  ...
  it('should check if topicId belongs to learn', () => {
    ...
    expect(learnerDashboardActivityIds.belongsToTopicsToLearn('18')).toBe(true);
    expect(learnerDashboardActivityIds.belongsToTopicsToLearn('19')).toBe(true);

    expect(learnerDashboardActivityIds.belongsToTopicsToLearn('0')).toBe(false);
    expect(learnerDashboardActivityIds.belongsToTopicsToLearn('2')).toBe(false);
    expect(learnerDashboardActivityIds.belongsToTopicsToLearn('4')).toBe(false);
    expect(learnerDashboardActivityIds.belongsToTopicsToLearn('6')).toBe(false);
    expect(learnerDashboardActivityIds.belongsToTopicsToLearn('10')).toBe(
      false
    );
  });
  ...
  it('should check if explorationId belongs to completed explorations', () => {
    ...
    expect(
      learnerDashboardActivityIds.belongsToCompletedExplorations('6')
    ).toBe(true);
    expect(
      learnerDashboardActivityIds.belongsToCompletedExplorations('7')
    ).toBe(true);

    expect(
      learnerDashboardActivityIds.belongsToCompletedExplorations('0')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToCompletedExplorations('2')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToCompletedExplorations('5')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToCompletedExplorations('8')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToCompletedExplorations('10')
    ).toBe(false);
  });
  ...
  it('should check if collectionId belongs to completed collections', () => {
    ...
    expect(learnerDashboardActivityIds.belongsToCompletedCollections('8')).toBe(
      true
    );
    expect(learnerDashboardActivityIds.belongsToCompletedCollections('9')).toBe(
      true
    );

    expect(learnerDashboardActivityIds.belongsToCompletedCollections('0')).toBe(
      false
    );
    expect(learnerDashboardActivityIds.belongsToCompletedCollections('2')).toBe(
      false
    );
    expect(learnerDashboardActivityIds.belongsToCompletedCollections('4')).toBe(
      false
    );
    expect(learnerDashboardActivityIds.belongsToCompletedCollections('7')).toBe(
      false
    );
    expect(
      learnerDashboardActivityIds.belongsToCompletedCollections('12')
    ).toBe(false);
  });
  ...
  it('should check if storyId belongs to completed stories', () => {
    ...
    expect(learnerDashboardActivityIds.belongsToCompletedStories('10')).toBe(
      true
    );
    expect(learnerDashboardActivityIds.belongsToCompletedStories('11')).toBe(
      true
    );

    expect(learnerDashboardActivityIds.belongsToCompletedStories('0')).toBe(
      false
    );
    expect(learnerDashboardActivityIds.belongsToCompletedStories('2')).toBe(
      false
    );
    expect(learnerDashboardActivityIds.belongsToCompletedStories('4')).toBe(
      false
    );
    expect(learnerDashboardActivityIds.belongsToCompletedStories('8')).toBe(
      false
    );
    expect(learnerDashboardActivityIds.belongsToCompletedStories('12')).toBe(
      false
    );
  });
  ...
  it('should check if topicId belongs to learnt topics', () => {
    ...
    expect(learnerDashboardActivityIds.belongsToLearntTopics('12')).toBe(true);
    expect(learnerDashboardActivityIds.belongsToLearntTopics('13')).toBe(true);

    expect(learnerDashboardActivityIds.belongsToLearntTopics('0')).toBe(false);
    expect(learnerDashboardActivityIds.belongsToLearntTopics('2')).toBe(false);
    expect(learnerDashboardActivityIds.belongsToLearntTopics('4')).toBe(false);
    expect(learnerDashboardActivityIds.belongsToLearntTopics('8')).toBe(false);
    expect(learnerDashboardActivityIds.belongsToLearntTopics('11')).toBe(false);
  });
  ...
  it('should check if explorationId belongs to incomplete explorations', () => {
    ...
    expect(
      learnerDashboardActivityIds.belongsToIncompleteExplorations('0')
    ).toBe(true);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteExplorations('1')
    ).toBe(true);

    expect(
      learnerDashboardActivityIds.belongsToIncompleteExplorations('2')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteExplorations('4')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteExplorations('6')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteExplorations('8')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteExplorations('10')
    ).toBe(false);
  });
  ...
  it('should check if collectionId belongs to incomplete collections', () => {
    ...
    expect(
      learnerDashboardActivityIds.belongsToIncompleteCollections('2')
    ).toBe(true);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteCollections('3')
    ).toBe(true);

    expect(
      learnerDashboardActivityIds.belongsToIncompleteCollections('0')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteCollections('4')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteCollections('6')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteCollections('8')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToIncompleteCollections('10')
    ).toBe(false);
  });
  ...
  it('should check if topicsId belongs to partially learnt topics', () => {
    ...
    expect(
      learnerDashboardActivityIds.belongsToPartiallyLearntTopics('4')
    ).toBe(true);
    expect(
      learnerDashboardActivityIds.belongsToPartiallyLearntTopics('5')
    ).toBe(true);

    expect(
      learnerDashboardActivityIds.belongsToPartiallyLearntTopics('0')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToPartiallyLearntTopics('2')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToPartiallyLearntTopics('3')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToPartiallyLearntTopics('8')
    ).toBe(false);
    expect(
      learnerDashboardActivityIds.belongsToPartiallyLearntTopics('10')
    ).toBe(false);
  });
});
