...
describe('Voiceover backend API service', function() {
  ...
  it(
    'should be able to get voice artist metadata information',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');

      voiceoverBackendApiService.fetchVoiceArtistMetadtaAsync().then(
        successHandler, failHandler);
      let req = httpTestingController.expectOne(
  ...
  it(
    'should handle error callback while getting voice artist metadata info',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
  ...
  it(
    'should be able to update language accent for voice artist',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
      ...
      voiceoverBackendApiService.updateVoiceArtistToLanguageAccentAsync(
  ...
  it(
    'should be able to get filenames for the given voice artist',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');

      voiceoverBackendApiService.fetchFilenamesForVoiceArtistAsync(
        'voiceArtistId', 'languageCode').then(successHandler, failHandler);
      let req = httpTestingController.expectOne(
  ...
  it(
    'should handle error callback while getting filenames for voice artist',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
