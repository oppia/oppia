...
angular
  .module('oppia')
  .constant('CMD_ADD_STORY_NODE', StoryDomainConstants.CMD_ADD_STORY_NODE);
angular
  .module('oppia')
  .constant(
    'CMD_DELETE_STORY_NODE',
...
angular
  .module('oppia')
  .constant('STORY_PROPERTY_TITLE', StoryDomainConstants.STORY_PROPERTY_TITLE);
angular
  .module('oppia')
  .constant(
...
angular
  .module('oppia')
  .constant('STORY_PROPERTY_NOTES', StoryDomainConstants.STORY_PROPERTY_NOTES);
angular
  .module('oppia')
  .constant(
...
angular
  .module('oppia')
  .constant('INITIAL_NODE_ID', StoryDomainConstants.INITIAL_NODE_ID);
