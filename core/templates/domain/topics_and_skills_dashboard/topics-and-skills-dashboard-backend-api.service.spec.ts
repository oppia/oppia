...
describe('Topics and Skills Dashboard backend API service', () => {
  ...
  let categorizedAndUntriagedSkillsDataBackendDict: CategorizedAndUntriagedSkillsDataBackendDict;
  let categorizedAndUntriagedSkillsDataBackendResponse: CategorizedAndUntriagedSkillsData;
  ...
  it(
    'should successfully fetch topic and skills dashboard ' +
  ...
  it('should fail to fetch topic and skills dashboard data from the backend', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    topicsAndSkillsDashboardBackendApiService
      .fetchDashboardDataAsync()
  ...
  it('should successfully fetch skills dashboard data from the backend', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    let filter = TopicsAndSkillsDashboardFilter.createDefault();

    topicsAndSkillsDashboardBackendApiService
      .fetchSkillsDashboardDataAsync(filter, 0, 'next')
      .then(successHandler, failHandler);
  ...
  it('should fail to fetch skills dashboard data from backend', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    let filter = TopicsAndSkillsDashboardFilter.createDefault();
  ...
  it(
    'should successfully fetch topic id to diagnostic test skill ids from ' +
      'the backend',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
      ...
      topicsAndSkillsDashboardBackendApiService
        .fetchTopicIdToDiagnosticTestSkillIdsAsync(topicIds)
        .then(successHandler, failHandler);
  ...
  it(
    'should fail to fetch topic id to diagnostic test skill ids from ' +
      'the backend',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
  ...
  it('should successfully fetch assigned skills data from the backend', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    topicsAndSkillsDashboardBackendApiService
      .fetchTopicAssignmentsForSkillAsync('skillId')
      .then(successHandler, failHandler);
  ...
  it('should fail to fetch assigned skills data from the backend', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    topicsAndSkillsDashboardBackendApiService
      .fetchTopicAssignmentsForSkillAsync('invalidId')
      .then(successHandler, failHandler);
  ...
  it(
    'should successfully merge skills given their ' + "skill Id's",
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
      topicsAndSkillsDashboardBackendApiService
        .mergeSkillsAsync('oldSkilldId', 'newSkillId')
        .then(successHandler, failHandler);

      let req = httpTestingController.expectOne('/merge_skills_handler');
      expect(req.request.method).toEqual('POST');
      req.flush(200);
      flushMicrotasks();
  ...
  it("should fail to merge skills given their skill Id's", fakeAsync(() => {
    ...
    let failHandler = jasmine.createSpy('fail');
    topicsAndSkillsDashboardBackendApiService
      .mergeSkillsAsync('invalidId1', 'invalidId2')
      .then(successHandler, failHandler);
    ...
    req.flush(
      ...
      {
        status: 500,
        statusText: 'Skill Id does not exist',
      }
    );
    flushMicrotasks();
  ...
  it(
    'should get topic and skills dashboard event emitter when ' +
      're-initialized',
    () => {
  ...
  it(
    'should successfully fetch categorized and untriaged skills ' +
      'data from the backend',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
  ...
  it(
    'should fail to fetch categorized and untriaged skills data ' +
      'from the backend',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
