...
/**
 * @fileoverview Unit tests for the WrittenTranslation model.
 */

import {
  WrittenTranslation,
  WRITTEN_TRANSLATION_TYPE_HTML
} from 'domain/exploration/WrittenTranslation.model';

describe('WrittenTranslation model', () => {
  ...
  it('should create a new written translation translation', () => {
    expect(WrittenTranslation.createNew(
      WRITTEN_TRANSLATION_TYPE_HTML, 'New')).toEqual(
      WrittenTranslation.createFromBackendDict({
        data_format: 'html',
        translation: 'New',
        needs_update: false
