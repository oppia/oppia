...
import { TranslationBackendDict, WrittenTranslation, WrittenTranslationDataFormat } from 'domain/exploration/WrittenTranslation.model';
...
export class WrittenTranslations {
  ...
  addWrittenTranslation(
    ...
    writtenTranslations[languageCode] = WrittenTranslation.createNew(
