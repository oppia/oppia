...
/**
 * @fileoverview Unit tests for Interaction model.
 */
...
describe('Interaction model', () => {
  ...
  it('should correctly set the new answer group', () => {
    ...
    var newAnswerGroup = AnswerGroup.createFromBackendDict(
      newAnswerGroupDict);
  ...
  it('should correctly copy from other interaction', () => {
    ...
    const otherInteraction = Interaction.createFromBackendDict(
      otherInteractionDict);
    ...
    expect(testInteraction).toEqual(Interaction.createFromBackendDict({
      answer_groups: newAnswerGroups,
      confirmed_unclassified_answers: [],
      customization_args: {
        showChoicesInShuffledOrder: {
