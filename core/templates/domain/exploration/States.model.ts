...
export class States {
  ...
  addState(newStateName: string): void {
    this._states[newStateName] = State.createDefaultState(newStateName);
  }
  setState(stateName: string, stateData: State): void {
    // We use the copy method defined in the State.model to make
  ...
  static createFromBackendDict(
      statesBackendDict: StateObjectsBackendDict): States {
