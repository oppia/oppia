...
/**
 * @fileoverview Model for creating new frontend instances of Exploration
 * domain objects.
 */
...
import { ParamSpecsBackendDict, ParamSpecs } from 'domain/exploration/ParamSpecs.model';
import { EndExplorationCustomizationArgs, InteractionCustomizationArgs } from 'interactions/customization-args-defs';
import { Interaction } from 'domain/exploration/Interaction.model';
import { BindableVoiceovers } from 'domain/exploration/RecordedVoiceovers.model';
import { State } from 'domain/state/State.model';
import { StateObjectsBackendDict, States, VoiceoverObjectsDict } from 'domain/exploration/States.model';
...
export class Exploration {
  ...
  static createFromBackendDict(
    ...
    return new Exploration(
      ...
      OppiaAngularRootComponent.loggerService,
