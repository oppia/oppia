...
/**
 * @fileoverview Unit tests for WrittenTranslations model.
 */

import { WrittenTranslations } from 'domain/exploration/WrittenTranslations.model';
import { WrittenTranslation } from 'domain/exploration/WrittenTranslation.model';

describe('Written Translations model', () => {
