...
export class LearnerGroupBackendApiService {
  ...
  async createNewLearnerGroupAsync(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        .post<LearnerGroupBackendDict>(learnerGroupCreationUrl, postData)
        .toPromise()
        .then(response => {
  ...
  async updateLearnerGroupAsync(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        .put<LearnerGroupBackendDict>(learnerGroupUpdationUrl, putData)
        .toPromise()
        .then(
          response => {
            resolve(LearnerGroupData.createFromBackendDict(response));
  ...
  async deleteLearnerGroupAsync(learnerGroupId: string): Promise<boolean> {
    return new Promise((resolve, reject) => {
      ...
      this.http
        .delete<DeleteLearnerGroupBackendResponse>(learnerGroupDeletionUrl)
        .toPromise()
        .then(
          response => {
  ...
  async _fetchLearnerGroupInfoAsync(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        .get<LearnerGroupBackendDict>(learnerGroupUrl)
        .toPromise()
        .then(
          learnerGroupInfo => {
  ...
  async searchNewLearnerToAddAsync(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        .get<LearnerGroupUserInfoBackendDict>(learnerGroupUrl, {
          params: filterData,
        })
        .toPromise()
        .then(response => {
  ...
  async fetchLearnersInfoAsync(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        .get<LearnerGroupAllLearnersInfoBackendDict>(learnerGroupUrl)
        .toPromise()
        .then(response => {
  ...
  async updateLearnerGroupInviteAsync(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        .put<LearnerGroupBackendDict>(learnerGroupUrl, putData)
        .toPromise()
        .then(response => {
          resolve(LearnerGroupData.createFromBackendDict(response));
        });
  ...
  async fetchProgressSharingPermissionOfLearnerAsync(
    learnerGroupId: string
  ): Promise<boolean> {
    return new Promise((resolve, reject) => {
      const permissionStatusUrl = this.urlInterpolationService.interpolateUrl(
      ...
      this.http
        .get<LearnerGroupProgressSharingPermissionBackendDict>(
          permissionStatusUrl
        )
        .toPromise()
        .then(response => {
  ...
  async updateProgressSharingPermissionAsync(
    ...
    return new Promise((resolve, reject) => {
      ...
      this.http
        .put<LearnerGroupProgressSharingPermissionBackendDict>(
          permissionStatusUrl,
          putData
        )
        .toPromise()
