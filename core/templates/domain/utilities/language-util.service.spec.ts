...
describe('Language util service', function() {
  ...
  beforeEach(() => {
    ...
    lus.SUPPORTED_CONTENT_LANGUAGES = mockSupportedContentLanguages;
    lus.AUTOGENERATED_AUDIO_LANGUAGES = mockAutogeneratedAudioLanguages;
    lus.SUPPORTED_AUDIO_LANGUAGES = mockSupportedAudioLanguages;
  });
