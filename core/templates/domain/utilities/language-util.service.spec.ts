...
describe('Language util service', function() {
  ...
  beforeEach(() => {
    ...
    spyOnProperty(lus, 'LANGUAGE_DIRECTIONS', 'get')
      .and.returnValue(mockLanguageDirections);
  });
...
describe('Language Constants', () => {
  describe('SUPPORTED_CONTENT_LANGUAGES', () => {
    it('should have a direction entry in LANGUAGE_DIRECTIONS for each ' +
      'language code', () => {
      CONSTANTS.SUPPORTED_CONTENT_LANGUAGES.forEach((contentLanguage) => {
        expect(CONSTANTS.LANGUAGE_DIRECTIONS[contentLanguage.code])
          .not.toBeUndefined();
      });
    });
  });

  describe('SUPPORTED_AUDIO_LANGUAGES', () => {
    it('should have a direction entry in LANGUAGE_DIRECTIONS for each ' +
      'language code', () => {
      CONSTANTS.SUPPORTED_AUDIO_LANGUAGES.forEach((audioLanguage) => {
        expect(CONSTANTS.LANGUAGE_DIRECTIONS[audioLanguage.id])
          .not.toBeUndefined();
      });
    });
  });
