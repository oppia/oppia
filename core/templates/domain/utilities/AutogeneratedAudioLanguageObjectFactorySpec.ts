...
import {
  AutogeneratedAudioLanguage, AutogeneratedAudioLanguageObjectFactory } from
  // @ts-ignore
  'domain/utilities/AutogeneratedAudioLanguageObjectFactory';

describe('AutogeneratedAudioLanguage object factory', () => {
  let autogenAudioLanguage: AutogeneratedAudioLanguage;
  let aalof: AutogeneratedAudioLanguageObjectFactory;
  beforeEach(() => {
    aalof = new AutogeneratedAudioLanguageObjectFactory();
