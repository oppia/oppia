...
import {
  IAudioLanguageBackendDict,
  AudioLanguage,
  AudioLanguageObjectFactory
} from 'domain/utilities/AudioLanguageObjectFactory';
import {
  IAutogeneratedAudioLanguageDict,
...
interface ISupportedAudioLanguagesDict {
  [language: string]: AudioLanguage;
}

interface IAutogeneratedAudioLanguagesByType {
  [language: string]: AutogeneratedAudioLanguage;
}

interface ILanguageIdAndText {
  id: string;
  text: string;
}
...
export class LanguageUtilService {
  supportedAudioLanguageList: IAudioLanguageBackendDict[] = (
      CONSTANTS.SUPPORTED_AUDIO_LANGUAGES);
  autogeneratedAudioLanguageList: IAutogeneratedAudioLanguageDict[] = (
  ...
  getSupportedAudioLanguages(): ISupportedAudioLanguagesDict {
  ...
  getAutogeneratedAudioLanguages(
      type: string): IAutogeneratedAudioLanguagesByType {
  ...
  getLanguageIdsAndTexts(): ILanguageIdAndText[] {
    var languageIdsAndTexts = CONSTANTS.SUPPORTED_CONTENT_LANGUAGES.map(
      (languageItem: IContentLanguage) => {
        return {
