...
interface SupportedAudioLanguagesBackendDict {
  'id': string;
  'description': string;
...
interface SupportedContentLanguagesBackendDict {
  'code': string;
  'description': string;
}
...
export class LanguageUtilService {
  get SUPPORTED_AUDIO_LANGUAGES():
      readonly SupportedAudioLanguagesBackendDict[] {
  ...
  get SUPPORTED_CONTENT_LANGUAGES():
      readonly SupportedContentLanguagesBackendDict[] {
