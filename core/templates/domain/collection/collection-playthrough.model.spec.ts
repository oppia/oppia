...
fdescribe('Collection playthrough model', () => {

    fit('should create a new CollectionPlaythrough instance', () => {
        let collectionPlaythroughObject = new CollectionPlaythrough(
            'exp_id0', ['exp_id1']);
        expect(collectionPlaythroughObject.getNextExplorationId()).toEqual('exp_id0');
        expect(collectionPlaythroughObject.getCompletedExplorationIds()).toEqual(['exp_id1']);
    });

    fit('should create a new CollectionPlaythrough instance from create', () => {
    ...
    fit('should get the correct next exploration id', () => {
    ...
    fit('should get 1 for next recommended collection node count', () => {
        var collectionPlaythroughBackendDict = {
            next_exploration_id: 'exp_id0',
            completed_exploration_ids: ['exp_id1']
        };
    ...
    fit('should get the completed exploration ids', () => {
        var collectionPlaythroughBackendDict = {
            next_exploration_id: 'exp_id0',
            completed_exploration_ids: ['exp_id1']
        };
    ...
    fit('should get the completed exploration node count', () => {
        var collectionPlaythroughBackendDict = {
            next_exploration_id: 'exp_id0',
            completed_exploration_ids: ['exp_id1']
        };
    ...
    fit('should get whether the collection is started when no exploration is' +
        'completed',
        () => {
            var collectionPlaythroughBackendDict = {
                next_exploration_id: 'exp_id0',
    ...
    fit('should get whether the collection is started when any exploration is' +
        'completed',
        () => {
            var collectionPlaythroughBackendDict = {
                next_exploration_id: 'exp_id0',
    ...
    fit('should get whether the collection is finished when a next' + 
