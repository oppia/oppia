...
describe('Collection update service', () => {
  ...
  it(
    'should swap nodes of a collection given indices and return to ' +
  ...
  it(
    'should return true when collection node is being added ' +
  ...
  it(
    'should return exploration id from change object when calling ' +
