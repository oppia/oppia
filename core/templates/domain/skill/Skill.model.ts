...
/**
 * @fileoverview Model for creating frontend skills.
 */
...
import { Misconception, MisconceptionBackendDict } from 'domain/skill/Misconception.model';
...
export class Skill {
  ...
  static createInterstitialSkill(): Skill {
    return new Skill(
  ...
  static hasValidDescription(description: string): boolean {
    ...
    return OppiaAngularRootComponent.validatorsService.isValidEntityName(
