...
export class EmailDashboardBackendApiService {
  ...
  async fetchQueriesPageAsync(
    ...
    return new Promise((resolve, reject) => {
      this.http
        .get<EmailDashboardQueryResultsBackendDict>(this.QUERY_DATA_URL, {
          params: params,
        } as Object)
        .toPromise()
        .then(
  ...
  async fetchQueryAsync(queryId: string): Promise<EmailDashboardQuery> {
    return new Promise((resolve, reject) => {
      this.http
        .get<EmailDashboardQueryBackendDict>(this.QUERY_STATUS_CHECK_URL, {
          params: {
            query_id: queryId,
          },
        })
  ...
  async submitQueryAsync(data: QueryData): Promise<EmailDashboardQuery> {
    return new Promise((resolve, reject) => {
      this.http
        .post<EmailDashboardQueryBackendDict>(this.QUERY_DATA_URL, {
          data: data,
        })
        .toPromise()
        .then(
