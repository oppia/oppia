  ...
  it('should load public exploration summaries from backend',
    function() {
      ...
      var sampleResults = [ new ExplorationSummary(
        'Category 1', undefined, undefined, undefined, undefined, undefined, undefined, 'public',
        undefined, undefined, 'Title 1', undefined, undefined)
      ];
    ...
    function() {
      ...
      var sampleResults = [
        new ExplorationSummary(
          ...
          undefined, undefined, 'Title 1', undefined, undefined),
        new ExplorationSummary(
          'Category 2', undefined, undefined, undefined, undefined, undefined, undefined, 'private',
          undefined, undefined, 'Title 2', undefined, undefined)
      ];
