...
import { StoryReferenceBackendDict, StoryReference } from 'domain/topic/StoryReference.model';
import { SkillIdToDescriptionMap, Subtopic, SubtopicBackendDict } from 'domain/topic/Subtopic.model';
...
export class Topic {
  ...
  addCanonicalStory(storyId: string): void {
    ...
    this._canonicalStoryReferences.push(StoryReference.createFromStoryId(
      storyId));
  }
  ...
  addAdditionalStory(storyId: string): void {
    ...
    this._additionalStoryReferences.push(StoryReference.createFromStoryId(
      storyId));
  }
  ...
  static createInterstitialTopic(): Topic {
    return new Topic(
