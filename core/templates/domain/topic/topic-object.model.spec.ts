...
describe('Topic object factory', () => {
  ...
  beforeEach(() => {
    ...
    skillSummary1 = ShortSkillSummary.create('skill_1', 'Description 1');
    skillSummary2 = ShortSkillSummary.create('skill_2', 'Description 2');
    skillSummary3 = ShortSkillSummary.create('skill_3', 'Description 3');
  ...
  it(
    'should warn user when url entered by the user execceds specified' +
      ' limit',
    () => {
  ...
  it(
    'should warn user when more than 3 skills were added for the ' +
      'diagnostic test',
    () => {
  ...
  it('should correctly remove the various array elements', () => {
    ...
    expect(_sampleTopic.getUncategorizedSkillSummaries()[0].getId()).toEqual(
      'skill_2'
    );
    expect(
  ...
  it('should warn user when subtopic has no thumbnail', () => {
    ...
    expect(issue).toEqual([
      'Subtopic with title Title ' + 'does not have any skill IDs linked.',
    ]);
  });
  ...
  it(
    'should warn user when page title length is less than the' +
      ' allowed limit',
    () => {
  ...
  it(
    'should warn user when page title length is more than the' +
      ' allowed limit',
    () => {
  ...
  it(
    'should warn user when meta tag content length is more than the' +
      ' allowed limit',
    () => {
      ...
      expect(issue).toEqual([
        'Topic meta tag content should not be longer than ' + '160 characters.',
      ]);
    }
  );
  ...
  it('should return skill Ids when called', () => {
    expect(_sampleTopic.getSkillIds()).toEqual([
      'skill_1',
      'skill_2',
      'skill_3',
    ]);
  ...
  it('should add subtopic when user creates a new subtopic', () => {
    ...
    expect(_sampleTopic.getSubtopics()).toEqual([
      ...
      Subtopic.createFromTitle(1, 'new subtopic'),
    ]);
  });

  it(
    'should throw error when user deletes a subtopic that does' + ' not exist',
    () => {
      expect(_sampleTopic.getSubtopics()).toEqual([
        Subtopic.create(
          {
  ...
  it('should delete subtopic when user deletes a subtopic', () => {
    ...
    expect(_sampleTopic.getSubtopics()).toEqual([
      ...
      Subtopic.createFromTitle(2, 'new subtopic'),
    ]);
  ...
  it(
    'should throw error when user deletes a Canonical story that' +
      ' does not exist',
    () => {
      expect(() => {
  ...
  it(
    'should throw error when user deletes a Additional story that' +
      ' does not exist',
    () => {
      expect(() => {
  ...
  it(
    'should throw error when user deletes Uncategorized skill that' +
      ' does not exist',
    () => {
      expect(() => {
