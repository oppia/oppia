...
describe('Topic update service', function() {
  ...
  var sampleTopicBackendObject = {
    topicDict: {
      ...
      subtopics: [{
        ...
        thumbnail_filename: 'subtopic.svg',
  ...
  it('should rearrange a subtopic', function() {
    var subtopicsDict = [{
      ...
      skill_ids: [],
      thumbnail_bg_color: 'blue',
      thumbnail_filename: 'subtopic2.svg',
      ...
      skill_ids: [],
      thumbnail_bg_color: 'blue',
      thumbnail_filename: 'subtopic3.svg',
      url_fragment: 'subtopic3'
    }];
  ...
  it('should set/unset changes to a subtopic page\'s page content', function() {
    ...
    var newSampleSubtitledHtml =
      SubtitledHtml.createFromBackendDict(newSampleSubtitledHtmlDict);
