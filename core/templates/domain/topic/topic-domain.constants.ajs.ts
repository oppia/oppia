...
angular
  .module('oppia')
  .constant('CMD_ADD_SUBTOPIC', TopicDomainConstants.CMD_ADD_SUBTOPIC);
angular
  .module('oppia')
  .constant(
...
angular
  .module('oppia')
  .constant('CMD_DELETE_SUBTOPIC', TopicDomainConstants.CMD_DELETE_SUBTOPIC);
angular
  .module('oppia')
  .constant(
...
angular
  .module('oppia')
  .constant('TOPIC_PROPERTY_NAME', TopicDomainConstants.TOPIC_PROPERTY_NAME);
