...
describe('Question backend Api service', () => {
  ...
  it(
    'should successfully fetch questions from the backend when' +
      'sortedByDifficulty is false',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
  ...
  it('should successfully fetch question count from the backend', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    ...
    questionBackendApiService
      .fetchTotalQuestionCountForSkillIdsAsync(['1'])
      .then(successHandler, failHandler);
  ...
  it('should use the fail handler if fetch question count fails', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
  ...
  it('should use the fail handler if question count is in invalid format', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    questionBackendApiService
      .fetchQuestionsAsync(
  ...
  it('should use the fail handler if question count is negative', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    questionBackendApiService
      .fetchQuestionsAsync(['1'], -1, true)
  ...
  it('should use the fail handler if question count is not an integer', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    questionBackendApiService
      .fetchQuestionsAsync(['1'], 1.5, true)
      .then(successHandler, failHandler);
    flushMicrotasks();
    expect(successHandler).not.toHaveBeenCalled();
    expect(failHandler).toHaveBeenCalledWith(
  ...
  it('should use the fail handler if skill ids is not a list', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    questionBackendApiService
      .fetchQuestionsAsync(
  ...
  it('should use the fail handler if skill ids is not a list of strings', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    questionBackendApiService
      .fetchQuestionsAsync(
  ...
  it('should use the fail handler if skill ids is sent as null', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    questionBackendApiService
      .fetchQuestionsAsync(
  ...
  it('should use the fail handler if question count is sent as null', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');
    questionBackendApiService
      .fetchQuestionsAsync(['1'], 0, true)
      .then(successHandler, failHandler);
    flushMicrotasks();
    expect(successHandler).not.toHaveBeenCalled();
    expect(failHandler).toHaveBeenCalledWith(
  ...
  it('should successfully fetch questions for editors from the backend', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');

    questionBackendApiService
      .fetchQuestionSummariesAsync('1')
      .then(successHandler, failHandler);
  ...
  it('should successfully fetch questions from the backend with cursor', fakeAsync(() => {
    let successHandler = jasmine.createSpy('success');
    let failHandler = jasmine.createSpy('fail');

    questionBackendApiService
      .fetchQuestionSummariesAsync('1', 1)
      .then(successHandler, failHandler);
    let req = httpTestingController.expectOne(
  ...
  it(
    'should successfully fetch diagnostic test skill id to questions dict' +
      ' from the backend',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
  ...
  it(
    'should fail to fetch diagnostic test skill id to questions dict from ' +
      'the backend',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
