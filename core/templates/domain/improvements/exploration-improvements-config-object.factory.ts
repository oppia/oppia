...
export class ExplorationImprovementsConfig {
  constructor(
    ...
    if (highBounceRateTaskStateBounceRateCreationThreshold < 0 ||
    ...
    if (highBounceRateTaskStateBounceRateObsoletionThreshold < 0 ||
    ...
    if (highBounceRateTaskStateBounceRateCreationThreshold <
        highBounceRateTaskStateBounceRateObsoletionThreshold) {
      throw new Error(
        ...
        'but got: ' + highBounceRateTaskStateBounceRateCreationThreshold +
        ' < ' + highBounceRateTaskStateBounceRateObsoletionThreshold);
    }
  }
}
