...
import { InteractionBackendDict, Interaction } from 'domain/exploration/Interaction.model';
...
import { RecordedVoiceOverBackendDict, RecordedVoiceovers } from 'domain/exploration/RecordedVoiceovers.model';
import { SubtitledHtmlBackendDict, SubtitledHtml } from 'domain/exploration/SubtitledHtml.model';
import { WrittenTranslationsBackendDict, WrittenTranslations } from 'domain/exploration/WrittenTranslations.model';
...
export class State {
  ...
  static createDefaultState(newStateName: string): State {
  ...
  static createFromBackendDict(
    ...
    return new State(
      ...
      WrittenTranslations.createFromBackendDict(stateDict.written_translations),
