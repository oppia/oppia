    ...
    it(
        ...
        fakeAsync(() => {
            ...
            expect(component.UPDATABLE_ROLES).toEqual(
                adminPageData.updatableRoles
            );
            expect(component.roleToActions).toEqual(
                adminPageData.roleToActions
            );
            expect(component.VIEWABLE_ROLES).toEqual(
                adminPageData.viewableRoles
            );
            expect(component.topicSummaries).toEqual(
                adminPageData.topicSummaries
            );
        })
    );
