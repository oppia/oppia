...
/**
 * @fileoverview Unit tests for Custom undo snackbar for Contributor Dashboard.
 */
...
describe('CustomSnackbarComponent', () => {
  ...
  beforeEach(async() => {
    mockSnackBarRef = jasmine.createSpyObj(
      'MatSnackBarRef', ['dismiss', 'dismissWithAction']);
