...
describe('Translation Modal Component', () => {
  ...
  describe('requestAutoTranslation', () => {
    ...
    it(
      'should populate the editor with the translated text on success',
      fakeAsync(() => {
    ...
    it(
      'should preserve math component tags returned by the backend',
      fakeAsync(() => {
        const mathSource =
    ...
    it(
      'should preserve hyperlink URL attributes returned by the backend',
      fakeAsync(() => {
        const linkSource =
    ...
    it(
      'should not fire a second request while one is in flight',
      fakeAsync(() => {
        component.requestAutoTranslation();
    ...
    it(
      'should set wasEdited to true when user edits the AI-generated text',
      fakeAsync(() => {
    ...
    it(
      'should reset wasAutoGenerated and wasEdited after clearTranslation',
      fakeAsync(() => {
        ...
        (component as unknown as {clearTranslation: () => void}).clearTranslation();
    ...
    it(
      'should pass wasAutoGenerated and provider to suggestTranslatedText on submit',
      fakeAsync(() => {
