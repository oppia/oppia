...
export class ContributionAndReviewStatsService {
  constructor(
    private contributionAndReviewStatsBackendApiService: ContributionAndReviewStatsBackendApiService
  ) {}

  async fetchAllStats(
    username: string
  ): Promise<ContributorStatsSummaryBackendDict> {
    return this.contributionAndReviewStatsBackendApiService.fetchAllContributionAndReviewStatsAsync(
      username
    );
  }
  ...
  async fetchTranslationContributionStats(
    ...
    return this.contributionAndReviewStatsBackendApiService.fetchContributionAndReviewStatsAsync(
