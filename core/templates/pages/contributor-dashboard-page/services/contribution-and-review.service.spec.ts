...
describe('Contribution and review service', () => {
    ...
    const expectedSuggestion2Dict = {
        ...
        details:
            multiplePageBackendFetchResponse.target_id_to_opportunity_dict
                .skill_id_2,
    };
    ...
    describe('getUserCreatedQuestionSuggestionsAsync', () => {
        const defaultOpportunitiesPageSize =
        ...
        it('should return available question suggestions and opportunity details', () => {
            ...
            cars.getUserCreatedQuestionSuggestionsAsync(true, 'sort_key').then(
                response => {
                    expect(
                        response.suggestionIdToDetails.suggestion_id_1
        ...
        it('should fetch one page ahead and cache extra results', fakeAsync(() => {
            ...
            cars.getUserCreatedQuestionSuggestionsAsync(true, 'sort_key').then(
                response => {
                    ...
                    expect(
                        response.suggestionIdToDetails.suggestion_id_2
                    ).toEqual(expectedSuggestion2Dict);
                    expect(
                        Object.keys(response.suggestionIdToDetails).length
                    ).toEqual(2);
            ...
            const expectedSuggestion4Dict = {
                ...
                details:
                    suggestion4BackendFetchResponse
            ...
            // caller.
            cars.getUserCreatedQuestionSuggestionsAsync(false, 'sort_key').then(
                response => {
                    expect(
                        response.suggestionIdToDetails.suggestion_id_3
                    ).toEqual(expectedSuggestion3Dict);
                    expect(
                        response.suggestionIdToDetails.suggestion_id_4
        ...
        it(
            ...
            async () => {
                ...
                cars.getReviewableTranslationSuggestionsAsync(
                    ...
                    expect(
                        fetchTranslationSuggestionsAsyncSpy
                    ).toHaveBeenCalled();
                });
            }
        );
        ...
        it(
            ...
            async () => {
                ...
                const exploration: Exploration = new Exploration(
                    ...
                    mockReadOnlyExplorationData.exploration
                        .states as unknown as States,
                ...
                explorationCreateFromBackendDictSpy.and.returnValue(
                    exploration
                );
                ...
                await cars
                    .fetchTranslationSuggestionsAsync('1')
                    .then(response => {
                        ...
                        expect(
                            explorationCreateFromBackendDictSpy
                        ).toHaveBeenCalled();
    ...
    describe('reviewExplorationSuggestion', () => {
        ...
        it(
            ...
            fakeAsync(() => {
                ...
                expect(
                    carbas.reviewExplorationSuggestionAsync
    ...
    describe('updateTranslationSuggestionAsync', () => {
        ...
        it(
            ...
            fakeAsync(() => {
                ...
                expect(
                    carbas.updateTranslationSuggestionAsync
    ...
    describe('updateQuestionSuggestionAsync', () => {
        ...
        it(
            ...
            fakeAsync(() => {
                ...
                expect(
                    carbas.updateQuestionSuggestionAsync
                ).toHaveBeenCalledWith('pqr', requestBody);
                expect(onSuccess).toHaveBeenCalledWith('pqr');
                expect(onFailure).not.toHaveBeenCalled();
            })
