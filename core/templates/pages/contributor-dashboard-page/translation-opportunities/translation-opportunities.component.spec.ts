...
describe('Translation opportunities component', () => {
  ...
  it(
    'should not chagne contents of each opportunity when get presentable ' +
      'opportunities',
    () => {
      spyOn(
        translationLanguageService,
  ...
  it(
    'should not show translation opportunities when language is not ' +
      'selected',
    fakeAsync(() => {
      spyOn(
        translationLanguageService,
