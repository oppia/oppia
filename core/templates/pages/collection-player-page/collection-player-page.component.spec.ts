...
describe('Collection player page component', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CollectionPlayerPageComponent, MockTranslatePipe],
      providers: [
        PageTitleService,
        {
  ...
  it(
    'should throw warning message when an invalid collection ' +
  ...
  it('should set page title and subscribe to the lang change emitter', fakeAsync(() => {
  ...
  it('should stop event propagation when click event is emitted', () => {
    let eventSpy = jasmine.createSpyObj('event', ['stopPropagation']);
  ...
  it(
    'should return exploration title position given index ' +
  ...
  it(
    'should check whether the exploration is completed when ' +
  ...
  it(
    'should return false on checking whether exploration is completed ' +
  ...
  it(
    'should generate empty path parameters when collection ' +
      'node count is one',
    fakeAsync(() => {
  ...
  it(
    'should generate path parameters when collection ' + 'node count is two',
    fakeAsync(() => {
  ...
  it(
    'should generate path parameters when collection ' + 'node count is three',
    fakeAsync(() => {
      sampleCollectionBackendObject.nodes = [
        collectionNodeBackendObject,
        collectionNodeBackendObject,
  ...
  it(
    'should generate path parameters when collection ' + 'node count is four',
    fakeAsync(() => {
      sampleCollectionBackendObject.nodes = [
        collectionNodeBackendObject,
        collectionNodeBackendObject,
  ...
  it(
    'should update exploration preview card when calling ' +
    ...
    () => {
      ...
      expect(component.explorationCardIsShown).toBe(true);
      expect(component.isCompletedExploration('2')).toBe(false);
    }
  );

  it(
    'should show warning message if we try to ' +
  ...
  it('should return completed collection node', fakeAsync(() => {
    component.collection = sampleCollection;
    component.collectionPlaythrough = CollectionPlaythrough.create('exp_id0', [
      'exp_id',
    ]);
  ...
  it(
    'should return non recommended collection node ' + 'count',
    fakeAsync(() => {
      spyOn(
        readOnlyCollectionBackendApiService,
        'loadCollectionAsync'
