...
export class CollectionPlayerPageComponent implements OnInit, OnDestroy {
  ...
  allowlistedCollectionIdsForGuestProgress;
  collectionSummary;
  ...
  ngOnInit(): void {
    ...
    this.allowlistedCollectionIdsForGuestProgress = (
      AppConstants.ALLOWLISTED_COLLECTION_IDS_FOR_SAVING_GUEST_PROGRESS);
