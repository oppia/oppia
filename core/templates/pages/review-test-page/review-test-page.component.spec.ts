...
describe('Review test page component', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ReviewTestPageComponent],
      providers: [
        TranslateService,
  ...
  beforeEach(() => {
    ...
    spyOn(
      ...
      'fetchReviewTestDataAsync'
    ).and.returnValue(
      Promise.resolve(new ReviewTest('', {skill_1: 'skill_1'}))
    );
  ...
  it(
    'should initialize correctly controller properties after its' +
      ' initialization and get skill details from backend',
    fakeAsync(() => {
