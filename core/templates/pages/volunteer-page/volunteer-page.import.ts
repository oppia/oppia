...
/**
 * @fileoverview Scripts for the volunteer page.
 */
...
import { VolunteerPageModule } from './volunteer-page.module';
...
platformBrowserDynamic().bootstrapModule(VolunteerPageModule).catch(
