...
/**
 * @fileoverview Classroom-Admin-page-root component component.
 */
...
export class ClassroomAdminPageRootComponent extends BaseRootComponent {
  constructor(
    ...
    super(
      pageHeadService,
      translateService,
      AppConstants.PAGES_REGISTERED_WITH_FRONTEND.CLASSROOM_ADMIN.TITLE,
      AppConstants.PAGES_REGISTERED_WITH_FRONTEND.CLASSROOM_ADMIN.META
    );
  }
}
