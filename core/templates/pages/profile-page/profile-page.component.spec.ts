...
describe('Profile page', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [MockTranslatePipe, ProfilePageComponent, TruncatePipe],
      providers: [
        {
  ...
  beforeEach(() => {
    ...
    csrfTokenService = TestBed.inject(
      CsrfTokenService
    ) as jasmine.SpyObj<CsrfTokenService>;
    ...
    ) as jasmine.SpyObj<ProfilePageBackendApiService>;
  ...
  it('should get formatted date string from the timestamp in milliseconds', () => {
    ...
    spyOn(dateTimeFormatService, 'getLocaleDateString')
      .withArgs(NOW_MILLIS)
      .and.returnValue('11/21/2014');
    expect(componentInstance.getLocaleDateString(NOW_MILLIS)).toBe(
      '11/21/2014'
    );
  });

  it('should not change subscription status and change to login page', fakeAsync(() => {
  ...
  it(
    'should not change subscription status and reload the page when login' +
  ...
  it('should update subscription button text to warn user to log in', fakeAsync(() => {
    componentInstance.ngOnInit();
    tick();
    componentInstance.updateSubscriptionButtonPopoverText();
  ...
  it('should get explorations to display when edited explorations are empty', fakeAsync(() => {
    let profileDataLocal = UserProfile.createFromBackendDict({
      username: '',
      username_of_viewed_profile: 'username1',
      user_bio: 'User bio',
  ...
  it('should get explorations to display', fakeAsync(() => {
    let profileDataLocal = UserProfile.createFromBackendDict({
      username: '',
      username_of_viewed_profile: 'username1',
      user_bio: 'User bio',
