...
const { EmailDashboardPageModule } = require(
  'pages/email-dashboard-pages/email-dashboard-page.module.ts');
require('App.ts');
...
platformBrowserDynamic().bootstrapModule(EmailDashboardPageModule);
