...
/**
 * @fileoverview Directive scripts for the thanks page.
 */
...
import { ThanksPageModule } from './thanks-page.module';
...
platformBrowserDynamic().bootstrapModule(ThanksPageModule).catch(
