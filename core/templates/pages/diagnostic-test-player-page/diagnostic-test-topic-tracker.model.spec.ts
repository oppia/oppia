...
describe('Diagnostic test topic tracker model', () => {
  ...
  it('should be able to get topic ID to ancestor topic IDs', () => {
    ...
    expect(diagnosticTestTopicTrackerModel.getAncestorTopicIds('topicID1'))
      .toEqual([]);

    expect(diagnosticTestTopicTrackerModel.getAncestorTopicIds('topicID2'))
      .toEqual(['topicID1']);

    expect(diagnosticTestTopicTrackerModel.getAncestorTopicIds('topicID3'))
  ...
  it('should be able to able to get topic ID to successor topic IDs', () => {
    ...
    expect(diagnosticTestTopicTrackerModel.getTopicIdToSuccessorTopicIds())
      .toEqual(expectedTopicIdToSuccessorTopicIds);

    expect(diagnosticTestTopicTrackerModel.getSuccessorTopicIds('topicID1'))
      .toEqual(['topicID2', 'topicID3']);

    expect(diagnosticTestTopicTrackerModel.getSuccessorTopicIds('topicID2'))
      .toEqual([]);

    expect(diagnosticTestTopicTrackerModel.getSuccessorTopicIds('topicID3'))
      .toEqual([]);
  });
  ...
  it(
    ...
    'a dependency graph containing loops', () => {
      ...
      const
      diagnosticTestTopicTrackerModel = new DiagnosticTestTopicTrackerModel(
        topicIdToPrerequisiteTopicIds);
