...
/**
 * @fileoverview Unit tests for the contact page root component.
 */
...
describe('Contact Page Root', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ContactPageRootComponent, MockTranslatePipe],
      providers: [
        PageHeadService,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ContactPageRootComponent);
