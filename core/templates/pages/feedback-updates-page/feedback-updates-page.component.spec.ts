...
describe('Feedback updates page', () => {
  ...
  describe('when succesfully fetching feedback updates data', () => {
    ...
    it(
      'should change feedback sorting options by last update msecs when' +
        ' changing sorting type',
      () => {
        expect(component.isCurrentFeedbackSortDescending).toBe(true);
        expect(component.currentFeedbackThreadsSortType).toBe(
          'lastUpdatedMsecs'
        );
    ...
    it(
      'should change feedback sorting options by exploration when changing' +
        ' sorting type',
      () => {
    ...
    it(
      'should sort feedback updates given sorting property as last updated' +
        ' in ascending order',
      fakeAsync(() => {
        ...
        expect(component.getValueOfFeedbackThreadSortKey()).toBe(
          'lastUpdatedMsecs'
        );
    ...
    it(
      'should sort feedback updates given sorting property as exploration' +
        ' in ascending order',
      fakeAsync(() => {
        // The default sort option for Feedback Updates is last updated.
        expect(component.currentFeedbackThreadsSortType).toBe(
    ...
    it(
      'should get messages in the thread from the backend when a thread is' +
        ' selected',
      fakeAsync(() => {
    ...
    it(
      'should set a new section as active when fetching message summary' +
        ' list from backend',
      fakeAsync(() => {
        let threadStatus = 'open';
        let explorationId = 'exp1';
    ...
    it('should show all threads when a thread is not selected', fakeAsync(() => {
      let threadStatus = 'open';
      let explorationId = 'exp1';
      let threadId = 'thread_1';
      let explorationTitle = 'Exploration Title';
  ...
  describe('when fetching dashboard data fails', () => {
    ...
    it('should show an alert warning when fails to get feedback updates data', fakeAsync(() => {
