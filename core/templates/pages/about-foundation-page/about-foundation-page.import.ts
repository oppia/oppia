...
/**
 * @fileoverview Scripts for the about foundation page.
 */
...
import { AboutFoundationPageModule } from './about-foundation-page.module';
...
platformBrowserDynamic().bootstrapModule(AboutFoundationPageModule).catch(
