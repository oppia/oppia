...
describe('Skill editor state service', () => {
  ...
  it('should return prerequisite skill IDs', fakeAsync(() => {
    ...
    spyOn(skill, 'getPrerequisiteSkillIds').and.returnValue(['prerequisite_id_1', 'prerequisite_id_2']);
    
    expect(skillEditorStateService.getPrerequisiteSkillIds()).toEqual(['prerequisite_id_1', 'prerequisite_id_2']);
