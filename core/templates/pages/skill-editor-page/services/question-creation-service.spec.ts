...
fdescribe('Question Creation Service', () => {
  let qcs = null;
  ...
  let linkedSkillsWithDifficulty = null;

  let skillObjectFactory: SkillObjectFactory;
  let skillSummaryDict = {
    id: 'skillId1',
  ...
  beforeEach(() => {
    ...
    qcs = TestBed.inject(QuestionCreationService);
  ...
  beforeEach(() => {
    ...
    let deferred = Promise.resolve([skillBackendDict]);
    ...
    let skillObject = skillObjectFactory.createFromBackendDict(
      skillBackendDict as unknown as SkillBackendDict);
  ...
  it('should create question', fakeAsync(() => {
    let skillDiff = SkillDifficulty.create(
