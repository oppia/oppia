...
@NgModule({
  ...
  declarations: [SubjectSelectorComponent, SubjectSelectorModalComponent],
  entryComponents: [SubjectSelectorComponent, SubjectSelectorModalComponent],
  exports: [SubjectSelectorComponent, SubjectSelectorModalComponent],
})
