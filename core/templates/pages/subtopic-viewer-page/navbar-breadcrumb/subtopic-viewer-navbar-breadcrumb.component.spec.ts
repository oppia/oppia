...
import {SubtopicViewerNavbarBreadcrumbComponent} from './subtopic-viewer-navbar-breadcrumb.component';
...
describe('Subtopic viewer navbar breadcrumb component', function () {
  ...
  it('should set subtopic title when component is initialized', waitForAsync(() => {
    component.ngOnInit();
  ...
  it('should get topic url after component is initialized', () => {
    component.ngOnInit();
    expect(component.getTopicUrl()).toBe('/learn/classroom_1/topic_1/studyguide');
  });
    ...
    waitForAsync(() => {
      ...
      fixture.whenStable().then(() => {
        ...
        expect(component.topicNameTranslationKey).toBe(
          'I18N_TOPIC_topic_1_TITLE'
        );
        expect(component.subtopicTitleTranslationKey).toBe(
          'I18N_SUBTOPIC_topic_1_subtopic_1_TITLE'
        );
