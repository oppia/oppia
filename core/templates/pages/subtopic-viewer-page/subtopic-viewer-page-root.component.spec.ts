...
/**
 * @fileoverview Unit tests for Subtopic Viewer Page Root component.
 */
...
describe('SubtopicViewerPageRootComponent', () => {
  let fixture: ComponentFixture<SubtopicViewerRootComponent>;
  let component: SubtopicViewerRootComponent;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [TranslateModule.forRoot(), HttpClientTestingModule],
      declarations: [SubtopicViewerRootComponent],
      providers: [PageHeadService],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],
    }).compileComponents();

    fixture = TestBed.createComponent(SubtopicViewerRootComponent);
