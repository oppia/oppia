...
describe('AdminPageRootComponent', () => {
  let fixture: ComponentFixture<SubtopicViewerPageRootComponent>;
  let component: SubtopicViewerPageRootComponent;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [TranslateModule.forRoot(), HttpClientTestingModule],
      declarations: [SubtopicViewerPageRootComponent],
      providers: [PageHeadService],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],
    }).compileComponents();

    fixture = TestBed.createComponent(SubtopicViewerPageRootComponent);
