...
/**
 * @fileoverview Unit tests for the playbook page root component.
 */
...
describe('Playbook Page Root', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [PlaybookPageRootComponent, MockTranslatePipe],
      providers: [
        PageHeadService,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PlaybookPageRootComponent);
