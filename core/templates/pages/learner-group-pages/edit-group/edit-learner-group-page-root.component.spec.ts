...
describe('EditLearnerGroupPageRootComponent', () => {
  ...
  let component: EditLearnerGroupPageRootComponent;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [TranslateModule.forRoot(), HttpClientTestingModule],
      declarations: [EditLearnerGroupPageRootComponent],
      providers: [PageHeadService],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],
    }).compileComponents();

    fixture = TestBed.createComponent(EditLearnerGroupPageRootComponent);
