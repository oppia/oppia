...
/**
 * @fileoverview Edit-Learner-Group-page-root component component.
 */
...
export class EditLearnerGroupPageRootComponent extends BaseRootComponent {
  constructor(
    ...
    super(
      pageHeadService,
      translateService,
      AppConstants.PAGES_REGISTERED_WITH_FRONTEND.EDIT_LEARNER_GROUP.TITLE,
      AppConstants.PAGES_REGISTERED_WITH_FRONTEND.EDIT_LEARNER_GROUP.META
    );
  }
}
