...
//     component.updateNewlyAddedStorySummaries(
//       [sampleStorySummary]);
...
//   it('should close save new syllabus items modal successfully',
//     fakeAsync(() => {
//       spyOn(ngbModal, 'open').and.returnValue({
//         componentInstance: {
//           itemsAddedCount: 2
...
//   it('should remove subtopic page id from syllabus successfully',
//     fakeAsync(() => {
//       const demoLearnerGroupBackendDict = {
//         id: 'groupId',
//         title: 'title',
...
//   it('should close remove story from syllabus modal successfully',
//     fakeAsync(() => {
//       spyOn(ngbModal, 'open').and.returnValue({
//         componentInstance: {
//           confirmationTitle: 'title',
...
//   it('should close remove subtopic from syllabus modal successfully',
//     fakeAsync(() => {
//       spyOn(ngbModal, 'open').and.returnValue({
//         componentInstance: {
//           confirmationTitle: 'title',
