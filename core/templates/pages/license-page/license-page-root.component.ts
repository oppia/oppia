...
/**
 * @fileoverview Root component for License Page.
 */
...
@Component({
  selector: 'oppia-license-page-root',
  templateUrl: './license-page-root.component.html'
})
export class LicensePageRootComponent {
  constructor(
  ...
  ngOnInit(): void {
    let pageData = AppConstants.PAGES_REGISTERED_WITH_FRONTEND.LICENSE;
