...
describe('Topic Editor Navbar', () => {
  ...
  beforeEach(() => {
    ...
    let skillSummary = ShortSkillSummary.create('skill_1', 'Description 1');
    topic = new Topic(
      '',
      'Topic name loading',
      'Abbrev. name loading',
  ...
  it(
    "should navigate to main tab when user clicks the 'Editor' " + 'option',
    () => {
  ...
  it(
    "should navigate to Questions tab when user clicks the 'Questions' " +
      'option',
    () => {
  ...
  it("should open topic viewer when user clicks the 'preview' button", () => {
    ...
    expect(windowRef.nativeWindow.open).toHaveBeenCalledWith(
      '/learn/classroom_url/Url%20Fragment%20loading',
      'blank'
    );
  });

  it(
    'should alert user to save changes when user clicks the ' +
  ...
  it(
    "should open subtopic editor when user clicks the 'editor' " +
  ...
  it(
    "should open subtopic preview when user clicks the 'preview' " +
  ...
  it(
    "should discard changes when user clicks 'Discard Changes'" + ' button',
    () => {
  ...
  it(
    'should toggle navigation option when user clicks the drop down' +
  ...
  it(
    'should toggle topic edit option when user clicks the drop down' +
  ...
  it(
    'should toggle warnings when user clicks the warning symbol in' + ' mobile',
    () => {
