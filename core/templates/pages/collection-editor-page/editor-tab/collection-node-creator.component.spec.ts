...
describe('Collection node creator component', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [CollectionNodeCreatorComponent],
      providers: [
        AlertsService,
  ...
  it(
    'should should not add exploration to collection if exploration' +
      ' id is empty',
    () => {
  ...
  it(
    'should show warning if request to backend fails while adding ' +
      'exploration to collection',
    fakeAsync(() => {
      componentInstance.collection = mockCollection;
      let expId = 'new_id';
      spyOn(alertsService, 'addWarning');
  ...
  it('should show an alert if exploration doesnot exist in collection', fakeAsync(() => {
    componentInstance.collection = mockCollection;
    let expId = 'new_id';
    spyOn(alertsService, 'addWarning');
    spyOn(
  ...
  it('should create new exploration', fakeAsync(() => {
    ...
    expect(
      explorationCreationBackendApiService.registerNewExplorationAsync
    ).toHaveBeenCalled();
