...
/**
 * @fileoverview Unit tests for OppiaRootComponent.
 */
...
describe('OppiaRootComponent', () => {
  let fixture: ComponentFixture<OppiaRootComponent>;
  let component: OppiaRootComponent;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(OppiaRootComponent);
