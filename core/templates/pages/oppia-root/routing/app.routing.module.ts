...
const routes: Route[] = [
  ...
  {
    path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.DIAGNOSTIC_TEST_PLAYER.ROUTE,
    loadChildren: () => import('pages/diagnostic-test-player-page/diagnostic-test-player-page.module')
