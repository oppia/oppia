...
const routes: Route[] = [
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.COLLECTION_EDITOR
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.EXPLORATION_EDITOR
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.CREATOR_DASHBOARD
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.PRACTICE_SESSION
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.CURRICULUM_ADMIN
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.LEARNER_DASHBOARD
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.EXPLORATION_PLAYER
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.LESSON_PLAYER_EMBED
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.NEW_LESSON_PLAYER
            .ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.FEEDBACK_UPDATES
            .ROUTE,
        pathMatch: 'full',
        canActivate: [IsLoggedInGuard],
        loadChildren: () =>
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND
            .RELEASE_COORDINATOR_PAGE.ROUTE,
        loadChildren: () =>
            import(
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND
            .LIBRARY_RECENTLY_PUBLISHED.ROUTE,
        pathMatch: 'full',
        loadChildren: () =>
            import('pages/library-page/library-page.module').then(
                m => m.LibraryPageModule
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.LIBRARY_TOP_RATED
            .ROUTE,
        pathMatch: 'full',
        loadChildren: () =>
            import('pages/library-page/library-page.module').then(
    ...
    },
    {
        ...
        loadChildren: () =>
            import('pages/teach-page/teach-page.module').then(
                m => m.TeachPageModule
            ),
    },
    {
        ...
        loadChildren: () =>
            import('pages/terms-page/terms-page.module').then(
                m => m.TermsPageModule
            ),
    },
    {
    ...
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND
            .BLOG_AUTHOR_PROFILE_PAGE.ROUTE,
        pathMatch: 'full',
        loadChildren: () =>
            import(
    ...
    },
    {
        ...
        loadChildren: () =>
            import(
                'pages/voiceover-admin-page/voiceover-admin-page.module'
            ).then(m => m.VoiceoverAdminPageModule),
        canActivate: [IsLoggedInGuard],
    },
    {
        path: AppConstants.PAGES_REGISTERED_WITH_FRONTEND.COLLECTION_PLAYER
            .ROUTE,
        pathMatch: 'full',
        loadChildren: () =>
            import(
