...
/**
 * @fileoverview Unit tests for Player correctness feedback enabled service.
 */
...
describe('Player correctness feedback enabled service', () => {
  let pcfes: PlayerCorrectnessFeedbackEnabledService;
  beforeEach(() => {
    pcfes = TestBed.inject(PlayerCorrectnessFeedbackEnabledService);
  });
