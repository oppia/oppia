...
describe('Audio translation manager service', () => {
  ...
  it('should properly set primary and secondary audio translations',
    ...
    () => {
      atms.setContentAudioTranslations(testAudioTranslations, 'contentHtmlForAutogeneratedAudio', '');
      expect(atms.getCurrentHtmlForAutogeneratedAudio()).toEqual(
        'contentHtmlForAutogeneratedAudio'
      );
      atms.setSecondaryAudioTranslations(testAudioTranslations2, 'secondaryHtmlForAutogeneratedAudio', '');
      expect(atms.getCurrentHtmlForAutogeneratedAudio()).toEqual(
    ...
    () => {
      atms.setContentAudioTranslations(testAudioTranslations, '', 'contentComponentName');
      expect(atms.getCurrentComponentName()).toEqual(
        'contentComponentName'
      );
      atms.setSecondaryAudioTranslations(testAudioTranslations2, '', 'secondaryComponentName');
      expect(atms.getCurrentComponentName()).toEqual(
