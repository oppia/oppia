...
export class AudioTranslationLanguageService {
  ...
  _init(
    ...
    this._allAudioLanguageCodesInExploration.forEach((languageCode: string) => {
      let languageDescription = this.languageUtilService
  ...
  getCurrentAudioLanguageDescription(): string | null {
    return this._currentAudioLanguageCode ? this.languageUtilService
      .getAudioLanguageDescription(this._currentAudioLanguageCode) : null;
  }
  ...
  isAutogeneratedLanguageCodeSelected(): boolean {
    return this._currentAudioLanguageCode ? this.languageUtilService
      .isAutogeneratedAudioLanguage(this._currentAudioLanguageCode) : false;
  }
