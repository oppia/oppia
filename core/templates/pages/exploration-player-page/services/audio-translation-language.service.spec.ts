...
describe('Audio translation language service', () => {
  ...
  it(
    'should properly initialize the current audio language when ' +
  ...
  it(
    'should initialize the current audio language when ' +
  ...
  it(
    'should initialize the current audio language to the most ' +
  ...
  it(
    'should not have any audio language option when no audio is available ' +
  ...
  it(
    'should initialize the current audio language when audio is available ' +
  ...
  it(
    'should correctly identify if autogenerated language code ' + 'is selected',
    () => {
      allAudioLanguageCodesInExploration = [];
      const explorationLanguageCode = 'en';
      const preferredLanguageCode = null;
  ...
  it(
    'should initialize the current audio language when exploration has ' +
