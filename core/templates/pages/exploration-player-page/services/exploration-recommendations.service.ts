...
export class ExplorationRecommendationsService {
  ...
  getRecommendedSummaryDicts(
    ...
    var recommendationsUrlParams: RecommendationsUrlParams = {
      stringified_author_recommended_ids: JSON.stringify(
        authorRecommendedExpIds),
      include_system_recommendations: 'false'
    };

    var collectionId = this.urlService.getCollectionIdFromExplorationUrl();
    var storyId = this.urlService.getUrlParams().story_id;
    var currentNodeId = this.urlService.getUrlParams().node_id;
