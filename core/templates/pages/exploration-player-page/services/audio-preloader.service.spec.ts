...
import { ExplorationBackendDict, Exploration } from 'domain/exploration/Exploration.model';
...
describe('Audio preloader service', () => {
  ...
  it('should maintain the correct number of download requests in queue',
    fakeAsync(() => {
      const exploration = Exploration.createFromBackendDict(explorationDict);
