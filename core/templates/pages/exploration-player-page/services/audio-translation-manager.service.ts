...
export class AudioTranslationManagerService {
  ...
  _contentAudioTranslations: AudioTranslations|null = null;
  _contentHtmlForAutogeneratedAudio: string|null = null;

  // Audio translations for everything other than the main content, such as
  // those for feedback, hints, and solutions.
  _secondaryAudioTranslations: AudioTranslations|null = null;
  _secondaryHtmlForAutogeneratedAudio: string|null = null;

  _currentPrimaryComponentName: string|null = null;
  _currentSecondaryComponentName: string|null = null;
  ...
  getCurrentAudioTranslations(): AudioTranslations|null {
  ...
  getCurrentHtmlForAutogeneratedAudio(): string|null {
  ...
  getCurrentComponentName(): string|null {
