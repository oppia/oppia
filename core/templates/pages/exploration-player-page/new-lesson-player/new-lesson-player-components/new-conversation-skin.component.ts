...
/**
 * @fileoverview Component for the new lesson player conversation skin.
 */
...
angular.module('oppia').directive('oppiaNewConversationSkin',
  downgradeComponent({
    component: NewConversationSkinComponent
