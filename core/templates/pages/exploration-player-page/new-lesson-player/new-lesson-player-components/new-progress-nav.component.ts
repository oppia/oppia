...
/**
 * @fileoverview Component for navigation in the new conversation skin.
 */
...
import './new-progress-nav.component.css';
...
@Component({
  ...
  styleUrls: ['./new-progress-nav.component.css'],
  animations: [
    trigger('fadeInOut', [
      transition('void => *', []),
      transition('* <=> *', [
...
angular.module('oppia').directive('oppiaNewProgressNav',
  downgradeComponent({
    component: NewProgressNavComponent
