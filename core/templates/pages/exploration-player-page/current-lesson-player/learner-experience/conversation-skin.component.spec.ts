...
describe('Conversation skin component', () => {
  ...
  //   let completedChaptersCount = chapterProgressService.getCompletedChaptersCount();
  //   expect(completedChaptersCount).toBeUndefined();
  ...
  //   completedChaptersCount = chapterProgressService.getCompletedChaptersCount();

  //   expect(completedChaptersCount).toEqual(1);
  // }));
  ...
  it(
    ...
    fakeAsync(() => {
      ...
      spyOn(urlService, 'getPidFromUrl').and.returnValue(null);
      spyOn(conversationFlowService, 'getLanguageCode').and.returnValues(
        'en',
        'en',
        'en',
        'pq'
