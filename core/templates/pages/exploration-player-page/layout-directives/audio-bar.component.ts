...
export class AudioBarComponent {
  ...
  constructor(
    ...
    // this.voiceoverLanguageCodes = this.entityVoiceoversService.getLanguageCodes();
  ...
  onNewLanguageSelected(): void {
    ...
    let voiceoverInSelectedLanguage =
      this.entityVoiceoversService.getVoiceoverInGivenLanguageAccentCode(
        this.selectedLanguage.value
      );
    console.log(voiceoverInSelectedLanguage);
    if (
