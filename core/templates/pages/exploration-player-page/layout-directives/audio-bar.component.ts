...
export class AudioBarComponent {
  ...
  getCurrentAudioLanguageCode(): string {
    ...
    if (currentAudioLanguageCode === null) {
      throw new Error('Expected currentAudioLanguageCode to be set.');
    }
  ...
  getCurrentAudioLanguageDescription(): string {
    ...
    if (CurrentAudioLanguageDescription === null) {
      throw new Error('Expected currentAudioLanguageDescription to be set.');
    }
  ...
  playPauseAutogeneratedAudioTranslation(): void {
    ...
    if (this.autogeneratedAudioPlayerService.isPlaying()) {
      ...
      if (speechSynthesisLanguageCode === null) {
        throw new Error(
          'Expected speechSynthesisLanguageCode to be set.');
      }
