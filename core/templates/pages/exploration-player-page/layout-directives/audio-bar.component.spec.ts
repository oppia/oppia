...
fdescribe('Audio Bar Component', () => {
  ...
  beforeEach(() => {
    ...
    audioTranslationManagerService = TestBed.inject(AudioTranslationManagerService);
    autogeneratedAudioPlayerService = TestBed.inject(AutogeneratedAudioPlayerService);
  ...
  describe('on clicking play pause button ', () => {
    it('should play auto generated audio translation when ' +
      ...
      spyOn(autogeneratedAudioPlayerService, 'isPlaying')
        .and.returnValue(false);
      spyOn(audioTranslationLanguageService, 'getSpeechSynthesisLanguageCode').and.returnValue('')
  ...
  it('should restart audio bar after selecting a new language', () => {
    ...
    spyOn(playerPositionService, 'getCurrentStateName').and.returnValue('Start');
    spyOn(
      audioTranslationLanguageService, 'isAutogeneratedLanguageCodeSelected')
      .and.returnValue(false);
    ...
    let languageSetSpy = spyOn(
      ...
      .and.returnValue(null);
    let restartAudioBarSpy = spyOn(audioPreloaderService, 'restartAudioPreloader')
      .and.returnValue(null);
