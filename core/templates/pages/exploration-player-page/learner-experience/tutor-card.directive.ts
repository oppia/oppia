  ...
  'UrlInterpolationService', function(UrlInterpolationService) {
    return {
      ...
      controller: [
        ...
        'ExplorationPlayerStateService', 'I18nLanguageCodeService',
        'LearnerAnswerInfoService', 'PlayerPositionService', 'UrlService',
        'UserService', 'WindowDimensionsService', 'AUDIO_HIGHLIGHT_CSS_CLASS',
