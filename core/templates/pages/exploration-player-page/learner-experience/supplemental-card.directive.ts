  ...
  'UrlInterpolationService', function(UrlInterpolationService) {
    return {
      ...
      controller: [
        ...
        'TWO_CARD_THRESHOLD_PX', 'CONTINUE_BUTTON_FOCUS_LABEL',
        'AudioTranslationManagerService', 'AudioPlayerService',
        'AutogeneratedAudioPlayerService', 'LearnerAnswerInfoService',
          ...
          ctrl.$onInit = function() {
            ...
            ctrl.directiveSubscriptions.add(
              LearnerAnswerInfoService.onActiveCardChanged.subscribe(
                () => {
                  console.log('Caught: activeCardChanged in supplemental-card');
                  updateDisplayedCard();
                }
              )
            );
