...
describe('Tutor Card directive', function() {
  ...
  let audioPreloaderService: AudioPreloaderService = null;
  ...
  beforeEach(angular.mock.inject(function($injector) {
    ...
    audioBarStatusService = $injector.get('AudioBarStatusService');
    audioPlayerService = $injector.get('AudioPlayerService');
    audioPreloaderService = $injector.get('AudioPreloaderService');
    ...
    spyOnProperty(explorationPlayerStateService, 'onOppiaFeedbackAvailable').and.returnValue(
      oppiaFeedbackEmitter);
  ...
  describe('on initialization ', function() {
    it('should set profile picture from data url when ' +
      ...
      spyOn(userService, 'getProfileImageDataUrlAsync').and.resolveTo('imageUrl');
  ...
  it('should toggle previous responses when ' +
    ...
    let result = $scope.toggleShowPreviousResponses();
    expect($scope.arePreviousResponsesShown).toBe(true);

    result = $scope.toggleShowPreviousResponses();
