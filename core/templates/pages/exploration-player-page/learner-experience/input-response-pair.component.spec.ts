...
describe('InputResponsePairComponent', () => {
  ...
  beforeEach(() => {
    ...
    contentTranslationLanguageService = TestBed
      .inject(ContentTranslationLanguageService);
  ...
  it('should determine if a strinf is a number', ()=>{
    let number = '-12.4';
  ...
  it('should convert answer to a local format if it is a number', ()=>{
    ...
    spyOn(i18nLanguageCodeService, 'currentDecimalSeparator').and
      .returnValue(',');
    spyOn(contentTranslationLanguageService, 'currentDecimalSeparator')
      .and.returnValue('.');
