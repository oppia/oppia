...
describe('InputResponsePairComponent', () => {
  ...
  it('should verify that the popup content contains its not null', () => {
    spyOn(explorationHtmlFormatter, 'getAnswerHtml').and.returnValue(
      '<p> HTML Answer </p>'
    );
    ...
    expect(document.querySelector('ngb-popover-window'))
      .not.toBeTruthy();

    const popover = fixture.debugElement.query(
      By.directive(NgbPopover)).injector.get(NgbPopover);
