...
require('pages/exploration-player-page/services/audio-translation-language.service')
require(
  ...
  function(UrlInterpolationService, UrlService) {
    return {
      ...
      controller: [
        ...
        'AutogeneratedAudioPlayerService', 'AudioTranslationLanguageService',
        ...
        function(
            $http, $location, $rootScope, $scope, $timeout, $translate,
            $window, AlertsService, AudioPlayerService, AudioTranslationLanguageService,
