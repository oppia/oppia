      ...
      controller: [
        ...
        function(
          ...
          var _navigateToDisplayedCard = function() {
            ...
            console.log('Emitted: autoplayAudio in conv-skin-navigate-to-displayed-card');
            AutogeneratedAudioPlayerService.onAutoplayAudio.emit();
            ...
            $scope.answerIsCorrect = currentEngineService.submitAnswer(
              answer, interactionRulesService, function(
                ...
                $timeout(function() {
                  ...
                  console.log('Emitted: autoplayAudio in conv-skin answer is correct');
                  AutogeneratedAudioPlayerService.onAutoplayAudio.emit({
