              ...
              if (!$scope.recommendedExplorationSummaries[0].id) {
                ...
                if (parentExplorationIds &&
                  ...
                  urlParams.hasOwnProperty('story_id') &&
                    ...
                    urlParams.hasOwnProperty('abbreviated_topic_name') &&
                    urlParams.hasOwnProperty('classroom_name')) {
                  abbreviatedTopicName = urlParams.abbreviated_topic_name;
                ...
                if (storyIdToAdd && $scope.storyNodeIdToAdd) {
                  result = UrlService.addField(
                    result, 'abbreviated_topic_name', abbreviatedTopicName);
                  result = UrlService.addField(
            ...
            if ($scope.displayedCard.isTerminal()) {
              ...
              if (ExplorationPlayerStateService.isInStoryChapterMode() &&
                ...
                var abbreviatedTopicName = (
                  UrlService.getUrlParams().abbreviated_topic_name);
                ...
                StoryViewerBackendApiService.fetchStoryData(
                  abbreviatedTopicName, classroomUrlFragment, storyId).then(
                  function(res) {
                    var nextStoryNode = [];
                ...
                StoryViewerBackendApiService.recordChapterCompletion(
                  abbreviatedTopicName, classroomUrlFragment, storyId, nodeId
