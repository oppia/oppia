...
export class LearnerGroupsTabComponent {
  ...
  ngOnInit(): void {
    this.learnerDashboardBackendApiService
      ...
      .then(learnerDashboardLearnerGroups => {
  ...
  declineLearnerGroupInvitation(
    ...
    let modalRef = this.ngbModal.open(DeclineInvitationModalComponent, {
      backdrop: 'static',
  ...
  viewLearnerGroupDetails(learnerGroupSummary: ShortLearnerGroupSummary): void {
    let modalRef = this.ngbModal.open(ViewLearnerGroupDetailsModalComponent, {
      backdrop: 'static',
