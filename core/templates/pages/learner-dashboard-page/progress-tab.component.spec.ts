...
describe('Progress Tab Component', () => {
  ...
  it('should populate curatedExplorationIds and filter community lessons correctly', () => {
    const expBackend1 = {
      last_updated_msec: 1591296737470.528,
      community_owned: false,
      objective: 'Test Objective',
    ...
    const expBackend2 = {
      last_updated_msec: 1591296737470.529,
      community_owned: true,
      objective: 'Test Objective',
      id: 'exp124',
      num_views: 0,
      thumbnail_icon_url: '/subjects/Algebra1.svg',
      human_readable_contributors_summary: {},
      language_code: 'en',
      thumbnail_bg_color: '#cc4b00',
      created_on_msec: 1591296635736.666,
      ...
      activity_type: 'exploration',
      category: 'Algebra',
      title: 'Test Exploration Community',
    };

    const explorationSummary1 =
      LearnerExplorationSummary.createFromBackendDict(expBackend1);
    const explorationSummary2 =
      LearnerExplorationSummary.createFromBackendDict(expBackend2);
    ...
    expect(component.curatedExplorationIds.has('exp123')).toBeTrue();
    expect(component.curatedExplorationIds.has('exp124')).toBeTrue();

    const filteredLessons = component.allCommunityLessons;
    expect(filteredLessons.length).toBe(0);
