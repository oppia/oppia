...
import { ContributorAdminDashboardPageRootComponent } from './contributor-admin-dashboard-page.component';
...
describe('ContributorAdminDashboard Page Root', () => {
  let fixture: ComponentFixture<ContributorAdminDashboardPageRootComponent>;
  let component: ContributorAdminDashboardPageRootComponent;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [
        ContributorAdminDashboardPageRootComponent,
        MockTranslatePipe
      ],
      providers: [
        PageHeadService,
