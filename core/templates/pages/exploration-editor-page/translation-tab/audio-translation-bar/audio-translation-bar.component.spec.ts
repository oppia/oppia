...
describe('Audio translation bar Component', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [AudioTranslationBarComponent, MockFormatTimePipe],
      providers: [
        ContextService,
        {
          provide: NgbModal,
  ...
  beforeEach(() => {
    ...
    spyOn(explorationStatesService, 'saveRecordedVoiceovers').and.callFake(
      () => {}
    );
    ...
    ).and.returnValue(mockActiveContentIdChangedEventEmitter);
    ...
    ).and.returnValue(mockShowTranslationTabBusyModalEventEmitter);
  ...
  it('should trigger dragover event in translation tab element', fakeAsync(() => {
    component.ngOnInit();
    tick();
  ...
  it('should load and play audio', () => {
    spyOn(component, 'getAvailableAudio').and.returnValue(
      new Voiceover('filename', 1, false, 12)
    );
  ...
  it(
    'should not check and start recording when voiceover recorder is' +
      ' not available',
    () => {
      spyOn(voiceoverRecordingService, 'status').and.returnValue({
        isAvailable: false,
  ...
  it(
    'should play and pause unsaved audio when wave surfer calls on method' +
      ' callback',
    fakeAsync(() => {
      component.ngOnInit();
      tick();
  ...
  it(
    'should play and pause unsaved audio when wave surfer on method does' +
  ...
  it('should open translation tab busy modal with NgbModal', fakeAsync(() => {
  ...
  it('should delete audio when closing delete audio translation modal', fakeAsync(() => {
    ...
    expect(explorationStatesService.saveRecordedVoiceovers).toHaveBeenCalled();
  }));

  it(
    'should not delete audio when dismissing delete audio translation' +
      ' modal',
    fakeAsync(() => {
      spyOn(stateRecordedVoiceoversService.displayed, 'deleteVoiceover');
  ...
  it('should add audio translation when closing add audio translation modal', fakeAsync(() => {
    spyOn(stateRecordedVoiceoversService.displayed, 'deleteVoiceover');
    spyOn(
      stateRecordedVoiceoversService.displayed,
      'addVoiceover'
  ...
  it(
    'should not add audio translation when dismissing add audio' +
      ' translation modal',
    fakeAsync(() => {
