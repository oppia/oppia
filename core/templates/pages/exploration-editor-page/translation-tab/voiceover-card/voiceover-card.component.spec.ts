...
describe('Voiceover card component', () => {
    ...
    it('should be able to play loaded manual voiceover', fakeAsync(() => {
        ...
        component.currentVoiceoverLoadedType =
            AppConstants.VOICEOVER_TYPE_MANUAL;
    ...
    it('should be able to play automatic voiceover by pausing manual voiceover', fakeAsync(() => {
        ...
        component.playAndPauseVoiceover(
            'a.mp3',
            AppConstants.VOICEOVER_TYPE_AUTO
        );
    ...
    it('should show voiceover regeneration section', () => {
        ...
        expect(
            component.shouldShowAutoVoiceoverRegenerationSection()
        ).toBeTrue();
    ...
    it('should update automatic voiceover status when generation status is SUCCEEDED', fakeAsync(() => {
        ...
        expect(component.automaticVoiceoverGenerationStatus).toEqual(
            'SUCCEEDED'
        );
    }));
