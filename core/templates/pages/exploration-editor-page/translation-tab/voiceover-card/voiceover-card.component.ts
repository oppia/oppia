...
export class VoiceoverCardComponent implements OnInit, AfterViewChecked {
    ...
    ngOnInit(): void {
        ...
        this.pollingSub =
            this.voiceoverRegenerationJobService.status$.subscribe(() => {
                this.updateAutomaticVoiceoverWithRegenerationStatus();
            });
        ...
        this.changeListService.getVoiceoverChangeList().forEach(changeDict => {
            ...
            if (voiceovers.hasOwnProperty('manual')) {
                ...
                entityVoiceovers.voiceoversMapping[contentId].manual =
                    undefined;
                if (
                    entityVoiceovers.voiceoversMapping[contentId].auto ===
                    undefined
                ) {
    ...
    deleteManualVoiceover(): void {
        ...
        modalRef.result.then(
            () => {
                ...
                if (this.automaticVoiceover) {
                    voiceoversMapping = {
                        auto: this.automaticVoiceover.toBackendDict(),
                    };
                }
                ...
                if (
                    ...
                    delete this.activeEntityVoiceoversInstance
                        .voiceoversMapping[this.activeContentId];
                }
