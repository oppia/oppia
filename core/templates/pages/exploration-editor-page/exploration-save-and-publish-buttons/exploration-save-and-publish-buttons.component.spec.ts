...
describe('Exploration save and publish buttons component', () => {
  ...
  class MockWindowRef {
    ...
    nativeWindow = {
      ...
      addEventListener: (value1: string, value2: string) => {},
    };
  }
  ...
  beforeEach(() => {
    ...
    fetchPermissionsAsyncSpy.and.returnValue(
  ...
  it('should publish exploration when show publish exploration is shown', fakeAsync(() => {
  ...
  it(
    'should resolve the warnings before saving exploration when exploration' +
    ...
    () => {
      ...
      expect(component.getSaveButtonTooltip()).toBe(
        'Please resolve the warnings.'
      );
    }
  );

  it(
    'should save exploration draft when it has no warnings and exploration' +
      ' is private',
    () => {
      spyOn(explorationWarningsService, 'hasCriticalWarnings').and.returnValue(
        false
  ...
  it(
    'should ask user to resolve the warnings before publishing' +
  ...
  it(
    'should save exploration changes before publishing it when trying to' +
  ...
  it(
    'should save or publish exploration when editing outside tutorial mode' +
  ...
  it(
    'should not save and publish exploration when editing inside tutorial' +
  ...
  it('should display publish button when the exploration is unpublished', fakeAsync(() => {
    component.explorationCanBePublished = false;

    userExplorationPermissionsService.onUserExplorationPermissionsFetched.emit();
    tick();
  ...
  it(
    'should fetch userExplorationPermissions when ' +
      'showPublishExplorationModal is called',
    fakeAsync(() => {
      let userPermissions = {
        canPublish: true,
      };
  ...
  it('should open a exploration save prompt modal only once', fakeAsync(() => {
    spyOn(changeListService, 'getChangeList').and.returnValue(new Array(51));
    spyOn(ngbModal, 'open').and.returnValue({
