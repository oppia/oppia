...
export class ResponsesService {
  ...
  private _saveAnswerGroups(newAnswerGroups) {
    let oldAnswerGroups = this._answerGroupsMemento;
    if (
      newAnswerGroups &&
      oldAnswerGroups &&
  ...
  private _saveConfirmedUnclassifiedAnswers(newConfirmedUnclassifiedAnswers) {
  ...
  updateConfirmedUnclassifiedAnswers(
      confirmedUnclassifiedAnswers: string[]
  ): void {
