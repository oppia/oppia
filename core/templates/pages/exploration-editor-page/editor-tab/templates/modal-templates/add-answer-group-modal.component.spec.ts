...
describe('Add Answer Group Modal Component', () => {
  ...
  it('should initialize component properties after controller is initialized', fakeAsync(() => {
  ...
  it('should initialize null destination values in question mode', () => {
    expect(component.questionModeEnabled).toBe(true);
    expect(component.tmpRule.type).toBe(null);
  ...
  it('should focus on the header after loading', () => {
    const addResponseRef = new ElementRef(document.createElement('h4'));
