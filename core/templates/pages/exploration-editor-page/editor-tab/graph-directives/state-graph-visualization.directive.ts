...
@Component({
  ...
  templateUrl: './state-graph-visualization.directive.html',
  styleUrls: []
})
export class StateGraphVisualization 
  ...
  @Input() allowPanning: any;
  @Input() centerAtCurrentState: any;
  @Input() currentStateId: any;
...
angular.module('oppia').directive(
  'StateGraphVisualization', downgradeComponent(
