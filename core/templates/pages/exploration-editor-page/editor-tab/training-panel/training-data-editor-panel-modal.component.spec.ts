...
describe('Training Data Editor Panel Component', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [TrainingDataEditorPanelComponent],
      providers: [
        FocusManagerService,
        AlertsService,
  ...
  it('should initialize component properties after component is initialized', fakeAsync(() => {
    ...
    expect(
      truncateInputBasedOnInteractionAnswerTypePipe.transform
    ).toHaveBeenCalled();
  ...
  it('should submit answer that is not explicity classified', () => {
    ...
    expect(component.newAnswerTemplate).toBe('answer');
    expect(component.newAnswerFeedback).toEqual('feedback');
