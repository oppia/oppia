...
export class TrainingModalService {
  ...
  openTrainUnresolvedAnswerModal(
      ...
      finishTrainingCallback: Function): void {
    this.alertsService.clearWarnings();

    const modelRef = this.ngbModal.open(TrainingModalComponent, {
      backdrop: 'static'
    });
    modelRef.componentInstance.unhandledAnswer = () => {
      return unhandledAnswer;
    };
    modelRef.componentInstance.finishTrainingCallback = () => {
