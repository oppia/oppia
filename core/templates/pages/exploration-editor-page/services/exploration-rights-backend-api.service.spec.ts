...
describe('Exploration Rights Backend Api Service', () => {
  ...
  it(
    'should successfully send put http request when' +
      ' makeCommunityOwnedPutData called',
    fakeAsync(() => {
      let requestData = {
        version: 3,
      ...
      service
        .makeCommunityOwnedPutData(
          'oppia12345',
          requestData.version,
          requestData.make_community_owned
        )
  ...
  it(
    'should successfully send put http request when' +
      ' when saveRoleChangesPutData called',
    fakeAsync(() => {
      let requestData = {
        version: 3,
  ...
  it(
    'should successfully send put http request' +
      ' when setViewabilityPutData called',
    fakeAsync(() => {
      let requestData = {
        version: 3,
  ...
  it(
    'should successfully send put http request' + 'when publishPutData called',
    fakeAsync(() => {
      let requestData = {
        make_public: true,
      };
      ...
      service
        .publishPutData('oppia12345', requestData.make_public)
        .then(successHandler, failHandler);
  ...
  it(
    'should successfully send put http request' +
      ' when saveModeratorChangeToBackendAsyncPutData called',
    fakeAsync(() => {
      let requestData = {
        version: 3,
        email_body: '',
  ...
  it(
    'should successfully send Delete http request' +
      ' when removeRoleAsyncDeleteData called',
    fakeAsync(() => {
      service
        .removeRoleAsyncDeleteData('oppia12345', 'userNameToDeleteTheUser')
        .then(successHandler, failHandler);
  ...
  it(
    'should successfully send http Post request' +
      ' when assignVoiceArtistRoleAsyncPostData called',
    fakeAsync(() => {
      let requestData = {
      ...
      service
        .assignVoiceArtistRoleAsyncPostData('oppia12345', requestData.username)
        .then(successHandler, failHandler);
  ...
  it(
    'should successfully send Delete http request' +
      ' when removeVoiceArtistRoleAsyncDeleteData called',
    fakeAsync(() => {
      service
        .removeVoiceArtistRoleAsyncDeleteData(
          'oppia12345',
          'usernameForRemoveVoiceArtistRole'
        )
        .then(successHandler, failHandler);
