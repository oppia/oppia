...
export class ExplorationStatesService {
    ...
    private _refreshGraphEventEmitter: EventEmitter<string> =
        new EventEmitter();
    ...
    _extractContentIds(
        ...
        let contents: TranslatableField[] = this._CONTENT_EXTRACTORS[
            backendName
    ...
    isNewStateNameValid(newStateName: string, showWarnings: boolean): boolean {
        ...
        return this.validatorsService.isValidStateName(
            newStateName,
            showWarnings
        );
    }
    ...
    saveCardIsCheckpoint(
        stateName: string,
        newCardIsCheckpoint: boolean
    ): void {
        this.saveStateProperty(
            stateName,
            'card_is_checkpoint',
