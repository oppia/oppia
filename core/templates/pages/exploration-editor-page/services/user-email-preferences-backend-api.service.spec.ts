...
describe('User Email Preferences Backend Api Service', () => {
  ...
  let userEmailPreferencesBackendApiService: UserEmailPreferencesBackendApiService;
  ...
  beforeEach(() => {
    ...
    userEmailPreferencesBackendApiService = TestBed.inject(
  ...
  it('should successfully send http request and get a valid response', fakeAsync(() => {
    let result: Promise<EmailPreferencesData> =
      userEmailPreferencesBackendApiService.saveChangeToBackendAsync({
