...
export class UserEmailPreferencesService {
  ...
  constructor(
    ...
    private userEmailPreferencesBackendApiService: UserEmailPreferencesBackendApiService
  ) {}
   ...
   */
  async saveChangeToBackendAsync(requestParams: RequestParams): Promise<void> {
