...
describe('Changes in Human Readable Form Component', () => {
  ...
  it('should make human readable when adding a state', () => {
    ...
    let html = fixture.debugElement.nativeElement.querySelector(
      '.oppia-lost-changes'
    ).outerHTML;
  ...
  it('should make human readable when renaming a state', () => {
    ...
    expect(result).toBe(
      '<div class="oppia-lost-changes e2e-test-oppia-lost-changes">' +
        ...
        '<li>' +
        '<span> Renamed state: ' +
        component.lostChanges[0].oldStateName +
        ' to ' +
        component.lostChanges[0].newStateName +
        ' </span>' +
        '</li>' +
        '</ul>' +
        '</div>'
  ...
  it('should make human readable when editing a state with property content', () => {
    ...
    let result = removeComments(html);
    let lostChangeValue = component.lostChanges[0].newValue as LostChangeValue;
    expect(result).toBe(
      '<div class="oppia-lost-changes e2e-test-oppia-lost-changes">' +
        '<ul>' +
        '<li>' +
        ...
        'Edits to property:' +
        '</strong> ' +
        component.lostChanges[0].propertyName +
        ' </div>' +
        '<div>' +
  ...
  it(
    'should make human readable when editing a state with property' +
  ...
  it(
    ...
    () => {
      ...
      let result = removeComments(html);
      let lostChangeValue = component.lostChanges[0]
        .newValue as LostChangeValue as Outcome;
      ...
      expect(result).toBe(
        '<div class="oppia-lost-changes e2e-test-oppia-lost-changes">' +
          ...
          '</i>' +
          // eslint-disable-next-line dot-notation
          lostChangeValue['dest' as keyof LostChangeValue] +
          ' </p>' +
          '<div class="sub-edit">' +
          '<i>Feedback: ' +
          '</i>' +
