  ...
  initExplorationPage(): Promise<void> {
    ...
    return Promise.all([
      ...
      this.explorationCategoryService.init(
        explorationData.category);
      this.explorationObjectiveService.init(explorationData.objective);
      ...
      this.explorationTagsService.init(explorationData.tags);
      ...
      this.currentUser = explorationData.user;
