...
describe('Subtopic viewer navbar breadcrumb component', () => {
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [StoryViewerNavbarBreadcrumbComponent, MockTranslatePipe],
  ...
  it('should set story title when component is initialized', waitForAsync(() => {
    component.ngOnInit();
  ...
  it(
    'should set topic name and story title translation key and ' +
    ...
    waitForAsync(() => {
      ...
      fixture.whenStable().then(() => {
        ...
        expect(component.storyTitleTranslationKey).toBe('I18N_STORY_id_TITLE');
