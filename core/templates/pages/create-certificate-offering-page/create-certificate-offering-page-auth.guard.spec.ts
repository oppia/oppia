...
/**
 * @fileoverview Tests for CreateCertificateOfferingPageAuthGuard.
 */
...
describe('CreateCertificateOfferingPageAuthGuard', () => {
  let guard: CreateCertificateOfferingPageAuthGuard;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        CreateCertificateOfferingPageAuthGuard,
        {
    ...
    guard = TestBed.inject(CreateCertificateOfferingPageAuthGuard);
  ...
  it('should redirect to 404 when certificate assessment is disabled', fakeAsync(() => {
    ...
    let canActivateResult: boolean | null = null;
    const stateSnapshot = {
      url: '/create-certificate-assessment-offering',
    ...
    expect(replaceStateSpy).toHaveBeenCalledWith(
      '/create-certificate-assessment-offering'
    );
  }));
});
