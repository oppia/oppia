...
/**
 * @fileoverview Unit tests for the get started page root component.
 */
...
describe('Get Started Page Root', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [GetStartedPageRootComponent, MockTranslatePipe],
      providers: [
        PageHeadService,
        {
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GetStartedPageRootComponent);
