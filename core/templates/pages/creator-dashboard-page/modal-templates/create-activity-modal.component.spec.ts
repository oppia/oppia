...
describe('Create Activity Modal Component', () => {
  ...
  it('should evaluate component properties after component is initialized', fakeAsync(() => {
    ...
    expect(component.getStaticImageUrl('/activity/exploration.svg')).toBe(
      '/assets/images/activity/exploration.svg'
    );
    expect(component.getStaticImageUrl('/activity/collection.svg')).toBe(
      '/assets/images/activity/collection.svg'
    );
  }));

  it(
    'should create new exploration when choosing exploration as the new' +
      ' activity',
    () => {
  ...
  it(
    'should create new collection when choosing collection as the new' +
      ' activity',
    () => {
      const dismissSpy = spyOn(ngbActiveModal, 'dismiss').and.callThrough();
