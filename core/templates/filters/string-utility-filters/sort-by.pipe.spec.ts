...
describe('Sort By Pipe', () => {
  ...
  it(
    'should sort single dimension integer' + ' array in ascending order',
    () => {
  ...
  it(
    'should sort single dimension integer array' + ' in descending order',
    () => {
      let numberArray = [1, 4, 3, 5, 2];
  ...
  it(
    'should sort single dimension character array' + ' in ascending order',
    () => {
  ...
  it(
    'should sort single dimension character array' + ' in descending order',
    () => {
      let charArray = ['b', 'c', 'a', 'd', 'e'];
  ...
  it(
    'should sort multi dimensional array with integer attribute' +
      ' in ascending order',
    () => {
      let result = sortByPipe.transform(multidimensionalArray, false, 'impact');
  ...
  it(
    'should sort multi dimensional array with integer attribute' +
      ' in descending order',
    () => {
      let result = sortByPipe.transform(multidimensionalArray, true, 'impact');
      result.forEach((value, index) => {
        if (index === 0) {
          expect(value.impact).toBe(3);
        }
  ...
  it(
    'should sort multi dimensional array with string attribute' +
      ' in ascending order',
    () => {
  ...
  it(
    'should return back the current value if' + ' sortKey values matches',
    () => {
      let result = sortByPipe.transform(
        multidimensionalArray,
        false,
  ...
  it('should return the reversed array if given sortKey is default', () => {
    let result = sortByPipe.transform(multidimensionalArray, true, 'default');
