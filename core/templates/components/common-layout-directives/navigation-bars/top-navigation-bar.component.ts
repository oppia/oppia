...
export class TopNavigationBarComponent implements OnInit, OnDestroy {
  ...
  ACTION_OPEN = null;
  ACTION_CLOSE = null;
  KEYBOARD_EVENT_TO_KEY_CODES = null;
  windowIsNarrow: boolean = false;
  activeMenuName: string;
  profilePageUrl = null;
  numUnseenNotifications = null;
  ...
  ngOnInit(): void {
    ...
    this.ACTION_OPEN = NavigationService.ACTION_OPEN;
    this.ACTION_CLOSE = NavigationService.ACTION_CLOSE;
  ...
  onMenuKeypress(evt: {
     keyCode: string;
     shiftKey: string; }, menuName: string, eventsTobeHandled: Event): void {
