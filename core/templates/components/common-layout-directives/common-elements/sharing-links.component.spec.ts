...
describe('SharingLinksComponent', () => {
  ...
  it(
    'should set query fields for social platform APIs when an' +
    ...
    () => {
      ...
      expect(component.classroomUrl).toBe(
        '/assets/images/general/classroom.png'
      );
    }
  );

  it(
    'should set query fields for social platform APIs when a' +
  ...
  it(
    'should throw an error when SharingLink component is used' +
  ...
  it('should get font and flex class according to font size', () => {
    ...
    expect(component.getFontAndFlexClass()).toBe('font-small fx-row-center');
  });
  ...
  it('should get social media URLs', () => {
    ...
    component.blogPostUrl = 'sample-blog-post-url';
    component.escapedTwitterText =
      'Check out this new blog post on Oppia - a' +
  ...
  it(
    'should show embed exploration modal when' +
  ...
  it(
    'should register exploration share event when user clicks' +
      ' on a social media icon',
    () => {
      const shareExplorationEventSpy = spyOn(
        siteAnalyticsService,
        'registerShareExplorationEvent'
      );
  ...
  it(
    'should register collection share event when user clicks' +
      ' on a social media icon',
    () => {
      const shareCollectionEventSpy = spyOn(
        siteAnalyticsService,
        'registerShareCollectionEvent'
      );
      const windowRefSpy = spyOn(windowRef.nativeWindow, 'open');
      component.shareType = 'collection';
  ...
  it(
    'should register blog post share event when user clicks' +
      ' on a social media icon',
    () => {
      const shareBlogPostEventSpy = spyOn(
        siteAnalyticsService,
