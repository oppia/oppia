...
angular.module('oppia').directive('ratingDisplay', [function() {
  return {
    ...
    template: require('./rating-display.directive.html'),
...
export class RatingDisplayDirective extends UpgradeComponent {
  constructor(elementRef: ElementRef, injector: Injector) {
    super('ratingDisplay', elementRef, injector);
  }
}
