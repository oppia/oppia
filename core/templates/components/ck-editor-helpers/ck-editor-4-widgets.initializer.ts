...
const CKEDITOR_IMPORT_PATH = 'third-party-imports/ckeditor.import';
...
export class CkEditorInitializerService {
  ...
  static ckEditorInitializer(
    ...
    // We use a dynamic import to load the CKEditor script asynchronously
    // and only proceed with the CKEDITOR setup once the script is loaded.
    import(CKEDITOR_IMPORT_PATH)
      .then(() => {
