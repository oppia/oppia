...
/**
 * @fileoverview Component for the skills mastery list.
 */
...
angular.module('oppia').component('skillsMasteryList', {
  bindings: {
    getDegreesOfMastery: '&degreesOfMastery',
    getSkillDescriptions: '&skillDescriptions'
  },
  template: require(
    'components/skills-mastery-list/skills-mastery-list.component.html'),
  controllerAs: '$ctrl',
  controller: [
