...
angular.module('oppia').directive('outcomeDestinationEditor', [function() {
  return {
    restrict: 'E',
    scope: {},
    bindToController: {
    ...
    template: require('./outcome-destination-editor.directive.html'),
    controllerAs: '$ctrl',
    controller: [
...
@Directive({
  selector: 'outcome-destination-editor'
})
export class OutcomeDestinationEditorDirective extends UpgradeComponent {
  constructor(elementRef: ElementRef, injector: Injector) {
    super('outcomeDestinationEditor', elementRef, injector);
  }
}
