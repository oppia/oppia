...
angular.module('oppia').directive('stateInteractionEditor', [function() {
  return {
    restrict: 'E',
    ...
    template: require('./state-interaction-editor.directive.html'),
    controller: [
...
@Directive({
  selector: 'state-interaction-editor'
})
export class StateInteractionEditorDirective extends UpgradeComponent {
  constructor(elementRef: ElementRef, injector: Injector) {
    super('stateInteractionEditor', elementRef, injector);
  }
}
