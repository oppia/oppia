...
angular.module('oppia').directive('stateSolutionEditor', [function() {
  return {
    ...
    template: require('./state-solution-editor.directive.html'),
    controller: [
...
@Directive({
  selector: 'state-solution-editor'
})
export class StateSolutionEditorDirective extends UpgradeComponent {
  constructor(elementRef: ElementRef, injector: Injector) {
    super('stateSolutionEditor', elementRef, injector);
  }
}
