...
angular.module('oppia').directive('schemaBasedDictViewer', [
  ...
  function(NestedDirectivesRecursionTimeoutPreventionService) {
    return {
      ...
      template: require('./schema-based-dict-viewer.directive.html'),
      restrict: 'E',
...
@Directive({
  selector: 'schema-based-dict-viewer'
})
export class SchemaBasedDictViewerDirective extends UpgradeComponent {
  constructor(elementRef: ElementRef, injector: Injector) {
    super('schemaBasedDictViewer', elementRef, injector);
  }
}
