...
/**
 * @fileoverview Unit tests for Schema Based Dict Viewer Directive
 */

import { importAllAngularServices } from 'tests/unit-test-utils.ajs';

describe('Schema Based Dict Viewer Directive', () => {
  let $rootScope = null;
  let $scope = null;
  let directive = null;
  ...
  beforeEach(angular.mock.inject(function($injector) {
    ...
    directive = $injector.get('schemaBasedDictViewerDirective')[0];
