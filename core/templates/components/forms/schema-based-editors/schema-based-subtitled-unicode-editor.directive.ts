...
/**
 * @fileoverview Directive for a schema-based editor for subtitled unicode.
 */
...
angular.module('oppia').directive('schemaBasedSubtitledUnicodeEditor', [
  function() {
    return {
      restrict: 'E',
      scope: {},
      ...
      template:
        require('./schema-based-subtitled-unicode-editor.directive.html'),
      controllerAs: '$ctrl',
      controller: [
        ...
        function(
          ...
          ctrl.getDisplayedValue = function() {
            return $sce.trustAsHtml(
              $filter('convertUnicodeWithParamsToHtml')(
                ctrl.localValue._unicode));
          };
