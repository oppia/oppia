...
import {AlgebraicExpressionEditorComponent} from 'extensions/objects/templates/algebraic-expression-editor.component.ts';
import {BooleanEditorComponent} from 'extensions/objects/templates/boolean-editor.component.ts';
import {CodeStringEditorComponent} from 'extensions/objects/templates/code-string-editor.component.ts';
import {CoordTwoDimEditorComponent} from 'extensions/objects/templates/coord-two-dim-editor.component.ts';
import {AllowedVariablesEditorComponent} from 'extensions/objects/templates/allowed-variables-editor.component.ts';
import {DragAndDropPositiveIntEditorComponent} from 'extensions/objects/templates/drag-and-drop-positive-int-editor.component.ts';
import {FilepathEditorComponent} from 'extensions/objects/templates/filepath-editor.component.ts';
import {FractionEditorComponent} from 'extensions/objects/templates/fraction-editor.component.ts';
import {GraphEditorComponent} from 'extensions/objects/templates/graph-editor.component.ts';
import {HtmlEditorComponent} from 'extensions/objects/templates/html-editor.component.ts';
import {ImageWithRegionsEditorComponent} from 'extensions/objects/templates/image-with-regions-editor.component.ts';
import {ListOfSetsOfTranslatableHtmlContentIdsEditorComponent} from 'extensions/objects/templates/list-of-sets-of-translatable-html-content-ids-editor.component.ts';
import {ListOfTabsEditorComponent} from 'extensions/objects/templates/list-of-tabs-editor.component';
import {ListOfUnicodeStringEditorComponent} from 'extensions/objects/templates/list-of-unicode-string-editor.component.ts';
import {MathEquationEditorComponent} from 'extensions/objects/templates/math-equation-editor.component.ts';
import {MathExpressionContentEditorComponent} from 'extensions/objects/templates/math-expression-content-editor.component.ts';
import {MusicPhraseEditorComponent} from 'extensions/objects/templates/music-phrase-editor.component.ts';
import {NonnegativeIntEditorComponent} from 'extensions/objects/templates/nonnegative-int-editor.component.ts';
import {NormalizedStringEditorComponent} from 'extensions/objects/templates/normalized-string-editor.component.ts';
import {NumberWithUnitsEditorComponent} from 'extensions/objects/templates/number-with-units-editor.component.ts';
import {NumericExpressionEditorComponent} from 'extensions/objects/templates/numeric-expression-editor.component.ts';
import {ParameterNameEditorComponent} from 'extensions/objects/templates/parameter-name-editor.component.ts';
import {PositionOfTermsEditorComponent} from 'extensions/objects/templates/position-of-terms-editor.component.ts';
import {PositiveIntEditorComponent} from 'extensions/objects/templates/positive-int-editor.component.ts';
import {RatioExpressionEditorComponent} from 'extensions/objects/templates/ratio-expression-editor.component.ts';
import {RealEditorComponent} from 'extensions/objects/templates/real-editor.component.ts';
import {SanitizedUrlEditorComponent} from 'extensions/objects/templates/sanitized-url-editor.component.ts';
import {SetOfAlgebraicIdentifierEditorComponent} from 'extensions/objects/templates/set-of-algebraic-identifier-editor.component.ts';
import {SetOfTranslatableHtmlContentIdsEditorComponent} from 'extensions/objects/templates/set-of-translatable-html-content-ids-editor.component.ts';
import {SetOfUnicodeStringEditorComponent} from 'extensions/objects/templates/set-of-unicode-string-editor.component.ts';
import {SkillSelectorEditorComponent} from 'extensions/objects/templates/skill-selector-editor.component.ts';
import {SubtitledHtmlEditorComponent} from 'extensions/objects/templates/subtitled-html-editor.component.ts';
import {SubtitledUnicodeEditorComponent} from 'extensions/objects/templates/subtitled-unicode-editor.component.ts';
import {SvgEditorComponent} from 'extensions/objects/templates/svg-editor.component.ts';
import {TranslatableHtmlContentIdEditorComponent} from 'extensions/objects/templates/translatable-html-content-id.component.ts';
import {TranslatableSetOfNormalizedStringEditorComponent} from 'extensions/objects/templates/translatable-set-of-normalized-string-editor.component.ts';
import {TranslatableSetOfUnicodeStringEditorComponent} from 'extensions/objects/templates/translatable-set-of-unicode-string-editor.component.ts';
import {UnicodeStringEditorComponent} from 'extensions/objects/templates/unicode-string-editor.component.ts';
import {IntEditorComponent} from 'extensions/objects/templates/int-editor.component.ts';
