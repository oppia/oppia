    ...
    return {
      ...
      controller: ['$rootScope', '$scope', '$window', 'BackgroundMaskService',
        ...
        function(
          ...
          // TODO(sll): This is added as a temporary fix for change detection to
          // enable side-navigation-bar while migrating Top-Navigation-Bar.
          // It needs to be removed with migration of this directive along
          // with changes made in SidebarStatusService.
