...
import { ProfilePictureDataBackendDict, UserBackendApiService, UserContributionRightsDataBackendDict } from 'services/user-backend-api.service';
...
export class UserService {
  ...
  async setProfileImageDataUrlAsync(
      newProfileImageDataUrl: string): Promise<ProfilePictureDataBackendDict> {
