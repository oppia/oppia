...
export class AutomaticVoiceoverHighlightService {
    ...
    transformMathSentenceContainingAudioSpecficWords(sentence: string): string {
        ...
        sentence = this.processFactorialInText(
            sentence,
            mathSymbolPronunciations
        );
    ...
    getCurrentSentenceIdToHighlight(
        ...
        let currentsentenceIdAndInterval =
            this.sentenceHighlightIntervalList.find(sentenceIdAndInterval => {
                return (
        ...
        if (!currentsentenceIdAndInterval) {
            currentsentenceIdAndInterval =
                this.sentenceHighlightIntervalList.find(
