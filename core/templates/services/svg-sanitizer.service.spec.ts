...
describe('SvgSanitizerService', () => {
  ...
  it(
    'should return null when a invalid base64 SVG is requested as' +
      'SafeResourceUrl',
    () => {
      expect(
        svgSanitizerService.getTrustedSvgResourceUrl(invalidBase64data)
      ).toBeNull();
    }
  );

  it('should return safeResourceUrl after removing invalid tags and attributes', () => {
    const testCases = [
      {
    ...
    testCases.forEach(testCase => {
      ...
      let safeResourceUrl =
        svgSanitizerService.getTrustedSvgResourceUrl(dataURI);
  ...
  it(
    'should expect dimensions.verticalPadding to be zero if attribute style' +
      'is invalid',
    () => {
      var svgString =
        '<svg width="1.33ex" height="1.429ex" viewBox="0 -511.5 572.5 615.4" ' +
  ...
  it('should catch malicious SVGs', () => {
    const testCases: {
    ...
    }[] = [
      {
        ...
        payload:
          '<image name=body><image name=adoptNode>@mmrupp<image name=' +
      ...
      {
        title:
          'DOM clobbering attack using name=body and injecting SVG + ke' +
          'ygen',
        payload:
          '<image name=body><img src=x><svg onload=alert(1); autofocu' +
      ...
      },
      {
        ...
        payload:
          '<div id="128"><svg><style><img/src=x onerror=alert(128)// ' +
          '</b>//["\'`-->]]>]</div>',
        expected: [0, 5],
      },
      {
        ...
        payload:
          '<div id="129"><svg><image style=\'filter:url("data:image/sv' +
      ...
      },
      {
        ...
        payload:
          '<svg></p><textarea><title><style></textarea><img src=x one' +
      ...
      },
      {
        ...
        payload:
          '<svg></p><title><a id="</title><img src=x onerror=alert()>' +
          '"></textarea></svg>',
        expected: [0, 4],
      },
      {
        ...
        payload:
          '<svg></p><title><template><style></title><img src=x onerro' +
          'r=alert(1)>',
        expected: [0, 4],
      },
      {
        ...
        payload:
          '<svg></p><math><title><style><img src=x onerror=alert(1)><' +
          '/style></title>',
        expected: [0, 4],
      },
      {
        ...
        payload:
          '<svg><p><style><g title="</style><img src=x onerror=alert(' +
          '1)>">',
        expected: [0, 5],
      },
      {
      ...
      },
      {
        ...
        payload:
          '<form><math><mtext></form><form><mglyph><svg><mtext><style' +
      ...
      },
      {
        ...
        payload:
          '<math><mtext><table><mglyph><svg><mtext><style><path id="<' +
    ...
    testCases.forEach((testCase, index) => {
      ...
      expect(testCaseResult.attrs.length).toEqual(
        testCase.expected[0],
        'Attributes - Case:' + testCase.title
      );
      expect(testCaseResult.tags.length).toEqual(
        testCase.expected[1],
        'Tags - Case:' + testCase.title
      );
    });
  });

  it(
    'should return correct GitHub issue URL when invalid Tags and attributes' +
