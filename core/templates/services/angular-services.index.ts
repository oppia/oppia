...
import { ExplorationEditsAllowedService } from 'pages/exploration-editor-page/services/exploration-edits-allowed.service';
...
export const angularServices: [string, Type<{}>][] = [
  ...
  ['ExplorationCorrectnessFeedbackService',
    ExplorationCorrectnessFeedbackService],
  ['ExplorationEditsAllowedService', ExplorationEditsAllowedService],
