...
export const angularServices: [string, Type<{}>][] = [
  ...
  ['ExplorationInitializationService', ExplorationInitializationService],
  ['ExplorationCreationService', ExplorationCreationService],
  [
  ...
  ['FeatureFlagDummyBackendApiService', FeatureFlagDummyBackendApiService],
  ...
  ['TutorialEventsBackendApiService', TutorialEventsBackendApiService],
