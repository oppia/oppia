...
describe('Voiceover contribution backend api service', () => {
  ...
  it('should successfully fetch data from the backend',
    fakeAsync(() => {
      ...
      voiceoverContributionBackendApiService.getVoiceoverContributionDataAsync()
  ...
  it('should make request to update voiceover contribution is enabled data',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
      let voiceoverContributionEnabled = true;
  ...
  it('should use reject hanlder while updating voiceover contribution data',
    fakeAsync(() => {
      let successHandler = jasmine.createSpy('success');
      let failHandler = jasmine.createSpy('fail');
      let voiceoverContributionEnabled = true;
