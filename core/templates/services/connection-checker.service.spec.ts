...
describe('Connection Service', () => {
  let connectionCheckerService: ConnectionCheckerService;
  ...
  beforeEach(() => {
    ...
    connectionCheckerService = TestBed.get(ConnectionCheckerService);
    httpTestingController = TestBed.get(HttpTestingController);
  });
  beforeEach(() => {
    connectionStateSpy = jasmine.createSpy('stateChange');
    subscriptions = new Subscription();
    subscriptions.add(connectionCheckerService.onInternetStateChange.subscribe(
      connectionStateSpy
    ));
  });
  ...
  it('should report internet status as online when internet is available',
    fakeAsync(() => {
      ...
      flushMicrotasks();
      var internetAccessible = connectionCheckerService.isOnline();
  ...
  it('should report internet status as online when reconnected after offline',
    fakeAsync(() => {
      ...
      connectionCheckerService['_connectedToNetwork'] = false;
