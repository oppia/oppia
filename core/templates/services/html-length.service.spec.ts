...
describe('Html Length Service', () => {
  ...
  it('should compute word count for strings with only paragraph tag', () => {
    const htmlString =
      '<p>Earth Our home planet is the third planet' + ' from the sun.</p>';
  ...
  it(
    'should compute word count for strings with paragraph tag and ' +
      'descendants text nodes',
    () => {
      const testCases = [
        {
          input:
            '<p><em>This is a brief exploration about conjugations' +
            ' in Spanish.</em></p>',
          expected: 9,
        },
        {
  ...
  it(
    ...
    () => {
      const htmlString =
        '<p>Hi this seems too good to be true but what' +
  ...
  it(
    'should compute word count of content with both text and non-text' +
      '(1 image tag)',
    () => {
      const htmlString =
  ...
  it(
    'should compute word count of content with text and all non-text' +
  ...
  it(
    'should compute character count for strings with paragraph tag and' +
      ' descendants text nodes',
    () => {
      const testCases = [
        {
  ...
  it(
    'should compute character count of content with text and non-text ' +
      '(1 math tag)',
    () => {
      const htmlString =
        '<p>Hi this seems too good to be true but what' +
  ...
  it(
    'should compute character count of content with both text and non-text' +
      '(1 image tag)',
    () => {
      const htmlString =
        '<p>naghiue abghy gjuh &nbsp;</p>' +
  ...
  it(
    'should compute character count of content with text and all non-text' +
      '(1 Collapsible, 1 Tabs, 1 Image, 1 Link, 1 Math, 1 SkillReview,' +
      ' 1 Video)',
    () => {
      const htmlString =
  ...
  describe('getLengthForNonTextNodes', () => {
    it(
      'should throw an error when unable to determine ' +
