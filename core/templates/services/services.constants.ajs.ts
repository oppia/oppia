...
angular
  .module('oppia')
  .constant('PAGE_CONTEXT', ServicesConstants.PAGE_CONTEXT);
...
angular
  .module('oppia')
  .constant('FETCH_ISSUES_URL', ServicesConstants.FETCH_ISSUES_URL);

angular
  .module('oppia')
  .constant('FETCH_PLAYTHROUGH_URL', ServicesConstants.FETCH_PLAYTHROUGH_URL);

angular
  .module('oppia')
  .constant('RESOLVE_ISSUE_URL', ServicesConstants.RESOLVE_ISSUE_URL);

angular
  .module('oppia')
  .constant('STORE_PLAYTHROUGH_URL', ServicesConstants.STORE_PLAYTHROUGH_URL);
...
angular
  .module('oppia')
  .constant('ENABLE_PROMO_BAR', ServicesConstants.ENABLE_PROMO_BAR);

angular
  .module('oppia')
  .constant('RTE_COMPONENT_SPECS', ServicesConstants.RTE_COMPONENT_SPECS);

angular
  .module('oppia')
  .constant('SEARCH_DATA_URL', ServicesConstants.SEARCH_DATA_URL);

angular
  .module('oppia')
  .constant('STATE_ANSWER_STATS_URL', ServicesConstants.STATE_ANSWER_STATS_URL);
