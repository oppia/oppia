...
angular
  .module('oppia')
  .constant('DEFAULT_TRANSLATIONS', AppConstants.DEFAULT_TRANSLATIONS);
...
angular
  .module('oppia')
  .constant('STATE_ERROR_MESSAGES', AppConstants.STATE_ERROR_MESSAGES);

angular
  .module('oppia')
  .constant(
    'CHECKPOINT_ERROR_MESSAGES',
    AppConstants.CHECKPOINT_ERROR_MESSAGES
  );
...
angular
  .module('oppia')
  .constant('PLACEHOLDER_OUTCOME_DEST', AppConstants.PLACEHOLDER_OUTCOME_DEST);
angular
  .module('oppia')
  .constant(
...
angular
  .module('oppia')
  .constant('LOADING_INDICATOR_URL', AppConstants.LOADING_INDICATOR_URL);
angular
  .module('oppia')
...
angular
  .module('oppia')
  .constant('PARAMETER_TYPES', AppConstants.PARAMETER_TYPES);

// The maximum number of nodes to show in a row of the state graph.
angular
  .module('oppia')
  .constant('MAX_NODES_PER_ROW', AppConstants.MAX_NODES_PER_ROW);
...
angular
  .module('oppia')
  .constant('MAX_NODE_LABEL_LENGTH', AppConstants.MAX_NODE_LABEL_LENGTH);

// If an $http request fails with the following error codes, a warning is
// displayed.
angular
  .module('oppia')
  .constant('FATAL_ERROR_CODES', AppConstants.FATAL_ERROR_CODES);

// Do not modify these, for backwards-compatibility reasons.
angular
  .module('oppia')
  .constant('COMPONENT_NAME_CONTENT', AppConstants.COMPONENT_NAME_CONTENT);
angular
  .module('oppia')
  .constant('COMPONENT_NAME_FEEDBACK', AppConstants.COMPONENT_NAME_FEEDBACK);
angular
  .module('oppia')
  .constant('COMPONENT_NAME_HINT', AppConstants.COMPONENT_NAME_HINT);
angular
  .module('oppia')
  .constant(
...
angular
  .module('oppia')
  .constant('COMPONENT_NAME_SOLUTION', AppConstants.COMPONENT_NAME_SOLUTION);
angular
  .module('oppia')
  .constant(
...
angular
  .module('oppia')
  .constant('ISSUE_TYPE_EARLY_QUIT', AppConstants.ISSUE_TYPE_EARLY_QUIT);
angular
  .module('oppia')
  .constant(
...
angular
  .module('oppia')
  .constant('LABEL_FOR_CLEARING_FOCUS', AppConstants.LABEL_FOR_CLEARING_FOCUS);
