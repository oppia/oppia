...
describe('Smart router link directive', () => {
  ...
  it('should navigate without refreshing inside normal router', fakeAsync(() => {
  ...
  it('should navigate by refreshing from lightweight router to normal router', fakeAsync(() => {
  ...
  it('should navigate by refreshing from normal router to lightweight router', fakeAsync(() => {
  ...
  it('should navigate without refreshing inside lightweight router', fakeAsync(() => {
