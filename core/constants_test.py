...
>>>>>>> c57168ee4017bf92ee49adc70dd236656aacc3b1:core/constants_test.py
    ...
    def test_all_comments_are_removed_from_json_text(self) -> None:
        ...
        with open(dummy_constants_filepath, 'r') as f: # type: ignore[no-untyped-call]
