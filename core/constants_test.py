...
class ConstantsTests(test_utils.GenericTestBase):
    ...
    def test_loading_non_existing_file_throws_error(self) -> None:
        ...
        with self.swap_to_always_raise(
            pkgutil,
            'get_data',
            FileNotFoundError('No such file or directory: \'assets/non_exist.xy\''),
        ):
    ...
    def test_loading_binary_file_returns_the_content(self) -> None:
        ...
        default_image_path = os.path.join('images', 'avatar', 'user_blue_150px.png')
        self.assertEqual(
            constants.get_package_file_contents(
    ...
    def test_constants_and_feconf_are_consistent(self) -> None:
        ...
        constants.js.
        """
        self.assertIn(feconf.MIGRATION_BOT_USER_ID, constants.constants.SYSTEM_USER_IDS)
        self.assertIn(feconf.SYSTEM_COMMITTER_ID, constants.constants.SYSTEM_USER_IDS)
    ...
    def test_language_constants_are_in_sync(self) -> None:
        ...
        conflicts = list(set(rtl_content_languages) & set(ltr_audio_languages)) + list(
