...
class FeatureNames(enum.Enum):
    ...
    # A separate flag is used for testing the campaign banner with early dates.
    ...
    ENABLE_CAMPAIGN_BANNER_TEST_MODE = 'enable_campaign_banner_test_mode'
...
TEST_FEATURES_LIST: List[FeatureNames] = [
    ...
    FeatureNames.ENABLE_CAMPAIGN_BANNER_TEST_MODE,
]
...
FEATURE_FLAG_NAME_TO_DESCRIPTION_AND_FEATURE_STAGE = {
    ...
    FeatureNames.ENABLE_CAMPAIGN_BANNER_TEST_MODE.value: (
        (
            'This flag enables the campaign banner for the fundraising campaign in test mode.',
            feature_flag_domain.ServerMode.TEST,
        )
    ),
}
