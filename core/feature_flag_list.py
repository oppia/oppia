...
DEV_FEATURES_LIST = [
    ...
    FeatureNames.SHOW_REDESIGNED_LEARNER_DASHBOARD, FeatureNames.SHOW_TRANSLATION_SIZE,
    FeatureNames.NEW_LESSON_PLAYER, FeatureNames.REDESIGNED_TOPIC_VIEWER_PAGE,
...
PROD_FEATURES_LIST: List[FeatureNames] = [
    FeatureNames.DUMMY_FEATURE_FLAG_FOR_E2E_TESTS, FeatureNames.END_CHAPTER_CELEBRATION,
    FeatureNames.CHECKPOINT_CELEBRATION, FeatureNames.IS_IMPROVEMENTS_TAB_ENABLED,
    FeatureNames.LEARNER_GROUPS_ARE_ENABLED, FeatureNames.ENABLE_VOICEOVER_CONTRIBUTION,
    FeatureNames.AUTO_UPDATE_EXP_VOICE_ARTIST_LINK,
    FeatureNames.ADD_VOICEOVER_WITH_ACCENT, FeatureNames.DIAGNOSTIC_TEST,
...
FEATURE_FLAG_NAME_TO_DESCRIPTION_AND_FEATURE_STAGE = {
    ...
    FeatureNames.SERIAL_CHAPTER_LAUNCH_CURRICULUM_ADMIN_VIEW.value: ((
        ...
        'only in the curriculum admin view.', feature_flag_domain.ServerMode.TEST
    )),
    FeatureNames.SERIAL_CHAPTER_LAUNCH_LEARNER_VIEW.value: ((
        'This flag is for serial chapter launch feature and making changes '
        'only in the learner view.', feature_flag_domain.ServerMode.TEST
    )),
    ...
    FeatureNames.SHOW_TRANSLATION_SIZE.value: ((
        ...
        'contributor dashboard.', feature_flag_domain.ServerMode.DEV
    )),
    FeatureNames.SHOW_FEEDBACK_UPDATES_IN_PROFILE_PIC_DROPDOWN.value: ((
        'This flag is to show feedback updates in the '
        'profile pic drop-down menu.', feature_flag_domain.ServerMode.DEV
    )),
    ...
    FeatureNames.IS_IMPROVEMENTS_TAB_ENABLED.value: ((
        ...
        'editor.', feature_flag_domain.ServerMode.PROD
    )),
    ...
    FeatureNames.ADD_VOICEOVER_WITH_ACCENT.value: ((
        ...
        'accent for the given language.', feature_flag_domain.ServerMode.PROD
    )),
    ...
    FeatureNames.ENABLE_VOICEOVER_CONTRIBUTION.value: ((
        ...
        'disabled during voiceover migration.', feature_flag_domain.ServerMode.PROD
    )),
    FeatureNames.AUTO_UPDATE_EXP_VOICE_ARTIST_LINK.value: ((
        'The flag allows auto-updating of the exploration voice artists '
        'link model after an exploration update.', feature_flag_domain.ServerMode.PROD
    )),
    FeatureNames.EXPLORATION_EDITOR_CAN_MODIFY_TRANSLATIONS.value: ((
        ...
        'editor page.', feature_flag_domain.ServerMode.PROD
    )),
    FeatureNames.EXPLORATION_EDITOR_CAN_TAG_MISCONCEPTIONS.value: ((
        ...
        'for a curated exploration.', feature_flag_domain.ServerMode.PROD
    )),
