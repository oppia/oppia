...
from core import android_validation_constants, constants
...
class AndroidValidationConstantsTest(test_utils.GenericTestBase):
    ...
    def test_exploration_constants_in_both_files_are_equal(self) -> None:
        ...
        constants_interactions_list = (
            constants.constants.ALLOWED_EXPLORATION_IN_STORY_INTERACTION_CATEGORIES
        )
        constants_languages_list = (
            constants.constants.SUPPORTED_CONTENT_LANGUAGES_FOR_ANDROID
        )
        ...
        self.assertItemsEqual(
            constants.constants.VALID_RTE_COMPONENTS_FOR_ANDROID,
