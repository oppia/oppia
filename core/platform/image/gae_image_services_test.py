...
from core.platform.gae_image_services import gae_image_services
from core.tests import test_utils
from PIL import Image
from constants import constants

class GaeImagesServicesUnitTests(test_utils.GenericTestBase):
    """Tests for gae_memcache_services."""
    
    def setUp(self):
        with os.path.join(feconf.TESTS_DATA_DIR, 'test_image.jpg') as img_path:
    ...
    def test_dimensions(self):
        with self.swap(constants, 'DEV_MODE', False),
            height, width = get_image_dimensions(self.file_content)
