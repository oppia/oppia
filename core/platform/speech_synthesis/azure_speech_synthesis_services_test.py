...
class AzureSpeechSynthesisTests(test_utils.GenericTestBase):
    ...
    @mock.patch('core.platform.speech_synthesis.azure_speech_synthesis_services.WordBoundaryCollection')
    def test_regenerate_speech_from_text_success(
        ...
        ssml_text = azure_speech_synthesis_services.convert_plaintext_to_ssml_content(plaintext, language_accent_code)

        mock_audio_data = b'mock_audio_data'
        mock_speech_config_instance = mock_speech_config.return_value
        mock_speech_config_instance.set_speech_synthesis_output_format = mock.MagicMock()
        ...
        mock_speech_synthesis_result.reason = speechsdk.ResultReason.SynthesizingAudioCompleted
        (mock_speech_synthesizer_instance.speak_ssml_async.return_value.get.return_value) = mock_speech_synthesis_result
        ...
        with self.swap_api_key_secrets_return_secret:
            result_binary_data, result_audio_offsets, result_error = azure_speech_synthesis_services.regenerate_speech_from_text(plaintext, language_accent_code)

        (mock_speech_config_instance.set_speech_synthesis_output_format.assert_called_once_with(speechsdk.SpeechSynthesisOutputFormat.Audio24Khz160KBitRateMonoMp3))
        (mock_speech_synthesizer_instance.speak_ssml_async.assert_called_once_with(ssml_text))
    ...
    def test_raise_exception_when_azure_api_key_is_not_set(self) -> None:
        azure_exception = self.assertRaisesRegex(Exception, 'Azure TTS API key is not available.')

        plaintext = 'This is a test text'
        language_accent_code = 'en-US'

        with self.swap_api_key_secrets_return_none, azure_exception:
            azure_speech_synthesis_services.regenerate_speech_from_text(plaintext, language_accent_code)
    ...
    def test_regenerate_speech_from_text_failed_for_invalid_credentials(
        ...
        mock_error_details = 'WebSocket upgrade failed: Authentication error (401). Please check subscription information and region name. USP state: Sending. Received audio size: 0 bytes.'
    ...
    def test_regenerate_speech_from_text_failed(
        ...
        error_details = 'Azure speech synthesis failed becuase of `custom message`.'
        ...
        mock_speech_synthesis_result.cancellation_details = mock_cancellation_details
        (mock_speech_synthesizer_instance.speak_ssml_async.return_value.get.return_value) = mock_speech_synthesis_result
        mock_word_boundary_instance = mock.MagicMock()
        mock_word_boundaries: List[Dict[str, Union[str, float]]] = []
        mock_word_boundary_instance.audio_offset_list = mock_word_boundaries
    ...
    def test_regenerate_speech_from_text_failed_due_to_multiple_requests(
        ...
        error_details = 'WebSocket upgrade failed: Too many requests (429). Please check subscription information and region name. USP state: Sending. Received audio size: 0 bytes'
        mock_cancellation_details.reason = speechsdk.CancellationReason.Error
        mock_cancellation_details.error_details = error_details
        mock_cancellation_details.error_code = speechsdk.CancellationErrorCode.TooManyRequests
    ...
    def test_regenerate_speech_from_text_failed_due_to_end_of_stream(
        ...
        mock_cancellation_details.reason = speechsdk.CancellationReason.EndOfStream
    ...
    def test_regenerate_speech_from_text_failed_due_to_unknown_reason(
        ...
        error_details = 'Speech synthesis failed for reason: UnknownCancellationReason'
    ...
    def test_should_return_word_boundary_collection_correctly(self) -> None:
        word_boundary_collection = azure_speech_synthesis_services.WordBoundaryCollection()
    ...
    def _get_ssml_content(self, main_content: str, language_accent_code: str) -> str:
        ...
        Returns:
            ...
            code.
        """
        voice_code = azure_speech_synthesis_services.get_azure_voicecode_from_language_accent_code(language_accent_code)
        main_ssml_content = azure_speech_synthesis_services.MAIN_CONTENT_SSML_TEMPLATE_BLOCK % main_content
        return (azure_speech_synthesis_services.SSML_TEMPLATE_FOR_SPEECH_SYNTHESIS) % (language_accent_code, voice_code, main_ssml_content)
    ...
    def test_should_convert_plaintext_to_ssml_content_correctly(self) -> None:
        ...
        ssml_content = azure_speech_synthesis_services.convert_plaintext_to_ssml_content(plaintext, language_accent_code)
        self.assertEqual(
            ssml_content,
        ...
        expected_main_content = 'Find the value of 5 <say-as interpret-as="math">times</say-as> 3.'
        ...
        plaintext = 'Find the value of 5 - 3.'
        expected_main_content = 'Find the value of 5 <say-as interpret-as="math">minus</say-as> 3.'
        ...
        plaintext = 'Find the value of 5 + 3.'
        expected_main_content = 'Find the value of 5 <say-as interpret-as="math">plus</say-as> 3.'
        ...
        expected_main_content = 'Find the value of 15<say-as interpret-as="math">divided by</say-as>5.'
        ...
        expected_main_content = 'Find the value of 15x <say-as interpret-as="math">divided by</say-as> 5<say-as interpret-as="math">equals</say-as>3.'
        ...
        expected_main_content = '15 <say-as interpret-as="math">divided by</say-as> 5 is  dash .'
    ...
    def test_should_pronounce_correctly_for_superscripts(self) -> None:
        math_symbol_pronunciations = constants.LANGUAGE_CODE_TO_MATH_SYMBOL_PRONUNCIATIONS.get('en', {})

        content = 'x^2 + y^2 = z^3'
        expected_content_to_be_pronounced = 'x squared + y squared = z cubed'

        self.assertEqual(
            azure_speech_synthesis_services.process_superscript_in_text(content, math_symbol_pronunciations),
            expected_content_to_be_pronounced,
        )

        content = 'x² + 5 = z⁴'
        expected_content_to_be_pronounced = 'x squared + 5 = z to the power of 4'
