...
LANGUAGE_CODE_TO_VOICEOVER_FILENAMES = {
    'en': 'autogenerated_english_voiceover.mp3',
    'hi': 'autogenerated_hindi_voiceover.mp3',
    'ar': 'autogenerated_arabic_voiceover.mp3',
    'pt': 'autogenerated_portueguese_voiceover.mp3'
}
...
def regenerate_speech_from_text(
    ...
    if language_code not in LANGUAGE_CODE_TO_VOICEOVER_FILENAMES.keys():
