...
class RedisCacheServicesUnitTests(test_utils.TestBase):
    ...
    def setUp(self) -> None:
        super().setUp()
        redis_client_models.RedisClientModel.delete_by_id(
    ...
    def test_set_multi_sets_elements(self) -> None:
        ...
        self.assertFalse(redis_cache_services.set_multi(key_value_mapping))
    ...
    def test_delete_multi_deletes_cache_elements(self) -> None:
        self.assertEqual(
            redis_cache_services.delete_multi(['a4', 'b4', 'c4']), 0
        )
