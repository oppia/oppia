...
class RedisCacheServicesUnitTests(test_utils.TestBase):
    ...
    def test_flush_cache_wipes_cache_clean(self) -> None:
        ...
        redis_cache_services.flush_caches()
        self.assertEqual(
            redis_cache_services.get_multi(['a1', 'b1', 'c1']), [None, None, None]
        )

    def test_get_multi_retrieves_cache_elements(self) -> None:
        redis_cache_services.flush_caches()
        self.assertEqual(
            redis_cache_services.get_multi(['a2', 'b2', 'c2']), [None, None, None]
        )
    ...
    def test_delete_multi_deletes_cache_elements(self) -> None:
        ...
        self.assertEqual(
            redis_cache_services.get_multi(['a4', 'b4', 'c4']), [None, None, None]
        )
    ...
    def test_partial_fetches_returns_reasonable_output(self) -> None:
        redis_cache_services.flush_caches()
        self.assertEqual(
            redis_cache_services.get_multi(['a5', 'b5', 'c5']), [None, None, None]
        )
        ...
        self.assertEqual(
            redis_cache_services.get_multi(['a5', 'z5', 'd5']), ['1', None, None]
        )
        self.assertEqual(
            redis_cache_services.get_multi(['x5', 'b5', 'd5']), [None, '2', None]
        )
    ...
    def test_partial_deletes_deletes_correct_elements(self) -> None:
        ...
        self.assertEqual(
            redis_cache_services.get_multi(['a6', 'b6', 'c6']), [None, '2', '3']
        )
