...
NAMES = python_utils.create_enum(
    ...
    'blog_post', 'classifier', 'collection', 'config', 'email', 'exploration',
...
MODULES_WITH_PSEUDONYMIZABLE_CLASSES = (  # pylint: disable=invalid-name
    NAMES.app_feedback_report, NAMES.blog_post, NAMES.collection, NAMES.config,
...
class _Gae(Platform):
    ...
    def import_models(cls, model_names):
        ...
        for name in model_names:
            ...
            elif name == NAMES.blog_post:
                from core.storage.blog_post import gae_models as blog_post_models # pylint: disable=line-too-long
                returned_models.append(blog_post_models)
