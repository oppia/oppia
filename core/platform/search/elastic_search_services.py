    ...
    if query_string.strip() == '':
        ...
        query_definition['query']['bool']['must'].append({
            'multi_match': {
                ...
                # It will first try to match with the title, then the category,
                ...
                # 'fuzziness' is used to allow for minor misspellings or typos
                # in the search query. The 'AUTO' setting lets Elasticsearch
