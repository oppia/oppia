...
class CronJobTests(test_utils.GenericTestBase):
    ...
    def test_run_cron_to_scrub_app_feedback_reports_scrubs_reports(self) -> None:
        ...
        self.assertEqual(
            scrubbed_model.scrubbed_by, feconf.APP_FEEDBACK_REPORT_SCRUBBER_BOT_ID
        )
...
class CronMailReviewerNewSuggestionsHandlerTests(test_utils.GenericTestBase):
    ...
    def test_email_not_sent_if_sending_reviewer_emails_is_not_enabled(
        ...
        with mock.patch.object(
            ...
            with self.testapp_swap:
                self.get_json(
                    '/cron/mail/reviewers/new_cont' 'ributor_dashboard_suggestions'
                )
    ...
    def test_email_not_sent_if_sending_emails_is_not_enabled(self) -> None:
        ...
        with mock.patch.object(
            ...
            with self.testapp_swap:
                self.get_json(
                    '/cron/mail/reviewers/new_contr' 'ibutor_dashboard_suggestions'
                )
            ...
            with self.swap(
                ...
                with self.swap(
                    ...
                    with self.swap(
                        ...
                        self.get_json(
                            '/cron/mail/admins/contributor_dashboard' '_bottlenecks'
                        )
...
class CronMailChapterPublicationsNotificationsHandlerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.story_publication_timeliness_1 = story_domain.StoryPublicationTimeliness(
            'story_1', 'Story', 'Topic', ['Chapter 1'], ['Chapter 2']
        )
        self.story_publication_timeliness_2 = story_domain.StoryPublicationTimeliness(
    ...
    def _mock_get_chapter_notifications_stories_list(
        ...
        chapter_notifications_stories_list: List[
            story_domain.StoryPublicationTimeliness
        ] = [self.story_publication_timeliness_1, self.story_publication_timeliness_2]
    ...
    def test_email_sent_if_sending_emails_is_enabled(self) -> None:
        ...
        self.assertEqual(
            self.chapter_notifications_list[0], self.story_publication_timeliness_1
        )
        self.assertEqual(
            self.chapter_notifications_list[1], self.story_publication_timeliness_2
        )
