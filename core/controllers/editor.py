...
class ExplorationHandler(
    base.BaseHandler[
        ExplorationHandlerNormalizedPayloadDict, ExplorationHandlerNormalizedRequestDict
    ]
):
...
class ExplorationRightsHandler(
    ...
    HANDLER_ARGS_SCHEMAS = {
        'PUT': {
            ...
            'viewable_if_private': {'schema': {'type': 'bool'}, 'default_value': None},
        },
...
class ExplorationStatusHandler(
    ...
    URL_PATH_ARGS_SCHEMAS = {'exploration_id': {'schema': SCHEMA_FOR_EXPLORATION_ID}}
    HANDLER_ARGS_SCHEMAS = {
        'PUT': {'make_public': {'schema': {'type': 'bool'}, 'default_value': False}}
    }
...
class UserExplorationEmailsHandler(
    ...
    def put(self, exploration_id: str) -> None:
        ...
        self.render_json({'email_preferences': exploration_email_preferences.to_dict()})
...
class ImageUploadHandler(
    base.BaseHandler[
        ImageUploadHandlerNormalizedPayloadDict, ImageUploadHandlerNormalizedRequestDict
    ]
):
    ...
    HANDLER_ARGS_SCHEMAS = {
        'POST': {
            ...
            'filename_prefix': {
                'schema': {'type': 'basestring', 'choices': ['thumbnail', 'image']},
