...
class VoiceoverAdminPageHandlerTests(test_utils.GenericTestBase):
    ...
    def test_get_voiceover_admin_data(self) -> None:
        ...
        self.assertDictEqual(json_response['language_codes_mapping'], language_codes_mapping)
...
class VoiceoverLanguageCodesMappingHandlerTests(test_utils.GenericTestBase):
    ...
    def test_put_language_accent_codes_mapping_correctly(self) -> None:
        ...
        initial_language_codes_mapping: Dict[str, Dict[str, bool]] = voiceover_services.get_all_language_accent_codes_for_voiceovers()
    ...
    def test_invalid_language_accent_codes_mapping_raise_error(self) -> None:
        ...
        self.assertEqual(
            response_dict['error'],
            'At \'http://localhost/voiceover_language_codes_mapping\' these errors are happening:\nSchema validation for \'language_codes_mapping\' failed: Expected dict, received en-US',
        )
...
class EntityVoiceoversBulkHandlerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.entity_voiceovers_1 = voiceover_domain.EntityVoiceovers(
            ...
            voiceovers_mapping={
                'content_id_0': {
                    feconf.VoiceoverType.MANUAL.value: (state_domain.Voiceover.from_dict(self.manual_voiceover_dict_1)),
                    feconf.VoiceoverType.AUTO.value: (state_domain.Voiceover.from_dict(self.autogenerated_voiceover_dict_1)),
                }
            },
        ...
        self.entity_voiceovers_2 = voiceover_domain.EntityVoiceovers(
            ...
            voiceovers_mapping={
                'content_id_0': {
                    feconf.VoiceoverType.MANUAL.value: (state_domain.Voiceover.from_dict(self.manual_voiceover_dict_1)),
                    feconf.VoiceoverType.AUTO.value: (state_domain.Voiceover.from_dict(self.autogenerated_voiceover_dict_2)),
                }
            },
            automated_voiceovers_audio_offsets_msecs={},
        )

        entity_voiceover_model_1 = voiceover_services.create_entity_voiceovers_model(self.entity_voiceovers_1)
        entity_voiceover_model_1.put()

        entity_voiceover_model_2 = voiceover_services.create_entity_voiceovers_model(self.entity_voiceovers_2)
...
class RegenerateAutomaticVoiceoverHandlerTests(test_utils.GenericTestBase):
    ...
    def test_should_be_able_to_regenerate_voiceovers(self) -> None:
        ...
        response_dict = self.put_json(handler_url, payload, csrf_token=csrf_token)
...
class RegenerateVoiceoverOnExpUpdateHandlerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.exploration = self.save_new_valid_exploration('exp_id', self.owner_id, title='Exploration 1')
        rights_manager.publish_exploration(self.owner, self.exploration.id)
        rights_manager.assign_role_for_exploration(
            self.voiceover_admin,
            self.exploration.id,
    ...
    def test_should_be_able_to_regenerate_voiceovers(self) -> None:
        ...
        expected_func_name = feconf.FUNCTION_ID_TO_FUNCTION_NAME_FOR_DEFERRED_JOBS['FUNCTION_ID_REGENERATE_VOICEOVERS_ON_EXP_UPDATE']
...
class AutomaticVoiceoverRegenerationRecordHandlerTests(test_utils.GenericTestBase):
    ...
    def test_get_automatic_voiceover_regeneration_records(self) -> None:
        ...
        start_date = cloud_task_run.created_on.replace(tzinfo=datetime.timezone.utc).isoformat()
        end_date = (cloud_task_run.created_on + datetime.timedelta(days=1)).replace(tzinfo=datetime.timezone.utc).isoformat()
...
class AutomaticVoiceoverRegenerationStatusHandlerTests(test_utils.GenericTestBase):
    ...
    def test_get_automatic_voiceover_regeneration_status(self) -> None:
        ...
        exploration_id = 'exploration_id'
        language_accent_to_content_status_map = {'en-US': {'content_0': 'SUCCEEDED', 'content_1': 'SUCCEEDED'}}
        ...
        voiceover_cloud_task_services.save_voiceover_regeneration_task_run_mapping(voiceover_regeneration_task_mapping)
        exploration = exp_domain.Exploration.create_default_exploration(exploration_id)
        exp_services.save_new_exploration(self.owner_id, exploration)
        rights_manager.publish_exploration(self.owner, exploration_id)

        json_response = self.get_json('/exploration_voiceover_regeneration_status_url/%s' % exploration_id)
        self.assertEqual(
...
class AutomaticVoiceoverRegenerationIntegrationTests(test_utils.GenericTestBase):
    ...
    def _add_exploration_to_published_topic(self) -> None:
        ...
        topic = topic_domain.Topic.create_default_topic(self.TOPIC_ID_1, 'topic1', 'abbrev', 'description', 'fragm')
    ...
    def test_regenerate_voiceovers_on_exploration_added_to_topic(self) -> None:
        entity_voiceovers = voiceover_services.get_entity_voiceovers_for_given_exploration(self.exploration_id, 'exploration', 2)
        ...
        automatic_voiceover_1 = entity_voiceovers[0].voiceovers_mapping['content_0']['auto']
        manual_voiceover_1 = entity_voiceovers[0].voiceovers_mapping['content_0']['manual']
        automatic_voiceover_2 = entity_voiceovers[0].voiceovers_mapping['content_3']['auto']
        manual_voiceover_2 = entity_voiceovers[0].voiceovers_mapping['content_3']['manual']
    ...
    def test_regenerate_voiceovers_on_exploration_update(self) -> None:
        ...
        entity_voiceovers = voiceover_services.get_entity_voiceovers_for_given_exploration(self.exploration_id, 'exploration', 3)
    ...
    def test_regenerate_voiceovers_on_translation_addition(self) -> None:
        ...
        entity_voiceovers = sorted(
            voiceover_services.get_entity_voiceovers_for_given_exploration(self.exploration_id, 'exploration', 3),
    ...
    def test_regenerate_voiceovers_on_translation_suggestion_acceptance(
        ...
        entity_voiceovers_list = voiceover_services.get_entity_voiceovers_for_given_exploration(self.exploration_id, 'exploration', 2)
        ...
        suggestion_to_accept = self.get_json('%s?author_id=%s' % (feconf.SUGGESTION_LIST_URL_PREFIX, self.voiceover_admin_id))['suggestions'][0]
        ...
        entity_voiceovers = voiceover_services.get_entity_voiceovers_for_given_exploration(self.exploration_id, 'exploration', 2)[0]

        self.assertEqual(entity_voiceovers.language_accent_code, 'hi-IN')
        self.assertEqual(entity_voiceovers.entity_version, 2)
        self.assertListEqual(['content_0'], list(entity_voiceovers.voiceovers_mapping.keys()))
    ...
    def test_should_not_regenerate_voiceovers_on_translation_suggestion_rejection(
        ...
        suggestion_to_reject = self.get_json('%s?author_id=%s' % (feconf.SUGGESTION_LIST_URL_PREFIX, self.voiceover_admin_id))['suggestions'][0]
...
class ExplorationDataForVoiceoverRegenerationHandlerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self._create_and_publish_exploration(self.curated_exp_id, curated_exp_title)
        ...
        # Creating an exploration and assigning roles.
        self._create_and_publish_exploration(self.non_curated_exp_id, non_curated_exp_title)
        rights_manager.assign_role_for_exploration(
            self.voiceover_admin,
            self.curated_exp_id,
            self.voiceover_admin_id,
    ...
    def _create_and_publish_exploration(self, exploration_id: str, title: str) -> None:
        """Creates and publishes a new exploration."""
        self.exploration = self.save_new_valid_exploration(
            exploration_id,
            self.owner_id,
...
class RegenerateVoiceoversForExplorationHandlerTests(test_utils.GenericTestBase):
    def mock_defer(
        self,
        _function_id: str,
        _queue_id: str,
