...
class BlogDashboardDataHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    def get(self) -> None:
        ...
        if published_post_summaries:
            ...
            published_post_summary_dicts = _get_blog_card_summary_dicts_for_dashboard(
                published_post_summaries
            )
        ...
        if draft_blog_post_summaries:
            ...
            draft_blog_post_summary_dicts = _get_blog_card_summary_dicts_for_dashboard(
                draft_blog_post_summaries
            )
        self.values.update(
            {
...
class BlogPostHandler(
    base.BaseHandler[
        BlogPostHandlerNormalizedPayloadDict, BlogPostHandlerNormalizedRequestDict
    ]
):
