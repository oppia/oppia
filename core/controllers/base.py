...
def _clear_login_cookies(response_headers):
    ...
    Args:
        response_headers: RequestHandler. The given response headers
    """
...
class BaseHandler(webapp2.RequestHandler):
    ...
    def get(self, *args, **kwargs):  # pylint: disable=unused-argument
        ...
        Raises:
            PageNotFoundException: No page found to handle GET requests.
        """
    ...
    def post(self, *args):  # pylint: disable=unused-argument
        ...
        Raises:
            PageNotFoundException: No page found to handle POST requests.
        """
        raise self.PageNotFoundException
    ...
    def put(self, *args):  # pylint: disable=unused-argument
        ...
        Raises:
            PageNotFoundException: No page found to handle PUT requests.
        """
        raise self.PageNotFoundException
    ...
    def delete(self, *args):  # pylint: disable=unused-argument
        ...
        Raises:
            PageNotFoundException: No page found to handle DELETE requests.
        """
        raise self.PageNotFoundException
