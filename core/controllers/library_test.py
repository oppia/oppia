...
class LibraryPageTests(test_utils.GenericTestBase):
    ...
    def test_library_handler_for_collection_summaries(self) -> None:
        ...
        self.save_new_default_collection(
            self.COL_ID_0, owner_id, title='Bridges in England', category='Architecture'
        )
        self.save_new_default_collection(
    ...
    def test_library_handler_demo_exploration(self) -> None:
        ...
        self.assertEqual(
            {'is_super_admin': False, 'activity_list': [], 'search_cursor': None},
            response_dict,
        )
    ...
    def test_library_handler_with_invalid_category(self) -> None:
        response_1 = self.get_json(
            feconf.LIBRARY_SEARCH_DATA_URL,
            params={'category': 'missing-outer-parens', 'language_code': '("en")'},
        ...
        response_2 = self.get_json(
            feconf.LIBRARY_SEARCH_DATA_URL,
            params={'category': '(missing-inner-quotes)', 'language_code': '("en")'},
            expected_status_int=400,
        )
...
class LibraryIndexHandlerTests(test_utils.GenericTestBase):
    ...
    def test_library_index_handler_for_user_preferred_language(self) -> None:
        ...
        self.put_json(
            ...
            {'updates': [{'update_type': 'preferred_language_codes', 'data': ['de']}]},
...
class ExplorationSummariesHandlerTests(test_utils.GenericTestBase):
    ...
    def test_handler_with_invalid_stringified_exp_ids_raises_error_404(self) -> None:
        ...
        self.get_json(
            feconf.EXPLORATION_SUMMARIES_DATA_URL,
            params={'stringified_exp_ids': json.dumps(self.PRIVATE_EXP_ID_EDITOR)},
