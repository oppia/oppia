...
class SubtopicMasteryDataHandlerTest(test_utils.GenericTestBase):
    ...
    def test_get_with_valid_topic_ids(self) -> None:
        ...
        self.save_new_topic(
            ...
            uncategorized_skill_ids=[self.skill_id_1, self.skill_id_2, self.skill_id_3],
            subtopics=[],
            next_subtopic_id=1,
        )
        self.save_new_topic(
            ...
            canonical_story_ids=[],
            additional_story_ids=[],
            uncategorized_skill_ids=[self.skill_id_3, self.skill_id_4, self.skill_id_5],
            subtopics=[],
            next_subtopic_id=1,
        )
        ...
        self.assertEqual(
            ...
            {topic_id_1: degrees_of_mastery_1, topic_id_2: degrees_of_mastery_2},
        )
