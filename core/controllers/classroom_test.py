...
class BaseClassroomControllerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.public_topic_1.thumbnail_bg_color = constants.ALLOWED_THUMBNAIL_BG_COLORS[
            'topic'
        ][0]
        ...
        self.public_topic_2.thumbnail_bg_color = constants.ALLOWED_THUMBNAIL_BG_COLORS[
            'topic'
        ][0]
        ...
        self.public_topic_3.thumbnail_bg_color = constants.ALLOWED_THUMBNAIL_BG_COLORS[
            'topic'
        ][0]
...
class ClassroomAdminTests(BaseClassroomControllerTests):
    ...
    def test_update_classroom_data(self) -> None:
        ...
        params = {
            'payload': json.dumps({'classroom_dict': self.physics_classroom_dict})
        }
...
class AllClassroomsSummaryHandlerTests(test_utils.GenericTestBase):
    ...
    def test_get_all_classrooms_summary(self) -> None:
        ...
        sort_key: Callable[[Dict[str, str | bool]], str | bool] = lambda item: item[
            'name'
        ]
...
class TopicsToClassroomsRelationHandlerTests(BaseClassroomControllerTests):
    ...
    def test_get_all_topics_classroom_info(self) -> None:
        ...
        sort_key: Callable[[Dict[str, Union[str, None]]], str] = (
            lambda item: item['topic_name'] or ''
        )
        self.assertListEqual(
