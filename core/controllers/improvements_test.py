...
class ExplorationImprovementsHandlerTests(ImprovementsTestBase):
    ...
    def test_post_with_missing_issue_description_is_allowed(self) -> None:
        ...
        task_id = improvements_models.ExplorationStatsTaskEntryModel.generate_task_id(
            constants.TASK_ENTITY_TYPE_EXPLORATION,
            self.exp.id,
            self.exp.version,
        ...
        task_entry_model = improvements_models.ExplorationStatsTaskEntryModel.get(
            task_id
        )
    ...
    def test_to_dict_with_non_existing_resolver_id(self) -> None:
        ...
        task_entry_dict = improvements.get_task_dict_with_username_and_profile_picture(
            task_entry
        )
        self.assertEqual(
            task_entry_dict,
