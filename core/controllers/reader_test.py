...
class QuestionsUnitTest(test_utils.GenericTestBase):
    ...
    def test_questions_are_returned_successfully(self):
        # Call the handler.
        url = '%s?question_count=%s&skill_ids=%s&fetch_by_mastery=%s' % (
    ...
    def test_multiple_skill_id_returns_questions(self):
        ...
        url = '%s?question_count=%s&skill_ids=%s,%s&fetch_by_mastery=%s' % (
    ...
    def test_invalid_fetch_by_mastery_raises_invalid_input_exception(self):
        # Call the handler.
        url = '%s?question_count=%s&skill_ids=%s&fetch_by_mastery=%s' % (
