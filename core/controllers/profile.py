    ...
    def put(self) -> None:
        ...
        for update in updates:
            ...
            if update_type == 'subject_interests':
                ...
                if missing_keys:
                    raise self.InvalidInputException(
                        'Expected data dict to have all the required keys. Missing keys: %s .'
                        % ', '.join(missing_keys)
                    )
                ...
                if non_boolean_keys:
                    raise self.InvalidInputException(
                        'Expected all values of data to be booleans. Non-boolean values found for keys: %s .'
    ...
    def get(self) -> None:
        ...
        if re.search(feconf.USER_ID_REGEX, user_data_json_string):
            ...
            user_data_json_string = (
                'There was an error while exporting data. Please contact %s to export your data.'
                % platform_parameter_services.get_platform_parameter_value(
