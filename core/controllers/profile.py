...
class MailingListSubscriptionHandler(
    ...
    HANDLER_ARGS_SCHEMAS = {
        'PUT': {
            ...
            'name': {
                'schema': {'type': 'basestring', 'validators': [{'id': 'is_nonempty'}]},
                'default_value': None,
            },
            'tag': {
                'schema': {'type': 'basestring', 'validators': [{'id': 'is_nonempty'}]}
...
class SignupPage(base.BaseHandler[Dict[str, str], SignupPageNormalizedRequestDict]):
    ...
    URL_PATH_ARGS_SCHEMAS: Dict[str, str] = {}
    HANDLER_ARGS_SCHEMAS = {
        'GET': {'return_url': {'schema': {'type': 'basestring'}, 'default_value': None}}
    }
...
class SignupHandler(
    ...
    HANDLER_ARGS_SCHEMAS = {
        ...
        'POST': {
            ...
            'agreed_to_terms': {'schema': {'type': 'bool'}, 'default_value': False},
            'default_dashboard': {
                'schema': {
                    'type': 'basestring',
                    'choices': [
    ...
    def post(self) -> None:
        ...
        has_fully_registered_account = user_services.has_fully_registered_account(
            self.user_id
        )
