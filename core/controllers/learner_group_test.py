...
class LearnerGroupSearchLearnerHandlerTests(test_utils.GenericTestBase):
    ...
    def test_searching_user_to_add_being_the_owner(self) -> None:
        ...
        self.assertEqual(
            response['error'], 'You cannot invite yourself to the group'
        )
        self.logout()
    ...
    def test_searching_an_already_invited_user(self) -> None:
        ...
        self.assertEqual(
            response['error'],
            'User with username %s has been already invited to join the group'
...
class LearnerGroupSyllabusHandlerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        topic_services.save_new_topic(self.admin_id, topic)
        self.save_new_story(
            self.STORY_ID, self.admin_id, self.TOPIC_ID, 'Story test'
        )
        topic_services.add_canonical_story(
