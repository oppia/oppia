...
class CreateLearnerGroupHandlerTests(test_utils.GenericTestBase):
    ...
    def test_create_new_learner_group(self) -> None:
        ...
        payload = {
            ...
            'invited_learner_usernames': [self.USER1_USERNAME, self.USER2_USERNAME],
...
class LearnerGroupHandlerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.learner_group = learner_group_services.create_learner_group(
            ...
            [self.facilitator_id], [self.user_id_1], ['subtopic_id_1'], ['story_id_1']
        )
    ...
    def test_update_learner_group_as_facilitator(self) -> None:
        ...
        payload = {
            ...
            'group_description': 'Learner Group Description',
            'learner_usernames': [],
            'invited_learner_usernames': [self.USER2_USERNAME],
            'subtopic_page_ids': ['subtopic_id_1', 'subtopic_id_2'],
            'story_ids': ['story_id_1', 'story_id_2']
        }
    ...
    def test_update_learner_group_as_invalid_facilitator(self) -> None:
        ...
        self.assertEqual(
            response['error'], 'You are not a facilitator of this learner group.'
        )
...
class LearnerGroupSearchSyllabusHandlerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        learner_group_services.create_learner_group(
            ...
            [self.facilitator_id], [self.LEARNER_ID], ['subtopic_id_1'], ['story_id_1']
        )
        ...
        self.save_new_story(
            self.STORY_ID_0, self.admin_id, self.TOPIC_ID_0, 'Story test 0'
        )
        ...
        topic = topic_domain.Topic.create_default_topic(
            self.TOPIC_ID_1, 'Negative Numbers', 'abbrev-one', 'description 1', 'fragm'
        )
        topic.thumbnail_filename = 'thumbnail.svg'
        topic.thumbnail_bg_color = '#C6DCDA'
        topic.subtopics = [
        ...
        topic_services.save_new_topic(self.admin_id, topic)
        self.save_new_story(
            self.STORY_ID_1, self.admin_id, self.TOPIC_ID_1, 'Story test 1'
        )
        topic_services.add_canonical_story(
    ...
    def test_filter_learner_group_syllabus(self) -> None:
        ...
        response = self.get_json(
            '/learner_group_search_syllabus_handler', params=params
        )
...
class ViewLearnerGroupInfoHandlerTests(test_utils.GenericTestBase):
    ...
    def test_facilitators_view_details_as_facilitator(self) -> None:
        ...
        response = self.get_json(
            '/view_learner_group_info_handler/%s' % (self.learner_group_id)
        )
...
class LearnerGroupLearnerProgressHandlerTests(test_utils.GenericTestBase):
    ...
    def test_get_progress_of_learners(self) -> None:
        ...
        params = {
            'learner_usernames':
                json.dumps([self.LEARNER_1_USERNAME, self.LEARNER_2_USERNAME])
        }

        response = self.get_json(
            '/learner_group_user_progress_handler/%s' % (self.learner_group_id),
            params=params
        )
        ...
        expected_story_prog_summary = {
            ...
            'story_model_created_on': (story_prog_summary['story_model_created_on']),
    ...
    def test_get_progress_of_learners_with_invalid_group_id(self) -> None:
        ...
        self.get_json(
            '/learner_group_user_progress_handler/%s' % ('invalidId'),
            params=params,
            expected_status_int=400
        )
...
class LearnerGroupLearnerSpecificProgressHandlerTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        learner_group_services.create_learner_group(
            self.learner_group_id, 'Learner Group Name', 'Description',
            [self.facilitator_id], [self.LEARNER_ID_1], [self.SUBTOPIC_PAGE_ID_1],
            [self.STORY_ID_1]
        )
    ...
    def test_get_progress_of_learners_with_invalid_group_id(self) -> None:
        ...
        self.get_json(
            '/learner_group_learner_specific_progress_handler/%s' % ('invalidId'),
            expected_status_int=400
        )
...
class LearnerGroupSearchLearnerHandlerTests(test_utils.GenericTestBase):
    ...
    def test_searching_invalid_user(self) -> None:
        ...
        self.assertEqual(
            response['error'], 'User with username invalid_username does not exist.'
        )
        self.logout()
    ...
    def test_searching_an_already_invited_user(self) -> None:
        learner_group_services.create_learner_group(
            'groupId', 'Group Title', 'Group Description', [self.owner_id],
            [self.new_user_id], ['subtopic1'], []
        )
        params = {
...
class LearnerGroupLearnerInvitationHandlerTests(test_utils.GenericTestBase):
    ...
    def test_invitation_accepted_by_the_learner(self) -> None:
        ...
        response = self.put_json(
            '/learner_group_learner_invitation_handler/%s' % (self.learner_group_id),
            payload,
            csrf_token=csrf_token
        )
...
class LearnerStoriesChaptersProgressHandlerTests(test_utils.GenericTestBase):
    ...
    def test_get_learner_stories_chapters_progress(self) -> None:
        ...
        response = self.get_json(
            '/user_progress_in_stories_chapters_handler/%s' % (self.NEW_USER_USERNAME),
            params=params
        )
    ...
    def test_cannot_fetch_learner_stories_progress_with_invalid_username(self) -> None:
        ...
        response = self.get_json(
            '/user_progress_in_stories_chapters_handler/%s' % ('Invalid_username'),
            params=params,
            expected_status_int=500
        )
        self.assertEqual(
...
class LearnerDashboardLearnerGroupsHandlerTests(test_utils.GenericTestBase):
    ...
    def test_get_learner_dashboard_learner_groups_view(self) -> None:
        ...
        self.assertEqual(
            response['invited_to_learner_groups'][0]['id'], learner_group.group_id
        )
        ...
        self.assertEqual(
            response['learner_groups_joined'][0]['id'], learner_group.group_id
        )
...
class LearnerGroupProgressSharingPermissionHandlerTests(test_utils.GenericTestBase):
