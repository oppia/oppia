...
SAMPLE_EXPLORATION_DICT = exp_domain.ExplorationDict(
    {
        ...
        'states': {
            'Introduction': {
                ...
                'recorded_voiceovers': {'voiceovers_mapping': {'content_0': {}}},
...
class AdminHandler(base.BaseHandler[AdminHandlerNormalizePayloadDict, Dict[str, str]]):
    ...
    HANDLER_ARGS_SCHEMAS = {
        ...
        'POST': {
            ...
            'exploration_id': {'schema': {'type': 'basestring'}, 'default_value': None},
            'collection_id': {'schema': {'type': 'basestring'}, 'default_value': None},
            'num_dummy_exps_to_generate': {
                'schema': {'type': 'int'},
                'default_value': None,
            },
            'skill_id': {'schema': {'type': 'basestring'}, 'default_value': None},
            ...
            'topic_id': {'schema': {'type': 'basestring'}, 'default_value': None},
            'platform_param_name': {
                'schema': {'type': 'basestring'},
                'default_value': None,
            },
            'commit_message': {'schema': {'type': 'basestring'}, 'default_value': None},
            'new_rules': {
                'schema': {
                    'type': 'list',
                    'items': {
    ...
    def get(self) -> None:
        ...
        platform_params_dicts = [
            ...
            if (
                ...
                and param['name'] not in PLATFORM_PARAMS_TO_SHOW_IN_BLOG_ADMIN_PAGE
            )
        ]
    ...
    def post(self) -> None:
        ...
        try:
            ...
            if action == 'reload_exploration':
                ...
                num_dummy_question_suggestions_generate = self.normalized_payload.get(
                    'num_dummy_question_suggestions_generate'
                )
...
class AdminRoleHandler(
    ...
    HANDLER_ARGS_SCHEMAS = {
        'GET': {
            ...
            'username': {'schema': {'type': 'basestring'}, 'default_value': None},
        },
        'PUT': {
            'role': {
                'schema': {'type': 'basestring', 'choices': feconf.ALLOWED_USER_ROLES}
            },
...
class TopicManagerRoleHandler(
    ...
    HANDLER_ARGS_SCHEMAS = {
        'PUT': {
            'username': {'schema': {'type': 'basestring'}},
            'action': {
                'schema': {'type': 'basestring', 'choices': ['assign', 'deassign']}
            },
...
class BannedUsersHandler(
    base.BaseHandler[
        BannedUsersHandlerNormalizedPayloadDict, BannedUsersHandlerNormalizedRequestDict
    ]
):
...
class AutomaticVoiceoverAdminControlHandler(
    base.BaseHandler[
        AutomaticVoiceoverAdminControlHandlerNormalizedPayloadDict, Dict[str, str]
    ]
):
...
class SendDummyMailToAdminHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    def post(self) -> None:
        ...
        server_can_send_emails = parameter_services.get_platform_parameter_value(
