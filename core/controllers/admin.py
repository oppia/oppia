...
class AdminHandler(
    ...
    def _generate_dummy_classroom(self) -> None:
        ...
        if constants.DEV_MODE:
            ...
            topic_1.update_meta_tag_content('addition math topic')
            ...
            topic_2.update_meta_tag_content('subtraction math topic')
            ...
            topic_3.update_meta_tag_content('multiplication math topic')
            ...
            topic_4.update_meta_tag_content('division math topic')
            ...
            topic_5.update_meta_tag_content('fraction math topic')
