...
class ViewSkillsDecoratorTests(test_utils.GenericTestBase):
    ...
    def test_invalid_input_exception_with_invalid_skill_ids(self):
        ...
        # error_msg = (
        #     'At \'http://localhost/mock_view_skills/%5B\'abcd1234\'%5D\' '
        #     'these errors are happening:\nSchema validation '
        #     'for \'selected_skill_ids\' failed: \'validation_method\''
        # )
        # self.assertEqual(response['error'], error_msg)
    ...
    def test_page_not_found_exception_with_invalid_skill_ids(self):
        ...
        #     response = self.get_json(
        #         '/mock_view_skills',
        #         params= {'selected_skill_ids': skill_ids},
        #         expected_status_int=400,
        ...
        # print("\n\n\n\n")
        # error_msg = (
        #     'At \'http://localhost/mock_view_skills/%5B\'invalid_id12\'%5D\' '
        #     'these errors are happening:\nSchema validation '
        #     'for \'selected_skill_ids\' failed: \'validation_method\''
        # )
        # self.assertEqual(response['error'], error_msg)
...
class AccessTopicsAndSkillsDashboardDecoratorTests(test_utils.GenericTestBase):
    ...
    def setUp(self):
        ...
        self.mock_testapp = webtest.TestApp(webapp2.WSGIApplication(
            [webapp2.Route(
                '/mock_access_dashboard/<topic_id>', self.MockHandler)],
            debug=feconf.DEBUG,
        ))
        self.topic_id = topic_fetchers.get_new_topic_id()
        self.save_new_topic(
    ...
    def test_guest_user_cannot_access_dashboard(self):
        with self.swap(self, 'testapp', self.mock_testapp):
            response = self.get_json(
                '/mock_access_dashboard/%s' % self.topic_id, expected_status_int=401)
        error_msg = 'You must be logged in to access this resource.'
        self.assertEqual(response['error'], error_msg)
