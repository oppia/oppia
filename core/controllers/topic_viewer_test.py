...
class BaseTopicViewerControllerTests(test_utils.GenericTestBase):
    ...
    def setUp(self):
        ...
        self.topic.page_title = 'topic page title'
...
class TopicPageDataHandlerTests(
    ...
    def test_get_with_page_title(self):
        self.topic = topic_domain.Topic.create_default_topic(
            self.topic_id, 'topic_with_page_title',
        ...
        expected_page_title = 'topic page title'
        self.assertEqual(expected_page_title, json_response['page_title'])
