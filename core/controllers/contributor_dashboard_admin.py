...
def get_translation_coordinator_frontend_dict(
    ...
    for stats_dict in stats_dicts:
        ...
        # to TypedDict.
        stats_dict['translators_count'] = ( # type: ignore[typeddict-unknown-key]
        ...
        # Here we use MyPy ignore because MyPy doesn't allow key addition
        # to TypedDict.
        stats_dict['reviewers_count'] = ( # type: ignore[typeddict-unknown-key]
            community_stats.translation_reviewer_counts_by_lang_code[
                stats_dict['language_id']])
        ...
        # Here we use MyPy ignore because MyPy doesn't allow key addition
        # to TypedDict.
        stats_dict['coordinator_activity_list'] = coordinator_activity_list # type: ignore[typeddict-unknown-key]
