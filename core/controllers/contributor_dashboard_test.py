    ...
    def test_featured_translation_langs_are_present_in_supported_audio_langs(
        ...
        for language in featured_languages:
            self.assertIn(
                ...
                suported_audio_langs_codes,
                'We expect all the featured languages to be present in the SUPPORTED_AUDIO_LANGUAGES list present in constants.ts file, but the language with language code %s is not present in the list'
                % (language['language_code']),
            )
