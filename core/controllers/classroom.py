...
class UnusedTopicsHandler(base.BaseHandler[Dict[str, str], Dict[str, str]]):
    ...
    def get(self) -> None:
        ...
        topics_not_in_classroom = [
            topic.to_dict() for topic in all_topics if not any(
...
class ClassroomHandler(
    base.BaseHandler[ClassroomHandlerNormalizedPayloadDict,
...
class NewClassroomHandler(
    base.BaseHandler[NewClassroomDataHandlerNormalizedPayloadDict, Dict[str, str]]
):
...
class TopicsToClassroomsRelationHandler(
    ...
    def get(self) -> None:
        ...
        self.render_json({
            'topics_to_classrooms_relation': list(topics_classroom_info_dicts.values())
        })
    ...
    def get(self) -> None:
        ...
        self.render_json({
            'all_classrooms_summary':
                sorted(all_classrooms_summary_dicts, key=lambda x: int(x['index']))
        })
...
class UpdateClassroomIndexMappingHandler(
    base.BaseHandler[UpdateClassroomIndexMappingHandlerNormalizedPayloadDict, Dict[str,
                                                                                   str]]
):
            ...
            'classroom_index_mappings': {
                'schema': {
                    ...
                    'items': {
                        ...
                        'required': [
                            'classroom_id', 'classroom_name', 'classroom_index'
                        ]
                    }
                }
            }
