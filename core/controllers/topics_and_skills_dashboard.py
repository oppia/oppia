...
class SkillsDashboardPageDataHandler(
    ...
    HANDLER_ARGS_SCHEMAS = {
        'POST': {
            ...
            'next_cursor': {'schema': {'type': 'basestring'}, 'default_value': None},
...
class NewTopicHandler(
    base.BaseHandler[
        NewTopicHandlerNormalizedPayloadDict, NewTopicHandlerNormalizedRequestDict
    ]
):
    """Creates a new topic."""
...
class TopicIdToDiagnosticTestSkillIdsHandler(
    base.BaseHandler[
        Dict[str, str], TopicIdToDiagnosticTestSkillIdsHandlerNormalizedRequestDict
    ]
):
