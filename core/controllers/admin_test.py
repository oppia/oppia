...
class ExplorationsLatexSvgHandlerTest(test_utils.GenericTestBase):
    ...
    def test_get_latex_from_all_explorations(self):
        user_email = 'user1@example.com'
        username = 'user1'
        self.signup(user_email, username)
        self.login(self.ADMIN_EMAIL, is_super_admin=True)
        ...
        exp_services.save_new_exploration(editor_id, exploration2)
        ...
        state2.update_content(
            state_domain.SubtitledHtml.from_dict(content2_dict))
        exp_services.save_new_exploration(editor_id, exploration3)
        ...
        self.assertEqual(
            response_dict,
            {'all_explorations_latex_mapping': expected_response})
