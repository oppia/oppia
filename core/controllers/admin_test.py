...
class AdminIntegrationTest(test_utils.GenericTestBase):
    ...
    def test_without_redis_host_action_update_redis_host_is_not_performed(
        self,
    ) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
        ...
        with assert_raises_regexp_context_manager, self.prod_mode_swap:
            self.post_json(
                '/adminhandler',
                {'action': 'update_redis_host', 'redis_host': None},
                csrf_token=csrf_token,
            )
    ...
    def test_update_redis_host_action(self) -> None:
        ...
        self.post_json(
            '/adminhandler',
            {'action': 'update_redis_host', 'redis_host': 'test_host'},
            csrf_token=csrf_token,
        )
