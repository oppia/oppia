...
class AdminIntegrationTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        caching_services.delete_multi(
            caching_services.CACHE_NAMESPACE_PLATFORM_PARAMETER, None, ['test_param_1']
        )
    ...
    def _create_dummy_param(self) -> platform_parameter_domain.PlatformParameter:
    ...
    def test_without_num_dummy_exps_to_publish_action_is_not_performed(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
    ...
    def test_without_topic_id_action_regenerate_topic_is_not_performed(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
        ...
        with assert_raises_regexp_context_manager, self.prod_mode_swap:
            self.post_json(
                '/adminhandler',
                {'action': 'regenerate_topic_related_opportunities', 'topic_id': None},
                csrf_token=csrf_token,
            )

        self.logout()

    def test_without_exp_id_action_rollback_exploration_is_not_performed(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
        ...
        with assert_raises_regexp_context_manager, self.prod_mode_swap:
            self.post_json(
                '/adminhandler',
                {'action': 'rollback_exploration_to_safe_state', 'exp_id': None},
                csrf_token=csrf_token,
            )
    ...
    def test_without_new_rules_action_update_param_is_not_performed(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
    ...
    def test_without_commit_message_action_update_param_is_not_performed(self) -> None:
        new_rule_dicts = [
            {
    ...
    def test_load_new_structures_data(self) -> None:
        ...
        questions, _ = (
            question_fetchers.get_questions_and_skill_descriptions_by_skill_ids(
                10,
                [skill_summaries[0].id, skill_summaries[1].id, skill_summaries[2].id],
                0,
            )
        )
    ...
    def test_regenerate_topic_related_opportunities_action(self) -> None:
        ...
        result = self.post_json(
            '/adminhandler',
            {'action': 'regenerate_topic_related_opportunities', 'topic_id': 'topic'},
            csrf_token=csrf_token,
        )
    ...
    def test_upload_topic_similarities(self) -> None:
        ...
        self.post_json(
            '/adminhandler',
            {'action': 'upload_topic_similarities', 'data': topic_similarities_data},
            csrf_token=csrf_token,
        )
    ...
    def test_update_parameter_rules_with_unknown_param_name_raises_error(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
    ...
    def test_update_parameter_rules_with_unknown_data_type_returns_400(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
    ...
    def test_update_param_rules_with_rules_of_non_list_type_returns_400(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
    ...
    def test_update_param_rules_with_unexpected_exception_returns_500(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
        ...
        self.assertEqual(
            response['error'], '\'NoneType\' object has no attribute \'serialize\''
        )
    ...
    def test_grant_super_admin_privileges_requires_system_default_admin(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        ...
        self.assertEqual(
            response['error'], 'Only the default system admin can manage super admins'
        )
    ...
    def test_grant_super_admin_privileges_fails_with_invalid_username(self) -> None:
        self.login(feconf.ADMIN_EMAIL_ADDRESS, is_super_admin=True)
    ...
    def test_revoke_super_admin_privileges_requires_system_default_admin(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
    ...
    def test_revoke_super_admin_privileges_fails_with_invalid_username(self) -> None:
        self.login(feconf.ADMIN_EMAIL_ADDRESS, is_super_admin=True)
    ...
    def test_revoke_super_admin_privileges_fails_for_default_admin(self) -> None:
        self.login(feconf.ADMIN_EMAIL_ADDRESS, is_super_admin=True)
...
class GenerateDummyExplorationsTest(test_utils.GenericTestBase):
    ...
    def test_handler_raises_error_with_non_int_num_dummy_exps_to_generate(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
    ...
    def test_handler_raises_error_with_non_int_num_dummy_exps_to_publish(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        csrf_token = self.get_new_csrf_token()
...
class GenerateDummyQuestionSuggestionsTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.signup(
            self.QUESTION_ADMIN_EMAIL, self.QUESTION_ADMIN_USERNAME, is_super_admin=True
        )
...
class AdminRoleHandlerTest(test_utils.GenericTestBase):
    ...
    def test_view_and_update_role(self) -> None:
        ...
        response_dict = self.get_json(
            feconf.ADMIN_ROLE_HANDLER_URL,
            params={'filter_criterion': 'role', 'role': feconf.ROLE_ID_MODERATOR},
        )
        self.assertEqual(response_dict, {'usernames': ['user1']})
        self.logout()

    def test_if_filter_criterion_is_username_and_username_is_not_provided(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            self.get_json(
                feconf.ADMIN_ROLE_HANDLER_URL, params={'filter_criterion': 'username'}
            )
    ...
    def test_if_filter_criterion_is_role_and_role_is_not_provided(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            self.get_json(
                feconf.ADMIN_ROLE_HANDLER_URL, params={'filter_criterion': 'role'}
            )
    ...
    def test_replacing_user_role_from_topic_manager_to_moderator(self) -> None:
        ...
        self.assertEqual(
            response_dict,
            {
                'roles': [feconf.ROLE_ID_FULL_USER, feconf.ROLE_ID_TOPIC_MANAGER],
                'banned': False,
    ...
    def test_general_role_handler_supports_unassigning_topic_manager(self) -> None:
        user_email = 'user1@example.com'
        username = 'user1'
...
class TopicManagerRoleHandlerTest(test_utils.GenericTestBase):
    ...
    def test_adding_new_topic_manager_to_a_topic(self) -> None:
        ...
        response_dict = self.put_json(
            '/topicmanagerrolehandler',
            {'action': 'assign', 'username': username, 'topic_id': new_topic_id},
            csrf_token=csrf_token,
        )
...
class DataExtractionQueryHandlerTests(test_utils.GenericTestBase):
    ...
    def test_raises_error_if_no_state_answer_exists_while_data_extraction(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        payload = {
            'exp_id': self.EXP_ID,
            'exp_version': self.exploration.version,
    ...
    def test_handler_when_exp_version_is_not_int_throws_exception(self) -> None:
        ...
        response = self.get_json(
            '/explorationdataextractionhandler', params=payload, expected_status_int=400
        )
        self.assertEqual(response['error'], error_msg)
    ...
    def test_that_handler_raises_exception(self) -> None:
        ...
        self.assertEqual(
            response['error'], 'Exploration \'exp\' does not have \'state name\' state.'
        )
    ...
    def test_handler_raises_error_with_invalid_exploration_id(self) -> None:
        ...
        self.get_json(
            '/explorationdataextractionhandler', params=payload, expected_status_int=404
        )

    def test_handler_raises_error_with_invalid_exploration_version(self) -> None:
        self.login(self.CURRICULUM_ADMIN_EMAIL, is_super_admin=True)
        payload = {
            'exp_id': self.EXP_ID,
            'state_name': 'state name',
...
class ClearSearchIndexTest(test_utils.GenericTestBase):
    ...
    def test_clear_search_index(self) -> None:
        ...
        result_explorations = search_services.search_explorations('Welcome', [], [], 2)[
            0
        ]
        ...
        csrf_token = self.get_new_csrf_token()
        generated_exps_response = self.post_json(
            '/adminhandler', {'action': 'clear_search_index'}, csrf_token=csrf_token
        )
...
class SendDummyMailTest(test_utils.GenericTestBase):
    ...
    def test_cannot_send_dummy_mail(self) -> None:
        ...
        self.assertEqual(generated_response['error'], 'This app cannot send emails.')
...
class UpdateUsernameHandlerTest(test_utils.GenericTestBase):
    ...
    def test_update_username_with_nonexistent_old_username(self) -> None:
        ...
        self.put_json(
            '/updateusernamehandler',
            {'old_username': non_existent_username, 'new_username': self.NEW_USERNAME},
            csrf_token=csrf_token,
            expected_status_int=404,
        )
    ...
    def test_update_username_with_new_username_already_taken(self) -> None:
        ...
        response = self.put_json(
            '/updateusernamehandler',
            {'old_username': self.OLD_USERNAME, 'new_username': self.OLD_USERNAME},
            csrf_token=csrf_token,
            expected_status_int=400,
        )
    ...
    def test_update_username(self) -> None:
        ...
        self.put_json(
            '/updateusernamehandler',
            {'old_username': self.OLD_USERNAME, 'new_username': self.NEW_USERNAME},
            csrf_token=csrf_token,
        )
    ...
    def test_update_username_creates_audit_model(self) -> None:
        ...
        self.assertTrue(
            audit_models.UsernameChangeAuditModel.has_reference_to_user_id(user_id)
        )
    ...
    def test_profile_picture_is_missing_raises_error(self) -> None:
        ...
        self.put_json(
            '/updateusernamehandler',
            {'old_username': self.EDITOR_USERNAME, 'new_username': self.NEW_USERNAME},
            csrf_token=csrf_token,
            expected_status_int=404,
        )
...
class VerifyUserModelsDeletedHandlerTest(test_utils.GenericTestBase):
    ...
    def test_get_with_existing_user_id_returns_true(self) -> None:
        response = self.get_json(
            '/verifyusermodelsdeletedhandler', params={'user_id': self.admin_user_id}
        )
...
class DeleteUserHandlerTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.admin_user_id = self.get_user_id_from_email(feconf.SYSTEM_EMAIL_ADDRESS)
    ...
    def test_delete_without_username_raises_error(self) -> None:
        self.delete_json(
            '/deleteuserhandler', params={'user_id': 'aa'}, expected_status_int=400
        )
    ...
    def test_delete_with_differing_user_id_and_username_raises_error(self) -> None:
        self.delete_json(
            '/deleteuserhandler',
            params={'username': self.NEW_USER_USERNAME, 'user_id': self.admin_user_id},
            expected_status_int=400,
        )
    ...
    def test_delete_with_correct_user_id_andusername_returns_true(self) -> None:
        response = self.delete_json(
            '/deleteuserhandler',
            params={'username': self.NEW_USER_USERNAME, 'user_id': self.new_user_id},
        )
...
class UpdateBlogPostHandlerTest(test_utils.GenericTestBase):
    ...
    def test_update_blog_post_without_author_username_raises_error(self) -> None:
        csrf_token = self.get_new_csrf_token()
    ...
    def test_update_blog_post_with_wrong_blog_post_id_raises_error(self) -> None:
        csrf_token = self.get_new_csrf_token()
...
class AutomaticVoiceoverAdminControlHandlerTests(test_utils.GenericTestBase):
    ...
    def test_handler_should_be_able_to_return_azure_config(self) -> None:
        response = self.get_json(
            '/automatic_voiceover_admin_control_handler', expected_status_int=200
        )
