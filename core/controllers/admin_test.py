...
class QuestionAdminRoleHandlerTest(test_utils.GenericTestBase):
    """Tests for QuestionAdminRoleHandler."""
    ...
    def test_adding_question_admin_role_to_user(self) -> None:
        ...
        self.assertEqual(
            response_dict, {
                'roles': [
                    feconf.ROLE_ID_FULL_USER, feconf.ROLE_ID_QUESTION_ADMIN],
                'banned': False,
                'managed_topic_ids': [],
                'coordinated_language_ids': []
            })
...
class QuestionCoordinatorRoleHandlerTest(test_utils.GenericTestBase):
    """Tests for QuestionCoordinatorRoleHandler."""
    ...
    def test_handler_with_invalid_username(self) -> None:
        ...
        csrf_token = self.get_new_csrf_token()
        self.put_json(
            '/questioncoordinatorrolehandler', {
                'action': 'assign',
                'username': username
            }, csrf_token=csrf_token, expected_status_int=404)

    def test_adding_question_coordinator_role_to_user(self) -> None:
        user_email = 'user1@example.com'
        username = 'user1'
    ...
    def test_deassigning_question_coordinator_role_from_user(self) -> None:
        user_email = 'user1@example.com'
        username = 'user1'
