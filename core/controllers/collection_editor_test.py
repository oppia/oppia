...
class CollectionEditorTests(BaseCollectionEditorControllerTests):
    ...
    def test_editable_collection_handler_put_with_invalid_payload_version(self) -> None:
        ...
        self.assertEqual(
            json_response['error'], 'Invalid POST request: a version must be specified.'
        )
    ...
    def test_can_not_publish_collection_with_invalid_payload_version(self) -> None:
        ...
        self.assertEqual(
            response_dict['error'], 'Invalid POST request: a version must be specified.'
        )
    ...
    def test_can_search_exploration_with_exploration_id(self) -> None:
        ...
        # to string.
        exploration_id = base64.b64encode(exploration_id.encode('utf-8')).decode(
            'utf-8'
        )
