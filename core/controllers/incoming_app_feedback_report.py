...
USER_SUPPLIED_FEEDBACK_DICT_SCHEMA = {
    'type': 'dict',
    'properties': [
        {'name': 'report_type', 'schema': {'type': 'unicode'}},
        {'name': 'category', 'schema': {'type': 'unicode'}},
        {
        ...
        {'name': 'user_feedback_other_text_input', 'schema': {'type': 'unicode'}},
    ],
}
...
ANDROID_SYSTEM_CONTEXT_DICT_SCHEMA = {
    'type': 'dict',
    'properties': [
        {'name': 'platform_version', 'schema': {'type': 'unicode'}},
        {'name': 'package_version_code', 'schema': {'type': 'int'}},
        {'name': 'android_device_country_locale_code', 'schema': {'type': 'unicode'}},
        {'name': 'android_device_language_locale_code', 'schema': {'type': 'unicode'}},
    ],
}
...
ANDROID_DEVICE_CONTEXT_DICT_SCHEMA = {
    'type': 'dict',
    'properties': [
        {'name': 'android_device_model', 'schema': {'type': 'unicode'}},
        {'name': 'android_sdk_version', 'schema': {'type': 'int'}},
        {'name': 'build_fingerprint', 'schema': {'type': 'unicode'}},
        {'name': 'network_type', 'schema': {'type': 'unicode'}},
    ],
}
...
ENTRY_POINT_DICT_SCHEMA = {
    'type': 'dict',
    'properties': [
        {'name': 'entry_point_name', 'schema': {'type': 'unicode'}},
        {'name': 'entry_point_exploration_id', 'schema': {'type': 'unicode_or_none'}},
        {'name': 'entry_point_story_id', 'schema': {'type': 'unicode_or_none'}},
        {'name': 'entry_point_topic_id', 'schema': {'type': 'unicode_or_none'}},
        {'name': 'entry_point_subtopic_id', 'schema': {'type': 'unicode_or_none'}},
    ],
}
...
ANDROID_APP_CONTEXT_DICT_SCHEMA = {
    'type': 'dict',
    'properties': [
        {'name': 'entry_point', 'schema': ENTRY_POINT_DICT_SCHEMA},
        {'name': 'text_language_code', 'schema': {'type': 'unicode'}},
        {'name': 'audio_language_code', 'schema': {'type': 'unicode'}},
        {'name': 'text_size', 'schema': {'type': 'unicode'}},
        {'name': 'only_allows_wifi_download_and_update', 'schema': {'type': 'bool'}},
        {'name': 'automatically_update_topics', 'schema': {'type': 'bool'}},
        {'name': 'account_is_profile_admin', 'schema': {'type': 'bool'}},
        {
            'name': 'event_logs',
            'schema': {
                'type': 'list',
...
class IncomingAndroidFeedbackReportHandler(
    base.BaseHandler[
        IncomingAndroidFeedbackReportHandlerNormalizedPayloadDict, Dict[str, str]
    ]
):
