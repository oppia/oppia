...
class _ActivityDataResponseDictRequiredFields(TypedDict):
    ...
    id: str
    payload: Union[exp_domain.ExplorationDict, story_domain.StoryDict,
                   skill_domain.SkillDict, subtopic_page_domain.SubtopicPageDict,
                   classroom_config_domain.ClassroomDict, topic_domain.TopicDict,
                   Dict[str, feconf.TranslatedContentDict],
                   classroom_domain.ClassroomDict, None]
...
class AndroidActivityHandler(
    base.BaseHandler[Dict[str, str], AndroidActivityHandlerHandlerNormalizedRequestDict]
):
            ...
            'activity_type': {
                'schema': {
                    ...
                    'choices': [
                        ...
                        constants.ACTIVITY_TYPE_STORY, constants.ACTIVITY_TYPE_SKILL,
        ...
        if activity_type == constants.ACTIVITY_TYPE_EXPLORATION:
            for activity_data in activities_data:
                ...
                activities.append({
                    ...
                    'payload':
                        (exploration.to_dict() if exploration is not None else None)
                })
            ...
            for activity_data in activities_data:
                ...
                activities.append({
                    'id': activity_data['id'],
                    'version': activity_data.get('version'),
                    'payload': (story.to_dict() if story is not None else None)
                })
            ...
            for activity_data in activities_data:
                ...
                activities.append({
                    'id': activity_data['id'],
                    'version': activity_data.get('version'),
                    'payload': (skill.to_dict() if skill is not None else None)
                })
            ...
            for activity_data in activities_data:
                ...
                activities.append({
                    ...
                    'version':
                        activity_data.get('version'),
                    'payload': (
                        subtopic_page.to_dict() if subtopic_page is not None else None
                    )
                })
            ...
            for activity_data in activities_data:
                ...
                translation = translation_fetchers.get_entity_translation(
                    entity_type, activity_data['id'], version, language_code
                )
                activities.append({
                    'id':
                        activity_data['id'],
            ...
            for activity_data in activities_data:
                ...
                activities.append({
                    'id': activity_data['id'],
                    'version': activity_data.get('version'),
                    'payload': (topic.to_dict() if topic is not None else None)
                })
