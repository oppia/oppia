...
class ContributorDashboardAdminStatsHandlerTest(test_utils.GenericTestBase):
    ...
    def test_get_translation_submitter_stats_for_last_activity_filter(
        ...
        # Test with end_date_for_last_activity filter and pagination.
        response = self.get_json(
            '/contributor-dashboard-admin-stats/translation/submission', {
                'page_size': 4,
                'offset': 1,
    ...
    def test_get_translation_submitter_stats_for_first_activity_filter(
        ...
        # Test with tart_date_for_last_activity filter and pagination.
        response = self.get_json(
            '/contributor-dashboard-admin-stats/translation/submission', {
                'page_size': 4,
                'offset': 0,
    ...
    def test_get_translation_reviewer_stats_for_first_activity_filter(
        ...
        # Test with start_date_for_last_activity filter and pagination.
        response = self.get_json(
            '/contributor-dashboard-admin-stats/translation/review', {
                'page_size': 4,
                'offset': 0,
