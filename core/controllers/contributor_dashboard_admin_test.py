...
(suggestion_models, user_models) = models.Registry.import_models([models.Names.SUGGESTION, models.Names.USER])
...
class ContributionRightsHandlerTest(test_utils.GenericTestBase):
    ...
    def test_add_reviewer_with_invalid_username_raise_error(self) -> None:
        ...
        response = self.post_json(
            ...
            {'username': 'invalid', 'language_code': 'en'},
    ...
    def test_add_translation_reviewer(self) -> None:
        ...
        self.post_json(
            '/contributionrightshandler/translation',
            {'username': 'translator', 'language_code': 'hi'},
            csrf_token=csrf_token,
        )
    ...
    def test_cannot_add_or_remove_translation_reviewer_without_language_code(
        ...
        self.assertEqual(
            response['error'],
            'The language_code cannot be None if the review category is \'translation\'',
        )

        response = self.delete_json(
            '/contributionrightshandler/translation',
            params={'username': 'translator'},
            expected_status_int=500,
        )
    ...
    def test_assigning_same_language_for_translation_review_raise_error(
        ...
        self.assertEqual(
            response['error'],
            'User translator already has rights to review translation in language code hi',
        )
    ...
    def test_add_reviewer_for_invalid_category_raise_error(self) -> None:
        ...
        self.assertEqual(
            response['error'],
            'At \'http://localhost/contributionrightshandler/invalid\' these errors are happening:\nSchema validation for \'category\' failed: Received invalid which is not in the allowed range of choices: %s' % constants.CD_USER_RIGHTS_CATEGORIES,
        )
    ...
    def test_remove_translation_reviewer(self) -> None:
        ...
        self.delete_json(
            '/contributionrightshandler/translation',
            params={'username': 'translator', 'language_code': 'hi'},
        )
    ...
    def test_remove_unassigned_translation_reviewer_raise_error(self) -> None:
        ...
        self.assertEqual(
            response['error'],
            'translator does not have rights to review translation in language hi.',
        )
...
class ContributorUsersListHandlerTest(test_utils.GenericTestBase):
    ...
    def test_check_contribution_reviewer_by_translation_reviewer_role(
        ...
        response = self.get_json(
            '/getcontributorusershandler/translation',
...
class TranslationContributionStatsHandlerTest(test_utils.GenericTestBase):
    ...
    def test_get_stats_without_username_raises_error(self) -> None:
        ...
        self.assertEqual(
            response['error'],
            'At \'http://localhost/translationcontributionstatshandler\' these errors are happening:\nMissing key in handler args: username.',
        )
...
class ContributorDashboardAdminStatsHandlerTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        for auth_id, email, name in zip(auth_ids, user_emails, usernames):
            ...
            user_models.UserSettingsModel(
                ...
                last_started_state_editor_tutorial=(user_settings.last_started_state_editor_tutorial),
                last_started_state_translation_tutorial=(user_settings.last_started_state_translation_tutorial),
    ...
    def test_get_question_submitter_stats_for_pagination(self) -> None:
        ...
        response = self.get_json(
            ...
            {'page_size': 2, 'offset': 1, 'topic_ids': []},
        )
