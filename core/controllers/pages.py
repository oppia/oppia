...
class SplashPage(base.BaseHandler):
    ...
    def get(self):
        ...
        if not c_value:
            self.render_template('splash/splash.html')
        else:
            try:
                self.render_template('splash/splash_%s.html' % c_value)
            except Exception:
...
class AboutPage(base.BaseHandler):
    ...
    def get(self):
        ...
        self.render_template('about/about.html')
...
class TeachPage(base.BaseHandler):
    ...
    def get(self):
        ...
        self.render_template('teach/teach.html')
...
class ContactPage(base.BaseHandler):
    ...
    def get(self):
        ...
        self.render_template('contact/contact.html')
...
class DonatePage(base.BaseHandler):
    ...
    def get(self):
        ...
        self.render_template('donate/donate.html')
...
class ThanksPage(base.BaseHandler):
    ...
    def get(self):
        ...
        self.render_template('thanks/thanks.html')
...
class ForumPage(base.BaseHandler):
    ...
    def get(self):
        ...
        self.render_template('forum/forum.html')
...
class TermsPage(base.BaseHandler):
    ...
    def get(self):
        ...
        self.render_template('terms/terms.html')
...
class PrivacyPage(base.BaseHandler):
    ...
    def get(self):
        """Handles GET requests."""
        self.render_template('privacy/privacy.html')
...
class ConsoleErrorPage(base.BaseHandler):
    ...
    def get(self):
        """Handles GET requests."""
        self.render_template('tests/console_errors.html')
