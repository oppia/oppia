...
class AuditsExisting:
    ...
    def __call__(self, do_fn_type: Type[beam.DoFn]) -> Type[beam.DoFn]:
        ...
        # The return type of functions with_input_types and with_output_types
        # is Any, because these functions are not type annotated yet in
        # Apache_beam library. Thus to return the appropriate type from function
        # instead of Any. We used cast here.
        return cast(
            Type[beam.DoFn],
