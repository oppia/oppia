...
class AuditsExistingTests(test_utils.TestBase):
    ...
    def test_replaces_base_do_fn_when_derived_do_fn_is_added_later(self) -> None:
        ...
        self.assertItemsEqual(
            MockAuditsExisting.get_audit_do_fn_types('BaseModel'), [DoFn, UnrelatedDoFn]
        )
        self.assertItemsEqual(
...
class RelationshipsOfTests(test_utils.TestBase):
    ...
    def test_has_no_relationships_by_default(self) -> None:
        ...
        self.assertEqual(
            MockRelationshipsOf.get_all_model_kinds_referenced_by_properties(), set()
        )
    ...
    def test_valid_relationship_generator(self) -> None:
        ...
        def bar_model_relationships(
            ...
            Tuple[model_property.PropertyType, List[Type[base_models.BaseModel]]]
        ]:
