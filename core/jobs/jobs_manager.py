...
_GCLOUD_DATAFLOW_JOB_STATE_TO_OPPIA_BEAM_JOB_STATE = {
    ...
    dataflow.JobState.JOB_STATE_STOPPED:
        beam_job_models.BeamJobState.STOPPED,
    # Indicates that the job is currently running.
    dataflow.JobState.JOB_STATE_RUNNING:
        beam_job_models.BeamJobState.RUNNING,
    ...
    dataflow.JobState.JOB_STATE_DONE:
        beam_job_models.BeamJobState.DONE,
    ...
    dataflow.JobState.JOB_STATE_FAILED:
        beam_job_models.BeamJobState.FAILED,
    ...
    dataflow.JobState.JOB_STATE_UPDATED:
        beam_job_models.BeamJobState.UPDATED,
    ...
    dataflow.JobState.JOB_STATE_DRAINING:
        beam_job_models.BeamJobState.DRAINING,
    ...
    dataflow.JobState.JOB_STATE_DRAINED:
        beam_job_models.BeamJobState.DRAINED,
    ...
    dataflow.JobState.JOB_STATE_PENDING:
        beam_job_models.BeamJobState.PENDING,
    ...
    # JOB_STATE_CANCELLED.
    dataflow.JobState.JOB_STATE_QUEUED:
        beam_job_models.BeamJobState.PENDING,
