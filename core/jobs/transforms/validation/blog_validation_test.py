...
class ValidateBlogModelTimeFieldTests(job_test_utils.PipelinedTestBase):
    ...
    def test_reports_model_created_on_timestamp_relationship_error(self) -> None:
        ...
        self.assert_pcoll_equal(
            output, [
                ...
                InconsistentLastUpdatedTimestampsError(invalid_timestamp),
            ]
        )
    ...
    def test_reports_model_last_updated_timestamp_relationship_error(self) -> None:
        ...
        self.assert_pcoll_equal(
            output, [
                blog_validation_errors.
                InconsistentPublishLastUpdatedTimestampsError(invalid_timestamp),
            ]
        )
    ...
    def test_process_reports_no_error_if_published_on_is_none(self) -> None:
        ...
        output = (
            self.pipeline | beam.Create([valid_timestamp]) |
            beam.ParDo(blog_validation.ValidateBlogModelTimestamps())
        )
    ...
    def test_process_reports_model_mutated_during_job_error_for_last_updated(
        ...
        self.assert_pcoll_equal(
            output, [
                blog_validation_errors.
                ModelMutatedDuringJobErrorForLastUpdated(invalid_timestamp),
            ]
        )
...
class ValidateBlogPostModelDomainObjectsInstancesTests(
    ...
    def test_validation_type_for_domain_object_strict(self) -> None:
        ...
        output = (
            self.pipeline | beam.Create([blog_model]) |
            beam.ParDo(blog_validation.ValidateBlogPostModelDomainObjectsInstances())
        )
...
class ValidateBlogPostSummaryModelDomainObjectsInstancesTests(
    ...
    def test_validation_type_for_domain_object_strict(self) -> None:
        ...
        output = (
            self.pipeline | beam.Create([blog_summary_model]) | beam.ParDo(
