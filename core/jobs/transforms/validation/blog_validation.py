...
(blog_models,
 user_models) = models.Registry.import_models([models.Names.BLOG, models.Names.USER])
...
class ValidateBlogPostModelDomainObjectsInstances(
    ...
    def _get_model_domain_object_instance(
        ...
        return blog_domain.BlogPost(
            ...
            blog_post_model.content, blog_post_model.url_fragment, blog_post_model.tags,
...
class ValidateBlogModelTimestamps(beam.DoFn):  # type: ignore[misc]
    ...
    def process(
        self, input_model: Union[blog_models.BlogPostModel,
                                 blog_models.BlogPostSummaryModel]
    ) -> Iterator[
        Union[blog_validation_errors.InconsistentLastUpdatedTimestampsError,
...
class ValidateBlogSummaryModelDomainObjectsInstances(
    ...
    def _get_model_domain_object_instance(
        ...
        return blog_domain.BlogPostSummary(
            ...
            summary_model.summary, summary_model.url_fragment, summary_model.tags,
            summary_model.thumbnail_filename, summary_model.last_updated,
...
def blog_post_summary_model_relationships(
    ...
    blog_models.BlogPostModel, blog_models.BlogPostRightsModel,
    user_models.UserSettingsModel]]]]]:
    """Yields how the properties of the model relates to the ID of others."""
