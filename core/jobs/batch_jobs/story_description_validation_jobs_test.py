...
"""Unit tests for jobs.batch_jobs.story_description_validation_jobs."""

from __future__ import annotations
from core import feconf

from core.jobs import job_test_utils
from core.jobs.batch_jobs import story_description_validation_jobs
...
class GetNumberOfStoriesExceedsMaxDescriptionLengthJobTests(
    job_test_utils.JobTestBase):

    JOB_CLASS = (
        story_description_validation_jobs.
            GetNumberOfStoriesExceedsMaxDescriptionLengthJob)
    ...
    INVALID_DESCRIPTION = 'description' * 100

    def setUp(self):
        super().setUp()

        # This is an invalid model with description length greater than 1000.
        ...
        # This is a valid model with description length less than 1000.
    ...
    def test_run_with_single_invalid_model(self) -> None:
        ...
        self.assert_job_output_is([
            ...
            job_run_result.JobRunResult.as_stderr(
                ...
                % (self.STORY_ID_1, len(self.INVALID_DESCRIPTION))),
        ])
    ...
    def test_run_with_mixed_models(self) -> None:
        ...
        self.assert_job_output_is([
            ...
            job_run_result.JobRunResult.as_stderr(
                'The id of story is %s and its description length is %s'
                % (self.STORY_ID_2, len(self.INVALID_DESCRIPTION))),
        ])
