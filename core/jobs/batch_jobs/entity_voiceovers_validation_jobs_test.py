...
"""Unit tests for jobs.batch_jobs.entity_voiceovers_validation_jobs."""
...
from core.jobs.batch_jobs import entity_voiceovers_validation_jobs
...
class VoiceoverSynthesisJobRunTests(
    ...
    JOB_CLASS: Type[
        entity_voiceovers_validation_jobs.EntityVoiceoversValidationAuditJob
    ] = entity_voiceovers_validation_jobs.EntityVoiceoversValidationAuditJob
    ...
    def _create_data_for_testing(self) -> None:
        ...
        non-curated. It adds voiceovers in Hindi and English content within
        the curated explorations.
        """
        ...
        voiceover_models.EntityVoiceoversModel.create_new(
            ...
            2,
            'en-US',
            {'content_0': {'manual': self.voiceover_dict_3, 'auto': None}},
            {},
        ).put()

    def test_entity_voiceover_audit_job_result(self) -> None:
        self._create_data_for_testing()
        expected_output = [
            job_run_result.JobRunResult(
                stdout='Exploration ID: exploration_id_1\nEntityVoiceoversModel: exploration_id_1-2-en-US, contains 1 manual voiceovers.\nEntityVoiceoversModel: exploration_id_1-2-hi-IN, contains 1 manual voiceovers.\n',
                stderr='',
            ),
            job_run_result.JobRunResult(
                stdout='Exploration ID: exploration_id_2\nEntityVoiceoversModel: exploration_id_2-2-en-US, contains 1 manual voiceovers.\n',
                stderr='',
            ),
        ]
