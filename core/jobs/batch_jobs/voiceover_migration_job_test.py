...
class VoiceArtistMetadataModelsTestsBaseClass(
    ...
    def _create_exp_voice_artists_link(self) -> None:
        ...
        exp_voice_artist_link_model_1 = voiceover_services.create_exploration_voice_artists_link_model_instance(
            self.CURATED_EXPLORATION_ID_1, content_id_to_voiceovers_mapping_1
        )
        exp_voice_artist_link_model_1.put()

        exp_voice_artist_link_model_2 = voiceover_services.create_exploration_voice_artists_link_model_instance(
