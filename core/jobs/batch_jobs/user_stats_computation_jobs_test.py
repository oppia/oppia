...
class CollectWeeklyDashboardStatsJobTests(job_test_utils.JobTestBase):
    ...
    JOB_CLASS: Type[user_stats_computation_jobs.CollectWeeklyDashboardStatsJob
    ...
    def test_updates_existing_stats_model_when_no_values_are_provided(self) -> None:
        user_settings_model = self.create_model(
            user_models.UserSettingsModel, id=self.VALID_USER_ID_1, email='a@a.com'
        )
    ...
    def test_fails_when_existing_stats_has_wrong_schema_version(self) -> None:
        ...
        user_stats_model = self.create_model(
            user_models.UserStatsModel, id=self.VALID_USER_ID_1, schema_version=0
        )
    ...
    def test_handles_multiple_models(self) -> None:
        ...
        user_settings_model_2 = self.create_model(
            user_models.UserSettingsModel, id=self.VALID_USER_ID_2, email='b@b.com'
        )
