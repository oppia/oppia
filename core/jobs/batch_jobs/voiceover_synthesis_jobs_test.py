...
"""Unit tests for jobs.batch_jobs.voiceover_synthesis_jobs."""
...
(translation_models, voiceover_models) = models.Registry.import_models([models.Names.TRANSLATION, models.Names.VOICEOVER])


class VoiceoverSynthesisBaseClass(job_test_utils.JobTestBase, test_utils.GenericTestBase):
...
class VoiceoverSynthesisJobRunTests(VoiceoverSynthesisBaseClass):
    JOB_CLASS: Type[voiceover_synthesis_jobs.VoiceoverSynthesisJob] = voiceover_synthesis_jobs.VoiceoverSynthesisJob
    ...
    def test_check_is_exploration_curated_for_invalid_id(self) -> None:
        is_exploration_curated = voiceover_synthesis_jobs.VoiceoverSynthesisJob.is_exploration_curated(exploration_id='')
...
class VoiceoverSynthesisAuditJobRunTests(VoiceoverSynthesisBaseClass):
    JOB_CLASS: Type[voiceover_synthesis_jobs.VoiceoverSynthesisAuditJob] = voiceover_synthesis_jobs.VoiceoverSynthesisAuditJob
