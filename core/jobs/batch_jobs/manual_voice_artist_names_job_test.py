...
class GetVoiceArtistNamesFromExplorationsJobTests(
    ...
    def _create_curated_explorations(self) -> None:
        ...
        self.EDITOR_EMAIL_1 = 'editor1@example.com'
        self.EDITOR_EMAIL_2 = 'editor2@example.com'
        self.EDITOR_EMAIL_3 = 'editor3@example.com'
        self.EDITOR_EMAIL_4 = 'editor4@example.com'
        self.EDITOR_EMAIL_5 = 'editor5@example.com'
        self.EDITOR_USERNAME_1 = 'editor1'
        self.EDITOR_USERNAME_2 = 'editor2'
        self.EDITOR_USERNAME_3 = 'editor3'
        self.EDITOR_USERNAME_4 = 'editor4'
        self.EDITOR_USERNAME_5 = 'editor5'
        ...
        print('Editor 1', self.editor_id_1)
        print('Editor 2', self.editor_id_2)
        print('Editor 3', self.editor_id_3)
        print('Editor 4', self.editor_id_4)
        print('Editor 5', self.editor_id_5)

        # Creating first curated Exploration.
        self.CURATED_EXPLORATION_ID_1 = 'explrotion_id_1'
        self.CURATED_EXPLORATION_ID_2 = 'exploration_id_2'
        self.NON_CURATED_EXPLORATION_ID_3 = 'exploration_id_3'

        self.TOPIC_ID_1 = 'topic_id_1'
        self.TOPIC_ID_2 = 'topic_id_2'
        self.STORY_ID_1 = 'story_id_1'
        self.STORY_ID_2 = 'story_id_3'
    ...
    def test_version_is_added_after_running_job(self) -> None:
        ...
        self.assert_job_output_is([job_run_result.JobRunResult(
            stdout='VOICE ARTIST NAMES FETCHED SUCCESS: 1'
        )])
