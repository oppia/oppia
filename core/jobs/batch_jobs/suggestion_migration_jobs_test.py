    ...
    def test_unmigrated_invalid_suggestion_raises_error(self) -> None:
        ...
        self.assert_job_output_is(
            [
                ...
                job_run_result.JobRunResult(
                    stderr=(
                        'SUGGESTION TARGET PROCESSED ERROR: "(16, \'State name invalid_state_name does not exist in the exploration\')": 1'
                    )
                ),
                job_run_result.JobRunResult(
                    stderr=(
                        'SUGGESTION TARGET PROCESSED ERROR: "(17, \'Content ID invalid does not exist in the exploration\')": 1'
                    )
                ),
            ]
        )
    ...
    def test_suggestion_with_invalid_content_id_raise_error(self) -> None:
        ...
        self.assert_job_output_is(
            [
                job_run_result.JobRunResult(
                    stderr=(
                        'SUGGESTION TARGET PROCESSED ERROR: "(\'111\', \'Content ID invalid_id does not exist in the exploration\')": 1'
                    )
                ),
            ]
        )
    ...
    def test_suggestion_with_invalid_content_id_raise_error(self) -> None:
        ...
        self.assert_job_output_is(
            [
                job_run_result.JobRunResult(
                    stderr=(
                        'SUGGESTION TARGET PROCESSED ERROR: "(15, \'Content ID invalid_id does not exist in the exploration\')": 1'
                    )
                ),
            ]
        )
        ...
        with migrate_state_schema_raise:
            self.assert_job_output_is(
                [
                    job_run_result.JobRunResult(
                        stderr=(
                            'SUGGESTION MIGRATED ERROR: "(\'%s\', Exception())": 1'
                            % suggestion_id
                        )
                    ),
                    job_run_result.JobRunResult(
