...
class CleanUpVoiceoverModelsTestsBaseClass(
    ...
    def _create_non_curated_explorations(self) -> None:
        ...
        new_voiceovers_dict = {
            'voiceovers_mapping': {
                'content_0': {'en': self.voiceover_dict_2},
                'ca_placeholder_2': {},
                'default_outcome_1': {},
            }
        }
        ...
        new_voiceovers_dict = {
            'voiceovers_mapping': {
                'content_0': {'en': self.voiceover_dict_3},
                'ca_placeholder_2': {},
                'default_outcome_1': {},
            }
        }
...
class AuditExplorationVoiceArtistLinkModelsJobTests(
    ...
    def test_check_is_exploration_curated_for_invalid_id(self) -> None:
        is_exploration_curated = clean_up_voiceover_models_job.AuditExplorationVoiceArtistsLinkModelJob.is_exploration_curated(
            exploration_id=''
        )
...
class DeleteExplorationVoiceArtistLinkModelsJobTests(
    ...
    JOB_CLASS: Type[
        clean_up_voiceover_models_job.DeleteNonCuratedInstanceofExplorationVoiceArtistsLinkModelJob
    ] = (
        clean_up_voiceover_models_job.DeleteNonCuratedInstanceofExplorationVoiceArtistsLinkModelJob
    )
...
class AuditEntityVoiceoversModelJobTests(CleanUpVoiceoverModelsTestsBaseClass):
    ...
    def test_check_is_exploration_curated_for_invalid_id(self) -> None:
        is_exploration_curated = clean_up_voiceover_models_job.AuditEntityVoiceoversModelJob.is_exploration_curated(
            exploration_id=''
        )
        self.assertFalse(is_exploration_curated)
...
class DeleteEntityVoiceoversModelsJobTests(
    ...
    JOB_CLASS: Type[
        clean_up_voiceover_models_job.DeleteNonCuratedInstanceofEntityVoiceoversModelJob
    ] = (
        clean_up_voiceover_models_job.DeleteNonCuratedInstanceofEntityVoiceoversModelJob
    )
