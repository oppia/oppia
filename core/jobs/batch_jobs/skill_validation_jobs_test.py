...
class GetNumberOfSkillsWithInvalidRubricExplanationsJobTests(
    job_test_utils.JobTestBase):

    JOB_CLASS = (
        skill_validation_jobs.GetNumberOfSkillsWithInvalidRubricExplanationsJob
    )
    ...
    def setUp(self):
        ...
        # Skill model with invalid rubrics.
        self.skill_model_3 = skill_models.SkillModel(
            id='skill_id_3',
    ...
    def test_run_with_mixed_models(self) -> None:
        self.put_multi([
            self.skill_model_1, self.skill_model_2, self.skill_model_3])
        self.assert_job_output_is([
