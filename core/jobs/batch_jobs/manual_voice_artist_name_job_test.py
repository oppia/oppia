...
class VoiceArtistMetadataModelsTestsBaseClass(
    ...
    def _create_curated_explorations(self) -> None:
        ...
        new_voiceovers_dict = {
            'voiceovers_mapping': {
                'content_0': {'en': self.voiceover_dict_1, 'hi': self.voiceover_dict_2},
                'ca_placeholder_2': {},
                'default_outcome_1': {},
            }
        }
...
class CreateExplorationVoiceArtistLinkModelsJobTests(
    ...
    def test_version_is_added_after_running_job(self) -> None:
        ...
        job_result_template = (
            'Generated exploration voice artist link model for ' 'exploration %s.'
        )
        ...
        expected_exp_id_to_content_id_to_voiceovers_mapping = {
            self.CURATED_EXPLORATION_ID_1: {
                ...
                'ca_placeholder_2': {'en': [self.editor_id_1, self.voiceover_dict_3]},
            },
            self.CURATED_EXPLORATION_ID_2: {
                'content_0': {
                    'en': [self.editor_id_4, self.voiceover_dict_6],
                },
                'ca_placeholder_2': {'en': [self.editor_id_1, self.voiceover_dict_4]},
                'default_outcome_1': {
