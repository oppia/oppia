...
class VoiceArtistMetadataModelsTestsBaseClass(
    ...
    def setUp(self) -> None:
        ...
        self.set_curriculum_admins([
            self.EDITOR_USERNAME_1, self.EDITOR_USERNAME_2, self.EDITOR_USERNAME_3,
            self.EDITOR_USERNAME_4, self.CURRICULUM_ADMIN_USERNAME
        ])
    ...
    def _create_curated_explorations(self) -> None:
        ...
        old_voiceover_dict: Dict[str, Dict[str, Dict[str,
                                                     state_domain.VoiceoverDict]]] = {
                                                         'voiceovers_mapping': {
                                                             'content_0': {},
                                                             'ca_placeholder_2': {},
                                                             'default_outcome_1': {}
        ...
        exp_services.update_exploration(
            self.editor_id_1, self.CURATED_EXPLORATION_ID_1, change_list,
            'Translation commits'
        )
        ...
        exp_services.update_exploration(
            self.editor_id_2, self.CURATED_EXPLORATION_ID_1, change_list,
        ...
        exp_services.update_exploration(
            self.owner_id, self.CURATED_EXPLORATION_ID_1, change_list,
        ...
        story_1 = story_domain.Story.create_default_story(
            self.STORY_ID_1, 'A story', 'Description', self.TOPIC_ID_1, 'story-two'
        )
        ...
        exp_services.update_exploration(
            self.editor_id_1, self.CURATED_EXPLORATION_ID_2, change_list,
            'Translation commits'
        )
        ...
        exp_services.update_exploration(
            self.editor_id_3, self.CURATED_EXPLORATION_ID_2, change_list,
            'Translation commits'
        )
        ...
        exp_services.update_exploration(
            self.editor_id_4, self.CURATED_EXPLORATION_ID_2, change_list,
            'Translation commits2'
        )
        ...
        story_2 = story_domain.Story.create_default_story(
            self.STORY_ID_2, 'The second story', 'Description second', self.TOPIC_ID_2,
            'story-three'
        )
    ...
    def test_version_is_added_after_running_job(self) -> None:
        ...
        self.assert_job_output_is([
            job_run_result.JobRunResult(
                stdout=job_result_template % self.CURATED_EXPLORATION_ID_1, stderr=''
            ),
            job_run_result.JobRunResult(
                stdout=job_result_template % self.CURATED_EXPLORATION_ID_2, stderr=''
            ),
        ...
        for exp_link_model in exploration_voice_artist_link_models:
            ...
            self.assertDictEqual(
                content_id_to_voiceovers_mapping, expected_content_id_voiceovers_mapping
            )

        self.assertEqual(len(exploration_voice_artist_link_models), 2)

    def test_should_skip_voiceover_if_specific_snapshot_model_is_invalid(self) -> None:
        self._create_curated_explorations()
        self._create_non_curated_exploration()
        ...
        snapshot_model: exp_models.ExplorationSnapshotContentModel = (
            exp_models.ExplorationSnapshotContentModel.get_by_id(snapshot_model_id)
        )
        # Deleting recorded voiceovers field to make this snapshot invalid.
        del snapshot_model.content['states']['Introduction']['recorded_voiceovers'][
            'voiceovers_mapping']
...
class AuditVoiceArtistMetadataModelsJobTests(VoiceArtistMetadataModelsTestsBaseClass):
    ...
    def test_generate_exp_link_model_if_some_commit_log_models_are_missing(
        ...
        snapshot_model: exp_models.ExplorationSnapshotMetadataModel = (
            exp_models.ExplorationSnapshotMetadataModel.get_by_id(snapshot_model_id)
        )
    ...
    def test_generate_exp_link_model_if_some_snapshot_models_are_missing(self) -> None:
...
class HelperMethodsForExplorationVoiceArtistLinkJobTest(
    ...
    def test_should_create_exploration_link_for_voice_artist(self) -> None:
        ...
        exploration_models: List[exp_models.ExplorationModel
                                ] = list(exp_models.ExplorationModel.get_all().fetch())
        snapshot_models: List[exp_models.ExplorationSnapshotContentModel] = list(
            exp_models.ExplorationSnapshotContentModel.get_all().fetch()
        )
        metadata_models: List[exp_models.ExplorationSnapshotMetadataModel] = list(
    ...
    def test_should_get_empty_filenames_successfully(self) -> None:
        ...
        new_voiceovers_dict_1: Dict[str,
                                    Dict[str,
        ...
        old_voiceover_dict_1: Dict[str, Dict[str, Dict[str,
                                                       state_domain.VoiceoverDict]]] = {
                                                           'voiceovers_mapping': {
                                                               'content_0': {},
                                                               'ca_placeholder_2': {},
        ...
        new_voiceovers_dict_2: Dict[str, Dict[str,
                                              Dict[str,
                                                   state_domain.VoiceoverDict]]] = {
                                                       'voiceovers_mapping': {
                                                           'content_0': {},
        ...
        old_voiceover_dict_2: Dict[str, Dict[str,
                                             Dict[str, state_domain.VoiceoverDict]]] = {
                                                 'voiceovers_mapping': {
                                                     'content_0': {
                                                         'en': self.voiceover_dict_1
    ...
    def test_should_create_empty_exploration_voice_artist_link_model(self) -> None:
        exploration = self.save_new_valid_exploration(
            self.CURATED_EXPLORATION_ID_1,
            self.owner_id,
            title='title1',
        ...
        snapshot_metadata_model = (
            exp_models.ExplorationSnapshotMetadataModel.get('exploration_id_1-2')
        )
        ...
        self.assertEqual(exp_link_model.id, self.CURATED_EXPLORATION_ID_1)
        self.assertDictEqual(exp_link_model.content_id_to_voiceovers_mapping, {})
