...
class PopulateQuestionSummaryVersionOneOffJob(base_jobs.JobBase):
    ...
    def _regenerate_question_summary(
        ...
        Tuple[str, question_models.QuestionSummaryModel], Tuple[str, Exception]
    ]:
...
class MigrateQuestionModels(beam.PTransform):  # type: ignore[misc]
    ...
    def expand(self, pipeline: beam.Pipeline) -> Tuple[
        ...
        question_summary_models = (
            ...
            >> (ndb_io.GetModels(question_models.QuestionSummaryModel.get_all()))
        ...
        migrated_questions = filtered_migrated_exp | 'Unwrap ok' >> beam.Map(
            lambda result_item: result_item.unwrap()
        )

        question_changes = (
            unmigrated_question_models
            | 'Generates question changes'
...
class MigrateQuestionJob(base_jobs.JobBase):
    ...
    def _update_question(
        ...
        Returns:
            ...
            the datastore.
        """
        updated_question_model = question_services.populate_question_model_fields(
    ...
    def run(self) -> beam.PCollection[job_run_result.JobRunResult]:
        ...
        question_models_to_put = (
            transformed_question_objects_list
            | 'Generate question models to put'
            >> beam.FlatMap(
        ...
        question_summary_model_to_put = (
            transformed_question_objects_list
            | 'Generate question summary to put'
            >> beam.Map(
