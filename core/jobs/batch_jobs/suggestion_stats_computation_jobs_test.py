...
class GenerateContributionStatsJobTests(job_test_utils.JobTestBase):
        ...
        self.assert_job_output_is(
            [
                job_run_result.JobRunResult(
                    stdout='TOTAL PROCESSED TRANSLATION CONTRIBUTION STATS COUNT SUCCESS: 1'
                )
            ]
        )
    ...
    def test_reports_failure_on_broken_model(self) -> None:
        ...
        self.assert_job_output_is(
            [
                job_run_result.JobRunResult(
                    stderr=(
                        'ERROR: "suggestion_id: argument cannot be of \'int\' type, must be of text type": 1'
                    )
                )
            ]
        )
    ...
    def test_creates_translation_stats_models_from_one_accepted_suggestion(
        ...
        self.assert_job_output_is(
            [
                ...
                job_run_result.JobRunResult(
                    stdout='TOTAL PROCESSED TRANSLATION REVIEW STATS COUNT SUCCESS: 1'
                ),
            ]
        )
    ...
    def test_creates_multiple_stats_models_from_multiple_users(self) -> None:
        ...
        self.assert_job_output_is(
            [
                job_run_result.JobRunResult(
                    stdout='TOTAL PROCESSED TRANSLATION CONTRIBUTION STATS COUNT SUCCESS: 2'
                ),
                job_run_result.JobRunResult(
                    stdout='TOTAL PROCESSED TRANSLATION REVIEW STATS COUNT SUCCESS: 1'
                ),
    ...
    def test_creates_question_stats_models_from_one_accepted_suggestion(
        ...
        self.assert_job_output_is(
            [
                job_run_result.JobRunResult(
                    stdout='TOTAL PROCESSED QUESTION CONTRIBUTION STATS COUNT SUCCESS: 1'
                ),
                job_run_result.JobRunResult(
                    stdout='TOTAL PROCESSED QUESTION REVIEW STATS COUNT SUCCESS: 1'
                ),
            ]
        )
