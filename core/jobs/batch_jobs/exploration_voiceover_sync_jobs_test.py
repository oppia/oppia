        ...
        entity_voiceovers_model = (
            voiceover_models.EntityVoiceoversModel.create_new(
                feconf.ENTITY_TYPE_EXPLORATION, 'exp_1', 1, 'en-US', {
                    'content_0': {
                        feconf.VoiceoverType.MANUAL.value: dummy_manual_voiceover_dict,
    ...
    def test_should_update_entity_voiceovers_model(self) -> None:
        ...
        entity_voiceovers_model = (
            voiceover_models.EntityVoiceoversModel.create_new(
                feconf.ENTITY_TYPE_EXPLORATION, 'exp_1', 1, 'en-US', {
                'content_0': {
                        feconf.VoiceoverType.MANUAL.value: manual_voiceover_dict_4,
                        feconf.VoiceoverType.AUTO.value: None
                }}, {}))
        ...
        expected_voiceovers_mapping = {
            'content_0': {
                feconf.VoiceoverType.MANUAL.value: manual_voiceover_dict_1,
                feconf.VoiceoverType.AUTO.value: None
            },
            'content_1': {
                feconf.VoiceoverType.MANUAL.value: manual_voiceover_dict_2,
                feconf.VoiceoverType.AUTO.value: None
            },
            'content_2': {
                feconf.VoiceoverType.MANUAL.value: manual_voiceover_dict_3,
                feconf.VoiceoverType.AUTO.value: None
            }
        }
