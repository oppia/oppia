        ...
        entity_voiceovers_model = (
            voiceover_models.EntityVoiceoversModel.create_new(
                feconf.ENTITY_TYPE_EXPLORATION, 'exp_1', 1, 'en-US', {
                    'content_0': {
                        feconf.VoiceoverType.MANUAL: dummy_manual_voiceover_dict,
    ...
    def test_should_update_entity_voiceovers_model(self) -> None:
        ...
        entity_voiceovers_model = (
            voiceover_models.EntityVoiceoversModel.create_new(
                feconf.ENTITY_TYPE_EXPLORATION, 'exp_1', 1, 'en-US', {
                'content_0': {
                    feconf.VoiceoverType.MANUAL: manual_voiceover_dict_4,
                    feconf.VoiceoverType.AUTO: None
                }}, {}))
        ...
        expected_voiceovers_mapping = {
            'content_0': {
                feconf.VoiceoverType.MANUAL: manual_voiceover_dict_1,
                feconf.VoiceoverType.AUTO: None
            },
            'content_1': {
                feconf.VoiceoverType.MANUAL: manual_voiceover_dict_2,
                feconf.VoiceoverType.AUTO: None
            },
            'content_2': {
                feconf.VoiceoverType.MANUAL: manual_voiceover_dict_3,
                feconf.VoiceoverType.AUTO: None
            }
        }
