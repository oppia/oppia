                ...
                for story_model in story_model_list:
                    ...
                    for node in nodes:
                        ...
                        for version in range(current_topic_version, 0, -1):
                            ...
                            topic_metadata = (
                                topic_models.TopicSnapshotMetadataModel.get(snapshot_id)
                            )
                            for cmd in topic_metadata.commit_cmds:
                                if (
                                    ...
                                    story_published_on = utils.get_time_in_millisecs(
                        ...
                        for version in range(current_story_version, 0, -1):
                            ...
                            story_metadata = (
                                story_models.StorySnapshotMetadataModel.get(snapshot_id)
                            )
                            for cmd in story_metadata.commit_cmds:
                                ...
                                if (
                                    ...
                                    node_created_on = utils.get_time_in_millisecs(
                                        story_metadata.created_on
                                    )
                                    break
