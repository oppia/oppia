...
class AuditAllStorageModelsJobTests(job_test_utils.JobTestBase):
    ...
    def test_base_validation(self) -> None:
        ...
        self.assert_job_output_is([
            base_validation_errors.ModelIdRegexError(
                base_model_with_invalid_id, base_validation.BASE_MODEL_ID_PATTERN
            ),
            base_validation_errors.
            ModelMutatedDuringJobError(base_model_with_invalid_timestamps),
            base_validation_errors.
            InconsistentTimestampsError(base_model_with_inconsistent_timestamps),
    ...
    def test_user_audits(self) -> None:
        ...
        user_settings_model_with_valid_id = self.create_model(
            user_models.UserSettingsModel, id=self.VALID_USER_ID, email='a@a.com'
        )
    ...
    def test_empty_when_web_of_id_property_targets_exist(self) -> None:
        self.put_multi([
            ...
            self.create_model(
                auth_models.UserIdentifiersModel, id='123', user_id=self.VALID_USER_ID
            ),
        ])
