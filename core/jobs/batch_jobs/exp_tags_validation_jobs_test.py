...
class GetNumberOfExpExceedsMaxTagsLengthJobTests(
    ...
    JOB_CLASS = exp_tags_validation_jobs.GetNumberOfExpExceedsMaxTagsLengthJob
    ...
    def setUp(self):
        ...
        # This is an valid model with atgs length lesser than equals to 10.
...
class GetNumberOfExpHavingDuplicatetTagValuesJobTests(
    ...
    JOB_CLASS = exp_tags_validation_jobs.GetNumberOfExpHavingDuplicatetTagValuesJob
