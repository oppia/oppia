...
class GenerateSkillOpportunityModelJob(base_jobs.JobBase):
    ...
    def _create_skill_opportunity_model(
        ...
        Returns:
            dict(str, *). Metadata about the operation. Keys are:
                ...
                model: SkillOpportunityModel. The model generated by the
                operation.
        """
        try:
    ...
    def count_unique_question_ids(self,
        question_skill_link_models: list[list[question_models.QuestionSkillLinkModel]] ) -> int:
