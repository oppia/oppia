...
class ContributorDashboardTest(job_test_utils.JobTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.question_suggestion_accepted_model_with_incomplete_contribution_stats = (
        ...
        unused_topic_assignment = skill_domain.TopicAssignment('topic1', 'name1', 2, 1)
        # Skill id 'exp1' is assigned to topic2.
        unused_topic_assignment = skill_domain.TopicAssignment('topic2', 'name1', 2, 1)
...
class GenerateContributorAdminStatsJobTests(ContributorDashboardTest):
    ...
    def test_job_does_not_creates_stats_if_contribution_stats_model_does_not_exist_for_a_suggestion(
        self,
...
class AuditGenerateContributorAdminStatsJobTests(ContributorDashboardTest):
    ...
    def test_job_does_not_audits_stats_if_contribution_stats_model_does_not_exist_for_a_suggestion(
        self,
    ) -> None:  # pylint: disable=line-too-long
