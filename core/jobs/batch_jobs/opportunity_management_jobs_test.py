...
class GenerateExplorationOpportunitySummariesJobTests(job_test_utils.JobTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.topic_model = self.create_model(
            ...
            language_code='cs',
            url_fragment='topic',
            canonical_story_references=[{'story_id': self.STORY_1_ID, 'story_is_published': False}],
    ...
    def test_job_returns_one_opportunity_for_multiple_topics_with_same_exp(
        ...
        topic_model = self.create_model(
            ...
            language_code='cs',
            url_fragment='topic',
            canonical_story_references=[{'story_id': self.STORY_2_ID, 'story_is_published': False}],
            page_title_fragment_for_web='fragm',
        )
