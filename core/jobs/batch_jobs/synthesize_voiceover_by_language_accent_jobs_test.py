...
class VoiceoverSynthesisByAccentBaseClass(
    ...
    def _set_language_accent_code(self, language_accent_code: str) -> None:
...
class VoiceoverSynthesisByAccentJobRunTests(
    ...
    def test_should_not_generate_voiceover_for_non_autogeneratable_accent(
        self,
    ) -> None:
        self._create_data_for_testing()
        self._set_language_accent_code('en-NG')

        expected_output_1 = (
            'Exploration ID: exploration_id_1.\n'
            'No voiceovers generated for language accent: en-NG.'
        )
