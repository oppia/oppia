...
"""Unit tests for jobs.batch_jobs.exp_rating_validation_jobs."""
...
from core.jobs.batch_jobs import exp_rating_validation_jobs
...
class GetExpWithInvalidRatingJobTests(
    ...
    JOB_CLASS = exp_rating_validation_jobs.GetExpWithInvalidRatingJob
