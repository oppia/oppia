...
class ClassroomModel(base_models.BaseModel):
    ...
    # Whether diagnostic test is enabled for this classroom or not.
    # False if diagnostic test is disabled, True if enabled.
    ...
    def create(
        ...
        Args:
            ...
            is_diagnostic_test_enabled: bool. Whether diagnostic test is enabled
                fpr the classroom or not.
