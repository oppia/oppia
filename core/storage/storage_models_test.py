...
class StorageModelsTest(test_utils.GenericTestBase):
    ...
    def test_locally_pseudonymize_models_have_wipeout_handling(self) -> None:
        ...
        self.assertEqual(
            ...
            set(),
            'The following models have LOCALLY_PSEUDONYMIZE deletion policy but are not listed as having wipeout handling. Please add wipeout logic in core/domain/wipeout_service.py and then add the model name to the models_with_wipeout_handling set in this test: %s'
