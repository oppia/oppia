...
class SentEmailModel(base_models.BaseModel):
    ...
    @classmethod
    def create(
        cls, recipient_id: str, recipient_email: str, sender_id: str, sender_email: str,
        intent: str, subject: str, html_body: str, sent_datetime: datetime.datetime
    ) -> None:
        ...
        if sent_datetime_lower_bound is not None:
            if not isinstance(sent_datetime_lower_bound, datetime.datetime):
                raise Exception(
                    ...
                    (sent_datetime_lower_bound, type(sent_datetime_lower_bound))
                )
    ...
    def check_duplicate_message(
        ...
        for message in messages:
            if (
                ...
                message.subject == email_subject and message.html_body == email_body
            ):
                return True
...
class BulkEmailModel(base_models.BaseModel):
    ...
    @classmethod
    def create(
        cls, instance_id: str, sender_id: str, sender_email: str, intent: str,
        subject: str, html_body: str, sent_datetime: datetime.datetime
    ) -> None:
