...
class BlogPostViewedEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostViewedEventLogEntryModel.get_deletion_policy(),
    ...
    def test_get_new_event_entity_id(self) -> None:
        ...
        with self.swap(
            ...
            with self.swap(utils, 'convert_to_hash', mock_convert_to_hash):
                ...
                self.assertEqual(
                    new_id, ':'.join([str(int(time_in_millisecs)), 'BLOG', rand_hash])
                )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostViewedEventLogEntryModel.get_model_association_to_user(),
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.BlogPostViewedEventLogEntryModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class BlogPostReadEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.event_model_three = blog_stats_models.BlogPostReadEventLogEntryModel(
            id='event_model_3', blog_post_id=self.BLOG_POST_ONE_ID
        )
        self.event_model_three.update_timestamps()
        self.event_model_three.put()

        self.event_model_four = blog_stats_models.BlogPostReadEventLogEntryModel(
            id='event_model_4', blog_post_id=self.BLOG_POST_TWO_ID
        )
        self.event_model_four.update_timestamps()
        self.event_model_four.put()
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostReadEventLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_create_raises_exception_by_mocking_collision(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            with self.swap(
                ...
                'get_by_id',
                types.MethodType(
                    lambda x, y: True, blog_stats_models.BlogPostReadEventLogEntryModel
                ),
            ):
                stats_model_class.create('blog_post_id')
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostReadEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.BlogPostReadEventLogEntryModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class BlogPostExitedEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostExitedEventLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostExitedEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.BlogPostExitedEventLogEntryModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class BlogPostViewsAggregatedStatsModelUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.model_one = blog_stats_models.BlogPostViewsAggregatedStatsModel(
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostViewsAggregatedStatsModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostViewsAggregatedStatsModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.BlogPostViewsAggregatedStatsModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class BlogPostReadsAggregatedStatsModelUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.model_one = blog_stats_models.BlogPostReadsAggregatedStatsModel(
            id=self.BLOG_POST_ONE_ID,
            reads_by_hour={},
            reads_by_date={},
            reads_by_month={},
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostReadsAggregatedStatsModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostReadsAggregatedStatsModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.BlogPostReadsAggregatedStatsModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class BlogPostReadingTimeModelUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.model_one = blog_stats_models.BlogPostReadingTimeModel(
            id=self.BLOG_POST_ONE_ID,
            zero_to_one_min=0,
            one_to_two_min=0,
            two_to_three_min=0,
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostReadingTimeModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.BlogPostReadingTimeModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.BlogPostReadingTimeModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class AuthorBlogPostReadsAggregatedStatsModelUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.model_one = blog_stats_models.AuthorBlogPostReadsAggregatedStatsModel(
            id=self.AUTHOR_ONE_ID, reads_by_hour={}, reads_by_date={}, reads_by_month={}
        )
        self.model_one.update_timestamps()
        self.model_one.put()
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.AuthorBlogPostReadsAggregatedStatsModel.get_deletion_policy(),
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.AuthorBlogPostReadsAggregatedStatsModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.AuthorBlogPostReadsAggregatedStatsModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class AuthorBlogPostViewsAggregatedStatsModelUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.model_one = blog_stats_models.AuthorBlogPostViewsAggregatedStatsModel(
            id=self.AUTHOR_ONE_ID, views_by_hour={}, views_by_date={}, views_by_month={}
        )
        self.model_one.update_timestamps()
        self.model_one.put()
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.AuthorBlogPostViewsAggregatedStatsModel.get_deletion_policy(),
            base_models.DELETION_POLICY.DELETE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.AuthorBlogPostViewsAggregatedStatsModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.AuthorBlogPostViewsAggregatedStatsModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class AuthorBlogPostsReadingTimeModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            blog_stats_models.AuthorBlogPostAggregatedReadingTimeModel.get_deletion_policy(),
            base_models.DELETION_POLICY.DELETE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            blog_stats_models.AuthorBlogPostAggregatedReadingTimeModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            blog_stats_models.AuthorBlogPostAggregatedReadingTimeModel.get_export_policy(),
            expected_export_policy_dict,
        )
