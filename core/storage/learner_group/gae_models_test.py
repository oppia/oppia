...
(base_models, learner_group_models) = models.Registry.import_models([models.Names.BASE_MODEL, models.Names.LEARNER_GROUP])
...
class LearnerGroupModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            learner_group_models.LearnerGroupModel.get_model_association_to_user(),
    ...
    def test_raise_exception_by_mocking_collision(self) -> None:
        ...
        # Test create method.
        with self.assertRaisesRegex(Exception, 'A learner group with the given group ID exists already.'):
            # Swap dependent method get_by_id to simulate collision every time.
            with self.swap(
                learner_group_model_cls,
                'get_by_id',
                types.MethodType(lambda x, y: True, learner_group_model_cls),
            ):
    ...
    def test_creating_new_learner_group_model_instance(self) -> None:
        learner_group_model_id = learner_group_models.LearnerGroupModel.get_new_id()
        learner_group_model_instance = learner_group_models.LearnerGroupModel.create(learner_group_model_id, 'title', 'description')
        self.assertEqual(learner_group_model_instance.id, learner_group_model_id)
        self.assertEqual(learner_group_model_instance.title, 'title')
        self.assertEqual(learner_group_model_instance.description, 'description')
    ...
    def test_get_field_names_for_takeout(self) -> None:
        ...
        self.assertEqual(
            learner_group_models.LearnerGroupModel.get_field_names_for_takeout(),
            expected_results,
        )
    ...
    def test_export_data_on_learners(self) -> None:
        ...
        learner_user_data = learner_group_models.LearnerGroupModel.export_data('learner_1')
    ...
    def test_export_data_on_invited_learners(self) -> None:
        ...
        learner group.
        """
        invited_learner_data = learner_group_models.LearnerGroupModel.export_data('invited_user_2')
    ...
    def test_export_data_on_facilitators(self) -> None:
        ...
        the learner group.
        """
        facilitator_user_data = learner_group_models.LearnerGroupModel.export_data('facilitator_1')
    ...
    def test_export_data_on_uninvolved_user(self) -> None:
        ...
        the learner group.
        """
        uninvolved_user_data = learner_group_models.LearnerGroupModel.export_data('learner_21')
        expected_uninvolved_user_data: Dict[str, Union[str, List[str]]] = {}

        self.assertEqual(expected_uninvolved_user_data, uninvolved_user_data)

    def test_apply_deletion_policy_on_learners(self) -> None:
        """Test apply_deletion_policy on users that are learners of
        the learner group.
        """
        self.assertTrue(learner_group_models.LearnerGroupModel.has_reference_to_user_id('learner_1'))

        learner_group_models.LearnerGroupModel.apply_deletion_policy('learner_1')

        self.assertFalse(learner_group_models.LearnerGroupModel.has_reference_to_user_id('learner_1'))
    ...
    def test_apply_deletion_policy_on_invited_users(self) -> None:
        ...
        """
        self.assertTrue(learner_group_models.LearnerGroupModel.has_reference_to_user_id('invited_user_1'))

        learner_group_models.LearnerGroupModel.apply_deletion_policy('invited_user_1')

        self.assertFalse(learner_group_models.LearnerGroupModel.has_reference_to_user_id('invited_user_1'))

    def test_apply_deletion_policy_on_facilitators(self) -> None:
        """Test apply_deletion_policy on users that are facilitators of
        the learner group.
        """
        self.assertTrue(learner_group_models.LearnerGroupModel.has_reference_to_user_id('facilitator_1'))
        self.assertTrue(learner_group_models.LearnerGroupModel.has_reference_to_user_id('facilitator_2'))

        # Deleting a facilitator when more than 1 facilitators are present.
        learner_group_models.LearnerGroupModel.apply_deletion_policy('facilitator_1')

        self.assertFalse(learner_group_models.LearnerGroupModel.has_reference_to_user_id('facilitator_1'))

        # Deleting a facilitator when only 1 facilitator is present.
        learner_group_models.LearnerGroupModel.apply_deletion_policy('facilitator_2')

        self.assertFalse(learner_group_models.LearnerGroupModel.has_reference_to_user_id('facilitator_2'))

    def test_get_by_facilitator_id(self) -> None:
        """Test get_by_facilitator_id."""
        learner_group_model = learner_group_models.LearnerGroupModel.get_by_facilitator_id('facilitator_1')
    ...
    def test_get_by_invited_learner_user_id(self) -> None:
        ...
        learner_grp_models = learner_group_models.LearnerGroupModel.get_by_invited_learner_user_id('facilitator_1')
        self.assertEqual(len(learner_grp_models), 0)

        learner_grp_models = learner_group_models.LearnerGroupModel.get_by_invited_learner_user_id('learner_2')
        self.assertEqual(len(learner_grp_models), 0)

        learner_grp_models = learner_group_models.LearnerGroupModel.get_by_invited_learner_user_id('invited_user_1')
    ...
    def test_get_by_learner_user_id(self) -> None:
        ...
        learner_grp_models = learner_group_models.LearnerGroupModel.get_by_learner_user_id('facilitator_1')
        self.assertEqual(len(learner_grp_models), 0)

        learner_grp_models = learner_group_models.LearnerGroupModel.get_by_learner_user_id('invited_user_1')
        self.assertEqual(len(learner_grp_models), 0)

        learner_grp_models = learner_group_models.LearnerGroupModel.get_by_learner_user_id('learner_2')
        self.assertEqual(learner_grp_models[0].id, 'learner_group_32')
