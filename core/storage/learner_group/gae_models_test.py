...
class LearnerGroupModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_export_data_on_invited_learners(self) -> None:
        ...
        invited_learner_data = (
            learner_group_models.LearnerGroupModel.export_data('invited_user_2')
        )
    ...
    def test_get_by_facilitator_id(self) -> None:
        ...
        learner_group_model = (
            learner_group_models.LearnerGroupModel.
            get_by_facilitator_id('facilitator_1')
        )
    ...
    def test_get_by_invited_learner_user_id(self) -> None:
        ...
        learner_grp_models = (
            learner_group_models.LearnerGroupModel.
            get_by_invited_learner_user_id('facilitator_1')
        )
        self.assertEqual(len(learner_grp_models), 0)

        learner_grp_models = (
            learner_group_models.LearnerGroupModel.
            get_by_invited_learner_user_id('learner_2')
        )
        self.assertEqual(len(learner_grp_models), 0)

        learner_grp_models = (
            learner_group_models.LearnerGroupModel.
            get_by_invited_learner_user_id('invited_user_1')
        )
    ...
    def test_get_by_learner_user_id(self) -> None:
        ...
        learner_grp_models = (
            learner_group_models.LearnerGroupModel.
            get_by_learner_user_id('facilitator_1')
        )
        self.assertEqual(len(learner_grp_models), 0)

        learner_grp_models = (
            learner_group_models.LearnerGroupModel.
            get_by_learner_user_id('invited_user_1')
        )
        self.assertEqual(len(learner_grp_models), 0)
