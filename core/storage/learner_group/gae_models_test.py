...
class LearnerGroupModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_creating_new_learner_group_model_instance(self) -> None:
        ...
        learner_group_model_instance = learner_group_models.LearnerGroupModel.create(
    ...
    def test_export_data_on_learners(self) -> None:
        ...
        learner_user_data = learner_group_models.LearnerGroupModel.export_data(
            'learner_1'
        )
    ...
    def test_export_data_on_invited_learners(self) -> None:
        ...
        learner group.
        """
        invited_learner_data = learner_group_models.LearnerGroupModel.export_data(
            'invited_user_2'
        )
    ...
    def test_export_data_on_facilitators(self) -> None:
        ...
        the learner group.
        """
        facilitator_user_data = learner_group_models.LearnerGroupModel.export_data(
            'facilitator_1'
        )
    ...
    def test_export_data_on_uninvolved_user(self) -> None:
        ...
        the learner group.
        """
        uninvolved_user_data = learner_group_models.LearnerGroupModel.export_data(
            'learner_21'
        )
    ...
    def test_apply_deletion_policy_on_learners(self) -> None:
        ...
        """
        self.assertTrue(
            learner_group_models.LearnerGroupModel.has_reference_to_user_id('learner_1')
        )
    ...
    def test_apply_deletion_policy_on_invited_users(self) -> None:
        ...
        """
        self.assertTrue(
            learner_group_models.LearnerGroupModel.has_reference_to_user_id(
                'invited_user_1'
            )
        )
    ...
    def test_get_by_learner_user_id(self) -> None:
        ...
        learner_grp_models = (
            learner_group_models.LearnerGroupModel.get_by_learner_user_id('learner_2')
        )
        self.assertEqual(learner_grp_models[0].id, 'learner_group_32')
