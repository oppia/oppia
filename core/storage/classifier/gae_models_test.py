...
class ClassifierTrainingJobModelUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self):
        ...
        classifier_models.ClassifierTrainingJobModel.create(
            'LDAStringClassifier', 'committer_id1', 'exp_id1', 1,
            [{'answer_group_index': 1, 'answers': ['a1', 'a2']}],
            'state_name1')
        classifier_models.ClassifierTrainingJobModel.create(
            'LDAStringClassifier', 'committer_id2', 'exp_id2', 2,
            [{'answer_group_index': 1, 'answers': ['a1', 'a2']}],
            'state_name1')
        classifier_models.ClassifierTrainingJobModel.create(
            'LDAStringClassifier', 'committer_id3', 'exp_id3', 3,
            [{'answer_group_index': 1, 'answers': ['a1', 'a2']}],
            'state_name1')
    ...
    def test_create_and_get_new_training_job_runs_successfully(self):
        ...
        self.assertEqual(training_job.committer_id, 'committer_id1')
