...
class QuestionModel(base_models.VersionedModel):
    ...
    @classmethod
    def create(
        cls, question_state_data: state_domain.StateDict, language_code: str,
        version: int, linked_skill_ids: List[str],
        inapplicable_skill_misconception_ids: List[str], next_content_id_index: int
    ) -> QuestionModel:
...
class QuestionSkillLinkModel(base_models.BaseModel):
    ...
    @classmethod
    def create(
        cls, question_id: str, skill_id: str, skill_difficulty: float
        ...
        for skill_id in skill_ids:
            ...
            if len(new_question_skill_link_models) >= question_count_per_skill:
                ...
                question_extra_count = (
                    ...
                    len(easier_question_skill_link_models) - question_count_per_skill
                )
    ...
    def get_question_skill_links_equidistributed_by_skill(
        ...
        for skill_id in skill_ids:
            ...
            new_question_skill_link_models: List[QuestionSkillLinkModel] = list(
                query.fetch(
                    limit=question_count_per_skill * 2, offset=get_offset(query)
                )
            )
            ...
            existing_question_ids.extend([
                model.question_id for model in (sampled_question_skill_link_models)
            ])
    ...
    def get_all_question_ids_linked_to_skill_id(cls, skill_id: str) -> List[str]:
        ...
        question_skill_link_models = cls.query().filter(
            cls.skill_id == skill_id, cls.deleted == False
    ...
    @classmethod
    def get_models_by_question_id(cls,
                                  question_id: str) -> Sequence[QuestionSkillLinkModel]:
