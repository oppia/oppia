...
class QuestionModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_export_policy(self) -> None:
        expected_export_policy_dict = {
            ...
            'question_state_data_schema_version': (base_models.EXPORT_POLICY.NOT_APPLICABLE),
            ...
            'inapplicable_skill_misconception_ids': (base_models.EXPORT_POLICY.NOT_APPLICABLE),
        }
        self.assertEqual(
    ...
    def test_create_question_empty_skill_id_list(self) -> None:
        state = state_domain.State.create_default_state('ABC', 'content_0', 'default_outcome_1')
        question_state_data = state.to_dict()
        language_code = 'en'
        version = 1
        question_model = question_models.QuestionModel.create(question_state_data, language_code, version, [], [], 2)

        self.assertEqual(question_model.question_state_data, question_state_data)
    ...
    def test_create_question_with_skill_ids(self) -> None:
        ...
        self.assertEqual(question_model.question_state_data, question_state_data)
        self.assertEqual(question_model.language_code, language_code)
        self.assertItemsEqual(question_model.linked_skill_ids, linked_skill_ids)
    ...
    def test_put_multi_questions(self) -> None:
        ...
        self.assertItemsEqual(question_model1.linked_skill_ids, ['skill_id1', 'skill_id2'])
        self.assertItemsEqual(question_model2.linked_skill_ids, ['skill_id1', 'skill_id2'])

        question_model1.linked_skill_ids = ['skill_id3']
        question_model2.linked_skill_ids = ['skill_id3']

        question_models.QuestionModel.put_multi_questions([question_model1, question_model2])

        updated_question_model1 = question_models.QuestionModel.get(question_ids[0])
        updated_question_model2 = question_models.QuestionModel.get(question_ids[1])
        self.assertEqual(updated_question_model1.linked_skill_ids, ['skill_id3'])
        self.assertEqual(updated_question_model2.linked_skill_ids, ['skill_id3'])
    ...
    def test_raise_exception_by_mocking_collision(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception,
            'The id generator for QuestionModel is producing too many collisions.',
        ):
            # Swap dependent method get_by_id to simulate collision every time.
            with self.swap(
                question_models.QuestionModel,
                'get_by_id',
                types.MethodType(lambda x, y: True, question_models.QuestionModel),
            ):
                question_models.QuestionModel.create(question_state_data, language_code, version, [], [], 2)
...
class QuestionSkillLinkModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_create_question_skill_link(self) -> None:
        ...
        questionskilllink_model = question_models.QuestionSkillLinkModel.create(question_id, skill_id, skill_difficulty)
        ...
        self.assertEqual(questionskilllink_model.skill_difficulty, skill_difficulty)
    ...
    def test_get_all_question_ids_linked_to_skill_id(self) -> None:
        ...
        self.assertEqual(
            question_models.QuestionSkillLinkModel.get_all_question_ids_linked_to_skill_id(skill_id_1),
            [],
        )
    ...
    def test_put_multi_question_skill_link(self) -> None:
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.1)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id1', 0.5)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id3', 'skill_id3', 0.8)
        ...
        question_skill_links = question_models.QuestionSkillLinkModel.get_models_by_skill_id('skill_id1')
    ...
    def test_delete_multi_question_skill_link(self) -> None:
        ...
        question_skill_links = question_models.QuestionSkillLinkModel.get_models_by_skill_id('skill_id3')
    ...
    def test_cannot_link_same_question_to_given_skill(self) -> None:
        question_skill_link_model = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.1)

        question_models.QuestionSkillLinkModel.put_multi_question_skill_links([question_skill_link_model])

        with self.assertRaisesRegex(
            Exception,
            'The question with ID question_id1 is already linked to skill skill_id1',
        ):
            question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.1)

    def test_get_models_by_question_id(self) -> None:
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.1)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id1', 0.5)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id3', 0.8)
        ...
        question_skill_links = question_models.QuestionSkillLinkModel.get_models_by_question_id('question_id2')
        self.assertEqual(len(question_skill_links), 2)
        question_skill_links = question_models.QuestionSkillLinkModel.get_models_by_question_id('question_id3')
        self.assertEqual(len(question_skill_links), 0)
    ...
    def test_get_total_question_count_for_skill_ids(self) -> None:
        ...
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', skill_id_1, 0.1)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', skill_id_1, 0.5)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id3', skill_id_2, 0.8)
        question_models.QuestionSkillLinkModel.put_multi_question_skill_links(
            [
                questionskilllink_model1,
                questionskilllink_model2,
        ...
        question_count = question_skill_link_model.get_total_question_count_for_skill_ids([skill_id_1, skill_id_2])

        self.assertEqual(question_count, 3)

        question_count = question_skill_link_model.get_total_question_count_for_skill_ids([skill_id_1])

        self.assertEqual(question_count, 2)

        question_count = question_skill_link_model.get_total_question_count_for_skill_ids([skill_id_1, skill_id_1])

        self.assertEqual(question_count, 2)

        question_count = question_skill_link_model.get_total_question_count_for_skill_ids([skill_id_2])

        self.assertEqual(question_count, 1)

        question_count = question_skill_link_model.get_total_question_count_for_skill_ids([skill_id_1, skill_id_2, skill_id_1])
    ...
    def test_get_question_skill_links_by_skill_ids(self) -> None:
        ...
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', skill_id_1, 0.1)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', skill_id_1, 0.5)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id2', skill_id_2, 0.8)
        question_models.QuestionSkillLinkModel.put_multi_question_skill_links(
            [
                questionskilllink_model1,
                questionskilllink_model2,
        ...
        question_skill_link_models = question_models.QuestionSkillLinkModel.get_question_skill_links_by_skill_ids(  # pylint: disable=line-too-long
        ...
        question_skill_link_models_2 = question_models.QuestionSkillLinkModel.get_question_skill_links_by_skill_ids(  # pylint: disable=line-too-long
        ...
        self.assertNotEqual(question_skill_link_models[0], question_skill_link_models_2[0])
    ...
    def test_get_question_skill_links_by_skill_ids_many_skills(self) -> None:
        ...
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', skill_id_1, 0.1)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', skill_id_2, 0.5)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id2', skill_id_3, 0.8)
        questionskilllink_model4 = question_models.QuestionSkillLinkModel.create('question_id2', skill_id_4, 0.3)
        question_models.QuestionSkillLinkModel.put_multi_question_skill_links(
            [
                questionskilllink_model1,
                questionskilllink_model2,
    ...
    def test_get_question_skill_links_based_on_difficulty(self) -> None:
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.7)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id1', 0.6)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id2', 0.5)
        questionskilllink_model4 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id2', 0.9)
        questionskilllink_model5 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id3', 0.9)
        questionskilllink_model6 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id3', 0.6)
        question_models.QuestionSkillLinkModel.put_multi_question_skill_links(
            [
                questionskilllink_model1,
                questionskilllink_model2,
        ...
        question_skill_links = question_models.QuestionSkillLinkModel.get_question_skill_links_based_on_difficulty_equidistributed_by_skill(  # pylint: disable=line-too-long
    ...
    def test_get_random_question_skill_links_based_on_difficulty(self) -> None:
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.6)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id1', 0.6)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id3', 'skill_id1', 0.6)
        questionskilllink_model4 = question_models.QuestionSkillLinkModel.create('question_id4', 'skill_id1', 0.6)
        questionskilllink_model5 = question_models.QuestionSkillLinkModel.create('question_id5', 'skill_id1', 0.6)
        questionskilllink_model6 = question_models.QuestionSkillLinkModel.create('question_id6', 'skill_id1', 0.6)
        questionskilllink_model7 = question_models.QuestionSkillLinkModel.create('question_id7', 'skill_id1', 0.6)
        questionskilllink_model8 = question_models.QuestionSkillLinkModel.create('question_id8', 'skill_id1', 0.6)
        question_models.QuestionSkillLinkModel.put_multi_question_skill_links(
            [
                questionskilllink_model1,
                questionskilllink_model2,
        ...
        def mock_random_sample(alist: List[question_models.QuestionSkillLinkModel], num: int) -> List[question_models.QuestionSkillLinkModel]:
            if num >= len(alist):
                return alist
    ...
    def test_request_too_many_skills_raises_error_when_fetch_by_difficulty(
        ...
        with self.assertRaisesRegex(Exception, 'Please keep the number of skill IDs below 20.'):
            (
    ...
    def test_get_questions_with_no_skills(self) -> None:
        ...
        question_skill_links = question_models.QuestionSkillLinkModel.get_question_skill_links_equidistributed_by_skill(1, [])
        self.assertEqual(question_skill_links, [])
    ...
    def test_get_more_question_skill_links_than_available(self) -> None:
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.1)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id1', 0.5)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id3', 'skill_id2', 0.8)
        question_models.QuestionSkillLinkModel.put_multi_question_skill_links(
            [
                questionskilllink_model1,
                questionskilllink_model2,
    ...
    def test_get_question_skill_links_equidistributed_by_skill(self) -> None:
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.1)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id1', 0.5)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id3', 'skill_id2', 0.8)
        questionskilllink_model4 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id2', 0.9)
        question_models.QuestionSkillLinkModel.put_multi_question_skill_links(
            [
                questionskilllink_model1,
                questionskilllink_model2,
        ...
        question_skill_links = question_models.QuestionSkillLinkModel.get_question_skill_links_equidistributed_by_skill(4, ['skill_id1', 'skill_id2'])
        self.assertEqual(len(question_skill_links), 3)
    ...
    def test_get_random_question_skill_links_equidistributed_by_skill(
        ...
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create('question_id1', 'skill_id1', 0.1)
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create('question_id2', 'skill_id1', 0.5)
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create('question_id3', 'skill_id1', 0.8)
        questionskilllink_model4 = question_models.QuestionSkillLinkModel.create('question_id4', 'skill_id1', 0.9)
        questionskilllink_model5 = question_models.QuestionSkillLinkModel.create('question_id5', 'skill_id1', 0.6)
        questionskilllink_model6 = question_models.QuestionSkillLinkModel.create('question_id6', 'skill_id1', 0.6)
        questionskilllink_model7 = question_models.QuestionSkillLinkModel.create('question_id7', 'skill_id1', 0.6)
        questionskilllink_model8 = question_models.QuestionSkillLinkModel.create('question_id8', 'skill_id1', 0.6)
        ...
        random_int_swap = self.swap(utils, 'get_random_int', mock_random_int)
        with sample_swap, random_int_swap:
            question_skill_links_1 = question_models.QuestionSkillLinkModel.get_question_skill_links_equidistributed_by_skill(3, ['skill_id1'])
        self.assertEqual(len(question_skill_links_1), 3)
        self.assertEqual(
            question_skill_links_1,
            [
    ...
    def test_request_too_many_skills_raises_error(self) -> None:
        skill_ids = ['skill_id%s' % number for number in range(25)]
        with self.assertRaisesRegex(Exception, 'Please keep the number of skill IDs below 20.'):
            (question_models.QuestionSkillLinkModel.get_question_skill_links_equidistributed_by_skill(3, skill_ids))
...
class QuestionCommitLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        ...
        commit.put()
        self.assertTrue(question_models.QuestionCommitLogEntryModel.has_reference_to_user_id('committer_id'))
        self.assertFalse(question_models.QuestionCommitLogEntryModel.has_reference_to_user_id('x_id'))
...
class QuestionSummaryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            question_models.QuestionSummaryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        expected_export_policy_dict = {
            ...
            'last_updated': base_models.EXPORT_POLICY.NOT_APPLICABLE,
            'deleted': base_models.EXPORT_POLICY.NOT_APPLICABLE,
            'question_model_last_updated': (base_models.EXPORT_POLICY.NOT_APPLICABLE),
            'question_model_created_on': (base_models.EXPORT_POLICY.NOT_APPLICABLE),
