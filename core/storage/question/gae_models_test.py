...
class QuestionModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_create_question_with_inapplicable_skill_misconception_ids(self) -> None:
        state = state_domain.State.create_default_state(
            'ABC', 'content_0', 'default_outcome_1'
        )
        question_state_data = state.to_dict()
...
class QuestionSkillLinkModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_all_question_ids_linked_to_skill_id(self) -> None:
        ...
        self.assertEqual(
            question_models.QuestionSkillLinkModel.get_all_question_ids_linked_to_skill_id(
                skill_id_1
            ),
            [],
        )

        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create(
            'question_id1', skill_id_1, 0.1
        )
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create(
    ...
    def test_put_multi_question_skill_link(self) -> None:
        ...
        questionskilllink_model3 = question_models.QuestionSkillLinkModel.create(
        ...
        question_skill_links = (
            question_models.QuestionSkillLinkModel.get_models_by_skill_id('skill_id1')
        )
    ...
    def test_delete_multi_question_skill_link(self) -> None:
        ...
        question_skill_links = (
            question_models.QuestionSkillLinkModel.get_models_by_skill_id('skill_id3')
        )
    ...
    def test_get_question_skill_links_by_skill_ids_many_skills(self) -> None:
        ...
        questionskilllink_model4 = question_models.QuestionSkillLinkModel.create(
    ...
    def test_get_question_skill_links_based_on_difficulty(self) -> None:
        ...
        questionskilllink_model5 = question_models.QuestionSkillLinkModel.create(
            'question_id1', 'skill_id3', 0.9
        )
        questionskilllink_model6 = question_models.QuestionSkillLinkModel.create(
    ...
    def test_get_random_question_skill_links_based_on_difficulty(self) -> None:
        ...
        questionskilllink_model7 = question_models.QuestionSkillLinkModel.create(
            'question_id7', 'skill_id1', 0.6
        )
        questionskilllink_model8 = question_models.QuestionSkillLinkModel.create(
        ...
        def mock_random_sample(
            alist: List[question_models.QuestionSkillLinkModel], num: int
    ...
    def test_get_questions_with_no_skills(self) -> None:
        ...
        question_skill_links = question_models.QuestionSkillLinkModel.get_question_skill_links_equidistributed_by_skill(
            1, []
        )
        self.assertEqual(question_skill_links, [])
    ...
    def test_get_question_skill_links_when_count_not_evenly_divisible(self) -> None:
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create(
            'question_id1', 'skill_id1', 0.1
        )
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create(
    ...
    def test_get_random_question_skill_links_equidistributed_by_skill(self) -> None:
        questionskilllink_model1 = question_models.QuestionSkillLinkModel.create(
            'question_id1', 'skill_id1', 0.1
        )
        questionskilllink_model2 = question_models.QuestionSkillLinkModel.create(
    ...
    def test_request_too_many_skills_raises_error(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            (
                question_models.QuestionSkillLinkModel.get_question_skill_links_equidistributed_by_skill(
                    3, skill_ids
                )
            )
...
class QuestionCommitLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        ...
        commit.put()
        self.assertTrue(
            question_models.QuestionCommitLogEntryModel.has_reference_to_user_id(
                'committer_id'
            )
        )
        self.assertFalse(
            question_models.QuestionCommitLogEntryModel.has_reference_to_user_id('x_id')
        )
