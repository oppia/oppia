...
class ExplorationStatsTaskEntryModelTests(test_utils.GenericTestBase):
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            improvements_models.ExplorationStatsTaskEntryModel.get_export_policy(),
            expected_export_policy_dict
        )
    ...
    def test_has_reference_to_user_id(self) -> None:
        improvements_models.ExplorationStatsTaskEntryModel.create(
            ...
            'state name', 'issue_description', constants.TASK_STATUS_RESOLVED, 'uid'
        )
        self.assertTrue(
            improvements_models.ExplorationStatsTaskEntryModel.
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            improvements_models.ExplorationStatsTaskEntryModel.get_deletion_policy(),
    ...
    def test_export_data_without_any_tasks(self) -> None:
        self.assertEqual(
            improvements_models.ExplorationStatsTaskEntryModel.export_data('uid'), {
                'issue_descriptions': [],
                'resolution_msecs': [],
                'statuses': [],
    ...
    def test_export_data_with_task(self) -> None:
        ...
        self.assertEqual(
            improvements_models.ExplorationStatsTaskEntryModel.export_data('uid'), {
                'issue_descriptions': ['issue_description_1', 'issue_description_2'],
    ...
    def test_can_create_task_with_unicode_identifiers(self) -> None:
        improvements_models.ExplorationStatsTaskEntryModel.create(
            constants.TASK_ENTITY_TYPE_EXPLORATION, 'eid_\U0001F4C8', 1,
            constants.TASK_TYPE_HIGH_BOUNCE_RATE, constants.TASK_TARGET_TYPE_STATE,
            'tid_\U0001F4C8'
        )
