...
TASK_STATUS_OPEN = feconf.TASK_STATUS_OPEN
TASK_STATUS_OBSOLETE = feconf.TASK_STATUS_OBSOLETE
TASK_STATUS_RESOLVED = feconf.TASK_STATUS_RESOLVED
TASK_STATUS_CHOICES = (
    TASK_STATUS_OPEN,
...
TASK_TARGET_TYPE_STATE = feconf.TASK_TARGET_TYPE_STATE
TASK_TARGET_TYPES = (
...
class TaskEntryModel(base_models.BaseModel):
    ...
    def export_data(user_id):
        ...
        task_ids_resolved_by_user = (
            TaskEntryModel.query(TaskEntryModel.resolver_id == user_id))
        return {
            'task_ids_resolved_by_user': (
