...
class TaskEntryModel(base_models.BaseModel):
    ...
    entity_type = ndb.StringProperty(
        required=True, choices=TASK_ENTITY_TYPES)
    ...
    task_type = ndb.StringProperty(
        required=True, choices=TASK_TYPES)
    ...
    target_type = ndb.StringProperty(
        required=True, choices=TASK_TARGET_TYPES)
    ...
    status = ndb.StringProperty(
        required=True, choices=TASK_STATUS_CHOICES)
