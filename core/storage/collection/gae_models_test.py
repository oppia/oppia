...
class CollectionRightsSnapshotContentModelTests(test_utils.GenericTestBase):
    ...
    def test_get_deletion_policy_is_locally_pseudonymize(self) -> None:
        self.assertEqual(
            collection_models.CollectionRightsSnapshotContentModel.get_deletion_policy(
...
class CollectionRightsModelUnitTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.col_1_dict = (
            collection_models.CollectionRightsModel.get_by_id(self.COLLECTION_ID_1
                                                             ).to_dict()
        )
    ...
    def test_save(self) -> None:
        ...
        self.assertEqual(['editor_ids', 'owner_ids', 'viewer_ids', 'voice_artist_ids'],
    ...
    def test_export_data_on_highly_involved_user(self) -> None:
        ...
        collection_ids = (
            collection_models.CollectionRightsModel.export_data(self.USER_ID_1)
        )
        expected_collection_ids = {
            'owned_collection_ids':
                ([self.COLLECTION_ID_1, self.COLLECTION_ID_2, self.COLLECTION_ID_3]),
    ...
    def test_export_data_on_partially_involved_user(self) -> None:
        ...
        collection_ids = (
            collection_models.CollectionRightsModel.export_data(self.USER_ID_2)
        )
        expected_collection_ids = {
            'owned_collection_ids': [],
            'editable_collection_ids': [],
    ...
    def test_export_data_on_uninvolved_user(self) -> None:
        ...
        collection_ids = (
            collection_models.CollectionRightsModel.export_data(self.USER_ID_3)
        )
    ...
    def test_export_data_on_invalid_user(self) -> None:
        ...
        collection_ids = (
            collection_models.CollectionRightsModel.export_data('fake_user')
        )
        expected_collection_ids: Dict[str, List[str]] = {
            'owned_collection_ids': [],
            'editable_collection_ids': [],
...
class CollectionCommitLogEntryModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            collection_models.CollectionCommitLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.PSEUDONYMIZE_IF_PUBLIC_DELETE_IF_PRIVATE
        )
    ...
    def test_get_all_non_private_commits_with_invalid_max_age(self) -> None:
        with self.assertRaisesRegex(
            ...
            (
                collection_models.CollectionCommitLogEntryModel.
                get_all_non_private_commits(2, None, max_age='invalid_max_age')
...
class CollectionSummaryModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        ...
        self.assertFalse(
            collection_models.CollectionSummaryModel.has_reference_to_user_id('x_id')
        )
    ...
    def test_get_private_at_least_viewable(self) -> None:
        ...
        collection_summary_models = (
            collection_models.CollectionSummaryModel.get_private_at_least_viewable('a')
        )
        self.assertEqual(1, len(collection_summary_models))
