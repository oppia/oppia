...
class CollectionModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_reconstitute(self) -> None:
        ...
        self.assertNotIn(
            'nodes', collection_model._properties # pylint: disable=protected-access
        )
        self.assertNotIn(
            'nodes', collection_model._values # pylint: disable=protected-access
        )
...
class CollectionRightsModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_reconstitute(self) -> None:
        ...
        self.assertNotIn(
            'translator_ids', collection_rights_model._properties # pylint: disable=protected-access
        )
        self.assertNotIn(
            'translator_ids', collection_rights_model._values # pylint: disable=protected-access
        )
