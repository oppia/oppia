...
class CollectionModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_reconstitute(self) -> None:
        ...
        self.assertNotIn(
            'nodes', collection_model._properties
        )  # pylint: disable=protected-access
        self.assertNotIn(
            'nodes', collection_model._values
        )  # pylint: disable=protected-access
...
class CollectionRightsModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_reconstitute(self) -> None:
        ...
        self.assertNotIn(
            'translator_ids', collection_rights_model._properties
        )  # pylint: disable=protected-access
        self.assertNotIn(
            'translator_ids', collection_rights_model._values
        )  # pylint: disable=protected-access
...
class CollectionRightsModelRevertUnitTest(test_utils.GenericTestBase):
    ...
    def test_revert_to_valid_version_is_successful(self) -> None:
        ...
        new_collection_model = collection_models.CollectionRightsModel.get_by_id(
            self.COLLECTION_ID_1
        )
...
class CollectionSummaryModelUnitTest(test_utils.GenericTestBase):
    ...
    def test_get_non_private(self) -> None:
        public_collection_summary_model = collection_models.CollectionSummaryModel(
            id='id0',
            title='title',
            category='category',
            objective='objective',
        ...
        private_collection_summary_model = collection_models.CollectionSummaryModel(
            id='id1',
            title='title',
            category='category',
            objective='objective',
    ...
    def test_get_at_least_editable(self) -> None:
        ...
        self.assertEqual('id0', collection_summary_models[0].id)
        collection_summary_models = (
            collection_models.CollectionSummaryModel.get_at_least_editable('viewer_ids')
        )
