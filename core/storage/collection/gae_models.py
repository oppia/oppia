...
class CollectionCommitLogEntryModel(base_models.BaseCommitLogEntryModel):
    ...
    @classmethod
    def get_instance_id(cls, collection_id: Text, version: int) -> Text:
    ...
    ) -> Tuple[List[CollectionCommitLogEntryModel], Optional[Text], bool]:
...
class CollectionModel(base_models.VersionedModel):
    ...
    @staticmethod
    def convert_to_valid_dict(model_dict: Dict[Text, Any]) -> Dict[Text, Any]:
    ...
    # remove Any from type-annotation below.
    def _reconstitute(self, snapshot_dict: Dict[Text, Any]) -> CollectionModel:
...
class CollectionRightsModel(base_models.VersionedModel):
    ...
    @classmethod
    def get_field_name_mapping_to_takeout_keys(cls) -> Dict[Text, Text]:
    ...
    def _reconstitute(self,
                      snapshot_dict: Dict[Text, Any]) -> CollectionRightsModel:
        """Populates the model instance with the snapshot.
    ...
    @classmethod
    def export_data(cls, user_id: Text) -> Dict[Text, List[Text]]:
...
class CollectionSummaryModel(base_models.BaseModel):
    ...
    def get_private_at_least_viewable(cls,
                                      user_id: Text) -> List[CollectionSummaryModel]:
