...
# NOTE: These values are from an external enum defined by Google Cloud Dataflow:
...
class BeamJobRunModel(base_models.BaseModel):
    ...
    job_arguments = datastore_services.StringProperty(
...
class BeamJobRunResultModel(base_models.BaseModel):
    ...
    # The field is repeated to make the cost of reading and writing cheaper for
    # Apache Beam jobs and our frontend.
