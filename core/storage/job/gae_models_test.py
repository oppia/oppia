...
class JobModelTest(test_utils.GenericTestBase):
    ...
    def test_is_cancelable(self) -> None:
        ...
        job = job_models.JobModel(id='MyJobId', status_code=job_models.STATUS_CODE_NEW)
...
class JobModelSetUpJobsTest(test_utils.GenericTestBase):
    ...
    def test_do_unfinished_jobs_exist(self) -> None:
        self.assertFalse(job_models.JobModel.do_unfinished_jobs_exist('JobType1'))
        self.assertTrue(job_models.JobModel.do_unfinished_jobs_exist('JobType2'))
        ...
        job2.put()
        self.assertFalse(job_models.JobModel.do_unfinished_jobs_exist('JobType2'))
