...
class AppFeedbackReportModelTests(test_utils.GenericTestBase):
    ...
    def test_create_raises_exception_by_mocking_collision(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception,
            'The id generator for AppFeedbackReportModel is '
    ...
    def test_export_data_without_scrubber(self) -> None:
        ...
        exported_data = app_feedback_report_models.AppFeedbackReportModel.export_data(
            'id'
        )
...
class AppFeedbackReportTicketModelTests(test_utils.GenericTestBase):
    ...
    def test_create_and_get_ticket_model(self) -> None:
        ticket_id = app_feedback_report_models.AppFeedbackReportTicketModel.generate_id(
            self.TICKET_NAME
        )
        ...
        ticket_model = app_feedback_report_models.AppFeedbackReportTicketModel.get(
            ticket_id
        )
...
class AppFeedbackReportStatsModelTests(test_utils.GenericTestBase):
    ...
    def test_create_and_get_stats_model(self) -> None:
        entity_id = app_feedback_report_models.AppFeedbackReportStatsModel.calculate_id(
        ...
        stats_model = app_feedback_report_models.AppFeedbackReportStatsModel.get_by_id(
            entity_id
        )
