...
class GeneralFeedbackThreadModel(base_models.BaseModel):
    ...
    def get_threads(
        ...
        """
        return cls.get_all().filter(cls.entity_type == entity_type
...
class GeneralFeedbackMessageModel(base_models.BaseModel):
    ...
    @overload
    @classmethod
    def get(cls, thread_id: str, message_id: int, *,
            strict: Literal[False]) -> Optional[GeneralFeedbackMessageModel]:
        ...
    ...
    def get(cls,
            ...
            message_id: int,
            *,
            strict: bool = ...) -> Optional[GeneralFeedbackMessageModel]:
        ...
    ...
    def get_messages(cls, thread_id: str) -> Sequence[GeneralFeedbackMessageModel]:
        ...
        Returns:
            ...
            messages.
        """
        return cls.get_all().filter(cls.thread_id == thread_id
...
class GeneralFeedbackThreadUserModel(base_models.BaseModel):
    ...
    @classmethod
    def create_multi(cls, user_id: str,
