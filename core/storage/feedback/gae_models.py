...
class GeneralFeedbackThreadModel(base_models.BaseModel):
    ...
    original_author_id = ndb.StringProperty()
    ...
    last_nonempty_message_text = ndb.TextProperty()
    ...
    # such message.
    last_nonempty_message_author_id = ndb.StringProperty()
...
class GeneralFeedbackMessageModel(base_models.BaseModel):
    ...
    updated_subject = ndb.TextProperty()
