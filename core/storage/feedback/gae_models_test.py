...
class FeedbackThreadModelTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        user_models.UserSettingsModel(
            id=self.NEW_USER_1_ID, email='some@email.com'
        ).put()
        user_models.UserSettingsModel(
            id=self.NEW_USER_2_ID, email='some_other@email.com'
        ).put()
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            feedback_models.GeneralFeedbackThreadModel.has_reference_to_user_id(
                self.USER_ID
            )
        )
        self.assertFalse(
    ...
    def test_raise_exception_by_mocking_collision(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'New thread id generator is producing too many collisions.'
        ):
            # Swap dependent method get_by_id to simulate collision every time.
            with self.swap(
                feedback_thread_model_cls,
...
class GeneralFeedbackMessageModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        ...
        self.assertTrue(
            feedback_models.GeneralFeedbackMessageModel.has_reference_to_user_id(
                'user_id'
            )
        )
        self.assertFalse(
            feedback_models.GeneralFeedbackMessageModel.has_reference_to_user_id('id_x')
        )
    ...
    def test_raise_exception_by_mocking_collision(self) -> None:
        ...
        with self.assertRaisesRegex(Exception, expected_exception_regexp):
            feedback_models.GeneralFeedbackMessageModel.create(
                feedback_domain.FullyQualifiedMessageIdentifier(thread_id, 0)
            )
    ...
    def test_get_all_messages(self) -> None:
        ...
        all_messages = feedback_models.GeneralFeedbackMessageModel.get_all_messages(
            2, None
        )
    ...
    def test_get_most_recent_message(self) -> None:
        ...
        message = feedback_models.GeneralFeedbackMessageModel.get_most_recent_message(
            thread_id
        )
    ...
    def test_export_data_trivial(self) -> None:
        user_data = feedback_models.GeneralFeedbackMessageModel.export_data(
            'non_existent_user'
        )
        test_data: Dict[str, str] = {}
        self.assertEqual(user_data, test_data)
    ...
    def test_export_data_nontrivial(self) -> None:
        ...
        test_export_author_id = self.get_user_id_from_email(
            'export_author_1@example.com'
        )
...
class FeedbackThreadUserModelTest(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        ...
        self.assertTrue(
            feedback_models.GeneralFeedbackThreadUserModel.has_reference_to_user_id(
                'user_id'
            )
        )
        self.assertFalse(
    ...
    def test_create_new_object(self) -> None:
        ...
        feedback_thread_user_model = feedback_models.GeneralFeedbackThreadUserModel.get(
            'user_id', 'exploration.exp_id.thread_id'
        )
        ...
        self.assertEqual(
            feedback_thread_user_model.id, 'user_id.exploration.exp_id.thread_id'
        )
        self.assertEqual(feedback_thread_user_model.user_id, 'user_id')
        self.assertEqual(
            feedback_thread_user_model.thread_id, 'exploration.exp_id.thread_id'
        )
    ...
    def test_get_multi(self) -> None:
        ...
        actual_models = feedback_models.GeneralFeedbackThreadUserModel.get_multi(
            'user_id',
            ['exploration.exp_id.thread_id_1', 'exploration.exp_id.thread_id_2'],
        )
    ...
    def test_delete_model_instance_of_user_by_applying_deletion_policy(self) -> None:
        feedback_models.GeneralFeedbackThreadUserModel.create(
            'user_id', 'exploration.exp_id.thread_id'
        )
...
class UnsentFeedbackEmailModelTest(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            feedback_models.UnsentFeedbackEmailModel.has_reference_to_user_id('user_id')
        )
        self.assertFalse(
            feedback_models.UnsentFeedbackEmailModel.has_reference_to_user_id('id_x')
        )
    ...
    def test_new_instances_stores_correct_data(self) -> None:
        ...
        retrieved_instance = feedback_models.UnsentFeedbackEmailModel.get_by_id(
            id=user_id
        )

        self.assertEqual(
            retrieved_instance.feedback_message_references, [message_reference_dict]
        )
