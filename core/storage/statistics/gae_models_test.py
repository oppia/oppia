...
class StartExplorationEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_create_and_get_event_models(self) -> None:
        event_id = stats_models.StartExplorationEventLogEntryModel.create(
            'exp_id1', 1, 'state_name1', 'session_id1', {}, feconf.PLAY_TYPE_NORMAL
        )
...
class MaybeLeaveExplorationEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_create_event_models(self) -> None:
        event_id = stats_models.MaybeLeaveExplorationEventLogEntryModel.create(
            'exp_id1', 1, 'state_name1', 'session_id1', 1.0, {}, feconf.PLAY_TYPE_NORMAL
        )
...
class CompleteExplorationEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_create_and_get_event_models(self) -> None:
        event_id = stats_models.CompleteExplorationEventLogEntryModel.create(
            'exp_id1', 1, 'state_name1', 'session_id1', 0.0, {}, feconf.PLAY_TYPE_NORMAL
        )
...
class LeaveForRefresherExplorationEventLogEntryModelUnitTests(
    ...
    def test_create_and_get_event_models(self) -> None:
        event_id = stats_models.LeaveForRefresherExplorationEventLogEntryModel.create(
            'exp_id1', 'exp_id2', 1, 'state_name1', 'session_id1', 0.0
        )

        event_model = stats_models.LeaveForRefresherExplorationEventLogEntryModel.get(
            event_id
        )
        ...
        self.assertEqual(event_model.time_spent_in_state_secs, 0.0)
        self.assertEqual(
            event_model.event_schema_version, feconf.CURRENT_EVENT_MODELS_SCHEMA_VERSION
        )
...
class LearnerAnswerDetailsModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_create_model_instance(self) -> None:
        ...
        model_instance = stats_models.LearnerAnswerDetailsModel.get_model_instance(
...
class StateAnswersModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_all_state_answer_models_of_a_single_shard(self) -> None:
        self.assertIsNone(
            stats_models.StateAnswersModel.get_all_models('exp_id', 1, 'state_name')
        )
    ...
    def test_get_all_state_answer_models_of_all_shards(self) -> None:
        ...
        with self.swap(stats_models.StateAnswersModel, '_MAX_ANSWER_LIST_BYTE_SIZE', 1):
            ...
            self.assertEqual(
                stat_answer_models[2].submitted_answer_list, submitted_answer_list2
            )
