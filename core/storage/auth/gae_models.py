...
class UserAuthDetailsModel(base_models.BaseModel):
    ...
    @staticmethod
    def get_field_names_for_takeout() -> Dict[Text, Text]:
    ...
    @classmethod
    def export_data(cls, user_id: Text) -> Dict[Text, Text]:
    ...
    @classmethod
    def apply_deletion_policy(cls, user_id: Text) -> None:
...
class FirebaseSeedModel(base_models.BaseModel):
    ...
    @classmethod
    def has_reference_to_user_id(cls, unused_user_id: Text) -> bool:
        """Model does not correspond to any users."""
        return False
