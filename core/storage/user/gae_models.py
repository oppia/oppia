...
class UserContributionProficiencyModel(base_models.BaseModel):
    ...
    def create(
        ...
        if cls.get_by_id(instance_id):
            raise Exception(
                'There is already a UserContributionProficiencyModel entry with the given id: %s'
                % instance_id
            )
...
class UserContributionRightsModel(base_models.BaseModel):
    ...
    def get_question_reviewer_user_ids(cls) -> List[str]:
        ...
        Returns:
            ...
            questions.
        """
        reviewer_keys = cls.query(cls.can_review_questions).fetch(
            keys_only=True
        )
        return [reviewer_key.id() for reviewer_key in reviewer_keys]
    ...
    def get_question_submitter_user_ids(cls) -> List[str]:
        ...
        Returns:
            ...
            questions.
        """
        contributor_keys = cls.query(cls.can_submit_questions).fetch(
            keys_only=True
        )
...
class PinnedOpportunityModel(base_models.BaseModel):
    ...
    def create(
        ...
        if cls.get_by_id(instance_id):
            raise Exception(
                'There is already a pinned opportunity with the given id: %s'
                % instance_id
            )
