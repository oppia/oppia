...
class UserSettingsModel(base_models.BaseModel):
    ...
    last_started_state_translation_tutorial = datastore_services.DateTimeProperty(
        default=None
    )
    ...
    def is_normalized_username_taken(cls, normalized_username: str) -> bool:
        ...
        return (
            cls.query().filter(cls.normalized_username == normalized_username).get()
            is not None
            or DeletedUsernameModel.get(hashed_normalized_username, strict=False)
            is not None
        )
    ...
    def get_by_normalized_username(
        ...
        """
        return (
            cls.get_all().filter(cls.normalized_username == normalized_username).get()
        )
...
class UserSubscriptionsModel(base_models.BaseModel):
    ...
    def has_reference_to_user_id(cls, user_id: str) -> bool:
        ...
        """
        return (
            cls.query(cls.creator_ids == user_id).get(keys_only=True) is not None
...
class UserSubscribersModel(base_models.BaseModel):
    ...
    def has_reference_to_user_id(cls, user_id: str) -> bool:
        ...
        """
        return (
            cls.query(cls.subscriber_ids == user_id).get(keys_only=True) is not None
            or cls.get_by_id(user_id) is not None
        )
...
class UserContributionRightsModel(base_models.BaseModel):
    ...
    can_review_translation_for_language_codes = datastore_services.StringProperty(
        repeated=True, indexed=True
    )
...
class LearnerGroupsUserModel(base_models.BaseModel):
    ...
    learner_groups_user_details_schema_version = datastore_services.IntegerProperty(
