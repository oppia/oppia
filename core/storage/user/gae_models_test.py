...
class UserSettingsModelTest(test_utils.GenericTestBase):
    ...
    def test_export_data(self):
        ...
        self.assertEqual(user.first_contribution_msec,
                         user_data['first_contribution_msec'])
        self.assertEqual(user.preferred_language_codes,
                         user_data['preferred_language_codes'])
        self.assertequal(user.preferred_site_language_code,
                         user_data['preferred_site_language_code'])
        self.assertEqual(user.preferred_audio_language_code,
