...
class UserSettingsModelTest(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_registered_user_id_is_true(self) -> None:
        # Case for a full user.
        self.assertTrue(
            user_models.UserSettingsModel.has_reference_to_user_id(self.USER_1_ID)
        )

        # Case for a profile user.
        self.assertTrue(
            user_models.UserSettingsModel.has_reference_to_user_id(self.PROFILE_1_ID)
        )

        # Case for a banned full user.
        self.assertTrue(
            user_models.UserSettingsModel.has_reference_to_user_id(self.USER_2_ID)
        )
    ...
    def test_get_normalized_username_invalid_username(self) -> None:
        ...
        self.assertIsNone(
            user_models.UserSettingsModel.get_by_normalized_username(invalid_username)
        )

    def test_get_by_email_valid_user(self) -> None:
        actual_user = user_models.UserSettingsModel.get_by_id(self.USER_3_ID)
        self.assertEqual(
            user_models.UserSettingsModel.get_by_email(self.USER_3_EMAIL), actual_user
        )

    def test_get_by_email_invalid_user(self) -> None:
        self.assertIsNone(
            user_models.UserSettingsModel.get_by_email('invalid_user@example.com')
        )
...
class LearnerGoalsModelTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        user_models.LearnerGoalsModel(
            id=self.USER_1_ID, topic_ids_to_learn=self.TOPIC_IDS, topic_ids_to_master=[]
        ).put()
        user_models.LearnerGoalsModel(
            id=self.USER_2_ID,
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.LearnerGoalsModel.has_reference_to_user_id(self.USER_1_ID)
        )
        self.assertTrue(
            user_models.LearnerGoalsModel.has_reference_to_user_id(self.USER_2_ID)
        )
        self.assertFalse(
...
class LearnerPlaylistModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.LearnerPlaylistModel.has_reference_to_user_id(self.USER_ID_1)
        )
        self.assertTrue(
            user_models.LearnerPlaylistModel.has_reference_to_user_id(self.USER_ID_2)
        )
        self.assertFalse(
...
class UserContributionsModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.UserContributionsModel.has_reference_to_user_id(self.user_a_id)
        )
        self.assertTrue(
            user_models.UserContributionsModel.has_reference_to_user_id(self.USER_C_ID)
        )
        self.assertFalse(
...
class UserSubscriptionsModelTests(test_utils.GenericTestBase):
    ...
    def test_exclude_non_existing_creator_user_model_while_exporting_data(self) -> None:
    ...
    def test_get_field_names_for_takeout(self) -> None:
        self.assertEqual(
            ...
            {'creator_ids': 'creator_usernames', 'last_checked': 'last_checked_msec'},
        )
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.UserSubscriptionsModel.has_reference_to_user_id(self.USER_ID_1)
        )
        self.assertTrue(
            user_models.UserSubscriptionsModel.has_reference_to_user_id(self.USER_ID_2)
        )
        self.assertFalse(
            user_models.UserSubscriptionsModel.has_reference_to_user_id(self.USER_ID_3)
        )
        self.assertTrue(
            user_models.UserSubscriptionsModel.has_reference_to_user_id(self.USER_ID_4)
        )
        self.assertTrue(
            user_models.UserSubscriptionsModel.has_reference_to_user_id(self.USER_ID_5)
        )
        self.assertTrue(
            user_models.UserSubscriptionsModel.has_reference_to_user_id(self.USER_ID_6)
        )
        self.assertFalse(
...
class UserSubscribersModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.UserSubscribersModel.has_reference_to_user_id(self.USER_ID_1)
        )
        self.assertTrue(
            user_models.UserSubscribersModel.has_reference_to_user_id(self.USER_ID_2)
        )
        self.assertTrue(
            user_models.UserSubscribersModel.has_reference_to_user_id(self.USER_ID_3)
        )
        self.assertFalse(
...
class ExplorationUserDataModelTest(test_utils.GenericTestBase):
    ...
    def test_get_success(self) -> None:
        ...
        self.assertEqual(
            retrieved_object.draft_change_list_last_updated, self.DATETIME_OBJECT
        )
...
class CollectionProgressModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.CollectionProgressModel.has_reference_to_user_id(self.USER_ID_1)
        )
        self.assertTrue(
            user_models.CollectionProgressModel.has_reference_to_user_id(self.USER_ID_2)
        )
        self.assertTrue(
            user_models.CollectionProgressModel.has_reference_to_user_id(self.USER_ID_3)
        )
        self.assertFalse(
    ...
    def test_create_collection_progress_model_success(self) -> None:
        ...
        self.assertEqual(retrieved_object.user_id, self.USER_ID_1)
        self.assertEqual(
            retrieved_object.id, '%s.%s' % (self.USER_ID_1, self.COLLECTION_ID_1)
        )
    ...
    def test_get_collection_progress_model_success(self) -> None:
        ...
        assert retrieved_object is not None
        self.assertEqual(
            retrieved_object.id, '%s.%s' % (self.USER_ID_1, self.COLLECTION_ID_2)
        )
        self.assertEqual(retrieved_object.user_id, self.USER_ID_1)
        self.assertEqual(retrieved_object.collection_id, self.COLLECTION_ID_2)
        self.assertEqual(
            retrieved_object.completed_explorations, self.COMPLETED_EXPLORATION_IDS_2
        )
    ...
    def test_get_multiple_collection_progress_model_success(self) -> None:
        ...
        self.assertEqual(
            retrieved_object[0].id, '%s.%s' % (self.USER_ID_1, self.COLLECTION_ID_1)
        )
        ...
        self.assertEqual(
            retrieved_object[1].id, '%s.%s' % (self.USER_ID_1, self.COLLECTION_ID_2)
        )
...
class StoryProgressModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.StoryProgressModel.has_reference_to_user_id(self.USER_ID_1)
        )
        self.assertTrue(
            user_models.StoryProgressModel.has_reference_to_user_id(self.USER_ID_2)
        )
        self.assertTrue(
            user_models.StoryProgressModel.has_reference_to_user_id(self.USER_ID_3)
        )
        self.assertFalse(
...
class UserQueryModelTests(test_utils.GenericTestBase):
    ...
    def test_instance_stores_correct_data(self) -> None:
        ...
        self.assertEqual(
            query_model.has_not_logged_in_for_n_days, has_not_logged_in_for_n_days
        )
...
class UserBulkEmailsModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.UserBulkEmailsModel.has_reference_to_user_id(self.USER_ID_1)
        )
        self.assertTrue(
            user_models.UserBulkEmailsModel.has_reference_to_user_id(self.USER_ID_2)
        )
        self.assertFalse(
...
class UserSkillMasteryModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.UserSkillMasteryModel.has_reference_to_user_id(self.USER_1_ID)
        )
        self.assertTrue(
            user_models.UserSkillMasteryModel.has_reference_to_user_id(self.USER_2_ID)
        )
        self.assertFalse(
    ...
    def test_construct_model_id(self) -> None:
        constructed_model_id = user_models.UserSkillMasteryModel.construct_model_id(
            self.USER_1_ID, self.SKILL_ID_1
        )
...
class UserContributionProficiencyModelTests(test_utils.GenericTestBase):
    ...
    def test_apply_deletion_policy(self) -> None:
        ...
        self.assertIsNone(
            user_models.UserContributionProficiencyModel.query(
                user_models.UserContributionProficiencyModel.user_id == self.USER_1_ID
            ).get()
        )
        # Test that calling apply_deletion_policy with no existing model
        # doesn't fail.
    ...
    def test_create_model(self) -> None:
        ...
        score_models = (
            user_models.UserContributionProficiencyModel.get_all_scores_of_user('user1')
        )
...
class UserContributionRightsModelTests(test_utils.GenericTestBase):
    ...
    def test_get_voiceover_reviewer_user_ids(self) -> None:
        voiceover_reviewer_ids = (
            user_models.UserContributionRightsModel.get_voiceover_reviewer_user_ids(
                'hi'
            )
        )
...
class PendingDeletionRequestModelTests(test_utils.GenericTestBase):
    ...
    def test_apply_deletion_policy_nonexistent_user_raises_no_exception(self) -> None:
        self.assertIsNone(
            user_models.PendingDeletionRequestModel.get_by_id(self.NONEXISTENT_USER_ID)
        )
...
class DeletedUserModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.DeletedUserModel.has_reference_to_user_id(self.USER_1_ID)
        )
        self.assertFalse(
...
class LearnerGroupsUserModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertFalse(
            user_models.LearnerGroupsUserModel.has_reference_to_user_id(self.USER_ID_1)
        )
        self.assertFalse(
            user_models.LearnerGroupsUserModel.has_reference_to_user_id(self.USER_ID_2)
        )
        self.assertFalse(
        ...
        user_models.LearnerGroupsUserModel(
            ...
            learner_groups_user_details=[
                {'group_id': 'group_id_3', 'progress_sharing_is_turned_on': False},
                {'group_id': 'group_id_4', 'progress_sharing_is_turned_on': True},
            ],
        ).put()
        user_models.LearnerGroupsUserModel(
            id=self.USER_ID_2,
...
class PinnedOpportunityModelTest(test_utils.GenericTestBase):
    ...
    def test_create_raises_exception_for_existing_instance(self) -> None:
        with self.assertRaisesRegex(
            Exception, 'There is already a pinned opportunity' ' with the given id:'
        ):
            user_models.PinnedOpportunityModel.create(
                user_id=self.user_id,
                language_code=self.language_code,
    ...
    def test_has_reference_to_user_id(self) -> None:
        self.assertTrue(
            user_models.PinnedOpportunityModel.has_reference_to_user_id(self.user_id)
        )
