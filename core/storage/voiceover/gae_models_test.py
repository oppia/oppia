...
class VoiceArtistMetadataModelTests(test_utils.GenericTestBase):
    ...
    def test_has_reference_to_user_id(self) -> None:
        user_id = 'user_id'
        self.assertFalse(
            voiceover_models.VoiceArtistMetadataModel.has_reference_to_user_id(
                user_id
            )
        )
    ...
    def test_export_data_trivial(self) -> None:
        ...
        user_data = voiceover_models.VoiceArtistMetadataModel.export_data(
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            voiceover_models.VoiceArtistMetadataModel.get_model_association_to_user(),
    ...
    def test_should_create_model_successfully(self) -> None:
        ...
        self.assertEqual(voice_artist_metadata_model.id, retrieved_model.id)
        self.assertDictEqual(
...
class ExplorationVoiceArtistsLinkModelTests(test_utils.GenericTestBase):
    ...
    def test_get_get_export_policy(self) -> None:
        ...
        self.assertDictEqual(
            voiceover_models.ExplorationVoiceArtistsLinkModel.get_export_policy(),
            expected_export_policy_dict,
        )
    ...
    def test_get_deletion_policy_is_to_keep(self) -> None:
        self.assertEqual(
            voiceover_models.ExplorationVoiceArtistsLinkModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )

    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            voiceover_models.ExplorationVoiceArtistsLinkModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_should_create_model_successfully(self) -> None:
        ...
        content_id_to_voiceovers_mapping = {
            'content_1': {'en': ('voice_artist_id_1', voiceover1)},
            'content_2': {'hi': ('voice_artist_id_2', voiceover2)},
        }
        ...
        retrieved_model = voiceover_models.ExplorationVoiceArtistsLinkModel.get(
        ...
        self.assertDictEqual(
            exploration_voice_artist_link_model.content_id_to_voiceovers_mapping,
