...
ACTION_PLAY_ANY_PRIVATE_COLLECTION = 'PLAY_PRIVATE_COLLECTION'
ACTION_PLAY_ANY_PUBLIC_COLLECTION = 'PLAY_PUBLIC_COLLECTION'
ACTION_PLAY_ANY_PRIVATE_EXPLORATION = 'PLAY_PRIVATE_EXPLORATION'
ACTION_PLAY_ANY_PUBLIC_EXPLORATION = 'PLAY_PUBLIC_EXPLORATION'
