...
ACTION_DELETE_OWNED_BLOG_POST = 'DELETE_BLOG_POST'
...
ACTION_EDIT_OWNED_BLOG_POST = 'EDIT_BLOG_POST'
...
ACTION_PUBLISH_ANY_BLOG_POST = 'PUBLISH_ANY_BLOG_POST'
ACTION_PUBLISH_OWNED_BLOG_POST= 'PUBLISH_BLOG_POST'
...
ACTION_UNPUBLISH_ANY_BLOG_POST = 'UNPUBLISH_ANY_BLOG_POST'
ACTION_UNPUBLISH_OWNED_BLOG_POST = 'UNPUBLISH_BLOG_POST'
...
_BLOG_POST_EDITOR_ALLOWED_ACTIONS = _get_unique_actions_list(
    ...
    ACTION_DELETE_OWNED_BLOG_POST,
    ACTION_EDIT_OWNED_BLOG_POST,
    ACTION_PUBLISH_OWNED_BLOG_POST,
    ACTION_UNPUBLISH_OWNED_BLOG_POST,
    *_EXPLORATION_EDITOR_ALLOWED_ACTIONS)
...
_BLOG_ADMIN_ALLOWED_ACTIONS = _get_unique_actions_list(
    ...
    ACTION_PUBLISH_ANY_BLOG_POST,
    ACTION_UNPUBLISH_ANY_BLOG_POST,
    *_EXPLORATION_EDITOR_ALLOWED_ACTIONS)
