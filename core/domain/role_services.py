...
ACTION_MANAGE_CONTRIBUTORS = 'MANAGE_CONTRIBUTORS'
...
UPDATABLE_ROLES = [
    ...
    feconf.ROLE_ID_CONTRIBUTOR_DASHBOARD_QUESTION_ADMIN,
    feconf.ROLE_ID_CONTRIBUTOR_DASHBOARD_TRANSLATION_ADMIN,
...
HUMAN_READABLE_ROLES = {
    ...
    feconf.ROLE_ID_CONTRIBUTOR_DASHBOARD_QUESTION_ADMIN: (
        'contributor dashboard question admin'),
    feconf.ROLE_ID_CONTRIBUTOR_DASHBOARD_TRANSLATION_ADMIN: (
        'contributor dashboard translation admin')
...
_CONTRIBUTOR_DASHBOARD_ADMIN_ALLOWED_ACTIONS = _get_unique_actions_list(
    ACTION_MANAGE_CONTRIBUTORS,
    *_EXPLORATION_EDITOR_ALLOWED_ACTIONS)
...
_ROLE_ACTIONS = {
    ...
    feconf.ROLE_ID_CONTRIBUTOR_DASHBOARD_TRANSLATION_ADMIN: (
        _CONTRIBUTOR_DASHBOARD_TRANSLATION_ADMIN_ALLOWED_ACTIONS),
    feconf.feconf.ROLE_ID_CONTRIBUTOR_DASHBOARD_QUESTION_ADMIN: (
        _CONTRIBUTOR_DASHBOARD_QUESTION_ADMIN_ALLOWED_ACTIONS)
