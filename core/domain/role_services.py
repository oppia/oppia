...
ACTION_PLAY_PRIVATE_COLLECTION = 'PLAY_PRIVATE_COLLECTION'
ACTION_PLAY_PUBLIC_COLLECTION = 'PLAY_PUBLIC_COLLECTION'
ACTION_PLAY_PRIVATE_EXPLORATION = 'PLAY_PRIVATE_EXPLORATION'
ACTION_PLAY_PUBLIC_EXPLORATION = 'PLAY_PUBLIC_EXPLORATION'
...
ROLE_ACTIONS = {
    ...
    feconf.ROLE_ID_GUEST: [
        ACTION_PLAY_PUBLIC_COLLECTION,
        ACTION_PLAY_PUBLIC_EXPLORATION,
    ],
    feconf.ROLE_ID_MODERATOR: [
        ACTION_PLAY_PRIVATE_COLLECTION,
        ACTION_PLAY_PRIVATE_EXPLORATION,
    ],
    feconf.ROLE_ID_SUPER_ADMIN: [
    ]
}
