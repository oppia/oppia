...
ACTION_PUBLICIZE_ANY_EXPLORATION = 'PUBLICIZE_ANY_EXPLORATION'
...
ACTION_UNPUBLICIZE_ANY_EXPLORATION = 'UNPUBLICIZE_ANY_EXPLORATION'
...
ROLE_ACTIONS = {
    ...
    feconf.ROLE_ID_MODERATOR: [
        ...
        ACTION_PUBLICIZE_ANY_EXPLORATION,
        ACTION_SEND_MODERATOR_EMAILS,
        ACTION_UNPUBLICIZE_ANY_EXPLORATION,
