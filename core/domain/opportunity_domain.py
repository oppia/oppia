...
class OverallLanguageTranslationStats:
    ...
    def __init__(
            self, language_code, language_description, cards_count, start_date,
            end_date):
        ...
        Args:
            ...
            cards_count: int. The number of cards(node_content) translated to
                the language from start_date to end_date.
            start_date: date. Date on which translated cards count was recorded.
            end_date: date. Date on which translated cards count was recorded.
        """
    ...
    def get_language_translations_data(self, start_date, end_date):
        """Fetches the language translation stats from
        OverallTranslationStatsModel.

        Returns:
            List(OverallLanguageTranslationStats). A List containing
            OverallLanguageTranslationStats items.
        """
