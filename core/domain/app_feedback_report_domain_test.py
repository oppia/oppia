...
class AppFeedbackReportDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        android_device_system_context = (
            app_feedback_report_domain.AndroidDeviceSystemContext(
                ...
                ANDROID_DEVICE_MODEL, ANDROID_SDK_VERSION, ANDROID_BUILD_FINGERPRINT,
                NETWORK_WIFI
            )
        )
        ...
        android_app_context = (
            app_feedback_report_domain.AndroidAppContext(
                ...
                LANGUAGE_LOCALE_CODE_ENGLISH, ANDROID_TEXT_SIZE, True, False, False,
        ...
        self.web_report_obj = app_feedback_report_domain.AppFeedbackReport(
            self.web_report_id, ANDROID_REPORT_INFO_SCHEMA_VERSION, PLATFORM_WEB,
            REPORT_SUBMITTED_TIMESTAMP, 0, TICKET_ID, None, web_user_supplied_feedback,
    ...
    def test_report_scrubber_id_is_invalid_validation_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.android_report_obj, 'The scrubbed_by user id \'%s\' is invalid.' %
    ...
    def test_android_report_system_context_invalid_type_validation_fails(self) -> None:
        ...
        self._assert_validation_error(
            self.android_report_obj, 'Expected device and system context to be of type '
    ...
    def _assert_validation_error(
        self, report_obj: app_feedback_report_domain.AppFeedbackReport,
...
class UserSuppliedFeedbackDomainTests(test_utils.GenericTestBase):
    ...
    def _assert_validation_error(
        self, feedback_obj: app_feedback_report_domain.UserSuppliedFeedback,
        expected_error_substring: str
    ) -> None:
...
class AndroidDeviceSystemContextTests(test_utils.GenericTestBase):
    ...
    def _assert_validation_error(
        self, context_obj: app_feedback_report_domain.AndroidDeviceSystemContext,
        expected_error_substring: str
    ) -> None:
    ...
    def setUp(self) -> None:
        ...
        self.entry_point = (
            app_feedback_report_domain.EntryPoint(
                app_feedback_report_constants.EntryPoint.NAVIGATION_DRAWER, 'topic_id',
                'story_id', 'exploration_id', 'subtopic_id'
            )
        )
...
class LessonPlayerEntryPointDomainTests(test_utils.GenericTestBase):
    ...
    def test_validation_name_is_invalid_fails(self) -> None:
        self.entry_point.entry_point_name = 'invalid_entry_point_name'
        self._assert_validation_error(
            self.entry_point, 'Expected entry point name %s' %
            (app_feedback_report_constants.EntryPoint.LESSON_PLAYER.value)
        )
    ...
    def _assert_validation_error(
        self, entry_point_obj: app_feedback_report_domain.LessonPlayerEntryPoint,
        expected_error_substring: str
    ) -> None:
...
class RevisionCardEntryPointDomainTests(test_utils.GenericTestBase):
    ...
    def _assert_validation_error(
        self, entry_point_obj: app_feedback_report_domain.RevisionCardEntryPoint,
        expected_error_substring: str
    ) -> None:
        """Checks that the entry point passes validation.
...
class AndroidAppContextDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.app_context = (
            app_feedback_report_domain.AndroidAppContext(
                entry_point, LANGUAGE_LOCALE_CODE_ENGLISH, LANGUAGE_LOCALE_CODE_ENGLISH,
                ANDROID_TEXT_SIZE, True, False, False, EVENT_LOGS, LOGCAT_LOGS
            )
        )
    ...
    def _assert_validation_error(
        self, app_context_obj: app_feedback_report_domain.AndroidAppContext,
        expected_error_substring: str
    ) -> None:
...
class AppFeedbackReportTicketDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.android_report_obj = app_feedback_report_domain.AppFeedbackReport(
            self.android_report_id, ANDROID_REPORT_INFO_SCHEMA_VERSION,
            PLATFORM_ANDROID, REPORT_SUBMITTED_TIMESTAMP, 0, self.ticket_id, None,
            android_user_supplied_feedback, android_device_system_context,
            android_app_context
        )
...
class AppFeedbackReportDailyStatsDomainTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        app_feedback_report_models.AppFeedbackReportModel.create(
            self.android_report_id, PLATFORM_ANDROID, REPORT_SUBMITTED_TIMESTAMP, 0,
            REPORT_TYPE_SUGGESTION.value, CATEGORY_SUGGESTION_OTHER.value,
            ANDROID_PLATFORM_VERSION, COUNTRY_LOCALE_CODE_INDIA, ANDROID_SDK_VERSION,
            ANDROID_DEVICE_MODEL, ENTRY_POINT_NAVIGATION_DRAWER, None, None, None, None,
...
class ReportStatsParameterValueCountsDomainTests(test_utils.GenericTestBase):
    ...
    def _assert_validation_error(
        self, counts_obj: (app_feedback_report_domain.ReportStatsParameterValueCounts),
        expected_error_substring: str
    ) -> None:
...
class AppFeedbackReportFilterDomainTests(test_utils.GenericTestBase):
    ...
    def _assert_validation_error(
        self, filter_obj: app_feedback_report_domain.AppFeedbackReportFilter,
        expected_error_substring: str
    ) -> None:
