...
class ExplorationStats:
    ...
    def __init__(
        ...
        num_completions_v2: int, state_stats_mapping: Dict[str, StateStats]
    ) -> None:
    ...
    @classmethod
    def create_default(
        cls, exp_id: str, exp_version: int, state_stats_mapping: Dict[str, StateStats]
    ) -> ExplorationStats:
    ...
    def validate(self) -> None:
        ...
        exploration_stats_properties: List[Literal['num_starts_v1', 'num_starts_v2',
        ...
        if not isinstance(self.exp_version, int):
            raise utils.ValidationError(
                'Expected exp_version to be an int, received %s' % (self.exp_version)
            )
    ...
    def clone(self) -> ExplorationStats:
        ...
        return ExplorationStats(
            self.exp_id, self.exp_version, self.num_starts_v1, self.num_starts_v2,
...
class StateStats:
    ...
    def __init__(
        ...
        num_completions_v1: int, num_completions_v2: int
    ) -> None:
    ...
    def validate(self) -> None:
        ...
        state_stats_properties = [
            ...
            'first_hit_count_v2', 'num_times_solution_viewed_v2', 'num_completions_v1',
            'num_completions_v2'
        ]
    ...
    def clone(self) -> StateStats:
        ...
        return StateStats(
            ...
            self.total_hit_count_v1, self.total_hit_count_v2, self.first_hit_count_v1,
            self.first_hit_count_v2, self.num_times_solution_viewed_v2,
            self.num_completions_v1, self.num_completions_v2
        )
...
class SessionStateStats:
    ...
    def __init__(
        ...
        total_hit_count: int, first_hit_count: int, num_times_solution_viewed: int,
        num_completions: int
    ):
    ...
    def validate_aggregated_stats_dict(
        ...
        exploration_stats_properties = [
            'num_starts', 'num_actual_starts', 'num_completions'
        ]
        state_stats_properties = [
            'total_answers_count', 'useful_feedback_count', 'total_hit_count',
        ...
        for state_name in state_stats_mapping:
            for state_stats_property in state_stats_properties:
                ...
                if not isinstance(state_stats_mapping[state_name][state_stats_property],
                    ...
                    raise utils.ValidationError(
                        'Expected %s to be an int, received %s' %
                        (state_stats_property, state_stats[state_stats_property])
                    )
...
class ExplorationIssues:
    ...
    def __init__(
        self, exp_id: str, exp_version: int, unresolved_issues: List[ExplorationIssue]
    ) -> None:
    ...
    def to_dict(self) -> ExplorationIssuesDict:
        ...
        unresolved_issue_dicts = [
            unresolved_issue.to_dict() for unresolved_issue in self.unresolved_issues
        ]
        return {
            'exp_id': self.exp_id,
            'exp_version': self.exp_version,
    ...
    def from_dict(cls, exp_issues_dict: ExplorationIssuesDict) -> ExplorationIssues:
        ...
        return cls(
            exp_issues_dict['exp_id'], exp_issues_dict['exp_version'], unresolved_issues
        )
    ...
    def validate(self) -> None:
        ...
        if not isinstance(self.exp_id, str):
            raise utils.ValidationError(
                'Expected exp_id to be a string, received %s' % type(self.exp_id)
            )
...
class Playthrough:
    ...
    def from_dict(cls, playthrough_data: PlaythroughDict) -> Playthrough:
        ...
        playthrough = cls(
            ...
            playthrough_data['issue_customization_args'], actions
        )
    ...
    def validate(self) -> None:
        ...
        if not isinstance(self.actions, list):
            raise utils.ValidationError(
                'Expected actions to be a list, received %s' % (type(self.actions))
            )
...
class ExplorationIssue:
    ...
    def __init__(
        self, issue_type: str,
        issue_customization_args: IssuesCustomizationArgsDictType,
        playthrough_ids: List[str], schema_version: int, is_valid: bool
    ):
    ...
    def from_dict(cls, exp_issue_dict: ExplorationIssueDict) -> ExplorationIssue:
        ...
        exp_issue = cls(
            exp_issue_dict['issue_type'], exp_issue_dict['issue_customization_args'],
            exp_issue_dict['playthrough_ids'], exp_issue_dict['schema_version'],
    ...
    def _convert_issue_v1_dict_to_v2_dict(
        cls, issue_dict: Dict[str, Union[str, Dict[str, Dict[str, str]], List[str], int,
                                         bool]]
    ) -> None:
...
class LearnerAction:
    ...
    def __init__(
        ...
        action_customization_args: Dict[str, Dict[str, Union[str,
                                                             int]]], schema_version: int
    ):
    ...
    def from_dict(cls, action_dict: LearnerActionDict) -> LearnerAction:
        ...
        """
        return cls(
            action_dict['action_type'], action_dict['action_customization_args'],
    ...
    def validate(self) -> None:
        ...
        if self.schema_version > feconf.CURRENT_STATE_ANSWERS_SCHEMA_VERSION:
            raise utils.ValidationError(
                ...
                '(%d): %d' %
                (feconf.CURRENT_STATE_ANSWERS_SCHEMA_VERSION, self.schema_version)
            )
...
class SubmittedAnswer:
    ...
    def validate(self) -> None:
        ...
        valid_classification_categories = [
            exp_domain.EXPLICIT_CLASSIFICATION, exp_domain.TRAINING_DATA_CLASSIFICATION,
...
class AnswerOccurrence:
    ...
    def from_raw_type(
        ...
        """
        return cls(
            answer_occurrence_dict['answer'], answer_occurrence_dict['frequency']
        )
...
class CategorizedAnswerFrequencyLists(AnswerCalculationOutput):
    ...
    def __init__(
        ...
        self.categorized_answer_freq_lists = (
            categorized_answer_freq_lists if categorized_answer_freq_lists else {}
        )
...
class StateAnswersCalcOutput:
    ...
    def __init__(
        self, exploration_id: str, exploration_version: int, state_name: str,
        interaction_id: str, calculation_id: str,
    ...
    def from_dict(
        ...
        return cls(
            ...
            learner_answer_details_dict['interaction_id'], [
                ...
                learner_answer_details_dict['learner_answer_info_list']
...
class LearnerAnswerInfo:
    ...
    def __init__(
        self, learner_answer_info_id: str,
        answer: Optional[Union[str, int, Dict[str, str], List[str]]],
        answer_details: str, created_on: datetime.datetime
    ) -> None:
    ...
    def from_dict(
        ...
        return cls(
            learner_answer_info_dict['id'], learner_answer_info_dict['answer'],
