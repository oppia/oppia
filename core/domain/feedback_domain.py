...
class FeedbackThread(object):
    ...
    Attributes:
        ...
        has_suggestion: bool. Whether the feedback thread includes a
            suggestion.
        created_on: str. The date on which the feedback thread was created.
        last_updated: str. The date on which the feedback thread was last
            updated.
    """
...
# TODO: Fix this here
    def to_dict(self):
        """Returns total thread count and open thread count

        Attributes:
            dict. Dict representation of the number of the total number of
                threads and number of open threads.
...
class Suggestion(object):
    ...
    Attributes:
        ...
        # TODO: find out more about state_content
        """
