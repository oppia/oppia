...
def get_translation_submitter_total_stats(
    ...
    Returns:
        3-tuple(sorted_results, next_offset, more). where:
                sorted_results:
                    ...
                    language_code, topic_ids, max_days_since_first_activity
    ...
    translation_submitter_models, next_offset, more = (
        ...
        .fetch_page(
            ...
            sort_by=sort_by,
            topic_ids=topic_ids,
            max_days_since_first_activity=max_days_since_first_activity,
    ...
    Returns:
        3-tuple(sorted_results, next_offset, more). where:
            sorted_results:
                ...
                The list of domain objects which match the supplied
                language_code, max_days_since_first_activity and
    ...
    Returns:
        3-tuple(sorted_results, next_offset, more). where:
            sorted_results:
                ...
                max_days_since_first_activity and max_days_since_last_activity
