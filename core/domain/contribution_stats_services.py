...
def get_translation_submitter_total_stats_from_model(
    translation_submitter_model: suggestion_models.
...
def get_translation_reviewer_total_stats_from_model(
    translation_reviewer_model: suggestion_models.
...
def get_question_submitter_total_stats_from_model(
    question_submitter_model: suggestion_models.
...
def get_question_reviewer_total_stats_from_model(
    question_reviewer_model: suggestion_models.
...
def get_translation_submitter_total_stats(
    page_size: int, offset: int, language_code: str, sort_by: Optional[str],
    topic_ids: Optional[List[str]], max_days_since_last_activity: Optional[int]
) -> Tuple[List[suggestion_registry.TranslationSubmitterTotalContributionStats], int,
           bool]:
...
) -> Tuple[List[suggestion_registry.TranslationReviewerTotalContributionStats], int,
           bool]:
    """Returns the list of domain objects according to values specified.
...
def get_question_submitter_total_stats(
    page_size: int, offset: int, sort_by: Optional[str], topic_ids: Optional[List[str]],
    max_days_since_last_activity: Optional[int]
) -> Tuple[List[suggestion_registry.QuestionSubmitterTotalContributionStats], int,
           bool]:
    """Returns the list of domain objects according to values specified.
...
def get_question_reviewer_total_stats(
    page_size: int, offset: int, sort_by: Optional[str],
    max_days_since_last_activity: Optional[int]
...
def get_all_translation_coordinator_stats(
    ...
    if sort == (
        ...
        translation_coordinator_models = (
            ...
            order(-model_class.coordinators_count).fetch()
        )
    return [
