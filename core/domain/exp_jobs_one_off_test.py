...
class TestDeleteStateIdMappingModelsOneOffJobs(test_utils.GenericTestBase):
    ...
    def test_job_deletes_all_instances_of_model(self):
        ...
        job_id = (
            exp_jobs_one_off.DeleteStateIdMappingModelsOneOffJobs.create_new())
        exp_jobs_one_off.DeleteStateIdMappingModelsOneOffJobs.enqueue(job_id)
