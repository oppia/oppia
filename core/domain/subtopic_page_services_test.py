...
class SubtopicPageServicesUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.subtopic_page_id = subtopic_page_domain.SubtopicPage.get_subtopic_page_id(
            self.TOPIC_ID, 1
        )
    ...
    def test_get_subtopic_page_contents_by_id(self) -> None:
        ...
        expected_page_contents_dict = {
            'subtitled_html': {'content_id': 'content', 'html': '<p>hello world</p>'},
        ...
        subtopic_page_content = subtopic_page_services.get_subtopic_page_contents_by_id(
    ...
    def test_save_subtopic_page(self) -> None:
        ...
        subtopic_page_id_1 = subtopic_page_domain.SubtopicPage.get_subtopic_page_id(
            'topic_id_1', 1
        )
    ...
    def test_migrate_page_contents_from_v1_to_v2_schema(self) -> None:
        ...
        page_contents_dict = {
            'subtitled_html': {'content_id': 'content_0', 'html': html_content},
            'recorded_voiceovers': recorded_voiceovers,
    ...
    def test_get_multi_users_subtopic_pages_progress(self) -> None:
        ...
        progress = subtopic_page_services.get_multi_users_subtopic_pages_progress(
    ...
    def test_populate_subtopic_page_model_fields(self) -> None:
        ...
        populated_model = subtopic_page_services.populate_subtopic_page_model_fields(
            model, subtopic_page
        )
