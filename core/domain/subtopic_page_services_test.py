...
class SubtopicPageServicesUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_learner_group_syllabus_subtopic_page_summaries(self) -> None:
        ...
        summaries = subtopic_page_services.get_learner_group_syllabus_subtopic_page_summaries(
            [subtopic_page_id]
        )
    ...
    def test_get_subtopic_pages_with_ids_and_versions_deleted(self) -> None:
        ...
        subtopic_page_services.delete_subtopic_page(self.user_id, topic_id, 1)
