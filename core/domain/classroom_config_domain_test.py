...
class ClassroomDomainTests(test_utils.GenericTestBase):
    ...
    def test_that_domain_object_is_created_correctly(self) -> None:
        ...
        self.assertEqual(
            self.classroom.teaser_text, 'Learn math through fun stories!'
        )
        self.assertEqual(
    ...
    def test_from_dict_method(self) -> None:
        ...
        self.assertEqual(
            classroom.course_details, 'Curated math foundations course.'
        )
        self.assertEqual(
            classroom.teaser_text, 'Learn math through fun stories!'
        )
        self.assertEqual(
