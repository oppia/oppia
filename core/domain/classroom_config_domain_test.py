...
class ClassroomDomainTests(test_utils.GenericTestBase):
    ...
    def test_that_domain_object_is_created_correctly(self) -> None:
        ...
        self.assertEqual(
            self.classroom.course_details, 'Curated math foundations course.'
        )
        self.assertEqual(self.classroom.teaser_text, 'Learn math through fun stories!')
        self.assertEqual(
        ...
        self.assertListEqual(
            self.classroom.get_topic_ids(), ['topic_id_1', 'topic_id_2', 'topic_id_3']
        )
        self.assertTrue(self.classroom.is_published)
        self.assertEqual(self.classroom.thumbnail_data, self.dummy_thumbnail_data)
    ...
    def test_from_dict_method(self) -> None:
        ...
        self.assertEqual(classroom.teaser_text, 'Learn math through fun stories!')
        self.assertEqual(
            classroom.topic_list_intro, 'Start from the basics with our first topic.'
        )
        self.assertEqual(
        ...
        self.assertEqual(
            classroom.banner_data.to_dict(), self.dummy_banner_data.to_dict()
        )
    ...
    def test_invalid_classroom_url_fragment_should_raise_exception(self) -> None:
        ...
        error_msg = (
            'Expected url fragment of the classroom to be a string, received: ' '1.'
        )
        with self.assertRaisesRegex(utils.ValidationError, error_msg):
            self.classroom.validate(strict=True)
    ...
    def test_invalid_teaser_text_should_raise_exception(self) -> None:
        ...
        error_msg = 'Expected teaser_text of the classroom to be a string, received: 1.'
        with self.assertRaisesRegex(utils.ValidationError, error_msg):
            self.classroom.validate(strict=True)
        ...
        error_msg = (
            ...
            'received %s.'
            % (constants.MAX_CHARS_IN_CLASSROOM_TEASER_TEXT, self.classroom.teaser_text)
        )
        with self.assertRaisesRegex(utils.ValidationError, error_msg):
            self.classroom.validate(strict=True)
    ...
    def test_invalid_topic_list_intro_should_raise_exception(self) -> None:
        ...
        error_msg = (
            'Expected topic_list_intro of the classroom to be a string, ' 'received: 1.'
        )
        with self.assertRaisesRegex(utils.ValidationError, error_msg):
            self.classroom.validate(strict=True)
    ...
    def test_invalid_course_details_should_raise_exception(self) -> None:
        ...
        error_msg = (
            'Expected course_details of the classroom to be a string, ' 'received: 1.'
        )
        with self.assertRaisesRegex(utils.ValidationError, error_msg):
            self.classroom.validate(strict=True)
    ...
    def test_invalid_is_published_should_raise_exception(self) -> None:
        ...
        error_msg = (
            'Expected is_published of the classroom to be a boolean, ' 'received: 1.'
        )
        with self.assertRaisesRegex(utils.ValidationError, error_msg):
            self.classroom.validate(strict=True)
    ...
    def test_invalid_thumbnail_data_should_raise_exception(self) -> None:
        ...
        error_msg = (
            'Expected thumbnail_data of the classroom to be a string, ' 'received: 1.'
        )
        with self.assertRaisesRegex(utils.ValidationError, error_msg):
            self.classroom.validate(strict=True)
    ...
    def test_invalid_thumbnail_bg_color_should_raise_exception(self) -> None:
        ...
        error_msg = 'Classroom thumbnail background color #FFFF is not supported.'
    ...
    def test_invalid_banner_filename_should_raise_exception(self) -> None:
        error_msg = 'Image filename should include an extension.'
        self.classroom.banner_data = classroom_config_domain.ImageData(
    ...
    def test_invalid_thumbnail_filename_should_raise_exception(self) -> None:
        error_msg = 'Expected a filename ending in svg, received invalid_thumbnail.png'
        self.classroom.thumbnail_data = classroom_config_domain.ImageData(
...
class ImageDomainTests(test_utils.GenericTestBase):
    ...
    def test_from_dict(self) -> None:
        image_from_dict = classroom_config_domain.ImageData.from_dict(self.image_dict)
