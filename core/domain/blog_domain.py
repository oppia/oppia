...
class BlogPost:
    ...
    def to_dict(self) -> BlogPostDict:
        ...
        published_on = utils.convert_naive_datetime_to_string(
            self.published_on
        ) if self.published_on else None
    ...
    def from_dict(cls, blog_post_dict: BlogPostDict) -> 'BlogPost':
        ...
        blog_post = cls(
            blog_post_dict['id'], blog_post_dict['author_id'], blog_post_dict['title'],
            blog_post_dict['content'], blog_post_dict['url_fragment'],
            blog_post_dict['tags'], blog_post_dict['thumbnail_filename'], last_updated,
            published_on
        )
