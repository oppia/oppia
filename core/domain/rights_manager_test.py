...
class ExplorationRightsTests(test_utils.GenericTestBase):
    ...
    def test_deassign_editor_is_successful_with_all_valid_commit_messages(self) -> None:
        ...
        snapshots_data = (
            exp_models.ExplorationRightsModel.get_snapshots_metadata(self.EXP_ID, [1])
        )
        ...
        snapshots_data = (
            exp_models.ExplorationRightsModel.get_snapshots_metadata(self.EXP_ID, [2])
        )
        self.assertEqual(
        ...
        snapshots_data = (
            exp_models.ExplorationRightsModel.get_snapshots_metadata(self.EXP_ID, [3])
        )
        self.assertEqual(
            snapshots_data[0]['commit_message'],
