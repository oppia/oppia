...
Registry.create_platform_parameter(
    ...
    platform_parameter_domain.DataTypes.STRING,
    default=(
        'You can change your email preferences via the <a href="LINK_TO_PREFERENCES_PAGE">Preferences</a> page.'
    ),
)
...
Registry.create_platform_parameter(
    ...
    (
        'Enable sending admins email notifications if there are Contributor Dashboard suggestions that have been waiting for a review for more than %s days. The default value is false.'
