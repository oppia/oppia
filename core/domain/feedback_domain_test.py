...
class FeedbackThreadDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_to_dict(self):
        ...
        expected_thread_dict = {
            ...
            'last_message_id': 'exp0.thread0.4',
            'last_message_text': 'last message',
            'last_message_author_id': 'u1',
            'second_last_message_id': 'exp0.thread0.3',
            'second_last_message_text': 'second last',
            'second_last_message_author_id': 'u1',
        }
        observed_thread = feedback_domain.FeedbackThread(
            ...
            'exp0.thread0.4', 'last message', 'u1', 'exp0.thread0.3',
            'second last', 'u1')
    ...
    def test_get_last_two_message_ids(self):
        ...
        thread_1 = feedback_domain.FeedbackThread(
            ...
            5, fake_date, fake_date, 'exp0.thread0.4', 'last message', 'u1',
            'exp0.thread0.3', 'second last', 'u1')
        ...
        thread_1 = feedback_domain.FeedbackThread(
            self.THREAD_ID, feconf.ENTITY_TYPE_EXPLORATION, self.EXP_ID,
            u'a_state_name', self.viewer_id, u'open', u'a subject', None, False,
            1, fake_date, fake_date, 'exp0.thread0.0', 'last message', 'u1',
            None, None, None)
