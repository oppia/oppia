...
def get_subtopic_page_from_model(
    ...
    return subtopic_page_domain.SubtopicPage(
        ...
        ), versioned_page_contents['schema_version'], subtopic_page_model.language_code,
...
def save_subtopic_page(
    committer_id: str, subtopic_page: subtopic_page_domain.SubtopicPage,
    commit_message: Optional[str], change_list: Sequence[change_domain.BaseChange]
) -> None:
