...
class InteractionInstance(translation_domain.BaseTranslatableObject):
    ...
    def _validate_item_selec_input(self, strict: bool = False) -> None:
        ...
        Raises:
            ValueError. Raised when min or max values are None.
            ValidationError. Duplicate rules are present.
        ...
        if min_value is not None and max_value is not None:
            ...
            # that the type is always going to be int because
            # 'ItemInputSelection' customization args always contains
            # 'maxAllowableSelectionCount' key
