...
from typing import (
    Callable, Dict, Final, List, Literal, Mapping, Optional, TypedDict, Union, overload
)
...
if MYPY:  # pragma: no cover
    ...
    AllowedCacheableObjectTypes = Union[AllowedDefaultTypes,
                                        collection_domain.Collection,
                                        exp_domain.Exploration, skill_domain.Skill,
                                        story_domain.Story, topic_domain.Topic,
...
NamespaceType = Literal['collection', 'exploration', 'skill', 'story', 'topic',
                        'platform', 'default']
...
def _get_memcache_key(
    ...
    return '%s%s%s%s%s' % (
        namespace, MEMCACHE_KEY_DELIMITER, sub_namespace_key_string,
        MEMCACHE_KEY_DELIMITER, obj_id
    )
...
def get_multi(namespace: NamespaceType, sub_namespace: str | None,
              obj_ids: List[str]) -> Mapping[str, AllowedCacheableObjectTypes]:
...
@overload
def set_multi(
    namespace: Literal['exploration'], sub_namespace: str | None,
...
@overload
def set_multi(
    namespace: Literal['collection'], sub_namespace: str | None,
...
@overload
def set_multi(
    namespace: Literal['skill'], sub_namespace: str | None,
...
@overload
def set_multi(
    namespace: Literal['story'], sub_namespace: str | None,
...
@overload
def set_multi(
    namespace: Literal['topic'], sub_namespace: str | None,
...
@overload
def set_multi(
    namespace: Literal['platform'], sub_namespace: str | None,
...
@overload
def set_multi(
    namespace: Literal['default'], sub_namespace: str | None,
...
def set_multi(
    namespace: NamespaceType, sub_namespace: str | None,
    ...
    memory_cache_id_value_mapping = {
        _get_memcache_key(namespace, sub_namespace, obj_id):  # Here we use MyPy ignore because 'SERIALIZATION_FUNCTIONS[namespace]'
