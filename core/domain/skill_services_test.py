...
SuggestionChangeDictType = Dict[
    str,
    Union[str, Dict[str, Union[state_domain.StateDict, int, str, List[str]]], float],
]
...
class SkillServicesUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_rubrics_of_linked_skills(self) -> None:
        ...
        skill_services.delete_skill(self.user_id_admin, 'skill_id_2')
        skill_rubrics, deleted_skill_ids = skill_services.get_rubrics_of_skills(
    ...
    def test_commit_log_entry(self) -> None:
        skill_commit_log_entry = skill_models.SkillCommitLogEntryModel.get_commit(
            self.SKILL_ID, 1
        )
    ...
    def test_get_filtered_skill_summaries(self) -> None:
        ...
        augmented_skill_summaries, next_cursor, more = (
            skill_services.get_filtered_skill_summaries(
                self.num_queries_to_fetch, None, None, [], 'Oldest Created', None
            )
        )
        ...
        augmented_skill_summaries, next_cursor, more = (
            skill_services.get_filtered_skill_summaries(
                self.num_queries_to_fetch, None, None, [], 'Most Recently Updated', None
            )
        )
    ...
    def test_cursor_behaves_correctly_when_fetching_skills_in_batches(self) -> None:
        ...
        augmented_skill_summaries, next_cursor, more = (
            skill_services.get_filtered_skill_summaries(1, None, None, [], None, None)
        )
        self.assertEqual(len(augmented_skill_summaries), 2)
    ...
    def test_filter_skills_by_status_all(self) -> None:
        ...
        augmented_skill_summaries, next_cursor, more = (
            skill_services.get_filtered_skill_summaries(
                self.num_queries_to_fetch, 'All', None, [], None, None
            )
        )
        self.assertEqual(len(augmented_skill_summaries), 2)
        self.assertEqual(next_cursor, None)
    ...
    def test_filter_skills_by_status_unassigned(self) -> None:
        ...
        augmented_skill_summaries, next_cursor, more = (
            skill_services.get_filtered_skill_summaries(
                self.num_queries_to_fetch, 'Unassigned', None, [], None, None
            )
        )
        self.assertEqual(len(augmented_skill_summaries), 2)
        self.assertEqual(next_cursor, None)
    ...
    def test_filter_skills_by_keywords(self) -> None:
        ...
        augmented_skill_summaries, next_cursor, more = (
            skill_services.get_filtered_skill_summaries(
                1, None, None, ['Non_existent'], 'Least Recently Updated', None
            )
        )
        ...
        augmented_skill_summaries, next_cursor, more = (
            skill_services.get_filtered_skill_summaries(
                self.num_queries_to_fetch, None, None, ['alp', 'bet'], None, None
            )
        )
    ...
    def test_remove_skill_from_all_topics(self) -> None:
        ...
        topic_assignments_dict = skill_services.get_all_topic_assignments_for_skill(
            self.SKILL_ID
        )
    ...
    def test_delete_skill(self) -> None:
        ...
        self.assertEqual(
            skill_services.get_skill_summary_by_id(self.SKILL_ID, strict=False), None
        )
    ...
    def test_delete_skill_model_with_deleted_summary_model(self) -> None:
        ...
        skill_summary_model_with_none = skill_models.SkillSummaryModel.get(
    ...
    def test_update_skill_worked_examples(self) -> None:
        ...
        self.assertEqual(
            skill.skill_contents.worked_examples[0].to_dict(), old_worked_example
        )
    ...
    def test_does_skill_with_description_exist(self) -> None:
        self.assertEqual(
            skill_services.does_skill_with_description_exist('Description'), True
        )
        self.assertEqual(
            skill_services.does_skill_with_description_exist('Does not exist'), False
        )
    ...
    def test_update_skill_misconception_notes(self) -> None:
        ...
        skill_services.update_skill(
            self.USER_ID, self.SKILL_ID, changelist, 'Update misconception notes.'
        )
        skill = skill_fetchers.get_skill_by_id(self.SKILL_ID)
    ...
    def test_update_skill_misconception_feedback(self) -> None:
        ...
        skill_services.update_skill(
            self.USER_ID, self.SKILL_ID, changelist, 'Update misconception feedback.'
        )
        skill = skill_fetchers.get_skill_by_id(self.SKILL_ID)
    ...
    def test_skill_has_associated_questions(self) -> None:
        ...
        self.assertEqual(
            skill_services.skill_has_associated_questions(skill_id_1), False
        )
    ...
    def test_cannot_update_skill_with_invalid_change_list(self) -> None:
        ...
        self.assertRegex(
            ...
            'object has no' ' attribute \'cmd\' %s invalid_change_list' % self.SKILL_ID,
        )
    ...
    def test_get_categorized_skill_ids_and_descriptions(self) -> None:
        ...
        self.save_new_skill(
            subtopic_skill_id, self.user_id_admin, description='Subtopic Skill'
        )
...
class SkillMasteryServicesUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_multi_users_skills_mastery(self) -> None:
        ...
        degrees_of_mastery = {
            ...
            'user_2': {self.SKILL_ID_1: None, self.SKILL_ID_2: None},
        }
...
class SkillMigrationTests(test_utils.GenericTestBase):
    ...
    def test_migrate_skill_contents_to_latest_schema(self) -> None:
        ...
        worked_example_dict_math: skill_domain.WorkedExampleDict = {
            'question': {'content_id': 'question1', 'html': html_content},
            'explanation': {'content_id': 'explanation1', 'html': html_content},
        }
        ...
        skill_contents_dict['written_translations']['translations_mapping']['content1'][
            'en'
        ]['translation'] = html_content
    ...
    def test_migrate_rubrics_to_latest_schema(self) -> None:
        ...
        model = skill_models.SkillModel(
            ...
            misconceptions=[],
            rubrics=[
                {'difficulty': 'Easy', 'explanations': ['Easy explanation']},
                {'difficulty': 'Medium', 'explanations': ['Medium explanation']},
                {
                    'difficulty': 'Hard',
        ...
        self.assertEqual(
            skill.rubrics[2].explanations, ['Hard explanation', html_content]
        )
