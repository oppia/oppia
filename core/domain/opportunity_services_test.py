...
class OpportunityServicesIntegrationTest(test_utils.GenericTestBase):
    ...
    def mock_generate_new_thread_id_for_suggestion(
        self, unused_entity_type: feedback_models.GeneralFeedbackThreadModel,
    ...
    def test_completing_translation_removes_language_from_incomplete_language_codes( # pylint: disable=line-too-long
        ...
        (
            ...
            update_translation_opportunity_with_accepted_suggestion('0', 'hi')
        )
    ...
    def test_update_skill_description_updates_skill_opportunity(self) -> None:
        ...
        skill_services.update_skill(
            self.admin_id, self.SKILL_ID, changelist, 'Updated misconception name.'
        )
...
class OpportunityServicesUnitTest(test_utils.GenericTestBase):
    ...
    def test_get_exploration_opportunity_summaries_by_ids(self) -> None:
        ...
        self.assertIsInstance(
            opportunities_first_value, opportunity_domain.ExplorationOpportunitySummary
        )
    ...
    def test_get_exploration_opportunity_summaries_by_no_topic_id(self) -> None:
        opportunity_summaries = (
            opportunity_services.
            get_exploration_opportunity_summaries_by_topic_id('None')
        )
    ...
    def test_get_exploration_opportunity_summaries_by_valid_topic_id(self) -> None:
        opportunity_summaries = (
            opportunity_services.
            get_exploration_opportunity_summaries_by_topic_id('topic')
        )

        self.assertEqual(len(opportunity_summaries), 1)
        self.assertIsInstance(
            opportunity_summaries[0], opportunity_domain.ExplorationOpportunitySummary
        )
    ...
    def test_get_exploration_opportunity_summary_by_id_for_none_result(self) -> None:
        self.assertIsNone(
            opportunity_services.get_exploration_opportunity_summary_by_id('exp_1')
        )
...
class OpportunityUpdateOnAcceeptingSuggestionUnitTest(test_utils.GenericTestBase):
    ...
    def test_update_translation_opportunity_with_accepted_suggestion(self) -> None:
        (
            opportunity_services.
            update_translation_opportunity_with_accepted_suggestion('exp_1', 'hi')
        )
