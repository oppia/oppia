...
class OpportunityServicesUnitTest(test_utils.GenericTestBase):
    ...
    def test_get_exploration_opportunity_summaries_by_ids_logs_warning_if_invalid_id(
            self):
        """Tests that a warning is logged if there is no ExplorationOpportunitySummaryModel
        associated with one of the ids.
        """
        ...
        self.assertEqual(
            ...
            [
                ...
                "summary models for ids: [u'badID'], one of the models was None."
            ]
        )
