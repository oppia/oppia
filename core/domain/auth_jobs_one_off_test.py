...
class PopulateFirebaseAccountsOneOffJobTests(test_utils.GenericTestBase):
    ...
    def assert_auth_mapping_exists(self, auth_id_user_id_pair):
    ...
    def assert_auth_mapping_does_not_exist(self, auth_id_user_id_pair):
    ...
    def test_import_user_error_is_reported(self):
        self.exit_stack.enter_context(self.sdk_stub.mock_import_users_error(
