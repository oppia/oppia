...
class StoryServicesUnitTests(test_utils.GenericTestBase):
    ...
    def test_update_story_node_properties(self) -> None:
        ...
        self.assertEqual(
            ...
            planned_publication_date, datetime.datetime(2023, 1, 2, 5, 30))
        self.assertEqual(
            story.story_contents.nodes[1].
            first_publication_date, datetime.datetime(2023, 1, 1, 5, 30))
        self.assertEqual(
            story.story_contents.nodes[1].
            last_modified, datetime.datetime(2023, 1, 1, 5, 30))
