...
class ContentMigrationTests(test_utils.GenericTestBase):
    ...
    def test_wrap_with_siblings(self) -> None:
        test_cases = [
            {
                'html_content': (
                    '<p><i>hello</i></p> this is<i>test case1</i> for <ol><li><i>testing</i></li></ol>'
                ),
                'expected_output': (
                    '<p><i>hello</i></p><p> this is<i>test case1</i> for </p><ol><li><i>testing</i></li></ol>'
                ),
            },
            {
                'html_content': (
                    '<br/>hello this is<br/>test<p> case2<br/></p> for <p><br/>testing</p>'
                ),
                'expected_output': (
                    '<p><br/>hello this is<br/>test</p><p> case2<br/></p> for <p><br/>testing</p>'
                ),
            },
            {
                'html_content': (
                    '<p>hello</p>this is case <b>3</b> for <i>testing</i> the <p>function</p>'
                ),
                'expected_output': (
    ...
    def test_validate_customization_args(self) -> None:
        ...
        expected_output = {
            ...
            'Expected unicode HTML string, received 34455': [
                (
                    '<oppia-noninteractive-workedexample question-with-value="34455" answer-with-value="&amp;quot;lorem ipsum&amp;quot;"></oppia-noninteractive-workedexample>'
                )
            ],
            'Expected unicode HTML string, received 34456': [
                (
                    '<oppia-noninteractive-workedexample question-with-value="&amp;quot;lorem ipsum&amp;quot;" answer-with-value="34456"></oppia-noninteractive-workedexample>'
                )
            ],
    ...
    def test_validate_customization_args_in_tag(self) -> None:
        test_cases = [
            ...
            {
                'html_string': (
                    '<oppia-noninteractive-tabs tab_contents-with-value="[{&amp;quot;content&amp;quot;: &amp;quot;&amp;lt;p&amp;gt;loremipsum&amp;lt;/p&amp;gt;&amp;quot;, &amp;quot;title&amp;quot;: &amp;quot;hello&amp;quot;}, [1,2,3]]"></oppia-noninteractive-tabs>'
                ),
        ...
        test_cases = [
            {
                ...
                'expected_output': (
                    '<p>Feedback</p><oppia-noninteractive-math math_content-with-value="{&amp;quot;raw_latex&amp;quot;: &amp;quot;+,-,-,+&amp;quot;, &amp;quot;svg_filename&amp;quot;: &amp;quot;&amp;quot;}"></oppia-noninteractive-math>'
                ),
            },
            {
                'html_content': (
            ...
            },
            {
                ...
                'html_content': (
                    '<p>Feedback</p><oppia-noninteractive-math></oppia-noninteractive-math>'
                ),
            ...
            },
            {
                ...
                # deleted.
                'html_content': (
                    '<oppia-noninteractive-math raw_latex-with-value=""></oppia-noninteractive-math>blahblah'
                ),
    ...
    def test_validate_math_tags_in_html(self) -> None:
        ...
        invalid_tags = html_validation_service.validate_math_tags_in_html(
            html_string
        )
    ...
    def test_validate_math_tags_in_html_with_attribute_math_content(
        ...
        invalid_tags = html_validation_service.validate_math_tags_in_html_with_attribute_math_content(
            html_string
        )
    ...
    def test_extract_svg_filenames_in_math_rte_components(self) -> None:
        ...
        self.assertEqual(
            html_validation_service.extract_svg_filenames_in_math_rte_components(
    ...
    def test_validate_svg_filenames_format_when_all_filenames_are_invalid(
        ...
        expected_output = [
            {
                'invalid_tag': (
                    '<oppia-noninteractive-math math_content-with-value="{&amp;quot;raw_latex&amp;quot;: &amp;quot;+,-,-,+&amp;quot;, &amp;quot;svg_filename&amp;quot;: &amp;quot;mathImg_20201216*331234_r3ir43lmfd_height_2d456_width_6d124_vertical_0d231.svg&amp;quot;}"></oppia-noninteractive-math>'
                ),
                'error': (
                    'Invalid svg_filename attribute in math component: mathImg_20201216*331234_r3ir43lmfd_height_2d456_width_6d124_vertical_0d231.svg'
                ),
            },
            {
                'invalid_tag': (
                    '<oppia-noninteractive-math math_content-with-value="{&amp;quot;raw_latex&amp;quot;: &amp;quot;+,-,-,+&amp;quot;, &amp;quot;svg_filename&amp;quot;: &amp;quot;mathImg_20200216_133832_imzlvnf23a_invalid_4d123_width_23d122_vertical_2d123.svg&amp;quot;}"></oppia-noninteractive-math>'
                ),
                'error': (
                    'Invalid svg_filename attribute in math component: mathImg_20200216_133832_imzlvnf23a_invalid_4d123_width_23d122_vertical_2d123.svg'
                ),
            },
        ]
    ...
    def test_check_for_svgdiagram_component_in_html(self) -> None:
        ...
        test_cases: List[SvgDiagramTestCaseDict] = [
            ...
            {
                'html_content': (
                    '<p><oppia-noninteractive-image filepath-with-value="abc1.png"></oppia-noninteractive-image>Hello this is test case to check that dimensions are added to the oppia noninteractive image tags.</p>'
                ),
    ...
    def test_parsable_as_xml(self) -> None:
        ...
        self.assertEqual(
            html_validation_service.is_parsable_as_xml(invalid_xml), False
        )
        invalid_xml = b'123'
        self.assertEqual(
            html_validation_service.is_parsable_as_xml(invalid_xml), False
        ...
        self.assertEqual(
            html_validation_service.is_parsable_as_xml(valid_xml), True
        )
    ...
    def test_no_convertion_of_non_interactive_image_tags(self) -> None:
        ...
        test_cases = [
            {
                'html_content': (
                    '<oppia-noninteractive-image alt-with-value="&amp;quot;Image1&amp;quot;" caption-with-value="&amp;quot;xyz&amp;quot;" filepath-with-value="&amp;quot;img123.svg&amp;quot;"></oppia-noninteractive-image>'
                ),
                'expected_output': (
                    '<oppia-noninteractive-image alt-with-value="&amp;quot;Image1&amp;quot;" caption-with-value="&amp;quot;xyz&amp;quot;" filepath-with-value="&amp;quot;img123.svg&amp;quot;"></oppia-noninteractive-image>'
                ),
