...
#         self.assertEqual(regenerated_name, 'abc_height_45_width_45.png')
    ...
    def test_get_html_with_image_id_in_image_tag(self):
        content_html = (
            '<oppia-noninteractive-image caption-with-value="&amp;quot;'
            '&amp;quot;" filepath-with-value="">'
            '</oppia-noninteractive-image>'
        ...
        expected_content_html = (
            ...
            '</oppia-noninteractive-image>'
            '<p>Some text.</p><p>Some more text.</p><p>Yet more text.</p>'
            '<p><oppia-noninteractive-image image_id-with-value="2">'
        ...
        self.assertEqual(received_content_html, expected_content_html)
        self.assertEqual(received_image_counter, expected_image_counter)
        self.assertEqual(received_image_mapping, expected_image_mapping)
