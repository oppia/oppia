...
class ContentMigrationTests(test_utils.GenericTestBase):
    ...
    def test_validate_soup_for_rte(self) -> None:
        test_cases_for_textangular = [
            ...
            'Text with no parent tag', '<h1>This is not a allowed tag</h1>',
            (
        ...
        for index, test_case in enumerate(test_cases_for_textangular):
            ...
            self.assertEqual(
                actual_output_for_textangular, expected_output_for_textangular[index]
            )
    ...
    def test_svg_string_validation(self) -> None:
        ...
        self.assertEqual(
            ...
            get_invalid_svg_tags_and_attrs(valid_svg_string_with_unicode), ([], [])
        )
    ...
    def test_svg_tag_without_xmlns_attribute(self) -> None:
        ...
        self.assertTrue(
            html_validation_service.
            does_svg_tag_contains_xmlns_attribute(valid_svg_string)
        )
        ...
        self.assertFalse(
            html_validation_service.
            does_svg_tag_contains_xmlns_attribute(invalid_svg_string)
        )
    ...
    def test_extract_svg_filenames_in_math_rte_components(self) -> None:
        ...
        self.assertEqual(
            html_validation_service.
            extract_svg_filenames_in_math_rte_components(html_string_with_no_filename),
            []
        )
