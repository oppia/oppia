...
def get_server_mode() -> ServerMode:
    ...
    """
    return (
        ServerMode.DEV if constants.DEV_MODE else ServerMode.PROD
        if feconf.ENV_IS_OPPIA_ORG_PRODUCTION_SERVER else ServerMode.TEST
    )
...
class FeatureFlag:
    ...
    def __init__(
        self, name: str, feature_flag_spec: FeatureFlagSpec,
...
class FeatureFlagConfig:
    ...
    def from_dict(
        ...
        return cls(
            ...
            feature_flag_config_dict['user_group_ids'], last_updated
        )
