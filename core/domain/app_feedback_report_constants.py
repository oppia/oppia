...
ANDROID_ENTRY_POINT = [
    EntryPoint.NAVIGATION_DRAWER,
    EntryPoint.LESSON_PLAYER,
    EntryPoint.REVISION_CARD,
    EntryPoint.CRASH,
]
...
ALLOWED_CATEGORIES = [
    ...
    Category.LANGUAGE_GENERAL_ISSUE,
    Category.LANGUAGE_AUDIO_ISSUE,
    Category.LANGUAGE_TEXT_ISSUE,
    Category.TOPICS_ISSUE,
    Category.PROFILE_ISSUE,
    Category.OTHER_ISSUE,
    Category.LESSON_PLAYER_CRASH,
    Category.PRACTICE_QUESTIONS_CRASH,
    Category.OPTIONS_PAGE_CRASH,
    Category.PROFILE_PAGE_CRASH,
...
ALLOWED_FILTERS = [
    FilterFieldNames.REPORT_TYPE,
    FilterFieldNames.PLATFORM,
    FilterFieldNames.ENTRY_POINT,
    FilterFieldNames.SUBMITTED_ON,
    FilterFieldNames.ANDROID_DEVICE_MODEL,
    FilterFieldNames.ANDROID_SDK_VERSION,
    FilterFieldNames.TEXT_LANGUAGE_CODE,
    FilterFieldNames.AUDIO_LANGUAGE_CODE,
    FilterFieldNames.PLATFORM_VERSION,
    FilterFieldNames.ANDROID_DEVICE_COUNTRY_LOCALE_CODE,
]
ALLOWED_ANDROID_NETWORK_TYPES = [
    AndroidNetworkType.WIFI,
    AndroidNetworkType.CELLULAR,
    AndroidNetworkType.NONE,
]
ALLOWED_ANDROID_TEXT_SIZES = [
    AndroidTextSize.TEXT_SIZE_UNSPECIFIED,
    AndroidTextSize.SMALL_TEXT_SIZE,
    AndroidTextSize.MEDIUM_TEXT_SIZE,
    AndroidTextSize.LARGE_TEXT_SIZE,
