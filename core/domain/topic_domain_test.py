...
class TopicDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_add_canonical_story(self) -> None:
        ...
        canonical_story_ids = self.topic.get_canonical_story_ids()
        self.assertEqual(
            canonical_story_ids, ['story_id', 'story_id_1', 'story_id_2']
        )
        with self.assertRaisesRegex(
            Exception,
    ...
    def test_delete_subtopic(self) -> None:
        ...
        self.assertNotEqual(
            [skill_id_moved], self.topic.uncategorized_skill_ids
        )
    ...
    def test_add_subtopic(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            self.topic.add_subtopic(
                incorrect_new_subtopic_id, 'subtopic_3', 'url_frag'
            )
        self.topic.add_subtopic(
            correct_new_subtopic_id, 'subtopic_title', 'url_frag'
        )
    ...
    def test_update_page_title_fragment_for_web(self) -> None:
        ...
        self.assertNotEqual(
            self.topic.page_title_fragment_for_web, updated_frag
        )
    ...
    def test_update_thumbnail_file_and_size(self) -> None:
        ...
        self.topic.update_thumbnail_filename_and_size(
            updated_file_name, updated_size
        )
    ...
    def _schema_update_vers_dict(
        ...
        topic.update_subtopics_from_model(
            vers_subtopic_dict, current_schema, topic.id
        )
    ...
    def test_subtopic_schema_v1_to_v2(self) -> None:
        ...
        self.assertEqual(
            vers_subtopic_dict['subtopics'][0]['thumbnail_filename'], None
        )
        self.assertEqual(
            vers_subtopic_dict['subtopics'][0]['thumbnail_bg_color'], None
        )
        self.assertEqual(
            vers_subtopic_dict['schema_version'], current_schema + 1
        )
    ...
    def test_unpublish_story(self) -> None:
        ...
        self.assertEqual(
            topic.canonical_story_references[1].story_is_published, False
        )
