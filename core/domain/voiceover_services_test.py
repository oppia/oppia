...
class EntityVoiceoversServicesTests(test_utils.GenericTestBase):
    def test_get_entity_voiceovers_returns_correctly(self) -> None:
        ...
        entity_voiceovers_instance = voiceover_services.get_voiceovers_for_given_language_accent_code('exploration', 'exp_id', 1, 'en-US')
        ...
        self.assertEqual(entity_voiceovers_instance.language_accent_code, 'en-US')
        automatic_voiceover = entity_voiceovers_instance.voiceovers_mapping['content_0']['auto']
        manual_voiceover = entity_voiceovers_instance.voiceovers_mapping['content_0']['manual']
        assert isinstance(automatic_voiceover, state_domain.Voiceover)
        assert isinstance(manual_voiceover, state_domain.Voiceover)
        self.assertDictEqual(manual_voiceover.to_dict(), dummy_manual_voiceover_dict)
        self.assertDictEqual(automatic_voiceover.to_dict(), dummy_autogenerated_voiceover_dict)
    ...
    def test_should_convert_domain_instance_to_model_instance(self) -> None:
        ...
        entity_voiceovers = voiceover_domain.EntityVoiceovers(
            ...
            voiceovers_mapping={
                'content_0': {
                    'manual': (state_domain.Voiceover.from_dict(dummy_manual_voiceover_dict)),
                    'auto': (state_domain.Voiceover.from_dict(dummy_autogenerated_voiceover_dict)),
                }
            },
            automated_voiceovers_audio_offsets_msecs={},
        )
        entity_voiceovers_model = voiceover_services.create_entity_voiceovers_model(entity_voiceovers)

        self.assertEqual(entity_voiceovers.entity_id, entity_voiceovers_model.entity_id)
        self.assertEqual(entity_voiceovers.entity_type, entity_voiceovers_model.entity_type)
        self.assertEqual(
        ...
        manual_voiceover = entity_voiceovers.voiceovers_mapping['content_0']['manual']
        automatic_voiceover = entity_voiceovers.voiceovers_mapping['content_0']['auto']
        assert isinstance(automatic_voiceover, state_domain.Voiceover)
        assert isinstance(manual_voiceover, state_domain.Voiceover)
    ...
    def test_should_get_entity_voiceovers_by_exploration(self) -> None:
        ...
        retrieved_entity_voiceovers = voiceover_services.get_entity_voiceovers_for_given_exploration('exp_id_1', 'exploration', 1)
    ...
    def test_should_get_entity_voiceovers_by_exploration_and_language_code(
        ...
        voiceover_models.EntityVoiceoversModel.create_new(feconf.ENTITY_TYPE_EXPLORATION, 'exp_id_1', 1, 'en-NG', {}, {}).put()
        ...
        retrieved_entity_voiceovers = voiceover_services.fetch_entity_voiceovers_by_language_code('exp_id_1', 'exploration', 1, 'en')
    ...
    def test_should_compute_entity_voiceovers_model_successfully(self) -> None:
        ...
        exploration = exp_domain.Exploration.create_default_exploration('exp_id_1', title='Title', category='Category')
        ...
        entity_voiceovers_models = voiceover_services.compute_voiceover_related_change(
            updated_exploration=exploration,
            voiceover_changes=voiceover_changes,
        )

        voiceover_models.EntityVoiceoversModel.update_timestamps_multi(entity_voiceovers_models)
        voiceover_models.EntityVoiceoversModel.put_multi(entity_voiceovers_models)

        exploration.version += 1

        self.assertEqual(len(entity_voiceovers_models), 1)

        retrieved_voiceover_1 = entity_voiceovers_models[0].voiceovers_mapping['content_0']['manual']
        retrieved_voiceover_2 = entity_voiceovers_models[0].voiceovers_mapping['default_outcome_1']['manual']
        ...
        retrieved_voiceover_3 = entity_voiceovers_models[0].voiceovers_mapping['content_0']['manual']
    ...
    def test_should_mark_entity_voiceovers_as_needing_update(self) -> None:
        ...
        retrieved_entity_voiceovers = voiceover_services.get_voiceovers_for_given_language_accent_code('exploration', 'exp_id_1', 2, 'en-US')

        manual_voiceover = retrieved_entity_voiceovers.voiceovers_mapping['content_0']['manual']
        # Ruling out the possibility of None for mypy type checking.
        assert manual_voiceover is not None

        auto_voiceover = retrieved_entity_voiceovers.voiceovers_mapping['content_0']['auto']
        # Ruling out the possibility of None for mypy type checking.
    ...
    def test_should_remove_entity_voiceovers(self) -> None:
        ...
        retrieved_entity_voiceovers = voiceover_services.get_voiceovers_for_given_language_accent_code('exploration', 'exp_id_1', 2, 'en-US')
        self.assertNotIn('content_0', retrieved_entity_voiceovers.voiceovers_mapping)
    ...
    def test_should_get_entity_voiceovers_for_reverted_version(self) -> None:
        ...
        entity_voiceovers_id = voiceover_models.EntityVoiceoversModel.generate_id(feconf.ENTITY_TYPE_EXPLORATION, 'exp_id_1', 2, 'en-US')

        entity_voicovers_model = voiceover_models.EntityVoiceoversModel.get(entity_voiceovers_id)
        self.assertEqual(entity_voicovers_model.entity_version, 2)

        # Reverting exploration from version 2 to version 1 and the new
        # version is 3.
        exploration.version += 1
        new_entity_voiceovers_models = voiceover_services.compute_voiceover_related_changes_upon_revert(exploration, 1)
        new_entity_voiceovers_models[0].update_timestamps()
        new_entity_voiceovers_models[0].put()

        entity_voiceovers_id = voiceover_models.EntityVoiceoversModel.generate_id(feconf.ENTITY_TYPE_EXPLORATION, 'exp_id_1', 3, 'en-US')
        entity_voicovers_model = voiceover_models.EntityVoiceoversModel.get(entity_voiceovers_id)

        self.assertEqual(entity_voicovers_model.entity_version, 3)
        self.assertEqual(
            entity_voicovers_model.voiceovers_mapping['content_0']['manual']['filename'],
            'filename1.mp3',
        )
...
class VoiceoverAutogenerationPolicyTests(test_utils.GenericTestBase):
    ...
    def test_save_and_get_language_accent_codes_works_correctly(self) -> None:
        ...
        retrieved_language_codes_mapping: Dict[str, Dict[str, bool]] = voiceover_services.get_all_language_accent_codes_for_voiceovers()
        expected_language_codes_mapping: Dict[str, Dict[str, bool]] = {}
        self.assertDictEqual(retrieved_language_codes_mapping, expected_language_codes_mapping)

        voiceover_services.save_language_accent_support(language_codes_mapping=language_codes_mapping)

        retrieved_language_codes_mapping = voiceover_services.get_all_language_accent_codes_for_voiceovers()
    ...
    def test_should_successfully_get_autogeneratable_accents(self) -> None:
        ...
        autogeneratable_accents_for_english = voiceover_services.get_supported_autogeneratable_accents_by_language('en')
        self.assertItemsEqual(autogeneratable_accents_for_english, ['en-US', 'en-IN'])

        autogeneratable_accents_for_hindi = voiceover_services.get_supported_autogeneratable_accents_by_language('hi')
...
class VoiceoversLanguageAccentConstantsTests(test_utils.GenericTestBase):
    ...
    def test_get_language_accent_master_list_works_correctly(self) -> None:
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            ...
            expected_language_accent_master_list = voiceover_services.get_language_accent_master_list()
    ...
    def test_get_autogeneratable_language_accent_list_works_correctly(
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            autogeneratable_language_accent_list: Dict[str, Dict[str, str]] = json.loads(f.read())
            expected_autogeneratable_language_accent_list = voiceover_services.get_autogeneratable_language_accent_list()
    ...
    def test_should_get_available_autogeneratable_language_accent_list(
        ...
        available_language_accent_list = voiceover_services.get_autogeneratable_language_accent_codes()
    ...
    def test_validate_data_format_stored_in_master_list_is_correct(
        ...
        try:
            ...
            self.fail('get_language_accent_master_list() raised ExceptionType unexpectedly!')
    ...
    def test_validate_data_format_stored_in_autogeneratable_list_is_correct(
        ...
        try:
            ...
            self.fail('get_autogeneratable_language_accent_list() raised ExceptionType unexpectedly!')

    def test_validate_autogeneratable_list_is_subset_of_master_list(
        self,
    ) -> None:
        language_accent_master_list = []
        for accent_code_to_description in voiceover_services.get_language_accent_master_list().values():
            for lang_accent_code in accent_code_to_description.keys():
                language_accent_master_list.append(lang_accent_code)
        autogeneratable_language_accent_codes = list(voiceover_services.get_autogeneratable_language_accent_list().keys())

        self.assertTrue(set(language_accent_master_list).issuperset(set(autogeneratable_language_accent_codes)))
    ...
    def test_should_get_correct_language_code_for_given_accent(self) -> None:
        ...
        self.assertEqual(
            voiceover_services.get_language_code_from_language_accent_code(language_accent_code),
...
class VoiceoverRegenerationTests(test_utils.GenericTestBase):
    ...
    def test_should_regenerate_voiceover_for_translation_update(self) -> None:
        ...
        entity_voiceovers_models = voiceover_services.get_entity_voiceovers_for_given_exploration(exploration_id, 'exploration', exploration_version)
        self.assertEqual(len(entity_voiceovers_models), 1)
        self.assertItemsEqual([entity_voiceovers_models[0].language_accent_code], ['ar-AE'])
    ...
    def test_should_raise_exception_when_change_diff_is_not_accessible(
        ...
        error = 'Could not fetch change diff for exploration %s, version %s during voiceover regeneration.' % (exploration_id, str(exploration_version))
    ...
    def test_should_not_regenerate_voiceover_for_non_supported_accents(
        ...
        self.voiceover_autogeneration_policy_model.language_codes_mapping = {'en': {'en-US': False}}
    ...
    def test_should_raise_error_while_regenerating_voiceover(self) -> None:
        ...
        self.voiceover_autogeneration_policy_model.language_codes_mapping = {'en': {'en-US': True}}
        ...
        for email_model in all_models:
            if email_model.subject == 'Report on Automatic Voiceovers Generated for Test Exploration':
        ...
        self.assertEqual(updated_cloud_task_run_model.latest_job_state, 'PERMANENTLY_FAILED')

    def _create_exploration_and_arabic_translation(self, exploration_id: str, language_code: str) -> None:
    ...
    def test_should_regenerate_voiceover_for_arabic_language(self) -> None:
        ...
        self._create_exploration_and_arabic_translation(exploration_id, language_code)
        ...
        with self.swap(
            ...
            (voiceover_services.regenerate_voiceovers_of_exploration_for_given_language_accent(exploration_id, language_accent_code, author_id, date_time))
        ...
        self.assertEqual(entity_voiceovers.language_accent_code, language_accent_code)
    ...
    def test_should_raise_exception_when_language_accent_code_is_not_supported(
        ...
        with self.assertRaisesRegex(Exception, 'Invalid language accent code: %s' % language_accent_code):
            (voiceover_services.regenerate_voiceovers_of_exploration_for_given_language_accent(exploration_id, language_accent_code, author_id, date_time))
    ...
    def test_should_regenerate_voiceover_when_exploration_is_curated(
        ...
        self._create_exploration_and_arabic_translation(exploration_id, language_code)
        entity_voiceovers_list = voiceover_services.get_entity_voiceovers_for_given_exploration(
            exploration_id,
            feconf.ENTITY_TYPE_EXPLORATION,
            exploration_version,
        )
        ...
        voiceover_regeneration_task_mapping_model = cloud_task_models.VoiceoverRegenerationTaskMappingModel.get(voiceover_regeneration_task_mapping_model_id, strict=False)
