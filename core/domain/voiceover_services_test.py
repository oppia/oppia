...
class EntityVoiceoversServicesTests(test_utils.GenericTestBase):
    def test_get_entity_voiceovers_returns_correctly(self) -> None:
        ...
        manual_voiceover = entity_voiceovers_instance.voiceovers_mapping['content_0'][
    ...
    def test_should_convert_domain_instance_to_model_instance(self) -> None:
        ...
        entity_voiceovers = voiceover_domain.EntityVoiceovers(
            ...
            voiceovers_mapping={
                'content_0': {
                    feconf.VoiceoverType.MANUAL: (
                        state_domain.Voiceover.from_dict(dummy_manual_voiceover_dict)
                    ),
                    feconf.VoiceoverType.AUTO: (
        ...
        self.assertEqual(
            entity_voiceovers.entity_version, entity_voiceovers_model.entity_version
        )
        self.assertEqual(
    ...
    def test_should_compute_entity_voiceovers_model_successfully(self) -> None:
        ...
        entity_voiceovers_models = voiceover_services.compute_voiceover_related_change(
            updated_exploration=exploration, voiceover_changes=voiceover_changes
        )
...
class VoiceoversLanguageAccentConstantsTests(test_utils.GenericTestBase):
    ...
    def test_get_language_accent_master_list_works_correctly(self) -> None:
        ...
        with utils.open_file(file_path, 'r') as f:
            ...
            self.assertDictEqual(
                language_accent_master_list, expected_language_accent_master_list
            )

    def test_get_autogeneratable_language_accent_list_works_correctly(self) -> None:
        file_path = os.path.join(
    ...
    def test_validate_data_format_stored_in_master_list_is_correct(self) -> None:
        valid_schema = {
        ...
        try:
            schema_utils.normalize_against_schema(
                voiceover_services.get_language_accent_master_list(), valid_schema
            )
        except Exception:
            self.fail(
    ...
    def test_validate_autogeneratable_list_is_subset_of_master_list(self) -> None:
...
class VoiceArtistMetadataTests(test_utils.GenericTestBase):
    ...
    def test_should_update_and_put_existing_voice_artist_model(self) -> None:
        voiceover_services.update_voice_artist_metadata(self.voice_artist_id, {})
        ...
        self.assertDictEqual(
            retrieved_model.language_code_to_accent, self.language_code_to_accent
        )
    ...
    def test_should_create_and_update_voice_artist_language_mapping(self) -> None:
        language_code = 'en'
        language_accent_code = 'en-US'
    ...
    def test_should_create_voice_artist_metadata_model_successfully(self) -> None:
...
class ExplorationVoiceArtistLinkTests(test_utils.GenericTestBase):
    ...
    def test_should_create_exploration_voice_artists_link_model_successfully(
        ...
        self.assertEqual(exploration_voice_artists_link_model.id, self.exploration_id)
        self.assertDictEqual(
    ...
    def test_auto_update_exploration_voice_artist_link_model(self) -> None:
        ...
        exp_services.update_exploration(
            'voice_artist_1', 'exploration_id', change_list, 'Adds voiceover'
        )
        ...
        exp_services.update_exploration(
            'voice_artist_3', 'exploration_id', change_list, 'Adds voiceover'
        )
        updated_exploration = exp_fetchers.get_exploration_by_id('exploration_id')
    ...
    def test_should_not_update_exp_link_model_for_empty_change_list(self) -> None:
        content_id_to_voiceovers_mapping = {
            'content_0': {
                'en': ('voice_artist_1', self.voiceover1),
            }
            ...
            exp_domain.ExplorationChange(
                {
                    ...
                    'state_name': 'Introduction',
                    'new_value': {
                        'voiceovers_mapping': {'content_0': {'en': self.voiceover7}}
                    },
                    'old_value': {'voiceovers_mapping': {'content_0': {}}},
                }
            ),
        ]
    ...
    def test_should_not_create_link_model_when_feature_flag_is_false(self) -> None:
        exploration = self.save_new_valid_exploration(
            'exploration_id',
            self.owner_id,
            title='title1',
