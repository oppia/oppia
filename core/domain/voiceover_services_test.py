...
class VoiceoverAutogenerationPolicyTests(test_utils.GenericTestBase):
    ...
    def test_get_and_set_voiceover_autogeneration_policy(self) -> None:
        retrieved_policy = (
            voiceover_services.get_voiceover_autogeneration_policy()
        )
        ...
        voiceover_services.set_voiceover_autogeneration_policy(
            voiceover_autogeneration_policy,
            True,
            False
        )
        ...
        self.assertFalse(
            retrieved_policy.autogenerated_voiceovers_are_enabled)
        self.assertDictEqual(
            retrieved_policy.language_codes_mapping,
            language_codes_mapping)

        voiceover_autogeneration_policy.autogenerated_voiceovers_are_enabled = (
            True)
        voiceover_services.set_voiceover_autogeneration_policy(
            voiceover_autogeneration_policy,
            False,
