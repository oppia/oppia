...
class DraftUpgradeUtilUnitTests(test_utils.GenericTestBase):
    ...
    def test_convert_states_v55_dict_to_v56_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v55_dict_list, migrated_draft_change_list_v56_dict_list
        )
    ...
    def test_convert_states_v53_dict_to_v54_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v52_dict_list, migrated_draft_change_list_v53_dict_list
        )
    ...
    def test_convert_states_v49_dict_to_v50_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v49_dict_list, migrated_draft_change_list_v50_dict_list
        )
    ...
    def test_convert_states_v48_dict_to_v49_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v48_dict_list, migrated_draft_change_list_v49_dict_list
        )
    ...
    def test_convert_states_v47_dict_to_v48_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v47_dict_list, migrated_draft_change_list_v48_dict_list
        )
    ...
    def test_convert_states_v46_dict_to_v47_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v46_dict_list, migrated_draft_change_list_v47_dict_list
        )
    ...
    def test_convert_states_v45_dict_to_v46_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v45_dict_list, migrated_draft_change_list_v46_dict_list
        )
    ...
    def test_convert_states_v44_dict_to_v45_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v44_dict_list, migrated_draft_change_list_v45_dict_list
        )
    ...
    def test_convert_states_v43_dict_to_v44_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v43_dict_list, migrated_draft_change_list_v44_dict_list
        )
    ...
    def test_convert_states_v38_dict_to_v39_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v38_dict_list, migrated_draft_change_list_v39_dict_list
        )
    ...
    def test_convert_states_v37_dict_to_v38_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v37_dict_list, migrated_draft_change_list_v38_dict_list
        )
    ...
    def test_convert_states_v36_dict_to_v37_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v37_dict_list, migrated_draft_change_list_v37_dict_list
        )
            ...
            exp_domain.ExplorationChange(
                {
                    ...
                    'new_value': {
                        'choices': {
                            'value': ['<p>1</p>', '<p>2</p>', html_content, '<p>4</p>']
                        },
                    ...
                    'new_value': [
                        {
                            'rule_specs': [
                                ...
                                },
                                {
                                    ...
                                    'inputs': {'x': html_content, 'y': html_content},
                                },
                                {
                                    'rule_type': (
            ...
            exp_domain.ExplorationChange(
                {
                    ...
                    'state_name': 'Intro',
                    'property_name': 'content',
                    'new_value': {'content_id': 'content', 'html': html_content},
                }
            ),
            exp_domain.ExplorationChange(
                {
            ...
            exp_domain.ExplorationChange(
                {
                    ...
                    'new_value': {
                        ...
                        'explanation': {'content_id': 'solution', 'html': html_content},
                    },
                }
            ),
            exp_domain.ExplorationChange(
            ...
            exp_domain.ExplorationChange(
                {
                    ...
                    'property_name': 'hints',
                    'new_value': [
                        {'hint_content': {'content_id': 'hint1', 'html': html_content}}
                    ],
                }
            ),
            exp_domain.ExplorationChange(
                    ...
                    'new_value': [
                        {
                            'rule_specs': [
                                ...
                                {
                                    'rule_type': 'HasElementXAtPositionY',
                                    'inputs': {'x': expected_html_content, 'y': 2},
                                },
                                {
                                    'rule_type': 'IsEqualToOrdering',
                                    'inputs': {'x': [[expected_html_content]]},
    ...
    def test_convert_states_v28_dict_to_v29_dict(self) -> None:
        ...
        self.assertEqual(
            draft_change_list_v28_dict_list, migrated_draft_change_list_v29_dict_list
        )
