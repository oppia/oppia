...
class TakeoutServiceFullUserUnitTests(test_utils.GenericTestBase):
    ...
    USER_1_WEEKLY_CREATOR_STATS_LIST: Final = [
        {('2019-05-21'): {'average_ratings': 4.00, 'total_plays': 5}},
        {('2019-05-28'): {'average_ratings': 4.95, 'total_plays': 10}},
    ]
    EXPLORATION_IDS: Final = ['exp_1']
    EXPLORATION_IDS_2: Final = ['exp_2']
    STORY_IDS: Final = ['12', '22', '32']
    ...
    def set_up_non_trivial(self) -> None:
        ...
        topic_models.TopicRightsModel(
            ...
            'committer_id', 'New topic rights', [{'cmd': topic_domain.CMD_CREATE_NEW}]
        )
        topic_models.TopicRightsModel(
        ...
        app_feedback_report_models.AppFeedbackReportModel(
            ...
            % (
                'random_hash',
                self.TICKET_CREATION_TIMESTAMP.second,
                '16CharString1234',
            ),
        ...
        learner_grp_user_model = user_models.LearnerGroupsUserModel(
            ...
            learner_groups_user_details=[
                {'group_id': 'group_id_2', 'progress_sharing_is_turned_on': False}
            ],
    ...
    def test_export_data_for_full_user_nontrivial_is_correct(self) -> None:
        ...
        expected_user_group_data = {
            'user_group_model': {'name': 'user_group_name', 'user_ids': self.USER_ID_1}
        }
        ...
        expected_general_feedback_thread_user_data = {
            thread_id: {'message_ids_read_by_user': self.MESSAGE_IDS_READ_BY_USER}
        }
        ...
        expected_contrib_proficiency_data = {
            self.SCORE_CATEGORY_1: {'onboarding_email_sent': False, 'score': 1.5},
            self.SCORE_CATEGORY_2: {'onboarding_email_sent': False, 'score': 2},
        }
        ...
        expected_exploration_sm = {
            ...
            'exp_1-2': {'commit_type': 'edit', 'commit_message': 'Test edit'},
        }
        ...
        with utils.open_file(
            os.path.join(feconf.TESTS_DATA_DIR, 'test_png_img.png'), 'rb', encoding=None
        ) as f:
