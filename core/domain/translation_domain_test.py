...
class DummyTranslatableObjectWithTwoParams(translation_domain.BaseTranslatableObject):
    ...
    def __init__(
        self, param1: str, param2: DummyTranslatableObjectWithSingleParam
    ) -> None:
        self.param1 = param1
        self.param2 = param2
    ...
    def get_translatable_contents_collection(
        ...
        translatable_contents_collection.add_translatable_field(
            'content_id_1', translation_domain.ContentType.CONTENT,
            translation_domain.TranslatableContentFormat.UNICODE_STRING, self.param1
        )
...
class DummyTranslatableObjectWithSingleParam(translation_domain.BaseTranslatableObject):
    ...
    def get_translatable_contents_collection(
        ...
        translatable_contents_collection.add_translatable_field(
            'content_id_2', translation_domain.ContentType.CONTENT,
            translation_domain.TranslatableContentFormat.UNICODE_STRING, self.param3
        )
        return translatable_contents_collection
...
class DummyTranslatableObjectWithDuplicateContentIdForParams(
    ...
    def get_translatable_contents_collection(
        ...
        translatable_contents_collection.add_translatable_field(
            'content_id_2', translation_domain.ContentType.CONTENT,
            translation_domain.TranslatableContentFormat.UNICODE_STRING, self.param2
        )
        return translatable_contents_collection
...
class DummyTranslatableObjectWithFourParams(translation_domain.BaseTranslatableObject):
    ...
    def get_translatable_contents_collection(
        ...
        translatable_contents_collection.add_translatable_field(
            'content_id_1', translation_domain.ContentType.CUSTOMIZATION_ARG,
            translation_domain.TranslatableContentFormat.HTML, self.param1
        )
        translatable_contents_collection.add_translatable_field(
            'content_id_2', translation_domain.ContentType.DEFAULT_OUTCOME,
            translation_domain.TranslatableContentFormat.UNICODE_STRING, self.param2
        )
        translatable_contents_collection.add_translatable_field(
            'content_id_3', translation_domain.ContentType.RULE,
            translation_domain.TranslatableContentFormat.UNICODE_STRING, self.param3
        )
        translatable_contents_collection.add_translatable_field(
            'content_id_4', translation_domain.ContentType.CONTENT,
            translation_domain.TranslatableContentFormat.UNICODE_STRING, self.param4
        )
        return translatable_contents_collection
...
class BaseTranslatableObjectUnitTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.translatable_object1 = DummyTranslatableObjectWithTwoParams(
            'My name is jhon.',
            DummyTranslatableObjectWithSingleParam('My name is jack.')
        )
    ...
    def test_registering_duplicate_content_id_raises_exception(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'Content_id content_id_2 already exists in the '
    ...
    def test_get_all_contents_which_need_translations(self) -> None:
        ...
        contents_which_need_translation = (
            translatable_object.
            get_all_contents_which_need_translations(entity_translations).values()
        )
    ...
    def test_are_translations_displayable_with_all_translations(self) -> None:
        translation_dict = {
            'content_id_2':
                translation_domain.TranslatedContent(
                    'Translation.', translation_domain.TranslatableContentFormat.HTML,
                    True
                ),
            'content_id_3':
                translation_domain.TranslatedContent(
        ...
        self.assertTrue(
            translatable_object.are_translations_displayable(entity_translations)
        )
    ...
    def test_are_translations_displayable_without_min_translation(self) -> None:
        ...
        min_value_swap = self.swap(
            feconf, 'MIN_ALLOWED_MISSING_OR_UPDATE_NEEDED_WRITTEN_TRANSLATIONS', 1
        )
        translatable_object = DummyTranslatableObjectWithFourParams(
            'Content', 'My name is jhon.', 'My name is Nikhil.', 'Content'
        )
    ...
    def test_get_content_count(self) -> None:
        translatable_object = DummyTranslatableObjectWithFourParams(
            'My name is jack.', 'My name is jhon.', 'My name is Nikhil.', 'Content'
        )
    ...
    def test_validate_translatable_contents_raise_error(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected all content id indexes to be less than'
        ):
...
class EntityTranslationsUnitTests(test_utils.GenericTestBase):
    ...
    def test_creation_of_object(self) -> None:
        ...
        self.assertEqual(
            entity_translations.translations['content_id_1'].needs_update, False
        )
    ...
    def test_validate_language_code(self) -> None:
        ...
        # wrong inputs that we can normally catch by typing.
        with self.assertRaisesRegex(
            utils.ValidationError, 'language_code must be a string'
        ):
    ...
    def test_validate_needs_update(self) -> None:
        ...
        # wrong inputs that we can normally catch by typing.
        with self.assertRaisesRegex(
            utils.ValidationError, 'needs_update must be a bool'
        ):
            entity_translations.translations[
                'content_id_1'].needs_update = 5  # type: ignore[assignment]
            entity_translations.validate()
...
class TranslatableContentUnitTests(test_utils.GenericTestBase):
    ...
    def test_creation_of_object(self) -> None:
        ...
        self.assertEqual(
            translatable_content.content_type, translation_domain.ContentType.CONTENT
        )
    ...
    def test_to_dict_method_of_translatable_content_class(self) -> None:
        ...
        translatable_content = translation_domain.TranslatableContent(
            'content_id_1', translation_domain.ContentType.CONTENT,
            translation_domain.TranslatableContentFormat.HTML, 'My name is Jhon.'
        )
...
class WrittenTranslationsDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_data_formats_are_correct_and_complete(self) -> None:
        translatable_class_names_in_data_formats = sorted(
            translation_domain.WrittenTranslation.DATA_FORMAT_TO_TRANSLATABLE_OBJ_TYPE.
            values()
        )
        self.assertEqual(
    ...
    def test_validate_non_dict_language_code_to_written_translation(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, re.escape('Expected content_id value to be a dict, received []')
        ):
