...
def assign_rating_to_exploration(
    user_id: str, exploration_id: str, new_rating: int
) -> None:
...
def get_user_specific_rating_for_exploration(user_id: str,
                                             exploration_id: str) -> Optional[int]:
...
def get_when_exploration_rated(user_id: str,
                               exploration_id: str) -> Optional[datetime.datetime]:
