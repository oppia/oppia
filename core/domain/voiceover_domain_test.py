...
class VoiceoverAutogenerationPolicyUnitTests(test_utils.GenericTestBase):
    """Test for VoiceoverAutogenerationPolicy domain class."""
    ...
    def test_creation_of_object(self) -> None:
        ...
        self.assertEqual(
            (
                voiceover_autogeneration_policy.
                language_codes_mapping['en']['en-US']
            ),
            False)
        self.assertEqual(
            (
    ...
    def test_validate_autogenerated_voiceovers_are_enabled_type(self) -> None:
        language_codes_mapping = {
            'en': {
                'en-US': False
            }
        ...
        with self.assertRaisesRegex(
            ...
            voiceover_auto_pol.autogenerated_voiceovers_are_enabled = (
    ...
    def test_validate_language_codes_mapping_type(self) -> None:
        ...
        with self.assertRaisesRegex(utils.ValidationError, expected_error_msg):
            ...
            # the codebase we plan to get rid of the tests that intentionally
            # test wrong inputs that we can normally catch by typing.
            voiceover_autogeneration_policy.language_codes_mapping = 3  # type: ignore[assignment]
            voiceover_autogeneration_policy.validate()

        with self.assertRaisesRegex(utils.ValidationError, expected_error_msg):
            # TODO(#13059): Here we use MyPy ignore because after we fully type
            # the codebase we plan to get rid of the tests that intentionally
            # test wrong inputs that we can normally catch by typing.
            voiceover_autogeneration_policy.language_codes_mapping = True # type: ignore[assignment]
            voiceover_autogeneration_policy.validate()
        ...
        with self.assertRaisesRegex(utils.ValidationError, expected_error_msg):
            ...
            # the codebase we plan to get rid of the tests that intentionally
            # test wrong inputs that we can normally catch by typing.
            voiceover_autogeneration_policy.language_codes_mapping = ['1']  # type: ignore[assignment]
            voiceover_autogeneration_policy.validate()
    ...
    def test_validate_language_code_mapping_type(self) -> None:
        ...
        with self.assertRaisesRegex(utils.ValidationError, expected_error_msg):
            ...
            # the codebase we plan to get rid of the tests that intentionally
            # test wrong inputs that we can normally catch by typing.
            voiceover_autogeneration_policy.language_codes_mapping['en'] = 4  # type: ignore[assignment]
            voiceover_autogeneration_policy.validate()
        ...
        with self.assertRaisesRegex(utils.ValidationError, expected_error_msg):
            ...
            # the codebase we plan to get rid of the tests that intentionally
            # test wrong inputs that we can normally catch by typing.
            voiceover_autogeneration_policy.language_codes_mapping['en'] = False  # type: ignore[assignment]
            voiceover_autogeneration_policy.validate()
        ...
        with self.assertRaisesRegex(utils.ValidationError, expected_error_msg):
            ...
            # the codebase we plan to get rid of the tests that intentionally
            # test wrong inputs that we can normally catch by typing.
            voiceover_autogeneration_policy.language_codes_mapping['en'] = ['1']  # type: ignore[assignment]
            voiceover_autogeneration_policy.validate()
    ...
    def test_validate_language_code_equals_extracted_language_code(
        ...
        with self.assertRaisesRegex(utils.ValidationError, expected_error_msg):
            voiceover_autogeneration_policy.language_codes_mapping['en'] = {
                'fr-US': False
            }
            voiceover_autogeneration_policy.validate()
    ...
    def test_validate_language_code_type(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            # the codebase we plan to get rid of the tests that intentionally
            # test wrong inputs that we can normally catch by typing.
            voiceover_autogeneration_policy.language_codes_mapping[1] = {  # type: ignore[index]
                'en-US': False
            }
            voiceover_autogeneration_policy.validate()
    ...
    def test_validate_language_accent_code_type(self) -> None:
        language_codes_mapping = {
            'en': {
                'en-US': False
            }
    ...
    def test_validate_is_auto_voiceover_enabled_type(self) -> None:
        language_codes_mapping = {
            'en': {
                'en-US': False
            }
