...
class VoiceoverAutogenerationPolicyUnitTests(test_utils.GenericTestBase):
    ...
    def test_creation_of_object(self) -> None:
        ...
        self.assertEqual(
            voiceover_auto_policy.language_codes_mapping['en']['en-US'],
            False)
        self.assertEqual(
            voiceover_auto_policy.autogenerated_voiceovers_are_enabled,
            True)
    ...
    def test_validate_language_code_type(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            # the codebase we plan to get rid of the tests that intentionally
            # test wrong inputs that we can normally catch by typing.
            voiceover_auto_policy.language_codes_mapping[1] = {  # type: ignore[index]
                'en-US': False
            }
            voiceover_auto_policy.validate()
    ...
    def test_validate_language_code(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            voiceover_auto_policy.language_codes_mapping['n'] = {
                'en-US': False
            }
            voiceover_auto_policy.validate()
