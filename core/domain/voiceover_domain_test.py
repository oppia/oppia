...
class EntityVoiceoversUnitTests(test_utils.GenericTestBase):
    ...
    def test_to_dict_method_of_entity_voiceovers_class(self) -> None:
        ...
        self.assertDictEqual(
            self.entity_voiceovers_instance.to_dict(), expected_entity_voiceovers_dict
        )
    ...
    def test_from_dict_method_of_entity_voiceovers_class(self) -> None:
        ...
        self.assertDictEqual(
            entity_voiceovers_dict, expected_entity_voiceovers_instance.to_dict()
        )
    ...
    def test_add_voiceovers_correctly(self) -> None:
        ...
        self.assertDictEqual(
            manual_voiceover.to_dict(), self.dummy_manual_voiceover_dict
        )
        ...
        assert isinstance(manual_voiceover, state_domain.Voiceover)
        self.assertDictEqual(manual_voiceover.to_dict(), dummy_new_voiceover_dict)
    ...
    def test_removes_voiceover_correctly(self) -> None:
        ...
        self.entity_voiceovers_instance.remove_voiceover(
            content_id='content_id_0', voiceover_type=feconf.VoiceoverType.MANUAL
        )
        ...
        self.entity_voiceovers_instance.remove_voiceover(
            content_id='content_id_0', voiceover_type=feconf.VoiceoverType.AUTO
        )
    ...
    def test_create_empty_entity_voiceovers(self) -> None:
        empty_entity_voiceovers = voiceover_domain.EntityVoiceovers.create_empty(
        ...
        self.assertEqual(empty_entity_voiceovers.entity_type, 'exploration')
        self.assertEqual(empty_entity_voiceovers.language_accent_code, 'en-US')
        self.assertEqual(empty_entity_voiceovers.voiceovers_mapping, {})

    def test_should_be_able_to_add_new_content_id(self) -> None:
        entity_voiceovers_object = voiceover_domain.EntityVoiceovers.create_empty(
            'exp_id', 'exploration', 1, 'en-US'
        )

        self.assertEqual(entity_voiceovers_object.entity_id, 'exp_id')
        self.assertEqual(entity_voiceovers_object.entity_version, 1)
        self.assertEqual(entity_voiceovers_object.entity_type, 'exploration')
        ...
        entity_voiceovers_object.add_new_content_id_without_voiceovers('content_1')
        ...
        manual_voiceover = entity_voiceovers_object.voiceovers_mapping['content_1'][
            feconf.VoiceoverType.MANUAL
        ]
        assert isinstance(manual_voiceover, state_domain.Voiceover)
    ...
    def test_is_both_voiceovers_empty_should_return_successfully(self) -> None:
        ...
        entity_voiceovers_object.add_new_content_id_without_voiceovers('content_0')

        self.assertTrue(entity_voiceovers_object.is_both_voiceovers_empty('content_0'))
        ...
        self.assertFalse(entity_voiceovers_object.is_both_voiceovers_empty('content_0'))
