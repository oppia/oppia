...
class TaskEntry:
    ...
    Attributes:
        entity_type: The type of entity the task entry refers to.
            For example, "exploration".
        entity_id: The ID of the entity the task entry refers to.
            For example, an exploration ID.
        entity_version: The version of the entity the task entry refers to.
            For example, an exploration's version.
        task_type: The type of task the task entry tracks.
        target_type: The type of sub-entity the task entry refers to.
            For example, "state" when entity type is "exploration".
        target_id: The ID of the sub-entity the task entry refers to.
            For example, the state name of an exploration.
        issue_description: The sentence generated by Oppia to
            describe why the task was created.
        status: Tracks the state/progress of the task entry.
        resolver_id: The corresponding user who resolved this task.
        resolved_on: The datetime at which this task was resolved.
    """
    ...
    def __init__(
        ...
        Args:
            ...
            entity_id: The ID of the entity the task entry refers to.
                For example: an exploration ID.
            entity_version: The version of the entity the task entry refers
            ...
            target_id: The ID of the sub-entity the task entry refers to.
                For example, the state name of an exploration.
            issue_description: The sentence generated by Oppia to describe
    ...
    def composite_entity_id(self) -> str:
        ...
        Returns:
            The value of the utility field.
        """
    ...
    def to_dict(self) -> TaskEntryDict:
        ...
        Returns:
            Contains the following keys:
                ...
                entity_id: The ID of the entity the task entry refers to.
                    For example, an exploration ID.
                entity_version: The version of the entity the task entry
                    refers to. For example, an exploration's version.
                task_type: The type of task the task entry tracks.
                target_type: The type of sub-entity the task entry refers
                    to. For example, "state" when entity type is "exploration".
                target_id: The ID of the sub-entity the task entry refers
                    to. For example, the state name of an exploration.
                issue_description: The sentence generated by Oppia to
                    describe why the task was created.
                status: Tracks the state/progress of the task entry.
                resolver_username: Username of the user who resolved
                    the task when status is resolved. Otherwise None.
                resolver_profile_picture_data_url: Profile picture URL
                    of the user who resolved the task when status is
                    resolved. Otherwise None.
                resolved_on_msecs: Time in milliseconds since epoch at
