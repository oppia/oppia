        ...
        Returns:
            dict. Contains the following keys:
                ...
                issue_description: str. The sentence generated by Oppia to
                    describe why the task was created.
                status: str. Tracks the state/progress of the task entry.
                resolver_username: str|None. Username of the user who resolved the
                    task when status is resolved. Otherwise None.
                resolver_profile_picture_data_url: str|None. Profile picture URL of
                    the user who resolved the task when status is resolved.
                    Otherwise None.
                resolved_on_msecs: float|datetime.datetime|None. Time in milliseconds
                    since epoch at which the task was resolved when status is
