...
class TopicChange(change_domain.BaseChange):
    ...
    SUBTOPIC_PROPERTIES: List[str] = [
        SUBTOPIC_PROPERTY_TITLE, SUBTOPIC_PROPERTY_THUMBNAIL_FILENAME,
        SUBTOPIC_PROPERTY_THUMBNAIL_BG_COLOR, SUBTOPIC_PROPERTY_URL_FRAGMENT
    ]
...
class StoryReference:
    ...
    def from_dict(cls, story_reference_dict: StoryReferenceDict) -> StoryReference:
        ...
        """
        story_reference = cls(
            story_reference_dict['story_id'], story_reference_dict['story_is_published']
        )
...
class Subtopic:
    ...
    def __init__(
        self, subtopic_id: int, title: str, skill_ids: List[str],
        thumbnail_filename: Optional[str], thumbnail_bg_color: Optional[str],
        thumbnail_size_in_bytes: Optional[int], url_fragment: str
    ) -> None:
    ...
    def from_dict(cls, subtopic_dict: SubtopicDict) -> Subtopic:
        ...
        """
        subtopic = cls(
            subtopic_dict['id'], subtopic_dict['title'], subtopic_dict['skill_ids'],
            subtopic_dict['thumbnail_filename'], subtopic_dict['thumbnail_bg_color'],
            subtopic_dict['thumbnail_size_in_bytes'], subtopic_dict['url_fragment']
        )
        return subtopic
...
class Topic:
    ...
    def to_dict(self) -> TopicDict:
        ...
        return {
            ...
            'canonical_story_references': [
                reference.to_dict() for reference in self.canonical_story_references
            ],
            'additional_story_references': [
                reference.to_dict() for reference in self.additional_story_references
            ],
    ...
    def from_dict(
        ...
        """
        topic = cls(
            topic_dict['id'], topic_dict['name'], topic_dict['abbreviated_name'],
            topic_dict['url_fragment'], topic_dict['thumbnail_filename'],
            topic_dict['thumbnail_bg_color'], topic_dict['thumbnail_size_in_bytes'],
            ...
            ], topic_dict['subtopic_schema_version'], topic_dict['next_subtopic_id'],
            topic_dict['language_code'], topic_version,
            topic_dict['story_reference_schema_version'],
            topic_dict['meta_tag_content'], topic_dict['practice_tab_is_displayed'],
    ...
    def deserialize(cls, json_string: str) -> Topic:
        ...
        created_on = (
            utils.convert_string_to_naive_datetime_object(topic_dict['created_on'])
            if 'created_on' in topic_dict else None
        )
        last_updated = (
            utils.convert_string_to_naive_datetime_object(topic_dict['last_updated'])
    ...
    def get_canonical_story_ids(self,
                                include_only_published: bool = False) -> List[str]:
    ...
    def validate(self, strict: bool = False) -> None:
        ...
        if (self.subtopic_schema_version != feconf.CURRENT_SUBTOPIC_SCHEMA_VERSION):
            raise utils.ValidationError(
                ...
                (feconf.CURRENT_SUBTOPIC_SCHEMA_VERSION, self.subtopic_schema_version)
            )
        ...
        skill_ids_for_diagnostic_that_are_not_in_topic = (
            set(self.skill_ids_for_diagnostic_test) - set(all_skill_ids)
        )
    ...
    def create_default_topic(
        ...
        """
        return cls(
            topic_id, name, name, url_fragment, None, None, None, description, [], [],
            [], [], feconf.CURRENT_SUBTOPIC_SCHEMA_VERSION, 1,
            constants.DEFAULT_LANGUAGE_CODE, 0,
            feconf.CURRENT_STORY_REFERENCE_SCHEMA_VERSION, '', False, page_title_frag,
            []
        )
    ...
    def update_story_references_from_model(
        cls, versioned_story_references: VersionedStoryReferencesDict,
        current_version: int
    ) -> None:
    ...
    def remove_uncategorized_skill_id(self, uncategorized_skill_id: str) -> None:
        ...
        if uncategorized_skill_id not in self.uncategorized_skill_ids:
            raise Exception(
                'The skill id %s is not present in the topic.' % uncategorized_skill_id
            )
    ...
    def add_subtopic(self, new_subtopic_id: int, title: str, url_frag: str) -> None:
        ...
        if self.next_subtopic_id != new_subtopic_id:
            raise Exception(
                ...
                'next subtopic id: %s' % (new_subtopic_id, self.next_subtopic_id)
            )
    ...
    def update_subtopic_thumbnail_filename_and_size(
        self, subtopic_id: int, new_thumbnail_filename: str, new_thumbnail_size: int
    ) -> None:
    ...
    def move_skill_id_to_subtopic(
        self, old_subtopic_id: Optional[int], new_subtopic_id: int, skill_id: str
    ) -> None:
        ...
        if old_subtopic_id is not None:
            ...
            if skill_id not in self.subtopics[old_subtopic_index].skill_ids:
                raise Exception(
                    'Skill id %s is not present in the given old subtopic' % skill_id
                )
        else:
        ...
        if skill_id in self.subtopics[new_subtopic_index].skill_ids:
            raise Exception(
                'Skill id %s is already present in the target subtopic' % skill_id
            )
...
class TopicSummary:
    ...
    def __init__(
        self, topic_id: str, name: str, canonical_name: str, language_code: str,
        description: str, version: int, canonical_story_count: int,
        additional_story_count: int, uncategorized_skill_count: int,
        subtopic_count: int, total_skill_count: int, total_published_node_count: int,
        thumbnail_filename: Optional[str], thumbnail_bg_color: Optional[str],
        url_fragment: str, published_story_exploration_mapping: Dict[str, List[str]],
...
class TopicChapterCounts:
    ...
    def __init__(
        self, total_upcoming_chapters_count: int, total_overdue_chapters_count: int,
        total_chapter_counts_for_each_story: List[int],
        published_chapter_counts_for_each_story: List[int]
    ) -> None:
