...
class LearnerGroupFetchersUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_learner_groups_of_facilitator(self) -> None:
        ...
        fake_learner_groups = learner_group_fetchers.get_learner_groups_of_facilitator(
            fake_facilitator_id
        )
    ...
    def test_get_invited_learner_groups_of_learner(self) -> None:
        ...
        learner_groups = learner_group_fetchers.get_invited_learner_groups_of_learner(
            fake_learner_id
        )
    ...
    def test_get_learner_groups_joined_by_learner(self) -> None:
        learner_groups = learner_group_fetchers.get_learner_groups_joined_by_learner(
            self.LEARNER_ID_1
        )
        self.assertEqual(len(learner_groups), 0)
