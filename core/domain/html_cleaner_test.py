...
class RteComponentExtractorUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_image_filenames_from_html_strings(self):
        html_strings = [
            ...
            ' alt-with-value="&quot;Image&quot;">'
            '</oppia-noninteractive-svgeditor><oppia-noninteractive-svgeditor '
            'svg_filename-with-value="&quot;img6.svg&quot;"'
            ' alt-with-value="&quot;Image&quot;">'
            '</oppia-noninteractive-svgeditor><oppia-noninteractive-image '
