...
class UserGlobalPrefsTests(test_utils.GenericTestBase):
    ...
    def test_initialization(self):
        """Testing init method."""
        user_global_prefs = (
            user_domain.UserGlobalPrefs(True, False, True, False))
...
class UserExplorationPrefsTests(test_utils.GenericTestBase):
    ...
    def test_initialization(self):
        """Testing init method."""
        user_exp_prefs = (
            user_domain.UserExplorationPrefs(False, True))
...
class IncompleteActivitiesTests(test_utils.GenericTestBase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(
            incomplete_activities.id, 'user_id0')
...
class UserContributionScoringTests(test_utils.GenericTestBase):
    ...
    def test_initialization(self):
        ...
        user_contribution_scoring = (
            user_domain.UserContributionScoring(
