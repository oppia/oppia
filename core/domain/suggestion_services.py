...
def SUGGESTION_ADD_QUESTION_HTML(
    ...
    return suggestion.change_cmd.question_dict['question_state_data'][
        'content'
    ]['html']
...
def create_suggestion(
    ...
    if suggestion_type == feconf.SUGGESTION_TYPE_EDIT_STATE_CONTENT:
        ...
        for existing_suggestion in existing_suggestions:
            if (
                existing_suggestion.change_cmd['content_id']
        ...
        if change_cmd['content_id'] in entity_translation.translations:
            if not entity_translation.translations[
                ...
                raise Exception(
                    'The content with content_id %s has already been translated to %s and is up-to-date.'
