...
class QuestionServicesUnitTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.question = self.save_new_question(
            ...
            inapplicable_skill_misconception_ids=['skillid12345-1', 'skillid12345-2'],
        )
        ...
        self.question_1 = self.save_new_question(
            self.question_id_1,
            self.editor_id,
            self._create_valid_question_data('ABC', self.content_id_generator_1),
            ['skill_2'],
        ...
        self.question_2 = self.save_new_question(
            self.question_id_2,
            self.editor_id,
            self._create_valid_question_data('ABC', self.content_id_generator_2),
            ['skill_2'],
    ...
    def test_get_question_by_id(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'Entity for class QuestionModel with id question_id ' 'not found'
        ):
    ...
    def test_get_questions_by_skill_ids_with_fetch_by_difficulty(self) -> None:
        ...
        sort_fn: Callable[[question_domain.Question], float] = lambda question: (
            question.last_updated.timestamp() if question.last_updated else 0
        )
    ...
    def test_create_multi_question_skill_links_for_question(self) -> None:
        ...
        question_services.link_multiple_skills_for_question(
            self.editor_id, self.question_id, ['skill_1', 'skill_2'], [0.5, 0.7]
        )
        skill_ids = [
            skill.id
            for skill in question_services.get_skills_linked_to_question(
                self.question_id
            )
        ]
    ...
    def test_linking_same_skill_to_question_twice(self) -> None:
        ...
        skill_ids = [
            skill.id
            for skill in question_services.get_skills_linked_to_question(question_id_2)
        ]
    ...
    def test_get_displayable_question_skill_link_details_with_no_skill_ids(
        ...
        question_summaries, merged_question_skill_links = (
            question_services.get_displayable_question_skill_link_details(2, [], 0)
        )
    ...
    def test_get_question_skill_links_of_skill(self) -> None:
        ...
        question_skill_links = question_services.get_question_skill_links_of_skill(
        ...
        self.assertTrue(
            isinstance(question_skill_links[0], question_domain.QuestionSkillLink)
        )
        question_ids = [
            question_skill.question_id for question_skill in question_skill_links
        ]
        self.assertItemsEqual(question_ids, [self.question_id, question_id_2])
    ...
    def test_get_question_summaries_by_ids(self) -> None:
        ...
        self.assertEqual(
            question_summaries[0].question_content, feconf.DEFAULT_STATE_CONTENT_STR
        )
    ...
    def test_delete_question_marked_deleted(self) -> None:
        ...
        self.assertEqual(
            question_models.QuestionSummaryModel.get(self.question_id, strict=False),
            None,
        )
    ...
    def test_delete_question_model_with_deleted_summary_model(self) -> None:
        ...
        question_summary_model_with_none = question_models.QuestionSummaryModel.get(
    ...
    def test_compute_summary_of_question(self) -> None:
        ...
        self.assertEqual(
            question_summary.question_content, feconf.DEFAULT_STATE_CONTENT_STR
        )
    ...
    def test_get_skills_of_question(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception,
            'Entity for class QuestionModel with id '
    ...
    def test_get_interaction_id_for_question(self) -> None:
        self.assertEqual(
            question_services.get_interaction_id_for_question(self.question_id),
            'TextInput',
        )
    ...
    def test_untag_deleted_misconceptions_on_no_change_to_skill(self) -> None:
        ...
        self.question = self.save_new_question(
            ...
            ['skillid12345'],
            content_id_generator.next_content_id_index,
            inapplicable_skill_misconception_ids=(inapplicable_skill_misconception_ids),
        )
        question_services.create_new_question_skill_link(
        ...
        question_services.untag_deleted_misconceptions(
            self.editor_id, 'skillid12345', 'Skill with misconceptions', []
        )
    ...
    def test_populate_question_model_fields(self) -> None:
        ...
        self.assertEqual(
            populated_model.question_state_data, question.question_state_data.to_dict()
        )
        ...
        self.assertEqual(
            populated_model.next_content_id_index, question.next_content_id_index
        )
    ...
    def test_populate_question_summary_model_fields(self) -> None:
        ...
        self.assertEqual(
            populated_model.question_model_last_updated, question_summary.last_updated
        )
        self.assertEqual(
            populated_model.question_model_created_on, question_summary.created_on
        )
        self.assertEqual(
            populated_model.question_content, question_summary.question_content
        )
        self.assertEqual(populated_model.version, question_summary.version)
        self.assertEqual(
            populated_model.interaction_id, question_summary.interaction_id
        )
        self.assertEqual(
            populated_model.misconception_ids, question_summary.misconception_ids
        )
...
class QuestionMigrationTests(test_utils.GenericTestBase):
    ...
    def test_migrate_question_state_from_v31_to_latest(self) -> None:
        answer_group = {
            ...
            'rule_specs': [
                {'inputs': {'x': ['A', 'B', 'C']}, 'rule_type': 'HasElementsIn'}
            ],
            'training_data': [],
            'tagged_skill_misconception_id': None,
        }
    ...
    def test_migrate_question_state_from_v32_to_latest(self) -> None:
        answer_group = {
            ...
            'rule_specs': [{'inputs': {'x': ['A']}, 'rule_type': 'Equals'}],
            'training_data': [],
            'tagged_skill_misconception_id': None,
        }
        question_state_dict = {
    ...
    def test_migrate_question_state_from_v33_to_latest(self) -> None:
        ...
        answer_group = {
            'outcome': {
                'dest': 'abc',
                'dest_if_really_stuck': None,
                'feedback': {'content_id': 'feedback_1', 'html': feedback_html_content},
                'labelled_as_correct': True,
                'param_changes': [],
                'refresher_exploration_id': None,
                'missing_prerequisite_skill_id': None,
        ...
        migrated_answer_group = question.question_state_data.interaction.answer_groups[
            0
        ]
        self.assertEqual(
            migrated_answer_group.outcome.feedback.html, expected_feeedback_html_content
        )
    ...
    def test_migrate_question_state_from_v34_to_latest(self) -> None:
        ...
        question_state_dict = {
            ...
            'interaction': {
                ...
                'hints': [{'hint_content': {'content_id': 'hint_1', 'html': 'Hint 1'}}],
                'solution': {
                    'correct_answer': {'ascii': 'x=y', 'latex': 'x=y'},
                    'answer_is_exclusive': False,
                    'explanation': {
                        'html': 'Solution explanation',
                        'content_id': 'explanation_1',
        ...
        answer_groups = question.question_state_data.interaction.answer_groups
        self.assertEqual(
            question.question_state_data.interaction.id, 'AlgebraicExpressionInput'
        )
        ...
        question_state_dict = {
            ...
            'interaction': {
                ...
                'hints': [{'hint_content': {'content_id': 'hint_1', 'html': 'Hint 1'}}],
                'solution': {
                    'correct_answer': {'ascii': '1.2 + 3', 'latex': '1.2 + 3'},
                    'answer_is_exclusive': False,
                    'explanation': {
                        'html': 'Solution explanation',
                        'content_id': 'explanation_1',
        ...
        answer_groups = question.question_state_data.interaction.answer_groups
        self.assertEqual(
            question.question_state_data.interaction.id, 'NumericExpressionInput'
        )
        self.assertEqual(len(answer_groups[0].rule_specs), 1)
        self.assertEqual(answer_groups[0].rule_specs[0].rule_type, 'MatchesExactlyWith')
        ...
        question_state_dict = {
            ...
            'interaction': {
                ...
                'default_outcome': {
                    'dest': 'Introduction',
                    'dest_if_really_stuck': None,
                    'feedback': {'content_id': 'feedback_3', 'html': 'Correct Answer'},
                    'param_changes': [],
                    'refresher_exploration_id': None,
                    'labelled_as_correct': True,
                    'missing_prerequisite_skill_id': None,
        ...
        self.assertEqual(
            sorted(state_data.recorded_voiceovers.voiceovers_mapping.keys()),
    ...
    def test_migrate_question_state_from_v35_to_latest(self) -> None:
        ...
        question_state_dict = {
            ...
            'written_translations': {
                'translations_mapping': {
                    'explanation': {'en': {'html': '<p>test</p>', 'needs_update': True}}
                }
            },
            'interaction': {
                'answer_groups': [],
        ...
        question_state_dict = {
            ...
            'interaction': {
                'answer_groups': [],
                'confirmed_unclassified_answers': [],
                'customization_args': {'initial_code': {'value': 'code'}},
                'default_outcome': {
                    'dest': None,
                    'dest_if_really_stuck': None,
                    'feedback': {
        ...
        self.assertEqual(
            migrated_ca,
            {
                'choices': {'value': [{'content_id': 'ca_choices_2', 'html': ''}]},
                'showChoicesInShuffledOrder': {'value': True},
            },
        )
        ...
        question_state_dict = {
            ...
            'interaction': {
                'answer_groups': [],
                'confirmed_unclassified_answers': [],
                'customization_args': {'choices': {'value': ['one', 'two', 'three']}},
                'default_outcome': {
                    'dest': None,
                    'dest_if_really_stuck': None,
                    'feedback': {
        ...
        self.assertEqual(
            migrated_ca,
            {
                'choices': {
                    'value': [
                        {'content_id': 'ca_choices_2', 'html': 'one'},
                        {'content_id': 'ca_choices_3', 'html': 'two'},
                        {'content_id': 'ca_choices_4', 'html': 'three'},
                    ]
                },
                'showChoicesInShuffledOrder': {'value': True},
            },
    ...
    def test_migrate_question_state_from_v36_to_latest(self) -> None:
        ...
        self.assertEqual(
            ...
            {
                'inputs': {
                    'x': {'contentId': 'rule_input_3', 'normalizedStrSet': ['test']}
                },
                'rule_type': 'Equals',
            },
        )
    ...
    def test_migrate_question_state_from_v38_to_latest(self) -> None:
        answer_group = {
            ...
            'rule_specs': [{'inputs': {'x': '1/2'}, 'rule_type': 'MatchesExactlyWith'}],
            'training_data': [],
            'tagged_skill_misconception_id': None,
        }
        question_state_dict = {
    ...
    def test_migrate_question_state_with_text_input_from_v40_to_latest(self) -> None:
        answer_group = {
            ...
            'rule_specs': [{'inputs': {'x': ['Test']}, 'rule_type': 'Equals'}],
            'training_data': [],
            'tagged_skill_misconception_id': None,
        }
        question_state_dict = {
        ...
        self.assertEqual(
            rule_spec.inputs['x'],
            {'contentId': 'rule_input_3', 'normalizedStrSet': ['Test']},
        )
    ...
    def test_migrate_question_state_with_set_input_from_v40_to_latest(self) -> None:
        ...
        question_state_dict = {
            ...
            'interaction': {
                ...
                'customization_args': {
                    'buttonText': {
                        'value': {'content_id': 'ca_buttonText_0', 'unicode_str': ''}
                    },
                },
                'default_outcome': {
                    'dest': None,
        ...
        self.assertEqual(
            rule_spec.inputs['x'],
            {'contentId': 'rule_input_3', 'unicodeStrSet': ['Test']},
        )
    ...
    def test_migrate_question_state_from_v41_with_item_selection_input_interaction_to_latest(  # pylint: disable=line-too-long
        ...
        answer_group = {
            ...
            'rule_specs': [
                {
                    'inputs': {'x': ['<p>Choice 1</p>', '<p>Choice 2</p>']},
                    'rule_type': 'Equals',
                }
            ],
            'training_data': [],
        ...
        question_state_dict = {
            ...
            'interaction': {
                ...
                'customization_args': {
                    'choices': {
                        'value': [
                            {'content_id': 'ca_choices_2', 'html': '<p>Choice 1</p>'},
                            {'content_id': 'ca_choices_3', 'html': '<p>Choice 2</p>'},
                        ]
                    },
    ...
    def test_migrate_question_state_from_v41_with_drag_and_drop_sort_input_interaction_to_latest(  # pylint: disable=line-too-long
        ...
        answer_group = {
            ...
            'rule_specs': [
                ...
                {
                    'inputs': {'x': [['<p>Choice 1</p>']]},
                    'rule_type': 'IsEqualToOrderingWithOneItemAtIncorrectPosition',
                },
                {
                    'inputs': {'x': '<p>Choice 1</p>', 'y': 1},
                    'rule_type': 'HasElementXAtPositionY',
                },
                {
                    'inputs': {'x': '<p>Choice 1</p>', 'y': '<p>Choice 2</p>'},
        ...
        self.assertEqual(
            answer_group_object.rule_specs[1].inputs['x'], [['ca_choices_4']]
        )
