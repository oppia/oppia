...
class QuestionServicesUnitTest(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.question_1 = self.save_new_question(
            ...
            ['skill_2'], self.content_id_generator_1.next_content_id_index
        )
        ...
        self.question_2 = self.save_new_question(
            ...
            ['skill_2'], self.content_id_generator_2.next_content_id_index
        )
    ...
    def test_get_total_question_count_for_skill_ids(self) -> None:
        ...
        question_count = (
            question_services.get_total_question_count_for_skill_ids(['skill_1'])
        )
        self.assertEqual(question_count, 2)

        question_count = (
            question_services.get_total_question_count_for_skill_ids(['skill_2'])
        )
    ...
    def test_create_multi_question_skill_links_for_question(self) -> None:
        ...
        skill_ids = [
            ...
            question_services.get_skills_linked_to_question(self.question_id)
        ]
    ...
    def test_create_and_get_question_skill_link(self) -> None:
        ...
        self.save_new_question(
            ...
            self._create_valid_question_data('ABC', content_id_generator), ['skill_2'],
            content_id_generator.next_content_id_index
        )
        question_services.create_new_question_skill_link(
    ...
    def test_untag_deleted_misconceptions_on_no_change_to_skill(self) -> None:
        ...
        expected_misconception_ids = [
            'skillid12345-0', 'skillid12345-1', 'skillid12345-2'
        ]
        self.assertEqual(
            self.question.inapplicable_skill_misconception_ids,
...
class QuestionMigrationTests(test_utils.GenericTestBase):
    ...
    def test_migrate_question_state_from_v36_to_latest(self) -> None:
        ...
        migrated_rule_spec = (
            question.question_state_data.interaction.answer_groups[0].rule_specs[0].
            to_dict()
        )
        self.assertEqual(
            migrated_rule_spec, {
