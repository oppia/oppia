...
class CollectionCreateAndDeleteUnitTests(CollectionServicesUnitTests):
    ...
    def test_soft_deletion_of_collection(self) -> None:
        ...
        collection_snapshot_id = (
            collection_models.CollectionModel.get_snapshot_id(self.COLLECTION_0_ID, 1)
        )
        self.assertIsNotNone(
            collection_models.CollectionSnapshotMetadataModel.
            get_by_id(collection_snapshot_id)
        )
        self.assertIsNotNone(
        ...
        self.assertIsNotNone(
            ...
            get_by_id(collection_rights_snapshot_id)
        )
        self.assertIsNotNone(
    ...
    def test_soft_deletion_of_multiple_collections(self) -> None:
        ...
        collection_1_snapshot_id = (
            collection_models.CollectionModel.get_snapshot_id(self.COLLECTION_1_ID, 1)
        )
        self.assertIsNotNone(
            collection_models.CollectionSnapshotMetadataModel.
            get_by_id(collection_0_snapshot_id)
        )
        self.assertIsNotNone(
            collection_models.CollectionSnapshotContentModel.
            get_by_id(collection_0_snapshot_id)
        ...
        self.assertIsNotNone(
            collection_models.CollectionSnapshotMetadataModel.
            get_by_id(collection_1_snapshot_id)
        )
        self.assertIsNotNone(
            collection_models.CollectionSnapshotContentModel.
            get_by_id(collection_1_snapshot_id)
        ...
        self.assertIsNotNone(
            collection_models.CollectionRightsSnapshotMetadataModel.
            get_by_id(collection_0_rights_snapshot_id)
        )
        self.assertIsNotNone(
            collection_models.CollectionRightsSnapshotContentModel.
            get_by_id(collection_0_rights_snapshot_id)
        ...
        self.assertIsNotNone(
            collection_models.CollectionRightsSnapshotMetadataModel.
            get_by_id(collection_1_rights_snapshot_id)
        )
        self.assertIsNotNone(
            collection_models.CollectionRightsSnapshotContentModel.
            get_by_id(collection_1_rights_snapshot_id)
    ...
    def test_summaries_of_hard_deleted_collections(self) -> None:
        ...
        self.assertNotIn(
            self.COLLECTION_0_ID, [
                collection.id for collection in
                collection_models.CollectionSummaryModel.get_all(include_deleted=True)
            ]
        )
    ...
    def test_save_and_retrieve_collection_summary(self) -> None:
        ...
        retrieved_collection_summary = (
            collection_services.get_collection_summary_by_id(self.COLLECTION_0_ID)
        )
