...
class SkillDomainUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        rubrics = [
            skill_domain.Rubric(constants.SKILL_DIFFICULTIES[0], ['<p>Explanation 1</p>']),
            skill_domain.Rubric(constants.SKILL_DIFFICULTIES[1], ['<p>Explanation 2</p>']),
            skill_domain.Rubric(constants.SKILL_DIFFICULTIES[2], ['<p>Explanation 3</p>']),
        ]
    ...
    def test_update_contents_from_model(self) -> None:
        versioned_skill_contents: skill_domain.VersionedSkillContentsDict = {
            ...
            'skill_contents': {
                ...
                'recorded_voiceovers': {'voiceovers_mapping': {'explanation': {}}},
                'written_translations': {'translations_mapping': {'explanation': {}}},
            },
        }
    ...
    def test_rubrics_validation(self) -> None:
        ...
        self.skill.rubrics = [
            skill_domain.Rubric(constants.SKILL_DIFFICULTIES[0], ['<p>Explanation</p>']),
            skill_domain.Rubric(constants.SKILL_DIFFICULTIES[0], ['<p>Another Explanation</p>']),
        ]
    ...
    def test_order_of_rubrics(self) -> None:
        self.skill.rubrics = [
            skill_domain.Rubric(constants.SKILL_DIFFICULTIES[1], ['<p>Explanation 1</p>']),
            skill_domain.Rubric(constants.SKILL_DIFFICULTIES[2], ['<p>Explanation 2</p>']),
            skill_domain.Rubric(constants.SKILL_DIFFICULTIES[0], ['<p>Explanation 3</p>']),
        ]
    ...
    def test_update_rubrics_from_model(self) -> None:
        ...
        self.assertEqual(
            versioned_rubrics,
            {
                'schema_version': 3,
                'rubrics': [
                    {'explanations': [('<p>Explanation</p><oppia-noninteractive-math math_content-with-value="{&amp;quot;raw_latex&amp;quot;: &amp;quot;+,-,-,+&amp;quot;, &amp;quot;svg_filename&amp;quot;: &amp;quot;&amp;quot;}"></oppia-noninteractive-math>')]},
                    {'explanations': ['explanation2']},
                ],
            },
        )
        ...
        self.assertEqual(
            versioned_rubrics,
            {
                'schema_version': 4,
                'rubrics': [
                    {'explanations': ['<oppia-noninteractive-image alt-with-value="&amp;quot;Image&amp;quot;" caption-with-value="&amp;quot;&amp;quot;" filepath-with-value="&amp;quot;img1.svg&amp;quot;"></oppia-noninteractive-image>']},
                    {'explanations': ['explanation2']},
                ],
            },
        )
...
class SkillSummaryTests(test_utils.GenericTestBase):
    def setUp(self) -> None:
        ...
        self.skill_summary = skill_domain.SkillSummary('skill_id', 'description', 'en', 1, 1, current_time, current_time)
