...
class SkillDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_update_contents_from_model(self) -> None:
        versioned_skill_contents: skill_domain.VersionedSkillContentsDict = {
            ...
            'skill_contents': {
                'explanation': {
                    'content_id': '1',
                    'html': '<p>Feedback</p><oppia-noninteractive-math raw_latex-with-value="&amp;quot;+,-,-,+&amp;quot;"></oppia-noninteractive-math>',
                },
                'recorded_voiceovers': {
                    'voiceovers_mapping': {'explanation': {}}
                },
                'written_translations': {
                    'translations_mapping': {'explanation': {}}
                },
            },
        }
        ...
        self.assertEqual(
            ...
            {
                'content_id': '1',
                'html': '<p>Feedback</p><oppia-noninteractive-math math_content-with-value="{&amp;quot;raw_latex&amp;quot;: &amp;quot;+,-,-,+&amp;quot;, &amp;quot;svg_filename&amp;quot;: &amp;quot;&amp;quot;}"></oppia-noninteractive-math>',
            },
        )
        versioned_skill_contents['skill_contents']['explanation'] = {
            'content_id': '1',
            'html': '<oppia-noninteractive-svgdiagram svg_filename-with-value="&amp;quot;img1.svg&amp;quot;" alt-with-value="&amp;quot;Image&amp;quot;"></oppia-noninteractive-svgdiagram>',
        }
        self.skill.update_skill_contents_from_model(
            versioned_skill_contents, versioned_skill_contents['schema_version']
        )
        ...
        self.assertEqual(
            ...
            {
                'content_id': '1',
                'html': '<oppia-noninteractive-image alt-with-value="&amp;quot;Image&amp;quot;" caption-with-value="&amp;quot;&amp;quot;" filepath-with-value="&amp;quot;img1.svg&amp;quot;"></oppia-noninteractive-image>',
            },
        )
    ...
    def test_update_misconceptions_from_model(self) -> None:
        ...
        versioned_misconceptions['misconceptions'][0]['feedback'] = (
            '<p>Feedback</p><oppia-noninteractive-math raw_latex-with-value="&amp;quot;+,-,-,+&amp;quot;"></oppia-noninteractive-math>'
        )
    ...
    def test_add_misconception(self) -> None:
        misconception = skill_domain.Misconception(
            self.MISCONCEPTION_ID + 1,
            'name_2',
            '<p>notes_2</p>',
            '<p>default_feedback_2</p>',
            True,
        )
    ...
    def test_rubrics_validation(self) -> None:
        ...
        self._assert_validation_error(
            'Explanation should be less than or equal to 300 chars, received 337 chars'
        )
        ...
        self._assert_validation_error(
            'Expected number of explanations to be less than or equal to 10, received 15'
        )
    ...
    def test_valid_rubric_difficulty(self) -> None:
        self.skill.rubrics = [
            skill_domain.Rubric('invalid_difficulty', ['<p>Explanation</p>'])
        ]
    ...
    def test_skill_migration_validation(self) -> None:
        ...
        self._assert_validation_error(
            'Expected a value for all_questions_merged when superseding_skill_id is set.'
        )
        self.skill.superseding_skill_id = None
        self.skill.all_questions_merged = True
        self._assert_validation_error(
            'Expected a value for superseding_skill_id when all_questions_merged is True.'
        )
    ...
    def test_skill_mastery_to_dict(self) -> None:
        ...
        self.assertDictEqual(
            expected_skill_mastery_dict, observed_skill_mastery.to_dict()
        )
    ...
    def test_update_rubrics_from_model(self) -> None:
        ...
        versioned_rubrics['rubrics'][0]['explanations'] = [
            '<p>Explanation</p><oppia-noninteractive-math raw_latex-with-value="&amp;quot;+,-,-,+&amp;quot;"></oppia-noninteractive-math>'
        ]
                ...
                'rubrics': [
                    {
                        'explanations': [
                            (
                                '<p>Explanation</p><oppia-noninteractive-math math_content-with-value="{&amp;quot;raw_latex&amp;quot;: &amp;quot;+,-,-,+&amp;quot;, &amp;quot;svg_filename&amp;quot;: &amp;quot;&amp;quot;}"></oppia-noninteractive-math>'
                            )
                        ]
                    },
                    {'explanations': ['explanation2']},
        ...
        versioned_rubrics['rubrics'][0]['explanations'] = [
            (
                '<oppia-noninteractive-svgdiagram svg_filename-with-value="&amp;quot;img1.svg&amp;quot;" alt-with-value="&amp;quot;Image&amp;quot;"></oppia-noninteractive-svgdiagram>'
            )
        ]
        ...
        self.assertEqual(
            versioned_rubrics,
            {
                ...
                'rubrics': [
                    {
                        'explanations': [
                            '<oppia-noninteractive-image alt-with-value="&amp;quot;Image&amp;quot;" caption-with-value="&amp;quot;&amp;quot;" filepath-with-value="&amp;quot;img1.svg&amp;quot;"></oppia-noninteractive-image>'
                        ]
                    },
                    {'explanations': ['explanation2']},
                ],
...
class SkillChangeTests(test_utils.GenericTestBase):
    ...
    def test_skill_change_object_with_invalid_skill_property(self) -> None:
        with self.assertRaisesRegex(
            utils.ValidationError,
            (
                'Value for property_name in cmd update_skill_property: invalid is not allowed'
            ),
        ):
            skill_domain.SkillChange(
                {
    ...
    def test_skill_change_object_with_invalid_skill_misconception_property(
        ...
        with self.assertRaisesRegex(
            utils.ValidationError,
            (
                'Value for property_name in cmd update_skill_misconceptions_property: invalid is not allowed'
            ),
        ):
            skill_domain.SkillChange(
                {
    ...
    def test_skill_change_object_with_invalid_skill_contents_property(
        ...
        with self.assertRaisesRegex(
            utils.ValidationError,
            (
                'Value for property_name in cmd update_skill_contents_property: invalid is not allowed'
            ),
        ):
            skill_domain.SkillChange(
                {
    ...
    def test_skill_change_object_with_delete_skill_misconception(self) -> None:
        skill_change_object = skill_domain.SkillChange(
            {'cmd': 'delete_skill_misconception', 'misconception_id': 'id'}
        )
...
class SkillSummaryTests(test_utils.GenericTestBase):
    def setUp(self) -> None:
        ...
        self.skill_summary = skill_domain.SkillSummary(
            'skill_id', 'description', 'en', 1, 1, current_time, current_time
        )
    ...
    def test_validation_fails_with_negative_misconception_count(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError,
            (
                'Expected misconception_count to be non-negative, received \'-1\''
            ),
        ):
            self.skill_summary.validate()
...
class AugmentedSkillSummaryTests(test_utils.GenericTestBase):
    ...
    def test_augmented_skill_summary_gets_created(self) -> None:
        ...
        self.assertEqual(
            self.augmented_skill_summary.to_dict(), augmented_skill_summary_dict
        )
...
class TopicAssignmentTests(test_utils.GenericTestBase):
    ...
    def test_topic_assignments_gets_created(self) -> None:
        ...
        self.assertEqual(
            self.topic_assignments.to_dict(), topic_assignments_dict
        )
...
class ShortSkillSummaryTests(test_utils.GenericTestBase):
    ...
    def test_short_skill_summary_gets_created(self) -> None:
        ...
        self.assertEqual(
            self.short_skill_summary.to_dict(), short_skill_summary_dict
        )

    def test_short_skill_summary_gets_created_from_skill_summary(self) -> None:
        short_skill_summary = skill_domain.ShortSkillSummary.from_skill_summary(
            self.skill_summary
        )
        self.assertEqual(
            short_skill_summary.to_dict(), self.short_skill_summary.to_dict()
        )
