...
class FeatureFlagSpecTests(test_utils.GenericTestBase):
    ...
    def test_create_from_dict_returns_correct_instance(self) -> None:
        ...
        self.assertEqual(feature_flag_spec.description, 'for test')
        self.assertEqual(
            feature_flag_spec.feature_stage, feature_flag_domain.FeatureStages.PROD
        )
    ...
    def test_to_dict_returns_correct_dict(self) -> None:
        ...
        self.assertDictEqual(feature_flag_spec.to_dict(), feature_flag_spec_dict)
...
class FeatureFlagConfigTests(test_utils.GenericTestBase):
    ...
    def test_to_dict_returns_correct_dict(self) -> None:
        ...
        self.assertDictEqual(feature_flag_config.to_dict(), feature_flag_config_dict)
    ...
    def test_validate_feature_flag_config_passes_without_exception(self) -> None:
        feature_flag_config = feature_flag_domain.FeatureFlagConfig(
            False, 0, [], datetime.datetime.utcnow()
        )
    ...
    def test_validate_feature_flag_with_percentage_less_than_0_raises_exception(
        ...
        with self.assertRaisesRegex(
            ...
            'Feature flag rollout-percentage should be between ' '0 and 100 inclusive.',
        ):
            feature_flag_config.validate(feature_flag_domain.ServerMode.DEV)
...
class FeatureFlagTests(test_utils.GenericTestBase):
    ...
    def test_create_from_dict_returns_correct_instance(self) -> None:
        ...
        self.assertFalse(feature_flag.feature_flag_config.force_enable_for_all_users)
        ...
        self.assertEqual(feature_flag.feature_flag_config.last_updated, current_time)
    ...
    def test_validate_feature_flag_with_invalid_name_raises_exception(self) -> None:
        feature_flag_config = feature_flag_domain.FeatureFlagConfig(
            False, 0, [], datetime.datetime.utcnow()
        )
        feature_flag_spec = feature_flag_domain.FeatureFlagSpec(
