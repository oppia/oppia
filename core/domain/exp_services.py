    ...
    for change in change_list:
        if change.cmd == exp_domain.CMD_ADD_STATE:
            ...
            if (change.property_name ==
                ...
                state.update_interaction_customization_args(change.new_value)
            elif (change.property_name ==
                ...
                written_translations = (
                    state_domain.WrittenTranslations.from_dict(change.new_value)
                )
            ...
            if change.property_name == 'title':
                ...
                exploration.update_param_changes(
                    list(python_utils.MAP(to_param_domain, change.new_value)))
