...
class PlatformParameterRegistryTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        caching_services.delete_multi(
            caching_services.CACHE_NAMESPACE_PLATFORM_PARAMETER, None, parameter_names
        )
    ...
    def _create_dummy_platform_parameter(
        ...
        return registry.Registry.create_platform_parameter(
            ParamName.PARAMETER_A, 'test', data_types
    ...
    def test_create_platform_parameter_with_invalid_type_failure(self) -> None:
        ...
        with self.assertRaisesRegex(Exception, 'Unsupported data type \'invalid\''):
            ...
            registry.Registry.create_platform_parameter(
                ParamName.PARAMETER_A, 'test', DataType.INVALID
            )  # type: ignore[arg-type]
    ...
    def test_memcache_is_set_after_getting(self) -> None:
        ...
        self.assertIsNone(
            registry.Registry.load_platform_parameter_from_memcache(parameter_name)
        )
    ...
    def test_updated_parameter_is_saved_in_storage(self) -> None:
        ...
        self._create_example_parameter_with_name(parameter_name)
        self.assertIsNone(
            registry.Registry.load_platform_parameter_from_storage(parameter_name)
        )
        ...
        parameter_updated = registry.Registry.load_platform_parameter_from_storage(
            parameter_name
        )
    ...
    def test_default_value_return_from_parameter_registry_when_none_in_model(
        ...
        with self.swap(
            ...
            parameter_storage = registry.Registry.load_platform_parameter_from_storage(
                parameter_name
            )
