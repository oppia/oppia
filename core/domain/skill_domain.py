...
class Skill(python_utils.OBJECT):
    ...
    def _convert_skill_contents_v2_dict_to_v3_dict(cls, skill_contents_dict):
        """Converts v2 skill contents to the v3 schema. In version 2, all
        oppia-noninteractive-svgdiagram tags are converted into
        oppia-noninteractive-image tag.

        Args:
            skill_contents_dict: dict. The v2 skill_contents_dict.
        Returns:
            dict. The converted skill_contents_dict.
        """
        skill_contents_dict['explanation']['html'] = (
    ...
    def _convert_misconception_v3_dict_to_v4_dict(cls, misconception_dict):
        """Converts v3 misconception schema to the v4 schema. In version 3, all
        oppia-noninteractive-svgdiagram tags are converted into
        oppia-noninteractive-image tag.
    ...
    def _convert_rubric_v3_dict_to_v4_dict(cls, rubric_dict):
        """Converts v3 rubric schema to the v4 schema. In version 3, all
        oppia-noninteractive-svgdiagram tags are converted into
        oppia-noninteractive-image tag.
