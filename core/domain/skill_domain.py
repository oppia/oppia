...
misconception_struct = TypedDict(
    'misconception',
    {'id': int, 'name': str, 'notes': str,
    'feedback': str, 'must_be_addressed': bool})
...
class Misconception:
    ...
    def __init__(
            ...
            notes: str, feedback: str,
            must_be_addressed: bool) -> None:
    ...
    @classmethod
    def from_dict(
        cls, misconception_dict: misconception_struct) -> Misconception:
...
skillDomain = TypedDict(
    ...
    'misconceptions': List[misconception_struct],
    'rubrics': List[rubric_struct],
    'skill_contents': skillsContents,
    'language_code': str,
    'misconceptions_schema_version': int,
    'rubric_schema_version': int,
    'skill_contents_schema_version': int,
    'version': int, 'next_misconception_id': int,
    'superseding_skill_id': Union[str, None],
    'all_questions_merged': bool,
    'prerequisite_skill_ids': List[str],
    'created_on': str, 'last_updated': str})
versioned_skill_Contents = TypedDict(
    'versioned_skill_Contents',
    {'schema_version': str,
    'skill_contents': skillsContents})
versioned_Misconceptions = TypedDict(
    'versioned_Misconceptions',
    {'schema_version': str,
    'misconceptions': List[misconception_struct]})
versioned_Rubrics = TypedDict(
    'versioned_Rubrics',
    {'schema_version': str, 'rubrics': List[rubric_struct]})
...
class Skill:
    ...
    def __init__(
            self, skill_id: str, description: str,
            misconceptions: List[Misconception], rubrics: List[Rubric],
            ...
            language_code: str, version: int, next_misconception_id: int,
    ...
    @classmethod
    def from_dict(
            cls, skill_dict: skillDomain,
            skill_version=0, skill_created_on=None,
    ...
    def create_default_skill(
        cls, skill_id: str, description: str,
        rubrics: List[Rubric]) -> Skill:
    ...
    def _convert_skill_contents_v1_dict_to_v2_dict(
        cls, skill_contents_dict: skillsContents) -> skillsContents:
    ...
    def update_skill_contents_from_model(
            cls, versioned_skill_contents: versioned_skill_Contents,
    ...
    def update_misconceptions_from_model(
            cls, versioned_misconceptions: versioned_Misconceptions,
            current_version: int) -> None:
    ...
    def _convert_misconception_v1_dict_to_v2_dict(
        cls, misconception_dict: misconception_struct
        ) -> misconception_struct:
    ...
    def _convert_misconception_v3_dict_to_v4_dict(
        cls, misconception_dict: misconception_struct) -> misconception_struct:
    ...
    def _convert_rubric_v2_dict_to_v3_dict(
        cls, rubric_dict: rubric_struct) -> rubric_struct:
    ...
    def update_rubrics_from_model(
        cls, versioned_rubrics: versioned_Rubrics,
        current_version: int) -> None:
    ...
    def record_that_all_questions_are_merged(
        self, all_questions_merged: bool) -> None:
    ...
    def update_worked_examples(
        self, worked_examples: List[WorkedExample]) -> None:
    ...
    def _update_content_ids_in_assets(
        self, old_ids_list: List[str], new_ids_list: List[str]) -> None:
    ...
    def _find_prerequisite_skill_id_index(
        self, skill_id_to_find: str) -> int|None:
    ...
    def update_misconception_name(
        self, misconception_id: int, name: str) -> None:
    ...
    def update_misconception_notes(
        self, misconception_id: int, notes: str) -> None:
...
skillSummary = TypedDict(
    'skillSummary', {
        'id': str, 'description': str, 'language_code': str,
        'version': int, 'misconception_count': int,
...
class SkillSummary:
    ...
    def __init__(
            self, skill_id: str, description: str, language_code: str,
            version: int,
...
augmentedSkillSummary = TypedDict(
    'augmentedSkillSummary', {'id': str,
            'description': str,
            'language_code': str,
            'version': int,
...
topicAssignment = TypedDict(
    'topicAssignment', {
        'topic_id': str, 'topic_name': str,
    'topic_version': int, 'subtopic_id': Union[str, None]})
...
class TopicAssignment:
    ...
    def __init__(
            self, topic_id: str, topic_name: str,
            topic_version: int, subtopic_id: str|None) -> None:
...
class UserSkillMastery:
    ...
    def __init__(
        self, user_id: str, skill_id: str, degree_of_mastery: float) -> None:
