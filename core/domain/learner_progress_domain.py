...
class LearnerProgressInTopicsAndStories:
    ...
    def __init__(
        ...
        Args:
            partially_learnt_topic_summaries: The summaries of the topics
                partially learnt by the learner.
            completed_story_summaries: The summaries of the stories completed
                by the learner.
            learnt_topic_summaries: The summaries of the topics learnt by the
                learner.
            topics_to_learn_summaries: The summaries of the topics to learn.
            all_topic_summaries: The summaries of the topics in the edit goals.
            untracked_topic_summaries: The summaries of the topics not tracked
                for the user.
            completed_to_incomplete_story_titles: The titles of summaries
                corresponding to those stories which have been moved to the in
                progress section on account of new nodes being added to them.
            learnt_to_partially_learnt_topic_titles: The titles of summaries
                corresponding to those topics which have been moved to the in
                progress section on account of new stories being added to them.
        """
...
class LearnerProgressInCollections:
    ...
    def __init__(
        ...
        Args:
            incomplete_collection_summaries: The summaries of the collections
                partially completed by the learner.
            completed_collection_summaries: The summaries of the collections
                partially completed by the learner.
            collection_playlist: The summaries of the collections in the learner
                playlist.
            completed_to_incomplete_collection_titles: The summaries
                corresponding to those collections which have been moved to the
                in progress section on account of new explorations being added
                to them.
        """
...
class LearnerProgressInExplorations:
    ...
    def __init__(
        ...
        Args:
            incomplete_exp_summaries: The summaries of the explorations
                partially completed by the learner.
            completed_exp_summaries: The summaries of the explorations partially
                completed by the learner.
            exploration_playlist: The summaries of the explorations in the
                learner playlist.
        """
...
class ActivityIdsInLearnerDashboard:
    ...
    def __init__(
        ...
        Args:
            completed_exploration_ids: The ids of the explorations completed
                by the user.
            completed_collection_ids: The ids of the collections completed
                by the user.
            completed_story_ids: The ids of the stories completed by the user.
            learnt_topic_ids: The ids of the topics learnt by the user.
            incomplete_exploration_ids: The ids of the explorations currently
                in progress.
            incomplete_collection_ids: The ids of the collections currently in
                progress.
            partially_learnt_topic_ids: The ids of the topics partially learnt.
            topic_ids_to_learn: The ids of the topics to learn.
            all_topic_ids: The ids of the all the topics.
            untracked_topic_ids: The ids of the untracked topics.
            exploration_playlist_ids: The ids of the explorations in the
                playlist of the user.
            collection_playlist_ids: The ids of the collections in the playlist
                of the user.
        """
    ...
    def to_dict(self) -> Dict[str, List[str]]:
        ...
        Returns:
            The keys of the dict are:
                'completed_exploration_ids': The ids of the explorations that
                    are completed.
                'completed_collection_ids': The ids of the collections that are
                    completed.
                'completed_story_ids': The ids of the stories that are
                    completed.
                'learnt_topic_ids': The ids of the topics that are learnt.
                'incomplete_exploration_ids': The ids of the explorations that
                    are incomplete.
                'incomplete_collection_ids': The ids of the collections that are
                    incomplete.
                'partially_learnt_topic_ids': The ids of the topics that are
                    partially learnt.
                'topic_ids_to_learn': The ids of the topics to learn.
                'all_topic_ids': The ids of all the topics.
                'untracked_topic_ids': The ids of the untracked topics.
                'exploration_playlist_ids': The ids of the explorations that are
                    in the playlist
                'collection_playlist_ids': The ids of the collections that are
                    in the playlist.
        """
