...
def get_displayable_exploration_summary_dicts(exploration_summaries):
...
def get_featured_activity_summary_dicts(language_codes):
    ...
    exp_summary_dicts = get_displayable_exploration_summary_dicts_matching_ids(
        exploration_ids)
...
def get_top_rated_exploration_summary_dicts(language_codes, limit):
    ...
    return get_displayable_exploration_summary_dicts(sorted_exp_summaries)


def get_recently_published_exploration_summary_dicts(limit):
    ...
    return get_displayable_exploration_summary_dicts(summaries)
...
def get_library_groups(language_codes):
    ...
    exp_summary_dicts = {
        summary_dict['id']: summary_dict
        for summary_dict in get_displayable_exploration_summary_dicts(
            exp_summaries)
    }
...
def get_displayable_exploration_summary_dicts_matching_ids(
    ...
    return get_displayable_exploration_summary_dicts(
        filtered_exploration_summaries)
...
def get_exploration_metadata_dicts_matching_query(
        query_string, search_cursor, user_id):
