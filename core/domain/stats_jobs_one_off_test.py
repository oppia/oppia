...
class DeleteIllegalPlaythroughsOneOffJobTests(OneOffJobTestBase):
    ...
    def create_playthrough_issues_model(self, playthrough_ids_list):
        ...
        """
        return stats_models.PlaythroughIssuesModel.create(
    ...
    def test_playthroughs_remain_in_whitelisted_explorations(self):
        ...
        stats_models.PlaythroughIssuesModel.get(playthrough_issues_id)
...
class PlaythroughIssuesModelCreatorOneOffJobTests(OneOffJobTestBase):
    ...
    def test_default_job_execution(self):
        ...
        exp_issues1_v1 = stats_models.PlaythroughIssuesModel.get_model(
        ...
        exp_issues1_v2 = stats_models.PlaythroughIssuesModel.get_model(
        ...
        exp_issues2 = stats_models.PlaythroughIssuesModel.get_model(
    ...
    def test_with_existing_exp_issues_instance(self):
        ...
        exp_issues1 = stats_models.PlaythroughIssuesModel.get_model(
            self.EXP_ID1, self.exp1.version)
