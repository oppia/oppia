...
class QuestionFetchersUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.question = self.save_new_question(
            ...
            ['skill_1'], self.content_id_generator.next_content_id_index
        )
    ...
    def test_get_questions_with_multi_skill_ids(self) -> None:
        ...
        question_1 = self.save_new_question(
            ...
            ['skill_1', 'skill_2'], content_id_generator.next_content_id_index
        )
        question_services.create_new_question_skill_link(
    ...
    def test_cannot_get_question_from_model_with_invalid_schema_version(self) -> None:
        ...
        question_model = question_models.QuestionModel(
            id=question_id,
            question_state_data=(
                self._create_valid_question_data('ABC', content_id_generator).to_dict()
            ),
            language_code='en',
            version=0,
