        ...
        Union[
            ...
            Dict[
                ...
                Union[
                    str,
                    List[
                        Dict[str, Union[str, Dict[str, Union[str, List[List[float]]]]]]
                    ],
                ],
            ],
        ],
        ...
        exp_services.update_exploration(
            ...
            + _get_change_list(
                ...
                exp_domain.STATE_PROPERTY_INTERACTION_CUST_ARGS,
                {
                    'choices': {
                        'value': [
                            {'content_id': 'ca_choices_0', 'html': '<p>Option A</p>'},
                            {'content_id': 'ca_choices_1', 'html': '<p>Option B</p>'},
                        ]
                    },
...
class ExplorationCreateAndDeleteUnitTests(ExplorationServicesUnitTests):
    ...
    def test_soft_deletion_of_exploration(self) -> None:
        ...
        exp_rights_snapshot_id = exp_models.ExplorationRightsModel.get_snapshot_id(
            self.EXP_0_ID, 1
        )
        self.assertIsNotNone(
    ...
    def test_soft_deletion_of_multiple_explorations(self) -> None:
        ...
        exp_0_rights_snapshot_id = exp_models.ExplorationRightsModel.get_snapshot_id(
            self.EXP_0_ID, 1
        )
        exp_1_rights_snapshot_id = exp_models.ExplorationRightsModel.get_snapshot_id(
            self.EXP_1_ID, 1
        )
        self.assertIsNotNone(
            exp_models.ExplorationRightsSnapshotMetadataModel.get_by_id(
    ...
    def test_apply_change_list(self) -> None:
        ...
        changed_exploration_voiceover = exp_services.apply_change_list(
            self.EXP_0_ID, change_list_voiceover
        )
        changed_exp_voiceover_obj = changed_exploration_voiceover.states[
            'State 1'
        ].recorded_voiceovers
            ...
            exp_domain.ExplorationChange(
                {
                    ...
                    'property_name': (exp_domain.STATE_PROPERTY_INTERACTION_CUST_ARGS),
                    'new_value': {
                        'recommendedExplorationIds': {'value': ['EXP_1', 'EXP_2']}
                    },
                }
            ),
            exp_domain.ExplorationChange(
    ...
    def test_update_exploration_by_migration_bot_not_updates_contribution_model(
        ...
        migration_bot_contributions_model = user_services.get_user_contributions(
            feconf.MIGRATION_BOT_USER_ID
        )
    ...
    def test_update_exploration_by_migration_bot_not_updates_settings_model(
        ...
        migration_bot_settings_model = user_services.get_user_settings_from_username(
...
"""
        ...
        % (
            INTRO_AUDIO_FILE,
            DEFAULT_OUTCOME_AUDIO_FILE,
            ANSWER_GROUP_AUDIO_FILE,
            HINT_AUDIO_FILE,
            SOLUTION_AUDIO_FILE,
        )
    )
...
class UpdateStateTests(ExplorationServicesUnitTests):
    ...
    def test_update_interaction_customization_args_rejects_obsolete_translation_suggestions(  # pylint: disable=line-too-long
        ...
        change_list = _get_change_list(
            ...
            {
                'buttonText': {
                    'value': {'content_id': content_id, 'unicode_str': 'Continue'}
                }
            },
        )
        exp_services.update_exploration(
        ...
        change_list = (
            ...
            + _get_change_list(
                ...
                exp_domain.STATE_PROPERTY_INTERACTION_CUST_ARGS,
                {
                    'choices': {
                        'value': [
                            {'content_id': 'ca_choices_1', 'html': '<p>Option A</p>'},
                            {'content_id': 'ca_choices_2', 'html': '<p>Option B</p>'},
                        ]
                    },
                    'showChoicesInShuffledOrder': {'value': False},
                },
...
class ExplorationSnapshotUnitTests(ExplorationServicesUnitTests):
    ...
    def test_get_last_updated_by_human_ms(self) -> None:
        ...
        self.assertLess(
            original_timestamp, exp_services.get_last_updated_by_human_ms(self.EXP_0_ID)
        )
        self.assertLess(
    ...
    def test_get_exploration_snapshots_metadata(self) -> None:
        ...
        self.assertDictContainsSubset(
            {
                'commit_cmds': [
                    {'cmd': 'create_new', 'title': 'A title', 'category': 'Algebra'}
                ],
                'committer_id': self.owner_id,
                'commit_message': ('New exploration created with title \'A title\'.'),
                'commit_type': 'create',
    ...
    def test_reverts_exp_to_safe_state_when_content_model_is_missing(self) -> None:
        ...
        exp_services.update_exploration(
            ...
            [
                exp_domain.ExplorationChange(
                    {
                        'new_value': {'content_id': 'content_0', 'html': 'content 1'},
...
class ExplorationSummaryGetTests(ExplorationServicesUnitTests):
    ...
    def test_get_top_rated_exploration_summaries(self) -> None:
        ...
        top_rated_summaries_model = exp_fetchers.get_exploration_summaries_from_models(
            top_rated_summaries
        )
    ...
    def test_get_user_exploration_data(self) -> None:
        ...
        exploration_description_draft_applied = exp_services.get_user_exploration_data(
            ...
            exp_domain.ExplorationChange(
                {
                    ...
                    'new_value': {
                        'choices': {
                            'value': [
                                {'content_id': 'ca_choices_5', 'html': '<p>1</p>'},
                                {'content_id': 'ca_choices_6', 'html': '<p>2</p>'},
                                {'content_id': 'ca_choices_7', 'html': '<p>3</p>'},
                                {'content_id': 'ca_choices_8', 'html': '<p>4</p>'},
                            ]
                        },
                        'showChoicesInShuffledOrder': {'value': False},
                    ...
                    'new_value': {
                        'choices': {
                            'value': [
                                ...
                                {'content_id': 'ca_choices_3', 'html': '<p>4</p>'},
                            ]
                        },
                        'maxAllowableSelectionCount': {'value': 1},
                        'minAllowableSelectionCount': {'value': 1},
...
class ApplyDraftUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.draft_change_list = _get_change_list(
            ...
            'content',
            {'content_id': state.content.content_id, 'html': '<p>New html value</p>'},
        )
        self.draft_change_list_dict = [
            change.to_dict() for change in self.draft_change_list
        ]
...
class RegenerateMissingExpStatsUnitTests(test_utils.GenericTestBase):
    ...
    def test_handle_state_name_is_not_found_in_state_stats_mapping(self) -> None:
        ...
        exp_stats_model_to_delete = stats_models.ExplorationStatsModel.get_model(
            exp_id, 3
        )
    ...
    def test_when_few_exp_stats_models_are_missing(self) -> None:
        ...
        exp_stats_model_for_version_2 = stats_models.ExplorationStatsModel.get_model(
            exp_id, 2
        )
        exp_stats_model_for_version_4 = stats_models.ExplorationStatsModel.get_model(
            exp_id, 4
        )
    ...
    def test_when_v1_version_exp_stats_model_is_missing(self) -> None:
        ...
        exp_stats_model_for_version_1 = stats_models.ExplorationStatsModel.get_model(
            exp_id, 1
        )
        ...
        exp_stats_model_for_version_3 = stats_models.ExplorationStatsModel.get_model(
            exp_id, 3
        )
    ...
    def test_when_few_state_stats_models_are_missing_for_old_exps(self) -> None:
        ...
        owner_id = 'owner_id'
        self.save_new_valid_exploration(
            exp_id, owner_id, title='title', category='Category 1', end_state_name='END'
        )
        exp_services.update_exploration(
            owner_id,
            exp_id,
...
class ComputeVoiceoversModelFromExplorationChangeTest(ExplorationServicesUnitTests):
    ...
    def test_should_be_able_to_create_entity_voiceovers_models(self) -> None:
        ...
        models_to_put = exp_services.compute_models_to_put_when_saving_new_exp_version(
            self.owner_id, 'test_exp_id', voiceover_changes, 'Added voiceover', False
        )
