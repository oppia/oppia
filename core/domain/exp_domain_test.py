...
class ExplorationVersionsDiffDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_cannot_create_exploration_change_with_invalid_state_property(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'Value for property_name in cmd edit_state_property: '
    ...
    def test_cannot_create_exploration_change_with_invalid_exploration_property(
        ...
        with self.assertRaisesRegex(
            Exception, 'Value for property_name in cmd edit_exploration_property: '
            'invalid_property is not allowed'
        ):
            exp_domain.ExplorationChange({
                'cmd': exp_domain.CMD_EDIT_EXPLORATION_PROPERTY,
...
class ExpVersionReferenceTests(test_utils.GenericTestBase):
    ...
    def test_validate_exp_version(self) -> None:
        with self.assertRaisesRegex(
            ...
            exp_domain.ExpVersionReference(
                'exp_id', 'invalid_version'
...
class TransientCheckpointUrlTests(test_utils.GenericTestBase):
    ...
    def test_initialization(self) -> None:
        ...
        self.assertEqual(
            self.transient_checkpoint_url.furthest_reached_checkpoint_exp_version, 1
        )
        self.assertEqual(
    ...
    def test_to_dict(self) -> None:
        ...
        logged_out_learner_progress_object = exp_domain.TransientCheckpointUrl(
            'exploration_id', 'furthest_reached_checkpoint_state_name', 1,
...
class ExplorationCheckpointsUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.set_interaction_for_state(
            self.exploration.states[self.exploration.init_state_name], 'TextInput',
    ...
    def test_checkpoint_count_with_count_outside_range_is_invalid(self) -> None:
        ...
        for i in range(8):
            ...
            self.set_interaction_for_state(
                self.exploration.states['State%s' % i], 'Continue',
                self.content_id_generator
            )
        with self.assertRaisesRegex(
    ...
    def test_bypassable_state_with_card_is_checkpoint_true_is_invalid(self) -> None:
        ...
        second_state_answer_groups = [
            state_domain.AnswerGroup(
                state_domain.Outcome(
                    'End', None,
                    state_domain.SubtitledHtml('feedback_0', '<p>Feedback</p>'), False,
                    [], None, None
                ), [
                    state_domain.RuleSpec(
                        'Contains', {
        ...
        init_state_answer_groups = [
            ...
            state_domain.AnswerGroup(
                state_domain.Outcome(
                    'B', None,
                    state_domain.SubtitledHtml('feedback_1', '<p>Feedback</p>'), False,
                    [], None, None
                ), [
                    state_domain.RuleSpec(
                        'Contains', {
            ...
            state_domain.AnswerGroup(
                state_domain.Outcome(
                    'C', None,
                    state_domain.SubtitledHtml('feedback_2', '<p>Feedback</p>'), False,
                    [], None, None
                ), [
                    state_domain.RuleSpec(
                        'Contains', {
...
class ExplorationDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_end_interaction(self) -> None:
        ...
        self.state.interaction.customization_args['recommendedExplorationIds'].value = [
            'id1', 'id2', 'id3', 'id4'
        ]
    ...
    def test_item_selection_choice_interaction(self) -> None:
        ...
        self.state.interaction.customization_args['minAllowableSelectionCount'
                                                 ].value = 1
        self.state.interaction.customization_args['maxAllowableSelectionCount'
                                                 ].value = 3
    ...
    def test_drag_and_drop_interaction(self) -> None:
        ...
        test_ans_group_for_drag_and_drop_interaction = [
            state_domain.AnswerGroup.from_dict({
                'rule_specs': [{
                    ...
                    'rule_type': ('IsEqualToOrderingWithOneItemAtIncorrectPosition'),
                    'inputs': {
                        'x': [['ca_choices_1', 'ca_choices_3'], ['ca_choices_0'],
                              ['ca_choices_2']]
                    }
                }, {
                    'rule_type': 'IsEqualToOrdering',
                    'inputs': {
                        'x': [['ca_choices_1'], ['ca_choices_0'],
                              ['ca_choices_2', 'ca_choices_3']]
                    }
                }, {
                    'rule_type': 'IsEqualToOrdering',
                    'inputs': {
                        'x': [['ca_choices_3'], ['ca_choices_2'], ['ca_choices_1'],
                              ['ca_choices_0']]
                    }
                }],
                'outcome': {
        ...
        self.state.interaction.customization_args['allowMultipleItemsInSamePosition'
                                                 ].value = False
    ...
    def test_validation(self) -> None:
        ...
        self._assert_validation_error(
            exploration, r'There is no state in \[\'ABC\'\, \'BCD\'\] corresponding to '
        ...
        self.set_interaction_for_state(
            exploration.states[exploration.init_state_name], 'PencilCodeEditor',
        ...
        self._assert_validation_error(
            exploration, 'Expected outcome refresher_exploration_id to be a string'
        )
        ...
        self._assert_validation_error(
            exploration, 'Expected outcome missing_prerequisite_skill_id to be a string'
        )
        ...
        self._assert_validation_error(
            exploration, 'has a refresher exploration ID, but is not a self-loop'
        )
        ...
        self._assert_validation_error(
            exploration, 'Terminal interactions must not have a default outcome.'
        )

        self.set_interaction_for_state(init_state, 'TextInput', content_id_generator)
        init_state.update_interaction_default_outcome(None)
        self._assert_validation_error(
            exploration, 'Non-terminal interactions must have a default outcome.'
        )
        ...
        self._assert_validation_error(
            exploration, 'Terminal interactions must not have any answer groups.'
        )
        ...
        state_answer_group = state_domain.AnswerGroup(
            state_domain.Outcome(
                exploration.init_state_name, None,
                state_domain.SubtitledHtml('feedback_1', 'Feedback'), False, [], None,
                None
            ),
            [
                state_domain.RuleSpec(
        ...
        self._assert_validation_error(
            exploration, 'Expected tagged skill misconception id to be None, received 1'
        )
        with self.assertRaisesRegex(
            Exception, 'Expected tagged skill misconception id to be None, received 1'
        ):
        ...
        self._assert_validation_error(
            exploration, 'Expected tagged skill misconception id to be None, received '
            'invalid_tagged_skill_misconception_id'
        )

        with self.assertRaisesRegex(
            Exception, 'Expected tagged skill misconception id to be None, received '
            'invalid_tagged_skill_misconception_id'
        ):
            exploration.init_state.validate(
                exploration.param_specs,
        ...
        self._assert_validation_error(
            exploration, 'There must be at least one rule for each answer group.'
        )
        with self.assertRaisesRegex(
    ...
    def test_get_content_with_correct_state_name_returns_html(self) -> None:
        ...
        self.set_interaction_for_state(init_state, 'TextInput', content_id_generator)
        hints_list = [
            state_domain.Hint(state_domain.SubtitledHtml('hint_1', '<p>hint one</p>'))
        ]
    ...
    def test_cannot_create_demo_exp_with_invalid_param_changes(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'Parameter myParam was used in a state but not '
    ...
    def test_validate_exploration_param_specs(self) -> None:
        ...
        exploration.param_specs = {
            1:
                param_domain.ParamSpec.
                from_dict(  # type: ignore[dict-item]
                    {
                        'obj_type': 'UnicodeString'
                    }
                )
    ...
    def test_validate_exploration_param_name(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'No parameter named \'invalid\' exists in this '
            'exploration'
        ):
            exploration.validate()
    ...
    def test_validate_exploration_reserved_param_name(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'The exploration-level parameter with name \'all\' is '
    ...
    def test_validate_exploration_is_non_self_loop(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'The default outcome for state Introduction has a refresher '
    ...
    def test_validate_exploration_answer_group_parameter(self) -> None:
        ...
        state_answer_group = state_domain.AnswerGroup(
            state_domain.Outcome(
                exploration.init_state_name, None,
                state_domain.SubtitledHtml('feedback_1', 'Feedback'), False,
                param_changes, None, None
            ), [
                state_domain.RuleSpec(
                    'Contains', {
                        'x': {
        ...
        with self.assertRaisesRegex(
            Exception, 'The parameter ParamChange was used in an answer group, '
    ...
    def test_default_outcome_is_labelled_incorrect_for_self_loop(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'The default outcome for state Introduction is labelled '
    ...
    def test_get_all_translatable_content_for_exp(self) -> None:
        ...
        state_interaction_cust_args: Dict[str,
                                          Dict[str,
                                               Union[state_domain.SubtitledUnicodeDict,
                                                     int]]] = {
                                                         'placeholder': {
                                                             'value': {
                                                                 'content_id':
        ...
        translatable_contents = [
            translatable_content.content_value for translatable_content in exploration.
        ...
        self.assertItemsEqual(
            translatable_contents, [
                '<p>state outcome html</p>', '<p>Default outcome for State1</p>',
                '<p>Hello, this is html1 for state1</p>', ['Test'],
                '<p>Hello, this is html2 for state1</p>',
                '<p>This is solution for state1</p>', '<p>state content html</p>'
            ]
        )
...
class ExplorationSummaryTests(test_utils.GenericTestBase):
    ...
    def test_validation_fails_with_invalid_category(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected category to be a string, received 0'
        ):
            self.exp_summary.validate()
    ...
    def test_validation_fails_with_invalid_objective(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected objective to be a string, received 0'
        ):
            self.exp_summary.validate()
    ...
    def test_validation_fails_with_invalid_language_code(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected language_code to be a string, received 0'
        ):
            self.exp_summary.validate()
    ...
    def test_validation_fails_with_invalid_value_for_ratings(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected value to be non-negative, received -1'
        ):
            self.exp_summary.validate()
    ...
    def test_validation_fails_with_invalid_community_owned(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected community_owned to be bool, received 1'
        ):
            self.exp_summary.validate()
    ...
    def test_validation_fails_with_invalid_voice_artist_ids_type(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected voice_artist_ids to be list, received 0'
        ):
            self.exp_summary.validate()
    ...
    def test_validation_fails_with_invalid_contributor_ids_type(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected contributor_ids to be list, received 0'
        ):
            self.exp_summary.validate()
...
class SchemaMigrationMethodsUnitTests(test_utils.GenericTestBase):
    ...
    def test_correct_exploration_schema_conversion_methods_exist(self) -> None:
        ...
        self.assertFalse(
            hasattr(
                exp_domain.Exploration, '_convert_v%s_dict_to_v%s_dict' %
...
"""
        ...
        self.assertEqual(
            exploration.to_yaml(), latest_sample_yaml_content_for_cont_and_end_interac_1
        )
...
"""
        ...
        self.assertEqual(
            exploration.to_yaml(), latest_sample_yaml_content_for_cont_and_end_interac_2
        )
...
"""
        ...
        self.assertEqual(
            exploration.to_yaml(), latest_sample_yaml_content_for_numeric_interac
        )
...
"""
        ...
        self.assertEqual(
            exploration.to_yaml(), latest_sample_yaml_content_for_fraction_interac_2
        )
...
class ConversionUnitTests(test_utils.GenericTestBase):
    ...
    def test_convert_exploration_to_player_dict(self) -> None:
        ...
        def _get_default_state_dict(
            content_str: str, dest_name: str, is_init_state: bool,
            content_id_generator: translation_domain.ContentIdGenerator
...
class HtmlCollectionTests(test_utils.GenericTestBase):
    ...
    def test_all_html_strings_are_collected(self) -> None:
        ...
        customization_args_dict1: Dict[str,
                                       Dict[str,
                                            Union[state_domain.SubtitledUnicodeDict,
                                                  int]]] = {
                                                      'placeholder': {
                                                          'value':
                                                              ca_placeholder_value_dict
                                                      },
                                                      'rows': {
                                                          'value': 1
                                                      },
        ...
        customization_args_dict2: Dict[str, Dict[str, Union[
            List[state_domain.SubtitledHtmlDict], bool]]] = {
                'choices': {
        ...
        customization_args_dict3: Dict[str, Dict[str, Union[
            List[state_domain.SubtitledHtmlDict], int]]] = {
                'choices': {
                    'value': choices_subtitled_html_dicts
                },
                'minAllowableSelectionCount': {
        ...
        expected_html_list = [
            '', '', '<pre>Hello, this is state2</pre>', '<p>Outcome1 for state2</p>',
            '<p>Outcome2 for state2</p>', '', '<p>Hello, this is html1 for state2</p>',
            '<p>Hello, this is html2 for state2</p>',
            '<p>This is value1 for MultipleChoice</p>',
            '<p>This is value2 for MultipleChoice</p>',
            '<blockquote>Hello, this is state1</blockquote>',
            '<p>Default outcome for state1</p>', '<p>This is solution for state1</p>',
            '<p>Hello, this is state3</p>', '<p>Outcome for state3</p>', '',
            '<p>This is value1 for ItemSelection</p>',
            '<p>This is value2 for ItemSelection</p>',
            '<p>This is value3 for ItemSelection</p>', '<p>Hello, this is state4</p>',
            '', '<p>This is value1 for DragAndDropSortInput</p>',
            '<p>This is value2 for DragAndDropSortInput</p>'
        ]
...
class ExplorationChangesMergeabilityUnitTests(
    ...
    def test_changes_are_mergeable_when_content_changes_do_not_conflict(self) -> None:
        ...
        exp_services.update_exploration(
            ...
            self.append_next_content_id_index_change(change_list), 'Changed title.'
        )
    ...
    def test_changes_are_not_mergeable_when_content_changes_conflict(self) -> None:
        ...
        exp_services.update_exploration(
            self.owner_id, self.EXP_0_ID,
            self.append_next_content_id_index_change(change_list), 'Changed Content.'
        )
            ...
            exp_domain.ExplorationChange({
                ...
                'new_value': [{
                    ...
                    'rule_specs': [{
                        'inputs': {
                            'x': {
                                'normalizedStrSet': ['Hello', 'Hola', 'Hey'],
                                'contentId': 'rule_input_2'
                            }
                        },
                        'rule_type': 'StartsWith'
    ...
    def test_changes_are_mergeable_when_translations_changes_do_not_conflict(
        ...
        exp_services.update_exploration(
            self.owner_id, self.EXP_0_ID, change_list_3, 'Added some translations.'
        )
        ...
        change_list_6 = [
            exp_domain.ExplorationChange({
                ...
                'new_value': {
                    ...
                    'html':
                        '<p>Changed First State Content.</p>'
                },
                'property_name': 'content',
                'cmd': 'edit_state_property'
            })
        ...
        change_list_6 = [
            exp_domain.ExplorationChange({
                ...
                'new_value': {
                    ...
                    'html':
                        '<p>Changed Second State Content.</p>'
                },
                'property_name': 'content',
                'cmd': 'edit_state_property'
            })
        ...
        change_list = [
            ...
            exp_domain.ExplorationChange({
                ...
                'new_value': {
                    ...
                    'html':
                        '<p>2Congratulations, you have finished!</p>'
                },
                'state_name': 'End'
            })
        ]
        ...
        change_list_4 = [
            exp_domain.ExplorationChange({
                'content_html':
                    'N/A',
                'translation_html':
                    '<p>State 2 Content Translation.</p>',
                'state_name':
                    'End',
                'language_code':
                    'de',
...
class ExplorationMetadataDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_exploration_metadata_gets_created(self) -> None:
        ...
        exploration.update_param_specs({
            'ExampleParamOne': (param_domain.ParamSpec('UnicodeString').to_dict())
        })
    ...
    def test_metadata_properties_are_synced(self) -> None:
        ...
        swapped_metadata_properties = self.swap(
            constants, 'METADATA_PROPERTIES', [
                'title', 'category', 'objective', 'language_code', 'blurb',
                'author_notes', 'states_schema_version', 'init_state_name',
                'param_specs', 'param_changes', 'auto_tts_enabled', 'edits_allowed'
            ]
        )
        error_message = (
...
class MetadataVersionHistoryDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_metadata_version_history_gets_created_from_dict(self) -> None:
        ...
        metadata_version_history = (
            exp_domain.MetadataVersionHistory.from_dict(metadata_version_history_dict)
        )
...
class ExplorationVersionHistoryUnitTests(test_utils.GenericTestBase):
    ...
    def test_exploration_version_history_gets_created(self) -> None:
        state_version_history_dict = {
            'state 1': state_domain.StateVersionHistory(1, 'state 1', 'user1').to_dict()
        }
        ...
        actual_dict = exp_domain.ExplorationVersionHistory(
            ...
            metadata_version_history.last_edited_version_number,
            metadata_version_history.last_edited_committer_id, ['user1']
        ).to_dict()
