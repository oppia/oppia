...
class ExplorationDomainUnitTests(test_utils.GenericTestBase):
    ...
    sample_yaml_content_for_proto = (
        """author_notes: ''
auto_tts_enabled: true
blurb: ''
category: Category
correctness_feedback_enabled: false
init_state_name: Algebraic Expression Input
language_code: en
objective: ''
param_changes: []
param_specs: {}
...
states:
  Algebraic Expression Input:
    ...
    content:
      content_id: content
      html: <p>Algebraic Expression Input.
        Provide the formula for calculating the
        area of a circle with radius = r.</p>
    interaction:
      answer_groups:
      - outcome:
          dest: Code Editor
          feedback:
            ...
            html: <p>That is exactly how you find
                the area of a circle! Good job!</p>
      ...
      default_outcome:
        ...
        feedback:
          ...
          html: <p>That is not how the area of a
            circle is calculated. Try again.</p>
        labelled_as_correct: false
        missing_prerequisite_skill_id: null
        param_changes: []
        refresher_exploration_id: null
      ...
      - hint_content:
          content_id: hint_1
          html: <p>The area of a circle is related
            to a constant called "pi".</p>
  ...
  Image Region:
    ...
    content:
      content_id: content
      html: <p>Image Region. Please click on the constructor
        in the Python code shown.</p>
    interaction:
      answer_groups:
      - outcome:
          dest: Image Region
      ...
      - outcome:
          ...
          feedback:
            ...
            html: <p>That's a function, which is close
      ...
      - outcome:
          ...
          feedback:
            ...
            html: <p>You found it! This is the code
      ...
      customization_args:
        ...
        imageAndRegions:
          value:
            imagePath: code_sample_height_333_width_466.png
            labeledRegions:
            - label: classdef
              region:
                area:
      ...
      default_outcome:
        ...
        feedback:
          content_id: default_outcome
          html: "<p>Constructors <em>initialize</em> an object,
            or <em>init</em> it.
            Constructors are also functions themselves.</p>"
        labelled_as_correct: false
        missing_prerequisite_skill_id: null
        param_changes: []
        refresher_exploration_id: null
  ...
  Item Selection Multi:
    ...
    interaction:
      ...
      - outcome:
          ...
          feedback:
            content_id: feedback_4
            html: <p>That's good! No bad options,
                but make sure to choose all good
                options!</p>
          labelled_as_correct: false
          missing_prerequisite_skill_id: null
          param_changes: []
      ...
      default_outcome:
        ...
        feedback:
          content_id: default_outcome
          html: <p>The two good options actually have
            the word 'good' in them.</p>
        labelled_as_correct: false
        missing_prerequisite_skill_id: null
        param_changes: []
        refresher_exploration_id: null
  ...
  Item Selection Single:
    ...
    content:
      content_id: content
      html: <p>Item Selection with one choice.
        Select "Choice 2" below.<br></p>
    interaction:
      answer_groups:
      - outcome:
  ...
  Numeric Expression Input:
    ...
    content:
      content_id: content
      html: <p>Numeric Expression Input.
        Break down 1234.56 into component place values.</p>
    interaction:
      answer_groups:
      - outcome:
          dest: Algebraic Expression Input
          feedback:
            content_id: feedback_1
            html: <p>That is perfect!</p>
          labelled_as_correct: false
          missing_prerequisite_skill_id: null
          param_changes: []
          refresher_exploration_id: null
      ...
      customization_args:
        placeholder:
          value:
            ...
            unicode_str: Type an expression here,
                using only numbers.
        useFractionForDivision:
            value: true
      default_outcome:
        dest: Numeric Expression Input
        feedback:
          content_id: default_outcome
          html: <p>That is not the correct
            expansion of 1234.56. Try again.</p>
        labelled_as_correct: false
        missing_prerequisite_skill_id: null
        param_changes: []
        refresher_exploration_id: null
      ...
      - hint_content:
          content_id: hint_1
          html: <p>The final numeric expression that you get
            should be equivalent
            to the original number. Also, don't forget
            to breakdown the decimal place
            values as well!</p>
      ...
      customization_args:
        ...
        placeholder:
          value:
            ...
            unicode_str: ''
      default_outcome:
        dest: Ratio Expression Input
        feedback:
          content_id: default_outcome
          html: <p>No, that's not right.
            The answer is 1:2 (or equivalent).</p>
        labelled_as_correct: false
        missing_prerequisite_skill_id: null
        param_changes: []
        refresher_exploration_id: null
...
""")
    ...
    def test_proto_size_calculation_is_correct(self):
        ...
        self.assertEqual(exploration_proto_size, 4774)
