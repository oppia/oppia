...
(email_models,
 user_models) = models.Registry.import_models([models.Names.EMAIL, models.Names.USER])
...
class UserQueryServicesTests(test_utils.GenericTestBase):
    ...
    def test_get_user_query_returns_user_query(self) -> None:
        ...
        self.assertEqual(
            self.user_query_model_1.sent_email_model_id, user_query.sent_email_model_id
        )
    ...
    def test_save_new_query_model(self) -> None:
        ...
        self.assertEqual(
            query_model.inactive_in_last_n_days, query_param['inactive_in_last_n_days']
        )
        self.assertEqual(
            query_model.created_at_least_n_exps, query_param['created_at_least_n_exps']
        )
        self.assertEqual(
    ...
    def test_archive_user_query_archives_user_query(self) -> None:
        ...
        self.assertEqual(
            archived_user_query_model.query_status, feconf.USER_QUERY_STATUS_ARCHIVED
        )
    ...
    def test_send_email_to_qualified_users(self) -> None:
        ...
        self.assertIsNone(
            user_models.UserBulkEmailsModel.get(self.admin_user_id, strict=False)
        )
