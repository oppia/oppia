...
class ClassroomServicesTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        classroom_models.ClassroomModel.create(
            self.math_classroom.classroom_id, self.math_classroom.name,
            self.math_classroom.url_fragment, self.math_classroom.course_details,
            self.math_classroom.teaser_text, self.math_classroom.topic_list_intro,
            ...
            self.math_classroom.banner_data.size_in_bytes, self.math_classroom.index
        )
        ...
        classroom_models.ClassroomModel.create(
            self.physics_classroom.classroom_id, self.physics_classroom.name,
            self.physics_classroom.url_fragment, self.physics_classroom.course_details,
            self.physics_classroom.teaser_text, self.physics_classroom.topic_list_intro,
    ...
    def test_get_classroom_by_url_fragment(self) -> None:
        ...
        self.assertIsNone(
            ...
            get_classroom_by_url_fragment('incorrect_url_fragment')
        )
    ...
    def test_get_classroom_url_fragment_and_name_for_existing_topic(self) -> None:
        ...
        classroom_models.ClassroomModel.create(
            chemistry_classroom.classroom_id, chemistry_classroom.name,
            chemistry_classroom.url_fragment, chemistry_classroom.course_details,
            chemistry_classroom.teaser_text, chemistry_classroom.topic_list_intro,
            ...
            chemistry_classroom.banner_data.size_in_bytes, chemistry_classroom.index
        )
        ...
        classroom_name = (
            classroom_config_services.get_classroom_name_for_topic_id('topic_id_chem')
        )
    ...
    def test_get_classroom_url_fragment_and_name_for_non_existing_topic(self) -> None:
        classroom_url_fragment = (
            classroom_config_services.
            get_classroom_url_fragment_for_topic_id('non_existing_topic_id')
        )
        classroom_name = (
            classroom_config_services.
            get_classroom_name_for_topic_id('non_existing_topic_id')
        )
    ...
    def test_update_classroom_id_to_index_mappings(self) -> None:
        ...
        updated_history_classroom = (
            classroom_config_services.get_classroom_by_id('history')
        )
