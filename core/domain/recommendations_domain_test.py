...
class ExplorationRecommendationsUnitTests(test_utils.GenericTestBase):
    ...
    def test_validate_invalid_exp_id_value_type_raises_exception(self) -> None:
    ...
    def test_validate_empty_str_exp_id_raises_exception(self) -> None:
        exp_id = ''
        recommended_exploration_ids = ['1']
        exploration_recommendations = (
            recommendations_domain.ExplorationRecommendations(
    ...
    def test_validate_non_str_recommended_id_raises_exception(self) -> None:
        exp_id = '123'
        # TODO(#13059): Here we use MyPy ignore because after we fully type the
        # codebase we plan to get rid of the tests that intentionally test wrong
        # inputs that we can normally catch by typing.
    ...
    def test_validate_empty_str_recommended_id_raises_exception(self) -> None:
        exp_id = '123'
        recommended_exploration_ids = ['']
        exploration_recommendations = (
            recommendations_domain.ExplorationRecommendations(
