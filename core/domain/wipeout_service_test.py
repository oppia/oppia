...
class WipeoutServicePreDeleteTests(test_utils.GenericTestBase):
    ...
    def test_pre_delete_user_email_subscriptions(self) -> None:
        ...
        self.assertItemsEqual(
            ...
            [
                'Email ID %s permanently deleted from bulk email provider\'s db. Cannot access API, since this is a dev environment'
                % self.USER_1_EMAIL
            ]
...
class WipeoutServiceDeleteCollectionModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_collection_with_missing_snapshot_is_pseudonymized(
        ...
        self.assertItemsEqual(
            log_messages,
            [
                '[WIPEOUT] The commit log model \'CollectionCommitLogEntryModel\' and snapshot models [\'CollectionSnapshotMetadataModel\', \'CollectionRightsSnapshotMetadataModel\'] IDs differ. Snapshots without commit logs: [], commit logs without snapshots: [\'%s\'].'
                % self.COL_2_ID,
            ],
        )
...
class WipeoutServiceDeleteExplorationModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_exploration_with_missing_snapshot_is_pseudonymized(
        ...
        self.assertItemsEqual(
            log_messages,
            [
                '[WIPEOUT] The commit log model \'ExplorationCommitLogEntryModel\' and snapshot models [\'ExplorationSnapshotMetadataModel\', \'ExplorationRightsSnapshotMetadataModel\'] IDs differ. Snapshots without commit logs: [], commit logs without snapshots: [\'%s\'].'
                % self.EXP_2_ID
            ],
        )
...
class WipeoutServiceDeleteQuestionModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_question_with_missing_snapshot_is_pseudonymized(self) -> None:
        ...
        self.assertEqual(
            log_messages,
            [
                '[WIPEOUT] The commit log model \'QuestionCommitLogEntryModel\' and snapshot models [\'QuestionSnapshotMetadataModel\'] IDs differ. Snapshots without commit logs: [], commit logs without snapshots: [\'%s\'].'
                % self.QUESTION_2_ID
            ],
        )
...
class WipeoutServiceDeleteSkillModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_skill_with_missing_snapshot_is_pseudonymized(self) -> None:
        ...
        self.assertEqual(
            log_messages,
            [
                '[WIPEOUT] The commit log model \'SkillCommitLogEntryModel\' and snapshot models [\'SkillSnapshotMetadataModel\'] IDs differ. Snapshots without commit logs: [], commit logs without snapshots: [\'%s\'].'
                % self.SKILL_2_ID
            ],
        )
...
class WipeoutServiceDeleteStoryModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_story_with_missing_snapshot_is_pseudonymized(self) -> None:
        ...
        self.assertEqual(
            log_messages,
            [
                '[WIPEOUT] The commit log model \'StoryCommitLogEntryModel\' and snapshot models [\'StorySnapshotMetadataModel\'] IDs differ. Snapshots without commit logs: [], commit logs without snapshots: [\'%s\'].'
                % self.STORY_2_ID
            ],
        )
...
class WipeoutServiceDeleteSubtopicModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_subtopic_with_missing_snapshot_is_pseudonymized(self) -> None:
        ...
        self.assertEqual(
            log_messages,
            [
                '[WIPEOUT] The commit log model \'SubtopicPageCommitLogEntryModel\' and snapshot models [\'SubtopicPageSnapshotMetadataModel\'] IDs differ. Snapshots without commit logs: [], commit logs without snapshots: [\'%s\'].'
                % self.SUBTOP_2_ID
            ],
        )
...
class WipeoutServiceDeleteTopicModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_topic_with_missing_snapshot_is_pseudonymized(self) -> None:
        ...
        self.assertItemsEqual(
            log_messages,
            [
                '[WIPEOUT] The commit log model \'TopicCommitLogEntryModel\' and snapshot models [\'TopicSnapshotMetadataModel\', \'TopicRightsSnapshotMetadataModel\'] IDs differ. Snapshots without commit logs: [], commit logs without snapshots: [\'%s\'].'
                % self.TOP_2_ID
            ],
        )
