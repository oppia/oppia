...
class WipeoutServiceHelpersTests(test_utils.GenericTestBase):
    ...
    def test_saves_pending_deletion_request_when_already_existing(self) -> None:
        pending_deletion_request_model_old = user_models.PendingDeletionRequestModel(
            id=self.user_1_id,
...
class WipeoutServicePreDeleteTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.profile_user_id = user_services.create_new_profiles(
            self.user_1_auth_id, self.USER_1_EMAIL, [self.modifiable_new_user_data]
        )[0].user_id
    ...
    def tearDown(self) -> None:
        ...
        for pending_deletion_request_model in pending_deletion_request_models:
            ...
            self.assertEqual(
                wipeout_service.run_user_deletion_completion(pending_deletion_request),
    ...
    def test_pre_delete_user_without_activities_works_correctly(self) -> None:
        ...
        pending_deletion_model = user_models.PendingDeletionRequestModel.get_by_id(
            self.user_1_id
        )
    ...
    def test_pre_delete_username_is_saved_for_user_older_than_week(self) -> None:
        ...
        self.assertEqual(
            pending_deletion_request.normalized_long_term_username, self.USER_3_USERNAME
        )
    ...
    def test_pre_delete_user_exploration_ownership_is_released_with_voice_art(
        ...
        self.publish_exploration(self.user_1_id, 'exp_id')
        rights_manager.assign_role_for_exploration(
            self.user_1_actions, 'exp_id', self.user_2_id, feconf.ROLE_VOICE_ARTIST
        )
...
class WipeoutServiceRunFunctionsTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        wipeout_service.pre_delete_user(self.user_1_id)
        self.process_and_flush_pending_tasks()
        self.pending_deletion_request = wipeout_service.get_pending_deletion_request(
            self.user_1_id
        )
    ...
    def test_run_user_deletion_completion_with_user_not_yet_deleted(self) -> None:
        self.assertEqual(
            wipeout_service.run_user_deletion_completion(self.pending_deletion_request),
...
class WipeoutServiceDeleteAppFeedbackReportModelsTests(test_utils.GenericTestBase):
    ...
    def test_user_is_pseudonymized_from_report(self) -> None:
        ...
        report_mappings = user_models.PendingDeletionRequestModel.get_by_id(
            self.user_1_id
        ).pseudonymizable_entity_mappings[models.Names.APP_FEEDBACK_REPORT.value]

        # Verify the user is pseudonymized.
        report_model = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            self.REPORT_ID_1
        )
    ...
    def test_same_pseudonym_used_for_same_user(self) -> None:
        ...
        report_model_2 = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            self.REPORT_ID_2
        )
        report_model_3 = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            self.REPORT_ID_3
        )
    ...
    def test_different_users_have_different_pseudonyms(self) -> None:
        ...
        user_1_report_mappings = user_models.PendingDeletionRequestModel.get_by_id(
            self.user_1_id
        ).pseudonymizable_entity_mappings[models.Names.APP_FEEDBACK_REPORT.value]
        user_2_report_mappings = user_models.PendingDeletionRequestModel.get_by_id(
            self.user_2_id
        ).pseudonymizable_entity_mappings[models.Names.APP_FEEDBACK_REPORT.value]

        # Verify pseudonyms are different for different users.
        report_model_1 = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            self.REPORT_ID_1
        )
        report_model_2 = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            self.REPORT_ID_2
...
class WipeoutServiceDeleteConfigModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_config_property_is_pseudonymized(self) -> None:
        ...
        metadata_model = config_models.PlatformParameterSnapshotMetadataModel.get_by_id(
    ...
    def test_remove_user_from_user_groups(self) -> None:
        user_group_model = user_models.UserGroupModel(
            id='group_1', name='Test Group', user_ids=[self.user_1_id, self.user_2_id]
        )
        user_group_model.put()

        existing_user_group_model = user_models.UserGroupModel.get_by_id('group_1')
        ...
        updated_user_group_model = user_models.UserGroupModel.get_by_id('group_1')
...
class WipeoutServiceDeleteCollectionModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_collection_snapshot_metadata_is_pseudonymized(self) -> None:
        ...
        metadata_model = collection_models.CollectionSnapshotMetadataModel.get_by_id(
            '%s-1' % self.COL_1_ID
        )
        self.assertEqual(
        ...
        self.assertEqual(
            rights_metadata_model_1.committer_id, collection_mappings[self.COL_1_ID]
        )
        self.assertEqual(
        ...
        self.assertEqual(
            rights_metadata_model_2.committer_id, collection_mappings[self.COL_1_ID]
        )
        self.assertEqual(
    ...
    def test_one_collection_commit_log_is_pseudonymized(self) -> None:
        ...
        commit_log_model_1 = collection_models.CollectionCommitLogEntryModel.get_by_id(
            'rights-%s-2' % self.COL_1_ID
        )
        self.assertEqual(commit_log_model_1.user_id, collection_mappings[self.COL_1_ID])
        commit_log_model_2 = collection_models.CollectionCommitLogEntryModel.get_by_id(
    ...
    def test_one_collection_when_the_deletion_is_repeated_is_pseudonymized(
        ...
        commit_log_model = collection_models.CollectionCommitLogEntryModel.get_by_id(
            'collection-%s-1' % self.COL_1_ID
        )
    ...
    def test_delete_exp_where_user_has_role_when_rights_model_marked_as_deleted(
        ...
        collection_rights_model = collection_models.CollectionRightsModel.get_by_id(
            self.COL_2_ID
        )
...
class WipeoutServiceDeleteExplorationModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_exploration_snapshot_metadata_is_pseudonymized(self) -> None:
        ...
        # Verify user is deleted.
        exploration_mappings = user_models.PendingDeletionRequestModel.get_by_id(
            self.user_1_id
        ...
        self.assertEqual(
            rights_metadata_model_1.committer_id, exploration_mappings[self.EXP_1_ID]
        )
        self.assertEqual(
            rights_metadata_model_1.content_user_ids,
        ...
        self.assertEqual(
            rights_metadata_model_2.committer_id, exploration_mappings[self.EXP_1_ID]
        )
        self.assertEqual(
            rights_metadata_model_2.content_user_ids,
            [exploration_mappings[self.EXP_1_ID]],
    ...
    def test_one_exploration_commit_log_is_pseudonymized(self) -> None:
        ...
        commit_log_model_1 = exp_models.ExplorationCommitLogEntryModel.get_by_id(
        ...
        commit_log_model_2 = exp_models.ExplorationCommitLogEntryModel.get_by_id(
...
class WipeoutServiceDeleteFeedbackModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_feedback_is_pseudonymized(self) -> None:
        ...
        feedback_thread_model = feedback_models.GeneralFeedbackThreadModel.get_by_id(
            self.FEEDBACK_1_ID
        )
        self.assertEqual(
        ...
        suggestion_model_model = suggestion_models.GeneralSuggestionModel.get_by_id(
            self.FEEDBACK_1_ID
        )
        self.assertEqual(
            suggestion_model_model.author_id, feedback_mappings[self.FEEDBACK_1_ID]
        )
    ...
    def test_one_feedback_when_the_deletion_is_repeated_is_pseudonymized(self) -> None:
        ...
        new_feedback_thread_model = (
            feedback_models.GeneralFeedbackThreadModel.get_by_id(self.FEEDBACK_1_ID)
        )
        self.assertEqual(
    ...
    def test_one_feedback_with_multiple_users_is_pseudonymized(self) -> None:
        ...
        self.assertEqual(
            feedback_thread_model.last_nonempty_message_author_id, self.user_2_id
        )
...
class WipeoutServiceDeleteImprovementsModelsTests(test_utils.GenericTestBase):
    ...
    def test_delete_user_is_successful(self) -> None:
        ...
        task_entry_model1 = improvements_models.ExplorationStatsTaskEntryModel.get(
            self.improvements_model_1_id
        )
        task_entry_model2 = improvements_models.ExplorationStatsTaskEntryModel.get(
            self.improvements_model_2_id
        )
...
class WipeoutServiceDeleteSubtopicModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_subtopic_is_pseudonymized(self) -> None:
        ...
        metadata_model = subtopic_models.SubtopicPageSnapshotMetadataModel.get_by_id(
        ...
        commit_log_model = subtopic_models.SubtopicPageCommitLogEntryModel.get_by_id(
...
class WipeoutServiceDeleteTopicModelsTests(test_utils.GenericTestBase):
    ...
    def test_one_topic_snapshot_metadata_is_pseudonymized(self) -> None:
        ...
        self.assertEqual(
            rights_metadata_model_2.content_user_ids, [topic_mappings[self.TOP_1_ID]]
        )
        self.assertEqual(
    ...
    def test_one_topic_snapshot_content_is_pseudonymized(self) -> None:
        ...
        rights_content_model_1 = topic_models.TopicRightsSnapshotContentModel.get_by_id(
            '%s-1' % self.TOP_1_ID
        )
        self.assertEqual(rights_content_model_1.content['manager_ids'], [])
        rights_content_model_2 = topic_models.TopicRightsSnapshotContentModel.get_by_id(
            '%s-3' % self.TOP_1_ID
        )
        self.assertItemsEqual(
    ...
    def test_multiple_topics_are_pseudonymized(self) -> None:
        self.save_new_topic(
            self.TOP_2_ID, self.user_1_id, name='topic2', url_fragment='topic-two'
        )
...
class WipeoutServiceDeleteUserModelsTests(test_utils.GenericTestBase):
    ...
    def test_delete_user_for_profile_user_is_successful(self) -> None:
        ...
        self.assertIsNotNone(
            user_models.IncompleteActivitiesModel.get_by_id(self.profile_user_id)
        )
        self.assertIsNotNone(
    ...
    def test_delete_user_with_collection_and_exploration_is_successful(self) -> None:
        ...
        self.save_new_valid_collection(
            self.COLLECTION_1_ID, self.user_1_id, exploration_id=self.EXPLORATION_1_ID
        )
    ...
    def test_delete_user_with_collections_and_explorations_is_successful(self) -> None:
        ...
        self.save_new_valid_collection(
            self.COLLECTION_2_ID, self.user_1_id, exploration_id=self.EXPLORATION_2_ID
        )
...
class WipeoutServiceDeleteBlogPostModelsTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.author_details_model = blog_models.BlogAuthorDetailsModel.get_by_author(
            self.user_1_id
        )
    ...
    def test_one_blog_post_model_is_pseudonymized(self) -> None:
        ...
        self.assertEqual(
            blog_post_model.author_id, pseudonymizable_user_id_mapping[self.BLOG_1_ID]
        )
...
class WipeoutServiceDeletelLearnerGroupModelsTests(test_utils.GenericTestBase):
    ...
    def test_delete_learner_is_successful(self) -> None:
        ...
        learner_group_model_1 = learner_group_models.LearnerGroupModel.get_by_id(
            self.LEARNER_GROUP_ID_1
        )
        learner_group_model_2 = learner_group_models.LearnerGroupModel.get_by_id(
    ...
    def test_delete_invited_user_is_successful(self) -> None:
        ...
        self.assertTrue(
            self.user_3_id not in (learner_group_model_1.invited_learner_user_ids)
        )
        self.assertTrue(
            self.user_3_id not in (learner_group_model_2.invited_learner_user_ids)
        )
...
class WipeoutServiceDeleteVersionHistoryModelsTests(test_utils.GenericTestBase):
    ...
    def test_multiple_version_history_models_are_pseudonymized(self) -> None:
        ...
        pseudonymized_models = exp_models.ExplorationVersionHistoryModel.get_multi(
            version_history_ids
        )
