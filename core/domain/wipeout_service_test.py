...
class WipeoutServiceDeleteSuggestionModelsTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        suggestion_models.TranslationSubmitterTotalContributionStatsModel(
            ...
            last_hundred_accepted_translations_count=1,
            last_hundred_accepted_translations_without_reviewer_edits_count=1,
            last_hundred_rejected_translations_count=1,
            submitted_translations_count=1,
            submitted_translation_word_count=1,
            accepted_translations_count=1,
            accepted_translations_without_reviewer_edits_count=2,
        ...
        suggestion_models.QuestionSubmitterTotalContributionStatsModel(
            ...
            last_hundred_accepted_questions_without_reviewer_edits_count=1,
            last_hundred_rejected_questions_count=1,
            submitted_questions_count=1,
