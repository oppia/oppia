...
class ParamName(enum.Enum):
    ...
    ALWAYS_ASK_LEARNERS_FOR_ANSWER_DETAILS = ('always_ask_learners_for_answer_details')
    ...
    MAX_NUMBER_OF_SUGGESTIONS_PER_REVIEWER = ('max_number_of_suggestions_per_reviewer')
    EMAIL_SENDER_NAME = 'email_sender_name'
    EMAIL_FOOTER = 'email_footer'
    SIGNUP_EMAIL_SUBJECT_CONTENT = 'signup_email_subject_content'
    SIGNUP_EMAIL_BODY_CONTENT = 'signup_email_body_content'
    UNPUBLISH_EXPLORATION_EMAIL_HTML_BODY = ('unpublish_exploration_email_html_body')
...
ALL_PLATFORM_PARAMS_LIST: List[ParamName] = [
    ...
    ParamName.DUMMY_PARAMETER, ParamName.EMAIL_FOOTER, ParamName.EMAIL_SENDER_NAME,
    ...
    ParamName.MAX_NUMBER_OF_SUGGESTIONS_PER_REVIEWER, ParamName.PROMO_BAR_ENABLED,
    ParamName.PROMO_BAR_MESSAGE, ParamName.SIGNUP_EMAIL_BODY_CONTENT,
    ParamName.SIGNUP_EMAIL_SUBJECT_CONTENT,
    ParamName.UNPUBLISH_EXPLORATION_EMAIL_HTML_BODY,
    ParamName.RECORD_PLAYTHROUGH_PROBABILITY, ParamName.SERVER_CAN_SEND_EMAILS,
    ParamName.SYSTEM_EMAIL_ADDRESS, ParamName.SYSTEM_EMAIL_NAME,
    ParamName.ADMIN_EMAIL_ADDRESS, ParamName.NOREPLY_EMAIL_ADDRESS,
    ParamName.MAILCHIMP_AUDIENCE_ID, ParamName.MAILCHIMP_USERNAME,
    ParamName.MAILGUN_DOMAIN_NAME, ParamName.ES_CLOUD_ID, ParamName.ES_USERNAME,
    ParamName.OPPIA_PROJECT_ID, ParamName.OPPIA_SITE_URL_FOR_EMAILS
]
