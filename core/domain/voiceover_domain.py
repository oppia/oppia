...
class EntityVoiceoversDict(TypedDict):
    ...
    voiceovers_mapping: Dict[
        str, Dict[feconf.VoiceoverType.value, Optional[state_domain.VoiceoverDict]]
    ]
...
class EntityVoiceovers:
    ...
    def __init__(
        ...
        language_accent_code: str,
        voiceovers_mapping: Dict[
            str, Dict[feconf.VoiceoverType, Optional[state_domain.Voiceover]]
        ],
    ) -> None:
    ...
    def to_dict(self) -> EntityVoiceoversDict:
        ...
        for content_id, voiceover_type_to_voiceover in self.voiceovers_mapping.items():
    ...
    def from_dict(
        ...
        for content_id, voiceover_type_to_voiceover_dict in entity_voiceovers_dict[
            'voiceovers_mapping'
        ].items():
