...
class VoiceoverAutogenerationPolicy:
    ...
    def validate(self) -> None:
        """Validates the EntityVoiceovers object."""
        for language_code, language_accent_code_to_auto_voiceover_enabled in (
                self.language_codes_mapping.items()):
            ...
            for language_accent_code, is_auto_voiceover_enabled in (
                    language_accent_code_to_auto_voiceover_enabled.items()):
