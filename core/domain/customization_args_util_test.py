...
class CustomizationArgsUtilUnitTests(test_utils.GenericTestBase):
    ...
    # def test_apply_conversion_fn_on_content(self):
    #     """Test apply conversion function on content method."""
    ...
    #         'explanation': {
    #             'content_id': 'explanation0',
    #             'html': '<p>French goes here</p>'
    #         }
    #     }]

    #     def conversion_fn(value, obj_type):
    #         value['html'] = '<div>' + value['html'] + '</div>'
    #         return value

    #     result = customization_args_util.apply_conversion_fn_on_content(
    #         value,
    #         schema,
    #         conversion_fn,
    #     )
    ...
    #             'explanation': {
    #                 'content_id': 'explanation0',
    #                 'html': '<div><p>Explain</p></div>'
    #             }
    #         }, {
    #             'language_code': 'fr',
    #             'explanation': {
    #                 'content_id': 'explanation0',
    #                 'html': '<div><p>French goes here</p></div>'
    #             }
    #         }]
    #     )
