...
def get_learner_groups_of_facilitator(
    ...
    """
    learner_grp_models = learner_group_models.LearnerGroupModel.get_by_facilitator_id(
        user_id
    )
...
def get_learner_groups_joined_by_learner(
    ...
    Returns:
        ...
        is part of.
    """
    learner_grp_models = learner_group_models.LearnerGroupModel.get_by_learner_user_id(
        user_id
    )
