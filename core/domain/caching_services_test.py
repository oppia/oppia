...
class CachingServicesUnitTests(test_utils.GenericTestBase):
    ...
    json_encoded_string_representing_an_exploration = (
        ...
        'ard_is_checkpoint": true, "interaction": {"solution": null, "answer_gro'
        'ups": [{"tagged_skill_misconception_id": null, "outcome": {"param_chan'
        'ges": [], "feedback": {"content_id": "feedback_2", "html": "<p>This is'
        ' great! \\u00ae\\u00ae</p>"}, "dest": "Introduction", "refresher_explo'
        'ration_id": null, "missing_prerequisite_skill_id": null, "labelled_as_'
        'correct": false}, "training_data": [], "rule_specs": [{"rule_type": "C'
        'ontains", "inputs": {"x": {"normalizedStrSet": ["\\u00ae\\u00ae"], "co'
        'ntentId": "rule_input_4"}}}]}], "default_outcome": {"param_changes": ['
        '], "feedback": {"content_id": "default_outcome", "html": ""}, "dest": '
        '"Introduction", "refresher_exploration_id": null, "missing_prerequisit'
        'e_skill_id": null, "labelled_as_correct": false}, "customization_args"'
        ': {"rows": {"value": 1}, "placeholder": {"value": {"unicode_str": "\\u'
        'd83d\\ude0d\\ud83d\\ude0d\\ud83d\\ude0d\\ud83d\\ude0d", "content_id": '
        '"ca_placeholder_0"}}}, "confirmed_unclassified_answers": [], "id": "Te'
        'xtInput", "hints": [{"hint_content": {"content_id": "hint_3", "html": '
        '"<p>This is a copyright character \\u00a9.</p>"}}]}, "recorded_voiceov'
        'ers": {"voiceovers_mapping": {"feedback_2": {}, "rule_input_4": {}, "c'
        'ontent": {}, "hint_3": {}, "default_outcome": {}, "ca_placeholder_0": '
        '{}}}, "classifier_model_id": null, "content": {"content_id": "content"'
        ', "html": "<p>Unicode Characters \\ud83d\\ude0d\\ud83d\\ude0d\\ud83d\\'
        'ude0d\\ud83d\\ude0d</p>"}, "written_translations": {"translations_mapp'
        'ing": {"feedback_2": {}, "rule_input_4": {}, "content": {}, "hint_'
