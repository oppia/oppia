...
class CachingServicesUnitTests(test_utils.GenericTestBase):
    ...
    json_encoded_string_representing_an_exploration = (
        ...
        'opyright character \\u00a9.</p>"}}]}, "linked_skill_id": null, "record'
        'ed_voiceovers": {"voiceovers_mapping": {"feedback_2": {}, "rule_input_'
        '4": {}, "content": {}, "hint_3": {}, "default_outcome": {}, "ca_placeh'
        'older_0": {}}}, "classifier_model_id": null, "content": {"content_id":'
        ' "content", "html": "<p>Unicode Characters \\ud83d\\ude0d\\ud83d\\ude0'
        'd\\ud83d\\ude0d\\ud83d\\ude0d</p>"}, "written_translations": {"transla'
        'tions_mapping": {"feedback_2": {}, "rule_input_4": {}, "content": {}, '
        '"hint_3": {}, "default_outcome": {}, "ca_placeholder_0": {}}}, "next_c'
        'ontent_id_index": 5, "solicit_answer_details": false}}, "version": 0, '
        '"correctness_feedback_enabled": false, "language_code": "en", "objecti'
        've": "", "init_state_name": "Introduction", "blurb": "", "author_notes'
        '": ""}'
    )
