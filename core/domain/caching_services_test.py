...
class CachingServicesUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_multi_correctly_retrieves_cache_elements(self) -> None:
        ...
        key_value_mapping: Dict[str, Union[str, int, List[Optional[bool]],
                                           Dict[str, float]]] = {
                                               'a': '1',
                                               'b': 2,
                                               'c': [True, None],
        ...
        self.assertEqual(
            caching_services.get_multi(
                caching_services.CACHE_NAMESPACE_DEFAULT, None, ['a', 'b', 'c', 'd']
            ), {}
        )
        self.assertEqual(
            caching_services.get_multi(
    ...
    def test_queries_to_wrong_sub_namespace_returns_none(self) -> None:
        ...
        self.assertEqual(
            existent_result[exploration_id].to_dict(), default_exploration.to_dict()
        )
    ...
    def test_collections_with_unicode_characters_are_set_and_get_correctly(
        ...
        default_collection = (
            collection_domain.Collection.create_default_collection(collection_id)
        )
    ...
    def test_skills_with_unicode_characters_are_set_and_get_correctly(self) -> None:
        ...
        default_skill = (
            skill_domain.Skill.create_default_skill(skill_id, 'Description 😍', rubrics)
        )
