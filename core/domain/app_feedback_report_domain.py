...
class AppFeedbackReport:
    ...
    def __init__(
        self, report_id: str, schema_version: int, platform: str,
        submitted_on_timestamp: datetime.datetime, local_timezone_offset_hrs: int,
        ticket_id: Optional[str], scrubbed_by: Optional[str],
        user_supplied_feedback: UserSuppliedFeedback,
        device_system_context: DeviceSystemContext, app_context: AppContext
    ) -> None:
    ...
    def validate(self) -> None:
        ...
        if not isinstance(self.device_system_context, AndroidDeviceSystemContext):
            raise utils.ValidationError(
                ...
                'received: %r' % (self.platform, self.device_system_context.__class__)
            )
    ...
    def require_valid_schema_version(cls, platform: str, schema_version: int) -> None:
        ...
        if not isinstance(schema_version, int) or schema_version <= 0:
            raise utils.ValidationError(
                ...
                'in [%d, %d].' % (schema_version, minimum_schema, current_schema)
            )
    ...
    def get_android_report_from_dict(
        ...
        user_supplied_feedback_obj = (
            UserSuppliedFeedback(
                ...
                cls.get_category_from_string(user_supplied_feedback_json['category']),
        ...
        app_context_obj = AndroidAppContext(
            ...
            cls.get_android_text_size_from_string(app_context_json['text_size']),
...
class UserSuppliedFeedback:
    ...
    def __init__(
        self, report_type: app_feedback_report_constants.ReportType,
        category: app_feedback_report_constants.Category,
        user_feedback_selected_items: List[str], user_feedback_other_text_input: str
    ) -> None:
    ...
    def to_dict(self) -> UserSuppliedFeedbackDict:
        ...
        return {
            ...
            'user_feedback_other_text_input': (self.user_feedback_other_text_input)
        }
    ...
    def require_valid_report_type(
        ...
        if report_type not in (app_feedback_report_constants.ALLOWED_REPORT_TYPES):
            raise utils.ValidationError(
                ...
                (report_type, app_feedback_report_constants.ALLOWED_REPORT_TYPES)
            )
    ...
    def require_valid_user_feedback_items_for_category(
        cls, category: app_feedback_report_constants.Category,
        selected_items: List[str], other_text_input: str
    ) -> None:
...
class AndroidDeviceSystemContext(DeviceSystemContext):
    ...
    def __init__(
        self, version_name: str, package_version_code: int,
    ...
    def require_valid_package_version_code(cls, package_version_code: int) -> None:
        ...
        if package_version_code < feconf.MINIMUM_ANDROID_PACKAGE_VERSION_CODE:
            raise utils.ValidationError(
                ...
                (feconf.MINIMUM_ANDROID_PACKAGE_VERSION_CODE, package_version_code)
            )
...
class AppContext:
    ...
    def __init__(
        self, entry_point: EntryPoint, text_language_code: str, audio_language_code: str
    ) -> None:
...
class AndroidAppContext(AppContext):
    ...
    def __init__(
        self, entry_point: EntryPoint, text_language_code: str,
        audio_language_code: str,
        text_size: app_feedback_report_constants.AndroidTextSize,
        only_allows_wifi_download_and_update: bool, automatically_update_topics: bool,
        account_is_profile_admin: bool, event_logs: List[str], logcat_logs: List[str]
    ) -> None:
    ...
    def validate(self) -> None:
        ...
        if self.logcat_logs is None or not isinstance(self.logcat_logs, list):
            raise utils.ValidationError(
                'Should have a logcat log list, received: %r' % (self.logcat_logs)
            )

    @classmethod
    def require_valid_language_code(
        cls, language_type: str, language_code: str
    ) -> None:
    ...
    def require_valid_text_size(
        ...
        if text_size not in (app_feedback_report_constants.ALLOWED_ANDROID_TEXT_SIZES):
            raise utils.ValidationError(
                ...
                (app_feedback_report_constants.ALLOWED_ANDROID_TEXT_SIZES, text_size)
            )
...
class EntryPoint:
    ...
    def require_valid_entry_point_name(
        ...
        if not isinstance(actual_name, str):
            raise utils.ValidationError(
                'Entry point name must be a string, received: %r.' % (actual_name)
            )
    ...
    def require_valid_entry_point_exploration(
        ...
        if not isinstance(exploration_id, str):
            raise utils.ValidationError(
                'Exploration id should be a string, received: %r' % (exploration_id)
            )
...
class NavigationDrawerEntryPoint(EntryPoint):
    ...
    def __init__(self) -> None:
        ...
        super().__init__(
            app_feedback_report_constants.EntryPoint.NAVIGATION_DRAWER, None, None,
            None, None
        )
...
class RevisionCardEntryPoint(EntryPoint):
    ...
    def __init__(self, topic_id: str, subtopic_id: str) -> None:
        ...
        """
        super().__init__(
            app_feedback_report_constants.EntryPoint.REVISION_CARD, topic_id, None,
            None, subtopic_id
        )
    ...
    def validate(self) -> None:
        ...
        if not isinstance(self.subtopic_id, int):
            raise utils.ValidationError(
                'Expected subtopic id to be an int, received %s' % (self.subtopic_id)
            )
...
class CrashEntryPoint(EntryPoint):
    ...
    def __init__(self) -> None:
        ...
        super().__init__(
            app_feedback_report_constants.EntryPoint.CRASH, None, None, None, None
        )
    ...
    def validate(self) -> None:
        ...
        """
        self.require_valid_entry_point_name(
            self.entry_point_name, app_feedback_report_constants.EntryPoint.CRASH
        )
...
class AppFeedbackReportTicket:
    ...
    def __init__(
        self, ticket_id: str, ticket_name: str, platform: str,
        github_issue_repo_name: Optional[str], github_issue_number: Optional[int],
        archived: bool, newest_report_creation_timestamp: Optional[datetime.datetime],
        reports: List[str]
    ) -> None:
    ...
    def validate(self) -> None:
        ...
        if self.github_issue_number is not None:
            if not isinstance(self.github_issue_number,
                              int) or (self.github_issue_number < 1):
                raise utils.ValidationError(
    ...
    def require_valid_github_repo(cls, repo_name: str) -> None:
        ...
        if not isinstance(repo_name, str):
            raise utils.ValidationError(
                'The Github repo name should be a string, received: %s' % (repo_name)
            )
...
AcceptableEntryPointClasses = Union[NavigationDrawerEntryPointDict,
                                    ...
                                    RevisionCardEntryPointDict, CrashEntryPointDict]
...
class AppFeedbackReportDailyStats:
    ...
    def __init__(
        self, stats_id: str, ticket: AppFeedbackReportTicket, platform: str,
    ...
    def to_dict(self) -> AppFeedbackReportDailyStatsDict:
        ...
        return {
            ...
            'daily_param_stats': {
                ...
                for (param_name, param_counts_obj) in (self.daily_param_stats.items())
            }
        }
    ...
    def require_valid_daily_param_stats(
        ...
        allowed_parameter_names = [
            parameter.value
            for parameter in (app_feedback_report_constants.ALLOWED_STATS_PARAMETERS)
        ]
...
class AppFeedbackReportFilter:
    ...
    def __init__(
        self, filter_field: app_feedback_report_constants.FilterFieldNames,
        filter_options: List[str]
    ) -> None:
