...
class StoryDomainUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.story = self.save_new_story(
            self.story_id, self.USER_ID, self.TOPIC_ID, url_fragment='story-frag'
        )
    ...
    def test_valid_story_id(self) -> None:
        ...
        self._assert_valid_story_id(
            'Story id should be a string', 10
    ...
    def test_story_description_validation(self) -> None:
        ...
        self._assert_validation_error(
            'Expected description to be less than %d chars, received %s' % (1000, 1001)
        )
    ...
    def test_defaults(self) -> None:
        ...
        topic_id = utils.generate_random_string(12)
        story = story_domain.Story.create_default_story(
            self.STORY_ID, 'Title', 'Description', topic_id, 'story-frag-default'
        )
    ...
    def test_get_prerequisite_skill_ids(self) -> None:
        ...
        self.assertEqual(
            self.story.get_prerequisite_skill_ids_for_exp_id('exp_id'), ['skill_1']
        )
    ...
    def test_node_outline_finalized_validation(self) -> None:
        self.story.story_contents.nodes[
            0].outline_is_finalized = 'abs'  # type: ignore[assignment]
    ...
    def test_story_node_update_last_modified(self) -> None:
        ...
        self.assertEqual(
            self.story.story_contents.nodes[0].last_modified_msecs, current_time_msecs
        )
    ...
    def test_story_node_update_unpublishing_reason(self) -> None:
        ...
        self.assertEqual(
            self.story.story_contents.nodes[0].unpublishing_reason, 'BAD CONTENT'
        )
    ...
    def test_nodes_validation(self) -> None:
        ...
        self.story.story_contents.nodes.append(
            story_domain.StoryNode.create_default_story_node(self.NODE_ID_2, 'Title 2')
        )
        self.story.story_contents.nodes[0].acquired_skill_ids = [
        ...
        # inputs that we can normally catch by typing.
        self.story.story_contents.nodes[
            0].acquired_skill_ids = 1  # type: ignore[assignment]
        self._assert_validation_error(
        ...
        # inputs that we can normally catch by typing.
        self.story.story_contents.nodes[
            0].prerequisite_skill_ids = 1  # type: ignore[assignment]
        self._assert_validation_error(
        ...
        self.assertEqual(
            self.story.story_contents.nodes[0].prerequisite_skill_ids, ['1', '2']
        )
    ...
    def test_node_is_behind_schedule(self) -> None:
        ...
        with self.swap(utils, 'get_current_time_in_millisecs',
            ...
            self.assertEqual(
                self.story.story_contents.nodes[1].is_node_behind_schedule(), True
            )
    ...
    def test_validate_non_string_unpublishing_reason(self) -> None:
        ...
        # inputs that we can normally catch by typing.
        self.story.story_contents.nodes[
            0].unpublishing_reason = 1  # type: ignore[assignment]
        self._assert_validation_error(
    ...
    def test_update_node_exploration_id_changes_node_exploration_id(self) -> None:
        ...
        self.assertEqual(
            self.story.story_contents.get_all_linked_exp_ids(), ['exp_3', 'exp_2']
        )
    ...
    def test_update_node_exploration_id_with_same_exploration_id_does_nothing(
        ...
        self.assertEqual(
            self.story.story_contents.get_all_linked_exp_ids(), ['exp_1', 'exp_2']
        )
    ...
    def test_get_all_linked_exp_ids_ignores_nodes_without_linked_exp_id(self) -> None:
        self.story.story_contents.next_node_id = 'node_3'
        node_1: story_domain.StoryNodeDict = {
            'id': 'node_1',
            'thumbnail_filename': 'image.svg',
    ...
    def test_update_story_contents_from_model_with_all_versions(self) -> None:
        ...
        self.assertEqual(
            version_dict['story_contents']['nodes'][0]['description'], 'Description 1'
        )
        ...
        self.assertEqual(
            version_dict['story_contents']['nodes'][0]['thumbnail_size_in_bytes'], 21131
        )
    ...
    def test_get_node_with_corresponding_exp_id_with_valid_exp_id(self) -> None:
        ...
        node_with_exp_1 = (
            self.story.story_contents.get_node_with_corresponding_exp_id('exp_1')
        )
    ...
    def test_story_contents_export_import(self) -> None:
        ...
        story_node = story_domain.StoryNode(
            ...
            constants.ALLOWED_THUMBNAIL_BG_COLORS['chapter'][0], None, [self.NODE_ID_2],
            [self.SKILL_ID_1], [self.SKILL_ID_2], 'Outline', False, self.EXP_ID,
    ...
    def test_validate_non_list_destination_node_ids(self) -> None:
        self.story.story_contents.nodes[
            0].destination_node_ids = 0  # type: ignore[assignment]
    ...
    def test_get_node_index_with_invalid_node_id(self) -> None:
        self.assertIsNone(
            self.story.story_contents.get_node_index('invalid_node_id', strict=False)
        )
...
class StorySummaryTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.story_summary = story_domain.StorySummary(
            ...
            '#F8BF74', 'image.svg', 'story-summary-frag', current_time, current_time
        )
