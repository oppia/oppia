...
class StoryDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_serialize_and_deserialize_returns_unchanged_story(self) -> None:
        ...
        self.assertEqual(
            story.to_dict(), story_domain.Story.deserialize(story.serialize()).to_dict()
        )
    ...
    def test_node_is_upcoming(self) -> None:
        ...
        self.story.story_contents.nodes[0].planned_publication_date_msecs = int(
        ...
        self.story.story_contents.nodes[1].planned_publication_date_msecs = int(
            datetime.datetime(2022, 12, 29).timestamp() * 1000
        )
    ...
    def test_get_node_with_corresponding_exp_id_with_valid_exp_id(self) -> None:
        ...
        node_with_exp_1 = self.story.story_contents.get_node_with_corresponding_exp_id(
            'exp_1'
        )
