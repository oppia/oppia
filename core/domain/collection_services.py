...
def get_collection_from_model(
    ...
    return collection_domain.Collection(
        ...
        [collection_domain.CollectionNode.from_dict(collection_node_dict) for collection_node_dict in versioned_collection_contents['collection_contents']['nodes']],
...
def get_collection_and_collection_rights_by_id(
    ...
    """
    collection_and_rights = datastore_services.fetch_multiple_entities_by_ids_and_models(
        [
...
def get_collection_summaries_where_user_has_role(
    ...
    """
    col_summary_models: Sequence[collection_models.CollectionSummaryModel] = collection_models.CollectionSummaryModel.query(
...
def _create_collection(
    ...
    model = collection_models.CollectionModel(
        ...
        collection_contents={'nodes': [collection_node.to_dict() for collection_node in collection.nodes]},
    )
...
def save_collection_summary(
    ...
    collection_summary_dict = {
        ...
        'collection_model_last_updated': (collection_summary.collection_model_last_updated),
