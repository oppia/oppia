...
class RatingServicesTests(test_utils.GenericTestBase):
    ...
    def test_rating_assignation(self) -> None:
        ...
        exp_services.save_new_exploration(
            self.EXP_ID, exp_domain.Exploration.create_default_exploration(self.EXP_ID)
        )
    ...
    def test_time_of_ratings_recorded(self) -> None:
        ...
        self.assertLess(
            datetime.datetime.utcnow(), first_rating_time + time_allowed_for_computation
        )
    ...
    def test_rating_assignations_do_not_conflict(self) -> None:
        ...
        exp_services.save_new_exploration(
            exp_id_a, exp_domain.Exploration.create_default_exploration(exp_id_a)
        )
        exp_services.save_new_exploration(
            exp_id_b, exp_domain.Exploration.create_default_exploration(exp_id_b)
        )
