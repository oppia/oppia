...
class RatingServicesTests(test_utils.GenericTestBase):
    ...
    def test_invalid_ratings_are_forbidden(self) -> None:
        ...
        with self.assertRaisesRegex(  # type: ignore[no-untyped-call]
            ...
            # The argument new_rating of assign_rating_to_exploration() can
            # only accept integer values, but for testing purposes here we are
            # providing string value. Thus to silent MyPy error, we added an
