...
class UserServicesUnitTests(test_utils.GenericTestBase):
    ...
    def test_add_user_role_to_mobile_learner_raises_exception(self) -> None:
        ...
        profile_user_id = user_services.get_all_profiles_auth_details_by_parent_user_id(
            user_id
        )[0].user_id
        self.assertEqual(
    ...
    def test_create_multiple_new_profiles_for_same_user_works_correctly(self) -> None:
        ...
        modifiable_new_user_data_2 = user_domain.ModifiableUserData.from_raw_dict(
    ...
    def test_update_users_data_for_multiple_users_works_correctly(self) -> None:
        ...
        expected_auth_details_output = [
            {'id': profile_user_ids[0], 'auth_id': None, 'parent_user_id': user_id},
            {'id': profile_user_ids[1], 'auth_id': None, 'parent_user_id': user_id},
        ]
        ...
        expected_user_settings_output = [
            {'id': profile_user_ids[0], 'display_alias': 'xyz', 'pin': profile_pin},
            {'id': profile_user_ids[1], 'display_alias': display_alias_3, 'pin': '345'},
        ]
...
class CommunityContributionStatsUnitTests(test_utils.GenericTestBase):
    ...
    def test_grant_multiple_reviewers_multi_reviewing_rights_increases_counts(
        ...
        self.assertEqual(stats.question_suggestion_count, 0)
        self.assertDictEqual(
            stats.translation_reviewer_counts_by_lang_code, {'hi': 2, 'en': 1, 'fr': 1}
        )
        self.assertDictEqual(stats.translation_suggestion_counts_by_lang_code, {})
...
class UserContributionReviewRightsTests(test_utils.GenericTestBase):
    ...
    def test_remove_question_submit_rights(self) -> None:
        ...
        pre_user_contribution_rights = user_services.get_user_contribution_rights(
            user_id
        )
