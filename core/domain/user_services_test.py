...
def _get_change_list(state_name: str, property_name: str,
                     new_value: bool) -> List[exp_domain.ExplorationChange]:
...
class UserServicesUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_usernames_for_pseudonymous_ids(self) -> None:
        ...
        self.assertEqual(['User_Aaaaaaaa', 'User_Bbbbbbbb'],
    ...
    def test_get_usernames_system_admin(self) -> None:
        ...
        self.assertEqual([feconf.SYSTEM_COMMITTER_ID],
    ...
    def test_create_new_user_with_invalid_emails_raises_exception(self) -> None:
        bad_email_addresses_with_expected_error_message = [
            ...
            ('abc', 'Invalid email address: abc'), ('', 'No user email specified.'),
    ...
    def test_create_new_user_with_already_existing_auth_id_raises_error(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'User %s already exists for auth_id %s.' % (user_id, auth_id)
        ):
    ...
    def test_get_user_id_from_username(self) -> None:
        ...
        self.assertEqual(
            user_services.get_user_id_from_username(username), user_settings.user_id
        )
    ...
    def test_get_multi_user_ids_from_usernames(self) -> None:
        ...
        self.assertEqual(
            user_services.get_multi_user_ids_from_usernames([
                'fakeUsername1', 'fakeUsername2', 'fakeUsername3', 'fakeUsername4',
                'fakeUsername5', 'fakeUsername6', 'fakeUsername7', 'fakeUsername8',
                'fakeUsername9'
            ]), [None, None, None, None, None, None, None, None, None]
        )
        self.assertEqual(
            user_services.get_multi_user_ids_from_usernames([
                'fakeUsername1', 'USERNAME1', 'fakeUsername3', 'fakeUsername4',
                'fakeUsername5', 'fakeUsername6', 'fakeUsername7', username2,
                'fakeUsername9'
    ...
    def test_get_users_setting_retrieves_settings_for_system_user(self) -> None:
        ...
        roles = [
            ...
            feconf.ROLE_ID_MODERATOR, feconf.ROLE_ID_VOICEOVER_ADMIN
        ]
    ...
    def test_add_user_to_mailing_list(self) -> None:
        ...
        def _mock_add_or_update_user_status(
            unused_email: str, merge_fields: Dict[str, str], unused_tag: str, *,
    ...
    def test_add_user_to_mailing_list_no_name(self) -> None:
        ...
        with fn_swap:
            self.assertTrue(
                user_services.add_user_to_mailing_list('email@example.com', 'Android')
            )
    ...
    def test_set_and_get_user_email_preferences(self) -> None:
        ...
        def _mock_add_or_update_user_status(
            unused_email: str, unused_merge_fields: Dict[str, str], unused_tag: str, *,
            can_receive_email_updates: bool
        ) -> bool:
            """Mocks bulk_email_services.add_or_update_user_status()."""
        ...
        user_services.update_email_preferences(
            user_id, feconf.DEFAULT_EMAIL_UPDATES_PREFERENCE, False, False, False
        )
    ...
    def test_get_and_set_user_email_preferences_with_error(self) -> None:
        ...
        with self.swap(
            ...
            try:
                user_services.update_email_preferences(
                    user_id, False, feconf.DEFAULT_EDITOR_ROLE_EMAIL_PREFERENCE,
                    feconf.DEFAULT_FEEDBACK_MESSAGE_EMAIL_PREFERENCE,
                    feconf.DEFAULT_SUBSCRIPTION_EMAIL_PREFERENCE
                )
            except Exception:
    ...
    def test_get_system_user_returns_system_user_action_info(self) -> None:
        ...
        expected_actions = set([
            'MANAGE_TOPIC_RIGHTS', 'EDIT_ANY_PUBLIC_ACTIVITY', 'DELETE_ANY_SKILL',
            'PUBLISH_OWNED_SKILL', 'DELETE_TOPIC', 'EDIT_OWNED_TOPIC',
            'CREATE_NEW_TOPIC', 'ACCESS_MODERATOR_PAGE', 'RATE_ANY_PUBLIC_EXPLORATION',
            'DELETE_ANY_PUBLIC_ACTIVITY', 'MANAGE_ACCOUNT',
            'MODIFY_CORE_ROLES_FOR_OWNED_ACTIVITY', 'CREATE_EXPLORATION',
            'UNPUBLISH_ANY_PUBLIC_ACTIVITY', 'CHANGE_TOPIC_STATUS',
            'SEND_MODERATOR_EMAILS', 'FLAG_EXPLORATION', 'ACCESS_CREATOR_DASHBOARD',
            'EDIT_ANY_TOPIC', 'ACCEPT_ANY_SUGGESTION', 'PUBLISH_OWNED_ACTIVITY',
            'PLAY_ANY_PUBLIC_ACTIVITY', 'EDIT_ANY_SUBTOPIC_PAGE',
            'VISIT_ANY_QUESTION_EDITOR_PAGE', 'ACCESS_LEARNER_DASHBOARD',
            'ACCESS_FEEDBACK_UPDATES', 'EDIT_ANY_ACTIVITY',
            'VISIT_ANY_TOPIC_EDITOR_PAGE', 'SUGGEST_CHANGES',
            'DELETE_OWNED_PRIVATE_ACTIVITY', 'EDIT_OWNED_ACTIVITY',
            'EDIT_SKILL_DESCRIPTION', 'DELETE_ANY_ACTIVITY', 'SUBSCRIBE_TO_USERS',
            'PLAY_ANY_PRIVATE_ACTIVITY', 'MANAGE_QUESTION_SKILL_STATUS',
            'MODIFY_CORE_ROLES_FOR_ANY_ACTIVITY', 'ACCESS_TOPICS_AND_SKILLS_DASHBOARD',
            'EDIT_SKILL', 'DELETE_ANY_QUESTION', 'EDIT_ANY_STORY',
            'PUBLISH_ANY_ACTIVITY', 'EDIT_ANY_QUESTION', 'CREATE_NEW_SKILL',
            'CHANGE_STORY_STATUS', 'CAN_MANAGE_VOICE_ARTIST', 'ACCESS_LEARNER_GROUPS',
    ...
    def test_add_user_role(self) -> None:
        ...
        self.assertEqual(
            user_services.get_user_roles_from_id(user_id), [feconf.ROLE_ID_FULL_USER]
        )
    ...
    def test_get_auth_details_by_user_id_for_existing_user_works_fine(self) -> None:
        ...
        self.assertEqual(
            user_auth_details.parent_user_id, user_auth_details_model.parent_user_id
        )
    ...
    def test_create_multiple_new_profiles_for_same_user_works_correctly(self) -> None:
        ...
        user_settings_list = user_services.create_new_profiles(
            auth_id, email, [self.modifiable_new_user_data, modifiable_new_user_data_2]
        )
    ...
    def test_get_all_user_groups(self) -> None:
        ...
        if user_groups_data[0].name == 'USERGROUP1':
            self.assertEqual(
                user_groups_data[0].member_usernames, ['user1', 'user2', 'user3']
            )
        else:
    ...
    def test_deleting_user_group_raises_error_when_not_exists(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, 'User group with id INVALID_USER_GROUP_ID does not exist.'
        ):
    ...
    def test_user_group_trying_to_update_not_exists_raise_error(self) -> None:
        ...
        with self.assertRaisesRegex(
            ...
            user_services.update_user_group(
                'INVALID_USER_GROUP_ID', 'INVALID_USER_GROUP',
                ['user1', 'user2', 'user3']
            )
        user_services.delete_user_group(user_groups_data[0].user_group_id)
        user_services.delete_user_group(user_groups_data[1].user_group_id)
    ...
    def test_user_group_containing_duplicate_users_raises_error(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, r'Users list of user-group USERGROUP1 contains '
            r'duplicates: \[\'user2\']\.'
        ):
            user_services.update_user_group(
                user_groups_data[0].user_group_id, 'USERGROUP1',
                ['user1', 'user2', 'user2']
            )
    ...
    def test_user_group_containing_invalid_user_raises_exception(self) -> None:
        ...
        with self.assertRaisesRegex(
            Exception, r'Following users of user-group USERGROUP1 '
    ...
    def test_get_current_date_as_string(self) -> None:
        ...
        datetime_strings = [
            custom_datetime.strftime(feconf.DASHBOARD_STATS_DATETIME_STRING_FORMAT)
    ...
    def test_parse_date_from_string(self) -> None:
        ...
        with self.assertRaisesRegex(
            ValueError, 'time data \'2016-13-01\' does not match format \'%Y-%m-%d\''
        ):
    ...
    def test_record_user_started_state_translation_tutorial(self) -> None:
        ...
        self.assertIsInstance(
            user_settings.last_started_state_translation_tutorial, datetime.datetime
        )
        self.assertTrue(
    ...
    def test_get_human_readable_user_ids(self) -> None:
        ...
        user_emails = [
            'reuglar_user@example.com', 'user_being_deleted@example.com',
        ...
        usernames = [
            'regularUsername', user_services.LABEL_FOR_USER_BEING_DELETED,
            (
    ...
    def test_create_user_contributions(self) -> None:
        ...
        self.assertEqual(['exp1', 'exp2', 'exp3'],
    ...
    def test_update_user_contributions_for_invalid_user_raises_error(self) -> None:
        with self.assertRaisesRegex(
            Exception, 'User contributions model for user %s does not exist.' %
            'non_existent_user_id'
        ):
            user_services.update_user_contributions(
                'non_existent_user_id', ['exp1', 'exp2', 'exp3'],
                ['exp2', 'exp3', 'exp4']
            )
...
"""
    ...
    def test_user_checkpoint_progress_is_updated_correctly(self) -> None:
        ...
        self.assertEqual(
            exp_user_data.most_recently_reached_checkpoint_state_name, 'Introduction'
        )
        ...
        self.assertEqual(
            exp_user_data.most_recently_reached_checkpoint_state_name, 'New state'
        )
...
class UpdateContributionMsecTests(test_utils.GenericTestBase):
    ...
    def test_contribution_msec_updates_on_published_explorations(self) -> None:
        ...
        self.assertIsNotNone(
            user_services.get_user_settings(self.editor_id).first_contribution_msec
        )
    ...
    def test_contribution_msec_does_not_change_if_exp_unpublished(self) -> None:
        ...
        # unpublished.
        self.assertIsNotNone(
            user_services.get_user_settings(self.owner_id).first_contribution_msec
        )
...
class UserDashboardStatsTests(test_utils.GenericTestBase):
    ...
    def test_get_user_impact_score(self) -> None:
        ...
        with self.swap(
            ...
            self.assertEqual(
                impact_score_for_user_with_some_learner_activity, expected_impact_score
            )
...
class LastExplorationEditedIntegrationTests(test_utils.GenericTestBase):
    ...
    def test_last_exp_edit_time_gets_updated(self) -> None:
        ...
        mocked_datetime_utcnow = (
            user_settings.last_edited_an_exploration - datetime.timedelta(hours=13)
        )
        with self.mock_datetime_utcnow(mocked_datetime_utcnow):
...
class LastExplorationCreatedIntegrationTests(test_utils.GenericTestBase):
    ...
    def test_last_exp_edit_time_gets_updated(self) -> None:
        ...
        with self.mock_datetime_utcnow(
            user_settings.last_created_an_exploration - datetime.timedelta(hours=13)
        ):
...
class UserContributionReviewRightsTests(test_utils.GenericTestBase):
    ...
    def test_translation_review_assignement_adds_language_in_sorted_order(self) -> None:
        ...
        self.assertEqual(
            user_contribution_rights.can_review_translation_for_language_codes, ['hi']
        )
    ...
    def test_voiceover_review_assignement_adds_language_in_sorted_order(self) -> None:
        ...
        self.assertEqual(
            user_contribution_rights.can_review_voiceover_for_language_codes, ['hi']
        )
    ...
    def test_get_all_reviewers_contribution_rights(self) -> None:
        ...
        self.assertItemsEqual([reviewer.id for reviewer in all_reviewers],
    ...
    def test_get_reviewer_user_ids_to_notify_when_reviewers_want_notifications(
        ...
        user_services.update_email_preferences(
            self.translator_id, True, feconf.DEFAULT_EDITOR_ROLE_EMAIL_PREFERENCE,
            feconf.DEFAULT_FEEDBACK_MESSAGE_EMAIL_PREFERENCE,
            feconf.DEFAULT_SUBSCRIPTION_EMAIL_PREFERENCE
        )
    ...
    def test_get_reviewer_user_ids_to_notify_when_reviewers_do_not_want_emails(
        ...
        user_services.update_email_preferences(
            self.translator_id, False, feconf.DEFAULT_EDITOR_ROLE_EMAIL_PREFERENCE,
            feconf.DEFAULT_FEEDBACK_MESSAGE_EMAIL_PREFERENCE,
            feconf.DEFAULT_SUBSCRIPTION_EMAIL_PREFERENCE
        )
    ...
    def test_get_question_reviewer_usernames_with_lanaguge_code_raise_error(
        ...
        with self.assertRaisesRegex(Exception, 'Expected language_code to be None'):
            user_services.get_contributor_usernames(
                constants.CD_USER_RIGHTS_CATEGORY_REVIEW_QUESTION, language_code='hi'
            )
    ...
    def test_get_contributor_usernames_for_translation_returns_correctly(self) -> None:
        usernames = user_services.get_contributor_usernames(
            constants.CD_USER_RIGHTS_CATEGORY_REVIEW_TRANSLATION, language_code='hi'
        )
...
class TranslationCoordinatorRightsTests(test_utils.GenericTestBase):
    ...
    def test_check_user_is_coordinator_for_no_language_model(self) -> None:
        self.assertFalse(
            user_services.check_user_is_coordinator('user1', 'non_existing_language')
        )
