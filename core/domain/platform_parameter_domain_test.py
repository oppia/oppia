...
class PlatformParameterFilterTests(test_utils.GenericTestBase):
    ...
    def test_create_from_dict_returns_correct_instance(self) -> None:
        ...
        filter_domain = (
            parameter_domain.PlatformParameterFilter.from_dict(filter_dict)
        )
    ...
    def test_evaluate_eq_version_filter_with_same_version_returns_true(self) -> None:
        ...
        self.assertTrue(
            filter_domain.evaluate(self._create_example_context(app_version='1.2.3'))
        )
    ...
    def test_evaluate_eq_version_filter_with_diff_version_returns_false(self) -> None:
        ...
        self.assertFalse(
            filter_domain.evaluate(self._create_example_context(app_version='1.2.4'))
        )
    ...
    def test_evaluate_gt_version_filter_with_small_version_returns_false(self) -> None:
        ...
        self.assertFalse(
            filter_domain.evaluate(self._create_example_context(app_version='0.2.3'))
        )
        self.assertFalse(
            filter_domain.evaluate(self._create_example_context(app_version='1.1.2'))
        )
    ...
    def test_evaluate_gt_version_filter_with_large_version_returns_true(self) -> None:
        ...
        self.assertTrue(
            filter_domain.evaluate(self._create_example_context(app_version='1.3.0'))
        )
        self.assertTrue(
            filter_domain.evaluate(self._create_example_context(app_version='2.0.0'))
        )
    ...
    def test_evaluate_lt_version_filter_with_small_version_returns_true(self) -> None:
        ...
        self.assertTrue(
            filter_domain.evaluate(self._create_example_context(app_version='0.3.4'))
        )
        self.assertTrue(
            filter_domain.evaluate(self._create_example_context(app_version='1.1.0'))
        )
        self.assertTrue(
            filter_domain.evaluate(self._create_example_context(app_version='1.1.2'))
        )
        self.assertTrue(
            filter_domain.evaluate(self._create_example_context(app_version='1.2.2'))
        )
    ...
    def test_evaluate_lt_version_filter_with_large_version_returns_false(self) -> None:
        ...
        self.assertFalse(
            filter_domain.evaluate(self._create_example_context(app_version='1.10.0'))
        )
        self.assertFalse(
            filter_domain.evaluate(self._create_example_context(app_version='2.0.0'))
        )
    ...
    def test_evaluate_app_version_filter_without_version_returns_false(self) -> None:
        ...
        self.assertFalse(
            filter_domain.evaluate(self._create_example_context(app_version=None))
        )
