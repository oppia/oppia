...
class ConfigProperty:
    ...
    # This function returns general structured schema, hence Any type has to be
    ...
    # This function returns latest value of configuration property from
    # memcache, datastore, or default value. so, if function returns
    # default value it should return Any.
    @property
    def value(self) -> Any:
    ...
    # This function returns that Normalized object which is generated by
    # schema_utils.normalize_against_schema() and Normalized object
    # generated by normalize_against_schema() is of Any type.
...
class Registry:
    ...
    # This function returns Dict with property_name as key and every key
    # contains Dictionary of properties of that particular Property_name.
    # so, value of properties can be of type Dict ,str ,list ,bool ,int.
    # hence Any type has to be used here for the type of returned dictionary.
    @classmethod
