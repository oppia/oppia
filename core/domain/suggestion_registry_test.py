...
class SuggestionEditStateContentUnitTests(test_utils.GenericTestBase):
    ...
    def test_validate_score_category_format(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError,
            'Expected score_category to be of the form' ' score_type.score_sub_type',
        ):
            suggestion.validate()
    ...
    def test_validate_score_type(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError,
            'Expected the first part of score_category to be among allowed' ' choices',
        ):
            suggestion.validate()
    ...
    def test_get_all_html_content_strings(self) -> None:
        change_dict: Dict[str, Union[Optional[str], Dict[str, str]]] = {
            ...
            'property_name': exp_domain.STATE_PROPERTY_CONTENT,
            'state_name': 'state_1',
            'new_value': {'content_id': 'content', 'html': 'new suggestion content'},
            'old_value': None,
        }
        suggestion = suggestion_registry.SuggestionEditStateContent(
...
class SuggestionTranslateContentUnitTests(test_utils.GenericTestBase):
    ...
    def test_accept_suggestion_adds_translation_in_exploration(self) -> None:
        ...
        translations = translation_fetchers.get_all_entity_translations_for_entity(
...
TestChangeDictType = Dict[
    str,
    Union[str, float, Dict[str, Union[state_domain.StateDict, int, str, List[str]]]],
]
    ...
    def test_convert_html_in_suggestion_change(self) -> None:
        ...
        question_state_dict = {
            ...
            'interaction': {
                ...
                'customization_args': {
                    'choices': {
                        'value': [{'html': 'option 1', 'content_id': 'ca_choices_0'}]
                    },
                ...
                'default_outcome': {
                    'dest': None,
                    'dest_if_really_stuck': None,
                    'feedback': {'content_id': 'feedback_2', 'html': 'Correct Answer'},
                    'param_changes': [],
                    'refresher_exploration_id': None,
                    'labelled_as_correct': True,
                    'missing_prerequisite_skill_id': None,
...
class CommunityContributionStatsUnitTests(test_utils.GenericTestBase):
    ...
    def test_translation_reviewers_are_needed_if_num_suggestions_past_max(self) -> None:
        ...
        reviewers_are_needed = stats.are_translation_reviewers_needed_for_lang_code(
            self.sample_language_code
        )
