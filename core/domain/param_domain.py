...
class ParamSpec:
    ...
    def validate(self) -> None:
        ...
        object_registry.Registry.get_object_class_by_type(self.obj_type) # type: ignore[no-untyped-call]
...
class ParamChange:
    ...
    def to_dict(self) -> ParamChange_dict:
    ...
    @classmethod
    def from_dict(cls, param_change_dict: ParamChange_dict) -> ParamChange:
