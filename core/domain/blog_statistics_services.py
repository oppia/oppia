...
def _increment_reading_time_bucket_count(
    ...
    # Here we use cast because Mypy checks raise error for stats type to be
    # non indexable, since stats is a domain object.
    typed_stats = cast(Dict[str, int], stats)
    typed_stats[key] = typed_stats[key] + 1
