        ...
        for change in change_list:
            if change.cmd == skill_domain.CMD_UPDATE_SKILL_PROPERTY:
                ...
                if (change.property_name ==
                    ...
                    (
                        skill_domain.CMD_MIGRATE_CONTENTS_SCHEMA_TO_LATEST_VERSION, # pylint: disable=line-too-long
                        skill_domain.CMD_MIGRATE_MISCONCEPTIONS_SCHEMA_TO_LATEST_VERSION, # pylint: disable=line-too-long
                        skill_domain.CMD_MIGRATE_RUBRICS_SCHEMA_TO_LATEST_VERSION # pylint: disable=line-too-long
                    )
                ):
