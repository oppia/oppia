...
class TopicServicesUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_all_summaries(self):
        topic_summary_dicts = topic_services.get_all_topic_summaries()

        self.assertEqual(len(topic_summary_dicts), 1)
        self.assertEqual(topic_summary_dicts[0].name, 'Name')
        self.assertEqual(topic_summary_dicts[0].canonical_story_count, 2)
        self.assertEqual(topic_summary_dicts[0].additional_story_count, 1)
        self.assertEqual(topic_summary_dicts[0].uncategorized_skill_count, 2)
        self.assertEqual(topic_summary_dicts[0].subtopic_count, 1)
