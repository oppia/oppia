...
class SuggestionServicesUnitTests(test_utils.GenericTestBase):
    ...
    change_cmd: Dict[str, Union[str, Dict[str, str]]] = {
        ...
        'state_name': 'state_1',
        'new_value': {'content_id': 'content_0', 'html': 'new suggestion content'},
    }
    ...
    def test_resubmit_rejected_suggestion_raises_exception_for_unhandled_input(
        ...
        # rejected yet.
        expected_exception_regexp = 'The suggestion with id %s is not yet handled.' % (
            self.suggestion_id
        )
        resubmit_change = exp_domain.ExplorationChange(
            {
...
class SuggestionIntegrationTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.old_recorded_voiceovers = state_domain.RecordedVoiceovers.from_dict(
    ...
    def test_update_question_stats_when_suggestion_is_accepted(self) -> None:
        ...
        question_review_stats_model = suggestion_models.QuestionReviewStatsModel.get(
...
class UserContributionProficiencyUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_all_user_ids_who_are_allowed_to_review(self) -> None:
        ...
        user_ids = suggestion_services.get_all_user_ids_who_are_allowed_to_review(
            'category1'
        )
...
class ReviewableSuggestionEmailInfoUnitTests(test_utils.GenericTestBase):
    ...
    def _create_edit_state_content_suggestion(
        ...
        edit_state_content_change_dict: Dict[str, Union[str, Dict[str, str]]] = {
            ...
            'property_name': exp_domain.STATE_PROPERTY_CONTENT,
            'state_name': 'Introduction',
            'new_value': {'content_id': 'content_0', 'html': 'new html content'},
            'old_value': {'content_id': 'content_0', 'html': 'old html content'},
        }
...
class GetSuggestionsWaitingForReviewInfoToNotifyReviewersUnitTests(
    ...
    def test_get_returns_suggestion_infos_for_reviewer_with_multi_review_rights(
        ...
        suggestion_1 = self._create_question_suggestion_with_skill_id_and_author_id(
        ...
        suggestion_3 = self._create_question_suggestion_with_skill_id_and_author_id(
    ...
    def test_get_returns_suggestion_infos_for_multi_reviewers_with_multi_rights(
        ...
        suggestion_4 = self._create_question_suggestion_with_skill_id_and_author_id(
            'skill_2', self.author_id
        )
        suggestion_5 = (
            self._create_translation_suggestion_with_language_code_and_author(
...
class CommunityContributionStatsUnitTests(test_utils.GenericTestBase):
    ...
    def test_accept_translation_suggestion_lowers_translation_suggestion_count(
        ...
        translation_suggestion = self._create_translation_suggestion_with_language_code(
            self.language_code
        )
