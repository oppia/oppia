...
class StateDomainUnitTests(test_utils.GenericTestBase):
    ...
    def test_update_inappliacble_misconception_skill_ids(self) -> None:
        ...
        state.update_inapplicable_skill_misconception_ids(['string_1', 'string_2'])
        self.assertEqual(state.inapplicable_skill_misconception_ids, ['string_1', 'string_2'])
    ...
    def test_validate_state_inapplicable_skill_misconception_ids(self) -> None:
        ...
        with self.assertRaisesRegex(
            utils.ValidationError, 'Expected inapplicable_skill_misconception_ids to be '
            'a list, received 12.'):
