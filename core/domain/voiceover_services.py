...
def get_voiceover_autogeneration_policy(
    ) -> Optional[voiceover_domain.VoiceoverAutogenerationPolicy]:
    """Returns the voiceover autogeneration policy domain object."""

    voiceover_auto_policy_model = (
        voiceover_models.VoiceoverAutogenerationPolicyModel.get(
            voiceover_models.VOICEOVER_AUTOGENERATION_POLICY_ID, strict=False)
    )

    if voiceover_auto_policy_model is None:
        return None
    return voiceover_domain.VoiceoverAutogenerationPolicy(
        voiceover_auto_policy_model.language_codes_mapping,
        voiceover_auto_policy_model.autogenerated_voiceovers_are_enabled
    )


def set_voiceover_autogeneration_policy(
    policy: voiceover_domain.VoiceoverAutogenerationPolicy,
    change_language_codes_mapping: bool,
    change_autogenerated_voiceovers_are_enabled: bool
) -> None:
    """Updates the voiceover autogeneration policy. Creates
    the policy if it does not exist yet.

    Args:
        policy: VoiceoverAutogenerationPolicy. The object
            containing the voiceover policies.
        change_language_codes_mapping: bool. True if 
            language_codes_mapping needs to be changed.
        change_autogenerated_voiceovers_are_enabled: bool. True
            if autogenerated_voiceovers_are_enabled needs
            to be changed.
    """
    ...
    if change_autogenerated_voiceovers_are_enabled:
        (
            voiceover_autogeneration_policy_model.
            autogenerated_voiceovers_are_enabled
        ) = (
            policy.autogenerated_voiceovers_are_enabled
        )

    if change_language_codes_mapping:
        voiceover_autogeneration_policy_model.language_codes_mapping = (
            policy.language_codes_mapping
        )
...
def get_all_language_accent_codes_for_voiceovers(
    ...
    voiceover_autogeneration_policy = get_voiceover_autogeneration_policy()
    language_codes_mapping: Dict[str, Dict[str, bool]] = {}
    if voiceover_autogeneration_policy is None:
...
def is_voiceover_autogeneration_using_cloud_service_enabled() -> bool:
    ...
    if voiceover_autogeneration_policy is not None:
        autogenerated_voiceovers_are_enabled = (
...
def update_admin_config_for_voiceover_autogeneration(
    ...
    """
    voiceover_autogeneration_policy = get_voiceover_autogeneration_policy()
    assert voiceover_autogeneration_policy is not None

    new_voiceover_autogeneration_policy = (
        voiceover_domain.VoiceoverAutogenerationPolicy(
            voiceover_autogeneration_policy.language_codes_mapping,
            autogenerated_voiceovers_are_enabled
        ))

    set_voiceover_autogeneration_policy(
        new_voiceover_autogeneration_policy,
        False,
        True
    )
