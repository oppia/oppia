...
class AppFeedbackReportServicesUnitTests(test_utils.GenericTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.android_report_obj = app_feedback_report_services.get_report_from_model(
            self.android_report_model
        )
        ...
        self.android_ticket_obj = app_feedback_report_services.get_ticket_from_model(
            self.android_ticket_model
        )
    ...
    def test_get_multiple_reports_returns_all_reports(self) -> None:
        new_report_id_1 = app_feedback_report_models.AppFeedbackReportModel.generate_id(
            self.PLATFORM_ANDROID, self.REPORT_SUBMITTED_TIMESTAMP
        )
        app_feedback_report_models.AppFeedbackReportModel.create(
            new_report_id_1,
        ...
        new_report_id_2 = app_feedback_report_models.AppFeedbackReportModel.generate_id(
            self.PLATFORM_ANDROID, self.REPORT_SUBMITTED_TIMESTAMP
        )
        app_feedback_report_models.AppFeedbackReportModel.create(
            new_report_id_2,
    ...
    def test_save_android_report_and_get_from_model_has_new_info(self) -> None:
        ...
        scrubbed_report_obj = app_feedback_report_services.get_report_from_model(
    ...
    def test_new_reports_added_updates_unticketed_stats_model_correctly(self) -> None:
        ...
        unticketed_stats_id = app_feedback_report_models.AppFeedbackReportStatsModel.calculate_id(
            self.PLATFORM_ANDROID,
    ...
    def test_new_report_added_updates_all_reports_stats_model_correctly(self) -> None:
        ...
        all_report_stats_id = app_feedback_report_models.AppFeedbackReportStatsModel.calculate_id(
            self.PLATFORM_ANDROID,
    ...
    def test_edit_ticket_name_does_not_change_stats_model(self) -> None:
        ...
        new_report_model = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            self.android_report_id
        )
    ...
    def test_reassign_ticket_updates_old_ticket_existing_ticket(self) -> None:
        ...
        for i in range(1, 4):
            ...
            temp_timestamp = self.REPORT_SUBMITTED_TIMESTAMP - datetime.timedelta(
                days=4 - i
            )
    ...
    def test_reassign_updates_new_ticket_newest_report_creation_timestamp(self) -> None:
        ...
        original_ticket_obj = app_feedback_report_services.get_ticket_from_model(
            original_ticket_model
        )
        app_feedback_report_services.store_incoming_report_stats(
            self.android_report_obj
    ...
    def test_scrubbing_on_current_and_expired_reports_only_scrubs_expired(self) -> None:
        ...
        scrubbed_model = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            expired_report_id
        )
        current_model = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            current_report_id
        )
    ...
    def test_scrubbing_on_all_expired_models_updates_all_models(self) -> None:
        ...
        android_model_1 = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            android_report_id_1
        )
        android_model_2 = app_feedback_report_models.AppFeedbackReportModel.get_by_id(
            android_report_id_2
        )
    ...
    def test_calculate_new_stats_count_for_parameter_adds_new_stats_val_to_dict(
        ...
        new_stats_map = app_feedback_report_services.calculate_new_stats_count_for_parameter(  # pylint: disable=line-too-long
