...
class AppFeedbackReportServicesUnitTests(test_utils.GenericTestBase):
    ...
    REPORT_STATS = {
        ...
        'entry_point_name': {
            ENTRY_POINT_NAVIGATION_DRAWER.value: 1
        },
        'text_language_code': {
            TEXT_LANGUAGE_CODE_ENGLISH: 1
        },
        'audio_language_code': {
            AUDIO_LANGUAGE_CODE_ENGLISH: 1
        },
        'android_sdk_version': {
    ...
    def setUp(self) -> None:
        ...
        app_feedback_report_models.AppFeedbackReportModel.create(
            ...
            self.REPORT_SUBMITTED_TIMESTAMP, 0, self.REPORT_TYPE_SUGGESTION.value,
            self.CATEGORY_OTHER.value, self.ANDROID_PLATFORM_VERSION,
            self.COUNTRY_LOCALE_CODE_INDIA, self.ANDROID_SDK_VERSION,
            self.ANDROID_DEVICE_MODEL, self.ENTRY_POINT_NAVIGATION_DRAWER.value, None,
        ...
        app_feedback_report_models.AppFeedbackReportTicketModel.create(
            self.android_ticket_id, self.TICKET_NAME, self.PLATFORM_ANDROID, None, None,
    ...
    def test_get_multiple_reports_returns_all_reports(self) -> None:
        ...
        app_feedback_report_models.AppFeedbackReportModel.create(
            new_report_id_1, self.PLATFORM_ANDROID, self.REPORT_SUBMITTED_TIMESTAMP, 0,
            self.REPORT_TYPE_SUGGESTION.value, self.CATEGORY_OTHER.value,
            self.ANDROID_PLATFORM_VERSION, self.COUNTRY_LOCALE_CODE_INDIA,
        ...
        app_feedback_report_models.AppFeedbackReportModel.create(
            new_report_id_2, self.PLATFORM_ANDROID, self.REPORT_SUBMITTED_TIMESTAMP, 0,
            self.REPORT_TYPE_SUGGESTION.value, self.CATEGORY_OTHER.value,
            self.ANDROID_PLATFORM_VERSION, self.COUNTRY_LOCALE_CODE_INDIA,
            self.ANDROID_SDK_VERSION, self.ANDROID_DEVICE_MODEL,
            self.ENTRY_POINT_NAVIGATION_DRAWER.value, None, None, None, None,
    ...
    def test_get_report_from_model_has_same_user_supplied_feedback_info(self) -> None:
        ...
        self.assertEqual(
            user_supplied_feedback.category.value, self.android_report_model.category
        )
        self.assertEqual(user_supplied_feedback.user_feedback_selected_items, [])
        self.assertEqual(
            user_supplied_feedback.user_feedback_other_text_input, self.
            android_report_model.android_report_info['user_feedback_other_text_input']
        )
    ...
    def test_get_report_from_model_has_same_device_system_info(self) -> None:
        ...
        self.assertEqual(
            ...
            self.android_report_model.android_report_info['build_fingerprint']
        )
        self.assertEqual(
            device_system_context.network_type.value,
            self.android_report_model.android_report_info['network_type']
        )
    ...
    def test_get_report_from_model_has_same_app_info(self) -> None:
        ...
        self.assertEqual(
            app_context.text_language_code, self.android_report_model.text_language_code
        )
        self.assertEqual(
        ...
        self.assertEqual(
            app_context.only_allows_wifi_download_and_update, self.android_report_model.
            android_report_info['only_allows_wifi_download_and_update']
        )
        self.assertEqual(
    ...
    def test_save_android_report_and_get_from_model_has_new_info(self) -> None:
        ...
        optional_scrubbed_report_models = (
            app_feedback_report_services.get_report_models([self.android_report_id])
        )
        # Ruling out the possibility of None for mypy type checking.
    ...
    def test_get_ticket_from_model_has_same_ticket_info(self) -> None:
        ...
        self.assertEqual(
            self.android_ticket_obj.ticket_name, self.android_ticket_model.ticket_name
        )
        self.assertEqual(
        ...
        self.assertEqual(
            self.android_ticket_obj.reports, self.android_ticket_model.report_ids
        )
    ...
    def test_get_ticket_from_model_with_github_info_has_same_ticket_info(self) -> None:
        ...
        self.assertEqual(
            ticket_obj.github_issue_repo_name, ticket_model.github_issue_repo_name
        )
        self.assertEqual(
    ...
    def test_get_stats_from_model_is_correct_object(self) -> None:
        ...
        stats_model = (
            app_feedback_report_models.AppFeedbackReportStatsModel.get_by_id(stats_id)
        )
        ...
        expected_stats_obj = (
            app_feedback_report_domain.AppFeedbackReportDailyStats(
                ...
                app_feedback_report_constants.PLATFORM_CHOICE_ANDROID,
                self.android_report_obj.submitted_on_timestamp.date(), 1, daily_stats
            )
        )

        self.assertEqual(actual_stats_obj.stats_id, expected_stats_obj.stats_id)
        self.assertEqual(
            actual_stats_obj.ticket.ticket_id, expected_stats_obj.ticket.ticket_id
        )
        self.assertEqual(actual_stats_obj.platform, expected_stats_obj.platform)
        self.assertEqual(
            actual_stats_obj.stats_tracking_date, expected_stats_obj.stats_tracking_date
        )
        self.assertEqual(
    ...
    def test_create_report_from_json_is_correct_object(self) -> None:
        report_obj = (
            app_feedback_report_services.create_report_from_json(self.REPORT_JSON)
        )
        ...
        self.assertTrue(
            isinstance(
                report_obj.app_context, app_feedback_report_domain.AndroidAppContext
            )
        )
    ...
    def test_get_all_filter_options(self) -> None:
        ...
        for filter_obj in filter_options:
            ...
            if filter_obj.filter_field == (filter_field_names.REPORT_TYPE):
                self.assertEqual(
                    filter_obj.filter_options[0], self.REPORT_TYPE_SUGGESTION.value
                )
                ...
                self.assertEqual(
                    filter_obj.filter_options[0], self.REPORT_SUBMITTED_TIMESTAMP.date()
                )
                ...
                self.assertEqual(
                    filter_obj.filter_options[0], self.TEXT_LANGUAGE_CODE_ENGLISH
                )
            elif filter_obj.filter_field == (filter_field_names.AUDIO_LANGUAGE_CODE):
                self.assertEqual(
                    filter_obj.filter_options[0], self.AUDIO_LANGUAGE_CODE_ENGLISH
                )
    ...
    def test_edit_ticket_name_does_not_change_stats_model(self) -> None:
        ...
        old_ticket_id = (
            app_feedback_report_models.AppFeedbackReportTicketModel.
            generate_id(old_ticket_name)
        )
        app_feedback_report_models.AppFeedbackReportTicketModel.create(
            old_ticket_id, old_ticket_name, self.PLATFORM_ANDROID, None, None,
        ...
        old_stats_id = (
            app_feedback_report_models.AppFeedbackReportStatsModel.calculate_id(
                self.android_report_obj.platform, self.android_report_obj.ticket_id,
                self.android_report_obj.submitted_on_timestamp.date()
            )
        )
        app_feedback_report_models.AppFeedbackReportStatsModel.create(
            old_stats_id, self.android_report_obj.platform, old_ticket_id,
            self.android_report_obj.submitted_on_timestamp.date(), 1, self.REPORT_STATS
        )
        old_stats_model = (
            app_feedback_report_models.AppFeedbackReportStatsModel.
            get_by_id(old_stats_id)
        )
        ...
        new_report_obj = (
            app_feedback_report_services.get_report_from_model(new_report_model)
        )
        new_stats_id = (
            app_feedback_report_models.AppFeedbackReportStatsModel.calculate_id(
                new_report_obj.platform, new_report_obj.ticket_id,
                new_report_obj.submitted_on_timestamp.date()
            )
        )
        new_stats_model = (
            app_feedback_report_models.AppFeedbackReportStatsModel.
            get_by_id(new_stats_id)
        )
        ...
        self.assertEqual(
            old_stats_model.stats_tracking_date, new_stats_model.stats_tracking_date
        )
        self._verify_stats_model(
    ...
    def test_reassign_report_to_ticket_updates_increasing_stats_model(self) -> None:
        ...
        new_stats_id = (
            app_feedback_report_models.AppFeedbackReportStatsModel.calculate_id(
                new_ticket_obj.platform, new_ticket_obj.ticket_id,
                self.android_report_obj.submitted_on_timestamp.date()
            )
        )
        new_stats_model = (
    ...
    def test_reassign_ticket_updates_old_ticket_existing_ticket(self) -> None:
        ...
        new_ticket_id = (
            app_feedback_report_models.AppFeedbackReportTicketModel.
            generate_id('new_ticket_name')
        )
        app_feedback_report_models.AppFeedbackReportTicketModel.create(
            new_ticket_id, 'new_ticket_name', self.PLATFORM_ANDROID, None, None,
            self.REPORT_SUBMITTED_TIMESTAMP, []
        )
        new_ticket_model = (
            app_feedback_report_models.AppFeedbackReportTicketModel.
        ...
        new_ticket_obj = (
            app_feedback_report_services.get_ticket_from_model(new_ticket_model)
        )
    ...
    def test_reassign_updates_new_ticket_newest_report_creation_timestamp(self) -> None:
        ...
        original_ticket_id = (
            app_feedback_report_models.AppFeedbackReportTicketModel.
            generate_id(ticket_name)
        )
        app_feedback_report_models.AppFeedbackReportTicketModel.create(
            original_ticket_id, ticket_name, self.PLATFORM_ANDROID, None, None,
            older_timestamp, report_ids
        )
        original_ticket_model = (
            app_feedback_report_models.AppFeedbackReportTicketModel.
            get_by_id(original_ticket_id)
        )
        original_ticket_obj = (
            app_feedback_report_services.get_ticket_from_model(original_ticket_model)
        )
        app_feedback_report_services.store_incoming_report_stats(
            self.android_report_obj
        )
    ...
    def test_reassign_ticket_does_not_change_all_report_stats_model(self) -> None:
        ...
        old_all_reports_stats_model = (
            app_feedback_report_models.AppFeedbackReportStatsModel.
            get_by_id(old_all_report_stats_id)
        )
    ...
    def test_scrubbing_on_current_and_expired_reports_only_scrubs_expired(self) -> None:
        ...
        scrubbed_model = (
            ...
            get_by_id(expired_report_id)
        )
        current_model = (
            app_feedback_report_models.AppFeedbackReportModel.
            get_by_id(current_report_id)
        )
    ...
    def test_scrubbing_on_all_expired_models_updates_all_models(self) -> None:
        ...
        android_model_1 = (
            app_feedback_report_models.AppFeedbackReportModel.
            get_by_id(android_report_id_1)
        )
        android_model_2 = (
            app_feedback_report_models.AppFeedbackReportModel.
            get_by_id(android_report_id_2)
        )
    ...
    def _add_new_android_ticket(self, ticket_name: str, report_ids: List[str]) -> str:
        ...
        app_feedback_report_models.AppFeedbackReportTicketModel.create(
            android_ticket_id, ticket_name, self.PLATFORM_ANDROID, None, None,
            self.REPORT_SUBMITTED_TIMESTAMP, report_ids
        )
        return android_ticket_id

    def _verify_stats_model(
        self, stats_json: Dict[str, Dict[str, int]], expected_json: Dict[str, Dict[str,
                                                                                   int]]
    ) -> None:
        """Verify the fields of the feedback report stats model."""
        self.assertEqual(stats_json['report_type'], expected_json['report_type'])
        self.assertEqual(
            stats_json['country_locale_code'], expected_json['country_locale_code']
        )
        self.assertEqual(
            stats_json['entry_point_name'], expected_json['entry_point_name']
        )
        self.assertEqual(
            stats_json['text_language_code'], expected_json['text_language_code']
        )
        self.assertEqual(
            stats_json['audio_language_code'], expected_json['audio_language_code']
        )
        self.assertEqual(
            stats_json['android_sdk_version'], expected_json['android_sdk_version']
        )
