...
#     """A one time job to attach a new field (representing role of user) to
#     UserSettingsModel. The job will load all existing users from the
#     datastore, look for the role to assign them and then store them back
#     thus updating the table schema and adding appropiate roles to users.
#     """
#     @classmethod
#     def entity_classes_to_map_over(cls):
#         return [user_models.UserSettingsModel]
