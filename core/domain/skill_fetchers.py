...
def get_multi_skills(skill_ids: List[str],
                     strict: bool = True) -> List[skill_domain.Skill]:
    ...
    skills = [
        get_skill_from_model(skill_model) for skill_model in local_skill_models
...
def get_skill_by_id(skill_id: str,
                    strict: bool = True,
                    version: Optional[int] = None) -> Optional[skill_domain.Skill]:
...
def get_skill_from_model(skill_model: skill_models.SkillModel) -> skill_domain.Skill:
    ...
    return skill_domain.Skill(
        ...
        versioned_rubrics['schema_version'], versioned_skill_contents['schema_version'],
        skill_model.language_code, skill_model.version,
        skill_model.next_misconception_id, skill_model.superseding_skill_id,
        skill_model.all_questions_merged, skill_model.prerequisite_skill_ids,
