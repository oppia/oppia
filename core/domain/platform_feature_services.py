...
def get_all_feature_flag_dicts() -> List[
    ...
    Returns:
        A list containing the dict mappings of all fields of the feature flags.
    """
    return [
...
def evaluate_all_feature_flag_values_for_client(
    ...
    Returns:
        The keys are the feature names and the values are boolean
...
def is_feature_enabled(feature_name: str) -> bool:
    ...
    Args:
        feature_name: The name of the feature flag that needs to be evaluated.

    Returns:
        The value of the feature flag, True if it's enabled.
    """
...
def update_feature_flag_rules(
    ...
    Args:
        ...
        new_rules: A list of PlatformParameterRule objects to update.
...
def _get_server_mode() -> platform_parameter_domain.ServerMode:
    ...
    Returns:
        The server mode of Oppia, dev if Oppia is running in development mode,
        prod if in production mode.
    """
    return (
...
def _evaluate_feature_flag_values_for_context(
    ...
    Args:
        feature_names_set: The set of names of feature flags that need to be
            evaluated.
        context: The context used for evaluation.

    Returns:
        The keys are the feature names and the values are boolean results of
        corresponding flags.
