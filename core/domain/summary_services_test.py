...
class CollectionLearnerDictTests(test_utils.GenericTestBase):
    ...
    def test_get_displayable_collection_summary_dicts_matching_ids(self) -> None:
        ...
        collection_summaries = (
            summary_services.
            get_displayable_collection_summary_dicts_matching_ids(collection_id_list)
        )
    ...
    def test_get_learner_collection_dict_by_id_without_user_id(self) -> None:
        ...
        self.assertEqual(
            len(collection_dict['playthrough_dict']['completed_exploration_ids']), 0
        )
        self.assertEqual(
            collection_dict['playthrough_dict']['next_exploration_id'], self.EXP_ID
        )
...
class TopRatedExplorationDisplayableSummariesTest(test_utils.GenericTestBase):
    ...
    def test_at_most_eight_top_rated_explorations(self) -> None:
        ...
        expected_ordering = [
            self.EXP_ID_3, self.EXP_ID_2, self.EXP_ID_5, self.EXP_ID_4, self.EXP_ID_6,
            self.EXP_ID_8, self.EXP_ID_7, self.EXP_ID_9
        ]
