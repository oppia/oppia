...
from core.domain import summary_services_test
...
class LibraryGroupsTest(exp_services_test.ExplorationServicesUnitTests):
    ...
    def test_get_library_groups(self):
        ...
        """
        library_groups = summary_tile_services.get_library_groups([])
...
class CollectionLearnerDictTests(test_utils.GenericTestBase):
    ...
    def test_get_learner_dict_with_allowed_private_exps(self):
        ...
        collection_dict = summary_tile_services.get_learner_collection_dict_by_id( #pylint: disable=line-too-long
...
class CollectionNodeMetadataDictsTest(
    ...
    def test_get_exploration_metadata_dicts(self):
        metadata_dicts = (summary_tile_services.get_exploration_metadata_dicts(
    ...
    def test_exploration_metadata_dicts_matching_query(self):
        metadata_dicts, _ = (
...
class ExplorationDisplayableSummariesTest(
        summary_services_test.HumanReadableContributorsSummaryTest):
