...
from typing import Callable, DefaultDict, Dict, Final, List, Mapping, Optional, Sequence, Set, Tuple, TypedDict, Union
...
email_models, suggestion_models = models.Registry.import_models([models.
    Names.EMAIL, models.Names.SUGGESTION])
app_identity_services = models.Registry.import_app_identity_services()
transaction_services = models.Registry.import_transaction_services()
secrets_services = models.Registry.import_secrets_services()
PlatformParameterRegistry = platform_parameter_registry.Registry
NEW_CD_USER_EMAIL_DATA: Dict[str, Dict[str, str]] = {constants.
    CD_USER_RIGHTS_CATEGORY_REVIEW_TRANSLATION: {'task': 'review',
    'category': 'translations', 'to_review': 'translation suggestions',
    'description_template': '%s language translations',
    'rights_message_template':
    'review translation suggestions made by contributors in the %s language'
    }, constants.CD_USER_RIGHTS_CATEGORY_REVIEW_QUESTION: {'task': 'review',
    'category': 'questions', 'to_review': 'question suggestions',
    'description': 'questions', 'rights_message':
    'review question suggestions made by contributors'}, constants.
    CD_USER_RIGHTS_CATEGORY_SUBMIT_QUESTION: {'task': 'submit', 'category':
    'questions', 'to_submit': 'question suggestions', 'description':
    'questions', 'rights_message': 'submit question suggestions'}}
REMOVED_CD_USER_EMAIL_DATA: Dict[str, Dict[str, str]] = {constants.
    CD_USER_RIGHTS_CATEGORY_REVIEW_TRANSLATION: {'category': 'translation',
    'role_description_template':
    'translation reviewer role in the %s language',
    'rights_message_template':
    'review translation suggestions made by contributors in the %s language'
    }, constants.CD_USER_RIGHTS_CATEGORY_REVIEW_QUESTION: {'category':
    'question', 'role_description': 'question reviewer role',
    'rights_message': 'review question suggestions made by contributors'},
    constants.CD_USER_RIGHTS_CATEGORY_SUBMIT_QUESTION: {'category':
    'question', 'role_description': 'question submitter role',
...
EDITOR_ROLE_EMAIL_HTML_ROLES: Dict[str, str] = {rights_domain.ROLE_OWNER:
    EXPLORATION_ROLE_MANAGER, rights_domain.ROLE_EDITOR:
    EXPLORATION_ROLE_EDITOR, rights_domain.ROLE_VOICE_ARTIST:
    EXPLORATION_ROLE_VOICE_ARTIST, rights_domain.ROLE_VIEWER:
    EXPLORATION_ROLE_PLAYTESTER}
_EDITOR_ROLE_EMAIL_HTML_RIGHTS: Dict[str, str] = {'can_manage':
    '<li>Change the exploration permissions</li><br>', 'can_edit':
    '<li>Edit the exploration</li><br>', 'can_voiceover':
    '<li>Voiceover the exploration</li><br>', 'can_play':
    '<li>View and playtest the exploration</li><br>'}
EDITOR_ROLE_EMAIL_RIGHTS_FOR_ROLE: Dict[str, str] = {EXPLORATION_ROLE_MANAGER:
    '%s%s%s' % (_EDITOR_ROLE_EMAIL_HTML_RIGHTS['can_manage'],
    _EDITOR_ROLE_EMAIL_HTML_RIGHTS['can_edit'],
    _EDITOR_ROLE_EMAIL_HTML_RIGHTS['can_play']), EXPLORATION_ROLE_EDITOR: 
    '%s%s' % (_EDITOR_ROLE_EMAIL_HTML_RIGHTS['can_edit'],
    _EDITOR_ROLE_EMAIL_HTML_RIGHTS['can_play']),
    EXPLORATION_ROLE_VOICE_ARTIST: '%s%s' % (_EDITOR_ROLE_EMAIL_HTML_RIGHTS
    ['can_voiceover'], _EDITOR_ROLE_EMAIL_HTML_RIGHTS['can_play']),
...
CONTRIBUTOR_DASHBOARD_REVIEWER_NOTIFICATION_EMAIL_DATA: Dict[str, str] = {
    'email_body_template':
    'Hi %s,<br><br>There are new review opportunities that we think you might be interested in on the <a href="%s%s">Contributor Dashboard</a>. Here are some examples of contributions that have been waiting the longest for review:<br><br><ul>%s</ul><br>Please take some time to review any of the above contributions (if they still need a review) or any other contributions on the dashboard. We appreciate your help!<br><br>Thanks again, and happy reviewing!<br>- The Oppia Contributor Dashboard Team<br><br>%s'
...
CURRICULUM_ADMIN_CHAPTER_NOTIFICATION_EMAIL_DATA: Dict[str, str] = {
    ...
    'The following stories have unpublished chapters which are behind schedule. Please publish them or adjust the planned publication date.<br><br><ol>%s</ol>'
    , 'upcoming_chapters_template': 
    'The following stories have unpublished chapters which are due for publication in the next %s days. Please ensure they are published on or before the planned date or adjust the planned publication date.<br><br><ol>%%s</ol>'
     % constants.CHAPTER_PUBLICATION_NOTICE_PERIOD_IN_DAYS, 'email_subject':
    'Chapter Publication Notifications'}
HTML_FOR_SUGGESTION_DESCRIPTION: Dict[str, Dict[str, Union[str, Callable[[
    Dict[str, str]], Tuple[str, ...]]]]] = {'suggestion_template': {feconf.
    SUGGESTION_TYPE_TRANSLATE_CONTENT:
    '<li>The following %s translation suggestion was submitted for review %s ago:<br>%s</li><br>'
    , feconf.SUGGESTION_TYPE_ADD_QUESTION:
    '<li>The following question suggestion was submitted for review %s ago:<br>%s</li><br>'
    }, 'suggestion_template_values_getter_functions': {feconf.
    SUGGESTION_TYPE_TRANSLATE_CONTENT: lambda values_dict: (values_dict[
    'language'], values_dict['review_wait_time'], values_dict[
    'suggestion_content']), feconf.SUGGESTION_TYPE_ADD_QUESTION: lambda
    values_dict: (values_dict['review_wait_time'], values_dict[
    'suggestion_content'])}}
ADMIN_NOTIFICATION_FOR_REVIEWER_SHORTAGE_EMAIL_DATA: Dict[str, str] = {
    'email_body_template':
    'Hi %s,<br><br>In the <a href="%s%s#/roles">admin roles page,</a> please add reviewers to the Contributor Dashboard community by entering their username(s) and allow reviewing for the suggestion types that need more reviewers bolded below.<br><br>%sThanks so much - we appreciate your help!<br><br>Best Wishes!<br>- The Oppia Contributor Dashboard Team'
    , 'email_subject': 'Reviewers Needed for Contributor Dashboard',
    'one_language_template':
    'There have been <b>%s translation suggestions</b> created on the <a href="%s%s">Contributor Dashboard page</a> where there are not enough reviewers.<br><br>'
    , 'multi_language_template':
    'There have been <b>translation suggestions</b> created on the <a href="%s%s">Contributor Dashboard page</a> in languages where there are not enough reviewers. The languages that need more reviewers are:<br><ul>%s</ul><br>'
    , 'question_template': 
    'There have been <b>question suggestions</b> created on the <a href="%s%s">Contributor Dashboard page</a> where there are not enough reviewers.<br><br>'
...
ADMIN_NOTIFICATION_FOR_SUGGESTIONS_NEEDING_REVIEW_EMAIL_DATA: Dict[str, str
    ...
    'Hi %s,<br><br>There are suggestions on the <a href="%s%s">Contributor Dashboard</a> that have been waiting for more than %s days for review. Please take a look at the suggestions mentioned below and help them get reviewed by going to the <a href="%s%s">admin roles page</a> and either:<br><br><ul><li>Add more reviewers to the suggestion types that have suggestions waiting too long for a review</li><br><li>Find the existing reviewers and email reviewers directly about the suggestions waiting for a review</li><br></ul><br>Here are the suggestions that have been waiting too long for a review:<br><br><ul>%s</ul><br>Thanks so much - we appreciate your help!<br>Best Wishes!<br><br>- The Oppia Contributor Dashboard Team'
    , 'email_subject':
    'Contributor Dashboard Suggestions Have Been Waiting Too Long for Review'}
CONTRIBUTOR_RANK_ACHIEVEMENT_NOTIFICATION: Dict[str, Dict[str, Dict[str, str]]
    ] = {feconf.CONTRIBUTION_TYPE_TRANSLATION: {feconf.
    CONTRIBUTION_SUBTYPE_ACCEPTANCE: {'email_body_template':
    'Hi %s,<br><br>This is to let you know that you have successfully achieved the %s rank for submitting translations in %s. Your efforts help Oppia grow better every day and support students around the world.<br><br>You can check all the achievements you earned in the <a href="%s%s">Contributor Dashboard</a>.<br><br>Best wishes and we hope you can continue to contribute!<br><br>The Oppia Contributor Dashboard Team'
    , 'email_subject': 'Oppia Translator Rank Achievement!'}, feconf.
    CONTRIBUTION_SUBTYPE_REVIEW: {'email_body_template':
    ...
    feconf.CONTRIBUTION_SUBTYPE_EDIT: {'email_body_template':
    'Hi %s,<br><br>This is to let you know that you have successfully achieved the %s rank for correcting translations in %s. Your efforts help Oppia grow better every day and support students around the world.<br><br>You can check all the achievements you earned in the <a href="%s%s">Contributor Dashboard</a>.<br><br>Best wishes and we hope you can continue to contribute!<br><br>The Oppia Contributor Dashboard Team'
    , 'email_subject': 'Oppia Translation Reviewer Rank Achievement!'}},
    feconf.CONTRIBUTION_TYPE_QUESTION: {feconf.
    CONTRIBUTION_SUBTYPE_ACCEPTANCE: {'email_body_template':
    'Hi %s,<br><br>This is to let you know that you have successfully achieved the %s rank for submitting practice questions. Your efforts help Oppia grow better every day and support students around the world.<br><br>You can check all the achievements you earned in the <a href="%s%s">Contributor Dashboard</a>.<br><br>Best wishes and we hope you can continue to contribute!<br><br>The Oppia Contributor Dashboard Team'
    , 'email_subject': 'Oppia Question Submitter Rank Achievement!'},
    feconf.CONTRIBUTION_SUBTYPE_REVIEW: {'email_body_template':
    ...
    , 'email_subject': 'Oppia Question Reviewer Rank Achievement!'}, feconf
    .CONTRIBUTION_SUBTYPE_EDIT: {'email_body_template':
    'Hi %s,<br><br>This is to let you know that you have successfully achieved the %s rank for correcting practice questions. Your efforts help Oppia grow better every day and support students around the world.<br><br>You can check all the achievements you earned in the <a href="%s%s">Contributor Dashboard</a>.<br><br>Best wishes and we hope you can continue to contribute!<br><br>The Oppia Contributor Dashboard Team'
    , 'email_subject': 'Oppia Question Reviewer Rank Achievement!'}}}
SENDER_VALIDATORS: Dict[str, Union[bool, Callable[[str], bool]]] = {feconf.
    EMAIL_INTENT_SIGNUP: lambda x: x == feconf.SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_UNPUBLISH_EXPLORATION: user_services.is_moderator, feconf.
    EMAIL_INTENT_DAILY_BATCH: lambda x: x == feconf.SYSTEM_COMMITTER_ID,
    feconf.EMAIL_INTENT_EDITOR_ROLE_NOTIFICATION: lambda x: x == feconf.
    SYSTEM_COMMITTER_ID, feconf.EMAIL_INTENT_FEEDBACK_MESSAGE_NOTIFICATION:
    lambda x: x == feconf.SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_SUGGESTION_NOTIFICATION: lambda x: x == feconf.
    SYSTEM_COMMITTER_ID, feconf.EMAIL_INTENT_SUBSCRIPTION_NOTIFICATION: lambda
    x: x == feconf.SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_QUERY_STATUS_NOTIFICATION: lambda x: x == feconf.
    SYSTEM_COMMITTER_ID, feconf.EMAIL_INTENT_MARKETING: lambda x: x ==
    feconf.SYSTEM_COMMITTER_ID, feconf.EMAIL_INTENT_DELETE_EXPLORATION:
    user_services.is_moderator, feconf.EMAIL_INTENT_REPORT_BAD_CONTENT: lambda
    x: x == feconf.SYSTEM_COMMITTER_ID, feconf.EMAIL_INTENT_ONBOARD_CD_USER:
    lambda x: x == feconf.SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_REMOVE_CD_USER: lambda x: x == feconf.SYSTEM_COMMITTER_ID,
    feconf.EMAIL_INTENT_REVIEW_CREATOR_DASHBOARD_SUGGESTIONS: lambda x: x ==
    feconf.SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_NOTIFY_CURRICULUM_ADMINS_CHAPTERS: lambda x: x == feconf.
    SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_ADDRESS_CONTRIBUTOR_DASHBOARD_SUGGESTIONS: lambda x: x ==
    feconf.SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_REVIEW_CONTRIBUTOR_DASHBOARD_SUGGESTIONS: lambda x: x ==
    feconf.SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_NOTIFY_CONTRIBUTOR_DASHBOARD_ACHIEVEMENTS: lambda x: x ==
    feconf.SYSTEM_COMMITTER_ID, feconf.
    EMAIL_INTENT_ADD_CONTRIBUTOR_DASHBOARD_REVIEWERS: lambda x: x == feconf
    .SYSTEM_COMMITTER_ID, feconf.EMAIL_INTENT_ACCOUNT_DELETED: lambda x: x ==
    feconf.SYSTEM_COMMITTER_ID, feconf.BULK_EMAIL_INTENT_MARKETING: lambda
    x: x == feconf.SYSTEM_COMMITTER_ID, feconf.
    BULK_EMAIL_INTENT_IMPROVE_EXPLORATION: user_services.
    is_curriculum_admin, feconf.BULK_EMAIL_INTENT_CREATE_EXPLORATION:
    user_services.is_curriculum_admin, feconf.
    BULK_EMAIL_INTENT_CREATOR_REENGAGEMENT: lambda x: x == feconf.
    SYSTEM_COMMITTER_ID, feconf.BULK_EMAIL_INTENT_LEARNER_REENGAGEMENT: lambda
    x: x == feconf.SYSTEM_COMMITTER_ID, feconf.BULK_EMAIL_INTENT_TEST: lambda
    x: x == feconf.SYSTEM_COMMITTER_ID}
...
def require_sender_id_is_valid(intent: str, sender_id: str) ->None:
    ...
    if not sender_validator_fn(sender_id):
        logging.error("Invalid sender_id %s for email with intent '%s'" % (
            sender_id, intent))
        raise Exception("Invalid sender_id for email with intent '%s'" % intent
            )


def _send_email(recipient_id: str, sender_id: str, intent: str,
    email_subject: str, email_html_body: str, sender_email: str, bcc_admin:
    bool=False, sender_name: Optional[str]=None, recipient_email: Optional[
    str]=None) ->None:
    ...
    if sender_name is None:
        email_sender_name = (platform_parameter_services.
...
"""
    ...
    if email_models.SentEmailModel.check_duplicate_message(recipient_id,
...
def _send_bulk_mail(recipient_ids: List[str], sender_id: str, intent: str,
    email_subject: str, email_html_body: str, sender_email: str,
    sender_name: str, instance_id: str) ->None:
...
def send_dummy_mail_to_admin(username: str) ->None:
    ...
    system_name_email = '%s <%s>' % (feconf.SYSTEM_EMAIL_NAME, feconf.
        SYSTEM_EMAIL_ADDRESS)
    email_services.send_mail(system_name_email, feconf.ADMIN_EMAIL_ADDRESS,
...
def send_post_signup_email(user_id: str, test_for_duplicate_email: bool=False
    ) ->None:
    ...
    """
    email_subject_content_param_name = (platform_parameter_list.ParamName.
        SIGNUP_EMAIL_SUBJECT_CONTENT.value)
    email_subject_content = (platform_parameter_services.
        get_platform_parameter_value(email_subject_content_param_name))
    assert isinstance(email_subject_content, str)
    email_body_content_param_name = (platform_parameter_list.ParamName.
        SIGNUP_EMAIL_BODY_CONTENT.value)
    email_body_content = (platform_parameter_services.
        get_platform_parameter_value(email_body_content_param_name))
    assert isinstance(email_body_content, str)
    if not test_for_duplicate_email:
        email_subject_content_default_value = (platform_parameter_registry.
            Registry.get_platform_parameter(
            email_subject_content_param_name).default_value)
        email_body_content_default_value = (platform_parameter_registry.
            Registry.get_platform_parameter(email_body_content_param_name).
            default_value)
        if not len(email_subject_content
            ) or email_subject_content_default_value == email_subject_content:
            logging.error(
                'Please ensure that the value for the admin platform property SIGNUP_EMAIL_SUBJECT_CONTENT is set, before allowing post-signup emails to be sent.'
                )
            return
        if not len(email_body_content
            ) or email_body_content_default_value == email_body_content:
            logging.error(
                'Please ensure that the value for the admin platform property SIGNUP_EMAIL_BODY_CONTENT is set, before allowing post-signup emails to be sent.'
                )
            return
    ...
    email_body = 'Hi %s,<br><br>%s<br><br>%s' % (recipient_username,
        email_body_content, email_footer)
    _send_email(user_id, feconf.SYSTEM_COMMITTER_ID, feconf.
        EMAIL_INTENT_SIGNUP, email_subject_content, email_body, feconf.
...
def get_moderator_unpublish_exploration_email() ->str:
    ...
    try:
        ...
        return ''
    unpublish_exp_email_html_body = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
...
def require_moderator_email_prereqs_are_satisfied() ->None:
    ...
    if not server_can_send_emails:
        raise utils.ValidationError(
            'For moderator emails to be sent, please ensure that SERVER_CAN_SEND_EMAILS is set to True.'
            )


def send_moderator_action_email(sender_id: str, recipient_id: str, intent:
    str, exploration_title: str, email_body: str) ->None:
    ...
    full_email_content = '%s<br><br>%s<br><br>%s<br><br>%s' % (
        email_salutation_html, email_body, email_signoff_html, email_footer)
    _send_email(recipient_id, sender_id, intent, email_subject,
        full_email_content, feconf.SYSTEM_EMAIL_ADDRESS, bcc_admin=True)


def send_role_notification_email(inviter_id: str, recipient_id: str,
    recipient_role: str, exploration_id: str, exploration_title: str) ->None:
    ...
    email_body_template = (
        'Hi %s,<br><br><b>%s</b> has granted you %s to their exploration, "<a href="https://www.oppia.org/create/%s">%s</a>", on Oppia.org.<br><br>This allows you to:<br><ul>%s</ul>You can find the exploration <a href="https://www.oppia.org/create/%s">here</a>.<br><br>Thanks, and happy collaborating!<br><br>Best wishes,<br>The Oppia Team<br><br>%s'
        )
    server_can_send_emails = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
        SERVER_CAN_SEND_EMAILS.value))
    ...
    email_footer = platform_parameter_services.get_platform_parameter_value(
        platform_parameter_list.ParamName.EMAIL_FOOTER.value)
    email_body = email_body_template % (recipient_username,
        inviter_username, role_description, exploration_id,
        exploration_title, rights_html, exploration_id, email_footer)
    _send_email(recipient_id, feconf.SYSTEM_COMMITTER_ID, feconf.
        EMAIL_INTENT_EDITOR_ROLE_NOTIFICATION, email_subject, email_body,
        feconf.NOREPLY_EMAIL_ADDRESS, sender_name=inviter_username)


def send_emails_to_subscribers(creator_id: str, exploration_id: str,
    ...
    email_body_template = (
        'Hi %s,<br><br>%s has published a new exploration! You can play it here: <a href="https://www.oppia.org/explore/%s">%s</a><br><br>Thanks, and happy learning!<br><br>Best wishes,<br>- The Oppia Team<br><br>%s'
        )
    server_can_send_emails = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
        SERVER_CAN_SEND_EMAILS.value))
    ...
    for index, username in enumerate(recipients_usernames):
        if recipients_preferences[index].can_receive_subscription_email:
            email_footer = (platform_parameter_services.
                get_platform_parameter_value(platform_parameter_list.
                ParamName.EMAIL_FOOTER.value))
            email_body = email_body_template % (username, creator_name,
                exploration_id, exploration_title, email_footer)
            _send_email(recipient_list[index], feconf.SYSTEM_COMMITTER_ID,
                feconf.EMAIL_INTENT_SUBSCRIPTION_NOTIFICATION,
                email_subject, email_body, feconf.NOREPLY_EMAIL_ADDRESS)


def send_feedback_message_email(recipient_id: str, feedback_messages: Dict[
    str, FeedbackMessagesDict]) ->None:
    ...
    email_body_template = (
        'Hi %s,<br><br>You\'ve received %s new message%s on your Oppia explorations:<br><ul>%s</ul>You can view and reply to your messages from your <a href="https://www.oppia.org/creator-dashboard">dashboard</a>.<br><br>Thanks, and happy teaching!<br><br>Best wishes,<br>The Oppia Team<br><br>%s'
        )
    server_can_send_emails = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
        SERVER_CAN_SEND_EMAILS.value))
    ...
    for exp_id, reference in feedback_messages.items():
        messages_html += (
            '<li><a href="https://www.oppia.org/create/%s#/feedback">%s</a>:<br><ul>'
             % (exp_id, reference['title']))
        for message in reference['messages']:
            messages_html += '<li>%s<br></li>' % message
            count_messages += 1
        messages_html += '</ul></li>'
    email_subject = email_subject_template % ((count_messages, 's') if 
        count_messages > 1 else ('a', ''))
    email_footer = platform_parameter_services.get_platform_parameter_value(
        platform_parameter_list.ParamName.EMAIL_FOOTER.value)
    email_body = email_body_template % (recipient_username, count_messages if
        count_messages > 1 else 'a', 's' if count_messages > 1 else '',
        messages_html, email_footer)
    _send_email(recipient_id, feconf.SYSTEM_COMMITTER_ID, feconf.
        EMAIL_INTENT_FEEDBACK_MESSAGE_NOTIFICATION, email_subject,
        email_body, feconf.NOREPLY_EMAIL_ADDRESS)


def can_users_receive_thread_email(recipient_ids: List[str], exploration_id:
    str, has_suggestion: bool) ->List[bool]:
    ...
    users_exploration_prefs = (user_services.
        get_users_email_preferences_for_exploration(recipient_ids,
        exploration_id))
    ...
    if has_suggestion:
        for user_global_prefs, user_exploration_prefs in zipped_preferences:
            result.append(user_global_prefs.
                can_receive_feedback_message_email and not
                user_exploration_prefs.mute_suggestion_notifications)
    else:
        for user_global_prefs, user_exploration_prefs in zipped_preferences:
            result.append(user_global_prefs.
                can_receive_feedback_message_email and not
                user_exploration_prefs.mute_feedback_notifications)
    return result


def send_suggestion_email(exploration_title: str, exploration_id: str,
    author_id: str, recipient_list: List[str]) ->None:
    ...
    can_users_receive_email = can_users_receive_thread_email(recipient_list,
        exploration_id, True)
    email_footer = platform_parameter_services.get_platform_parameter_value(
        platform_parameter_list.ParamName.EMAIL_FOOTER.value)
    for index, recipient_id in enumerate(recipient_list):
        ...
        if can_users_receive_email[index]:
            email_body = email_body_template % (recipient_username,
                author_username, exploration_id, exploration_title,
                exploration_id, email_footer)
            _send_email(recipient_id, feconf.SYSTEM_COMMITTER_ID, feconf.
                EMAIL_INTENT_SUGGESTION_NOTIFICATION, email_subject,
                email_body, feconf.NOREPLY_EMAIL_ADDRESS)


def send_instant_feedback_message_email(recipient_id: str, sender_id: str,
    message: str, email_subject: str, exploration_title: str,
    exploration_id: str, thread_title: str) ->None:
    ...
    """
    email_body_template = (
        'Hi %s,<br><br>New update to thread "%s" on <a href="https://www.oppia.org/create/%s#/feedback">%s</a>:<br><ul><li>%s: %s<br></li></ul>(You received this message because you are a participant in this thread.)<br><br>Best wishes,<br>The Oppia team<br><br>%s'
        )
    server_can_send_emails = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
        SERVER_CAN_SEND_EMAILS.value))
    ...
    if recipient_preferences.can_receive_feedback_message_email:
        email_footer = (platform_parameter_services.
            ...
            EMAIL_FOOTER.value))
        email_body = email_body_template % (recipient_username,
            thread_title, exploration_id, exploration_title,
            sender_username, message, email_footer)
        _send_email(recipient_id, feconf.SYSTEM_COMMITTER_ID, feconf.
            EMAIL_INTENT_FEEDBACK_MESSAGE_NOTIFICATION, email_subject,
            email_body, feconf.NOREPLY_EMAIL_ADDRESS)


def send_flag_exploration_email(exploration_title: str, exploration_id: str,
    reporter_id: str, report_text: str) ->None:
    ...
    email_body_template = (
        'Hello Moderator,<br>%s has flagged exploration "%s" on the following grounds: <br>%s .<br>You can modify the exploration by clicking <a href="https://www.oppia.org/create/%s">here</a>.<br><br>Thanks!<br>- The Oppia Team<br><br>%s'
        )
    server_can_send_emails = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
        SERVER_CAN_SEND_EMAILS.value))
    ...
    email_footer = platform_parameter_services.get_platform_parameter_value(
        platform_parameter_list.ParamName.EMAIL_FOOTER.value)
    email_body = email_body_template % (reporter_username,
        exploration_title, report_text, exploration_id, email_footer)
    recipient_list = user_services.get_user_ids_by_role(feconf.
        ROLE_ID_MODERATOR)
    for recipient_id in recipient_list:
        _send_email(recipient_id, feconf.SYSTEM_COMMITTER_ID, feconf.
            EMAIL_INTENT_REPORT_BAD_CONTENT, email_subject, email_body,
...
def send_query_completion_email(recipient_id: str, query_id: str) ->None:
    ...
    email_body_template = (
        'Hi %s,<br>Your query with id %s has succesfully completed its execution. Visit the result page <a href="https://www.oppia.org/emaildashboardresult/%s">here</a> to see result of your query.<br><br>Thanks!<br><br>Best wishes,<br>The Oppia Team<br><br>%s'
        )
    recipient_username = user_services.get_username(recipient_id)
    email_footer = platform_parameter_services.get_platform_parameter_value(
        platform_parameter_list.ParamName.EMAIL_FOOTER.value)
    email_body = email_body_template % (recipient_username, query_id,
        query_id, email_footer)
    _send_email(recipient_id, feconf.SYSTEM_COMMITTER_ID, feconf.
        EMAIL_INTENT_QUERY_STATUS_NOTIFICATION, email_subject, email_body,
        feconf.NOREPLY_EMAIL_ADDRESS)


def send_query_failure_email(recipient_id: str, query_id: str, query_params:
    Dict[str, str]) ->None:
...
def send_user_query_email(sender_id: str, recipient_ids: List[str],
    email_subject: str, email_body: str, email_intent: str) ->str:
...
def send_test_email_for_bulk_emails(tester_id: str, email_subject: str,
    email_body: str) ->None:
    ...
    _send_email(tester_id, feconf.SYSTEM_COMMITTER_ID, feconf.
        BULK_EMAIL_INTENT_TEST, email_subject, email_body, tester_email,
        sender_name=tester_name)


def send_mail_to_onboard_new_reviewers(recipient_id: str, category: str
    ) ->None:
    ...
    if not server_can_send_emails:
        ...
        return
    recipient_username = user_services.get_username(recipient_id)
    can_user_receive_email = user_services.get_email_preferences(recipient_id
        ).can_receive_email_updates
    if can_user_receive_email:
        email_footer = (platform_parameter_services.
            get_platform_parameter_value(platform_parameter_list.ParamName.
            EMAIL_FOOTER.value))
        email_body = email_body_template % (recipient_username, category,
            category, email_footer)
        _send_email(recipient_id, feconf.SYSTEM_COMMITTER_ID, feconf.
            EMAIL_INTENT_ONBOARD_CD_USER, email_subject, email_body, feconf
            .NOREPLY_EMAIL_ADDRESS)


def send_mail_to_notify_users_to_review(recipient_id: str, category: str
    ) ->None:
...
def _create_html_for_reviewable_suggestion_email_info(
    reviewable_suggestion_email_info: suggestion_registry.
    ReviewableSuggestionEmailInfo) ->str:
    ...
    suggestion_review_wait_time = get_current_datetime_utc(
        ) - reviewable_suggestion_email_info.submission_datetime
    human_readable_review_wait_time = (utils.
        create_string_from_largest_unit_in_timedelta(
        suggestion_review_wait_time))
    values_to_populate_suggestion_template_dict = {'language': language,
        'review_wait_time': human_readable_review_wait_time,
        'suggestion_content': reviewable_suggestion_email_info.
        suggestion_content}
    ...
    suggestion_template = HTML_FOR_SUGGESTION_DESCRIPTION['suggestion_template'
        ][reviewable_suggestion_email_info.suggestion_type]
    assert isinstance(suggestion_template, str)
    return suggestion_template % get_values_to_populate_suggestion_template(
        values_to_populate_suggestion_template_dict)


def send_mail_to_notify_admins_suggestions_waiting_long(admin_ids: List[str
    ], translation_admin_ids: List[str], question_admin_ids: List[str],
    reviewable_suggestion_email_infos: List[suggestion_registry.
    ReviewableSuggestionEmailInfo]) ->None:
    ...
    if not platform_parameter_services.get_platform_parameter_value(
        ...
        logging.error(
            'The "notify_admins_suggestions_waiting_too_long" property must be enabled on the admin config page in order to send admins the emails.'
            )
        return
    if not reviewable_suggestion_email_infos:
        logging.info(
            'There were no Contributor Dashboard suggestions that were waiting too long for a review.'
            )
        return
    if not admin_ids:
    ...
    if list_of_translation_suggestion_descriptions:
        ...
        _send_suggestions_waiting_too_long_email(user_ids,
...
def _send_suggestions_waiting_too_long_email(admin_ids: List[str],
    list_of_suggestion_descriptions: str) ->None:
    ...
    curriculum_admin_usernames, admin_emails = list(zip(*[((
        admin_user_setting.username, admin_user_setting.email) if 
        admin_user_setting is not None else (None, None)) for
        admin_user_setting in admin_user_settings]))
    for index, admin_id in enumerate(admin_ids):
        if not admin_emails[index]:
            logging.error('There was no email for the given admin id: %s.' %
                admin_id)
            continue
        email_body = email_body_template % (curriculum_admin_usernames[
            index], feconf.OPPIA_SITE_URL, feconf.CONTRIBUTOR_DASHBOARD_URL,
        ...
        _send_email(admin_id, feconf.SYSTEM_COMMITTER_ID, feconf.
            EMAIL_INTENT_ADDRESS_CONTRIBUTOR_DASHBOARD_SUGGESTIONS,
            email_subject, email_body, feconf.NOREPLY_EMAIL_ADDRESS,
            recipient_email=admin_emails[index])


def send_reviewer_notifications(reviewer_ids_by_language: DefaultDict[str,
    List[str]], suggestions_by_language: DefaultDict[str, List[
    ...
    for language_code, suggestions in suggestions_by_language.items():
        ...
        for reviewer_id in reviewer_ids:
            ...
            email_body = email_body_template % (reviewer_username, feconf.
                OPPIA_SITE_URL, feconf.CONTRIBUTOR_DASHBOARD_URL, ''.join(
                suggestion_descriptions))
            reviewer_email = user_services.get_email_from_user_id(reviewer_id)
            _send_email(reviewer_id, feconf.SYSTEM_COMMITTER_ID, feconf.
                EMAIL_INTENT_ADDRESS_CONTRIBUTOR_DASHBOARD_SUGGESTIONS,
                email_subject, email_body, feconf.NOREPLY_EMAIL_ADDRESS,
                recipient_email=reviewer_email)


def send_mail_to_notify_admins_that_reviewers_are_needed(admin_ids: List[
    str], translation_admin_ids: List[str], question_admin_ids: List[str],
    suggestion_types_needing_reviewers: Dict[str, Set[str]]) ->None:
    ...
    if not platform_parameter_services.get_platform_parameter_value(
        ...
        logging.error(
            'The "enable_admin_notifications_for_reviewer_shortage" property must be enabled on the admin config page in order to send admins the emails.'
            )
        return
    if not suggestion_types_needing_reviewers:
        logging.info(
            'There were no suggestion types that needed more reviewers on the Contributor Dashboard.'
            )
        return
    if not admin_ids:
        logging.error('There were no admins to notify.')
    ...
    if (feconf.SUGGESTION_TYPE_TRANSLATE_CONTENT in
        ...
        if len(language_codes_that_need_reviewers) == 1:
            translation_suggestions_needing_reviewers_paragraphs.append(
                ...
                'one_language_template'] % (utils.
                get_supported_audio_language_description(
                language_codes_that_need_reviewers.pop()), feconf.
                OPPIA_SITE_URL, feconf.CONTRIBUTOR_DASHBOARD_URL))
        else:
            html_for_languages_that_need_more_reviewers = ''.join([(
                '<li><b>%s</b></li><br>' % utils.
                get_supported_audio_language_description(language_code)) for
                language_code in sorted(language_codes_that_need_reviewers)])
            translation_suggestions_needing_reviewers_paragraphs.append(
                ADMIN_NOTIFICATION_FOR_REVIEWER_SHORTAGE_EMAIL_DATA[
                'multi_language_template'] % (feconf.OPPIA_SITE_URL, feconf
        ...
        user_ids.extend(admin_ids)
        user_ids.extend(translation_admin_ids)
        _send_reviews_needed_email_to_admins(user_ids,
...
def _send_reviews_needed_email_to_admins(admin_ids: List[str],
    suggestions_needing_reviewers_html: str) ->None:
    ...
    for index, admin_id in enumerate(admin_ids):
        if not admin_emails[index]:
            ...
            continue
        email_body = email_body_template % (curriculum_admin_usernames[
            index], feconf.OPPIA_SITE_URL, feconf.ADMIN_URL,
            suggestions_needing_reviewers_html)
        _send_email(admin_id, feconf.SYSTEM_COMMITTER_ID, feconf.
            EMAIL_INTENT_ADD_CONTRIBUTOR_DASHBOARD_REVIEWERS, email_subject,
            email_body, feconf.NOREPLY_EMAIL_ADDRESS, recipient_email=
            admin_emails[index])


def send_mail_to_notify_contributor_dashboard_reviewers(reviewer_ids: List[
    str], reviewers_suggestion_email_infos: List[List[suggestion_registry.
    ReviewableSuggestionEmailInfo]]) ->None:
    ...
    if not platform_parameter_services.get_platform_parameter_value(
        ...
        logging.error(
            'The "contributor_dashboard_reviewer_emails_is_enabled" property must be enabled on the platform parameters tab on the admin page in order to send reviewers the emails.'
            )
        return
    if not reviewer_ids:
    ...
    reviewer_usernames, reviewer_emails = list(zip(*[((
        reviewer_user_setting.username, reviewer_user_setting.email) if 
        reviewer_user_setting is not None else (None, None)) for
        reviewer_user_setting in reviewer_user_settings]))
    email_footer = platform_parameter_services.get_platform_parameter_value(
        platform_parameter_list.ParamName.EMAIL_FOOTER.value)
    for index, reviewer_id in enumerate(reviewer_ids):
        if not reviewers_suggestion_email_infos[index]:
            logging.info(
                'There were no suggestions to recommend to the reviewer with user id: %s.'
                 % reviewer_id)
            continue
        ...
        email_body = email_body_template % (reviewer_usernames[index],
            feconf.OPPIA_SITE_URL, feconf.CONTRIBUTOR_DASHBOARD_URL, ''.
            join(suggestion_descriptions), email_footer)
        _send_email(reviewer_id, feconf.SYSTEM_COMMITTER_ID, feconf.
...
def send_mail_to_notify_contributor_ranking_achievement(
    contributor_ranking_email_info: suggestion_registry.
    ContributorMilestoneEmailInfo) ->None:
    ...
    if can_user_receive_email:
        ...
        email_body = ''
        if (contributor_ranking_email_info.contribution_type == feconf.
            ...
            email_body = email_template['email_body_template'] % (
                recipient_username, contributor_ranking_email_info.
                rank_name, language, feconf.OPPIA_SITE_URL, feconf.
                CONTRIBUTOR_DASHBOARD_URL)
        else:
            email_body = email_template['email_body_template'] % (
                recipient_username, contributor_ranking_email_info.
                rank_name, feconf.OPPIA_SITE_URL, feconf.
                CONTRIBUTOR_DASHBOARD_URL)
        _send_email(contributor_ranking_email_info.contributor_user_id,
            feconf.SYSTEM_COMMITTER_ID, feconf.
            EMAIL_INTENT_NOTIFY_CONTRIBUTOR_DASHBOARD_ACHIEVEMENTS,
            email_template['email_subject'], email_body, feconf.
            NOREPLY_EMAIL_ADDRESS)


def send_reminder_mail_to_notify_curriculum_admins(curriculum_admin_ids:
    List[str], chapter_notifications_list: List[story_domain.
    StoryPublicationTimeliness]) ->None:
    ...
    for overdue_story in chapter_notifications_list:
        ...
        story_link = '%s%s/%s' % (str(feconf.OPPIA_SITE_URL), str(feconf.
            STORY_EDITOR_URL_PREFIX), overdue_story.id)
        story_html = '<li>%s (%s) - <a href="%s">Link</a><ul>' % (overdue_story
            .story_name, overdue_story.topic_name, story_link)
    ...
    for upcoming_story in chapter_notifications_list:
        ...
        story_link = '%s%s/%s' % (str(feconf.OPPIA_SITE_URL), str(feconf.
            STORY_EDITOR_URL_PREFIX), upcoming_story.id)
        story_html = '<li>%s (%s) - <a href="%s">Link</a><ul>' % (
            upcoming_story.story_name, upcoming_story.topic_name, story_link)
    ...
    if chapters_are_overdue or chapters_are_upcoming:
        bulk_email_model_id = email_models.BulkEmailModel.get_new_id('')
        _send_bulk_mail(curriculum_admin_ids, feconf.SYSTEM_COMMITTER_ID,
            feconf.EMAIL_INTENT_NOTIFY_CURRICULUM_ADMINS_CHAPTERS,
            email_subject, email_body, feconf.NOREPLY_EMAIL_ADDRESS, feconf
            .SYSTEM_EMAIL_NAME, bulk_email_model_id)
...
def send_account_deleted_email(user_id: str, user_email: str) ->None:
    ...
    email_body_template = (
        'Hi %s,<br><br>Your account was successfully deleted.<br><br>- The Oppia Team'
        )
    server_can_send_emails = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
        SERVER_CAN_SEND_EMAILS.value))
    ...
    _send_email(user_id, feconf.SYSTEM_COMMITTER_ID, feconf.
        EMAIL_INTENT_ACCOUNT_DELETED, email_subject, email_body, feconf.
...
def send_account_deletion_failed_email(user_id: str, user_email: str) ->None:
    ...
    email_body_template = (
        "The Wipeout process failed for the user with ID '%s' and email '%s'."
         % (user_id, user_email))
    send_mail_to_admin(email_subject, email_body_template)


def send_email_to_new_cd_user(recipient_id: str, category: str,
    ...
    email_subject = 'You have been invited to %s Oppia %s' % (category_data
        ['task'], category_data['category'])
    if category in [constants.CD_USER_RIGHTS_CATEGORY_REVIEW_TRANSLATION]:
        ...
        category_description = category_data['description_template'
    ...
    if category in [constants.CD_USER_RIGHTS_CATEGORY_REVIEW_TRANSLATION,
        ...
        email_body_template = (
            'Hi %s,<br><br>This is to let you know that the Oppia team has added you as a reviewer for %s. This allows you to %s.<br><br>You can check the %s waiting for review in the <a href="https://www.oppia.org/contributor-dashboard">Contributor Dashboard</a>.<br><br>Thanks, and happy contributing!<br><br>Best wishes,<br>The Oppia Community'
            )
        email_body = email_body_template % (recipient_username,
            category_description, rights_message, to_review)
    elif category in [constants.CD_USER_RIGHTS_CATEGORY_SUBMIT_QUESTION]:
        email_body_template = (
            'Hi %s,<br><br>This is to let you know that the Oppia team has added you as a contributor to %s for use in lessons.<br><br>You can now start to submit %s in the <a href="https://www.oppia.org/contributor-dashboard">Contributor Dashboard</a>.<br><br>Thanks, and happy contributing!<br><br>Best wishes,<br>The Oppia Community'
            )
        email_body = email_body_template % (recipient_username,
            rights_message, category_description)
    can_user_receive_email = user_services.get_email_preferences(recipient_id
        ).can_receive_email_updates
    if can_user_receive_email:
        _send_email(recipient_id, feconf.SYSTEM_COMMITTER_ID, feconf.
...
def send_email_to_removed_cd_user(user_id: str, category: str,
    language_code: Optional[str]=None) ->None:
    ...
    if category == constants.CD_USER_RIGHTS_CATEGORY_REVIEW_TRANSLATION:
        ...
        rights_message = category_data['rights_message']
    email_body_template = (
        'Hi %s,<br><br>The Oppia team has removed you from the %s. You won\'t be able to %s any more, but you can still contribute %ss through the <a href="https://www.oppia.org/contributor-dashboard">Contributor Dashboard</a>.<br><br>Thanks, and happy contributing!<br><br>Best wishes,<br>The Oppia Community'
        )
    server_can_send_emails = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
        SERVER_CAN_SEND_EMAILS.value))
    if not server_can_send_emails:
        ...
        return
    recipient_username = user_services.get_username(user_id)
    can_user_receive_email = user_services.get_email_preferences(user_id
        ).can_receive_email_updates
    if can_user_receive_email:
        email_body = email_body_template % (recipient_username,
            role_description, rights_message, category_data['category'])
        _send_email(user_id, feconf.SYSTEM_COMMITTER_ID, feconf.
            EMAIL_INTENT_REMOVE_CD_USER, email_subject, email_body, feconf.
            NOREPLY_EMAIL_ADDRESS)


def send_not_mergeable_change_list_to_admin_for_review(exp_id: str,
    frontend_version: int, backend_version: int, change_list_dict: Sequence
    [Mapping[str, change_domain.AcceptableChangeDictTypes]]) ->None:
    ...
    email_body_template = (
        'Hi Admin,<br><br>Some draft changes were rejected in exploration %s because the changes were conflicting and could not be saved. Please see the rejected change list below:<br>Discarded change list: %s <br><br>Frontend Version: %s<br>Backend Version: %s<br><br>Thanks!'
        )
    server_can_send_emails = (platform_parameter_services.
        get_platform_parameter_value(platform_parameter_list.ParamName.
        SERVER_CAN_SEND_EMAILS.value))
    if server_can_send_emails:
        email_body = email_body_template % (exp_id, change_list_dict,
