...
class IncompleteActivities(python_utils.OBJECT):
    ...
    def add_topic_id(self, topic_id):
        """Adds the topic id to the list of incomplete topic ids."""
        self.topic_ids.append(topic_id)

    def remove_topic_id(self, topic_id):
        """Removes the topic id from the list of incomplete topic
        ids.
        """
...
class CompletedActivities(python_utils.OBJECT):
    ...
    def add_topic_id(self, topic_id):
        """Adds the topic id to the list of completed topic ids."""
        self.topic_ids.append(topic_id)

    def remove_topic_id(self, topic_id):
        """Removes the topic id from the list of completed topic
        ids.
        """
        self.topic_ids.remove(topic_id)
