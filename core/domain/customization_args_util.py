...
def get_full_customization_args(
    ...
    """
    # Here we have used assert because we want to narrow down the type to dict,
    # to avoid the errors that was generated by MyPy while writing values to
    # Mapping object.
