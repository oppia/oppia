...
def convert_translatable_in_cust_args(
    ...
    Args:
        customization_args: dict. The customization dict. The keys are names
            ...
            single key, 'value', whose corresponding value is the value of
            the customization arg.
        ca_specs: list(dict). List of spec dictionaries.
    ...
    def find_translatable(
            customization_arg, ca_spec,
            content_id_prefix='custarg'):
        """Helper function that recursively traverses customization argument
        spec to locate any SubtitltedHtml or SubtitledUnicode objects.
    ...
    for ca_spec in ca_specs:
        customization_arg_spec_name = ca_spec['name']
