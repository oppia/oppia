...
def _get_user_settings_from_model(user_settings_model):
    ...
    return user_domain.UserSettings(
        ...
        preferred_text_language_code=(
            user_settings_model.preferred_text_language_code),
...
def update_preferred_text_language_code(
        user_id, preferred_text_language_code):
    """Updates preferred_text_language_code of user with given user_id.

    Args:
        user_id: str. The unique ID of the user.
        preferred_text_language_code: str. New text translation language 
            preference to set.
    """
    user_settings = get_user_settings(user_id, strict=True)
