...
USER_IDENTIFICATION_FOR_USER_BEING_DELETED = '[User being deleted]'
    ...
    for index, user_settings in enumerate(non_system_users_settings):
        if user_settings:
            usernames[non_system_user_indices[index]] = (
                ...
                else USER_IDENTIFICATION_FOR_USER_BEING_DELETED
            )
    ...
    for ind, user_settings in enumerate(users_settings):
        if user_settings is None:
            if strict:
                ...
                usernames.append(USER_IDENTIFICATION_FOR_USER_BEING_DELETED)
