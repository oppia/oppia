...
# TODO(#10178): Remove gae_id attribute from UserSettings class
...
class UserSettings(python_utils.OBJECT):
    ...
    def validate(self):
        ...
        # TODO(#10178): Remove check for gae_id attribute below
        # when feconf.ENABLE_USER_AUTH_MODEL flag has been set True.
...
def _save_user_settings(user_settings):
    ...
    # TODO(#10178): Remove gae_id attribute from user_settings_dict below
    # when feconf.ENABLE_USER_AUTH_MODEL flag has been set True.
    user_settings_dict = {
