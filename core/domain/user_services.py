...
def get_usernames_by_role(role: str) -> List[str]:
    ...
    TOPIC_IDS_WITH_TRANSLATION_REVIEWS = ['topic1', 'topic2', 'topic3']
    ...
    def load_stats_data() -> None:
        # TranslationSubmitterTotalContributionStatsModel models
        ...
        print("TranslationSubmitterTotalContributionStatsModel model created")

        # TranslationReviewerTotalContributionStatsModel models
        ...
        print("TranslationReviewerTotalContributionStatsModel created")
        ...
        print("QuestionSubmitterTotalContributionStatsModel created")


        # QuestionReviewerTotalContributionStatsModel models
        ...
        # create_new_user('reviewer1', 'reviewer@gmail.com')

        allow_user_to_review_translation_in_language(
            'reviewer', 'en')
        allow_user_to_review_translation_in_language(
            'reviewer', 'fr')
        allow_user_to_review_question('reviewer')
    load_stats_data()
