...
class ExplorationMetadataVersionHistory:
    """Class to represent an element of the version history list of the
    exploration metadata. The version history list of the exploration metadata
    is the list of exploration versions in which the metadata has been edited.

    Attributes:
        previously_edited_in_version: int. The version number of the
            exploration in which the metadata was previously edited.
        committer_id: str. The id of the user who committed the changes in the
            previously edited version.
    """

    def __init__(self, previously_edited_in_version, committer_id):
        """Initializes the ExplorationMetadataVersionHistory domain object.
    ...
    def to_dict(self):
        ...
        ExplorationMetadataVersionHistory domain object.

        Returns:
            dict. The dict representation of the
            ExplorationMetadataVersionHistory domain object.
        """
        return {
    ...
    def from_dict(cls, metadata_version_history_dict):
        """Returns an ExplorationMetadataVersionHistory domain object from a
        dict.

        Args:
            metadata_version_history_dict: dict. The dict representation of
                ExplorationMetadataVersionHistory object.

        Returns:
            ExplorationMetadataVersionHistory. The corresponding
            ExplorationMetadataVersionHistory domain object.
        """
        return cls(
            metadata_version_history_dict['previously_edited_in_version'],
            metadata_version_history_dict['committer_id']
        )
