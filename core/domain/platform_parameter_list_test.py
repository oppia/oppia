...
class ExistingPlatformParameterValidityTests(test_utils.GenericTestBase):
    ...
    EXPECTED_PARAM_NAMES = [
        ...
        ('high_bounce_rate_task_state_bounce_' 'rate_creation_threshold'),
        ('high_bounce_rate_task_state_bounce_rate_' 'obsoletion_threshold'),
        'mailchimp_audience_id',
        'mailchimp_username',
        'mailgun_domain_name',
        'max_number_of_suggestions_per_reviewer',
        'max_number_of_tags_assigned_to_blog_post',
        ('notify_admins_suggestions_waiting_too_long_' 'is_enabled'),
