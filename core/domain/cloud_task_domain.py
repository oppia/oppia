...
class VoiceoverRegenerationTaskMapping:
    ...
    def from_dict(
        ...
        """
        return cls(
            exploration_id=voiceover_regeneration_task_mapping_dict['exploration_id'],
            task_run_id=voiceover_regeneration_task_mapping_dict['task_run_id'],
            language_accent_to_content_status_map=(voiceover_regeneration_task_mapping_dict['language_accent_to_content_status_map']),
        )

    @classmethod
    def create_default_voiceover_regeneration_task_mapping(cls, exploration_id: str, task_run_id: str) -> VoiceoverRegenerationTaskMapping:
    ...
    def update_final_content_status_for_cloud_task_run(self, language_accent_code: str, failed_content_ids: List[str]) -> None:
    ...
    def add_language_accent_to_content_status_map(self, language_accent_code: str, content_id_list: List[str]) -> None:
        ...
        self.language_accent_to_content_status_map[language_accent_code] = content_status_map
