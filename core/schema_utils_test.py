...
VALIDATOR_SPECS: Dict[str, Dict[str, Any]] = {
    ...
    SCHEMA_TYPE_CUSTOM: {
        ...
        'has_expected_subtitled_content_length': {
            'max_value': {'type': SCHEMA_TYPE_INT}
        },
    },
}
...
class SchemaValidationUnitTests(test_utils.GenericTestBase):
    ...
    def test_schemas_are_correctly_validated(self) -> None:
        ...
        invalid_schemas_with_error_messages = [
            ...
            (
                {
                    ...
                    'items': {'type': 'unicode'},
                    'validators': [
                        {'id': 'has_length_at_most', 'max_value': 0}
                    ],
                },
                re.escape(
                    'Validation failed: is_at_least ({\'min_value\': 1}) for object 0'
                ),
            ),
            (
                {'type': 'dict', 'items': {'type': 'float'}},
                re.escape(
                    'Missing keys: {\'type\': \'dict\', \'items\': {\'type\': \'float\'}}'
                ),
            ),
            (
            ...
            (
                ...
                re.escape(
                    'Validation failed: is_at_least ({\'min_value\': 1}) for object -1'
                ),
            ),
            (
                {
                ...
                re.escape(
                    'Received invalid_mode which is not in the allowed range of choices: [\'none\', \'python\', \'coffeescript\']'
                ),
            ),
        ]
        ...
        valid_schemas: List[Dict[str, Any]] = [
            ...
            {'type': 'bool'},
            {
                'type': 'dict',
                'properties': [
                    {'name': 'str_property', 'schema': {'type': 'unicode'}}
                ],
            },
            {
                'type': 'variable_keys_dict',
    ...
    def test_is_search_query_string(self) -> None:
        ...
        double quotes.
        """
        is_search_query_string = schema_utils.get_validator(
    ...
    def test_is_valid_username_string(self) -> None:
        ...
        is_valid_username_string = schema_utils.get_validator(
    ...
    def test_has_expected_subtitled_content_length(self) -> None:
        ...
        given length.
        """
        has_expected_subtitled_content_length = schema_utils.get_validator(
            'has_expected_subtitled_content_length'
        )
    ...
    def test_has_unique_subtitled_contents(self) -> None:
        ...
        has_unique_subtitled_contents = schema_utils.get_validator(
            'has_unique_subtitled_contents'
        )
...
class SchemaNormalizationUnitTests(test_utils.GenericTestBase):
    ...
    def test_html_schema(self) -> None:
        ...
        invalid_values_with_error_messages = [
            (
                ...
                re.escape(
                    'Expected unicode HTML string, received [\'<script></script>\', \'<script></script>\']'
                ),
            )
        ]
        self.check_normalization(
    ...
    def test_dict_schema(self) -> None:
        ...
        invalid_values_with_error_messages = [
            ...
            (
                ...
                re.escape(
                    'Expected dict, received [\'unicodeListProp\', \'intProp\', \'dictProp\']'
                ),
            ),
    ...
    def test_object_dict_schema_with_validation_method_key(self) -> None:
        ...
        invalid_values_with_error_messages = [
            ({'arg_a': 'arbitary_argument_a'}, 'Missing arg_b in argument.')
        ]
    ...
    def test_normalizer_sanitize_url(self) -> None:
        ...
        self.assertEqual(
            ...
            sanitize_url(
                'https://www.web.com/<script type="text/javascript">alert(\'rm -rf\');</script>'
            ),
        )
