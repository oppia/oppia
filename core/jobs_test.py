...
class BaseMapReduceJobManagerForContinuousComputationsTests(
    ...
    def test_raise_error_with_get_continuous_computation_class(self):
        with self.assertRaisesRegexp(
            ...
            (
                # Access of private attribute OK because it is testing
                # structure by seeing whether or not the base class raises a
                # NotImplementedError for a specific method that cannot
                # be called otherwise.
