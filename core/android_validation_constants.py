...
VALID_INTERACTION_IDS = [
    'AlgebraicExpressionInput', 'Continue', 'DragAndDropSortInput', 'EndExploration',
    'FractionInput', 'ImageClickInput', 'ItemSelectionInput', 'MathEquationInput',
    'MultipleChoiceInput', 'NumericExpressionInput', 'NumericInput', 'NumberWithUnits',
    'RatioExpressionInput', 'TextInput'
]
