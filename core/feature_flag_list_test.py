...
FRONTEND_FEATURE_NAMES_PATH: Final = os.path.join(
    os.getcwd(), 'core/templates/domain/feature-flag', 'feature-status-summary.model.ts'
)
...
class FeatureFlagListTest(test_utils.GenericTestBase):
    ...
    def test_feature_flag_names_and_platform_parameter_names_are_unique(self) -> None:
        feature_flag_names = []
