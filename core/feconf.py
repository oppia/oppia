...
SAMPLE_AUTO_VOICEOVERS_DATA_DIR = os.path.join('assets', 'sample-autogenerated-voiceovers-for-dev')
...
RTE_EXTENSIONS_DIR = os.path.join(EXTENSIONS_DIR_PREFIX, 'extensions', 'rich_text_components')
RTE_EXTENSIONS_DEFINITIONS_PATH = os.path.join('assets', 'rich_text_components_definitions.ts')

OBJECT_TEMPLATES_DIR = os.path.join('extensions', 'objects', 'templates')

# Choose production templates folder when we are in production mode.
FRONTEND_TEMPLATES_DIR = os.path.join('webpack_bundles') if constants.DEV_MODE else os.path.join('build', 'webpack_bundles')
# To know more about AOT visit https://angular.io/guide/glossary#aot
FRONTEND_AOT_DIR = os.path.join('dist', 'oppia-angular') if constants.DEV_MODE else os.path.join('dist', 'oppia-angular-prod')
DEPENDENCIES_TEMPLATES_DIR = os.path.join(EXTENSIONS_DIR_PREFIX, 'extensions', 'dependencies')

VALUE_GENERATORS_DIR_FOR_JS = os.path.join('local_compiled_js', 'extensions', 'value_generators')
VALUE_GENERATORS_DIR = os.path.join('extensions', 'value_generators')

VISUALIZATIONS_DIR = os.path.join('extensions', 'visualizations')
VISUALIZATIONS_DIR_FOR_JS = os.path.join('local_compiled_js', 'extensions', 'visualizations')

OBJECT_DEFAULT_VALUES_EXTENSIONS_MODULE_PATH = os.path.join('objects', 'object_defaults.json')
RULES_DESCRIPTIONS_EXTENSIONS_MODULE_PATH = os.path.join('interactions', 'rule_templates.json')
HTML_FIELD_TYPES_TO_RULE_SPECS_EXTENSIONS_MODULE_PATH = os.path.join('interactions', 'html_field_types_to_rule_specs.json')
LEGACY_HTML_FIELD_TYPES_TO_RULE_SPECS_EXTENSIONS_MODULE_DIR = os.path.join('interactions', 'legacy_html_field_types_to_rule_specs_by_state_version')
...
MAX_CHARS_IN_BLOG_POST_URL = constants.MAX_CHARS_IN_BLOG_POST_TITLE + len('-') + constants.BLOG_POST_ID_LENGTH
...
# gating.
ENV_IS_OPPIA_ORG_PRODUCTION_SERVER = bool(os.environ.get('GOOGLE_CLOUD_PROJECT', 'dev-project-id') == 'oppiaserver')
...
EMAIL_INTENT_ADDRESS_CONTRIBUTOR_DASHBOARD_SUGGESTIONS = 'address_contributor_dashboard_suggestions'
EMAIL_INTENT_REVIEW_CREATOR_DASHBOARD_SUGGESTIONS = 'review_creator_dashboard_suggestions'
EMAIL_INTENT_REVIEW_CONTRIBUTOR_DASHBOARD_SUGGESTIONS = 'review_contributor_dashboard_suggestions'
...
EMAIL_INTENT_NOTIFY_CONTRIBUTOR_DASHBOARD_ACHIEVEMENTS = 'notify_contributor_dashboard_achievements'
...
def DEFAULT_SALUTATION_HTML_FN(recipient_username: str) -> str:
    return 'Hi %s,' % recipient_username


def DEFAULT_SIGNOFF_HTML_FN(sender_username: str) -> str:
    return 'Thanks!<br>%s (Oppia moderator)' % sender_username


def DEFAULT_EMAIL_SUBJECT_FN(exp_title: str) -> str:
    return 'Your Oppia exploration "%s" has been unpublished' % exp_title
...
TASK_URL_FEEDBACK_MESSAGE_EMAILS = '%s/email/batchfeedbackmessageemailhandler' % TASKQUEUE_URL_PREFIX
TASK_URL_FEEDBACK_STATUS_EMAILS = '%s/email/feedbackthreadstatuschangeemailhandler' % TASKQUEUE_URL_PREFIX
TASK_URL_FLAG_EXPLORATION_EMAILS = '%s/email/flagexplorationemailhandler' % TASKQUEUE_URL_PREFIX
TASK_URL_INSTANT_FEEDBACK_EMAILS = '%s/email/instantfeedbackmessageemailhandler' % TASKQUEUE_URL_PREFIX
TASK_URL_CONTRIBUTOR_DASHBOARD_ACHIEVEMENT_NOTIFICATION_EMAILS = '%s/email/contributordashboardachievementnotificationemailhandler' % (TASKQUEUE_URL_PREFIX)
TASK_URL_RETRY_FAILED_EMAIL = '%s/email/retryemailhandler' % TASKQUEUE_URL_PREFIX
...
LEARNER_DASHBOARD_TOPIC_AND_STORY_DATA_URL = '/learnerdashboardtopicsandstoriesprogresshandler/data'
LEARNER_COMPLETED_CHAPTERS_COUNT_DATA_URL = '/learnercompletedchapterscounthandler/data'
LEARNER_DASHBOARD_COLLECTION_DATA_URL = '/learnerdashboardcollectionsprogresshandler/data'
LEARNER_DASHBOARD_EXPLORATION_DATA_URL = '/learnerdashboardexplorationsprogresshandler/data'
...
TOPIC_ID_TO_DIAGNOSTIC_TEST_SKILL_IDS_HANDLER = '/topic_id_to_diagnostic_test_skill_ids_handler'
...
FLOAT_VERIFIER_REGEX = '^([-+]?\\d*\\.\\d+)$|^([-+]?(\\d*\\.?\\d+|\\d+\\.?\\d*)e[-+]?\\d*)$'
...
COLLECTION_RIGHTS_CHANGE_ALLOWED_COMMANDS: List[ValidCmdDict] = copy.deepcopy(COMMON_RIGHTS_ALLOWED_COMMANDS)
...
EXPLORATION_RIGHTS_CHANGE_ALLOWED_COMMANDS = copy.deepcopy(COMMON_RIGHTS_ALLOWED_COMMANDS)
