...
def check_dev_mode_is_true() -> None:
    ...
    """
    if constants.constants.DEV_MODE and os.getenv('SERVER_SOFTWARE'):
...
EXTENSIONS_DIR_PREFIX = 'build' if not constants.constants.DEV_MODE else ''
...
# Use canonical mapping for dev mode.
...
SUGGESTIONS_SORT_KEYS = [constants.constants.SUGGESTIONS_SORT_KEY_DATE]
