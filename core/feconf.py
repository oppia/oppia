...
OPPIA_PROJECT_ID = 'oppiaserver-backup-migration'
...
DATAFLOW_TEMP_LOCATION = 'gs://oppiaserver-backup-migration-beam-jobs-temp/'
DATAFLOW_STAGING_LOCATION = 'gs://oppiaserver-backup-migration-beam-jobs-staging/'
