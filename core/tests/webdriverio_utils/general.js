...
var CONSOLE_ERRORS_TO_FIX = [
  ...
  _.escapeRegExp(
    ...
    'http://localhost:8181/logout?redirect_url=/learner_groups_feature_' +
    'status_handler","ok":false,"name":"HttpErrorResponse"'
  ),
  ...
  _.escapeRegExp(
    'http://localhost:8181/dist/oppia-angular-prod/favicon.ico - Failed to ' +
    'load resource: the server responded with a status of 404 (Not Found)'),
