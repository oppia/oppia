...
var CollectionEditorPage = function() {
  this.addExistingExploration = async function(explorationId) {
    var addExplorationInput = await $('.protractor-test-add-exploration-input');
    ...
    var addExplorationButton = await $(
      '.protractor-test-add-exploration-button');
  ...
  this.setCommitMessage = async function(message) {
    var saveModal = await $('.protractor-test-save-modal');
    await waitFor.visibilityOf(
      saveModal, 'Save Modal takes too long to appear');
    var commitMessageInput = await $('.protractor-test-commit-message-input');
    await waitFor.elementToBeClickable(
  ...
  this.saveDraft = async function() {
    var saveDraftButton = await $('.protractor-test-save-draft-button');
    await waitFor.elementToBeClickable(
  ...
  this.closeSaveModal = async function() {
    var closeSaveModalButton = await $(
      '.protractor-test-close-save-modal-button');
    await waitFor.elementToBeClickable(
  ...
  this.publishCollection = async function() {
    var editorPublishButton = await $('.protractor-test-editor-publish-button');
    await waitFor.elementToBeClickable(
  ...
  this.setTitle = async function(title) {
    var editorTitleInput = await $(
      '.protractor-test-collection-editor-title-input');
  ...
  this.saveChanges = async function() {
    var saveChangesButton = await $(
      '.protractor-test-collection-save-changes-button');
    await waitFor.elementToBeClickable(
