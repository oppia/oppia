    ...
    async function (explorationTitle) {
      ...
      expect(
        await action.getText(
          ...
          explorationTitleInIncompleteSection
        )
      ).toMatch(explorationTitle);
    };
  ...
  this.navigateToCommunityLessonsAndCheckCompleteExplorations = async function (
    ...
    expect(
      await action.getText(
        ...
        explorationTitleInCompleteSection
      )
    ).toMatch(explorationTitle);
  };
    ...
    async function (collectionTitle) {
      ...
      expect(
        await action.getText(
          ...
          collectionTitleInIncompleteSection
        )
      ).toMatch(collectionTitle);
    };
  ...
  this.navigateToCommunityLessonsAndCheckCompleteCollections = async function (
    ...
    expect(
      await action.getText(
        ...
        collectionTitleInCompleteSection
      )
    ).toMatch(collectionTitle);
  };
};
