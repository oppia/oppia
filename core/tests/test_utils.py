...
def swap_get_platform_parameter_value_function(
    ...
    def mock_get_platform_parameter_value(
        ...
        if parameter_name not in platform_parameter_name_value_dict:
            raise Exception(
                'The value for the platform parameter %s was needed in this test, but not specified in the set_platform_parameters decorator. Please use this information in the decorator.'
                % parameter_name
            )
...
class AppEngineTestBase(TestBase):
    ...
    def mock_set_constants_to_default(self) -> None:
        ...
        """
        raise Exception(
            'Tests should mock common.set_constants_to_default() to avoid modifying the constants file during tests.'
        )
...
class GenericTestBase(AppEngineTestBase):
    ...
    VERSION_1_STORY_CONTENTS_DICT: Final = {
        'nodes': [
            {
                'outline': (
                    '<p>Value</p><oppia-noninteractive-math raw_latex-with-value="&amp;quot;+,-,-,+&amp;quot;"></oppia-noninteractive-math>'
                ),
                'exploration_id': None,
    ...
    VERSION_4_STORY_CONTENTS_DICT: Final = {
        'nodes': [
            {
                'outline': (
                    '<p>Value</p><oppia-noninteractive-math math_content-with-value="{&amp;quot;raw_latex&amp;quot;: &amp;quot;+,-,-,+&amp;quot;, &amp;quot;svg_filename&amp;quot;: &amp;quot;&amp;quot;}"></oppia-noninteractive-math>'
                ),
                'exploration_id': None,
                'destination_node_ids': [],
                'outline_is_finalized': False,
