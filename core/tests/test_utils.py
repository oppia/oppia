    ...
    def mock_search(
        ...
        if terms:
            ...
            for term in terms:
                    ...
                    # all terms in the 'must' clause had a 'query' key. This assumption worked 
                    # for 'multi_match' queries but failed for 'match_all' queries, 
                    # which do not have a 'query' key. This caused a KeyError when processing
