...
describe('Full exploration editor', function() {
  ...
  it('should correctly play autogenerated audio', function() {
    users.createUser('creator2@editorAndPlayer.com', 'creator2EditorAndPlayer');
    users.login('creator2@editorAndPlayer.com');
    workflow.createExploration();

    var CONTENT = 'This is a some content';
    var EXPLORATION_OBJECTIVE = 'Let us learn how to add fractions';
    explorationEditorMainTab.setContent(forms.toRichText(CONTENT));
    explorationEditorMainTab.setInteraction('EndExploration');
    explorationEditorMainTab.setContent(forms.toRichText(CONTENT));

    explorationEditorPage.navigateToSettingsTab();
    explorationEditorSettingsTab.setTitle('Fractions');
    explorationEditorSettingsTab.setCategory('Mathematics');
    explorationEditorSettingsTab.setObjective(EXPLORATION_OBJECTIVE);

    explorationEditorPage.saveChanges();
    workflow.publishExploration();
    libraryPage.get();
    libraryPage.findExploration('Fractions');
    libraryPage.playExploration('Fractions');

    explorationPlayerPage.clickExpandAudioButton();
    explorationPlayerPage.clickPlayAudioButton();
    explorationPlayerPage.clickPauseAudioButton();
  });
