...
module.exports = function(config) {
  config.set({
    ...
    files: [
      'compiled_js/core/tests/karma-globals.js',
      // Constants must be loaded before everything else.
      'compiled_js/assets/constants.js',
      'compiled_js/assets/rich_text_components_definitions.js',
    ...
    exclude: [
      'compiled_js/core/templates/dev/head/**/*-e2e.js',
      'compiled_js/extensions/**/protractor.js',
    ...
    preprocessors: {
      'compiled_js/core/templates/dev/head/!(*Spec).js': ['coverage'],
      'compiled_js/core/templates/dev/head/**/!(*Spec).js': ['coverage'],
      'compiled_js/extensions/!(*Spec).js': ['coverage'],
      'compiled_js/extensions/**/!(*Spec).js': ['coverage'],
