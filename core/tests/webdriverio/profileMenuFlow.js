...
describe('Profile menu flow', function () {
  ...
  beforeAll(async function () {
    ...
    await users.createUser(
      'desktopAndMobileVisitor@profileMenuFlow.com',
      VISITOR_USERNAME
    );
  });

  it(
    'should visit the topics and skills dashboard from the profile ' +
      'dropdown menu when user is admin',
    async function () {
      await users.createAndLoginCurriculumAdminUser(
        'desktopAndMobileAdm@profileMenuFlow.com',
        'desktopAndMobileAdm'
      );
  ...
  describe('profile dropdown menu', function () {
    ...
    it('should land on the learner dashboard after successful login', async function () {
      expect(await browser.getUrl()).toEqual(
        'http://localhost:8181/learner-dashboard'
      );
    });

    it('should visit the profile page from the profile dropdown menu', async function () {
    ...
    it('should visit the creator dashboard from the profile dropdown menu', async function () {
    ...
    it(
      'should not show the topics and skills dashboard link in the profile ' +
        'dropdown menu when user is not admin',
      async function () {
    ...
    it('should visit the preferences page from the profile dropdown menu', async function () {
