...
describe('screenreader and keyboard user accessibility features', function () {
  ...
  it('should navigate to the get-started page when ctrl+6 is pressed', async function () {
  ...
  it('should navigate to the community-library page when ctrl+1 is pressed', async function () {
    await browser.url('get-started');
    await waitFor.urlRedirection(GET_STARTED_URL);
    var oppiaContentContainer = $('.e2e-test-content-container');
    await waitFor.presenceOf(oppiaContentContainer, ERROR_MESSAGE);
  ...
  it('should navigate to the learner-dashboard page when ctrl+2 is pressed', async function () {
    await browser.url('get-started');
    await waitFor.urlRedirection(GET_STARTED_URL);
    var oppiaContentContainer = $('.e2e-test-content-container');
    await waitFor.presenceOf(oppiaContentContainer, ERROR_MESSAGE);
  ...
  it('should navigate to the creator-dashboard page when ctrl+3 is pressed', async function () {
    await browser.url('get-started');
    await waitFor.urlRedirection(GET_STARTED_URL);
    var oppiaContentContainer = $('.e2e-test-content-container');
    await waitFor.presenceOf(oppiaContentContainer, ERROR_MESSAGE);
  ...
  it('should navigate to about page when ctrl+4 is pressed', async function () {
    await browser.url('get-started');
    await waitFor.urlRedirection(GET_STARTED_URL);
    var oppiaContentContainer = $('.e2e-test-content-container');
    await waitFor.presenceOf(oppiaContentContainer, ERROR_MESSAGE);
  ...
  it('should navigate to the notifications page when ctrl+5 is pressed', async function () {
    await browser.url('get-started');
    await waitFor.urlRedirection(GET_STARTED_URL);
    var oppiaContentContainer = $('.e2e-test-content-container');
    await waitFor.presenceOf(oppiaContentContainer, ERROR_MESSAGE);
  ...
  it('should navigate to the preferences page when ctrl+5 is pressed', async function () {
    await browser.url('get-started');
    await waitFor.urlRedirection(GET_STARTED_URL);
    var oppiaContentContainer = $('.e2e-test-content-container');
    await waitFor.presenceOf(oppiaContentContainer, ERROR_MESSAGE);
  ...
  it('should test the action shortcuts in library page', async function () {
