...
describe('Learner dashboard functionality', function() {
  ...
  it('should display incomplete and completed collections', async function() {
    ...
    var firstExploration = browser.isMobile ? element.all(
      by.css('.protractor-test-mobile-collection-exploration'))[0] :
    ...
    if (browser.isMobile) {
      ...
      var playExploration = $('.protractor-test-play-exploration-button');
    ...
    if (!browser.conf.isMobile) {
      ...
      var collectionsTab = $('.protractor-test-collections-tab');
