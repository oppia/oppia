...
export class BaseUser {
  ...
  async waitForElementToBeClickable(
    ...
    // Ensure the element is visible before checking clickability.
    ...
    if (typeof selector === 'string') {
      ...
      element = (await this.page.$(selector)) as ElementHandle<Element>;
    } else {
      element = selector;
    }
    ...
    // Wait for element to be clickable in one attempt (no retry logic)
