...
const userFactory = require('../../../puppeteer-testing-utilities/user-factory.ts');
const testConstants = require('../../../puppeteer-testing-utilities/test-constants.ts');
...
describe('Logged-in User in About page', function () {
  ...
  it('About Page Screenshot', async function () {
