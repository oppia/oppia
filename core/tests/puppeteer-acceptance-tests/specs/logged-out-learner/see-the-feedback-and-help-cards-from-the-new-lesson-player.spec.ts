...
describe('Logged-Out Learner', function () {
  ...
  beforeAll(
    async function () {
      ...
      // Add this line to create env without doing manually.
      // await curriculumAdmin.page.waitForTimeout(7200000);
    },
  ...
  it('should be able to go forward by one card', async function () {
    await loggedOutLearner.clickOnElementWithText('Close');
    ...
    expect(loggedOutLearner.isContinueButtonPresent()).toBe(false);
    loggedOutLearner.expectScreenshotToMatch(
  ...
  it('should be able to get feedback on the incorrect answer', async function () {
    ...
    await loggedOutLearner.submitAnswerInTextArea('4');
  ...
  it('should be able to get a hint or a solution when the user gets stuck', async function () {
    await loggedOutLearner.submitAnswerInTextArea('ABC');
    await loggedOutLearner.page.waitForTimeout(10000);
