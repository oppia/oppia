...
/**
 * @fileoverview Acceptance Test for checking the site navigation.
 */
...
describe('Site Navigation', function () {
  ...
  it('should verify the navigation to the About page', async function () {
  ...
  it('should verify the navigation to the Get Started page', async function () {
  ...
  it('should verify the navigation to the Donate page', async function () {
  ...
  it('should verify the navigation to the Contact page', async function () {
