...
var clientSideRedirection = async function(action, check) {
  // Client side redirection which is known to cause "both angularJS testability
  ...
  // The action only triggers the redirection but donot waits for it to
