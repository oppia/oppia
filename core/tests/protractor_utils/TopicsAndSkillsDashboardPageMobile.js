...
var TopicsAndSkillsDashboardPage = function() {
  ...
  var createSkillButtonSecondary = element(
    by.css('.protractor-test-create-skill-button-secondary'));
  ...
  var skillsTable = element(by.css('.protractor-test-skills-table-mobile'));
  ...
  this.filterTopicsByKeyword = async function(keyword) {
    await action.click('Open Skill Fitler', openFilter);
