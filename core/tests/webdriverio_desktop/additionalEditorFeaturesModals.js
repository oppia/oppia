...
describe('Full exploration editor', function () {
  ...
  it('should show discard changes modal when the changes are conflicting', async function () {
  ...
  it('should show discard changes modal and allow downloading of lost changes', async function () {
