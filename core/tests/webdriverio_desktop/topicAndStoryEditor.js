...
describe('Topic editor functionality', function () {
  ...
  it('should edit story title, description and notes correctly', async function () {
...
describe('Chapter editor functionality', function () {
  ...
  it('should fail to add one more chapter with existing exploration', async function () {
    await storyEditorPage.createNewChapter(
      'Chapter 3',
      dummyExplorationIds[1],
      Constants.TEST_SVG_PATH
  ...
  it('should add one more chapter and change the chapters sequences', async function () {
    await storyEditorPage.createNewChapter(
      'Chapter 3',
      dummyExplorationIds[2],
      Constants.TEST_SVG_PATH
    );
  ...
  it('should add one prerequisite and acquired skill to chapter 1', async function () {
    await storyEditorPage.navigateToChapterWithName('Chapter 1');
  ...
  it(
    'should fail to add one prerequisite skill which is already added as' +
      ' acquired skill',
    async function () {
      await storyEditorPage.navigateToChapterWithName('Chapter 1');
      await storyEditorPage.addPrerequisiteSkill(dummySkills[0]);
