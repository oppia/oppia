...
describe('Preferences', function () {
  ...
  it('should load the correct dashboard according to selection', async function () {
  ...
  it('should navigate to account deletion page', async function () {
  ...
  it('should export account data', async function () {
