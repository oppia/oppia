...
var ContributorDashboardPage = require('../webdriverio_utils/ContributorDashboardPage.js');
var ContributorDashboardAdminPage = require('../webdriverio_utils/ContributorDashboardAdminPage.js');
...
describe('Contributor dashboard page', function () {
  ...
  it("should persist user's preferred translation language across sessions", async function () {
...
describe('Contributor dashboard admin page contribution rights form', () => {
  ...
  beforeAll(async function () {
    ...
    await users.createUser(
      translationReviewerEmail,
      translationReviewerUsername
    );
  ...
  it('should allow translation admin to add translation reviewer', async function () {
...
describe('Translation contribution featured languages', () => {
  ...
  beforeAll(async function () {
    ...
    contributorDashboardTranslateTextTab =
      contributorDashboardPage.getTranslateTextTab();
    await users.createAndLoginSuperAdminUser(
      'config@contributorDashboard.com',
  ...
  it('should show correct featured languages', async function () {
    ...
    await contributorDashboardTranslateTextTab.expectFeaturedLanguagesToBe(
      expectedFeaturedLanguages
    );
  });

  it('should show correct explanation', async function () {
    await contributorDashboardTranslateTextTab.mouseoverFeaturedLanguageTooltip(
      0
    );
    await contributorDashboardTranslateTextTab.expectFeaturedLanguageExplanationToBe(
