...
describe('Learner dashboard functionality', function () {
  ...
  it(
    ...
    async function () {
      ...
      await topicEditorPage.saveTopic(
        'Added meta tag and page title fragment.'
      );
      ...
      await learnerDashboardPage.expectNumberOfTopicsInContinueWhereYouLeftOff(
        0
      );
  ...
  it(
    'should display all the topics that are partially learnt or learnt ' +
