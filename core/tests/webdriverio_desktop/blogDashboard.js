...
describe('Blog dashboard functionality', function () {
  ...
  it(
    'should check user profile is visible on both blog dashboard and editor,' +
  ...
  it(
    'should create, publish, and delete the published blog post from' +
      ' dashboard.',
    async function () {
      await blogDashboardPage.createNewBlogPost();
  ...
  it(
    'should create, publish, check for thumbnail uploading error,' +
      ' unpublish and delete the blog post',
    async function () {
      await blogDashboardPage.createNewBlogPost();
      await blogDashboardPage.navigateToBlogDashboardPageWithBackButton();
      await blogDashboardPage.expectNumberOfDraftBlogPostsToBe(1);
  ...
  it(
    'should create multiple blog posts both published and drafts and' +
