...
describe('Embedding', function () {
  ...
  var createCountingExploration = async function () {
    ...
    await explorationEditorMainTab.addResponse(
      'NumericInput',
      await forms.toRichText('Describe solution!!'),
      null,
      false,
      'IsLessThanOrEqualTo',
      0
    ...
    await defaultResponseEditor.setDestination('Not 6', true, null);
  ...
  var EMBEDDING_ERRORS_TO_IGNORE = [
    'http://localhost:8181/assets/scripts/' +
      'embedding_tests_dev_i18n_0.0.1.html - Refused to display ' +
      "'http://localhost:8181/' in a frame because it set " +
  ...
  it('should use the url language as site language.', async function () {
