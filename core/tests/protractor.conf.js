...
var CHROME_DOWNLOAD_PATH = path.resolve(__dirname, Constants.CHROME_DOWNLOAD_PATH);
    ...
    'goog:chromeOptions': {
      ...
      prefs: {
        'download': {
            ...
            'default_directory': CHROME_DOWNLOAD_PATH,
        }
      },       
    },
    prefs: {
  ...
  onPrepare: function() {
    ...
    if (_ADD_SCREENSHOT_REPORTER) {
      ...
      jasmine.getEnv().addReporter(new HtmlScreenshotReporter({
        ...
        dest: path.resolve(__dirname, '../protractor-screenshots'),
