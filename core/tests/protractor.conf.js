...
exports.config = {
  ...
  suites: {
    full: ['protractor/*.js'],
    editor: ['protractor/editorAndPlayer.js','protractor/gadgetEditor.js','protractor/stateEditor.js'],
    usermanagement: ['protractor/userManagement.js'],
    misc: ['protractor/embedding.js','protractor/explorationRating.js','protractor/fallbacks.js','protractor/historyTab.js','protractor/interactions.js','protractor/preferences.js','protractor/privileges.js','protractor/publicationAndGallery.js','protractor/richTextComponents.js']
  },
