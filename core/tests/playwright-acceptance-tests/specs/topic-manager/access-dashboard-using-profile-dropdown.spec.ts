...
test.describe('Topic Manager', function () {
  ...
  test('should be able to access topic and skills dashboard using the profile menu', async function () {
    ...
    await topicManager.expectScreenshotToMatch('topicsAndSkillsDashboard');
  });

  test('should be able to view the topic with no rights', async function () {
  ...
  test('should be able to filter topics and skills', async function () {
