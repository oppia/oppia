...
/**
 * @fileoverview Acceptance tests for assigning and removing blog editor and admin roles.
 */
...
test.describe('Blog Admin', () => {
  ...
  test.beforeAll(async ({browser}) => {
    ...
    guest2 = new BlogPostEditor((guest2Base as unknown as LoggedInUser).page);
  ...
  test('should be able to assign blog editor and blog admin role', async () => {
    await admin.navigateToBlogAdminPage();
    await admin.expectScreenshotToMatch('blogAdminPage');
