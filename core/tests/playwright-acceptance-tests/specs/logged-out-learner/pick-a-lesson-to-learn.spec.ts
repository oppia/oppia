...
test.describe('Logged-Out Learner', function () {
  ...
  test.beforeAll(async function ({browser}) {
    test.setTimeout(700000); // Setup takes longer than default timeout.
  ...
  test('should be able to find a lesson to start learning', async function () {
  ...
  test('should be able to reach checkpoint', async function () {
