...
test.describe('Logged-Out Learner', function () {
  ...
  test('should be able to play/pause the audio', async function () {
    ...
    await loggedOutLearner.expectScreenshotToMatch('audioBar');
  });
  ...
  test('should be able to play audio till the end', async function () {
    await loggedOutLearner.startVoiceover();
