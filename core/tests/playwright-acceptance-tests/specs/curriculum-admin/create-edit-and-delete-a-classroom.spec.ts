...
test.describe('Curriculum Admin', function () {
  ...
  test('should be able to create a new classroom', async function () {
    await curriculumAdmin.createNewClassroom('Math', 'math');
    await curriculumAdmin.expectClassroomTileToBePresent('Math');
  });

  test('should be able to edit classroom information', async function () {
  ...
  test('should be able to publish classroom', async function () {
    await curriculumAdmin.publishClassroom('Math');
    await loggedOutUser.navigateToClassroomPage('math');
    await loggedOutUser.expectToBeOnClassroomPage('Math');
  });

  test('should be able to enable diagnostic test for a classroom', async function () {
  ...
  test('should be able to change order of classrooms', async function () {
  ...
  test('should be able to delete a classroom', async function () {
