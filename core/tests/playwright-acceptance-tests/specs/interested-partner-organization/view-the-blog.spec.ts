...
test.describe('Logged-out User', function () {
  ...
  test('should observe the welcome message and empty-state notice when no blog posts exist', async function () {
  ...
  test('should observe blogs with navigation', async function () {
  ...
  test('should paginate blog posts after the first 10 items', async function () {
  ...
  test('should display blog page with correct layout elements', async function () {
    await interestedPartnerOrg.navigateToBlogPageViaNavbar();

    await interestedPartnerOrg.expectBlogPageLayoutToBeCorrect();
  });

  test('should display blog post page with all required elements', async function () {
  ...
  test('should be able to search and filter blog posts', async function () {
    await interestedPartnerOrg.navigateToBlogPage();
