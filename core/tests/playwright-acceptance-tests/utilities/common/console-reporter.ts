 ...
 * certain console logs while running playwright tests.
 */
...
export class ConsoleReporter {
  ...
  /**
   * This function initializes tracking for the given page's console messages.
   */
  public static trackConsoleMessagesInPage(page: Page): void {
    page.on('console', async (message: PlaywrightConsoleMessage) => {
      ...
      // Sometimes the browser returns a JSHandle error so we have to parse
