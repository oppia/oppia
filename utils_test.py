...
class UtilsTests(test_utils.GenericTestBase):
    ...
    def test_get_hashable_value(self):
        ...
        test_set = set(get_hashable_value(json1))
        self.assertIn(get_hashable_value(json1_deepcopy), test_set)
        test_set.add(get_hashable_value(json2))
        self.assertEqual(test_set, {
            get_hashable_value(json1_deepcopy),
            get_hashable_value(json2_deepcopy),
        })
