...
class UtilsTests(test_utils.GenericTestBase):
    ...
    def test_vfs_get_directory_path_from_filepath(self):
        p = utils.vfs_get_directory_path_from_filepath('foo/image.png')
        self.assertEqual(p, 'foo')
        p = utils.vfs_get_directory_path_from_filepath('image.png')
        self.assertEqual(p, '')
        p = utils.vfs_get_directory_path_from_filepath('foo/bar/image.png')
        self.assertEqual(p, 'foo/bar')
