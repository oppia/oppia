...
(function () {
  ...
  CKEDITOR.BBCodeParser.prototype = {
    parse: function (a) {
      for (var b, c, k = 0; (b = this._.bbcPartsRegex.exec(a)); )
        if (
          ((c = b.index),
          c > k && ((k = a.substring(k, c)), this.onText(k, 1)),
          (k = this._.bbcPartsRegex.lastIndex),
          ...
          var e = l[c],
            ...
            h = {};
          b = b[2];
          if ('left' == c || 'right' == c || 'center' == c || 'justify' == c)
            b = c;
          if (b)
            if (
              ('list' == c &&
              ...
              var f = '',
                d = void 0;
              for (d in h) var u = (d + ':' + h[d]).replace(C, ';'), f = f + u;
              b.style = f;
            } else z[c] && (g[z[c]] = CKEDITOR.tools.htmlDecode(b));
  ...
  CKEDITOR.htmlParser.fragment.fromBBCode = function (a) {
      ...
      if (0 < h.length)
        for (var a = 0; a < h.length; a++) {
          var b = h[a],
            c = b.name,
            g = CKEDITOR.dtd[c],
            f = d.name && CKEDITOR.dtd[d.name];
          (f && !f[c]) ||
            (e && g && !g[e] && CKEDITOR.dtd[e]) ||
    ...
    var e = new CKEDITOR.BBCodeParser(),
      g = new CKEDITOR.htmlParser.fragment(),
      h = [],
      f = 0,
      d = g,
      u;
    e.onTagOpen = function (a, g) {
      var f = new CKEDITOR.htmlParser.element(a, g);
      if (CKEDITOR.dtd.$removeEmpty[a]) h.push(f);
      else {
        var w = d.name,
          p =
            w &&
    ...
    e.onTagClose = function (a) {
      ...
      if (g.type) {
        for (e = 0; e < b.length; e++) (a = b[e]), k(a, a.parent);
        d = g;
        k(g, g.parent);
        g == d && (d = d.parent);
        h = h.concat(c);
        ...
        c(),
          ...
          a.replace(/(\r\n|[\r\n])|[^\r\n]*/g, function (a, e) {
            if (void 0 !== e && e.length) f++;
              ...
              b != a.length &&
                k(new CKEDITOR.htmlParser.text(a.substring(b, a.length)), d);
            }
          });
    };
    for (
      e.parse(CKEDITOR.tools.htmlEncode(a));
      d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT;

    )
      (a = d.parent), k(d, a), (d = a);
    return g;
  };
        ...
        elements: {
          ...
          smiley: function (a) {
            ...
            var b = a.attributes.desc,
              ...
              h = CKEDITOR.tools.htmlEncode(c.smiley_path + h);
              ...
              if (d in x) d = x[d];
                ...
                if ((f = c.href))
                  -1 !== f.indexOf('mailto:')
                    ? ((d = 'email'),
                      (b.children = [
                        new CKEDITOR.htmlParser.text(f.replace('mailto:', '')),
                      ]),
                      (f = ''))
          ...
          'link' == e && 0 === b.getAttribute('href').indexOf('mailto:')
            ...
            : 'span' == k
              ? b.getStyle('font-size')
                ? (e = 'size')
                : b.getStyle('color') && (e = 'color')
              : 'div' == k && b.getStyle('text-align')
                ? (e = b.getStyle('text-align'))
                : 'img' == e &&
