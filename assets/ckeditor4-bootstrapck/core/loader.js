  ...
  CKEDITOR.loader = (function () {
    ...
    var scripts = {
      _bootstrap: [
        ...
        'style',
        'tools',
        /* The following are entries that we want to force loading at the end to avoid dependence recursion */ 'dom/comment',
        'dom/elementpath',
        'dom/text',
        'dom/rangelist',
        'skin',
    ...
    var basePath = (function () {
      ...
      // "_source/loader.js".
      if (CKEDITOR && CKEDITOR.basePath) return CKEDITOR.basePath;
