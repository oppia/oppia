...
CKEDITOR.plugins.add('dialogui', {
  onLoad: function () {
    var initPrivateObject = function (elementDefinition) {
        this._ || (this._ = {});
        this._['default'] = this._.initValue =
      ...
      textBuilder = {
        build: function (dialog, elementDefinition, output) {
          return new CKEDITOR.ui.dialog.textInput(
            dialog,
            elementDefinition,
            output
          );
      ...
      commonEventProcessors = CKEDITOR.tools.extend(
        {},
                ...
                function () {
                  this.getInputElement().on(
                    ...
                    function () {
                      ...
                      if (!dialog.parts.dialog.isVisible()) return;
      ...
      cleanInnerDefinition = function (def) {
        ...
        for (var i in def) {
          if (eventRegex.test(i) || i == 'title' || i == 'type') delete def[i];
        }
        return def;
      };
      ...
      CKEDITOR.ui.dialog,
      {
          ...
          var innerHTML = function () {
            ...
            if (elementDefinition.labelLayout != 'horizontal') {
              html.push(
                ...
                (elementDefinition.labelStyle
                  ? ' style="' + elementDefinition.labelStyle + '"'
                  : '') + '>',
                elementDefinition.label,
                '</label>',
                '<div class="cke_dialog_ui_labeled_content"',
                elementDefinition.controlStyle
        ...
        textInput: function (dialog, elementDefinition, htmlList) {
          ...
          dialog.on('load', function () {
            me.getInputElement().on('keydown', function (evt) {
              if (evt.data.getKeystroke() == 13) keyPressedOnMe = true;
            });

            // Lower the priority this 'keyup' since 'ok' will close the dialog.(#3749)
            me.getInputElement().on(
              'keyup',
              function (evt) {
        ...
        textarea: function (dialog, elementDefinition, htmlList) {
          ...
          var innerHTML = function () {
            ...
            for (var i in attributes)
              html.push(
                i + '="' + CKEDITOR.tools.htmlEncode(attributes[i]) + '" '
              );
            html.push(
              '>',
              CKEDITOR.tools.htmlEncode(me._['default']),
              '</textarea></div>'
            );
            return html.join('');
          };
        ...
        checkbox: function (dialog, elementDefinition, htmlList) {
          ...
          var innerHTML = function () {
            var myDefinition = CKEDITOR.tools.extend(
                ...
                elementDefinition,
                {
                  id: elementDefinition.id
                    ? elementDefinition.id + '_checkbox'
            ...
            _.checkbox = new CKEDITOR.ui.dialog.uiElement(
              dialog,
              myDefinition,
              html,
              'input',
          ...
          var innerHTML = function () {
            ...
            for (var i = 0; i < elementDefinition.items.length; i++) {
              var item = elementDefinition.items[i],
                ...
                inputDefinition = CKEDITOR.tools.extend(
                  {},
                  elementDefinition,
                  {
                    id: inputId,
                ...
                labelDefinition = CKEDITOR.tools.extend(
                  {},
                  inputDefinition,
                  {
                    title: title,
        ...
        button: function (dialog, elementDefinition, htmlList) {
          ...
          initPrivateObject.call(this, elementDefinition, {
            disabled: elementDefinition.disabled || false,
          });
        ...
        select: function (dialog, elementDefinition, htmlList) {
          ...
          var innerHTML = function () {
            ...
            for (
              ...
              (item = elementDefinition.items[i]);
              i++
            ) {
              innerHTML.push(
                '<option value="',
                CKEDITOR.tools
                  .htmlEncode(item[1] !== undefined ? item[1] : item[0])
                  .replace(/"/g, '&quot;'),
                '" /> ',
            ...
            _.select = new CKEDITOR.ui.dialog.uiElement(
              dialog,
              myDefinition,
              html,
              'select',
        ...
        fileButton: function (dialog, elementDefinition, htmlList) {
          ...
          myDefinition.className =
            (myDefinition.className ? myDefinition.className + ' ' : '') +
          ...
          dialog.on('load', function () {
            dialog
              .getContentElement(
                elementDefinition['for'][0],
                elementDefinition['for'][1]
              )
              ._.buttons.push(me);
          });
        ...
        html: (function () {
          ...
          return function (dialog, elementDefinition, htmlList) {
            ...
            htmlList.push(
              [theirMatch[1], ' ', myMatch[1] || '', theirMatch[2]].join('')
            );
          };
        })(),
    ...
    CKEDITOR.ui.dialog.select.prototype = CKEDITOR.tools.extend(
      new CKEDITOR.ui.dialog.labeledElement(),
      {
        ...
        add: function (label, value, index) {
          var option = new CKEDITOR.dom.element(
              'option',
          ...
          if (index === undefined || index === null) {
            if (CKEDITOR.env.ie) selectElement.add(option.$);
    ...
    CKEDITOR.ui.dialog.file.prototype = CKEDITOR.tools.extend(
      ...
      commonPrototype,
      {
         ...
         */
        getInputElement: function () {
          var frameDocument = CKEDITOR.document
        ...
        reset: function () {
          ...
          function generateFormField() {
            ...
            for (var i = 0; i < buttons.length; i++) buttons[i].enable();
          }
