...
(function () {
  var imageDialog = function (editor, dialogType) {
    ...
    var switchLockRatio = function (dialog, value) {
      ...
      if (value == 'check') {
        if (
          ...
          var width = dialog.getValueOf('info', 'txtWidth'),
            ...
            originalRatio =
              (oImageOriginal.$.width * 1000) / oImageOriginal.$.height,
      ...
      } else if (value != undefined) dialog.lockRatio = value;
      else {
      ...
      onOk: function () {
        ...
        if (!this.imageEditMode) {
          if (this.addLink) {
            ...
            else editor.insertElement(this.imageElement);
          } else editor.insertElement(this.imageElement);
            ...
            },
            {
              ...
              commit: function (type, element) {
                if (type == IMAGE) {
                  ...
                  element.setAttribute('alt', this.getValue());
                else if (type == CLEANUP) element.removeAttribute('alt');
              },
            },
            {
              type: 'hbox',
                ...
                },
                {
                  ...
                  commit: function (type, element) {
                    if (type == IMAGE) {
                      ...
                      element.setAttribute('title', this.getValue());
                    else if (type == CLEANUP) element.removeAttribute('title');
                  },
                },
              ],
            },
