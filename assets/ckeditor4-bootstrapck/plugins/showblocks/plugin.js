  ...
  CKEDITOR.plugins.add('showblocks', {
    ...
    onLoad: function () {
      var tags = [
        ...
        notDisabled = supportsNotPseudoclass
          ? ':not([contenteditable=false]):not(.cke_show_blocks_off)'
          : '',
        tag,
        trailing;
      ...
      while ((tag = tags.pop())) {
        ...
        cssLtr +=
          '.cke_show_blocks.cke_contents_ltr ' + tag + notDisabled + trailing;
        cssRtl +=
          '.cke_show_blocks.cke_contents_rtl ' + tag + notDisabled + trailing;
        cssImg +=
          '.cke_show_blocks ' +
          tag +
          notDisabled +
      ...
      cssLtr +=
        '{' + 'background-position:top left;' + 'padding-left:8px' + '}';

      // .cke_show_blocks.cke_contents_rtl p { ... }
      cssRtl +=
        '{' + 'background-position:top right;' + 'padding-right:8px' + '}';
