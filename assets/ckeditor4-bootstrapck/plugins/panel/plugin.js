...
(function () {
  ...
  var panelTpl = CKEDITOR.addTemplate(
    'panel',
  ...
  CKEDITOR.ui.panel.prototype = {
      ...
      this.getHolderElement = function () {
        ...
        if (!holder) {
          if (this.isFramed) {
            ...
            var onLoad = CKEDITOR.tools.addFunction(
              CKEDITOR.tools.bind(function (ev) {
                this.isLoaded = true;
    ...
    addBlock: function (name, block) {
      block = this._.blocks[name] =
        block instanceof CKEDITOR.ui.panel.block
          ? block
    ...
    showBlock: function (name) {
      ...
      this._.onKeyDown =
        block.onKeyDown && CKEDITOR.tools.bind(block.onKeyDown, block);
      ...
      onKeyDown: function (keystroke, noCycle) {
        ...
        switch (keyAction) {
          ...
          case 'mouseup':
            index = this._.focusIndex;
            link =
              index >= 0 && this.element.getElementsByTag('a').getItem(index);
