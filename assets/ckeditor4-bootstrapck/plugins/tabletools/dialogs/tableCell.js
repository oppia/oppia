...
CKEDITOR.dialog.add('cellProperties', function (editor) {
  ...
  return {
                ...
                children: [
                    ...
                    children: [
                      {
                        ...
                        onLoad: function () {
                          var widthType = this.getDialog().getContentElement(
                              'info',
                              'widthType'
                            ),
                          ...
                          inputElement.setAttribute(
                            'aria-labelledby',
                            [ariaLabelledByAttr, labelElement.$.id].join(' ')
                          );
                        },

                        setup: function (element) {
                          var widthAttr = parseInt(
                        ...
                        commit: function (element) {
                          var value = parseInt(this.getValue(), 10),
                            unit = this.getDialog().getValueOf(
                              'info',
                              'widthType'
                            );
                      ...
                      },
                      {
                        ...
                        setup: function (selectedCell) {
                          var widthMatch = widthPattern.exec(
                            selectedCell.getStyle('width') ||
                              selectedCell.getAttribute('width')
                          );
                          if (widthMatch) this.setValue(widthMatch[2]);
                        },
                      },
                    ],
                  },
                    ...
                    children: [
                      {
                        ...
                        onLoad: function () {
                          var heightType = this.getDialog().getContentElement(
                              'info',
                              'htmlHeightType'
                            ),
                        ...
                        setup: function (element) {
                          var heightAttr = parseInt(
                              element.getAttribute('height'),
                              10
                            ),
                            heightStyle = parseInt(
                        ...
                        commit: function (element) {
                          ...
                          if (!isNaN(value))
                            element.setStyle(
                              'height',
                              CKEDITOR.tools.cssLength(value)
                            );
                  ...
                  spacer,
                  {
                    ...
                    commit: function (element) {
                      ...
                      else element.removeStyle('white-space');
                  ...
                  spacer,
                  {
                    ...
                    commit: function (selectedCell) {
                      ...
                      if (value) selectedCell.setStyle('text-align', value);
                      else selectedCell.removeStyle('text-align');
                  ...
                  },
                  {
                    ...
                    commit: function (element) {
                      ...
                      if (value) element.setStyle('vertical-align', value);
                      else element.removeStyle('vertical-align');
              ...
              spacer,
              {
                ...
                children: [
                  ...
                  spacer,
                  {
                    ...
                    setup: function (selectedCell) {
                      var attrVal = parseInt(
                        selectedCell.getAttribute('rowSpan'),
                        10
                      );
                      if (attrVal && attrVal != 1) this.setValue(attrVal);
                    },
                    commit: function (selectedCell) {
                      var value = parseInt(this.getValue(), 10);
                      if (value && value != 1)
                        selectedCell.setAttribute('rowSpan', this.getValue());
                      else selectedCell.removeAttribute('rowSpan');
                    },
                  },
                  {
                    type: 'text',
                    ...
                    commit: function (selectedCell) {
                      ...
                      else selectedCell.removeAttribute('colSpan');
                    },
                  },
                  spacer,
                  {
                    ...
                    children: [
                      {
                        ...
                        commit: function (selectedCell) {
                          ...
                          else selectedCell.removeStyle('background-color');
                    ...
                    children: [
                      {
                        ...
                        commit: function (selectedCell) {
                          ...
                          else selectedCell.removeStyle('border-color');
    ...
    onOk: function () {
      ...
      for (var i = 0; i < cells.length; i++) this.commitContent(cells[i]);
