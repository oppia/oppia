...
CKEDITOR.dialog.add('scaytcheck', function (editor) {
      ...
      elements: [
        {
          ...
          html:
            ...
            '	<div style="margin:5px auto; width:95%;white-space:normal; overflow:hidden;" id="dic_message_' +
            editorName +
            '"> </div>' +
            ...
            '				<input id="dic_name_' +
            editorName +
            '" type="text" class="cke_dialog_ui_input_text" style = "height: 25px; background: none; padding: 0;"/>' +
            '		</div></span></div>' +
            '		<div style="margin:5px auto; width:95%;white-space:normal;">' +
  ...
  for (i = 0; i < tags.length; i++) {
    if (tags[i] == 1) contents[contents.length] = tags_contents[i];
  }
        ...
        if (checkbox) {
          ...
          if (firstLoad) {
            checkbox.on('click', function () {
              dialog.options[this.getId().split('_')[0]] = this.$.checked
                ? 1
                : 0;
            });
          }
  ...
  function dic_error_message(m) {
    doc
      ...
      .setHtml('<span style="color:red;">' + m + '</span>');
  }

  function dic_success_message(m) {
    doc
      .getById('dic_message_' + editorName)
      .setHtml('<span style="color:blue;">' + m + '</span>');
  }
