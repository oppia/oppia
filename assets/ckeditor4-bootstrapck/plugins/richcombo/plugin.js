...
(function () {
  ...
  CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
    $: function (definition) {
      ...
      this.document =
        (panelDefinition.parent && panelDefinition.parent.getDocument()) ||
        CKEDITOR.document;
    ...
    proto: {
      ...
      render: function (editor, output) {
        ...
        function updateState() {
          var state = this.modes[editor.mode]
      ...
      createPanel: function (editor) {
        ...
        var panelDefinition = this._.panelDefinition,
          ...
          panelParentElement =
            panelDefinition.parent || CKEDITOR.document.getBody(),
          namedPanelCls = 'cke_combopanel__' + this.name,
          panel = new CKEDITOR.ui.floatPanel(
            editor,
            panelParentElement,
            panelDefinition
          ),
