...
CKEDITOR.plugins.add('wsc', {
  ...
  parseApi: function (editor) {
    editor.config.wsc_onFinish =
      typeof editor.config.wsc_onFinish === 'function'
        ? editor.config.wsc_onFinish
        : function () {};
    editor.config.wsc_onClose =
      typeof editor.config.wsc_onClose === 'function'
        ? editor.config.wsc_onClose
        : function () {};
  },
  parseConfig: function (editor) {
    ...
    editor.config.wsc_customDictionaryIds =
      ...
      '';
    editor.config.wsc_userDictionaryName =
      editor.config.wsc_userDictionaryName ||
    ...
    CKEDITOR.config.wsc_cmd =
      editor.config.wsc_cmd || CKEDITOR.config.wsc_cmd || 'spell'; // spell, thes or grammar. default tab
  ...
  init: function (editor) {
    ...
    var command = editor.addCommand(
      commandName,
      new CKEDITOR.dialogCommand(commandName)
    );
