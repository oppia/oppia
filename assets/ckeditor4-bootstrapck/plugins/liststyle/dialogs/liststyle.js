            ...
            elements: [
              {
                ...
                setup: function (element) {
                  var value =
                    element.getStyle('list-style-type') ||
                ...
                commit: function (element) {
                  ...
                  else element.removeStyle('list-style-type');
                },
              },
            ],
          },
                ...
                children: [
                  {
                    ...
                    validate: CKEDITOR.dialog.validate.integer(
                      lang.validateStartNumber
                    ),
                    setup: function (element) {
                      // List item start number dominates.
                      var value =
                        element.getFirst(listItem).getAttribute('value') ||
                    ...
                    commit: function (element) {
                      ...
                      if (isNaN(val)) element.removeAttribute('start');
                      else element.setAttribute('start', val);
                      ...
                      while (
                        (nextItem = nextItem.getNext(listItem)) &&
                        conseq++
                      ) {
                        if (nextItem.getAttribute('value') == conseq)
                          nextItem.setAttribute(
                            'value',
                            startNumber + conseq - oldStart
                          );
                      }
                    },
                  },
