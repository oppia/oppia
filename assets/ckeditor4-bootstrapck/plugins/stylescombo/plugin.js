    ...
    init: function (editor) {
      ...
      editor.ui.addRichCombo('Styles', {
        ...
        onClick: function (value) {
          ...
          editor[style.checkActive(elementPath) ? 'removeStyle' : 'applyStyle'](
            style
          );
          editor.fire('saveSnapshot');
        },
        ...
        onOpen: function () {
          ...
          for (var name in styles) {
            ...
            if (style.checkActive(elementPath)) this.mark(name);
          }
        ...
        refresh: function () {
          ...
          for (var name in styles) {
            ...
            if (style.checkApplicable(elementPath, editor.activeFilter)) return;
          }
