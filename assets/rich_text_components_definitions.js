...
var richTextComponents = {
  "Collapsible": {
    ...
    "preview_url_template_production": "/rich_text_components/Collapsible/CollapsiblePreview.png",
    "is_complex": true,
    "requires_fs": false,
  ...
  "Image": {
    ...
    "preview_url_template_dev": "/imagehandler/<[explorationId]>/<[filepath.name]>",
    "preview_url_template_production": "/<[urlWithBucket]>/<[explorationId]>/<[filepath.name]>",
    "is_complex": false,
    "requires_fs": true,
    "is_block_element": true,
    "customization_arg_specs": [{
  ...
  "Link": {
    ...
    "preview_url_template_production": "/rich_text_components/Link/LinkPreview.png",
    "is_complex": false,
    "requires_fs": false,
  ...
  "Math": {
    ...
    "preview_url_template_production": "/rich_text_components/Math/MathPreview.png",
    "is_complex": false,
    "requires_fs": false,
    "is_block_element": false,
    "customization_arg_specs": [{
  ...
  "Tabs": {
    ...
    "preview_url_template_production": "/rich_text_components/Tabs/TabsPreview.png",
    "is_complex": true,
    "requires_fs": false,
    "is_block_element": true,
    "customization_arg_specs": [{
  ...
  "Video": {
    ...
    "preview_url_template_production": "https://img.youtube.com/vi/<[video_id]>/hqdefault.jpg",
    "is_complex": false,
    "requires_fs": false,
    "is_block_element": true,
    "customization_arg_specs": [{
