...
(function(window, document) {
      ...
      window.addEventListener('message', function(evt) {
        ...
        switch (data.title) {
          ...
          case 'heightChange':
            ...
            break;
          case 'answerSubmit':
              window.OPPIA_PLAYER.onAnswerSubmit(
                iframeNode, data.payload.stateName, data.payload.jsonAnswer);
              break;
  ...
  window.OPPIA_PLAYER = {
    ...
    onAnswerSubmit: function(
      iframeNode, stateName, jsonAnswer) {
      window.OPPIA_PLAYER.onAnswerSubmitHook(iframeNode, stateName, jsonAnswer);
    },
...
/**
 * Called when a new answer is submitted.
 * @param {object} iframeNode The iframe node that is the source of the
 *     postMessage call.
 * @param {string} stateName The name of the previous state.
 * @param {string} jsonAnswer A JSON representation of the reader's answer.
 */
window.OPPIA_PLAYER.onAnswerSubmitHook = function(
  iframeNode, stateName, jsonAnswer) {
