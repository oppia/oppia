...
export = {
  ...
  // and attributes on the following page:
  ...
  // Deprecated tags/attributes were removed based on information in the
  // relevant MDN docs page for each tag/attribute. For example:
  ...
  "SVG_ATTRS_WHITELIST": {
    ...
    "desc": ["class", "content", "id", "lang", "xml:lang"],
    "ellipse": [
      "class",
      "color",
      "color-rendering",
    ...
    "metadata": ["class", "content", "id", "lang", "xml:lang"],
    "mpath": ["class", "content", "id", "lang", "xml:lang"],
    "path": [
      "class",
      "color",
      "color-rendering",
    ...
    "title": ["class", "content", "id", "lang", "xml:lang"],
    "tspan": [
      "class",
      "color",
      "color-rendering",
