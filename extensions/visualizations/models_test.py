...
"""Unit tests for extensions/visualizations/models.py"""
...
class BaseVisualizationTests(test_utils.GenericTestBase):
    ...
    def test_get_class_name_correctly(self):
        self.assertEqual(
    ...
    def test_invalid_addressed_info_is_supported_raises_error(self):
        error_message = (
