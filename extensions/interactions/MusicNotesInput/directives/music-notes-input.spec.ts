...
describe('MusicNotesInput interaction', function () {
  ...
  describe('MusicNotesInput tests', function () {
    ...
    it('should not do anything when asked to remove a note that does not exist', function () {
      expect(ctrlScope.noteSequence).toEqual([]);
...
describe('Music phrase player service', function () {
  describe('music phrase player service', function () {
    ...
    beforeEach(
      angular.mock.inject(function ($injector, $window) {
    ...
    it(
      'should play all the notes in a music phrase',
