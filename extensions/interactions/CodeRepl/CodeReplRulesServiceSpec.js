...
describe('Code REPL rules service', function() {
  ...
  describe('fuzzy rule', function() {
    ...
    it('should match the same code', function() {
      expect(crrs.FuzzyMatches({
        code: 'def func():\n    return 1\nprint func()',
        output: '1',
        evaluation: '',
        error: ''
    ...
    it('should match the same code with extra whitespace', function() {
      expect(crrs.FuzzyMatches({
        code: '\ndef func():\n  return 1\n\n\nprint func()\n',
        output: '1',
        evaluation: '',
    ...
    it('should match the same code with comments', function() {
      expect(crrs.FuzzyMatches({
        code: (
    ...
    it('should fail on renamed identifiers', function() {
      expect(crrs.FuzzyMatches({
        code: 'def ret_one():\n    return 1\nprint ret_one()',
        output: '1',
        evaluation: '',
    ...
    it('should not match different code', function() {
      expect(crrs.FuzzyMatches({
        code: 'print (1+2)',
        output: '1',
        evaluation: '',
