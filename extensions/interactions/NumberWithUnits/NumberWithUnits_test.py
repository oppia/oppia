...
from extensions.interactions.NumberWithUnits import NumberWithUnits # pylint: disable=unused-import, line-too-long
...
class NumberWithUnitsTests(test_utils.GenericTestBase):
    ...
    # (like extensions/interactions/NumberWithUnits/NumberWithUnits.py), a
