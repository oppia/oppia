...
describe('Numeric Input service', () => {
  ...
  it('should have a correct is greater than rule', () => {
    expect(
      nirs.IsGreaterThan(3.0, {
        x: 4.0,
      })
    ).toBe(false);
    expect(
      nirs.IsGreaterThan(3, {
        x: 4,
      })
    ).toBe(false);
    expect(
  ...
  it('should have a correct less than or equal to rule', () => {
    expect(
      nirs.IsLessThanOrEqualTo(3.0, {
        x: 4.0,
      })
    ).toBe(true);
    expect(
      nirs.IsLessThanOrEqualTo(3, {
        x: 4,
      })
    ).toBe(true);
    expect(
      nirs.IsLessThanOrEqualTo(2, {
        x: 4,
      })
    ).toBe(true);
    expect(
    ...
    expect(
      nirs.IsLessThanOrEqualTo(4, {
        x: 3.0,
      })
    ).toBe(false);
    expect(
      nirs.IsLessThanOrEqualTo(4.0, {
        x: 3.0,
      })
    ).toBe(false);
  });
  ...
  it('should have a correct greater than or equal to rule', () => {
    expect(
      nirs.IsGreaterThanOrEqualTo(3.0, {
        x: 4.0,
      })
    ).toBe(false);
    expect(
      nirs.IsGreaterThanOrEqualTo(3, {
        x: 4,
      })
    ).toBe(false);
    expect(
      nirs.IsGreaterThanOrEqualTo(2, {
        x: 4,
      })
    ).toBe(false);
    expect(
    ...
    expect(
      nirs.IsGreaterThanOrEqualTo(4, {
        x: 3.0,
      })
    ).toBe(true);
    expect(
      nirs.IsGreaterThanOrEqualTo(4.0, {
        x: 3.0,
      })
    ).toBe(true);
  });
  ...
  it('should have a correct inclusively between rule', () => {
    ...
    expect(
      nirs.IsInclusivelyBetween(1.0, {
        a: 0,
        b: 2,
      })
    ).toBe(true);
    expect(
      nirs.IsInclusivelyBetween(1.01, {
        a: 0,
        b: 1,
      })
    ).toBe(false);
  ...
  it('should have a correct within tolerence rule', () => {
    expect(
      nirs.IsWithinTolerance(0, {
        x: 0,
        tol: 1,
      })
    ).toBe(true);
    expect(
      nirs.IsWithinTolerance(0.5, {
        x: 0,
        tol: 0.5,
      })
    ).toBe(true);
    ...
    expect(
      nirs.IsWithinTolerance(3, {
        x: 2.0,
        tol: 1,
      })
    ).toBe(true);
    expect(
      nirs.IsWithinTolerance(0.1, {
        x: 0,
        tol: 0,
      })
    ).toBe(false);
