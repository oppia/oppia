...
"""Unit tests for extensions/interactions/ImageClickInput/ImageClickInput.py"""

from __future__ import annotations

from core.tests import test_utils
from . import ImageClickInput # pylint: disable=unused-import
...
class ImageClickInputTests(test_utils.GenericTestBase):
    ...
    # (like extensions/interactions/ImageClickInput/ImageClickInput.py), a
