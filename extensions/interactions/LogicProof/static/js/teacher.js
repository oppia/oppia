...
var logicProofTeacher = (function() {
  ...
  var TEACHER_ERROR_MESSAGES = {
    unparseable: {
      ...
      parameters: {field: {format: 'string'}}
    },
    ambiguous_typing: {
      templates: [
        [
          {
            isFixed: true,
            content: (
              'Unfortunately this cannot be accepted as it has multiple' +
          ' possible typings.')
          }
        ]
      ],
    ...
    hidden_operator: {
      ...
      parameters: {operator: {format: 'string'}}
    },
        ...
        [
          {
            isFixed: true,
            content: (
              'You cannot use n as a function name; it is reserved to refer' +
          ' to line numbers')
          }
        ]
      ]
        ...
        [
          {
            ...
            isFixed: true,
            content: (
              '\' is the name of a function and so cannot be used as an' +
              ' argument.')
          }
        ]
      ],
      parameters: {argument: {format: 'string'}}
    },
    duplicate_argument: {
      templates: [
        [
    ...
    unknown_typing_error: {
      ...
      parameters: {expression: {format: 'expression'}}
    },
    'unmatched_{{': {
      templates: [
        [
    ...
    unparseable_fragment: {
      ...
      parameters: {fragment: {format: 'string'}}
    },
    ambiguous_parsing: {
      templates: [
        [
    ...
    illegal_symbol: {
      ...
      parameters: {symbol: {format: 'string'}}
    },
    blank_line: {
      templates: [
        [
