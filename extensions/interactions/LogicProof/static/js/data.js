...
var logicProofData = (function() {
  var BASE_VOCABULARY = {
    ...
    whichever: [
      'and whichever is true', 'and either way',
      'and in either case'
    ],
        ...
        typing: [
          {
            ...
            arguments: [
              SINGLE_BOOLEAN, SINGLE_SET_OF_FORMULAS,
              SINGLE_SET_OF_FORMULAS
            ],
            dummies: [],
            output: 'set_of_formulas'
          }
        ...
        [
          {
            ...
            isFixed: true,
            content: (
              '\' as words; please make sure you are using vocabulary ' +
          'from the given list, and don\'t have two consecutive expressions.')
          }
        ]
      ],
      parameters: {
        ...
        [
          {
            isFixed: true,
            content: (
              'This can be parsed in too many different ways - try ' +
          'using fewer words, especially single-character words.')
          }
        ]
      ],
      parameters: {},
