...
@Component({
  selector: 'oppia-response-logic-proof',
  templateUrl: './logic-proof-response.component.html'
})
...
angular.module('oppia').directive(
  'oppiaResponseLogicProof', downgradeComponent({
    component: ResponseLogicProofComponent
  })
);
