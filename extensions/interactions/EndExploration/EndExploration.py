    ...
    _customization_arg_specs: List[domain.CustomizationArgSpecsDict] = [
        {
            ...
            'description': (
                'IDs of explorations to recommend to the learner (at most 3 are shown). The ID of an exploration is the string of characters appearing after \'/explore/\' in the URL bar.'
            ),
            'schema': {
                'type': 'list',
                'items': {
