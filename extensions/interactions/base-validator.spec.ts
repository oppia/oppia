...
describe('Interaction validator', function () {
  ...
  describe('baseValidator', function () {
    it(
      'should have no warnings for good answer groups with no ' +
        'confusing outcomes',
      function () {
    ...
    it(
      'should have a warning for an answer group with a self-loop labelled' +
        ' as correct',
      function () {
    ...
    it(
      'should have a warning for a default outcome with a self-loop' +
        ' labelled as correct',
      function () {
        goodOutcomeFeedback.labelledAsCorrect = true;
        var warnings = bivs.getDefaultOutcomeWarnings(
    ...
    it(
      'should not have any warnings for no answer groups and a null default ' +
        'outcome.',
      function () {
    ...
    it(
      'should be able to concatenate warnings for both answer groups and ' +
        'the default outcome',
      function () {
        var badAnswerGroups = [
          agof.createNew([], goodOutcomeDest, false, null),
  ...
  describe('HTMLValidator', function () {
    ...
    it(
      'should categorize balanced HTML tags as empty if the remaining ' +
        'string is empty',
      function () {
    ...
    it(
      'should categorize balanced HTML tags as not empty if the remaining ' +
        'string is not empty',
      function () {
