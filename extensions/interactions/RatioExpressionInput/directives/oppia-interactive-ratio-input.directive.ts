...
/**
 * @fileoverview Directive for the RatioInput interaction.
 */
...
angular.module('oppia').directive('oppiaInteractiveRatioInput', [
  'HtmlEscaperService', function(HtmlEscaperService) {
    return {
      restrict: 'E',
      scope: {},
      bindToController: {},
      template: require('./ratio-input-interaction.directive.html'),
      controllerAs: '$ctrl',
      controller: [
        '$scope', '$attrs', 'FocusManagerService', 'RatioInputRulesService',
        'RATIO_PARSING_ERRORS', 'WindowDimensionsService',
        ...
        function(
          ...
          var FORM_ERROR_TYPE = 'RATIO_FORMAT_ERROR';
          var errorMessage = '';
