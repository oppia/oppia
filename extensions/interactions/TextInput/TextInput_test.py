...
from extensions.interactions.TextInput import (  # pylint: disable=unused-import # isort: skip
    TextInput,
)
...
class TextInputTests(test_utils.GenericTestBase):
    ...
    # (like extensions/interactions/TextInput/TextInput.py), a trivial test
