...
export class GraphViz implements OnInit, AfterViewInit {
  ...
  selectedVertexLabelGetterSetter(label: string): string {
  ...
  selectedEdgeWeight(weight: number | null): number | string {
