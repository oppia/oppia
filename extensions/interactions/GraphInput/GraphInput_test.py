...
"""Unit tests for GraphInput.py"""

from __future__ import annotations

from core.tests import test_utils
from extensions.interactions.GraphInput import GraphInput # pylint: disable=unused-import, line-too-long
...
class GraphInputTests(test_utils.GenericTestBase):
    ...
    # (like extensions/interactions/GraphInput/GraphInput.py), a trivial test
    # like the one here is sufficient.
