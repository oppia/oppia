...
describe('AlgebraicExpressionInputInteractive', () => {
  ...
  class MockGuppy {
    constructor(_id: string, _config: Object) {}

    asciimath() {
      return 'Dummy value';
    }
    configure(_name: string, _val: Object): void {}
    static event(_name: string, handler: Function): void {
      handler({focused: true});
    }
    static configure(_name: string, _val: Object): void {}
    static 'remove_global_symbol'(_symbol: string): void {}
    static 'add_global_symbol'(_name: string, _symbol: Object): void {}
  }

  let mockCurrentInteractionService = {
    onSubmit: (_answer, _rulesService) => {},
