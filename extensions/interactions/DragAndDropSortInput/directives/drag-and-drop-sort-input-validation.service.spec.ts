...
describe('DragAndDropSortInputValidationService', () => {
  ...
  let equalsListWithEmptyListRule: Rule,
    equalsListWithDuplicatesRule: Rule,
    equalsListWithAllowedValuesRule: Rule,
    equalsListWithValuesRule: Rule,
    goodRule1: Rule,
    goodRule2: Rule,
    ...
    equalsListWithDuplicatesRule = Rule.createFromBackendDict(
      {
        rule_type: 'IsEqualToOrderingWithOneItemAtIncorrectPosition',
        inputs: {
          x: [['ca_0', 'ca_1'], ['ca_1'], ['ca_2', 'ca_0', 'ca_3']],
        },
      },
      'DragAndDropSortInput'
    );
  ...
  it('should expect at least two choices', () => {
    customizationArgs.choices.value = [new SubtitledHtml('1', '')];
