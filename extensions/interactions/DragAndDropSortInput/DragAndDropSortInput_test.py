...
from extensions.interactions.DragAndDropSortInput import DragAndDropSortInput # pylint: disable=unused-import, line-too-long
...
class DragAndDropSortInputTests(test_utils.GenericTestBase):
    ...
    # (like DragAndDropSortInput.py), a trivial test like the one here is
    # sufficient.
