...
describe('Numeric expression input rules service', () => {
  ...
  it('should have a correct MatchesExactlyWith rule', () => {
    ...
    expect(
      neirs.MatchesExactlyWith('3*2-(-4)', { x: inputString })).toBeFalse();


    inputString = '3*10^(-5)';

    expect(
      neirs.MatchesExactlyWith('3*10^(-5)', { x: inputString })).toBeTrue();
    ...
    expect(
      neirs.MatchesExactlyWith('2*2*3*2*1', { x: inputString })).toBeFalse();
    ...
    expect(
      neirs.MatchesExactlyWith('8/2 * 3*3', { x: inputString })).toBeFalse();
  ...
  it('should have a correct ContainsSomeOf rule', () => {
    ...
    expect(
      neirs.ContainsSomeOf('1000 + 234.56', { x: inputString })).toBeTrue();
