...
export class NoninteractiveSkillreview implements OnInit, OnChanges {
  ...
  // calling components once the editor is closed. This is needed because
  // images are loaded relative to the current entity context, so leaving the
  // context pointing at the skill makes images on the underlying page fail to
  // load (see issue #20766).
