...
var expectComponentDetailsToMatch = async function(
  ...
  if (selectedAction === 'create') {
    ...
    var svgDiagramInputElement = await elem.$('.protractor-test-image');
    await waitFor.visibilityOf(
