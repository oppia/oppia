...
class ComponentValidationUnitTests(test_utils.GenericTestBase):
    ...
    def test_collapsible_validation(self) -> None:
        ...
        valid_items: List[Dict[str, str]] = [
            {'content-with-value': '<p>Hello</p>', 'heading-with-value': 'Collapsible'},
            {'content-with-value': '<p>1234</p>', 'heading-with-value': '1234'},
        ]
        ...
        self.check_validation(
            components.Collapsible, valid_items, invalid_items_with_error_messages
        )
    ...
    def test_image_validation(self) -> None:
        ...
        invalid_items_with_error_messages = [
            (
                {'filepath-with-value': 'random.png', 'caption-with-value': 'abc'},
    ...
    def test_link_validation(self) -> None:
        ...
        valid_items: List[Dict[str, str]] = [
            ...
            {'url-with-value': 'https://hello.com', 'text-with-value': '1234'},
        ]
        invalid_items_with_error_messages = [
            (
                {'url-with-value': 'javascript:alert(5);', 'text-with-value': 'Hello'},
                r'Invalid URL: Sanitized URL should start with \'http://\' or '
                r'\'https://\'; received javascript:alert%285%29%3B',
            ),
            (
                {'url-with-value': 'http://link.com', 'text-with-value': 1234},
    ...
    def test_math_validation(self) -> None:
        ...
        invalid_items_with_error_messages = [
            ({'math_content-with-value': False}, 'Expected dict, received False'),
            (
            ...
            (
                {'math_content-with-value': {'raw_latex': True, 'svg_filename': False}},
                'Expected unicode string, received True',
            ),
            (
                {'math_content-with-value': {'raw_latex': 123, 'svg_filename': 11}},
    ...
    def test_skillreview_validation(self) -> None:
        ...
        valid_items = [
            {'skill_id-with-value': 'skill_id', 'text-with-value': 'Skill Link Text'}
        ]
        invalid_items_with_error_messages = [
            (
        ...
        self.check_validation(
            components.Skillreview, valid_items, invalid_items_with_error_messages
        )
    ...
    def test_component_e2e_tests(self) -> None:
        ...
        with utils.open_file(test_file, 'r') as f:
            ...
            text_inside_constant = (
                text[first_bracket_index + len(beginning_sequence) : last_bracket_index]
                + ','
            )
