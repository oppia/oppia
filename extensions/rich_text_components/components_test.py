...
ValidItemTypes = Union[Dict[str, str], Dict[str, Dict[str, str]],
                       Dict[str, List[Dict[str, str]]], Dict[str, Union[str, int,
                                                                        bool]]]
...
class ComponentValidationUnitTests(test_utils.GenericTestBase):
    ...
    def check_validation(
        self, rte_component_class: Type[components.BaseRteComponent],
    ...
    def test_component_e2e_tests(self) -> None:
        ...
        with utils.open_file(test_file, 'r') as f:
            ...
            text_inside_constant = text[
                first_bracket_index + len(beginning_sequence):last_bracket_index] + ','
            ...
            while text_inside_constant.find(',') != -1:
                ...
                text_inside_constant = text_inside_constant[text_inside_constant.
                                                            find(',') + 1:]
