  ...
  function(
    ...
    return {
      ...
      controller: ['$scope', function($scope) {
         ...
         *
         * Once an image is uploaded, the user can use the resize controls
         * to make it smaller. This function takes into account the user's
         * resize choices plus the maximum output width configured in the
         * editor and returns the expected width and height of the final
         * image that will be generated by the editor.
         *
