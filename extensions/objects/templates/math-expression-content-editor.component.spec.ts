...
describe('MathExpressionContentEditorComponent', () => {
  ...
  it(
    ...
    fakeAsync(() => {
      ...
      spyOnProperty(
        ...
        'onExternalRteSave'
      ).and.returnValue(mockOnExternalRteSaveEventEmitter);
  ...
  it(
    "should replace with the old value if the user clicks 'Close'" +
  ...
  it(
    'should not replace raw latex value when the expression is not' +
      ' always editable',
    () => {
      component.localValue.label = '\\frac{x}{y}';
      component.active = true;
