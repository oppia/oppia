...
describe('ListOfSetsOfTranslatableHtmlContentIdsEditorComponent', () => {
  ...
  let fixture: ComponentFixture<ListOfSetsOfTranslatableHtmlContentIdsEditorComponent>;
  ...
  it('should rearrage choices when user changes position of choices', () => {
    ...
    expect(component.value).toEqual([
      ['ca_choices_1'],
      ['ca_choices_2'],
      ['ca_choices_3', 'ca_choices_4'],
    ]);
  });

  it(
    'should add choiceId to selected rank that is undefined when user' +
    ...
    () => {
      ...
      component.value[2] = ['ca_choices_3', 'ca_choices_4'];
      // This throws "Type 'undefined' is not assignable to type 'string[]'."
      // We need to suppress this error because of the need to test validations.
      // This throws an error because the value is undefined.
      // @ts-ignore
  ...
  it(
    'should add choice as a subitem of another choice when user allots' +
  ...
  it('should add empty arrays in between when user skips positions', () => {
    ...
    component.value = [['ca_choices_1'], ['ca_choices_2']];
  ...
  it('should warn user when none of the choices are in position 1', () => {
    ...
    expect(component.errorMessage).toBe(
      'Please assign some choice at position 1.'
    );
  ...
  it(
    'should warn user when one of the positions in the middle are not' +
    ...
    () => {
      ...
      expect(component.errorMessage).toBe(
        'Please assign some choice at position 2.'
      );
      expect(component.eventBusGroup.emit).toHaveBeenCalled();
      expect(component.validOrdering).toBeFalse();
    }
  ...
  it(
    'should return the choices to be displayed in the add ' + 'response editor',
    () => {
      component.choices = [
        {
          id: '<p>choice1</p>',
