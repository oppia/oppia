...
require('objects/templates/DragAndDropPositiveint-editor.directive.ts');
...
require('objects/templates/Nonnegativeint-editor.directive.ts');
...
require('objects/templates/SetOfunicode-string-editor.directive.ts');
