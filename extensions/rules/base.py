...
class HanoiTowerMoveLogRule(rule_domain.Rule):
    subject_type = objects.HanoiTowerMoveLog
...
class NumberWithUnitsRule(rule_domain.Rule):
    subject_type = objects.NumberWithUnits
