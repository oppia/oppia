...
from extensions.issues.EarlyQuit import EarlyQuit # pylint: disable=unused-import, line-too-long
...
class EarlyQuitTests(test_utils.GenericTestBase):
    ...
    # (like extensions/issues/EarlyQuit/EarlyQuit.py), a trivial test
