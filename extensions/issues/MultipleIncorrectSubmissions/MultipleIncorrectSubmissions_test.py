...
from extensions.issues.MultipleIncorrectSubmissions import MultipleIncorrectSubmissions # pylint: disable=unused-import, line-too-long
...
class MultipleIncorrectSubmissionsTests(test_utils.GenericTestBase):
    ...
    # (like MultipleIncorrectSubmissions.py), a trivial test like the one here
    # is sufficient.
