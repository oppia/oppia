...
describe('FeedbackImprovementCardObjectFactory', function () {
    ...
    beforeEach(angular.mock.inject(function (_$q_, _$rootScope_, _$uibModal_, _FeedbackImprovementCardObjectFactory_, _ImprovementModalService_, _ThreadDataService_, _FEEDBACK_IMPROVEMENT_CARD_TYPE_) {
        $q = _$q_;
