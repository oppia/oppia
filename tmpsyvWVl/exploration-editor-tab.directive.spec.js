...
require('pages/exploration-editor-page/editor-tab/' +
...
describe('Exploration editor tab controller', function () {
    describe('ExplorationEditorTab', function () {
        ...
        beforeEach(angular.mock.inject(function (_$componentController_, $injector, $rootScope) {
        ...
        it('should correctly broadcast the stateEditorInitialized flag with ' +
            ...
            expect(rootScope.$broadcast).toHaveBeenCalledWith('stateEditorInitialized', ess.getState('Third State'));
        });
    });
});
