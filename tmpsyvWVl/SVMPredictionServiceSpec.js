...
var PredictionResultObjectFactory_ts_1 = require("domain/classifier/PredictionResultObjectFactory.ts");
// ^^^ This block is to be removed.
describe('SVM prediction functions', function () {
    beforeEach(angular.mock.module('oppia'));
    beforeEach(angular.mock.module('oppia', function ($provide) {
        $provide.value('PredictionResultObjectFactory', new PredictionResultObjectFactory_ts_1.PredictionResultObjectFactory());
    }));
