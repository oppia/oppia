...
CLASSROOM_DATA_HANDLER = '/classroom-data-handler'
COLLECTION_DATA_URL_PREFIX = '/collection-handler/data'
COLLECTION_EDITOR_DATA_URL_PREFIX = '/collection-editor-handler/data'
COLLECTION_SUMMARIES_DATA_URL = '/collectionsummarieshandler/data'
COLLECTION_RIGHTS_PREFIX = '/collection-editor-handler/rights'
COLLECTION_PUBLISH_PREFIX = '/collection-editor-handler/publish'
COLLECTION_UNPUBLISH_PREFIX = '/collection-editor-handler/unpublish'
COLLECTION_EDITOR_URL_PREFIX = '/collection-editor/create'
COLLECTION_URL_PREFIX = '/collection'
CONCEPT_CARD_DATA_URL_PREFIX = '/concept-card-handler'
...
EXPLORATION_METADATA_SEARCH_URL = '/exploration/metadata-search'
EXPLORATION_PRETESTS_URL_PREFIX = '/pretest-handler'
EXPLORATION_RIGHTS_PREFIX = '/createhandler/rights'
EXPLORATION_STATE_ANSWER_STATS_PREFIX = '/createhandler/state-answer-stats'
...
FEEDBACK_THREAD_VIEW_EVENT_URL = '/feedbackhandler/thread-view-event'
FETCH_SKILLS_URL_PREFIX = '/fetch-skills'
...
MERGE_SKILLS_URL = '/merge-skills-handler'
NEW_COLLECTION_URL = '/collection-editor-handler/create_new'
NEW_EXPLORATION_URL = '/contributehandler/create_new'
NEW_QUESTION_URL = '/question-editor-handler/create_new'
NEW_SKILL_URL = '/skill-editor-handler/create_new'
TOPIC_EDITOR_STORY_URL = '/topic-editor-story-handler'
TOPIC_EDITOR_QUESTION_URL = '/topic-editor-question-handler'
NEW_TOPIC_URL = '/topic-editor-handler/create_new'
NOTIFICATIONS_DASHBOARD_URL = '/notifications'
PREFERENCES_URL = '/preferences'
PRACTICE_SESSION_URL_PREFIX = '/practice-session'
PRACTICE_SESSION_DATA_URL_PREFIX = '/practice-session/data'
PREFERENCES_DATA_URL = '/preferenceshandler/data'
QUESTION_EDITOR_DATA_URL_PREFIX = '/question-editor-handler/data'
QUESTION_SKILL_LINK_URL_PREFIX = '/manage-question-skill-link'
QUESTIONS_LIST_URL_PREFIX = '/questions-list-handler'
QUESTION_COUNT_URL_PREFIX = '/question-count-handler'
QUESTIONS_URL_PREFIX = '/question-player-handler'
RECENT_COMMITS_DATA_URL = '/recentcommitshandler/recent-commits'
RECENT_FEEDBACK_MESSAGES_DATA_URL = '/recent-feedback-messages'
...
REVIEW_TEST_DATA_URL_PREFIX = '/review-test-handler/data'
REVIEW_TEST_URL_PREFIX = '/review-test'
ROBOTS_TXT_URL = '/robots.txt'
SITE_LANGUAGE_DATA_URL = '/save-site-language'
SIGNUP_DATA_URL = '/signuphandler/data'
SIGNUP_URL = '/signup'
SKILL_DASHBOARD_DATA_URL = '/skills-dashboard/data'
SKILL_DATA_URL_PREFIX = '/skill_data_handler'
SKILL_EDITOR_DATA_URL_PREFIX = '/skill-editor-handler/data'
SKILL_EDITOR_URL_PREFIX = '/skill-editor'
SKILL_EDITOR_QUESTION_URL = '/skill-editor-question-handler'
SKILL_MASTERY_DATA_URL = '/skill-mastery-handler/data'
SKILL_RIGHTS_URL_PREFIX = '/skill-editor-handler/rights'
STORY_DATA_HANDLER = '/story-data-handler'
STORY_EDITOR_URL_PREFIX = '/story-editor'
STORY_EDITOR_DATA_URL_PREFIX = '/story-editor-handler/data'
STORY_PROGRESS_URL_PREFIX = '/story-progress-handler'
STORY_PUBLISH_HANDLER = '/story-publish-handler'
STORY_URL_FRAGMENT_HANDLER = '/story-url-fragment-handler'
STORY_VIEWER_URL_PREFIX = '/story'
SUBTOPIC_DATA_HANDLER = '/subtopic-data-handler'
SUBTOPIC_VIEWER_URL_PREFIX = '/subtopic'
SUGGESTION_ACTION_URL_PREFIX = '/suggestionactionhandler'
SUGGESTION_LIST_URL_PREFIX = '/suggestionlisthandler'
SUGGESTION_URL_PREFIX = '/suggestionhandler'
SUBSCRIBE_URL_PREFIX = '/subscribehandler'
SUBTOPIC_PAGE_EDITOR_DATA_URL_PREFIX = '/subtopic-page-editor-handler/data'
TOPIC_VIEWER_URL_PREFIX = (
    '/learn/<classroom_url_fragment>/<topic_url_fragment>')
TOPIC_DATA_HANDLER = '/topic-data-handler'
TOPIC_EDITOR_DATA_URL_PREFIX = '/topic-editor-handler/data'
TOPIC_EDITOR_URL_PREFIX = '/topic-editor'
TOPIC_NAME_HANDLER = '/topic-name-handler'
TOPIC_RIGHTS_URL_PREFIX = '/rightshandler/get_topic_rights'
TOPIC_SEND_MAIL_URL_PREFIX = '/rightshandler/send-topic-publish-mail'
TOPIC_STATUS_URL_PREFIX = '/rightshandler/change-topic-status'
TOPIC_URL_FRAGMENT_HANDLER = '/topic-url-fragment-handler'
TOPICS_AND_SKILLS_DASHBOARD_DATA_URL = '/topics-and-skills-dashboard/data'
UNASSIGN_SKILL_DATA_HANDLER_URL = '/topics-and-skills-dashboard/unassign-skill'
...
VALIDATE_STORY_EXPLORATIONS_URL_PREFIX = '/validate-story-explorations'
