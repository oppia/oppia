...
ROLE_ID_CONTRIBUTOR_DASHBOARD_TRANSLATION_ADMIN = (
    'CONTRIBUTOR_DASHBOARD_TRANSLATION_ADMIN')
ROLE_ID_CONTRIBUTOR_DASHBOARD_QUESTION_ADMIN = (
    'CONTRIBUTOR_DASHBOARD_QUESTION_ADMIN')
...
ALLOWED_USER_ROLES = [
    ...
    ROLE_ID_CONTRIBUTOR_DASHBOARD_TRANSLATION_ADMIN,
    ROLE_ID_CONTRIBUTOR_DASHBOARD_QUESTION_ADMIN, ROLE_ID_RELEASE_COORDINATOR,
    ROLE_ID_ADMIN]
