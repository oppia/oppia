...
SHOW_COLLECTION_NAVIGATION_TAB_MAIN = True
SHOW_COLLECTION_NAVIGATION_TAB_PREVIEW = True
SHOW_COLLECTION_NAVIGATION_TAB_SETTINGS = True
SHOW_COLLECTION_NAVIGATION_TAB_HISTORY = True
SHOW_COLLECTION_NAVIGATION_TAB_FEEDBACK = True
SHOW_COLLECTION_NAVIGATION_TAB_STATS = True
SHOW_COLLECTION_NAVIGATION_TAB_HELP = True
