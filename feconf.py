...
HTML_TYPE_FORMAT_SET = 'set'
HTML_TYPE_FORMAT_STRING = 'string'
HTML_TYPE_FORMAT_LIST_OF_SETS = 'listOfSets'

ALLOWED_HTML_TYPE_FORMATS = [
    HTML_TYPE_FORMAT_SET,
    HTML_TYPE_FORMAT_STRING,
    HTML_TYPE_FORMAT_LIST_OF_SETS
]
