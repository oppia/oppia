...
## MOBILE: Whether to run the acceptance test in mobile viewport. Defaults to false.
	@echo 'Shutting down any previously started server.'
	$(MAKE) stop
...
# Starting the development server for the acceptance tests.
	...
	cp -r ./core/tests/puppeteer-acceptance-tests/images ./core/tests/puppeteer-acceptance-tests/build/
