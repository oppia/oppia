...
# Starting the development server for the acceptance tests.
	...
	../oppia_tools/node-16.13.0/bin/node ./node_modules/.bin/jest --config="./core/tests/puppeteer-acceptance-tests/jest.config.js" ./core/tests/puppeteer-acceptance-tests/build/specs/$(suite).spec.js
	@echo '------------------------------------------------------'
