  ...
  (function() {
    function X(e) {
      ...
      if (x.readyState == "complete") e.call(n, "lazy");
        ...
        if (x.createEventObject && K.doScroll) {
          try {
            C = !n.frameElement
          } catch (A) {}
          C && j()
      ...
      S && X(function() {
        ...
        $(e ? function() {
          for (var j = 0; j < e; ++j)(function(e) {
            O(function() {
              n.exports[Q[e]].apply(n, arguments)
            }, 0)
          })(j)
        } : void 0)
      })
    }
    for (var n = window, O = n.setTimeout, x = document, K = x.documentElement, L = x.head || x.getElementsByTagName("head")[0] || K, z = "", A = x.getElementsByTagName("script"), m = A.length; --m >= 0;) {
      var M = A[m],
    ...
    z.replace(/[&?]([^&=]+)=([^&]+)/g, function(e, j, w) {
      ...
      j == "autorun" ? S = !/^[0fn]/i.test(w) : j == "lang" ? D.push(w) : j == "skin" ? N.push(w) : j == "callback" && Q.push(w)
    });
    m = 0;
    for (z = D.length; m < z; ++m)(function() {
      var e = x.createElement("script");
      e.onload = e.onerror = e.onreadystatechange = function() {
        if (e && (!e.readyState || /loaded|complete/.test(e.readyState))) e.onerror = e.onload = e.onreadystatechange = r, --R, R || O(P, 0), e.parentNode && e.parentNode.removeChild(e),
          e = r
      };
      e.type = "text/javascript";
      e.src = "https://cdn.rawgit.com/google/code-prettify/master/loader/lang-" + encodeURIComponent(D[m]) + ".js";
      L.insertBefore(e, L.firstChild)
    })(D[m]);
    for (var R = D.length, A = [], m = 0, z = N.length; m < z; ++m) A.push("https://cdn.rawgit.com/google/code-prettify/master/loader/skins/" + encodeURIComponent(N[m]) + ".css");
    A.push("https://cdn.rawgit.com/google/code-prettify/master/loader/prettify.css");
    (function(e) {
      function j(m) {
        if (m !== w) {
    ...
    var $ = function() {
      ...
      (function() {
        ...
        var V = window,
          ...
          K = [J, "alignof,align_union,asm,axiom,bool,concept,concept_map,const_cast,constexpr,decltype,delegate,dynamic_cast,explicit,export,friend,generic,late_check,mutable,namespace,nullptr,property,reinterpret_cast,static_assert,static_cast,template,typeid,typename,using,virtual,where"],
          Q = [J, "abstract,assert,boolean,byte,extends,final,finally,implements,import,instanceof,interface,null,native,package,strictfp,super,synchronized,throws,transient"],
          ...
          S = /\S/,
          T = t({
            keywords: [K, L, J, "caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END", M, N, G],
            hashComments: !0,
            cStyleComments: !0,
            multiLineStrings: !0,
            regexLiterals: !0
