...
class MigrateSkillJobTests(job_test_utils.JobTestBase):
    ...
    def setUp(self) -> None:
        ...
        self.latest_skill_contents = {
            'explanation': {'content_id': 'content_id', 'html': '<b>bo ld</b>'},
            'recorded_voiceovers': {'voiceovers_mapping': {'content_id': {}}},
            'written_translations': {
                'translations_mapping': {'content_id': {}}
            },
        }
        self.latest_rubrics = [
            {'difficulty': 'Easy', 'explanations': ['ab']},
            {'difficulty': 'Medium', 'explanations': ['a b']},
            {'difficulty': 'Hard', 'explanations': ['a b']},
        ]
    ...
    def test_unmigrated_skill_with_unmigrated_rubric_is_migrated(self) -> None:
        skill_model = self.create_model(
            ...
            rubrics=[
                {'difficulty': 'Easy', 'explanations': ['a\nb']},
                {'difficulty': 'Medium', 'explanations': ['a&nbsp;b']},
                {'difficulty': 'Hard', 'explanations': ['a&nbsp;b']},
            ],
            language_code='cs',
    ...
    def test_unmigrated_skill_with_unmigrated_misconceptions_is_migrated(
        ...
        self.assertEqual(
            migrated_skill_model.misconceptions, self.latest_misconceptions
        )
    ...
    def test_unmigrated_skill_with_unmigrated_skill_contents_is_migrated(
        ...
        self.assertEqual(
            migrated_skill_model.skill_contents, self.latest_skill_contents
        )
    ...
    def test_broken_skill_is_not_migrated(self) -> None:
        skill_model_one = self.create_model(
            ...
            rubrics=[
                {'difficulty': 'Easy', 'explanations': ['a\nb']},
                {'difficulty': 'aaa', 'explanations': ['a&nbsp;b']},
                {'difficulty': 'Hard', 'explanations': ['a&nbsp;b']},
            ],
            language_code='cs',
            skill_contents_schema_version=(
