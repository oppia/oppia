...
def get_story_from_model(
    ...
    return story_domain.Story(
        story_model.id,
        story_model.title,
        story_model.thumbnail_filename,
        story_model.thumbnail_bg_color,
        ...
        story_model.version,
        story_model.url_fragment,
        story_model.meta_tag_content,
...
def get_story_summary_from_model(
    ...
    return story_domain.StorySummary(
        story_summary_model.id,
        story_summary_model.title,
