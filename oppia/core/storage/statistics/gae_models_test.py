...
class AnswerSubmittedEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            stats_models.AnswerSubmittedEventLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.AnswerSubmittedEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class ExplorationActualStartEventLogEntryModelUnitTests(
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            stats_models.ExplorationActualStartEventLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.ExplorationActualStartEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            stats_models.ExplorationActualStartEventLogEntryModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class StartExplorationEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            stats_models.StartExplorationEventLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )

    def test_create_and_get_event_models(self) -> None:
        event_id = stats_models.StartExplorationEventLogEntryModel.create(
            'exp_id1',
            1,
            'state_name1',
            'session_id1',
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.StartExplorationEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class MaybeLeaveExplorationEventLogEntryModelUnitTests(
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            stats_models.MaybeLeaveExplorationEventLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.MaybeLeaveExplorationEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class CompleteExplorationEventLogEntryModelUnitTests(
    ...
    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            stats_models.CompleteExplorationEventLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )

    def test_create_and_get_event_models(self) -> None:
        event_id = stats_models.CompleteExplorationEventLogEntryModel.create(
            'exp_id1',
            1,
            'state_name1',
            'session_id1',
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.CompleteExplorationEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class RateExplorationEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    """Test the RateExplorationEventLogEntryModel class."""

    def test_get_deletion_policy(self) -> None:
        self.assertEqual(
            stats_models.RateExplorationEventLogEntryModel.get_deletion_policy(),
            base_models.DELETION_POLICY.NOT_APPLICABLE,
        )
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.RateExplorationEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
    ...
    def test_get_export_policy(self) -> None:
        ...
        self.assertEqual(
            stats_models.RateExplorationEventLogEntryModel.get_export_policy(),
            expected_export_policy_dict,
        )
...
class StateHitEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_create_and_get_event_models(self) -> None:
        event_id = stats_models.StateHitEventLogEntryModel.create(
            'exp_id1',
            1,
            'state_name1',
            'session_id1',
        ...
        event_model = stats_models.StateHitEventLogEntryModel.get(event_id)
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.StateHitEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class StateCompleteEventLogEntryModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.StateCompleteEventLogEntryModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class ExplorationIssuesModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_create_and_get_exp_issues_model(self) -> None:
        model_id = stats_models.ExplorationIssuesModel.create('exp_id1', 1, [])
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.ExplorationIssuesModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class LearnerAnswerDetailsModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.LearnerAnswerDetailsModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class ExplorationAnnotationsModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.ExplorationAnnotationsModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
...
class StateAnswersCalcOutputModelUnitTests(test_utils.GenericTestBase):
    ...
    def test_get_model_association_to_user(self) -> None:
        self.assertEqual(
            stats_models.StateAnswersCalcOutputModel.get_model_association_to_user(),
            base_models.MODEL_ASSOCIATION_TO_USER.NOT_CORRESPONDING_TO_USER,
        )
