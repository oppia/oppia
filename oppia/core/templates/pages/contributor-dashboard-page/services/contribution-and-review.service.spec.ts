...
describe('Contribution and review service', () => {
  ...
  const expectedSuggestion2Dict = {
    ...
    details:
      multiplePageBackendFetchResponse.target_id_to_opportunity_dict.skill_id_2,
  };
  const expectedSuggestion3Dict = {
    suggestion: suggestion3,
    details:
      multiplePageBackendFetchResponse.target_id_to_opportunity_dict.skill_id_3,
  };
    ...
    it('should fetch one page ahead and cache extra results', fakeAsync(() => {
      ...
      cars
        ...
        .then(response => {
          ...
          expect(response.suggestionIdToDetails.suggestion_id_2).toEqual(
      ...
      const expectedSuggestion4Dict = {
        ...
        details:
          suggestion4BackendFetchResponse.target_id_to_opportunity_dict
            .skill_id_4,
      };
      ...
      cars
        ...
        .then(response => {
          ...
          expect(response.suggestionIdToDetails.suggestion_id_4).toEqual(
  ...
  describe('getReviewableQuestionSuggestionsAsync', () => {
    it('should return available question suggestions and opportunity details', () => {
      ...
      cars
        .getReviewableQuestionSuggestionsAsync(true, 'sort_key', 'topicName')
        .then(response => {
          expect(response.suggestionIdToDetails.suggestion_id_1).toEqual(
            expectedSuggestionDict
          );
  ...
  describe('getReviewableTranslationSuggestionsAsync', () => {
    ...
    beforeEach(() => {
      ...
      mockSortTranslationSpy = spyOn(cars, 'sortTranslationSuggestionsByState');
    });
    it('should return translation suggestions and opportunity details', () => {
      fetchSuggestionsAsyncSpy.and.returnValue(
        Promise.resolve(backendFetchResponse)
    ...
    it(
      'should return translation suggestions for given ' + 'exploration',
      async () => {
        fetchSuggestionsAsyncSpy.and.returnValue(
          Promise.resolve(backendFetchResponse)
        );
        const fetchTranslationSuggestionsAsyncSpy = spyOn(
          cars,
          'fetchTranslationSuggestionsAsync'
        ).and.returnValue(
          Promise.resolve({
        ...
        cars
          .getReviewableTranslationSuggestionsAsync(true, 'skill_id_1', '1')
          .then(response => {
            expect(response.suggestionIdToDetails.skill_id_1).toEqual({
              suggestions: suggestion1,
              details: opportunityDict1,
            });
    ...
    it(
      'should correctly fetch translation suggestions and return ' +
      ...
      async () => {
        ...
        await cars.fetchTranslationSuggestionsAsync('1').then(response => {
  ...
  describe('reviewExplorationSuggestion', () => {
    ...
    it(
      'should call onFailure function when' +
        'resolving suggestion to exploration fails',
      fakeAsync(() => {
        spyOn(carbas, 'reviewExplorationSuggestionAsync').and.returnValue(
          Promise.reject({
  ...
  describe('updateTranslationSuggestionAsync', () => {
    ...
    it(
      'should call onSuccess function when' +
        'updateTranslationSuggestionAsync succeeds',
      fakeAsync(() => {
        spyOn(carbas, 'updateTranslationSuggestionAsync').and.returnValue(
          Promise.resolve()
        );
        ...
        expect(carbas.updateTranslationSuggestionAsync).toHaveBeenCalledWith(
          'pqr',
          requestBody
        );
    ...
    it(
      'should call onFailure function when' +
        'updateTranslationSuggestionAsync fails',
      fakeAsync(() => {
        spyOn(carbas, 'updateTranslationSuggestionAsync').and.returnValue(
          Promise.reject()
        );
  ...
  describe('updateQuestionSuggestionAsync', () => {
    ...
    it(
      'should call onSuccess function when' +
        'updateQuestionSuggestionAsync succeeds',
      fakeAsync(() => {
        spyOn(carbas, 'updateQuestionSuggestionAsync').and.returnValue(
          Promise.resolve()
        );
        ...
        expect(carbas.updateQuestionSuggestionAsync).toHaveBeenCalledWith(
          'pqr',
          requestBody
        );
        expect(onSuccess).toHaveBeenCalledWith('pqr');
    ...
    it(
      'should call onFailure function when' +
        'updateQuestionSuggestionAsync fails',
      fakeAsync(() => {
        spyOn(carbas, 'updateQuestionSuggestionAsync').and.returnValue(
          Promise.reject()
        );
