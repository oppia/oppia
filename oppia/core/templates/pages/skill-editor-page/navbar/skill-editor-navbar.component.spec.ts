...
describe('Skill Editor Navbar Component', () => {
  ...
  beforeEach(() => {
    ...
    spyOnProperty(
      skillUpdateService,
      'onPrerequisiteSkillChange'
    ).and.returnValue(mockPrerequisiteSkillChangeEventEmitter);
  });
  ...
  it(
    'should get current active tab name when ' + "calling 'getActiveTabName'",
    () => {
  ...
  it(
    ...
    () => {
      spyOn(skillEditorStateService, 'isLoadingSkill').and.returnValue(false);
  ...
  it(
    'should check whether the skill is being saved when ' +
      "calling 'isSaveInProgress '",
    () => {
      spyOn(skillEditorStateService, 'isSavingSkill').and.returnValue(false);
  ...
  it(
    'should get change list count when calling ' + "'getChangeListCount'",
    () => {
      spyOn(undoRedoService, 'getChangeCount').and.returnValue(2);
  ...
  it(
    'should get number of warnings when calling ' + "'getWarningsCount'",
    () => {
      spyOn(
        skillEditorStateService,
  ...
  it(
    'should check whether the skill is saveable when ' +
  ...
  it(
    'should toggle navigation options when calling ' +
  ...
  it('should navigate to main tab when ' + "calling 'selectMainTab'", () => {
  ...
  it('should navigate to main tab when ' + "calling 'selectPreviewTab'", () => {
  ...
  it(
    'should toggle skill edit options when calling ' +
  ...
  describe('on navigating to questions tab ', () => {
    it(
      'should open undo changes modal if there are unsaved ' + 'changes',
      fakeAsync(() => {
    ...
    it(
      'should close undo changes modal if somewhere outside is' + ' clicked',
      fakeAsync(() => {
        // Setting unsaved changes to be two.
        spyOn(undoRedoService, 'getChangeCount').and.returnValue(2);
        const ngbModalSpy = spyOn(ngbModal, 'open').and.callFake((dlg, opt) => {
    ...
    it(
      'should navigate to questions tab if there are no unsaved ' + 'changes',
      () => {
