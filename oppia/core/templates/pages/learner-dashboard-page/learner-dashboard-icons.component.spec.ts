...
describe('Learner Dashboard Icons Component', () => {
  ...
  let learnerDashboardIdsBackendApiService: LearnerDashboardIdsBackendApiService;
  ...
  beforeEach(() => {
    ...
    learnerDashboardIdsBackendApiService = TestBed.inject(
      LearnerDashboardIdsBackendApiService
    );
  ...
  it('should intialize the component and set values', fakeAsync(() => {
    ...
    expect(component.learnerDashboardActivityIds).toBe(
  ...
  it(
    'should return true if the activity can be added to' + ' learner playlist',
    fakeAsync(() => {
  ...
  it(
    'should return false if the activity can not be added to' +
      ' learner playlist',
    fakeAsync(() => {
      component.isContainerNarrow = true;
      component.learnerDashboardActivityIds =
  ...
  it(
    'should return true if the curent exploration belongs to the' +
      ' learner playlist',
    fakeAsync(() => {
  ...
  it(
    'should return true if the curent collection belongs to the' +
      ' learner playlist',
    fakeAsync(() => {
  ...
  it(
    'should return true if the curent story belongs to the' +
      ' completed playlist',
    fakeAsync(() => {
  ...
  it(
    'should return true if the curent topic belongs to the' +
      ' learnt playlist',
    fakeAsync(() => {
  ...
  it(
    'should return false if the curent exploration belongs to the' +
      ' learner playlist',
    fakeAsync(() => {
      component.activityType = 'exploration';
      component.activityId = '1';
  ...
  it(
    'should return false if the curent collection belongs to the' +
      ' learner playlist',
    fakeAsync(() => {
      component.activityType = 'collection';
      component.activityId = '1';
  ...
  it(
    'should return false if the curent story belongs to the' +
      ' completed playlist',
    fakeAsync(() => {
      component.activityType = 'story';
      component.activityId = '1';
  ...
  it(
    'should return false if the curent topic belongs to the' +
      ' learnt playlist',
    fakeAsync(() => {
      component.activityType = 'learntopic';
      component.activityId = '1';
  ...
  it(
    'should open a modal for removing exploration from' + ' learner playlist',
    fakeAsync(() => {
      const learnerDashboardActivityIds =
        LearnerDashboardActivityIds.createFromBackendDict({
          incomplete_exploration_ids: [],
          incomplete_collection_ids: [],
          completed_exploration_ids: [],
  ...
  it(
    'should open a modal for removing collection from' + ' learner playlist',
    fakeAsync(() => {
      const learnerDashboardActivityIds =
        LearnerDashboardActivityIds.createFromBackendDict({
          incomplete_exploration_ids: [],
  ...
  it(
    ...
    fakeAsync(() => {
      ...
      component.removeFromLearnerPlaylist('0', 'title', 'exploration');
      expect(modalSpy).toHaveBeenCalled();
      flushMicrotasks();
  ...
  it(
    ...
    fakeAsync(() => {
      ...
      component.removeFromLearnerPlaylist('0', 'title', 'collection');
      flushMicrotasks();
  ...
  it('should add exploration to learner playlist', fakeAsync(() => {
    ...
    const learnerPlaylistSpy = spyOn(
      learnerDashboardActivityBackendApiService,
      'addToLearnerPlaylist'
    ).and.returnValue(Promise.resolve(true));

    component.addToLearnerPlaylist(activityId, activityType);
    ...
    expect(learnerPlaylistSpy).toHaveBeenCalled();
    expect(
      component.learnerDashboardActivityIds.explorationPlaylistIds
    ).toEqual(['1']);
  }));
  ...
  it('should add collection to learner playlist', fakeAsync(() => {
    ...
    expect(learnerPlaylistSpy).toHaveBeenCalled();
    expect(component.learnerDashboardActivityIds.collectionPlaylistIds).toEqual(
      ['1']
    );
  }));
