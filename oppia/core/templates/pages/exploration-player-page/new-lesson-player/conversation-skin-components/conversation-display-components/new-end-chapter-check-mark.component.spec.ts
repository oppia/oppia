...
import {NewEndChapterCheckMarkComponent} from './new-end-chapter-check-mark.component';

describe('End chapter check mark component', function () {
  let component: NewEndChapterCheckMarkComponent;
  let fixture: ComponentFixture<NewEndChapterCheckMarkComponent>;

  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [NewEndChapterCheckMarkComponent],
    }).compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(NewEndChapterCheckMarkComponent);
