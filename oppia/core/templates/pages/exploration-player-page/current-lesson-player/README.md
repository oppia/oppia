# ⚠️ Deprecated Folder Warning

This folder contains files and sub-directories that are **deprecated** and will be **removed** once the new Lesson Player is fully launched.
...
You can track the development status and rollout progress of the New Lesson Player via:
...
**Avoid adding new files to this folder.**  
If you **must** add or modify files here, please contact:

📧 Hardik Goyal — [hardikgoyal2003@gmail.com](mailto:hardikgoyal2003@gmail.com)
