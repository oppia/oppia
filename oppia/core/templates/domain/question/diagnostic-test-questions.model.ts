...
/**
 * @fileoverview Model for creating an object for the diagnostic test question
...
export class DiagnosticTestQuestionsModel {
  ...
  getMainQuestion(): Question {
    return this._mainQuestion;
  }

  getBackupQuestion(): Question {
    return this._backupQuestion;
  }
}
