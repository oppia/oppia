...
describe('Pretest question backend API service', function () {
  ...
  it('should successfully fetch pretest questions from the backend', fakeAsync(() => {
    var successHandler = jasmine.createSpy('success');
    var failHandler = jasmine.createSpy('fail');

    pretestQuestionBackendApiService
      .fetchPretestQuestionsAsync('expId', 'story-fragment')
  ...
  it(
    'should return empty list if we fetch pretest ' +
      'question with invalid url fragment',
    fakeAsync(() => {
      ...
      pretestQuestionBackendApiService
        .fetchPretestQuestionsAsync('expId', invalidUrl)
        .then(successHandler, failHandler);
      flushMicrotasks();
