...
describe('Skill Editor functionality', function () {
  ...
  it('should edit rubrics for the skill', async function () {
    await skillEditorPage.addRubricExplanationForDifficulty(
      'Easy',
      'Explanation for easy difficulty'
    );
    await skillEditorPage.addRubricExplanationForDifficulty(
      'Medium',
      'Explanation for medium difficulty'
    );
    await skillEditorPage.addRubricExplanationForDifficulty(
      'Hard',
      'Explanation for hard difficulty'
    );

    await skillEditorPage.expectRubricExplanationsToMatch('Easy', [
      'Explanation for easy difficulty',
    ]);
    await skillEditorPage.expectRubricExplanationsToMatch('Medium', [
      'Skill 1',
      'Explanation for medium difficulty',
    ]);
    await skillEditorPage.expectRubricExplanationsToMatch('Hard', [
      'Explanation for hard difficulty',
    ]);
    ...
    await skillEditorPage.addRubricExplanationForDifficulty(
      'Medium',
      'Second explanation for medium difficulty.'
    );
    await skillEditorPage.addRubricExplanationForDifficulty(
      'Hard',
      'Second explanation for hard difficulty.'
    );

    await skillEditorPage.editRubricExplanationWithIndex(
      'Easy',
      0,
      'Easy explanation 1 edited'
    );
    await skillEditorPage.editRubricExplanationWithIndex(
      'Easy',
      1,
      'Easy explanation 2 edited'
    );
    await skillEditorPage.editRubricExplanationWithIndex(
      'Medium',
      1,
      'Medium explanation 1 edited'
    );
    await skillEditorPage.editRubricExplanationWithIndex(
      'Medium',
      2,
      'Medium explanation 2 edited'
    );
    await skillEditorPage.deleteRubricExplanationWithIndex('Medium', 0);
    await skillEditorPage.editRubricExplanationWithIndex(
      'Hard',
      0,
      'Hard explanation 1 edited'
    );
    await skillEditorPage.editRubricExplanationWithIndex(
      'Hard',
      1,
      'Hard explanation 2 edited'
    );
  ...
  it('should show stale tab and unsaved changes status info modals', async function () {
    await topicsAndSkillsDashboardPage.get();
    var handle = await browser.getWindowHandle();
    await topicsAndSkillsDashboardPage.createSkillWithDescriptionAndExplanation(
      'Skill 2',
    ...
    await topicsAndSkillsDashboardPage.navigateToSkillWithDescription(
      'Skill 2'
    );
