...
class ImageContext(proto.Message):
    ...
    Attributes:
        lat_long_rect (google.cloud.vision_v1p4beta1.types.LatLongRect):
            Not used.
        ...
        crop_hints_params (google.cloud.vision_v1p4beta1.types.CropHintsParams):
            Parameters for crop hints annotation request.
        face_recognition_params (google.cloud.vision_v1p4beta1.types.FaceRecognitionParams):
            Parameters for face recognition.
        product_search_params (google.cloud.vision_v1p4beta1.types.ProductSearchParams):
            Parameters for product search.
        web_detection_params (google.cloud.vision_v1p4beta1.types.WebDetectionParams):
            Parameters for web detection.
        text_detection_params (google.cloud.vision_v1p4beta1.types.TextDetectionParams):
    ...
    face_recognition_params: face.FaceRecognitionParams = proto.Field(
        proto.MESSAGE,
        number=10,
        message=face.FaceRecognitionParams,
    )
...
class AnnotateImageRequest(proto.Message):
    ...
    Attributes:
        image (google.cloud.vision_v1p4beta1.types.Image):
            The image to be processed.
        features (MutableSequence[google.cloud.vision_v1p4beta1.types.Feature]):
            Requested features.
        image_context (google.cloud.vision_v1p4beta1.types.ImageContext):
...
class AnnotateImageResponse(proto.Message):
    ...
    Attributes:
        face_annotations (MutableSequence[google.cloud.vision_v1p4beta1.types.FaceAnnotation]):
            If present, face detection has completed
            successfully.
        landmark_annotations (MutableSequence[google.cloud.vision_v1p4beta1.types.EntityAnnotation]):
            If present, landmark detection has completed
            successfully.
        logo_annotations (MutableSequence[google.cloud.vision_v1p4beta1.types.EntityAnnotation]):
            If present, logo detection has completed
            successfully.
        label_annotations (MutableSequence[google.cloud.vision_v1p4beta1.types.EntityAnnotation]):
            If present, label detection has completed
            successfully.
        localized_object_annotations (MutableSequence[google.cloud.vision_v1p4beta1.types.LocalizedObjectAnnotation]):
            If present, localized object detection has
            completed successfully. This will be sorted
            descending by confidence score.
        text_annotations (MutableSequence[google.cloud.vision_v1p4beta1.types.EntityAnnotation]):
            If present, text (OCR) detection has
            completed successfully.
        full_text_annotation (google.cloud.vision_v1p4beta1.types.TextAnnotation):
        ...
        safe_search_annotation (google.cloud.vision_v1p4beta1.types.SafeSearchAnnotation):
            If present, safe-search annotation has
            completed successfully.
        image_properties_annotation (google.cloud.vision_v1p4beta1.types.ImageProperties):
            If present, image properties were extracted
            successfully.
        crop_hints_annotation (google.cloud.vision_v1p4beta1.types.CropHintsAnnotation):
            If present, crop hints have completed
            successfully.
        web_detection (google.cloud.vision_v1p4beta1.types.WebDetection):
            If present, web detection has completed
            successfully.
        product_search_results (google.cloud.vision_v1p4beta1.types.ProductSearchResults):
        ...
        context (google.cloud.vision_v1p4beta1.types.ImageAnnotationContext):
...
class BatchAnnotateImagesResponse(proto.Message):
    ...
    Attributes:
        responses (MutableSequence[google.cloud.vision_v1p4beta1.types.AnnotateImageResponse]):
...
class AnnotateFileRequest(proto.Message):
    ...
    Attributes:
        input_config (google.cloud.vision_v1p4beta1.types.InputConfig):
...
class BatchAnnotateFilesRequest(proto.Message):
    ...
    Attributes:
        requests (MutableSequence[google.cloud.vision_v1p4beta1.types.AnnotateFileRequest]):
...
class BatchAnnotateFilesResponse(proto.Message):
    ...
    Attributes:
        responses (MutableSequence[google.cloud.vision_v1p4beta1.types.AnnotateFileResponse]):
...
class AsyncBatchAnnotateFilesResponse(proto.Message):
    ...
    Attributes:
        responses (MutableSequence[google.cloud.vision_v1p4beta1.types.AsyncAnnotateFileResponse]):
...
class InputConfig(proto.Message):
    ...
    Attributes:
        gcs_source (google.cloud.vision_v1p4beta1.types.GcsSource):
...
class OutputConfig(proto.Message):
    ...
    Attributes:
        gcs_destination (google.cloud.vision_v1p4beta1.types.GcsDestination):
...
class OperationMetadata(proto.Message):
    ...
    Attributes:
        state (google.cloud.vision_v1p4beta1.types.OperationMetadata.State):
