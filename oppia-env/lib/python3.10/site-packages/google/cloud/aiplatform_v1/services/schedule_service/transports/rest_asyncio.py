...
from .rest_base import _BaseScheduleServiceRestTransport
...
class AsyncScheduleServiceRestInterceptor:
    """Asynchronous Interceptor for ScheduleService.
    ...
    * Stripping extraneous information from responses
    ...
    instance of a custom subclass when constructing the AsyncScheduleServiceRestTransport.

    .. code-block:: python
        class MyCustomScheduleServiceInterceptor(ScheduleServiceRestInterceptor):
            async def pre_create_schedule(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_create_schedule(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_delete_schedule(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_delete_schedule(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_get_schedule(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_get_schedule(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_list_schedules(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_list_schedules(self, response):
                logging.log(f"Received response: {response}")
                return response

            async def pre_pause_schedule(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def pre_resume_schedule(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def pre_update_schedule(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            async def post_update_schedule(self, response):
                logging.log(f"Received response: {response}")
                return response

        transport = AsyncScheduleServiceRestTransport(interceptor=MyCustomScheduleServiceInterceptor())
        client = async ScheduleServiceClient(transport=transport)


    """

    async def pre_create_schedule(
        self,
        request: schedule_service.CreateScheduleRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        schedule_service.CreateScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    async def pre_delete_schedule(
        ...
        schedule_service.DeleteScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    async def post_delete_schedule(
    ...
    async def pre_get_schedule(
        ...
        schedule_service.GetScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    async def pre_list_schedules(
        ...
        schedule_service.ListSchedulesRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    async def pre_pause_schedule(
        ...
        schedule_service.PauseScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    async def pre_resume_schedule(
        self,
        request: schedule_service.ResumeScheduleRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        schedule_service.ResumeScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    async def pre_update_schedule(
        self,
        request: schedule_service.UpdateScheduleRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        schedule_service.UpdateScheduleRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
    ...
    async def post_update_schedule(
        self, response: gca_schedule.Schedule
    ) -> gca_schedule.Schedule:
...
class AsyncScheduleServiceRestStub:
    _session: AsyncAuthorizedSession
    _host: str
    _interceptor: AsyncScheduleServiceRestInterceptor


class AsyncScheduleServiceRestTransport(_BaseScheduleServiceRestTransport):
    """Asynchronous REST backend transport for ScheduleService.
    ...
    def __init__(
        ...
        *,
        ...
        interceptor: Optional[AsyncScheduleServiceRestInterceptor] = None,
    ) -> None:
        ...
        self._interceptor = interceptor or AsyncScheduleServiceRestInterceptor()
    ...
    class _CreateSchedule(
        _BaseScheduleServiceRestTransport._BaseCreateSchedule,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.CreateSchedule")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseCreateSchedule._get_http_options()
            )

            request, metadata = await self._interceptor.pre_create_schedule(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseCreateSchedule._get_transcoded_request(
                http_options, request
            )

            body = _BaseScheduleServiceRestTransport._BaseCreateSchedule._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseCreateSchedule._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.CreateSchedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "CreateSchedule",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._CreateSchedule._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = gca_schedule.Schedule.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.create_schedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "CreateSchedule",
    ...
    class _DeleteSchedule(
        _BaseScheduleServiceRestTransport._BaseDeleteSchedule,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.DeleteSchedule")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseDeleteSchedule._get_http_options()
            )

            request, metadata = await self._interceptor.pre_delete_schedule(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseDeleteSchedule._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseDeleteSchedule._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.DeleteSchedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "DeleteSchedule",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._DeleteSchedule._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.delete_schedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "DeleteSchedule",
                        "metadata": http_response["headers"],
    ...
    class _GetSchedule(
        _BaseScheduleServiceRestTransport._BaseGetSchedule, AsyncScheduleServiceRestStub
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.GetSchedule")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseGetSchedule._get_http_options()
            )

            request, metadata = await self._interceptor.pre_get_schedule(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseGetSchedule._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseGetSchedule._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.GetSchedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "GetSchedule",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._GetSchedule._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = schedule.Schedule.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.get_schedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "GetSchedule",
                        "metadata": http_response["headers"],
    ...
    class _ListSchedules(
        _BaseScheduleServiceRestTransport._BaseListSchedules,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.ListSchedules")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseListSchedules._get_http_options()
            )

            request, metadata = await self._interceptor.pre_list_schedules(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseListSchedules._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseListSchedules._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.ListSchedules",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "ListSchedules",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._ListSchedules._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = schedule_service.ListSchedulesResponse.to_json(
                        response
                    )
                except:
                    response_payload = None
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.list_schedules",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "ListSchedules",
                        "metadata": http_response["headers"],
    ...
    class _PauseSchedule(
        _BaseScheduleServiceRestTransport._BasePauseSchedule,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.PauseSchedule")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BasePauseSchedule._get_http_options()
            )

            request, metadata = await self._interceptor.pre_pause_schedule(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BasePauseSchedule._get_transcoded_request(
                http_options, request
            )

            body = _BaseScheduleServiceRestTransport._BasePauseSchedule._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BasePauseSchedule._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.PauseSchedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "PauseSchedule",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._PauseSchedule._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _ResumeSchedule(
        _BaseScheduleServiceRestTransport._BaseResumeSchedule,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.ResumeSchedule")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseResumeSchedule._get_http_options()
            )

            request, metadata = await self._interceptor.pre_resume_schedule(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseResumeSchedule._get_transcoded_request(
                http_options, request
            )

            body = _BaseScheduleServiceRestTransport._BaseResumeSchedule._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseResumeSchedule._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.ResumeSchedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "ResumeSchedule",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._ResumeSchedule._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _UpdateSchedule(
        ...
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.UpdateSchedule")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseUpdateSchedule._get_http_options()
            )

            request, metadata = await self._interceptor.pre_update_schedule(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseUpdateSchedule._get_transcoded_request(
                http_options, request
            )

            body = _BaseScheduleServiceRestTransport._BaseUpdateSchedule._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseUpdateSchedule._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.UpdateSchedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "UpdateSchedule",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._UpdateSchedule._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.update_schedule",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "UpdateSchedule",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(
        _BaseScheduleServiceRestTransport._BaseGetLocation, AsyncScheduleServiceRestStub
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.GetLocation")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseGetLocation._get_http_options()
            )

            request, metadata = await self._interceptor.pre_get_location(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseGetLocation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseGetLocation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._GetLocation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(
        ...
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.ListLocations")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseListLocations._get_http_options()
            )

            request, metadata = await self._interceptor.pre_list_locations(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseListLocations._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseListLocations._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._ListLocations._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _GetIamPolicy(
        _BaseScheduleServiceRestTransport._BaseGetIamPolicy,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.GetIamPolicy")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseGetIamPolicy._get_http_options()
            )

            request, metadata = await self._interceptor.pre_get_iam_policy(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseGetIamPolicy._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._GetIamPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        _BaseScheduleServiceRestTransport._BaseSetIamPolicy,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.SetIamPolicy")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseSetIamPolicy._get_http_options()
            )

            request, metadata = await self._interceptor.pre_set_iam_policy(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(
                http_options, request
            )

            body = _BaseScheduleServiceRestTransport._BaseSetIamPolicy._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseSetIamPolicy._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._SetIamPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        ...
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.TestIamPermissions")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseTestIamPermissions._get_http_options()
            )

            request, metadata = await self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = await AsyncScheduleServiceRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(
        _BaseScheduleServiceRestTransport._BaseCancelOperation,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.CancelOperation")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseCancelOperation._get_http_options()
            )

            request, metadata = await self._interceptor.pre_cancel_operation(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseCancelOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseCancelOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._CancelOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _DeleteOperation(
        _BaseScheduleServiceRestTransport._BaseDeleteOperation,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.DeleteOperation")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseDeleteOperation._get_http_options()
            )

            request, metadata = await self._interceptor.pre_delete_operation(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseDeleteOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseDeleteOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._DeleteOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetOperation(
        _BaseScheduleServiceRestTransport._BaseGetOperation,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.GetOperation")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseGetOperation._get_http_options()
            )

            request, metadata = await self._interceptor.pre_get_operation(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseGetOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseGetOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._GetOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(
        _BaseScheduleServiceRestTransport._BaseListOperations,
        AsyncScheduleServiceRestStub,
    ):
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.ListOperations")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseListOperations._get_http_options()
            )

            request, metadata = await self._interceptor.pre_list_operations(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseListOperations._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseListOperations._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._ListOperations._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
    ...
    class _WaitOperation(
        ...
        def __hash__(self):
            return hash("AsyncScheduleServiceRestTransport.WaitOperation")
        ...
        async def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseScheduleServiceRestTransport._BaseWaitOperation._get_http_options()
            )

            request, metadata = await self._interceptor.pre_wait_operation(
                request, metadata
            )
            transcoded_request = _BaseScheduleServiceRestTransport._BaseWaitOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseScheduleServiceRestTransport._BaseWaitOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1.ScheduleServiceClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
            ...
            # Send the request
            response = (
                await AsyncScheduleServiceRestTransport._WaitOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ScheduleServiceAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ScheduleService",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
