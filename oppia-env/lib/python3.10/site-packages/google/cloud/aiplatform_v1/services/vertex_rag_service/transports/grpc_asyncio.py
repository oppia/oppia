...
class VertexRagServiceGrpcAsyncIOTransport(VertexRagServiceTransport):
    ...
    def retrieve_contexts(
        ...
        if "retrieve_contexts" not in self._stubs:
            self._stubs["retrieve_contexts"] = self._logged_channel.unary_unary(
    ...
    def augment_prompt(
        ...
        if "augment_prompt" not in self._stubs:
            self._stubs["augment_prompt"] = self._logged_channel.unary_unary(
    ...
    def corroborate_content(
        ...
        if "corroborate_content" not in self._stubs:
            self._stubs["corroborate_content"] = self._logged_channel.unary_unary(
