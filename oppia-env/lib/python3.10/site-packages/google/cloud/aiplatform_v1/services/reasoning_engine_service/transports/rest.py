...
class ReasoningEngineServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_update_reasoning_engine(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
...
class ReasoningEngineServiceRestTransport(_BaseReasoningEngineServiceRestTransport):
    ...
    class _CreateReasoningEngine(
        ...
        ReasoningEngineServiceRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._CreateReasoningEngine._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineServiceClient.create_reasoning_engine",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineService",
                        "rpcName": "CreateReasoningEngine",
    ...
    class _DeleteReasoningEngine(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._DeleteReasoningEngine._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineServiceClient.delete_reasoning_engine",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineService",
                        "rpcName": "DeleteReasoningEngine",
                        "metadata": http_response["headers"],
    ...
    class _GetReasoningEngine(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ReasoningEngineServiceRestTransport._GetReasoningEngine._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineServiceClient.get_reasoning_engine",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineService",
                        "rpcName": "GetReasoningEngine",
                        "metadata": http_response["headers"],
    ...
    class _ListReasoningEngines(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ReasoningEngineServiceRestTransport._ListReasoningEngines._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineServiceClient.list_reasoning_engines",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineService",
                        "rpcName": "ListReasoningEngines",
                        "metadata": http_response["headers"],
    ...
    class _UpdateReasoningEngine(
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_update_reasoning_engine(
                request, metadata
            )
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._UpdateReasoningEngine._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.ReasoningEngineServiceClient.update_reasoning_engine",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.ReasoningEngineService",
                        "rpcName": "UpdateReasoningEngine",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._GetLocation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _ListLocations(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._ListLocations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _GetIamPolicy(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _SetIamPolicy(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _TestIamPermissions(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ReasoningEngineServiceRestTransport._TestIamPermissions._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _CancelOperation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ReasoningEngineServiceRestTransport._CancelOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _DeleteOperation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ReasoningEngineServiceRestTransport._DeleteOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetOperation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._GetOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _ListOperations(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ReasoningEngineServiceRestTransport._ListOperations._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _WaitOperation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ReasoningEngineServiceRestTransport._WaitOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
