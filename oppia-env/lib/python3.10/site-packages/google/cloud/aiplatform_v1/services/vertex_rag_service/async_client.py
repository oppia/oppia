...
class VertexRagServiceAsyncClient:
    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.aiplatform_v1.VertexRagServiceAsyncClient`.",
                extra={
    ...
    async def retrieve_contexts(
        ...
        *,
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.RetrieveContextsRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            query (:class:`google.cloud.aiplatform_v1.types.RagQuery`):
        ...
        Returns:
            google.cloud.aiplatform_v1.types.RetrieveContextsResponse:
    ...
    async def augment_prompt(
        self,
        request: Optional[Union[vertex_rag_service.AugmentPromptRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        model: Optional[vertex_rag_service.AugmentPromptRequest.Model] = None,
        vertex_rag_store: Optional[tool.VertexRagStore] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> vertex_rag_service.AugmentPromptResponse:
        r"""Given an input prompt, it returns augmented prompt
        ...
        .. code-block:: python
            ...
            async def sample_augment_prompt():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.AugmentPromptRequest(
                    parent="parent_value",
                )

                # Make the request
                response = await client.augment_prompt(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.AugmentPromptRequest, dict]]):
                The request object. Request message for AugmentPrompt.
            parent (:class:`str`):
                Required. The resource name of the Location from which
                to augment prompt. The users must have permission to
                make a call in the project. Format:
                ``projects/{project}/locations/{location}``.

                This corresponds to the ``parent`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            model (:class:`google.cloud.aiplatform_v1.types.AugmentPromptRequest.Model`):
                Optional. Metadata of the backend
                deployed model.

                This corresponds to the ``model`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            vertex_rag_store (:class:`google.cloud.aiplatform_v1.types.VertexRagStore`):
                Optional. Retrieves contexts from the
                Vertex RagStore.

                This corresponds to the ``vertex_rag_store`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.cloud.aiplatform_v1.types.AugmentPromptResponse:
                Response message for AugmentPrompt.
        """
        # Create or coerce a protobuf request object.
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, model, vertex_rag_store]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, vertex_rag_service.AugmentPromptRequest):
            request = vertex_rag_service.AugmentPromptRequest(request)
        ...
        if model is not None:
            request.model = model
        if vertex_rag_store is not None:
            request.vertex_rag_store = vertex_rag_store

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.augment_prompt
        ]
    ...
    async def corroborate_content(
        self,
        request: Optional[
            Union[vertex_rag_service.CorroborateContentRequest, dict]
        ] = None,
        *,
        parent: Optional[str] = None,
        content: Optional[gca_content.Content] = None,
        facts: Optional[MutableSequence[vertex_rag_service.Fact]] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> vertex_rag_service.CorroborateContentResponse:
        r"""Given an input text, it returns a score that
        ...
        .. code-block:: python
            ...
            async def sample_corroborate_content():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1.CorroborateContentRequest(
                    parent="parent_value",
                )

                # Make the request
                response = await client.corroborate_content(request=request)

                # Handle the response
                print(response)

        Args:
            request (Optional[Union[google.cloud.aiplatform_v1.types.CorroborateContentRequest, dict]]):
                The request object. Request message for
                CorroborateContent.
            parent (:class:`str`):
                Required. The resource name of the Location from which
                to corroborate text. The users must have permission to
                make a call in the project. Format:
                ``projects/{project}/locations/{location}``.
            ...
            content (:class:`google.cloud.aiplatform_v1.types.Content`):
                Optional. Input content to
                corroborate, only text format is
                supported for now.

                This corresponds to the ``content`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            facts (:class:`MutableSequence[google.cloud.aiplatform_v1.types.Fact]`):
                Optional. Facts used to generate the
                text can also be used to corroborate the
                text.

                This corresponds to the ``facts`` field
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            retry (google.api_core.retry_async.AsyncRetry): Designation of what errors, if any,
                should be retried.
        ...
        Returns:
            google.cloud.aiplatform_v1.types.CorroborateContentResponse:
                Response message for
                CorroborateContent.
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, content, facts]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, vertex_rag_service.CorroborateContentRequest):
            request = vertex_rag_service.CorroborateContentRequest(request)
        ...
        if facts:
            request.facts.extend(facts)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._client._transport._wrapped_methods[
            self._client._transport.corroborate_content
        ]
