        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SpecialistPoolServiceAsyncClient.create_specialist_pool",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SpecialistPoolService",
                        "rpcName": "CreateSpecialistPool",
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SpecialistPoolServiceAsyncClient.delete_specialist_pool",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SpecialistPoolService",
                        "rpcName": "DeleteSpecialistPool",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SpecialistPoolServiceAsyncClient.get_specialist_pool",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SpecialistPoolService",
                        "rpcName": "GetSpecialistPool",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SpecialistPoolServiceAsyncClient.list_specialist_pools",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SpecialistPoolService",
                        "rpcName": "ListSpecialistPools",
                        "metadata": http_response["headers"],
        ...
        async def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1.SpecialistPoolServiceAsyncClient.update_specialist_pool",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1.SpecialistPoolService",
                        "rpcName": "UpdateSpecialistPool",
                        "metadata": http_response["headers"],
