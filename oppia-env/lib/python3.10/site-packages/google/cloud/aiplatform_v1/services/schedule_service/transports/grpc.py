...
class ScheduleServiceGrpcTransport(ScheduleServiceTransport):
    ...
    def pause_schedule(
        ...
        if "pause_schedule" not in self._stubs:
            self._stubs["pause_schedule"] = self._logged_channel.unary_unary(
    ...
    def resume_schedule(
        ...
        if "resume_schedule" not in self._stubs:
            self._stubs["resume_schedule"] = self._logged_channel.unary_unary(
    ...
    def update_schedule(
        ...
        if "update_schedule" not in self._stubs:
            self._stubs["update_schedule"] = self._logged_channel.unary_unary(
