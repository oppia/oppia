...
class DatastoreClient(metaclass=DatastoreClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = DatastoreClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = DatastoreClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = DatastoreClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = DatastoreClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, DatastoreTransport)
        if transport_provided:
            ...
            self._transport = cast(DatastoreTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = self._api_endpoint or DatastoreClient._get_api_endpoint(
