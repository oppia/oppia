...
try:
    from .transports.rest_asyncio import AsyncSessionServiceRestTransport
...
class SessionServiceClient(metaclass=SessionServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            api_endpoint = SessionServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def __init__(
        ...
        *,
        ...
        self._universe_domain = SessionServiceClient._get_universe_domain(
        ...
        self._api_endpoint = (
            self._api_endpoint
            or SessionServiceClient._get_api_endpoint(
        ...
        if not transport_provided:
            transport_init: Union[
                Type[SessionServiceTransport], Callable[..., SessionServiceTransport]
            ] = (
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.aiplatform_v1beta1.SessionServiceClient`.",
                    extra={
    ...
    def create_session(
        self,
        request: Optional[Union[session_service.CreateSessionRequest, dict]] = None,
        *,
        ...
        .. code-block:: python
            ...
            def sample_create_session():
                # Create a client
                client = aiplatform_v1beta1.SessionServiceClient()
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.CreateSessionRequest, dict]):
        ...
        Returns:
            google.api_core.operation.Operation:
                ...
                :class:`google.cloud.aiplatform_v1beta1.types.Session` A
                session contains a set of actions between users and
                Vertex agents.
        ...
        if not isinstance(request, session_service.CreateSessionRequest):
            request = session_service.CreateSessionRequest(request)
        ...
        response = gac_operation.from_gapic(
            ...
            gca_session.Session,
            metadata_type=session_service.CreateSessionOperationMetadata,
        )
    ...
    def get_session(
        self,
        request: Optional[Union[session_service.GetSessionRequest, dict]] = None,
        *,
        ...
        r"""Gets details of the specific
        ...
        .. code-block:: python
            ...
            def sample_get_session():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.GetSessionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.GetSessionRequest, dict]):
                The request object. Request message for
        ...
        Returns:
            google.cloud.aiplatform_v1beta1.types.Session:
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, session_service.GetSessionRequest):
            request = session_service.GetSessionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def list_sessions(
        self,
        request: Optional[Union[session_service.ListSessionsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        .. code-block:: python
            ...
            def sample_list_sessions():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.ListSessionsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ListSessionsRequest, dict]):
                The request object. Request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, session_service.ListSessionsRequest):
            request = session_service.ListSessionsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
    ...
    def update_session(
        self,
        request: Optional[Union[session_service.UpdateSessionRequest, dict]] = None,
        *,
        session: Optional[gca_session.Session] = None,
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.UpdateSessionRequest, dict]):
                The request object. Request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, session_service.UpdateSessionRequest):
            request = session_service.UpdateSessionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if session is not None:
                request.session = session
    ...
    def delete_session(
        self,
        request: Optional[Union[session_service.DeleteSessionRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Deletes details of the specific
        [Session][google.cloud.aiplatform.v1beta1.Session].
        ...
        .. code-block:: python
            ...
            def sample_delete_session():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.DeleteSessionRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.DeleteSessionRequest, dict]):
                The request object. Request message for
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, session_service.DeleteSessionRequest):
            request = session_service.DeleteSessionRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
    ...
    def list_events(
        self,
        request: Optional[Union[session_service.ListEventsRequest, dict]] = None,
        *,
        parent: Optional[str] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        ...
        r"""Lists [Events][google.cloud.aiplatform.v1beta1.Event] in a given
        session.
        ...
        .. code-block:: python
            ...
            def sample_list_events():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.ListEventsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.ListEventsRequest, dict]):
                The request object. Request message for
                [SessionService.ListEvents][google.cloud.aiplatform.v1beta1.SessionService.ListEvents].
            parent (str):
                Required. The resource name of the session to list
                events from. Format:
                ``projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/sessions/{session}``
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, session_service.ListEventsRequest):
            request = session_service.ListEventsRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if parent is not None:
                request.parent = parent
    ...
    def append_event(
        self,
        request: Optional[Union[session_service.AppendEventRequest, dict]] = None,
        *,
        name: Optional[str] = None,
        event: Optional[session.SessionEvent] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_append_event():
                ...
                request = aiplatform_v1beta1.AppendEventRequest(
                    name="name_value",
                    event=event,
                )

                # Make the request
                response = client.append_event(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.aiplatform_v1beta1.types.AppendEventRequest, dict]):
                The request object. Request message for
                [SessionService.AppendEvent][google.cloud.aiplatform.v1beta1.SessionService.AppendEvent].
            name (str):
                Required. The resource name of the session to append
                event to. Format:
                ``projects/{project}/locations/{location}/reasoningEngines/{reasoning_engine}/sessions/{session}``
            ...
            event (google.cloud.aiplatform_v1beta1.types.SessionEvent):
                Required. The event to append to the
                session.
        ...
        Returns:
            google.cloud.aiplatform_v1beta1.types.AppendEventResponse:
                Response message for
                   [SessionService.AppendEvent][google.cloud.aiplatform.v1beta1.SessionService.AppendEvent].
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, session_service.AppendEventRequest):
            request = session_service.AppendEventRequest(request)
            # If we have keyword arguments corresponding to fields on the
            # request, apply these.
            if name is not None:
                request.name = name
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.append_event]
