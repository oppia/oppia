    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomVertexRagServiceInterceptor(VertexRagServiceRestInterceptor):
            def pre_augment_prompt(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_augment_prompt(self, response):
                logging.log(f"Received response: {response}")
                return response

            def pre_corroborate_content(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_corroborate_content(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def pre_augment_prompt(
        self,
        request: vertex_rag_service.AugmentPromptRequest,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[
        vertex_rag_service.AugmentPromptRequest, Sequence[Tuple[str, Union[str, bytes]]]
    ]:
...
class VertexRagServiceRestTransport(_BaseVertexRagServiceRestTransport):
    """REST backend synchronous transport for VertexRagService.
    ...
    class _AugmentPrompt(
        _BaseVertexRagServiceRestTransport._BaseAugmentPrompt, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.AugmentPrompt")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_augment_prompt(request, metadata)
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.AugmentPrompt",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "AugmentPrompt",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._AugmentPrompt._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = vertex_rag_service.AugmentPromptResponse.to_json(
                        response
                    )
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.augment_prompt",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "AugmentPrompt",
    ...
    class _CorroborateContent(
        ...
        VertexRagServiceRestStub,
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.CorroborateContent")
        ...
        def __call__(
            ...
            *,
            ...
            request, metadata = self._interceptor.pre_corroborate_content(
                request, metadata
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.CorroborateContent",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "CorroborateContent",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = VertexRagServiceRestTransport._CorroborateContent._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = (
                        vertex_rag_service.CorroborateContentResponse.to_json(response)
                    )
                except:
                    response_payload = None
                http_response = {
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.corroborate_content",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "CorroborateContent",
                        "metadata": http_response["headers"],
    ...
    class _RetrieveContexts(
        ...
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.RetrieveContexts")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.RetrieveContexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "RetrieveContexts",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            # Send the request
            response = VertexRagServiceRestTransport._RetrieveContexts._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = (
                        vertex_rag_service.RetrieveContextsResponse.to_json(response)
                    )
                except:
                    response_payload = None
                http_response = {
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.retrieve_contexts",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "RetrieveContexts",
                        "metadata": http_response["headers"],
    ...
    class _GetLocation(
        _BaseVertexRagServiceRestTransport._BaseGetLocation, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.GetLocation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = VertexRagServiceRestTransport._GetLocation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(
        _BaseVertexRagServiceRestTransport._BaseListLocations, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.ListLocations")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._ListLocations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _GetIamPolicy(
        _BaseVertexRagServiceRestTransport._BaseGetIamPolicy, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.GetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseVertexRagServiceRestTransport._BaseGetIamPolicy._get_request_body_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        _BaseVertexRagServiceRestTransport._BaseSetIamPolicy, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.SetIamPolicy")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        ...
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.TestIamPermissions")
        ...
        def __call__(
            ...
            *,
            ...
            body = _BaseVertexRagServiceRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
    ...
    class _CancelOperation(
        ...
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.CancelOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._CancelOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _DeleteOperation(
        ...
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.DeleteOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._DeleteOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _GetOperation(
        _BaseVertexRagServiceRestTransport._BaseGetOperation, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.GetOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._GetOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
    ...
    class _ListOperations(
        _BaseVertexRagServiceRestTransport._BaseListOperations, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.ListOperations")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            # Send the request
            response = VertexRagServiceRestTransport._ListOperations._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
    ...
    class _WaitOperation(
        _BaseVertexRagServiceRestTransport._BaseWaitOperation, VertexRagServiceRestStub
    ):
        def __hash__(self):
            return hash("VertexRagServiceRestTransport.WaitOperation")
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.VertexRagServiceClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.VertexRagService",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
