...
class GenAiTuningServiceRestInterceptor:
    ...
    * Stripping extraneous information from responses
    ...
    def post_create_tuning_job_with_metadata(
        self,
    ...
    def post_get_tuning_job_with_metadata(
        self,
    ...
    def post_list_tuning_jobs_with_metadata(
        self,
    ...
    def post_rebase_tuned_model_with_metadata(
        self,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.CancelTuningJob",
                    extra={
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.CreateTuningJob",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "CreateTuningJob",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            resp, _ = self._interceptor.post_create_tuning_job_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                try:
                    response_payload = gca_tuning_job.TuningJob.to_json(response)
                except:
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.create_tuning_job",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "CreateTuningJob",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.GetTuningJob",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "GetTuningJob",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_get_tuning_job_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = tuning_job.TuningJob.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.get_tuning_job",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "GetTuningJob",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.ListTuningJobs",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "ListTuningJobs",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_list_tuning_jobs_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = (
                        genai_tuning_service.ListTuningJobsResponse.to_json(response)
                    )
                except:
                    response_payload = None
                http_response = {
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.list_tuning_jobs",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "ListTuningJobs",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.RebaseTunedModel",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "RebaseTunedModel",
                        "httpRequest": http_request,
                        "metadata": http_request["headers"],
                    },
                )
            ...
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_rebase_tuned_model_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.rebase_tuned_model",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "RebaseTunedModel",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.GenAiTuningServiceClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.GenAiTuningServiceAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.GenAiTuningService",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
