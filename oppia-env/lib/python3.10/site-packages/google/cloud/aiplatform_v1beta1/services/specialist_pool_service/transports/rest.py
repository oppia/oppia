...
class SpecialistPoolServiceRestTransport(_BaseSpecialistPoolServiceRestTransport):
    """REST backend synchronous transport for SpecialistPoolService.
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.SpecialistPoolServiceClient.create_specialist_pool",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.SpecialistPoolService",
                        "rpcName": "CreateSpecialistPool",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.SpecialistPoolServiceClient.delete_specialist_pool",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.SpecialistPoolService",
                        "rpcName": "DeleteSpecialistPool",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.SpecialistPoolServiceClient.get_specialist_pool",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.SpecialistPoolService",
                        "rpcName": "GetSpecialistPool",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.SpecialistPoolServiceClient.list_specialist_pools",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.SpecialistPoolService",
                        "rpcName": "ListSpecialistPools",
                        "metadata": http_response["headers"],
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.SpecialistPoolServiceClient.update_specialist_pool",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.SpecialistPoolService",
                        "rpcName": "UpdateSpecialistPool",
                        "metadata": http_response["headers"],
