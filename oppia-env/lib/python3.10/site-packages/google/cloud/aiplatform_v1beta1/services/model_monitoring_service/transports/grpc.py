...
class ModelMonitoringServiceGrpcTransport(ModelMonitoringServiceTransport):
    """gRPC backend transport for ModelMonitoringService.
    ...
    def create_model_monitor(
        ...
        r"""Return a callable for the create model monitor method over gRPC.

        Creates a ModelMonitor.

        Returns:
            Callable[[~.CreateModelMonitorRequest],
                    ~.Operation]:
        ...
        return self._stubs["create_model_monitor"]
    ...
    def update_model_monitor(
        ...
        r"""Return a callable for the update model monitor method over gRPC.

        Updates a ModelMonitor.

        Returns:
            Callable[[~.UpdateModelMonitorRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        return self._stubs["update_model_monitor"]
    ...
    def get_model_monitor(
        ...
        r"""Return a callable for the get model monitor method over gRPC.

        Gets a ModelMonitor.

        Returns:
            Callable[[~.GetModelMonitorRequest],
                    ~.ModelMonitor]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        return self._stubs["get_model_monitor"]
    ...
    def list_model_monitors(
        ...
        r"""Return a callable for the list model monitors method over gRPC.

        Lists ModelMonitors in a Location.

        Returns:
            Callable[[~.ListModelMonitorsRequest],
        ...
        return self._stubs["list_model_monitors"]
    ...
    def delete_model_monitor(
        ...
        r"""Return a callable for the delete model monitor method over gRPC.

        Deletes a ModelMonitor.

        Returns:
            Callable[[~.DeleteModelMonitorRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        return self._stubs["delete_model_monitor"]
    ...
    def create_model_monitoring_job(
        ...
        r"""Return a callable for the create model monitoring job method over gRPC.

        Creates a ModelMonitoringJob.

        Returns:
            Callable[[~.CreateModelMonitoringJobRequest],
                    ~.ModelMonitoringJob]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def get_model_monitoring_job(
        ...
        r"""Return a callable for the get model monitoring job method over gRPC.

        Gets a ModelMonitoringJob.

        Returns:
            Callable[[~.GetModelMonitoringJobRequest],
                    ~.ModelMonitoringJob]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
        ...
        return self._stubs["get_model_monitoring_job"]
    ...
    def list_model_monitoring_jobs(
        ...
        r"""Return a callable for the list model monitoring jobs method over gRPC.
        ...
        Returns:
            Callable[[~.ListModelMonitoringJobsRequest],
    ...
    def delete_model_monitoring_job(
        ...
        r"""Return a callable for the delete model monitoring job method over gRPC.

        Deletes a ModelMonitoringJob.

        Returns:
            Callable[[~.DeleteModelMonitoringJobRequest],
                    ~.Operation]:
                A function that, when called, will call the underlying RPC
                on the server.
        """
    ...
    def search_model_monitoring_stats(
        ...
        r"""Return a callable for the search model monitoring stats method over gRPC.

        Searches Model Monitoring Stats generated within a
        given time window.

        Returns:
            Callable[[~.SearchModelMonitoringStatsRequest],
    ...
    def search_model_monitoring_alerts(
        ...
        r"""Return a callable for the search model monitoring alerts method over gRPC.

        Returns the Model Monitoring alerts.

        Returns:
            Callable[[~.SearchModelMonitoringAlertsRequest],
...
__all__ = ("ModelMonitoringServiceGrpcTransport",)
