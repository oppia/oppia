    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomEvaluationServiceInterceptor(EvaluationServiceRestInterceptor):
            def pre_evaluate_dataset(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_evaluate_dataset(self, response):
    ...
    def pre_evaluate_dataset(
        ...
        """Pre-rpc interceptor for evaluate_dataset
    ...
    def post_evaluate_dataset(
        self, response: operations_pb2.Operation
    ) -> operations_pb2.Operation:
        """Post-rpc interceptor for evaluate_dataset

        DEPRECATED. Please use the `post_evaluate_dataset_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the EvaluationService server but before
        it is returned to user code. This `post_evaluate_dataset` interceptor runs
        before the `post_evaluate_dataset_with_metadata` interceptor.
        """
        return response

    def post_evaluate_dataset_with_metadata(
        self,
        ...
        We recommend only using this `post_evaluate_dataset_with_metadata`
        interceptor in new development instead of the `post_evaluate_dataset` interceptor.
        When both interceptors are used, this `post_evaluate_dataset_with_metadata` interceptor runs after the
        `post_evaluate_dataset` interceptor. The (possibly modified) response returned by
        `post_evaluate_dataset` will be passed to
    ...
    def post_evaluate_instances_with_metadata(
        self,
...
class EvaluationServiceRestTransport(_BaseEvaluationServiceRestTransport):
    ...
    class _EvaluateDataset(
        _BaseEvaluationServiceRestTransport._BaseEvaluateDataset,
        EvaluationServiceRestStub,
    ):
        def __hash__(self):
            return hash("EvaluationServiceRestTransport.EvaluateDataset")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the evaluate dataset method over HTTP.
            ...
            http_options = (
                _BaseEvaluationServiceRestTransport._BaseEvaluateDataset._get_http_options()
            )

            request, metadata = self._interceptor.pre_evaluate_dataset(
                request, metadata
            )
            transcoded_request = _BaseEvaluationServiceRestTransport._BaseEvaluateDataset._get_transcoded_request(
                http_options, request
            )

            body = _BaseEvaluationServiceRestTransport._BaseEvaluateDataset._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseEvaluationServiceRestTransport._BaseEvaluateDataset._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.EvaluateDataset",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "EvaluateDataset",
            ...
            # Send the request
            response = EvaluationServiceRestTransport._EvaluateDataset._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            resp = self._interceptor.post_evaluate_dataset(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_evaluate_dataset_with_metadata(
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.evaluate_dataset",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "EvaluateDataset",
    ...
    class _EvaluateInstances(
        _BaseEvaluationServiceRestTransport._BaseEvaluateInstances,
        EvaluationServiceRestStub,
    ):
        def __hash__(self):
    ...
    def evaluate_dataset(
        ...
        [evaluation_service.EvaluateDatasetRequest], operations_pb2.Operation
    ]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._EvaluateDataset(self._session, self._host, self._interceptor)  # type: ignore
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "GetLocation",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.GetLocation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "GetLocation",
                        "httpResponse": http_response,
    ...
    class _ListLocations(
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseEvaluationServiceRestTransport._BaseListLocations._get_http_options()
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.ListLocations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "ListLocations",
                        "httpResponse": http_response,
    ...
    class _GetIamPolicy(
        _BaseEvaluationServiceRestTransport._BaseGetIamPolicy, EvaluationServiceRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseEvaluationServiceRestTransport._BaseGetIamPolicy._get_http_options()
            )

            request, metadata = self._interceptor.pre_get_iam_policy(request, metadata)
            transcoded_request = _BaseEvaluationServiceRestTransport._BaseGetIamPolicy._get_transcoded_request(
                http_options, request
            )

            body = _BaseEvaluationServiceRestTransport._BaseGetIamPolicy._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseEvaluationServiceRestTransport._BaseGetIamPolicy._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
            ...
            # Send the request
            response = EvaluationServiceRestTransport._GetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.GetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "GetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _SetIamPolicy(
        _BaseEvaluationServiceRestTransport._BaseSetIamPolicy, EvaluationServiceRestStub
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseEvaluationServiceRestTransport._BaseSetIamPolicy._get_http_options()
            )

            request, metadata = self._interceptor.pre_set_iam_policy(request, metadata)
            transcoded_request = _BaseEvaluationServiceRestTransport._BaseSetIamPolicy._get_transcoded_request(
                http_options, request
            )

            body = _BaseEvaluationServiceRestTransport._BaseSetIamPolicy._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseEvaluationServiceRestTransport._BaseSetIamPolicy._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
            ...
            # Send the request
            response = EvaluationServiceRestTransport._SetIamPolicy._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.SetIamPolicy",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "SetIamPolicy",
                        "httpResponse": http_response,
    ...
    class _TestIamPermissions(
        _BaseEvaluationServiceRestTransport._BaseTestIamPermissions,
        EvaluationServiceRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseEvaluationServiceRestTransport._BaseTestIamPermissions._get_http_options()
            )

            request, metadata = self._interceptor.pre_test_iam_permissions(
                request, metadata
            )
            transcoded_request = _BaseEvaluationServiceRestTransport._BaseTestIamPermissions._get_transcoded_request(
                http_options, request
            )

            body = _BaseEvaluationServiceRestTransport._BaseTestIamPermissions._get_request_body_json(
                transcoded_request
            )

            # Jsonify the query params
            query_params = _BaseEvaluationServiceRestTransport._BaseTestIamPermissions._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
            ...
            # Send the request
            response = EvaluationServiceRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.TestIamPermissions",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "TestIamPermissions",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.CancelOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
    ...
    class _DeleteOperation(
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseEvaluationServiceRestTransport._BaseDeleteOperation._get_http_options()
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.DeleteOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.GetOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "GetOperation",
                        "httpResponse": http_response,
        ...
        def __call__(
            ...
            *,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.ListOperations",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "ListOperations",
                        "httpResponse": http_response,
    ...
    class _WaitOperation(
        _BaseEvaluationServiceRestTransport._BaseWaitOperation,
        EvaluationServiceRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            http_options = (
                _BaseEvaluationServiceRestTransport._BaseWaitOperation._get_http_options()
            )

            request, metadata = self._interceptor.pre_wait_operation(request, metadata)
            transcoded_request = _BaseEvaluationServiceRestTransport._BaseWaitOperation._get_transcoded_request(
                http_options, request
            )

            # Jsonify the query params
            query_params = _BaseEvaluationServiceRestTransport._BaseWaitOperation._get_query_params_json(
                transcoded_request
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.aiplatform_v1beta1.EvaluationServiceClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
            ...
            # Send the request
            response = EvaluationServiceRestTransport._WaitOperation._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.aiplatform_v1beta1.EvaluationServiceAsyncClient.WaitOperation",
                    extra={
                        "serviceName": "google.cloud.aiplatform.v1beta1.EvaluationService",
                        "rpcName": "WaitOperation",
                        "httpResponse": http_response,
