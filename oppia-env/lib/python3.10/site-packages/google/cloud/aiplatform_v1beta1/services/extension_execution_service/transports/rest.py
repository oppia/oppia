...
class ExtensionExecutionServiceRestTransport(
    ...
    class _ExecuteExtension(
        ...
        ExtensionExecutionServiceRestStub,
    ):
        def __hash__(self):
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._ExecuteExtension._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _QueryExtension(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._QueryExtension._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetLocation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._GetLocation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _ListLocations(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._ListLocations._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetIamPolicy(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._GetIamPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _SetIamPolicy(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._SetIamPolicy._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _TestIamPermissions(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = ExtensionExecutionServiceRestTransport._TestIamPermissions._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
    ...
    class _CancelOperation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._CancelOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _DeleteOperation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._DeleteOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _GetOperation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._GetOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _ListOperations(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._ListOperations._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
    ...
    class _WaitOperation(
        ...
        def __call__(
            ...
            *,
            ...
            # Send the request
            response = (
                ExtensionExecutionServiceRestTransport._WaitOperation._get_response(
                    self._host,
                    metadata,
                    query_params,
                    self._session,
