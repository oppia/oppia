...
class _BaseReasoningEngineExecutionServiceRestTransport(
    ReasoningEngineExecutionServiceTransport
):
    """Base REST backend transport for ReasoningEngineExecutionService.
    ...
    class _BaseQueryReasoningEngine:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReasoningEngineExecutionServiceRestTransport._BaseQueryReasoningEngine._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseStreamQueryReasoningEngine:
        def __hash__(self):  # pragma: NO COVER
            return NotImplementedError("__hash__ must be implemented.")
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{name=projects/*/locations/*/reasoningEngines/*}:streamQuery",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseReasoningEngineExecutionServiceRestTransport._BaseStreamQueryReasoningEngine._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseReasoningEngineExecutionServiceRestTransport",)
