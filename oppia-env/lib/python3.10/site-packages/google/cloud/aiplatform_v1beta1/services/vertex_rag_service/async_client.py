    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.aiplatform_v1beta1.VertexRagServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_augment_prompt():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.AugmentPromptRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.AugmentPromptRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            model (:class:`google.cloud.aiplatform_v1beta1.types.AugmentPromptRequest.Model`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            vertex_rag_store (:class:`google.cloud.aiplatform_v1beta1.types.VertexRagStore`):
        ...
        Returns:
            google.cloud.aiplatform_v1beta1.types.AugmentPromptResponse:
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_corroborate_content():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.CorroborateContentRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.CorroborateContentRequest, dict]]):
                The request object. Request message for
                CorroborateContent.
            parent (:class:`str`):
                Required. The resource name of the Location from which
            ...
            content (:class:`google.cloud.aiplatform_v1beta1.types.Content`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            facts (:class:`MutableSequence[google.cloud.aiplatform_v1beta1.types.Fact]`):
        ...
        Returns:
            google.cloud.aiplatform_v1beta1.types.CorroborateContentResponse:
                Response message for
                CorroborateContent.
