...
class _BaseVertexRagServiceRestTransport(VertexRagServiceTransport):
    """Base REST backend transport for VertexRagService.
    ...
    class _BaseAugmentPrompt:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{parent=projects/*/locations/*}:augmentPrompt",
                    "body": "*",
                },
            ]
            return http_options
        ...
        def _get_transcoded_request(http_options, request):
            pb_request = vertex_rag_service.AugmentPromptRequest.pb(request)
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseVertexRagServiceRestTransport._BaseAugmentPrompt._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseCorroborateContent:
        ...
        def _get_http_options():
            http_options: List[Dict[str, str]] = [
                {
                    "method": "post",
                    "uri": "/v1beta1/{parent=projects/*/locations/*}:corroborateContent",
                    "body": "*",
                },
            ]
            return http_options
        ...
        @staticmethod
        def _get_transcoded_request(http_options, request):
            pb_request = vertex_rag_service.CorroborateContentRequest.pb(request)
            transcoded_request = path_template.transcode(http_options, pb_request)
            return transcoded_request
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseVertexRagServiceRestTransport._BaseCorroborateContent._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseRetrieveContexts:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseVertexRagServiceRestTransport._BaseRetrieveContexts._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseVertexRagServiceRestTransport",)
