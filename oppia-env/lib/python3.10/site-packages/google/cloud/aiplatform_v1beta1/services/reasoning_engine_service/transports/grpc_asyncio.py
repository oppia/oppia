...
class ReasoningEngineServiceGrpcAsyncIOTransport(ReasoningEngineServiceTransport):
    ...
    def create_reasoning_engine(
        ...
        if "create_reasoning_engine" not in self._stubs:
            self._stubs["create_reasoning_engine"] = self._logged_channel.unary_unary(
    ...
    def get_reasoning_engine(
        ...
        if "get_reasoning_engine" not in self._stubs:
            self._stubs["get_reasoning_engine"] = self._logged_channel.unary_unary(
    ...
    def list_reasoning_engines(
        ...
        if "list_reasoning_engines" not in self._stubs:
            self._stubs["list_reasoning_engines"] = self._logged_channel.unary_unary(
    ...
    def update_reasoning_engine(
        ...
        if "update_reasoning_engine" not in self._stubs:
            self._stubs["update_reasoning_engine"] = self._logged_channel.unary_unary(
    ...
    def delete_reasoning_engine(
        ...
        if "delete_reasoning_engine" not in self._stubs:
            self._stubs["delete_reasoning_engine"] = self._logged_channel.unary_unary(
