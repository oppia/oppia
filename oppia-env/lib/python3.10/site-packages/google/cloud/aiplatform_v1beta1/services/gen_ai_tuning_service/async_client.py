    ...
    def __init__(
        ...
        *,
        ...
        if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
            ...
            _LOGGER.debug(
                "Created client `google.cloud.aiplatform_v1beta1.GenAiTuningServiceAsyncClient`.",
                extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_create_tuning_job():
                # Create a client
                client = aiplatform_v1beta1.GenAiTuningServiceAsyncClient()

                # Initialize request argument(s)
                tuning_job = aiplatform_v1beta1.TuningJob()
                tuning_job.base_model = "base_model_value"
                tuning_job.supervised_tuning_spec.training_dataset_uri = "training_dataset_uri_value"

                request = aiplatform_v1beta1.CreateTuningJobRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.CreateTuningJobRequest, dict]]):
            ...
            parent (:class:`str`):
                ...
                should not be set.
            tuning_job (:class:`google.cloud.aiplatform_v1beta1.types.TuningJob`):
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_get_tuning_job():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.GetTuningJobRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.GetTuningJobRequest, dict]]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_list_tuning_jobs():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.ListTuningJobsRequest(
                    parent="parent_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.ListTuningJobsRequest, dict]]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_cancel_tuning_job():
                ...
                # Initialize request argument(s)
                request = aiplatform_v1beta1.CancelTuningJobRequest(
                    name="name_value",
                )
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.CancelTuningJobRequest, dict]]):
                The request object. Request message for
        ...
        *,
        ...
        .. code-block:: python
            ...
            async def sample_rebase_tuned_model():
                ...
                # Initialize request argument(s)
                tuned_model_ref = aiplatform_v1beta1.TunedModelRef()
                tuned_model_ref.tuned_model = "tuned_model_value"

                request = aiplatform_v1beta1.RebaseTunedModelRequest(
                    parent="parent_value",
        ...
        Args:
            request (Optional[Union[google.cloud.aiplatform_v1beta1.types.RebaseTunedModelRequest, dict]]):
                The request object. Request message for
            ...
            parent (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            tuned_model_ref (:class:`google.cloud.aiplatform_v1beta1.types.TunedModelRef`):
        ...
        Returns:
            google.api_core.operation_async.AsyncOperation:
                ...
                :class:`google.cloud.aiplatform_v1beta1.types.TuningJob`
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [parent, tuned_model_ref]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
