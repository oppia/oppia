...
class _BaseFirestoreRestTransport(FirestoreTransport):
    ...
    class _BaseRunQuery:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseFirestoreRestTransport._BaseRunQuery._get_unset_required_fields(
                    query_params
                )
            )
    ...
    class _BaseUpdateDocument:
        ...
        def _get_query_params_json(transcoded_request):
            ...
            query_params.update(
                _BaseFirestoreRestTransport._BaseUpdateDocument._get_unset_required_fields(
                    query_params
                )
            )
...
__all__ = ("_BaseFirestoreRestTransport",)
