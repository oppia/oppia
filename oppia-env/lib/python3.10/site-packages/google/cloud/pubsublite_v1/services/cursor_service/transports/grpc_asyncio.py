...
class CursorServiceGrpcAsyncIOTransport(CursorServiceTransport):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.streaming_commit_cursor: gapic_v1.method_async.wrap_method(
                self.streaming_commit_cursor,
                default_timeout=None,
                client_info=client_info,
            ),
            self.commit_cursor: gapic_v1.method_async.wrap_method(
                self.commit_cursor,
            ...
            self.list_partition_cursors: gapic_v1.method_async.wrap_method(
