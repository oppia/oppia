...
class AdminServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = AdminServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = AdminServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        """Instantiates the admin service async client.
