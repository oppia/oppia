...
class TopicStatsServiceClient(metaclass=TopicStatsServiceClientMeta):
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = "pubsublite.{UNIVERSE_DOMAIN}"
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = TopicStatsServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = TopicStatsServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = TopicStatsServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = TopicStatsServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or TopicStatsServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        self._client_cert_source = TopicStatsServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = TopicStatsServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, TopicStatsServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(TopicStatsServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or TopicStatsServiceClient._get_api_endpoint(
