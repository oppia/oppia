...
class PublisherServiceAsyncClient:
    ...
    _DEFAULT_ENDPOINT_TEMPLATE = PublisherServiceClient._DEFAULT_ENDPOINT_TEMPLATE
    _DEFAULT_UNIVERSE = PublisherServiceClient._DEFAULT_UNIVERSE
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[
                str, PublisherServiceTransport, Callable[..., PublisherServiceTransport]
            ]
        ] = "grpc_asyncio",
        ...
        Args:
            ...
            transport (Optional[Union[str,PublisherServiceTransport,Callable[..., PublisherServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport to use.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the PublisherServiceTransport constructor.
