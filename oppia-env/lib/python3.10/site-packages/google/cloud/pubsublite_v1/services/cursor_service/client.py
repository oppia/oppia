...
class CursorServiceClient(metaclass=CursorServiceClientMeta):
    ...
    def _get_api_endpoint(
        ...
        if api_override is not None:
            ...
            _default_universe = CursorServiceClient._DEFAULT_UNIVERSE
            if universe_domain != _default_universe:
                raise MutualTLSChannelError(
                    f"mTLS is not supported in any universe other than {_default_universe}."
                )
            api_endpoint = CursorServiceClient.DEFAULT_MTLS_ENDPOINT
        else:
            api_endpoint = CursorServiceClient._DEFAULT_ENDPOINT_TEMPLATE.format(
    ...
    def _get_universe_domain(
        ...
        """
        universe_domain = CursorServiceClient._DEFAULT_UNIVERSE
    ...
    def _compare_universes(
        ...
        default_universe = CursorServiceClient._DEFAULT_UNIVERSE
    ...
    def _validate_universe_domain(self):
        ...
        self._is_universe_domain_valid = (
            self._is_universe_domain_valid
            or CursorServiceClient._compare_universes(
    ...
    def __init__(
        ...
        *,
        ...
        transport: Optional[
            Union[str, CursorServiceTransport, Callable[..., CursorServiceTransport]]
        ] = None,
        ...
        Args:
            ...
            transport (Optional[Union[str,CursorServiceTransport,Callable[..., CursorServiceTransport]]]):
                The transport to use, or a Callable that constructs and returns a new transport.
                If a Callable is given, it will be called with the same set of initialization
                arguments as used in the CursorServiceTransport constructor.
        ...
        ) = CursorServiceClient._read_environment_variables()
        self._client_cert_source = CursorServiceClient._get_client_cert_source(
            self._client_options.client_cert_source, self._use_client_cert
        )
        self._universe_domain = CursorServiceClient._get_universe_domain(
        ...
        transport_provided = isinstance(transport, CursorServiceTransport)
        if transport_provided:
            ...
            self._transport = cast(CursorServiceTransport, transport)
            self._api_endpoint = self._transport.host

        self._api_endpoint = (
            self._api_endpoint
            or CursorServiceClient._get_api_endpoint(
