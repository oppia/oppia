...
_TRAININGJOBRESPONSEPAYLOAD_JOBRESULT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='textClassifier', file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_TRAININGJOBRESPONSEPAYLOAD = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='jobResult', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='vmId', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
...
TrainingJobResponsePayload = _reflection.GeneratedProtocolMessageType('TrainingJobResponsePayload', (_message.Message,), dict(
