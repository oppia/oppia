...
URLS = [
    ...
    get_redirect_route(
        r'%s/can_access_subtopic_viewer_page/<classroom_url_fragment>/<topic_url_fragment>/revision/<subtopic_url_fragment>'
    ...
    get_redirect_route(
        r'%s/can_access_topic_viewer_page/<classroom_url_fragment>'
        r'/<topic_url_fragment>/revision' % feconf.ACCESS_VALIDATION_HANDLER_PREFIX,
        access_validators.TopicViewerPageAccessValidationHandler
    ),
    get_redirect_route(
        r'%s/can_access_topic_viewer_page/<classroom_url_fragment>'
    ...
    get_redirect_route(
        r'/translationcoordinatorrolehandler', admin.TranslationCoordinatorRoleHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        '/contributor_dashboard', creator_dashboard.OldContributorDashboardRedirectPage
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.NEW_EXPLORATION_URL, creator_dashboard.NewExplorationHandler
    ),
    get_redirect_route(
        r'%s' % feconf.NEW_COLLECTION_URL, creator_dashboard.NewCollectionHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/gettranslatabletexthandler', contributor_dashboard.TranslatableTextHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.NEW_SKILL_URL, topics_and_skills_dashboard.NewSkillHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/<topic_name>' % feconf.TOPIC_NAME_HANDLER, topic_editor.TopicNameHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.NEW_CLASSROOM_ID_HANDLER_URL, classroom.NewClassroomIdHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/<classroom_id>' % feconf.CLASSROOM_HANDLER_URL, classroom.ClassroomHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        ...
        r'<entity_version>/<language_code>', voiceover.EntityVoiceoversBulkHandler
    ),
    get_redirect_route(
        r'%s/<classroom_url_fragment>/<topic_url_fragment>'
    ...
    get_redirect_route(
        r'%s' % feconf.NEW_TOPIC_URL, topics_and_skills_dashboard.NewTopicHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.MERGE_SKILLS_URL, topics_and_skills_dashboard.MergeSkillHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.BLOG_HOMEPAGE_DATA_URL, blog_homepage.BlogHomepageDataHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/value_generator_handler/<generator_id>', resources.ValueGeneratorHandler
    ),
    ...
    get_redirect_route(
        feconf.EXPLORATION_SUMMARIES_DATA_URL, library.ExplorationSummariesHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/mailinglistsubscriptionhandler', profile.MailingListSubscriptionHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.FEATURE_FLAGS_URL, release_coordinator.FeatureFlagsHandler
    ),
    get_redirect_route(
        r'%s' % feconf.USER_GROUPS_HANDLER_URL, release_coordinator.UserGroupHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/explorehandler/state_hit_event/<exploration_id>', reader.StateHitEventHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/explorehandler/give_feedback/<exploration_id>', reader.ReaderFeedbackHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/explorehandler/stats_events/<exploration_id>', reader.StatsEventsHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        ...
        (feconf.STATE_VERSION_HISTORY_URL_PREFIX), reader.StateVersionHistoryHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/<exploration_id>' % feconf.EDITOR_URL_PREFIX, editor.ExplorationPage
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/editsallowedhandler/<exploration_id>', editor.ExplorationEditsAllowedHandler
    ),
    get_redirect_route(
        r'/createhandler/download/<exploration_id>', editor.ExplorationFileDownloader
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/createhandler/audioupload/<exploration_id>', voice_artist.AudioUploadHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/createhandler/revert/<exploration_id>', editor.ExplorationRevertHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/createhandler/autosave_draft/<exploration_id>', editor.EditorAutosaveHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.RECENT_COMMITS_DATA_URL, recent_commits.RecentCommitsHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/<thread_id>' % feconf.FEEDBACK_THREAD_URL_PREFIX, feedback.ThreadHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.SUGGESTION_LIST_URL_PREFIX, suggestion.SuggestionListHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/<topic_id>' % feconf.TOPIC_EDITOR_URL_PREFIX, topic_editor.TopicEditorPage
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/' % feconf.TOPIC_ID_TO_TOPIC_NAME, topic_editor.TopicIdToTopicNameHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s' % feconf.SKILL_MASTERY_DATA_URL, skill_mastery.SkillMasteryDataHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/numberofdeletionrequestshandler', admin.NumberOfDeletionRequestsHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/%s/<exploration_id>' %
        (feconf.IMPROVEMENTS_CONFIG_URL_PREFIX, constants.TASK_ENTITY_TYPE_EXPLORATION),
        improvements.ExplorationImprovementsConfigHandler
    ),
    get_redirect_route(
        r'%s' % feconf.BLOG_ADMIN_ROLE_HANDLER_URL, blog_admin.BlogAdminRolesHandler
    ),
    ...
    get_redirect_route(
        r'%s' % feconf.BLOG_DASHBOARD_DATA_URL, blog_dashboard.BlogDashboardDataHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'/feature_flags_evaluation_handler', feature_flag.FeatureFlagsEvaluationHandler
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        ...
        r'<entity_version>/<language_code>', reader.EntityTranslationHandler
    ),
    get_redirect_route(
        r'/create_learner_group_handler', learner_group.CreateLearnerGroupHandler
    ),
    get_redirect_route(
...
for subject, topics in constants.AVAILABLE_LANDING_PAGES.items():
    for topic in topics:
        URLS.append(
            get_redirect_route(r'/%s/%s' % (subject, topic), oppia_root.OppiaRootPage)
        )

if constants.DEV_MODE:
    URLS.append(
        get_redirect_route(
            r'/initialize_android_test_data', android.InitializeAndroidTestDataHandler
        )
    )
...
URLS.extend((
    ...
    get_redirect_route(
        r'%s/<exploration_id>' % feconf.EXPLORATION_URL_PREFIX, oppia_root.OppiaRootPage
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/story' % feconf.TOPIC_VIEWER_URL_PREFIX, oppia_root.OppiaRootPage
    ),
    get_redirect_route(
        r'%s/revision' % feconf.TOPIC_VIEWER_URL_PREFIX, oppia_root.OppiaRootPage
    ),
    get_redirect_route(
        r'%s/practice' % feconf.TOPIC_VIEWER_URL_PREFIX, oppia_root.OppiaRootPage
    ),
    get_redirect_route(
        r'%s' % feconf.TOPIC_VIEWER_URL_PREFIX, oppia_root.OppiaRootPage
    ),
    get_redirect_route(
        r'%s/<blog_post_url>' % feconf.BLOG_HOMEPAGE_URL, oppia_root.OppiaRootPage
    ),
    get_redirect_route(
    ...
    get_redirect_route(
        r'%s/<skill_id>' % feconf.SKILL_EDITOR_URL_PREFIX, oppia_root.OppiaRootPage
    ),
    get_redirect_route(
        r'%s/<story_id>' % feconf.STORY_EDITOR_URL_PREFIX, oppia_root.OppiaRootPage
    )
))
