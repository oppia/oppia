...
URLS = MAPREDUCE_HANDLERS + [
    ...
    get_redirect_route(r'/explorations/<rank_method>', library.LibraryPage),
    get_redirect_route(r'/rankexplorationshandler/rank_method', library.RankExplorationsHandler),
